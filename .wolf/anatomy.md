...
- `session.ts` — GameSession: o SERVIDOR autoritativo, independente de hospedeiro. (~40022 tok)
  - section `SessionOptions` L125-157 (~442 tok)
  - section `SessionPlayer` L158-168 (~58 tok)
  - section `Identity` L169-181 (~110 tok)
  - fn `parseCoordArg` L182-193 (~106 tok)
  - class `GameSession` L194-3263 (~38601 tok)
