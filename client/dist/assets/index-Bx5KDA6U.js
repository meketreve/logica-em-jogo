...
attribute float luz;
varying float vLuz;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
vLuz = luz;`),r.fragmentShader=r.fragmentShader.replace(`#include <common>`,`#include <common>
varying float vLuz;
uniform float nivelCeu;
uniform float luzMin;`).replace(`#include <color_fragment>`,`#include <color_fragment>
{
