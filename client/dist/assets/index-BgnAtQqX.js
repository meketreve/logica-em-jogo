...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ko(e,t,n){let r=new Float32Array(ho),i=new V(0,1,0);return new $i({name:`SphericalGaussianBlur`,defines:{n:ho,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ao(){return new $i({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(){return new $i({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Mo(),fragmentShader:`
	...
	`}var No=class extends jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Mi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ic={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ac(e,t){let n=ic[t];return n===void 0?(R(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var oc=new V;function sc(){return vt.getLuminanceCoefficients(oc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${oc.x.toFixed(4)}, ${oc.y.toFixed(4)}, ${oc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Xs(i,i.VERTEX_SHADER,y),S=Xs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=nc(i,x,`vertex`),n=nc(i,S,`fragment`);z(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,cl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Ii(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new $i({vertexShader:ol,fragmentShader:sl,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ei(new Wi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ll=class extends tt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new cl,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new B,te=null,O=new Ma;O.viewport=new kt;let ne=new Ma;ne.viewport=new kt;let k=[O,ne],A=new Ba,re=null,ie=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getHandSpace()};function j(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function M(){r.removeEventListener(`select`,j),r.removeEventListener(`selectstart`,j),r.removeEventListener(`selectend`,j),r.removeEventListener(`squeeze`,j),r.removeEventListener(`squeezestart`,j),r.removeEventListener(`squeezeend`,j),r.removeEventListener(`end`,M),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,ie=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,P.stop(),n.isPresenting=!1,e.setPixelRatio(te),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&R(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&R(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,j),r.addEventListener(`selectstart`,j),r.addEventListener(`selectend`,j),r.addEventListener(`squeeze`,j),r.addEventListener(`squeezestart`,j),r.addEventListener(`squeezeend`,j),r.addEventListener(`end`,M),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),te=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new jt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new Pi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new jt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),P.setContext(r),P.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new V,se=new V;function ce(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function le(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=ne.near=O.near=t,A.far=ne.far=O.far=n,(re!==A.near||ie!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,ie=A.far),A.layers.mask=e.layers.mask|6,O.layers.mask=A.layers.mask&-5,ne.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;le(A,i);for(let e=0;e<a.length;e++)le(a[e],i);a.length===2?ce(A,O,ne):A.projectionMatrix.copy(O.projectionMatrix),ue(e,A,i)};function ue(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=it*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let N=null;function de(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=k[n];o===void 0&&(o=new Ma,o.layers.enable(n),o.viewport=new kt,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Ii,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}N&&N(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let P=new to;P.setAnimationLoop(de),this.setAnimationLoop=function(e){N=e},this.dispose=function(){}}},ul=new Pt,dl=new H;dl.set(-1,0,0,0,1,0,0,0,1);function fl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Yi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(ul.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(dl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function pl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return z(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?R(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):R(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var ml=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),hl=null;function gl(){return hl===null&&(hl=new ri(ml,16,16,te,g),hl.name=`DFG_LUT`,hl.minFilter=o,hl.magFilter=o,hl.wrapS=t,hl.wrapT=t,hl.generateMipmaps=!1,hl.needsUpdate=!0),hl}var _l=class{constructor(e={}){let{canvas:t=Je(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([ne,O,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new V,te=null,k=null,A=[],re=[],ie=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,M=!1,ae=null,oe=null,se=null,ce=null;this._outputColorSpace=Re;let le=0,ue=0,N=null,de=-1,P=null,fe=new kt,pe=new kt,me=null,he=new U(0),ge=0,_e=t.width,ve=t.height,ye=1,be=null,xe=null,Se=new kt(0,0,_e,ve),Ce=new kt(0,0,_e,ve),we=!1,Te=new di,Ee=!1,De=!1,Oe=new Pt,ke=new V,Ae=new kt,je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Me=!1;function Ne(){return N===null?ye:1}let F=n;function Pe(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,lt,!1),t.addEventListener(`webglcontextrestored`,ut,!1),t.addEventListener(`webglcontextcreationerror`,B,!1),F===null){let t=`webgl2`;if(F=Pe(t,e),F===null)throw Pe(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw z(`WebGLRenderer: `+e.message),e}let Fe,Ie,I,Le,L,ze,Be,Ve,He,Ue,Ge,Ke,qe,Ye,Ze,Qe,et,tt,nt,rt,it,at,ot;function st(){Fe=new Fo(F),Fe.init(),it=new al(F,Fe),Ie=new uo(F,Fe,e,it),I=new rl(F,Fe),Ie.reversedDepthBuffer&&h&&I.buffers.depth.setReversed(!0),oe=F.createFramebuffer(),se=F.createFramebuffer(),ce=F.createFramebuffer(),Le=new Ro(F),L=new Lc,ze=new il(F,Fe,I,L,Ie,it,Le),Be=new Po(j),Ve=new no(F),at=new co(F,Ve),He=new Io(F,Ve,Le,at),Ue=new Bo(F,He,Ve,at,Le),tt=new zo(F,Ie,ze),Ze=new fo(L),Ge=new Ic(j,Be,Fe,Ie,at,Ze),Ke=new fl(j,L),qe=new Vc,Ye=new Jc(Fe),et=new so(j,Be,I,Ue,x,s),Qe=new nl(j,Ue,Ie),ot=new pl(F,Le,Ie,I),nt=new lo(F,Fe,Le),rt=new Lo(F,Fe,Le),Le.programs=Ge.programs,j.capabilities=Ie,j.extensions=Fe,j.properties=L,j.renderLists=qe,j.shadowMap=Qe,j.state=I,j.info=Le}st(),S!==1009&&(ie=new Ho(S,t.width,t.height,o,r,i));let ct=new ll(j,F);this.xr=ct,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let e=Fe.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Fe.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ye},this.setPixelRatio=function(e){e!==void 0&&(ye=e,this.setSize(_e,ve,!1))},this.getSize=function(e){return e.set(_e,ve)},this.setSize=function(e,n,r=!0){if(ct.isPresenting){R(`WebGLRenderer: Can't change size while VR device is presenting.`);return}_e=e,ve=n,t.width=Math.floor(e*ye),t.height=Math.floor(n*ye),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ie!==null&&ie.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(_e*ye,ve*ye).floor()},this.setDrawingBufferSize=function(e,n,r){_e=e,ve=n,ye=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){z(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){R(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ie.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(fe)},this.getViewport=function(e){return e.copy(Se)},this.setViewport=function(e,t,n,r){e.isVector4?Se.set(e.x,e.y,e.z,e.w):Se.set(e,t,n,r),I.viewport(fe.copy(Se).multiplyScalar(ye).round())},this.getScissor=function(e){return e.copy(Ce)},this.setScissor=function(e,t,n,r){e.isVector4?Ce.set(e.x,e.y,e.z,e.w):Ce.set(e,t,n,r),I.scissor(pe.copy(Ce).multiplyScalar(ye).round())},this.getScissorTest=function(){return we},this.setScissorTest=function(e){I.setScissorTest(we=e)},this.setOpaqueSort=function(e){be=e},this.setTransparentSort=function(e){xe=e},this.getClearColor=function(e){return e.copy(et.getClearColor())},this.setClearColor=function(){et.setClearColor(...arguments)},this.getClearAlpha=function(){return et.getClearAlpha()},this.setClearAlpha=function(){et.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=et.getClearColor(),r=et.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,F.clearBufferuiv(F.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,F.clearBufferiv(F.COLOR,0,E))}else r|=F.COLOR_BUFFER_BIT}t&&(r|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&F.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,lt,!1),t.removeEventListener(`webglcontextrestored`,ut,!1),t.removeEventListener(`webglcontextcreationerror`,B,!1),et.dispose(),qe.dispose(),Ye.dispose(),L.dispose(),Be.dispose(),Ue.dispose(),at.dispose(),ot.dispose(),Ge.dispose(),ct.dispose(),ct.removeEventListener(`sessionstart`,gt),ct.removeEventListener(`sessionend`,_t),yt.stop()};function lt(e){e.preventDefault(),Xe(`WebGLRenderer: Context Lost.`),M=!0}function ut(){Xe(`WebGLRenderer: Context Restored.`),M=!1;let e=Le.autoReset,t=Qe.enabled,n=Qe.autoUpdate,r=Qe.needsUpdate,i=Qe.type;st(),Le.autoReset=e,Qe.enabled=t,Qe.autoUpdate=n,Qe.needsUpdate=r,Qe.type=i}function B(e){z(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function dt(e){let t=e.target;t.removeEventListener(`dispose`,dt),ft(t)}function ft(e){pt(e),L.remove(e)}function pt(e){let t=L.get(e).programs;t!==void 0&&(t.forEach(function(e){Ge.releaseProgram(e)}),e.isShaderMaterial&&Ge.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=je);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=At(e,t,n,r,i);I.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=He.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;at.setup(i,r,s,n,c);let h,g=nt;if(c!==null&&(h=Ve.get(c),g=rt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(I.setLineWidth(r.wireframeLinewidth*Ne()),g.setMode(F.LINES)):g.setMode(F.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),I.setLineWidth(e*Ne()),i.isLineSegments?g.setMode(F.LINES):i.isLineLoop?g.setMode(F.LINE_LOOP):g.setMode(F.LINE_STRIP)}else i.isPoints?g.setMode(F.POINTS):i.isSprite&&g.setMode(F.TRIANGLES);if(i.isBatchedMesh)if(Fe.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ve.get(c).bytesPerElement:1,o=L.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(F,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function H(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Tt(e,t,n),e.side=0,e.needsUpdate=!0,Tt(e,t,n),e.side=2):Tt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Ye.get(n),k.init(t),re.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];H(a,n,e),r.add(a)}else H(t,n,e),r.add(t)}),k=re.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){L.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Fe.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let mt=null;function ht(e){mt&&mt(e)}function gt(){yt.stop()}function _t(){yt.start()}let yt=new to;yt.setAnimationLoop(ht),typeof self<`u`&&yt.setContext(self),this.setAnimationLoop=function(e){mt=e,ct.setAnimationLoop(e),e===null?yt.stop():yt.start()},ct.addEventListener(`sessionstart`,gt),ct.addEventListener(`sessionend`,_t),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){z(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(M===!0)return;ae!==null&&ae.renderStart(e,t);let n=ct.enabled===!0&&ct.isPresenting===!0,r=ie!==null&&(N===null||n)&&ie.begin(j,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ct.enabled===!0&&ct.isPresenting===!0&&(ie===null||ie.isCompositing()===!1)&&(ct.cameraAutoUpdate===!0&&ct.updateCamera(t),t=ct.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,N),k=Ye.get(e,re.length),k.init(t),k.state.textureUnits=ze.getTextureUnits(),re.push(k),Oe.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Te.setFromProjectionMatrix(Oe,We,t.reversedDepth),De=this.localClippingEnabled,Ee=Ze.init(this.clippingPlanes,De),te=qe.get(e,A.length),te.init(),A.push(te),ct.enabled===!0&&ct.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&bt(e,t,-1/0,j.sortObjects)}bt(e,t,0,j.sortObjects),te.finish(),j.sortObjects===!0&&te.sort(be,xe,t.reversedDepth),Me=ct.enabled===!1||ct.isPresenting===!1||ct.hasDepthSensing()===!1,Me&&et.addToRenderList(te,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ee===!0&&Ze.beginShadows();let i=k.state.shadowsArray;if(Qe.render(i,e,t),Ee===!0&&Ze.endShadows(),(r&&ie.hasRenderPass())===!1){let n=te.opaque,r=te.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];St(n,r,e,a)}Me&&et.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];xt(te,e,n,n.viewport)}}else r.length>0&&St(n,r,e,t),Me&&et.render(e),xt(te,e,t)}N!==null&&ue===0&&(ze.updateMultisampleRenderTarget(N),ze.updateRenderTargetMipmap(N)),r&&ie.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),at.resetDefaultState(),de=-1,P=null,re.pop(),re.length>0?(k=re[re.length-1],ze.setTextureUnits(k.state.textureUnits),Ee===!0&&Ze.setGlobalState(j.clippingPlanes,k.state.camera)):k=null,A.pop(),te=A.length>0?A[A.length-1]:null,ae!==null&&ae.renderEnd()};function bt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Te.intersectsSprite(e)){r&&Ae.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Oe);let t=Ue.update(e),i=e.material;i.visible&&te.push(e,t,i,n,Ae.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Te.intersectsObject(e))){let t=Ue.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Ae.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Ae.copy(e.boundingSphere.center)),Ae.applyMatrix4(e.matrixWorld).applyMatrix4(Oe)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&te.push(e,t,s,n,Ae.z,o)}}else i.visible&&te.push(e,t,i,n,Ae.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)bt(i[e],t,n,r)}function xt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Ee===!0&&Ze.setGlobalState(j.clippingPlanes,n),r&&I.viewport(fe.copy(r)),i.length>0&&Ct(i,t,n),a.length>0&&Ct(a,t,n),o.length>0&&Ct(o,t,n),I.buffers.depth.setTest(!0),I.buffers.depth.setMask(!0),I.buffers.color.setMask(!0),I.setPolygonOffset(!1)}function St(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Fe.has(`EXT_color_buffer_half_float`)||Fe.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new jt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Ie.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:vt.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||fe;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(he),ge=j.getClearAlpha(),ge<1&&j.setClearColor(16777215,.5),j.clear(),Me&&et.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Ee===!0&&Ze.setGlobalState(j.clippingPlanes,r),Ct(e,n,r),ze.updateMultisampleRenderTarget(a),ze.updateRenderTargetMipmap(a),Fe.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,wt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(ze.updateMultisampleRenderTarget(a),ze.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(he,ge),p!==void 0&&(r.viewport=p),j.toneMapping=f}function Ct(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&wt(o,t,n,s,l,c)}}function wt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function Tt(e,t,n){t.isScene!==!0&&(t=je);let r=L.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ge.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ge.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Be.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,dt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Dt(e,s),d}else s.uniforms=Ge.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,j),d=Ge.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ze.uniform),Dt(e,s),r.needsLights=Nt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Et(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Ys.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Dt(e,t){let n=L.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Ot(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function At(e,t,n,r,i){t.isScene!==!0&&(t=je),ze.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?j.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:vt.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Be.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=L.get(r),y=k.state.lights;if(Ee===!0&&(De===!0||e!==P)){let t=e===P&&r.id===de;Ze.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ze.numPlanes||v.numIntersection!==Ze.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Tt(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(I.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==de&&(de=r.id,C=!0),v.needsLights){let e=Ot(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||P!==e){I.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(F,`projectionMatrix`,e.projectionMatrix),T.setValue(F,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(F,ke.setFromMatrixPosition(e.matrixWorld)),Ie.logarithmicDepthBuffer&&T.setValue(F,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(F,`isOrthographic`,e.isOrthographicCamera===!0),P!==e&&(P=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(F,`directionalShadowMap`,y.state.directionalShadowMap,ze),y.state.spotShadowMap.length>0&&T.setValue(F,`spotShadowMap`,y.state.spotShadowMap,ze),y.state.pointShadowMap.length>0&&T.setValue(F,`pointShadowMap`,y.state.pointShadowMap,ze)),i.isSkinnedMesh){T.setOptional(F,i,`bindMatrix`),T.setOptional(F,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(F,`boneTexture`,e.boneTexture,ze))}i.isBatchedMesh&&(T.setOptional(F,i,`batchingTexture`),T.setValue(F,`batchingTexture`,i._matricesTexture,ze),T.setOptional(F,i,`batchingIdTexture`),T.setValue(F,`batchingIdTexture`,i._indirectTexture,ze),T.setOptional(F,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(F,`batchingColorTexture`,i._colorsTexture,ze));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&tt.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(F,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=gl()),C){if(T.setValue(F,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&Mt(E,w),a&&r.fog===!0&&Ke.refreshFogUniforms(E,a),Ke.refreshMaterialUniforms(E,r,ye,ve,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Ys.upload(F,Et(v),E,ze)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Ys.upload(F,Et(v),E,ze),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(F,`center`,i.center),T.setValue(F,`modelViewMatrix`,i.modelViewMatrix),T.setValue(F,`normalMatrix`,i.normalMatrix),T.setValue(F,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];ot.update(n,x),ot.bind(n,x)}}return x}function Mt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Nt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return le},this.getActiveMipmapLevel=function(){return ue},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=L.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),L.get(e.texture).__webglTexture=t,L.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=L.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){N=e,le=t,ue=n;let r=null,i=!1,a=!1;if(e){let o=L.get(e);if(o.__useDefaultFramebuffer!==void 0){I.bindFramebuffer(F.FRAMEBUFFER,o.__webglFramebuffer),fe.copy(e.viewport),pe.copy(e.scissor),me=e.scissorTest,I.viewport(fe),I.scissor(pe),I.setScissorTest(me),de=-1;return}else if(o.__webglFramebuffer===void 0)ze.setupRenderTarget(e);else if(o.__hasExternalTextures)ze.rebindTextures(e,L.get(e.texture).__webglTexture,L.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&L.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);ze.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=L.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&ze.useMultisampledRTT(e)===!1?L.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,fe.copy(e.viewport),pe.copy(e.scissor),me=e.scissorTest}else fe.copy(Se).multiplyScalar(ye).floor(),pe.copy(Ce).multiplyScalar(ye).floor(),me=we;if(n!==0&&(r=oe),I.bindFramebuffer(F.FRAMEBUFFER,r)&&I.drawBuffers(e,r),I.viewport(fe),I.scissor(pe),I.setScissorTest(me),i){let r=L.get(e.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=L.get(e.textures[t]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=L.get(e.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,t.__webglTexture,n)}de=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){I.bindFramebuffer(F.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+s),!Ie.textureFormatReadable(c)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ie.textureTypeReadable(l)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&F.readPixels(t,n,r,i,it.convert(c),it.convert(l),a)}finally{let e=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(F.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){I.bindFramebuffer(F.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+s),!Ie.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ie.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,d),F.bufferData(F.PIXEL_PACK_BUFFER,a.byteLength,F.STREAM_READ),F.readPixels(t,n,r,i,it.convert(l),it.convert(u),0);let f=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(F.FRAMEBUFFER,f);let p=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await $e(F,p,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,d),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,a),F.deleteBuffer(d),F.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;ze.setTexture2D(e,0),F.copyTexSubImage2D(F.TEXTURE_2D,n,0,0,o,s,i,a),I.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=it.convert(t.format),_=it.convert(t.type),v;t.isData3DTexture?(ze.setTexture3D(t,0),v=F.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(ze.setTexture2DArray(t,0),v=F.TEXTURE_2D_ARRAY):(ze.setTexture2D(t,0),v=F.TEXTURE_2D),I.activeTexture(F.TEXTURE0),I.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,t.flipY),I.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),I.pixelStorei(F.UNPACK_ALIGNMENT,t.unpackAlignment);let y=I.getParameter(F.UNPACK_ROW_LENGTH),b=I.getParameter(F.UNPACK_IMAGE_HEIGHT),x=I.getParameter(F.UNPACK_SKIP_PIXELS),S=I.getParameter(F.UNPACK_SKIP_ROWS),C=I.getParameter(F.UNPACK_SKIP_IMAGES);I.pixelStorei(F.UNPACK_ROW_LENGTH,h.width),I.pixelStorei(F.UNPACK_IMAGE_HEIGHT,h.height),I.pixelStorei(F.UNPACK_SKIP_PIXELS,l),I.pixelStorei(F.UNPACK_SKIP_ROWS,u),I.pixelStorei(F.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=L.get(e),r=L.get(t),h=L.get(n.__renderTarget),g=L.get(r.__renderTarget);I.bindFramebuffer(F.READ_FRAMEBUFFER,h.__webglFramebuffer),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,L.get(e).__webglTexture,i,d+n),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,L.get(t).__webglTexture,a,m+n)),F.blitFramebuffer(l,u,o,s,f,p,o,s,F.DEPTH_BUFFER_BIT,F.NEAREST);I.bindFramebuffer(F.READ_FRAMEBUFFER,null),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||L.has(e)){let n=L.get(e),r=L.get(t);I.bindFramebuffer(F.READ_FRAMEBUFFER,se),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,ce);for(let e=0;e<c;e++)w?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,n.__webglTexture,i),T?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,r.__webglTexture,a),i===0?T?F.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):F.copyTexSubImage2D(v,a,f,p,l,u,o,s):F.blitFramebuffer(l,u,o,s,f,p,o,s,F.COLOR_BUFFER_BIT,F.NEAREST);I.bindFramebuffer(F.READ_FRAMEBUFFER,null),I.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?F.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?F.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):F.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):F.texSubImage2D(F.TEXTURE_2D,a,f,p,o,s,g,_,h);I.pixelStorei(F.UNPACK_ROW_LENGTH,y),I.pixelStorei(F.UNPACK_IMAGE_HEIGHT,b),I.pixelStorei(F.UNPACK_SKIP_PIXELS,x),I.pixelStorei(F.UNPACK_SKIP_ROWS,S),I.pixelStorei(F.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&F.generateMipmap(v),I.unbindTexture()},this.initRenderTarget=function(e){L.get(e).__webglFramebuffer===void 0&&ze.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?ze.setTextureCube(e,0):e.isData3DTexture?ze.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?ze.setTexture2DArray(e,0):ze.setTexture2D(e,0),I.unbindTexture()},this.resetState=function(){le=0,ue=0,N=null,I.reset(),at.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return We}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=vt._getDrawingBufferColorSpace(e),t.unpackColorSpace=vt._getUnpackColorSpace()}},K={Air:0,Grass:1,Stone:2,Cobblestone:3,Sand:4,Dirt:5,Log:6,Planks:7,Brick:8,Gravel:9,Bedrock:10,WoolWhite:11,WoolBlack:12,WoolRed:13,WoolOrange:14,WoolYellow:15,WoolGreen:16,WoolBlue:17,WoolPurple:18,Sandstone:19,StoneBricks:20,Snow:21,Obsidian:22,WoolPink:23,WoolCyan:24,WoolGray:25,WoolBrown:26,Glass:27,Leaves:28,LetterA:29,LetterB:30,LetterC:31,LetterD:32,LetterE:33,LetterF:34,LetterG:35,LetterH:36,LetterI:37,LetterJ:38,LetterK:39,LetterL:40,LetterM:41,LetterN:42,LetterO:43,LetterP:44,LetterQ:45,LetterR:46,LetterS:47,LetterT:48,LetterU:49,LetterV:50,LetterW:51,LetterX:52,LetterY:53,LetterZ:54,Digit0:55,Digit1:56,Digit2:57,Digit3:58,Digit4:59,Digit5:60,Digit6:61,Digit7:62,Digit8:63,Digit9:64,Cerca:65,PortaXFechada:66,PortaXAberta:67,PortaZFechada:68,PortaZAberta:69,Tocha:70,TapeteBranco:71,TapetePreto:72,TapeteVermelho:73,TapeteLaranja:74,TapeteAmarelo:75,TapeteVerde:76,TapeteAzul:77,TapeteRoxo:78,TapeteRosa:79,TapeteCiano:80,TapeteCinza:81,TapeteMarrom:82,JanelaXFechada:83,JanelaXAberta:84,JanelaZFechada:85,JanelaZAberta:86,Mesa:87,CadeiraXP:88,CadeiraZP:89,CadeiraXN:90,CadeiraZN:91,SofaXP:92,SofaZP:93,SofaXN:94,SofaZN:95,CamaXP:96,CamaZP:97,CamaXN:98,CamaZN:99,QuadroXP:100,QuadroZP:101,QuadroXN:102,QuadroZN:103,FlorVermelha:104,FlorAmarela:105,FlorAzul:106,FlorBranca:107,PortaXFechadaR:108,PortaXAbertaR:109,PortaZFechadaR:110,PortaZAbertaR:111,JanelaXFechadaR:112,JanelaXAbertaR:113,JanelaZFechadaR:114,JanelaZAbertaR:115,MinerioCarvao:116,MinerioFerro:117,MinerioOuro:118,MinerioDiamante:119,GramaSeca:120,GramaFria:121,LogIpe:122,FolhasIpe:123,LogAraucaria:124,FolhasAraucaria:125,LogPauBrasil:126,FolhasPauBrasil:127,Mandacaru:128,Agua:129,AguaFluida1:130,AguaFluida2:131,AguaFluida3:132,AguaFluida4:133,AguaFluida5:134,AguaFluida6:135,AguaFluida7:136,VidroBranco:137,VidroPreto:138,VidroVermelho:139,VidroLaranja:140,VidroAmarelo:141,VidroVerde:142,VidroAzul:143,VidroRoxo:144,VidroRosa:145,VidroCiano:146,VidroCinza:147,VidroMarrom:148,LajePedraBaixo:149,LajePedraCima:150,LajeTabuaBaixo:151,LajeTabuaCima:152,LajeTijoloBaixo:153,LajeTijoloCima:154,EscadaPedraXP:155,EscadaPedraZP:156,EscadaPedraXN:157,EscadaPedraZN:158,EscadaPedraXPC:159,EscadaPedraZPC:160,EscadaPedraXNC:161,EscadaPedraZNC:162,EscadaTabuaXP:163,EscadaTabuaZP:164,EscadaTabuaXN:165,EscadaTabuaZN:166,EscadaTabuaXPC:167,EscadaTabuaZPC:168,EscadaTabuaXNC:169,EscadaTabuaZNC:170,EscadaTijoloXP:171,EscadaTijoloZP:172,EscadaTijoloXN:173,EscadaTijoloZN:174,EscadaTijoloXPC:175,EscadaTijoloZPC:176,EscadaTijoloXNC:177,EscadaTijoloZNC:178,GramaAlta:179,GramaAltaSeca:180,GramaAltaFria:181},vl=K.GramaAltaFria;function yl(e){return e>=K.Agua&&e<=K.AguaFluida7}function bl(e){return e===K.Agua}function xl(e){return e===K.Agua?8:e>=K.AguaFluida1&&e<=K.AguaFluida7?e-K.AguaFluida1+1:0}function Sl(e){return e>=8?K.Agua:e>=1?K.AguaFluida1+(e-1):K.Air}function Cl(e){return e===900||e===901}function wl(e){return e>=K.FlorVermelha&&e<=K.FlorBranca}function Tl(e){return e>=K.GramaAlta&&e<=K.GramaAltaFria}function El(e){return e===K.Leaves||e===K.FolhasIpe||e===K.FolhasAraucaria||e===K.FolhasPauBrasil}function Dl(e){return e>=K.VidroBranco&&e<=K.VidroMarrom}function Ol(e){return e>=K.LajePedraBaixo&&e<=K.LajeTijoloCima}function kl(e){return(e-K.LajePedraBaixo&1)==1}function Al(e){return e-K.LajePedraBaixo>>1}function jl(e){return e>=K.EscadaPedraXP&&e<=K.EscadaTijoloZNC}function Ml(e){return(e-K.EscadaPedraXP)%4}function Nl(e){return(e-K.EscadaPedraXP)%8>=4}function Pl(e){return(e-K.EscadaPedraXP)/8|0}function Fl(e,t,n){return K.EscadaPedraXP+e*8+(n?4:0)+(t&3)}function Il(e){switch(e&3){case 1:return[0,.5,1,1];case 2:return[0,0,.5,1];case 3:return[0,0,1,.5];default:return[.5,0,1,1]}}function Ll(e){if(Ol(e))return kl(e)?[[0,.5,0,1,1,1]]:[[0,0,0,1,.5,1]];if(jl(e)){let[t,n,r,i]=Il(Ml(e));return Nl(e)?[[0,.5,0,1,1,1],[t,0,n,r,.5,i]]:[[0,0,0,1,.5,1],[t,.5,n,r,1,i]]}return[[0,0,0,1,1,1]]}function Rl(e){return e>=K.QuadroXP&&e<=K.QuadroZN}function zl(e){return e>=K.CadeiraXP&&e<=K.CadeiraZN}function Bl(e){return e>=K.SofaXP&&e<=K.SofaZN}function Vl(e){return e>=K.CamaXP&&e<=K.CamaZN}function Hl(e){switch(e-K.CamaXP){case 0:return{dx:-1,dz:0};case 1:return{dx:0,dz:-1};case 2:return{dx:1,dz:0};default:return{dx:0,dz:1}}}function Ul(e){return e>=K.Mesa&&e<=K.CamaZN}function Wl(e){return e>=K.TapeteBranco&&e<=K.TapeteMarrom}function Gl(e){return e===K.Glass||e===K.Leaves||e===K.FolhasIpe||e===K.FolhasAraucaria||e===K.FolhasPauBrasil||yl(e)||Dl(e)}function Kl(e){return e>=K.PortaXFechada&&e<=K.PortaZAberta||e>=K.PortaXFechadaR&&e<=K.PortaZAbertaR}function ql(e){return e===K.PortaXAberta||e===K.PortaZAberta||e===K.PortaXAbertaR||e===K.PortaZAbertaR}function Jl(e){return e===K.PortaXFechada||e===K.PortaXAberta||e===K.PortaXFechadaR||e===K.PortaXAbertaR}function Yl(e){return e>=K.PortaXFechadaR&&e<=K.PortaZAbertaR}K.PortaXFechadaR-K.PortaXFechada;function Xl(e){return e>=K.JanelaXFechada&&e<=K.JanelaZAberta||e>=K.JanelaXFechadaR&&e<=K.JanelaZAbertaR}function Zl(e){return e===K.JanelaXAberta||e===K.JanelaZAberta||e===K.JanelaXAbertaR||e===K.JanelaZAbertaR}function Ql(e){return e===K.JanelaXFechada||e===K.JanelaXAberta||e===K.JanelaXFechadaR||e===K.JanelaXAbertaR}function $l(e){return e>=K.JanelaXFechadaR&&e<=K.JanelaZAbertaR}K.JanelaXFechadaR-K.JanelaXFechada;function eu(e){return Kl(e)||Xl(e)}function tu(e){return e!==K.Air&&!(e>=K.Cerca&&e<=K.Tocha)&&!Kl(e)&&!Wl(e)&&!Xl(e)&&!Ul(e)&&!Rl(e)&&!wl(e)&&!Tl(e)&&!Ol(e)&&!jl(e)}function nu(e){return e!==K.Air&&!ql(e)&&!Zl(e)&&e!==K.Tocha&&!Wl(e)&&!Rl(e)&&!wl(e)&&!Tl(e)&&!yl(e)}function ru(e){return ql(e)||Zl(e)||yl(e)?!1:Number.isInteger(e)&&e>=K.Grass&&e<=vl}function iu(e){return e===K.Bedrock}var au={caatinga:{nome:`caatinga`,topo:K.Sand,subsolo:K.Sandstone,profundidadeSubsolo:3,arvores:[],flores:0,gramaAlta:0,mandacaru:1/16},cerrado:{nome:`cerrado`,topo:`grama`,subsolo:K.Dirt,profundidadeSubsolo:3,arvores:[[`ipe`,1/160]],flores:1/64,gramaAlta:1/6,mandacaru:0},mata:{nome:`mata`,topo:`grama`,subsolo:K.Dirt,profundidadeSubsolo:3,arvores:[[`comum`,1/28],[`paubrasil`,1/80]],flores:1/48,gramaAlta:1/10,mandacaru:0},araucarias:{nome:`araucárias`,topo:`grama`,subsolo:K.Dirt,profundidadeSubsolo:3,arvores:[[`araucaria`,1/48]],flores:1/128,gramaAlta:1/12,mandacaru:0}};function ou(e){return e.temp<.35?au.araucarias:e.temp>.65&&e.umid<.4?au.caatinga:e.umid>.55?au.mata:au.cerrado}function su(e){return e.temp<.42?K.GramaFria:e.temp>.58&&e.umid<.5?K.GramaSeca:K.Grass}var cu=16**3,lu={x:16,z:16,y:8},uu=1200;function du(e,t=!0){let n=e.x*e.y*e.z,r=Array(n);if(t)for(let e=0;e<n;e++)r[e]=new Uint8Array(cu);return{dims:e,sizeX:e.x*16,sizeY:e.y*16,sizeZ:e.z*16,chunks:r}}function fu(e,t,n){for(let r=0;r<e.dims.y;r++){let i=pu(e,t,r,n);e.chunks[i]||(e.chunks[i]=new Uint8Array(cu))}}function pu(e,t,n,r){return(n*e.dims.z+r)*e.dims.x+t}function mu(e,t,n){return(t*16+n)*16+e}function hu(e,t,n,r){return t>=0&&n>=0&&r>=0&&t<e.sizeX&&n<e.sizeY&&r<e.sizeZ}function gu(e,t,n,r){if(!hu(e,t,n,r))return K.Air;let i=t/16|0,a=n/16|0,o=r/16|0,s=e.chunks[pu(e,i,a,o)];return s?s[mu(t-i*16,n-a*16,r-o*16)]??K.Air:K.Air}function _u(e,t,n,r,i){if(!hu(e,t,n,r))return;let a=t/16|0,o=n/16|0,s=r/16|0,c=e.chunks[pu(e,a,o,s)];c&&(c[mu(t-a*16,n-o*16,r-s*16)]=i)}function vu(e,t,n){for(let r=e.sizeY-1;r>=0;r--)if(gu(e,t,r,n)!==K.Air)return r+1;return 1}K.Log,K.LogIpe,K.LogAraucaria,K.LogPauBrasil,K.Leaves,K.FolhasIpe,K.FolhasAraucaria,K.FolhasPauBrasil;function yu(e){return[...e.trim()].filter(e=>/[\p{L}\p{N}\p{M}_-]/u.test(e)).join(``).slice(0,24)||`jogador`}function bu(e){return{x:e.max.x-e.min.x+1,y:e.max.y-e.min.y+1,z:e.max.z-e.min.z+1}}function xu(e){if(typeof e!=`object`||!e)return null;let t=e;return[t.x,t.y,t.z].every(e=>typeof e==`number`&&Number.isInteger(e))?{x:t.x,y:t.y,z:t.z}:null}function Su(e){if(typeof e!=`object`||!e)return null;let t=e,n=t.nome;if(typeof n!=`string`||!n||n.length>24)return null;let r=xu(t.min),i=xu(t.max);return!r||!i||r.x>i.x||r.y>i.y||r.z>i.z?null:{nome:n,min:r,max:i}}function Cu(e){if(typeof e!=`object`||!e)return null;let t=e,n=t.dono;if(typeof n!=`string`||!n)return null;let r=xu(t.min),i=xu(t.max);if(!r||!i||r.x>i.x||r.y>i.y||r.z>i.z)return null;let a={dono:n,min:r,max:i},o=t.nome;return typeof o==`string`&&o&&o.length<=24&&(a.nome=o),a}function wu(e){if(typeof e!=`object`||!e)return null;let t=e,n=t.dono;if(typeof n!=`string`||!n)return null;let r=[];if(Array.isArray(t.membros))for(let e of t.membros)typeof e==`string`&&e&&e!==n&&!r.includes(e)&&r.push(e);return{dono:n,membros:r.slice(0,5)}}function Tu(e){if(!Array.isArray(e))return[];let t=[];for(let n of e){if(typeof n!=`object`||!n)continue;let e=n,r=e.id;if(typeof r!=`number`||!Number.isInteger(r)||r<1||r>20)continue;let i=Array.isArray(e.membros)?e.membros.filter(e=>typeof e==`string`&&e.length>0):[];t.push({id:r,membros:i})}return t}function Eu(e){return e===`plano`||e===`cabines`?e:`normal`}function Du(e){return e===`M`||e===`G`||e===`E`?e:`P`}function Ou(e,t,n){let r=n^Math.imul(e,374761393)^Math.imul(t,668265263);return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function ku(e){return e*e*(3-2*e)}function Au(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=ku(e-r),o=ku(t-i),s=Ou(r,i,n),c=Ou(r+1,i,n),l=Ou(r,i+1,n),u=Ou(r+1,i+1,n),d=s+(c-s)*a;return d+(l+(u-l)*a-d)*o}function ju(e,t,n,r=128){let i=Au(e/24,t/24,n),a=Au(e/7,t/7,n^2654435769),o=16+i*12+a*4;if(r<128)return Math.floor(o);let s=Au(e/90,t/90,n^6191009),c=ku(Math.min(1,Math.max(0,(s-.52)/.3))),l=Au(e/28,t/28,n^9516923);return Math.floor(o+c*(28+l*60))}function Mu(e,t,n){return{temp:Au(e/80,t/80,n^1375183809),umid:Au(e/80,t/80,n^731782471)}}K.MinerioCarvao,K.MinerioFerro,K.MinerioOuro,K.MinerioDiamante,K.StoneBricks;var Nu=Math.PI*2,Pu=[[-3,0],[-2,-2],[0,-3],[2,-2],[3,0],[2,2],[0,3],[-2,2]];function Fu(e,t){return e===0&&t===0?0:(Math.round(Math.atan2(t,e)/(Nu/8))+8)%8}function Iu(e){let t=(e%Nu+Nu)%Nu/(Nu/8)%8,n=Math.floor(t)%8;return{a:Pu[n],b:Pu[(n+1)%8],mistura:t-Math.floor(t)}}var q={tilesPerRow:16,tilePx:16},J={grassTop:0,grassSide:1,dirt:2,stone:3,cobblestone:4,sand:5,logTop:6,logSide:7,planks:8,brick:9,gravel:10,bedrock:11,woolWhite:12,woolBlack:13,woolRed:14,woolOrange:15,woolYellow:16,woolGreen:17,woolBlue:18,woolPurple:19,sandstone:20,stoneBricks:21,snow:22,obsidian:23,woolPink:24,woolCyan:25,woolGray:26,woolBrown:27,glass:28,leaves:29,cerca:66,portaBaixo:67,portaCima:68,tocha:69,janela:70,estofado:71,colchao:72,quadro:73,florVermelha:74,florAmarela:75,florAzul:76,florBranca:77,minerioCarvao:78,minerioFerro:79,minerioOuro:80,minerioDiamante:81,gramaSecaTop:82,gramaSecaSide:83,gramaFriaTop:84,gramaFriaSide:85,logIpe:86,folhasIpe:87,logAraucaria:88,folhasAraucaria:89,logPauBrasil:90,folhasPauBrasil:91,mandacaruSide:92,mandacaruTop:93,agua:94,vidroBranco:95,vidroPreto:96,vidroVermelho:97,vidroLaranja:98,vidroAmarelo:99,vidroVerde:100,vidroAzul:101,vidroRoxo:102,vidroRosa:103,vidroCiano:104,vidroCinza:105,vidroMarrom:106,gramaAlta:107,gramaAltaSeca:108,gramaAltaFria:109,aguaFluxo:112},Lu={base:30,letters:`ABCDEFGHIJKLMNOPQRSTUVWXYZ`,digits:`0123456789`},Y=e=>({top:e,bottom:e,side:e}),Ru={[K.Grass]:{top:J.grassTop,bottom:J.dirt,side:J.grassSide},[K.Stone]:Y(J.stone),[K.Cobblestone]:Y(J.cobblestone),[K.Sand]:Y(J.sand),[K.Dirt]:Y(J.dirt),[K.Log]:{top:J.logTop,bottom:J.logTop,side:J.logSide},[K.Planks]:Y(J.planks),[K.Brick]:Y(J.brick),[K.Gravel]:Y(J.gravel),[K.Bedrock]:Y(J.bedrock),[K.WoolWhite]:Y(J.woolWhite),[K.WoolBlack]:Y(J.woolBlack),[K.WoolRed]:Y(J.woolRed),[K.WoolOrange]:Y(J.woolOrange),[K.WoolYellow]:Y(J.woolYellow),[K.WoolGreen]:Y(J.woolGreen),[K.WoolBlue]:Y(J.woolBlue),[K.WoolPurple]:Y(J.woolPurple),[K.Sandstone]:Y(J.sandstone),[K.StoneBricks]:Y(J.stoneBricks),[K.Snow]:Y(J.snow),[K.Obsidian]:Y(J.obsidian),[K.WoolPink]:Y(J.woolPink),[K.WoolCyan]:Y(J.woolCyan),[K.WoolGray]:Y(J.woolGray),[K.WoolBrown]:Y(J.woolBrown),[K.Glass]:Y(J.glass),[K.Leaves]:Y(J.leaves),[K.Cerca]:Y(J.cerca),[K.PortaXFechada]:Y(J.portaCima),[K.PortaXAberta]:Y(J.portaCima),[K.PortaZFechada]:Y(J.portaCima),[K.PortaZAberta]:Y(J.portaCima),[K.PortaXFechadaR]:Y(J.portaCima),[K.PortaXAbertaR]:Y(J.portaCima),[K.PortaZFechadaR]:Y(J.portaCima),[K.PortaZAbertaR]:Y(J.portaCima),[K.Tocha]:Y(J.tocha),[K.JanelaXFechada]:Y(J.janela),[K.JanelaXAberta]:Y(J.janela),[K.JanelaZFechada]:Y(J.janela),[K.JanelaZAberta]:Y(J.janela),[K.JanelaXFechadaR]:Y(J.janela),[K.JanelaXAbertaR]:Y(J.janela),[K.JanelaZFechadaR]:Y(J.janela),[K.JanelaZAbertaR]:Y(J.janela),[K.Mesa]:Y(J.planks),[K.MinerioCarvao]:Y(J.minerioCarvao),[K.MinerioFerro]:Y(J.minerioFerro),[K.MinerioOuro]:Y(J.minerioOuro),[K.MinerioDiamante]:Y(J.minerioDiamante),[K.GramaSeca]:{top:J.gramaSecaTop,bottom:J.dirt,side:J.gramaSecaSide},[K.GramaFria]:{top:J.gramaFriaTop,bottom:J.dirt,side:J.gramaFriaSide},[K.LogIpe]:{top:J.logTop,bottom:J.logTop,side:J.logIpe},[K.FolhasIpe]:Y(J.folhasIpe),[K.LogAraucaria]:{top:J.logTop,bottom:J.logTop,side:J.logAraucaria},[K.FolhasAraucaria]:Y(J.folhasAraucaria),[K.LogPauBrasil]:{top:J.logTop,bottom:J.logTop,side:J.logPauBrasil},[K.FolhasPauBrasil]:Y(J.folhasPauBrasil),[K.Mandacaru]:{top:J.mandacaruTop,bottom:J.mandacaruTop,side:J.mandacaruSide},[K.Agua]:Y(J.agua)};for(let e=K.AguaFluida1;e<=K.AguaFluida7;e++)Ru[e]=Y(J.agua);for(let e=0;e<12;e++)Ru[K.VidroBranco+e]=Y(J.vidroBranco+e);var zu=[J.stone,J.planks,J.brick];for(let e=K.LajePedraBaixo;e<=K.LajeTijoloCima;e++)Ru[e]=Y(zu[Al(e)]);for(let e=K.EscadaPedraXP;e<=K.EscadaTijoloZNC;e++)Ru[e]=Y(zu[Pl(e)]);for(let e=0;e<4;e++)Ru[K.CadeiraXP+e]=Y(J.planks),Ru[K.SofaXP+e]=Y(J.estofado),Ru[K.CamaXP+e]=Y(J.colchao),Ru[K.QuadroXP+e]=Y(J.quadro);for(let e=0;e<4;e++)Ru[K.FlorVermelha+e]=Y(J.florVermelha+e);for(let e=0;e<3;e++)Ru[K.GramaAlta+e]=Y(J.gramaAlta+e);for(let e=0;e<Lu.letters.length;e++)Ru[K.LetterA+e]=Y(Lu.base+e);for(let e=0;e<Lu.digits.length;e++)Ru[K.Digit0+e]=Y(Lu.base+Lu.letters.length+e);var Bu=[J.woolWhite,J.woolBlack,J.woolRed,J.woolOrange,J.woolYellow,J.woolGreen,J.woolBlue,J.woolPurple,J.woolPink,J.woolCyan,J.woolGray,J.woolBrown];for(let e=0;e<Bu.length;e++)Ru[K.TapeteBranco+e]=Y(Bu[e]);function Vu(e){return Ru[e]?.side??J.stone}function Hu(e){if(wl(e)||Tl(e))return[4*X,0,4*X,12*X,1,12*X];if(Wl(e))return[0,0,0,1,X,1];if(e===K.Tocha)return[7*X,0,7*X,9*X,10*X,9*X];if(e===K.Cerca)return[6*X,0,6*X,10*X,1,10*X];if(Kl(e)){if(!ql(e))return Jl(e)?[0,0,0,2*X,1,1]:[0,0,0,1,1,2*X];let t=Yl(e)?1-2*X:0;return Jl(e)?[0,0,t,1,1,t+2*X]:[t,0,0,t+2*X,1,1]}if(Xl(e)){if(!Zl(e))return Ql(e)?[0,0,0,2*X,1,1]:[0,0,0,1,1,2*X];let t=$l(e)?1-2*X:0;return Ql(e)?[0,0,t,1,1,t+2*X]:[t,0,0,t+2*X,1,1]}if(Rl(e)){let[t,n,r,i]=Xu(0,1*X,2*X,15*X,e-K.QuadroXP);return[Math.min(t,r),1*X,Math.min(n,i),Math.max(t,r),15*X,Math.max(n,i)]}return e===K.Mesa?[0,0,0,1,14*X,1]:zl(e)?[3*X,0,3*X,13*X,1,13*X]:Bl(e)?[0,0,0,1,15*X,1]:Vl(e)?[0,0,0,1,9*X,1]:Ol(e)?Ll(e)[0]:(jl(e),[0,0,0,1,1,1])}var Uu=[{dir:[-1,0,0],corners:[{pos:[0,1,0],uv:[0,1]},{pos:[0,0,0],uv:[0,0]},{pos:[0,1,1],uv:[1,1]},{pos:[0,0,1],uv:[1,0]}]},{dir:[1,0,0],corners:[{pos:[1,1,1],uv:[0,1]},{pos:[1,0,1],uv:[0,0]},{pos:[1,1,0],uv:[1,1]},{pos:[1,0,0],uv:[1,0]}]},{dir:[0,-1,0],corners:[{pos:[1,0,1],uv:[1,0]},{pos:[0,0,1],uv:[0,0]},{pos:[1,0,0],uv:[1,1]},{pos:[0,0,0],uv:[0,1]}]},{dir:[0,1,0],corners:[{pos:[0,1,1],uv:[1,1]},{pos:[1,1,1],uv:[0,1]},{pos:[0,1,0],uv:[1,0]},{pos:[1,1,0],uv:[0,0]}]},{dir:[0,0,-1],corners:[{pos:[1,0,0],uv:[0,0]},{pos:[0,0,0],uv:[1,0]},{pos:[1,1,0],uv:[0,1]},{pos:[0,1,0],uv:[1,1]}]},{dir:[0,0,1],corners:[{pos:[0,0,1],uv:[0,0]},{pos:[1,0,1],uv:[1,0]},{pos:[0,1,1],uv:[0,1]},{pos:[1,1,1],uv:[1,1]}]}];function Wu(e,t){for(let n of[0,1,2])if(e.pos[n]!==t.pos[n])return{axis:n,flip:e.pos[n]===1};return{axis:0,flip:!1}}var Gu=Uu.map(e=>{let t=(t,n)=>e.corners.find(e=>e.uv[0]===t&&e.uv[1]===n)??e.corners[0],n=t(0,0).pos,r=t(1,0).pos,i=t(0,1).pos,a=(e,t)=>[e[0]-t[0],e[1]-t[1],e[2]-t[2]];return{dir:e.dir,du:a(r,n),dv:a(i,n)}}),Ku=Uu.map(e=>{let t=(t,n)=>e.corners.find(e=>e.uv[0]===t&&e.uv[1]===n)??e.corners[0];return{u:Wu(t(0,0),t(1,0)),v:Wu(t(0,0),t(0,1))}}),X=1/16,qu=[[1,0],[-1,0],[0,1],[0,-1]];function Ju(e,t,n,r){let i=Gu[e];if(!i||t===0&&n===0)return J.agua;let a=i.dv[1]!==0,o=t*i.du[0]+n*i.du[2],s=t*i.dv[0]+n*i.dv[2];return a&&(r||o===0)&&(o=0,s=-1),o===0&&s===0?J.agua:J.aguaFluxo+Fu(-o,s)}var Yu=.875;function Xu(e,t,n,r,i){for(let a=0;a<i;a++){let i=1-r,a=n,o=1-t,s=e;e=i,t=s,n=o,r=a}return[e,t,n,r]}var Zu=.34;function Qu(e){return El(e)?Zu:wl(e)||Tl(e)?1:0}var $u=18,ed=$u*$u*$u;function td(e,t,n){return((t+1)*$u+(n+1))*$u+(e+1)}var nd=()=>({positions:new Float32Array,normals:new Float32Array,uvs:new Float32Array,sway:new Uint8Array,indices:new Uint32Array,opaqueIndexCount:0,aguaIndexCount:0});function rd(e,t,n,r){let i=e.chunks[pu(e,t,n,r)];if(!i||i.every(e=>e===0))return null;let a=new Uint8Array(ed);for(let e=0;e<16;e++)for(let t=0;t<16;t++){let n=(e*16+t)*16;a.set(i.subarray(n,n+16),td(0,e,t))}let o=t*16,s=n*16,c=r*16;for(let t=-1;t<=16;t++){let n=t>=0&&t<16;for(let r=-1;r<=16;r++){let i=n&&r>=0&&r<16;for(let n=-1;n<=16;n++)i&&n===0&&(n=16),a[td(n,t,r)]=gu(e,o+n,s+t,c+r)}}return a}function id(e,t,n,r){let i=rd(e,t,n,r);return i?ad(i):nd()}function ad(e){let t=(t,n,r)=>e[td(t,n,r)]??K.Air,n=[],r=[],i=[],a=[],o=[],s=0,c=e=>{for(let t=0;t<e;t++)o.push(s)},l=[],u=[],d=q.tilesPerRow,f=.5/(d*q.tilePx),p=(e,o,s,l,u,p,m,h,g,_,v)=>{let y=u%d,b=u/d|0,x=[p,m,h],S=[g,_,v];for(let u=0;u<Uu.length;u++){let C=Uu[u],w=Ku[u];if(!C||!w)continue;if(C.dir[0]===-1?p===0:C.dir[0]===1?g===1:C.dir[1]===-1?m===0:C.dir[1]===1?_===1:C.dir[2]===-1?h===0:v===1){let n=t(e+C.dir[0],o+C.dir[1],s+C.dir[2]);if(n===l||tu(n)&&!Gl(n))continue}let T=n.length/3;for(let t of C.corners){let a=t.pos[0]===0?p:g,c=t.pos[1]===0?m:_,l=t.pos[2]===0?h:v;n.push(e+a,o+c,s+l),r.push(C.dir[0],C.dir[1],C.dir[2]);let u=(e,t)=>{let n=t===0?e.flip?S[e.axis]:x[e.axis]:e.flip?x[e.axis]:S[e.axis];return e.flip?1-n:n},T=u(w.u,t.uv[0]),E=u(w.v,t.uv[1]);i.push(y/d+f+T*(1/d-2*f),1-(b+1)/d+f+E*(1/d-2*f))}c(4),a.push(T,T+1,T+2,T+2,T+1,T+3)}},m=(e,t,c,l,u,p,m,h)=>{let g=l%d,_=l/d|0,v=g/d+f,y=(g+1)/d-f,b=1-(_+1)/d+f,x=1-_/d-f,S=[[e+u,t,c+p],[e+m,t,c+h],[e+m,t+1,c+h],[e+u,t+1,c+p]],C=[v,y,y,v],w=[b,b,x,x],T=h-p,E=-(m-u),D=Math.hypot(T,E)||1;T/=D,E/=D;for(let e of[1,-1]){let t=n.length/3;for(let t=0;t<4;t++){let a=S[t];n.push(a[0],a[1],a[2]),r.push(T*e,0,E*e),i.push(C[t],w[t]),o.push(t>=2?s:0)}e>0?a.push(t,t+1,t+2,t,t+2,t+3):a.push(t,t+2,t+1,t,t+3,t+2)}},h=(e,n,r)=>{let i=t(e,n,r);return i===K.Cerca||tu(i)},g=(e,n,r,i)=>{switch(e){case K.Cerca:{p(n,r,i,e,J.cerca,6*X,0,6*X,10*X,1,10*X);let t=(t,a,o,s)=>{p(n,r,i,e,J.cerca,t,12*X,a,o,15*X,s),p(n,r,i,e,J.cerca,t,6*X,a,o,9*X,s)};return h(n-1,r,i)&&t(0,7*X,6*X,9*X),h(n+1,r,i)&&t(10*X,7*X,1,9*X),h(n,r,i-1)&&t(7*X,0,9*X,6*X),h(n,r,i+1)&&t(7*X,10*X,9*X,1),!0}case K.PortaXFechada:case K.PortaXAberta:case K.PortaZFechada:case K.PortaZAberta:case K.PortaXFechadaR:case K.PortaXAbertaR:case K.PortaZFechadaR:case K.PortaZAbertaR:{let a=t(n,r-1,i)===e?J.portaCima:J.portaBaixo,o=Jl(e);if(!ql(e))o?p(n,r,i,e,a,0,0,0,2*X,1,1):p(n,r,i,e,a,0,0,0,1,1,2*X);else{let t=Yl(e)?1-2*X:0;o?p(n,r,i,e,a,0,0,t,1,1,t+2*X):p(n,r,i,e,a,t,0,0,t+2*X,1,1)}return!0}case K.Tocha:return p(n,r,i,e,J.tocha,7*X,0,7*X,9*X,10*X,9*X),!0;case K.JanelaXFechada:case K.JanelaXAberta:case K.JanelaZFechada:case K.JanelaZAberta:case K.JanelaXFechadaR:case K.JanelaXAbertaR:case K.JanelaZFechadaR:case K.JanelaZAbertaR:{let t=Ql(e);if(!Zl(e))t?p(n,r,i,e,J.janela,0,0,0,2*X,1,1):p(n,r,i,e,J.janela,0,0,0,1,1,2*X);else{let a=$l(e)?1-2*X:0;t?p(n,r,i,e,J.janela,0,0,a,1,1,a+2*X):p(n,r,i,e,J.janela,a,0,0,a+2*X,1,1)}return!0}case K.Mesa:p(n,r,i,e,J.planks,0,12*X,0,1,14*X,1);for(let[t,a]of[[1,1],[13,1],[1,13],[13,13]])p(n,r,i,e,J.planks,t*X,0,a*X,(t+2)*X,12*X,(a+2)*X);return!0;default:if(Ol(e)||jl(e)){let t=zu[Ol(e)?Al(e):Pl(e)];for(let[a,o,s,c,l,u]of Ll(e))p(n,r,i,e,t,a,o,s,c,l,u);return!0}if(Rl(e)){let[t,a,o,s]=Xu(0,1*X,2*X,15*X,e-K.QuadroXP);return p(n,r,i,e,J.quadro,t,1*X,a,o,15*X,s),!0}if(wl(e)){let t=J.florVermelha+(e-K.FlorVermelha);return m(n,r,i,t,0,0,1,1),m(n,r,i,t,0,1,1,0),!0}if(Tl(e)){let t=J.gramaAlta+(e-K.GramaAlta);return m(n,r,i,t,0,0,1,1),m(n,r,i,t,0,1,1,0),!0}if(Vl(e)){let a=e-K.CamaXP,{dx:o,dz:s}=Hl(e),c=t(n+o,r,i+s)===e?[[J.planks,0,0,0,1,3*X,1],[J.colchao,0,3*X,1*X,1,7*X,15*X]]:[[J.planks,0,0,0,1,3*X,1],[J.colchao,0,3*X,1*X,1,7*X,15*X],[J.woolWhite,1*X,7*X,3*X,6*X,9*X,13*X]];for(let[t,o,s,l,u,d,f]of c){let[c,m,h,g]=Xu(o,l,u,f,a);p(n,r,i,e,t,c,s,m,h,d,g)}return!0}if(zl(e)||Bl(e)){let t=zl(e)?e-K.CadeiraXP:e-K.SofaXP,a=zl(e)?[[J.planks,3*X,6*X,3*X,13*X,8*X,13*X],[J.planks,3*X,0,3*X,5*X,6*X,5*X],[J.planks,11*X,0,3*X,13*X,6*X,5*X],[J.planks,3*X,0,11*X,5*X,6*X,13*X],[J.planks,11*X,0,11*X,13*X,6*X,13*X],[J.planks,3*X,8*X,3*X,5*X,1,13*X]]:[[J.estofado,0,0,0,1,8*X,1],[J.estofado,0,8*X,0,4*X,15*X,1],[J.estofado,4*X,8*X,0,1,12*X,2*X],[J.estofado,4*X,8*X,14*X,1,12*X,1]];for(let[o,s,c,l,u,d,f]of a){let[a,m,h,g]=Xu(s,l,u,f,t);p(n,r,i,e,o,a,c,m,h,d,g)}return!0}return Wl(e)?(p(n,r,i,e,Bu[e-K.TapeteBranco],0,0,0,1,X,1),!0):!1}},_=(e,n,r,i,a)=>{let o=0,s=0;for(let c=0;c<2;c++)for(let l=0;l<2;l++){let u=e+i-1+c,d=r+a-1+l,f=t(u,n,d);if(yl(f)){if(yl(t(u,n+1,d)))return 1;o+=xl(f),s++}}return s===0?Yu:o/s/8*Yu},v=(e,n,r,i)=>{let a=xl(i),o=0,s=0;for(let[i,c]of qu){let l=t(e+i,n,r+c);if(!yl(l))continue;let u=a-xl(l);u<=0||(o+=i*u,s+=c*u)}return[o,s]};for(let e=0;e<16;e++)for(let o=0;o<16;o++)for(let p=0;p<16;p++){let m=t(p,e,o);if(m===K.Air)continue;if(s=Qu(m),!tu(m)){g(m,p,e,o);continue}let h=Ru[m];if(!h)continue;let y=yl(m)?l:Dl(m)?u:a,b=yl(m)?[[_(p,e,o,0,0),_(p,e,o,0,1)],[_(p,e,o,1,0),_(p,e,o,1,1)]]:null,x=b?v(p,e,o,m):null,S=x!==null&&t(p,e-1,o)===K.Air;for(let a=0;a<Uu.length;a++){let s=Uu[a],l=t(p+s.dir[0],e+s.dir[1],o+s.dir[2]);if(l!==K.Air&&tu(l)&&(yl(m)&&yl(l)||!Gl(l)||l===m))continue;let u=x?Ju(a,x[0],x[1],S):s.dir[1]===1?h.top:s.dir[1]===-1?h.bottom:h.side,g=u%d,_=u/d|0,v=g/d+f,C=(g+1)/d-f,w=1-(_+1)/d+f,T=1-_/d-f,E=n.length/3;for(let t of s.corners){let a=b&&t.pos[1]===1?b[t.pos[0]]?.[t.pos[2]]??1:t.pos[1];n.push(p+t.pos[0],e+a,o+t.pos[2]),r.push(s.dir[0],s.dir[1],s.dir[2]),i.push(t.uv[0]===1?C:v,t.uv[1]===1?T:w)}c(4),y.push(E,E+1,E+2,E+2,E+1,E+3)}}let y=l.length||u.length?a.concat(l,u):a;return{sway:new Uint8Array(o.map(e=>Math.round(e*255))),positions:new Float32Array(n),normals:new Float32Array(r),uvs:new Float32Array(i),indices:new Uint32Array(y),opaqueIndexCount:a.length,aguaIndexCount:l.length}}var Z={width:.6,height:1.8,eyeHeight:1.62,sneakEyeHeight:1.32,walkSpeed:4.3,sprintFactor:1.6,sneakFactor:.3,jumpSpeed:8.4,gravity:25,terminalVelocity:40,flySpeed:9,flyVertSpeed:7,waterFactor:.5,waterGravity:8,swimSpeed:4,waterJumpSpeed:7.5,waterSinkMax:3},od=.001,sd=.4,cd=.55;function ld(e){return Ol(e)||jl(e)}function ud(e,t,n){return{pos:{x:e,y:t,z:n},vel:{x:0,y:0,z:0},onGround:!1,sprinting:!1}}function dd(e,t){let n=Z.width/2,r=t.x-n,i=t.x+n,a=t.y,o=t.y+Z.height,s=t.z-n,c=t.z+n,l=Math.floor(r),u=Math.floor(i),d=Math.floor(a),f=Math.floor(o),p=Math.floor(s),m=Math.floor(c);for(let t=d;t<=f;t++)for(let n=p;n<=m;n++)for(let d=l;d<=u;d++){let l=gu(e,d,t,n);if(nu(l)){if(!ld(l))return!0;for(let e of Ll(l))if(i>d+e[0]&&r<d+e[3]&&o>t+e[1]&&a<t+e[4]&&c>n+e[2]&&s<n+e[5])return!0}}return!1}var fd=[[0,0,0,1,1,1]];function pd(e,t,n){let r=Z.width/2,i=t.x-r,a=t.x+r,o=t.z-r,s=t.z+r,c=Math.floor(i),l=Math.floor(a),u=Math.floor(o),d=Math.floor(s),f=Math.floor(t.y)-1,p=Math.floor(t.y+Z.height)+1,m=t.y,h=t.y+Z.height,g=NaN;for(let t=f;t<=p;t++)for(let r=u;r<=d;r++)for(let u=c;u<=l;u++){let c=gu(e,u,t,r);if(!nu(c))continue;let l=ld(c)?Ll(c):fd;for(let e of l){if(a<=u+e[0]||i>=u+e[3]||s<=r+e[2]||o>=r+e[5])continue;let c=t+e[1],l=t+e[4];n<0?c<=m+od&&(Number.isNaN(g)||l>g)&&(g=l):l>=h-od&&(Number.isNaN(g)||c<g)&&(g=c)}}return g}function md(e,t,n,r){let i=Z.width/2,a=n===`x`,o=a?0:2,s=a?3:5,c=a?2:0,l=a?5:3,u=t[n]-i,d=t[n]+i,f=a?t.z:t.x,p=f-i,m=f+i,h=t.y,g=t.y+Z.height,_=Math.floor(u),v=Math.floor(d),y=Math.floor(p),b=Math.floor(m),x=Math.floor(h),S=Math.floor(g),C=NaN;for(let t=x;t<=S;t++)for(let n=y;n<=b;n++)for(let i=_;i<=v;i++){let f=gu(e,a?i:n,t,a?n:i);if(!nu(f))continue;let _=ld(f)?Ll(f):fd;for(let e of _)if(!(g<=t+e[1]||h>=t+e[4])&&!(m<=n+e[c]||p>=n+e[l])&&!(d<=i+e[o]||u>=i+e[s]))if(r>0){let t=i+e[o];(Number.isNaN(C)||t<C)&&(C=t)}else{let t=i+e[s];(Number.isNaN(C)||t>C)&&(C=t)}}return C}function hd(e,t,n,r){if(r===0||(t.pos[n]+=r,!dd(e,t.pos)))return;let i=Z.width/2;if(n===`y`){if(r<0){let n=pd(e,t.pos,-1);t.pos.y=(Number.isNaN(n)?Math.floor(t.pos.y)+1:n)+od,t.onGround=!0}else{let n=pd(e,t.pos,1);t.pos.y=(Number.isNaN(n)?Math.floor(t.pos.y+Z.height):n)-Z.height-od}t.vel.y=0}else{let a=md(e,t.pos,n,r);r>0?t.pos[n]=(Number.isNaN(a)?Math.floor(t.pos[n]+i):a)-i-od:t.pos[n]=(Number.isNaN(a)?Math.floor(t.pos[n]-i)+1:a)+i+od,t.vel[n]=0}}function gd(e,t){return yl(gu(e,Math.floor(t.x),Math.floor(t.y+Z.height*.5),Math.floor(t.z)))}function _d(e,t){let n=Z.width/2,r=t.x-n,i=t.x+n,a=t.z-n,o=t.z+n,s=Math.floor(r),c=Math.floor(i),l=Math.floor(a),u=Math.floor(o),d=Math.floor(t.y-.06),f=Math.floor(t.y);for(let n=d;n<=f;n++)for(let d=l;d<=u;d++)for(let l=s;l<=c;l++){let s=gu(e,l,n,d);if(!nu(s))continue;let c=ld(s)?Ll(s):fd;for(let e of c){if(i<=l+e[0]||r>=l+e[3]||o<=d+e[2]||a>=d+e[5])continue;let s=n+e[4];if(s<=t.y+od&&s>=t.y-.06)return!0}}return!1}function vd(e,t,n,r,i,a){let o=t.pos[n];bd(e,t,n,r,i);let s=t.pos[n]-o;if(!a||Math.abs(s)>=Math.abs(r)-od)return;let c=t.pos[n],l=t.pos.y;if(t.pos.y=l+cd,dd(e,t.pos)){t.pos.y=l;return}if(t.pos[n]+=r-s,dd(e,t.pos)){t.pos[n]=c,t.pos.y=l;return}hd(e,t,`y`,-.55),i&&!_d(e,t.pos)&&(t.pos[n]=c,t.pos.y=l)}function yd(e,t){let n=Z.width/2,r=Math.floor(t.x),i=Math.floor(t.z),a=Math.floor(t.x+n)+1,o=Math.floor(t.x-n)-1,s=Math.floor(t.z+n)+1,c=Math.floor(t.z-n)-1,l=Math.floor(t.y),u=Math.floor(t.y+Z.height*.5);for(let t=l;t<=u;t++)if(nu(gu(e,a,t,i))||nu(gu(e,o,t,i))||nu(gu(e,r,t,s))||nu(gu(e,r,t,c)))return!0;return!1}function bd(e,t,n,r,i){let a=t.pos[n];hd(e,t,n,r),i&&!_d(e,t.pos)&&(t.pos[n]=a,t.vel[n]=0)}function xd(e,t,n,r){let i=n.forward,a=n.strafe;if(n.fly===!0){t.sprinting=!1,t.onGround=!1;let o=Math.sin(n.yaw),s=Math.cos(n.yaw),c=Math.hypot(i,a),l=(c>1?1/c:1)*Z.flySpeed;t.vel.x=(a*s-i*o)*l,t.vel.z=(-i*s-a*o)*l,t.vel.y=(!!n.jump-+(n.sneak===!0))*Z.flyVertSpeed;let u=Math.max(Math.abs(t.vel.x),Math.abs(t.vel.y),Math.abs(t.vel.z))*r,d=Math.max(1,Math.ceil(u/sd)),f=r/d;for(let n=0;n<d;n++)hd(e,t,`y`,t.vel.y*f),hd(e,t,`x`,t.vel.x*f),hd(e,t,`z`,t.vel.z*f);return}let o=n.sneak===!0,s=gd(e,t.pos);o||i<=0||s?t.sprinting=!1:n.sprint===!0&&t.onGround&&(t.sprinting=!0);let c=(o?Z.sneakFactor:t.sprinting?Z.sprintFactor:1)*(s?Z.waterFactor:1),l=Math.hypot(i,a),u=(l>1?1/l:1)*Z.walkSpeed*c,d=Math.sin(n.yaw),f=Math.cos(n.yaw);t.vel.x=(a*f-i*d)*u,t.vel.z=(-i*f-a*d)*u,s?n.jump?t.vel.y=yd(e,t.pos)?Z.waterJumpSpeed:Z.swimSpeed:o?t.vel.y=-Z.swimSpeed:(t.vel.y-=Z.waterGravity*r,t.vel.y<-Z.waterSinkMax&&(t.vel.y=-Z.waterSinkMax),t.vel.y>Z.waterSinkMax&&(t.vel.y=Z.waterSinkMax)):(n.jump&&t.onGround&&(t.vel.y=Z.jumpSpeed),t.vel.y-=Z.gravity*r,t.vel.y<-Z.terminalVelocity&&(t.vel.y=-Z.terminalVelocity)),t.onGround=!1;let p=Math.max(Math.abs(t.vel.x),Math.abs(t.vel.y),Math.abs(t.vel.z))*r,m=Math.max(1,Math.ceil(p/sd)),h=r/m;for(let n=0;n<m;n++){hd(e,t,`y`,t.vel.y*h);let n=o&&t.onGround,r=t.onGround&&!s;vd(e,t,`x`,t.vel.x*h,n,r),vd(e,t,`z`,t.vel.z*h,n,r)}}function Sd(e,t,n,r,i,a,o,s,c,l,u){let d=0,f=u,p=-1;{let t=o+l[0],n=o+l[3];if(r!==0){let i=1/r,a=(t-e)*i,o=(n-e)*i;if(a>o){let e=a;a=o,o=e}if(a>d&&(d=a,p=0),o<f&&(f=o),d>f)return null}else if(e<t||e>n)return null}{let e=s+l[1],n=s+l[4];if(i!==0){let r=1/i,a=(e-t)*r,o=(n-t)*r;if(a>o){let e=a;a=o,o=e}if(a>d&&(d=a,p=1),o<f&&(f=o),d>f)return null}else if(t<e||t>n)return null}{let e=c+l[2],t=c+l[5];if(a!==0){let r=1/a,i=(e-n)*r,o=(t-n)*r;if(i>o){let e=i;i=o,o=e}if(i>d&&(d=i,p=2),o<f&&(f=o),d>f)return null}else if(n<e||n>t)return null}return d>u?null:p===0?[r>0?-1:1,0,0]:p===1?[0,i>0?-1:1,0]:p===2?[0,0,a>0?-1:1]:[0,0,0]}function Cd(e,t,n,r,i,a,o,s,c=!1){let l=Math.hypot(i,a,o);if(l===0||!Number.isFinite(l))return null;i/=l,a/=l,o/=l;let u=Math.floor(t),d=Math.floor(n),f=Math.floor(r),p=i>0?1:-1,m=a>0?1:-1,h=o>0?1:-1,g=i===0?1/0:Math.abs(1/i),_=a===0?1/0:Math.abs(1/a),v=o===0?1/0:Math.abs(1/o),y=i===0?1/0:(i>0?u+1-t:t-u)*g,b=a===0?1/0:(a>0?d+1-n:n-d)*_,x=o===0?1/0:(o>0?f+1-r:r-f)*v,S=0,C=0,w=0,T=0;for(;T<=s;){let l=gu(e,u,d,f);if(c&&yl(l))return{x:u,y:d,z:f,nx:S,ny:C,nz:w};if(l!==K.Air&&!yl(l)){if(tu(l))return{x:u,y:d,z:f,nx:S,ny:C,nz:w};let e=Sd(t,n,r,i,a,o,u,d,f,Hu(l),s);if(e)return{x:u,y:d,z:f,nx:e[0],ny:e[1],nz:e[2]}}y<b&&y<x?(u+=p,T=y,y+=g,S=-p,C=0,w=0):b<x?(d+=m,T=b,b+=_,S=0,C=-m,w=0):(f+=h,T=x,x+=v,S=0,C=0,w=-h)}return null}function wd(e,t,n){return`${e},${t},${n}`}function Td(e){if(typeof e!=`object`||!e)return null;let t=e,{x:n,y:r,z:i}=t;if(typeof n!=`number`||!Number.isInteger(n)||typeof r!=`number`||!Number.isInteger(r)||typeof i!=`number`||!Number.isInteger(i)||typeof t.texto!=`string`)return null;let a=t.texto.slice(0,300),o=t.imagem;return o===void 0?{x:n,y:r,z:i,texto:a}:typeof o!=`string`||!o.startsWith(`data:image/`)||o.length>32768?null:{x:n,y:r,z:i,texto:a,imagem:o}}var Ed=(e,t,n,r)=>n===0||gu(e,t,n-1,r)!==K.Air?null:[{x:t,y:n-1,z:r,blockId:gu(e,t,n,r)},{x:t,y:n,z:r,blockId:K.Air}],Dd=(e,t,n,r)=>{let i=gu(e,t,n,r);return gu(e,t,n+1,r)===i||gu(e,t,n-1,r)===i?null:[{x:t,y:n,z:r,blockId:K.Air}]},Od=(e,t,n,r)=>{let i=gu(e,t,n,r),{dx:a,dz:o}=Hl(i);return gu(e,t+a,n,r+o)===i||gu(e,t-a,n,r-o)===i?null:[{x:t,y:n,z:r,blockId:K.Air}]},kd=(e,t,n,r)=>tu(gu(e,t,n-1,r))?null:[{x:t,y:n,z:r,blockId:K.Air}],Ad=[[1,0],[-1,0],[0,1],[0,-1]];function jd(e,t,n,r){let i=0;for(let[a,o]of Ad)bl(gu(e,t+a,n,r+o))&&i++;return i}function Md(e,t,n,r){if(yl(gu(e,t,n+1,r)))return 7;let i=0;for(let[a,o]of Ad){let s=xl(gu(e,t+a,n,r+o));s>0&&(i=Math.max(i,s-1))}return i}var Nd=4;function Pd(e,t,n,r){if(!hu(e,t,n-1,r))return!1;let i=gu(e,t,n-1,r);return i===K.Air||yl(i)&&!bl(i)}function Fd(e,t,n,r){if(!hu(e,t,n,r))return!1;let i=gu(e,t,n,r);return i===K.Air||yl(i)&&!bl(i)}function Id(e,t,n,r,i,a,o){let s=1/0;for(let[c,l]of Ad){if(c===a&&l===o)continue;let u=t+c,d=r+l;if(!Fd(e,u,n,d))continue;if(Pd(e,u,n,d))return i;if(i>=Nd)continue;let f=Id(e,u,n,d,i+1,-c,-l);f<s&&(s=f)}return s}var Ld=(e,t,n,r)=>{let i=gu(e,t,n,r),a=[],o=gu(e,t,n-1,r),s;if(bl(i))s=8;else if(tu(o)&&!yl(o)&&jd(e,t,n,r)>=2)a.push({x:t,y:n,z:r,blockId:K.Agua}),s=8;else{let o=Md(e,t,n,r);if(o<=0)return[{x:t,y:n,z:r,blockId:K.Air}];o!==xl(i)&&a.push({x:t,y:n,z:r,blockId:Sl(o)}),s=o}if(o===K.Air)a.push({x:t,y:n-1,z:r,blockId:K.AguaFluida7});else if(tu(o)&&!yl(o)){let i=s-1;if(i>=1){let o=[1/0,1/0,1/0,1/0],s=[!1,!1,!1,!1],c=1/0;for(let[a,[l,u]]of Ad.entries()){let d=t+l,f=r+u,p=gu(e,d,n,f);if(s[a]=hu(e,d,n,f)&&(p===K.Air||yl(p)&&!bl(p)&&xl(p)<i),!Fd(e,d,n,f))continue;let m=Pd(e,d,n,f)?0:Id(e,d,n,f,1,-l,-u);o[a]=m,m<c&&(c=m)}let l=c!==1/0;for(let[e,[u,d]]of Ad.entries())s[e]&&(l&&(o[e]??1/0)>c||a.push({x:t+u,y:n,z:r+d,blockId:Sl(i)}))}}return a.length?a:null},Rd=new Map([[K.Sand,Ed],[K.Gravel,Ed],[K.PortaXFechada,Dd],[K.PortaXAberta,Dd],[K.PortaZFechada,Dd],[K.PortaZAberta,Dd],[K.PortaXFechadaR,Dd],[K.PortaXAbertaR,Dd],[K.PortaZFechadaR,Dd],[K.PortaZAbertaR,Dd],[K.Tocha,kd]]);for(let e=K.TapeteBranco;e<=K.TapeteMarrom;e++)Rd.set(e,kd);for(let e of[K.CamaXP,K.CamaZP,K.CamaXN,K.CamaZN])Rd.set(e,Od);for(let e=K.FlorVermelha;e<=K.FlorBranca;e++)Rd.set(e,kd);for(let e=K.Agua;e<=K.AguaFluida7;e++)Rd.set(e,Ld);function zd(e){return(e.max.x-e.min.x+1)*(e.max.y-e.min.y+1)*(e.max.z-e.min.z+1)}function Bd(e){return e===`construir`||e===`chegar`||e===`limpar`}function Vd(e,t){let n=xu(e),r=xu(t);return!n||!r||n.x>r.x||n.y>r.y||n.z>r.z?null:{min:n,max:r}}function Hd(e){if(typeof e!=`object`||!e)return null;let t=e;if(typeof t.id!=`number`||!Number.isInteger(t.id)||t.id<1||!Bd(t.kind)||typeof t.regiao!=`string`||!t.regiao||typeof t.texto!=`string`)return null;let n=Vd(t.min,t.max);if(!n)return null;let r;if(t.kind===`construir`){if(!Array.isArray(t.gabarito)||t.gabarito.length!==zd(n)||!t.gabarito.every(e=>typeof e==`number`&&Number.isInteger(e)&&e>=0))return null;r=t.gabarito}let i;if(t.alvos!==void 0){if(!Array.isArray(t.alvos)||t.alvos.length===0)return null;i=[];for(let e of t.alvos){let t=e,a=t?Vd(t.min,t.max):null;if(!a||r&&zd(a)!==zd(n))return null;i.push(a)}}let a;if(Array.isArray(t.baseline)){let e=i??[n],r=t.baseline;r.length===e.length&&r.every((t,n)=>Array.isArray(t)&&t.length===zd(e[n])&&t.every(e=>typeof e==`number`&&Number.isInteger(e)&&e>=0))&&(a=r)}return{id:t.id,kind:t.kind,regiao:t.regiao,texto:t.texto.slice(0,120),min:n.min,max:n.max,...typeof t.modelo==`string`?{modelo:t.modelo}:{},...r?{gabarito:r}:{},...i?{alvos:i}:{},...t.regra===`todos`||t.regra===`um`?{regra:t.regra}:{},...a?{baseline:a}:{}}}function Ud(e){if(typeof e!=`object`||!e)return null;let t=e,n=[];if(Array.isArray(t.objetivos))for(let e of t.objetivos){let t=Hd(e);t&&n.push(t)}let r=Array.isArray(t.completos)?t.completos.filter(e=>typeof e==`number`&&Number.isInteger(e)):[],i=[];if(Array.isArray(t.completosGrupos))for(let e of t.completosGrupos){if(typeof e!=`object`||!e)continue;let t=e;typeof t.grupo!=`number`||!Number.isInteger(t.grupo)||i.push({grupo:t.grupo,objetivos:Array.isArray(t.objetivos)?t.objetivos.filter(e=>typeof e==`number`&&Number.isInteger(e)):[]})}return{modo:t.modo===`livre`?`livre`:`sequencial`,objetivos:n,completos:r,...i.length?{completosGrupos:i}:{}}}function Wd(e){if(typeof e!=`object`||!e)return null;let t=e;if(typeof t.id!=`number`||!Number.isInteger(t.id)||!Bd(t.kind)||typeof t.regiao!=`string`||typeof t.texto!=`string`)return null;let n=xu(t.min),r=xu(t.max);if(!n||!r||typeof t.completo!=`boolean`||typeof t.ativo!=`boolean`||![t.atual,t.total,t.extras].every(e=>typeof e==`number`&&Number.isInteger(e)))return null;let i;if(t.porGrupo!==void 0){if(!Array.isArray(t.porGrupo))return null;i=[];for(let e of t.porGrupo){if(typeof e!=`object`||!e)return null;let t=e,n=Vd(t.min,t.max);if(!n||typeof t.grupo!=`number`||!Number.isInteger(t.grupo)||typeof t.completo!=`boolean`||typeof t.ativo!=`boolean`||![t.atual,t.total,t.extras].every(e=>typeof e==`number`&&Number.isInteger(e)))return null;i.push({grupo:t.grupo,min:n.min,max:n.max,atual:t.atual,total:t.total,extras:t.extras,completo:t.completo,ativo:t.ativo})}}return{id:t.id,kind:t.kind,regiao:t.regiao,texto:t.texto,min:n,max:r,completo:t.completo,ativo:t.ativo,atual:t.atual,total:t.total,extras:t.extras,...i?{porGrupo:i}:{}}}function Gd(e){let t;try{t=JSON.parse(e)}catch{return null}if(typeof t!=`object`||!t)return null;let n=t;switch(n.type){case`debug_stats`:{if(![n.tickAvgMs,n.tickMaxMs,n.tps].every(e=>typeof e==`number`&&Number.isFinite(e)))return null;let e=e=>{let t=n[e];return typeof t==`number`&&Number.isFinite(t)?t:void 0};return{type:`debug_stats`,tickAvgMs:n.tickAvgMs,tickMaxMs:n.tickMaxMs,tps:n.tps,...e(`regrasCelulasAvg`)===void 0?{}:{regrasCelulasAvg:e(`regrasCelulasAvg`)},...e(`regrasCelulasMax`)===void 0?{}:{regrasCelulasMax:e(`regrasCelulasMax`)},...e(`regrasMudancasAvg`)===void 0?{}:{regrasMudancasAvg:e(`regrasMudancasAvg`)},...e(`regrasAguaAvg`)===void 0?{}:{regrasAguaAvg:e(`regrasAguaAvg`)}}}case`block_changed`:return[n.x,n.y,n.z,n.blockId].every(e=>typeof e==`number`&&Number.isInteger(e))?{type:`block_changed`,x:n.x,y:n.y,z:n.z,blockId:n.blockId}:null;case`blocks_filled`:return[n.x0,n.y0,n.z0,n.x1,n.y1,n.z1,n.blockId].every(e=>typeof e==`number`&&Number.isInteger(e))?{type:`blocks_filled`,x0:n.x0,y0:n.y0,z0:n.z0,x1:n.x1,y1:n.y1,z1:n.z1,blockId:n.blockId}:null;case`player_moved`:return typeof n.id!=`number`||!Number.isInteger(n.id)||![n.x,n.y,n.z,n.yaw,n.pitch].every(e=>typeof e==`number`&&Number.isFinite(e))?null:{type:`player_moved`,id:n.id,x:n.x,y:n.y,z:n.z,yaw:n.yaw,pitch:n.pitch,...typeof n.name==`string`?{name:n.name}:{}};case`player_left`:return typeof n.id!=`number`||!Number.isInteger(n.id)?null:{type:`player_left`,id:n.id};case`spawn`:return[n.x,n.y,n.z].every(e=>typeof e==`number`&&Number.isFinite(e))?{type:`spawn`,x:n.x,y:n.y,z:n.z,...n.papel===`professor`||n.papel===`aluno`?{papel:n.papel}:{}}:null;case`regions`:{if(!Array.isArray(n.regions))return null;let e=[];for(let t of n.regions){let n=Su(t);n&&e.push(n)}return{type:`regions`,regions:e}}case`objectives`:{if(n.modo!==`sequencial`&&n.modo!==`livre`||!Array.isArray(n.objetivos))return null;let e=[];for(let t of n.objetivos){let n=Wd(t);n&&e.push(n)}return{type:`objectives`,modo:n.modo,objetivos:e}}case`group`:{let e=n.grupo;return e!==null&&(typeof e!=`number`||!Number.isInteger(e))?null:{type:`group`,grupo:e}}case`groups`:return{type:`groups`,grupos:Tu(n.grupos)};case`claims`:{if(typeof n.ativo!=`boolean`||!Array.isArray(n.claims))return null;let e=[];for(let t of n.claims){let n=Cu(t);n&&e.push(n)}return{type:`claims`,ativo:n.ativo,claims:e}}case`friends`:{let e=e=>Array.isArray(e)?e.filter(e=>typeof e==`string`):[],t=null,r=n.equipe;if(r&&typeof r==`object`){let n=r;typeof n.dono==`string`&&(t={dono:n.dono,membros:e(n.membros)})}return{type:`friends`,equipe:t,convites:e(n.convites)}}case`players`:{if(!Array.isArray(n.conectados)||!Array.isArray(n.banidos))return null;let e=[];for(let t of n.conectados){if(!t||typeof t!=`object`)continue;let n=t;typeof n.name==`string`&&e.push({name:n.name,papel:n.papel===`professor`?`professor`:`aluno`})}return{type:`players`,conectados:e,banidos:n.banidos.filter(e=>typeof e==`string`)}}case`quadro_changed`:{let e=Td(n);return e?{type:`quadro_changed`,...e}:null}case`quadros`:{if(!Array.isArray(n.lista))return null;let e=[];for(let t of n.lista){let n=Td(t);n&&e.push(n)}return{type:`quadros`,lista:e}}case`chat`:return typeof n.author!=`string`||typeof n.text!=`string`?null:{type:`chat`,author:n.author,text:n.text};case`join_denied`:return typeof n.reason==`string`?{type:`join_denied`,reason:n.reason}:null;case`teleport`:return[n.x,n.y,n.z,n.yaw,n.pitch].every(e=>typeof e==`number`&&Number.isFinite(e))?{type:`teleport`,x:n.x,y:n.y,z:n.z,yaw:n.yaw,pitch:n.pitch}:null;case`time`:return typeof n.hora!=`number`||!Number.isFinite(n.hora)||typeof n.ciclo!=`boolean`?null:{type:`time`,hora:n.hora,ciclo:n.ciclo};case`vento`:{let e=n.dir,t=n.forca;return typeof e!=`number`||!Number.isFinite(e)||typeof t!=`number`||!Number.isFinite(t)||typeof n.ativo!=`boolean`?null:{type:`vento`,dir:e,forca:t,ativo:n.ativo}}case`mundo_trocando`:return typeof n.nome==`string`?{type:`mundo_trocando`,nome:n.nome}:null;case`voo`:return typeof n.liberado==`boolean`?{type:`voo`,liberado:n.liberado}:null;case`kicked`:return typeof n.reason==`string`?{type:`kicked`,reason:n.reason}:null;default:return null}}function Kd(e){if(e.byteLength<12)throw Error(`snapshot menor que o header (${e.byteLength} bytes)`);let t=new DataView(e);if(t.getUint32(0,!0)!==810178380)throw Error(`snapshot com magic inválido — não é um world_snapshot`);let n={x:t.getUint8(4),z:t.getUint8(5),y:t.getUint8(6)};if(n.x<1||n.z<1||n.y<1||n.x>lu.x||n.z>lu.z||n.y>lu.y)throw Error(`snapshot com dims fora do limite: ${n.x}×${n.z}×${n.y}`);let r=t.getUint32(8,!0),i=du(n),a=12+i.chunks.length*cu;if(e.byteLength!==a)throw Error(`snapshot com tamanho errado: ${e.byteLength} bytes (esperado ${a})`);for(let t=0;t<i.chunks.length;t++)i.chunks[t]?.set(new Uint8Array(e,12+t*cu,cu));return{world:i,seed:r}}var qd=809847372,Jd={x:240,z:240,y:8};function Yd(e){return e.byteLength<4?0:new DataView(e).getUint32(0,!0)}function Xd(e){if(e.byteLength!==16)throw Error(`LJE0 com tamanho errado (${e.byteLength} bytes)`);let t=new DataView(e);if(t.getUint32(0,!0)!==809847372)throw Error(`LJE0 com magic inválido`);let n={x:t.getUint16(4,!0),z:t.getUint16(6,!0),y:t.getUint16(8,!0)};if(n.x<1||n.z<1||n.y<1||n.x>Jd.x||n.z>Jd.z||n.y>Jd.y)throw Error(`LJE0 com dims fora do limite: ${n.x}×${n.z}×${n.y}`);return{world:du(n,!1),seed:t.getUint32(12,!0)}}var Zd=8;function Qd(e,t){if(e.byteLength<Zd)throw Error(`LJC0 menor que o header (${e.byteLength} bytes)`);let n=new DataView(e);if(n.getUint32(0,!0)!==809716300)throw Error(`LJC0 com magic inválido`);let r=n.getUint16(4,!0),i=4+t.dims.y*cu;if(e.byteLength!==Zd+r*i)throw Error(`LJC0 com tamanho errado (${e.byteLength} bytes p/ ${r} colunas)`);let a=[],o=Zd;for(let i=0;i<r;i++){let r=n.getUint16(o,!0),i=n.getUint16(o+2,!0);if(o+=4,r>=t.dims.x||i>=t.dims.z)throw Error(`LJC0 com coluna fora do mundo: ${r},${i}`);fu(t,r,i);for(let n=0;n<t.dims.y;n++)t.chunks[pu(t,r,n,i)]?.set(new Uint8Array(e,o,cu)),o+=cu;a.push({cx:r,cz:i})}return a}var $d=8;function ef(e){if(typeof e!=`object`||!e)return!1;let t=e;return[`x`,`y`,`z`].every(e=>typeof t[e]==`number`&&Number.isFinite(t[e]))}function tf(e){if(e.byteLength<$d)throw Error(`save menor que o header (${e.byteLength} bytes)`);let t=new DataView(e),n=t.getUint32(0,!0);if(n===844319308)return nf(e,t);if(n!==827542092)throw Error(`save com magic inválido — não é um arquivo .ljw`);let{jsonLen:r,meta:i}=rf(e,t),a=Kd(e.slice($d+r));return{...i,world:a.world}}function nf(e,t){let{jsonLen:n,m:r,meta:i}=rf(e,t),a=r.dims,o=typeof a==`object`&&a&&typeof a.x==`number`&&typeof a.z==`number`&&typeof a.y==`number`?a:null;if(!o||o.x<1||o.z<1||o.y<1||o.x>Jd.x||o.z>Jd.z||o.y>Jd.y)throw Error(`save esparso sem dims válidas`);let s=$d+n;if(s+4>e.byteLength)throw Error(`save esparso truncado (sem contagem)`);let c=t.getUint32(s,!0);if(s+=4,s+c*4100>e.byteLength)throw Error(`save esparso truncado (${c} chunks não cabem)`);let l=o.x*o.y*o.z,u=[];for(let n=0;n<c;n++){let n=t.getUint32(s,!0);s+=4,n<l&&u.push({index:n,bytes:new Uint8Array(e.slice(s,s+cu))}),s+=cu}return{...i,dims:o,world:du(o,!1),editedChunks:u}}function rf(e,t){let n=t.getUint32(4,!0);if($d+n>e.byteLength)throw Error(`save truncado: JSON de metadados maior que o arquivo`);let r;try{r=JSON.parse(new TextDecoder().decode(new Uint8Array(e,$d,n)))}catch{throw Error(`save com JSON de metadados quebrado`)}if(typeof r!=`object`||!r)throw Error(`metadados não são objeto`);let i=r;if(typeof i.seed!=`number`||!Number.isFinite(i.seed))throw Error(`save sem seed válida`);if(!ef(i.spawn))throw Error(`save sem spawn válido`);let a=[];if(Array.isArray(i.roster)){for(let e of i.roster)if(typeof e==`object`&&e&&typeof e.name==`string`&&ef(e)){let t=e,n=e=>typeof e==`number`&&Number.isFinite(e)?e:0;a.push({name:t.name,x:t.x,y:t.y,z:t.z,yaw:n(t.yaw),pitch:n(t.pitch),...typeof t.pin==`string`?{pin:t.pin}:{},...t.papel===`professor`?{papel:`professor`}:{}})}}let o=[];if(Array.isArray(i.regioes))for(let e of i.regioes){let t=Su(e);t&&o.push(t)}let s=Ud(i.cenario),c=Tu(i.grupos),l=[];if(Array.isArray(i.claims))for(let e of i.claims){let t=Cu(e);t&&l.push(t)}let u=[];if(Array.isArray(i.amigos))for(let e of i.amigos){let t=wu(e);t&&u.push(t)}let d=[];if(Array.isArray(i.banidos))for(let e of i.banidos)typeof e==`string`&&e&&!d.includes(e)&&d.push(e);let f=[];if(Array.isArray(i.quadros))for(let e of i.quadros){let t=Td(e);t&&f.push(t)}return{jsonLen:n,m:i,meta:{seed:i.seed,spawn:{x:i.spawn.x,y:i.spawn.y,z:i.spawn.z},roster:a,...typeof i.codigo==`string`?{codigo:i.codigo}:{},...o.length?{regioes:o}:{},...s?.objetivos.length?{cenario:s}:{},...c.length?{grupos:c}:{},...i.claimsAtivo===!0?{claimsAtivo:!0}:{},...l.length?{claims:l}:{},...u.length?{amigos:u}:{},...d.length?{banidos:d}:{},...i.confinamento===!0?{confinamento:!0}:{},...f.length?{quadros:f}:{},...typeof i.hora==`number`&&Number.isFinite(i.hora)?{hora:i.hora}:{},...typeof i.ciclo==`boolean`?{ciclo:i.ciclo}:{},...i.vento===!1?{vento:!1}:{}}}}var af=`0.8.0`;function of(e,t,n){let r=n^Math.imul(e,374761393)^Math.imul(t,668265263);return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function Q(e,t,n,r,i=0,a=q.tilePx){let o=q.tilePx,s=t%q.tilesPerRow*o,c=(t/q.tilesPerRow|0)*o;for(let l=i;l<a;l++)for(let i=0;i<o;i++){let a=(of(i,l,t*7919+1)-.5)*2*r;e.fillStyle=`rgb(${Math.round(n[0]+a)},${Math.round(n[1]+a)},${Math.round(n[2]+a)})`,e.fillRect(s+i,c+l,1,1)}}function sf(e,t){let n=q.tilePx,r=t%q.tilesPerRow*n,i=(t/q.tilesPerRow|0)*n;e.fillStyle=`rgb(72,72,72)`;for(let t=0;t<n;t++)e.fillRect(r+t,i+(t%2==0?4:5),1,1),e.fillRect(r+t,i+(t%3==0?11:10),1,1),e.fillRect(r+(t%2==0?7:8),i+t,1,1)}function cf(e){let t=q.tilePx;return[e%q.tilesPerRow*t,(e/q.tilesPerRow|0)*t]}function lf(e,t){let[n,r]=cf(t);e.fillStyle=`rgb(74,54,34)`;for(let i=1;i<q.tilePx;i+=4)for(let a=0;a<q.tilePx;a++)of(i,a,t*31+3)<.8&&e.fillRect(n+i,r+a,1,a===0?2:1)}function uf(e,t){let[n,r]=cf(t),i=q.tilePx/2-.5;e.fillStyle=`rgb(120,90,52)`;for(let t=0;t<q.tilePx;t++)for(let a=0;a<q.tilePx;a++){let o=Math.hypot(a-i,t-i);Math.round(o)%3==0&&o<7.5&&e.fillRect(n+a,r+t,1,1)}}function df(e,t){let[n,r]=cf(t);e.fillStyle=`rgb(122,92,56)`;for(let t=3;t<q.tilePx;t+=4)e.fillRect(n,r+t,q.tilePx,1);for(let t=0;t<4;t++)e.fillRect(n+(t%2==0?4:11),r+t*4,1,3)}function ff(e,t){let[n,r]=cf(t);e.fillStyle=`rgb(196,178,124)`;for(let i=3;i<q.tilePx;i+=5)for(let a=0;a<q.tilePx;a++)of(a,i,t*41+5)<.7&&e.fillRect(n+a,r+i,1,1)}function pf(e,t){let[n,r]=cf(t);e.fillStyle=`rgb(96,96,96)`;for(let t=3;t<q.tilePx;t+=4)e.fillRect(n,r+t,q.tilePx,1);for(let t=0;t<4;t++){let i=t%2==0?7:3;e.fillRect(n+i,r+t*4,1,3),e.fillRect(n+(i+8)%q.tilePx,r+t*4,1,3)}}function mf(e,t){let[n,r]=cf(t);e.fillStyle=`rgb(92,58,128)`;for(let i=0;i<q.tilePx;i++)for(let a=0;a<q.tilePx;a++)of(a,i,t*67+11)<.06&&e.fillRect(n+a,r+i,1,1)}function hf(e,t){let[n,r]=cf(t);for(let i=0;i<4;i++)for(let a=0;a<q.tilePx;a++){let o=(a+(i%2==0?0:4))%8;for(let s=0;s<3;s++){if(o===7)continue;let c=(of(a,i*4+s,t*53+9)-.5)*20;e.fillStyle=`rgb(${Math.round(158+c)},${Math.round(64+c)},${Math.round(52+c)})`,e.fillRect(n+a,r+i*4+s,1,1)}}}function gf(e,t){let[n,r]=cf(t),i=q.tilePx;e.clearRect(n,r,i,i),e.fillStyle=`rgb(214,232,240)`,e.fillRect(n,r,i,1),e.fillRect(n,r+i-1,i,1),e.fillRect(n,r,1,i),e.fillRect(n+i-1,r,1,i);for(let t=2;t<6;t++)e.fillRect(n+t,r+8-t,1,1);for(let t=4;t<10;t++)e.fillRect(n+t,r+14-t,1,1)}function _f(e,t,n){let[r,i]=cf(t),a=q.tilePx;e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`,e.fillRect(r,i,a,a),e.fillStyle=`rgb(${Math.round((n[0]+255)/2)},${Math.round((n[1]+255)/2)},${Math.round((n[2]+255)/2)})`,e.fillRect(r,i,a,1),e.fillRect(r,i+a-1,a,1),e.fillRect(r,i,1,a),e.fillRect(r+a-1,i,1,a),e.fillStyle=`rgb(240,246,250)`;for(let t=3;t<8;t++)e.fillRect(r+t,i+11-t,1,1)}function vf(e,t,n,r){Q(e,t,r,6);let[i,a]=cf(t),o=q.tilePx;e.fillStyle=`rgb(28,28,32)`,e.font=`bold ${o-3}px sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(n,i+o/2,a+o/2+1)}function yf(e,t){Q(e,t,[146,112,66],10);let[n,r]=cf(t);e.fillStyle=`rgb(116,86,48)`;for(let i=2;i<q.tilePx;i+=3)for(let a=0;a<q.tilePx;a++)of(i,a,t*29+7)<.6&&e.fillRect(n+i,r+a,1,1)}function bf(e,t,n){Q(e,t,[164,126,76],8);let[r,i]=cf(t),a=q.tilePx;e.fillStyle=`rgb(112,82,46)`,e.fillRect(r,i,a,1),e.fillRect(r,i+a-1,a,1),e.fillRect(r,i,1,a),e.fillRect(r+a-1,i,1,a),e.fillRect(r+8,i,1,a),n&&(e.fillRect(r+3,i+3,10,1),e.fillRect(r+3,i+9,10,1),e.fillRect(r+3,i+3,1,7),e.fillRect(r+12,i+3,1,7),e.clearRect(r+4,i+4,8,5))}function xf(e,t){Q(e,t,[255,232,122],14,0,10),Q(e,t,[122,92,56],10,10,q.tilePx)}function Sf(e,t){Q(e,t,[164,126,76],8);let[n,r]=cf(t),i=q.tilePx;e.clearRect(n+2,r+2,i-4,i-4),e.fillStyle=`rgb(112,82,46)`,e.fillRect(n+7,r+2,2,i-4),e.fillRect(n+2,r+7,i-4,2),e.fillStyle=`rgb(214,232,240)`;for(let t=0;t<3;t++)e.fillRect(n+3+t,r+6-t,1,1);for(let t=0;t<3;t++)e.fillRect(n+10+t,r+13-t,1,1)}function Cf(e,t){Q(e,t,[72,104,168],8);let[n,r]=cf(t);e.fillStyle=`rgb(54,80,132)`;for(let t=5;t<q.tilePx;t+=6)e.fillRect(n,r+t,q.tilePx,1),e.fillRect(n+t,r,1,q.tilePx)}function wf(e,t){Q(e,t,[178,54,48],8);let[n,r]=cf(t);e.fillStyle=`rgb(140,40,36)`;for(let t=4;t<q.tilePx;t+=5)e.fillRect(n,r+t,q.tilePx,1)}function Tf(e,t){Q(e,t,[242,238,228],4);let[n,r]=cf(t),i=q.tilePx;e.fillStyle=`rgb(122,86,50)`,e.fillRect(n,r,i,2),e.fillRect(n,r+i-2,i,2),e.fillRect(n,r,2,i),e.fillRect(n+i-2,r,2,i)}function Ef(e,t,n=[52,118,44]){Q(e,t,n,16);let[r,i]=cf(t);for(let n=0;n<q.tilePx;n++)for(let a=0;a<q.tilePx;a++)of(a,n,t*97+13)<.22&&e.clearRect(r+a,i+n,1,1)}function Df(e,t,n,r){Q(e,t,[136,136,136],12);let[i,a]=cf(t);e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`;for(let n=1;n<q.tilePx-2;n++)for(let r=1;r<q.tilePx-2;r++)of(r,n,t*131+17)<.07&&e.fillRect(i+r,a+n,2,2);let o=i+q.tilePx/2,s=a+q.tilePx/2;e.font=`bold 8px sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillStyle=`rgb(20,20,24)`,e.fillText(r,o+1,s+2),e.fillStyle=`rgb(244,244,248)`,e.fillText(r,o,s+1)}function Of(e,t){Q(e,t,[66,138,74],10);let[n,r]=cf(t);e.fillStyle=`rgb(48,104,56)`;for(let t=2;t<q.tilePx;t+=4)e.fillRect(n+t,r,1,q.tilePx);e.fillStyle=`rgb(230,238,214)`;for(let i=1;i<q.tilePx;i+=3)for(let a=3;a<q.tilePx;a+=4)of(a,i,t*61+19)<.5&&e.fillRect(n+a,r+i,1,1)}function kf(e,t){Q(e,t,[96,168,100],8);let[n,r]=cf(t),i=q.tilePx;e.fillStyle=`rgb(48,104,56)`,e.fillRect(n,r,i,1),e.fillRect(n,r+i-1,i,1),e.fillRect(n,r,1,i),e.fillRect(n+i-1,r,1,i)}function Af(e,t,n){let[r,i]=cf(t),a=q.tilePx;e.clearRect(r,i,a,a);let o=r+(a>>1);e.fillStyle=`rgb(56,132,52)`,e.fillRect(o-1,i+(a>>1),2,a>>1),e.fillRect(o-3,i+a-5,2,2),e.fillRect(o+1,i+a-7,2,2),e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`,e.fillRect(o-3,i+2,6,6),e.fillRect(o-4,i+4,8,2),e.fillRect(o-2,i+1,4,8),e.fillStyle=`rgb(250,214,74)`,e.fillRect(o-1,i+4,2,2)}function jf(e,t,n){let[r,i]=cf(t),a=q.tilePx;e.clearRect(r,i,a,a);for(let o=0;o<7;o++){let s=1+Math.floor(of(o,0,t*17+3)*(a-2)),c=7+Math.floor(of(o,1,t*17+5)*7),l=of(o,2,t*17+7)<.5?-1:1,u=.72+of(o,3,t*17+9)*.5;e.fillStyle=`rgb(${Math.round(n[0]*u)},${Math.round(n[1]*u)},${Math.round(n[2]*u)})`;for(let t=0;t<c;t++){let n=a-1-t,o=t/c,u=s+Math.round(o*o*3)*l;u<0||u>=a||(e.fillRect(r+u,i+n,1,1),o<.45&&u+1<a&&e.fillRect(r+u+1,i+n,1,1))}}}var Mf={a:[-3,0],b:[-3,0],mistura:0},Nf=J.agua*7919+1;function Pf(e,t,n,r,i){let a=q.tilePx,o=Math.PI*2/a,s=i.mistura,c=(e,t,n)=>{let i=Math.sin((e[0]*t+e[1]*n)*o-r),a=Math.sin((-e[1]*t+e[0]*n)*o*2-r*.55);return[i*6+a*3,+(i>.82&&a>.1)]};for(let r=0;r<a;r++)for(let o=0;o<a;o++){let[a,l]=c(i.a,o,r),[u,d]=c(i.b,o,r),f=a+(u-a)*s,p=l+(d-l)*s,m=(of(o,r,Nf)-.5)*2*6,h=(r*t+n+o)*4;e[h]=46+f+m+p*52,e[h+1]=108+f+m+p*44,e[h+2]=182+f*.6+m+p*28,e[h+3]=255}}var Ff=null,If=null;function Lf(e,t,n,r){let i=q.tilePx,a=Math.PI*2/16;Ff??=e.createImageData(i,i),Pf(Ff.data,i,0,t%16*a,n);let[o,s]=cf(J.agua);e.putImageData(Ff,o,s);let c=Pu.length;If??=e.createImageData(i*c,i);let l=r%16*a;for(let e=0;e<c;e++){let t=Pu[e];Pf(If.data,i*c,e*i,l,{a:t,b:t,mistura:0})}let[u,d]=cf(J.aguaFluxo);e.putImageData(If,u,d)}function Rf(e,t,n,r){let i=e.image.getContext(`2d`);i&&(Lf(i,t,n??Mf,r),e.needsUpdate=!0)}function zf(){let e=q.tilesPerRow*q.tilePx,t=document.createElement(`canvas`);t.width=e,t.height=e;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);Q(n,J.grassTop,[92,158,60],14),Q(n,J.grassSide,[121,88,58],12),Q(n,J.grassSide,[92,158,60],14,0,4),Q(n,J.dirt,[121,88,58],12),Q(n,J.stone,[136,136,136],12),Q(n,J.cobblestone,[120,120,120],20),sf(n,J.cobblestone),Q(n,J.sand,[219,207,142],10),Q(n,J.logSide,[104,78,48],10),lf(n,J.logSide),Q(n,J.logTop,[168,132,82],8),uf(n,J.logTop),Q(n,J.planks,[172,136,86],8),df(n,J.planks),Q(n,J.brick,[186,180,172],8),hf(n,J.brick),Q(n,J.gravel,[112,106,100],30),Q(n,J.bedrock,[42,42,46],24),Q(n,J.woolWhite,[232,232,230],6),Q(n,J.woolBlack,[38,38,42],6),Q(n,J.woolRed,[196,52,46],8),Q(n,J.woolOrange,[226,132,38],8),Q(n,J.woolYellow,[232,206,58],8),Q(n,J.woolGreen,[74,164,62],8),Q(n,J.woolBlue,[58,94,194],8),Q(n,J.woolPurple,[142,72,182],8),Q(n,J.sandstone,[214,198,146],8),ff(n,J.sandstone),Q(n,J.stoneBricks,[128,128,128],10),pf(n,J.stoneBricks),Q(n,J.snow,[240,244,248],5),Q(n,J.obsidian,[30,24,42],8),mf(n,J.obsidian),Q(n,J.woolPink,[226,140,170],8),Q(n,J.woolCyan,[70,178,190],8),Q(n,J.woolGray,[130,130,134],6),Q(n,J.woolBrown,[110,80,54],8),gf(n,J.glass),Ef(n,J.leaves),yf(n,J.cerca),bf(n,J.portaBaixo,!1),bf(n,J.portaCima,!0),xf(n,J.tocha),Sf(n,J.janela),Cf(n,J.estofado),wf(n,J.colchao),Tf(n,J.quadro),Af(n,J.florVermelha,[214,58,54]),Af(n,J.florAmarela,[242,206,62]),Af(n,J.florAzul,[86,122,220]),Af(n,J.florBranca,[238,240,246]),Df(n,J.minerioCarvao,[40,40,44],`C`),Df(n,J.minerioFerro,[216,162,122],`Fe`),Df(n,J.minerioOuro,[244,208,64],`Au`),Df(n,J.minerioDiamante,[108,226,222],`D`),Q(n,J.gramaSecaTop,[178,162,66],14),Q(n,J.gramaSecaSide,[121,88,58],12),Q(n,J.gramaSecaSide,[178,162,66],14,0,4),Q(n,J.gramaFriaTop,[96,138,116],12),Q(n,J.gramaFriaSide,[121,88,58],12),Q(n,J.gramaFriaSide,[96,138,116],12,0,4),Q(n,J.logIpe,[128,110,86],10),lf(n,J.logIpe),Q(n,J.logAraucaria,[86,60,42],10),lf(n,J.logAraucaria),Q(n,J.logPauBrasil,[124,66,46],10),lf(n,J.logPauBrasil),Ef(n,J.folhasIpe,[222,186,48]),Ef(n,J.folhasAraucaria,[34,88,46]),Ef(n,J.folhasPauBrasil,[42,130,54]),Of(n,J.mandacaruSide),kf(n,J.mandacaruTop),Lf(n,0,Mf,0),jf(n,J.gramaAlta,[92,158,60]),jf(n,J.gramaAltaSeca,[178,162,66]),jf(n,J.gramaAltaFria,[96,138,116]);let i=[[232,232,230],[38,38,42],[196,52,46],[226,132,38],[232,206,58],[74,164,62],[58,94,194],[142,72,182],[226,140,170],[70,178,190],[130,130,134],[110,80,54]];for(let e=0;e<i.length;e++)_f(n,J.vidroBranco+e,i[e]);for(let e=0;e<Lu.letters.length;e++)vf(n,Lu.base+e,Lu.letters[e],[236,228,206]);for(let e=0;e<Lu.digits.length;e++)vf(n,Lu.base+Lu.letters.length+e,Lu.digits[e],[206,222,240]);let a=new Ni(t);return a.magFilter=r,a.minFilter=r,a.generateMipmaps=!1,a.colorSpace=Re,a}var Bf=.11,Vf=3042486,Hf=class{scene;fog=new _n(Vf,Bf);tint;submerso=!1;constructor(e){this.scene=e,this.tint=document.createElement(`div`),this.tint.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:1;opacity:0;transition:opacity .18s linear;background:rgba(38,104,170,.3)`,document.body.appendChild(this.tint)}update(e,t,n,r){let i=Uf(e,t,n,r);i!==this.submerso&&(this.submerso=i,this.scene.fog=i?this.fog:null,this.tint.style.opacity=i?`1`:`0`)}get estaSubmerso(){return this.submerso}};function Uf(e,t,n,r){let i=Math.floor(t),a=Math.floor(n),o=Math.floor(r),s=gu(e,i,a,o);return yl(s)?yl(gu(e,i,a+1,o))?!0:n-a<xl(s)/8*Yu:!1}var Wf=new Set;function Gf(e){Wf.add(e)}function Kf(e){for(let t of Wf)t(e)}var qf=null,Jf=null,Yf=.8;function Xf(){if(!qf)try{qf=new AudioContext,Jf=qf.createGain(),Jf.gain.value=Yf,Jf.connect(qf.destination)}catch{return null}return qf.state===`suspended`&&qf.resume(),qf}function Zf(e){Yf=e,Jf&&(Jf.gain.value=e)}function Qf(e,t,n,r,i,a=0){if(!qf||!Jf)return;let o=qf.currentTime+a/1e3,s=o+n/1e3,c=qf.createOscillator();c.type=r,c.frequency.setValueAtTime(e,o),c.frequency.exponentialRampToValueAtTime(Math.max(t,1),s);let l=qf.createGain();l.gain.setValueAtTime(0,o),l.gain.linearRampToValueAtTime(i,o+.008),l.gain.exponentialRampToValueAtTime(1e-4,s),c.connect(l).connect(Jf),c.start(o),c.stop(s+.01)}function $f(e){if(Xf())switch(e){case`click`:Qf(700,980,70,`triangle`,.22);break;case`back`:Qf(520,340,90,`triangle`,.2);break;case`confirm`:Qf(660,660,80,`sine`,.22),Qf(990,990,110,`sine`,.2,85);break;case`notify`:Qf(880,880,90,`sine`,.18),Qf(1175,1175,130,`sine`,.16,100);break;case`denied`:Qf(220,160,180,`sawtooth`,.15);break}}function ep(e){qf&&$f(e)}function tp(e){Zf(e),window.addEventListener(`pointerdown`,()=>void Xf(),{capture:!0});let t=-1/0;Gf(e=>{if(e.kind===`objective_complete`)t=performance.now(),ep(`confirm`);else if(e.kind===`chat_message`){if(performance.now()-t<800)return;ep(`notify`)}})}var np=20260726,rp=.75,ip=24,ap=96,op=18,sp=-.25,cp={raioRender:6,meshMsPorFrame:6,pixelRatioCap:1,fov:75,nuvens:!0,balanco:!0};function lp(e){if(!e.has(`bench`))return null;let t=Number(e.get(`bench`));return{duracaoS:Number.isFinite(t)&&t>=10?Math.min(t,300):30,semVida:e.has(`semvida`)}}function up(e){return e.semVida?{...cp,nuvens:!1,balanco:!1}:{...cp}}var dp=class e{duracaoS;trajeto;semVida;t0=0;rodando=!1;constructor(e,t,n=!1){this.duracaoS=e,this.trajeto=t,this.semVida=n}static paraMundo(t,n,r){let i=Math.min(r.x,r.z)*16,a=Math.max(16,Math.min(ap,i/2-16)),o=(e,t)=>Math.min(Math.max(e,a+8),Math.max(a+8,t*16-a-8));return new e(t.duracaoS,{centroX:+o(n.x,r.x).toFixed(2),centroZ:+o(n.z,r.z).toFixed(2),y:+(n.y+ip).toFixed(2),raio:+a.toFixed(2)},t.semVida)}get ativo(){return this.rodando}iniciar(e){this.t0=e,this.rodando=!0}terminou(e){return this.rodando&&(e-this.t0)/1e3>=this.duracaoS}parar(){this.rodando=!1}pontoDoVoo(e){let{centroX:t,centroZ:n,raio:r}=this.trajeto,i=op*e/r,a=-Math.sin(i),o=Math.cos(i);return{x:t+Math.cos(i)*r,z:n+Math.sin(i)*r,yaw:Math.atan2(-a,-o)}}amostra(e){let t=Math.min((e-this.t0)/1e3,this.duracaoS),n=this.duracaoS*rp;if(t<n){let e=this.pontoDoVoo(t);return{x:e.x,y:this.trajeto.y,z:e.z,yaw:e.yaw,pitch:sp,fase:`voo`,t:+t.toFixed(2)}}let r=this.pontoDoVoo(n),i=(t-n)/(this.duracaoS-n)*Math.PI*2;return{x:r.x,y:this.trajeto.y,z:r.z,yaw:r.yaw+i,pitch:sp,fase:`giro`,t:+t.toFixed(2)}}meta(){return{versaoTrajeto:1,duracaoS:this.duracaoS,seed:np,trajeto:{...this.trajeto,fracaoVoo:rp,velocidadeBlocosS:op,pitch:sp},config:up(this),semVida:this.semVida,viewport:`${window.innerWidth}×${window.innerHeight}`,dpr:window.devicePixelRatio}}};function fp(e,t,n){e.clearRect(0,0,t,t);let r=t*.28,i=t*.82,a=t*.2,o=t*.8,s=t*.32,c=t*.68;n&&(e.fillStyle=`#2e6fd6`,e.beginPath(),e.moveTo(a+t*.03,r+t*.03),e.lineTo(o-t*.03,r+t*.03),e.lineTo(c,i),e.lineTo(s,i),e.closePath(),e.fill()),e.strokeStyle=`#4a4a52`,e.fillStyle=n?`rgba(120,124,132,0.35)`:`#9a9ea8`,e.lineWidth=Math.max(1,t*.06),e.beginPath(),e.moveTo(a,r),e.lineTo(o,r),e.lineTo(c,i),e.lineTo(s,i),e.closePath(),n||e.fill(),e.stroke(),e.beginPath(),e.arc(t*.5,r,(o-a)/2,Math.PI,2*Math.PI),e.stroke()}function pp(e,t){let n=q.tilePx,r=new Map,i=document.createElement(`canvas`);i.width=n,i.height=n;let a=i.getContext(`2d`);if(!a)return r;for(let o of t){if(Cl(o)){fp(a,n,o===901),r.set(o,i.toDataURL());continue}let t=Vu(o),s=t%q.tilesPerRow*n,c=(t/q.tilesPerRow|0)*n;a.clearRect(0,0,n,n),a.drawImage(e,s,c,n,n,0,0,n,n),r.set(o,i.toDataURL())}return r}var mp=[{id:`blocos`,label:`blocos`},{id:`vegetacao`,label:`vegetação`},{id:`mobilia`,label:`mobília`},{id:`minerios`,label:`minérios`},{id:`ferramentas`,label:`ferramentas`},{id:`glifos`,label:`letras e números`}],hp=[...Array.from(Lu.letters,(e,t)=>({id:K.LetterA+t,name:`letra ${e}`,cat:`glifos`})),...Array.from(Lu.digits,(e,t)=>({id:K.Digit0+t,name:`número ${e}`,cat:`glifos`}))],gp=[{id:K.Grass,name:`grama`,cat:`blocos`},{id:K.Stone,name:`pedra`,cat:`blocos`},{id:K.Cobblestone,name:`pedregulho`,cat:`blocos`},{id:K.Sand,name:`areia`,cat:`blocos`},{id:K.Dirt,name:`terra`,cat:`blocos`},{id:K.Log,name:`tronco`,cat:`vegetacao`},{id:K.Planks,name:`tábuas`,cat:`blocos`},{id:K.Brick,name:`tijolo`,cat:`blocos`},{id:K.Gravel,name:`cascalho`,cat:`blocos`},{id:K.Bedrock,name:`rocha-matriz`,cat:`blocos`},{id:K.WoolWhite,name:`lã branca`,cat:`blocos`},{id:K.WoolBlack,name:`lã preta`,cat:`blocos`},{id:K.WoolRed,name:`lã vermelha`,cat:`blocos`},{id:K.WoolOrange,name:`lã laranja`,cat:`blocos`},{id:K.WoolYellow,name:`lã amarela`,cat:`blocos`},{id:K.WoolGreen,name:`lã verde`,cat:`blocos`},{id:K.WoolBlue,name:`lã azul`,cat:`blocos`},{id:K.WoolPurple,name:`lã roxa`,cat:`blocos`},{id:K.Sandstone,name:`arenito`,cat:`blocos`},{id:K.StoneBricks,name:`pedra-lavrada`,cat:`blocos`},{id:K.Snow,name:`neve`,cat:`blocos`},{id:K.Obsidian,name:`obsidiana`,cat:`blocos`},{id:K.WoolPink,name:`lã rosa`,cat:`blocos`},{id:K.WoolCyan,name:`lã ciano`,cat:`blocos`},{id:K.WoolGray,name:`lã cinza`,cat:`blocos`},{id:K.WoolBrown,name:`lã marrom`,cat:`blocos`},{id:K.Glass,name:`vidro`,cat:`blocos`},{id:K.Leaves,name:`folhas`,cat:`vegetacao`},...hp,{id:K.Cerca,name:`cerca`,cat:`mobilia`},{id:K.PortaXFechada,name:`porta`,cat:`mobilia`},{id:K.Tocha,name:`tocha`,cat:`mobilia`},{id:K.JanelaXFechada,name:`janela`,cat:`mobilia`},{id:K.Mesa,name:`mesa`,cat:`mobilia`},{id:K.CadeiraXP,name:`cadeira`,cat:`mobilia`},{id:K.SofaXP,name:`sofá`,cat:`mobilia`},{id:K.CamaXP,name:`cama`,cat:`mobilia`},{id:K.QuadroXP,name:`quadro`,cat:`mobilia`},...[`branco`,`preto`,`vermelho`,`laranja`,`amarelo`,`verde`,`azul`,`roxo`,`rosa`,`ciano`,`cinza`,`marrom`].map((e,t)=>({id:K.TapeteBranco+t,name:`tapete ${e}`,cat:`mobilia`})),...[`vermelha`,`amarela`,`azul`,`branca`].map((e,t)=>({id:K.FlorVermelha+t,name:`flor ${e}`,cat:`vegetacao`})),...[``,` seca`,` fria`].map((e,t)=>({id:K.GramaAlta+t,name:`grama alta${e}`,cat:`vegetacao`})),{id:K.MinerioCarvao,name:`minério de carvão`,cat:`minerios`},{id:K.MinerioFerro,name:`minério de ferro`,cat:`minerios`},{id:K.MinerioOuro,name:`minério de ouro`,cat:`minerios`},{id:K.MinerioDiamante,name:`minério de diamante`,cat:`minerios`},{id:K.GramaSeca,name:`grama seca`,cat:`blocos`},{id:K.GramaFria,name:`grama fria`,cat:`blocos`},{id:K.LogIpe,name:`tronco de ipê`,cat:`vegetacao`},{id:K.FolhasIpe,name:`folhas de ipê`,cat:`vegetacao`},{id:K.LogAraucaria,name:`tronco de araucária`,cat:`vegetacao`},{id:K.FolhasAraucaria,name:`folhas de araucária`,cat:`vegetacao`},{id:K.LogPauBrasil,name:`tronco de pau-brasil`,cat:`vegetacao`},{id:K.FolhasPauBrasil,name:`folhas de pau-brasil`,cat:`vegetacao`},{id:K.Mandacaru,name:`mandacaru`,cat:`vegetacao`},...[`branco`,`preto`,`vermelho`,`laranja`,`amarelo`,`verde`,`azul`,`roxo`,`rosa`,`ciano`,`cinza`,`marrom`].map((e,t)=>({id:K.VidroBranco+t,name:`vidro ${e}`,cat:`blocos`})),{id:K.LajePedraBaixo,name:`laje de pedra`,cat:`blocos`},{id:K.LajeTabuaBaixo,name:`laje de tábuas`,cat:`blocos`},{id:K.LajeTijoloBaixo,name:`laje de tijolo`,cat:`blocos`},{id:K.EscadaPedraXP,name:`escada de pedra`,cat:`blocos`},{id:K.EscadaTabuaXP,name:`escada de tábuas`,cat:`blocos`},{id:K.EscadaTijoloXP,name:`escada de tijolo`,cat:`blocos`},{id:901,name:`balde de água`,cat:`ferramentas`}];function _p(e){return e===`professor`?gp:gp.filter(e=>!iu(e.id))}var vp=class{icons;blocks;state;pick;select;onToggle;root=document.getElementById(`inventario`);isOpen=!1;cat=`blocos`;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t,n,r,i,a){this.icons=e,this.blocks=t,this.state=n,this.pick=r,this.select=i,this.onToggle=a,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&$f(`click`)})}get open(){return this.isOpen}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}refresh(){this.isOpen&&this.render()}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`inventário de blocos`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`p`);i.className=`inv-dica`,i.textContent=`clique num bloco pra pôr no slot selecionado · 1–9 ou clique escolhem o slot`;let a=this.blocks(),o=document.createElement(`div`);o.className=`inv-abas`;for(let e of mp){if(!a.some(t=>t.cat===e.id))continue;let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.cat?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.cat=e.id,this.render()}),o.appendChild(t)}let s=document.createElement(`div`);s.className=`inv-grid`;for(let e of a.filter(e=>e.cat===this.cat)){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-bloco`,t.title=e.name;let n=document.createElement(`img`);n.src=this.icons.get(e.id)??``,n.alt=e.name;let r=document.createElement(`small`);r.textContent=e.name,t.append(n,r),t.addEventListener(`click`,()=>{this.pick(e.id),this.render()}),s.appendChild(t)}let c=document.createElement(`div`);c.className=`inv-hotbar`;let{hotbar:l,selected:u}=this.state();l.forEach((e,t)=>{let n=document.createElement(`button`);n.type=`button`,n.className=`inv-slot`+(t===u?` sel`:``);let r=document.createElement(`small`);r.textContent=String(t+1);let i=document.createElement(`img`);i.src=this.icons.get(e)??``,i.alt=``,n.append(r,i),n.addEventListener(`click`,()=>{this.select(t),this.render()}),c.appendChild(n)}),e.append(t,i,o,s,c)}},yp=[`bloco`,`resetpin`,`regiao`,`objetivo`,`grupo`,`mundo`,`tp`,`tpr`,`tpa`,`iniciar`,`hora`,`ciclo`,`voo`,`confinar`,`kicar`,`claim`,`amigos`],bp={regiao:[`criar`,`apagar`,`lista`,`encher`,`sortear`,`carimbar`],objetivo:[`add`,`lista`,`texto`,`mover`,`remover`,`modo`,`resetar`],grupo:[`criar`,`entrar`,`sair`,`lista`],mundo:[`lista`,`atual`,`carregar`],tp:[`grupos`],hora:[`dia`,`noite`,`amanhecer`,`entardecer`,`meio-dia`,`meia-noite`],ciclo:[`ligar`,`desligar`],voo:[`ligar`,`desligar`],confinar:[`ligar`,`desligar`,`status`],claim:[`ligar`,`desligar`,`criar`,`remover`,`lista`],amigos:[`convidar`,`aceitar`,`recusar`,`sair`,`expulsar`,`lista`]},xp=new Set([`kicar`,`resetpin`,`tpr`,`tpa`]),Sp=new Set([`convidar`,`aceitar`,`recusar`,`expulsar`]),Cp=[],wp=[];function Tp(e){Cp=e}function Ep(e){wp=e}function Dp(e,t){return e===`objetivo`&&t===`add`?[`construir`,`chegar`,`limpar`]:e===`objetivo`&&t===`modo`?[`sequencial`,`livre`]:e===`mundo`&&t===`carregar`?Cp:e===`amigos`&&Sp.has(t)?wp:[]}function Op(e){if(e.length===0)return yp.map(e=>`/${e}`);let t=(e[0]??``).replace(/^\//,``);return e.length===1?xp.has(t)?wp:t===`tp`?[`grupos`,...wp]:bp[t]??[]:e.length===2?Dp(t,e[1]??``):[]}var kp=1e4,Ap=50;function jp(){let e=window.visualViewport;if(!e)return;let t=()=>{let t=Math.max(0,window.innerHeight-e.height-e.offsetTop);document.documentElement.style.setProperty(`--kb`,`${Math.round(t)}px`)};e.addEventListener(`resize`,t),e.addEventListener(`scroll`,t),t()}var Mp=class{onToggle;root=document.getElementById(`chat`);log=document.getElementById(`chat-log`);field=document.getElementById(`chat-input`);hint=document.getElementById(`chat-hint`);cycle=null;constructor(e,t){this.onToggle=t,this.field&&(this.field.maxLength=200,jp(),this.field.addEventListener(`keydown`,t=>{if(t.stopPropagation(),t.code===`Tab`){t.preventDefault(),this.autocomplete();return}if(t.code===`Enter`||t.key===`Enter`){let t=this.field?.value.trim()??``;t&&e(t),this.close()}else t.code===`Escape`?this.close():this.resetCycle()}))}get open(){return this.field!==null&&!this.field.classList.contains(`hidden`)}openInput(){this.field&&(this.field.value=``,this.resetCycle(),this.field.classList.remove(`hidden`),this.root?.classList.add(`open`),this.field.focus(),this.scrollarFim(),this.onToggle(!0))}close(){this.field&&(this.field.value=``,this.resetCycle(),this.field.classList.add(`hidden`),this.root?.classList.remove(`open`),this.field.blur(),this.onToggle(!1))}autocomplete(){let e=this.field;if(!e)return;let t=e.value;if(!t.startsWith(`/`))return;if(this.cycle&&t===this.cycle.produced&&this.cycle.matches.length>1){let t=this.cycle;t.index=(t.index+1)%t.matches.length,t.produced=t.base+t.matches[t.index],e.value=t.produced,this.showHint(t.matches,t.index);return}let n=/\s$/.test(t),r=t.replace(/\s+$/,``),i=r.length?r.split(/\s+/):[],a=n?i:i.slice(0,-1),o=n?``:i[i.length-1]??``,s=Op(a).filter(e=>e.toLowerCase().startsWith(o.toLowerCase()));if(s.length===0){this.resetCycle();return}let c=a.length?`${a.join(` `)} `:``;s.length===1?(e.value=`${c}${s[0]} `,this.resetCycle()):(e.value=c+s[0],this.cycle={produced:e.value,matches:s,index:0,base:c},this.showHint(s,0))}showHint(e,t){this.hint&&(this.hint.textContent=``,e.forEach((e,n)=>{let r=document.createElement(`span`);r.textContent=e,n===t&&(r.className=`sel`),this.hint?.appendChild(r)}),this.hint.classList.remove(`hidden`))}resetCycle(){this.cycle=null,this.hint?.classList.add(`hidden`)}addMessage(e,t){if(!this.log)return;let n=document.createElement(`div`);for(n.className=`msg`,n.textContent=`<${e}> ${t}`,this.log.appendChild(n);this.log.childElementCount>Ap;)this.log.firstElementChild?.remove();this.scrollarFim(),setTimeout(()=>n.classList.add(`old`),kp)}scrollarFim(){this.log&&(this.log.scrollTop=this.log.scrollHeight)}},Np=4,Pp=8,Fp=1,Ip=class{onColapso;workers=[];carga=[];prontos=[];proximoId=1;dono=new Map;msTotal=0;profundidadeJogo;constructor(e,t){this.onColapso=e,this.profundidadeJogo=Math.max(1,t??Fp);let n=navigator.hardwareConcurrency??4,r=Math.max(1,Math.min(Np,n-1));for(let e=0;e<r;e++)try{let e=new Worker(new URL(`/assets/meshWorker-DzXSuCs-.js`,``+import.meta.url),{type:`module`});e.onmessage=e=>{let t=e.data,n=this.dono.get(t.id);n!==void 0&&(this.carga[n]=Math.max(0,(this.carga[n]??0)-1),this.dono.delete(t.id)),this.msTotal+=t.ms,this.prontos.push(t)},e.onerror=()=>this.colapsar(),this.workers.push(e),this.carga.push(0)}catch{break}}get disponivel(){return this.workers.length>0}get config(){return{workers:this.workers.length,profundidadeJogo:this.profundidadeJogo,profundidadeCarga:Pp}}get emVoo(){return this.dono.size}get prontosPendentes(){return this.prontos.length}modoCarga=!0;get temVaga(){let e=this.modoCarga?Pp:this.profundidadeJogo;return this.disponivel&&this.emVoo<this.workers.length*e}enviar(e){if(e.length!==ed)throw Error(`vizinhança ${e.length} ≠ ${ed}`);let t=0;for(let e=1;e<this.workers.length;e++)(this.carga[e]??0)<(this.carga[t]??0)&&(t=e);let n=this.proximoId++;return this.dono.set(n,t),this.carga[t]=(this.carga[t]??0)+1,this.workers[t].postMessage({id:n,viz:e},[e.buffer]),n}colher(){return this.prontos.shift()}colapsar(){let e=[...this.dono.keys()];for(let e of this.workers)e.terminate();this.workers=[],this.carga=[],this.dono.clear(),this.prontos=[],console.warn(`[mesh] pool de workers caiu — ${e.length} chunks voltam pro caminho síncrono`),this.onColapso?.(e)}encerrar(){for(let e of this.workers)e.terminate();this.workers=[],this.carga=[],this.dono.clear(),this.prontos=[]}},Lp=64,Rp={positions:new Float32Array,normals:new Float32Array,uvs:new Float32Array,sway:new Uint8Array,indices:new Uint32Array,opaqueIndexCount:0,aguaIndexCount:0},zp=class{world;materials;scene;meshes=new Map;fila=[];filaSet=new Set;remeshCount=0;remeshMsTotal=0;lastRemeshMs=0;porCaminho={fila:{n:0,ms:0},bloco:{n:0,ms:0},area:{n:0,ms:0}};caminho=`bloco`;pool=null;versaoAtual=new Map;seq=0;emVoo=new Map;chavesEmVoo=new Set;sujosEmVoo=new Set;onFalha;get remeshWorkerMsTotal(){return this.pool?.msTotal??0}get meshConfig(){return this.pool?.config??null}set modoCarga(e){this.pool&&(this.pool.modoCarga=e)}constructor(e,t,n,r=!0,i){if(this.world=e,this.materials=t,this.scene=n,r&&typeof Worker<`u`){let e=new Ip(e=>{this.chavesEmVoo.clear(),this.sujosEmVoo.clear();for(let t of e){let e=this.emVoo.get(t);e&&this.enfileirar(e.cx,e.cy,e.cz)}this.emVoo.clear(),this.pool=null},i);this.pool=e.disponivel?e:null}}novaVersao(e){let t=++this.seq;return this.versaoAtual.set(e,t),t}trocarMundo(e,t=!0){for(let e of this.meshes.values())this.scene.remove(e),e.geometry.dispose();this.meshes.clear(),this.versaoAtual.clear(),this.fila.length=0,this.filaSet.clear(),this.sujosEmVoo.clear(),this.chavesEmVoo.clear(),this.world=e,t&&this.buildAll()}buildAll(){this.caminho=`fila`;for(let e=0;e<this.world.dims.y;e++)for(let t=0;t<this.world.dims.z;t++)for(let n=0;n<this.world.dims.x;n++)this.remesh(n,e,t)}remesh(e,t,n){let r=performance.now(),i=pu(this.world,e,t,n);this.novaVersao(i);let a=id(this.world,e,t,n);this.aplicar(i,e,t,n,a),this.contabilizar(performance.now()-r)}aplicar(e,t,n,r,i){let a=this.meshes.get(e);if(a&&(this.scene.remove(a),a.geometry.dispose(),this.meshes.delete(e)),i.indices.length===0)return;let o=new fr;o.setAttribute(`position`,new Zn(i.positions,3)),o.setAttribute(`normal`,new Zn(i.normals,3)),o.setAttribute(`uv`,new Zn(i.uvs,2)),o.setAttribute(`sway`,new Zn(i.sway,1,!0)),o.setIndex(new Zn(i.indices,1));let s=i.opaqueIndexCount+i.aguaIndexCount;o.addGroup(0,i.opaqueIndexCount,0),o.addGroup(i.opaqueIndexCount,i.aguaIndexCount,1),o.addGroup(s,i.indices.length-s,2);let c=new ei(o,this.materials);c.position.set(t*16,n*16,r*16),this.scene.add(c),this.meshes.set(e,c)}contabilizar(e){this.lastRemeshMs=e,this.remeshMsTotal+=e,this.remeshCount++;let t=this.porCaminho[this.caminho];t.n++,t.ms+=e}remeshBox(e,t){this.caminho=`area`;let n=(e,t)=>Math.max(0,Math.min(Math.floor(e/16),t-1)),r=n(e.x-1,this.world.dims.x),i=n(t.x+1,this.world.dims.x),a=n(e.y-1,this.world.dims.y),o=n(t.y+1,this.world.dims.y),s=n(e.z-1,this.world.dims.z),c=n(t.z+1,this.world.dims.z);for(let e=a;e<=o;e++)for(let t=s;t<=c;t++)for(let n=r;n<=i;n++)this.remesh(n,e,t)}enfileirar(e,t,n){let r=pu(this.world,e,t,n);if(!this.filaSet.has(r)){if(this.chavesEmVoo.has(r)){this.sujosEmVoo.add(r);return}this.filaSet.add(r),this.fila.push({cx:e,cy:t,cz:n})}}enfileirarColuna(e,t){let n=(e,t,n)=>this.enfileirar(e,t,n);for(let r=0;r<this.world.dims.y;r++)n(e,r,t);for(let[r,i]of[[1,0],[-1,0],[0,1],[0,-1]]){let a=e+r,o=t+i;if(!(a<0||o<0||a>=this.world.dims.x||o>=this.world.dims.z)&&this.world.chunks[pu(this.world,a,0,o)])for(let e=0;e<this.world.dims.y;e++)n(a,e,o)}}processarFila(e,t){this.caminho=`fila`,this.onFalha=t;let n=performance.now()+e,r=0;if(this.pool){let e=this.pool.colher();for(;e&&r<Lp;){let t=performance.now(),i=this.emVoo.get(e.id);if(this.emVoo.delete(e.id),i&&(this.chavesEmVoo.delete(i.key),this.sujosEmVoo.delete(i.key)&&this.enfileirar(i.cx,i.cy,i.cz),e.erro?(console.warn(`[mesh] chunk ${i.cx},${i.cy},${i.cz} falhou no worker: ${e.erro}`),this.onFalha?.(i.cx,i.cz)):this.versaoAtual.get(i.key)===i.versao&&this.aplicar(i.key,i.cx,i.cy,i.cz,{positions:e.positions,normals:e.normals,uvs:e.uvs,sway:e.sway,indices:e.indices,opaqueIndexCount:e.opaqueIndexCount,aguaIndexCount:e.aguaIndexCount}),this.contabilizar(i.msExtracao+(performance.now()-t))),++r>=1&&performance.now()>=n)break;e=this.pool.colher()}for(;this.fila.length>0&&this.pool.temVaga&&r<Lp;){let e=this.fila.shift(),t=pu(this.world,e.cx,e.cy,e.cz);this.filaSet.delete(t);let i=performance.now(),a=this.novaVersao(t),o;try{o=rd(this.world,e.cx,e.cy,e.cz)}catch(t){console.warn(`[mesh] vizinhança ${e.cx},${e.cy},${e.cz} falhou:`,t),this.onFalha?.(e.cx,e.cz);continue}if(!o)this.aplicar(t,e.cx,e.cy,e.cz,Rp),this.contabilizar(performance.now()-i);else{let n=this.pool.enviar(o);this.emVoo.set(n,{key:t,cx:e.cx,cy:e.cy,cz:e.cz,versao:a,msExtracao:performance.now()-i}),this.chavesEmVoo.add(t)}if(++r>=1&&performance.now()>=n)break}this.ultimoLote=r;return}for(;this.fila.length>0&&r<Lp;){let e=this.fila.shift();this.filaSet.delete(pu(this.world,e.cx,e.cy,e.cz));try{this.remesh(e.cx,e.cy,e.cz)}catch(n){console.warn(`[mesh] chunk ${e.cx},${e.cy},${e.cz} falhou:`,n),t?.(e.cx,e.cz)}if(++r>=1&&performance.now()>=n)break}this.ultimoLote=r}ultimoLote=0;get filaPendente(){return this.fila.length+(this.pool?.emVoo??0)+(this.pool?.prontosPendentes??0)}descartarColuna(e,t){for(let n=0;n<this.world.dims.y;n++){let r=pu(this.world,e,n,t);this.versaoAtual.delete(r),this.sujosEmVoo.delete(r);let i=this.meshes.get(r);i&&(this.scene.remove(i),i.geometry.dispose(),this.meshes.delete(r))}}remeshBlock(e,t,n){this.caminho=`bloco`;let r=e/16|0,i=t/16|0,a=n/16|0;this.remesh(r,i,a);let o=e-r*16,s=t-i*16,c=n-a*16;o===0&&r>0&&this.remesh(r-1,i,a),o===15&&r<this.world.dims.x-1&&this.remesh(r+1,i,a),s===0&&i>0&&this.remesh(r,i-1,a),s===15&&i<this.world.dims.y-1&&this.remesh(r,i+1,a),c===0&&a>0&&this.remesh(r,i,a-1),c===15&&a<this.world.dims.z-1&&this.remesh(r,i,a+1)}},Bp=(e,t,n,r,i)=>({hora:e,ceu:new U(t),sol:new U(n),solInt:r,ambInt:i}),Vp=[Bp(0,263695,3819392,.14,.3),Bp(4.5,660016,4544666,.18,.31),Bp(5.5,2569582,8022682,.35,.34),Bp(6.5,14715470,16763274,1.15,.44),Bp(7.5,11062764,16772300,1.9,.5),Bp(12,8900331,16777215,2.4,.55),Bp(16.5,9421800,16774106,2.1,.51),Bp(17.8,14260572,16760954,1.5,.46),Bp(18.7,14248516,16747093,.9,.4),Bp(19.6,1778768,4871568,.3,.33),Bp(21,659494,3819392,.17,.3),Bp(24,263695,3819392,.14,.3)],Hp=420,Up=460,Wp=400,Gp=100,Kp=1400,qp=260,Jp=9,Yp=128;function Xp(e,t,n){let r=(e%n+n)%n,i=(t%n+n)%n,a=Math.imul(r,374761393)^Math.imul(i,668265263);return a=Math.imul(a^a>>>13,1274126177),((a^a>>>16)>>>0)/4294967296}function Zp(e,t,n){let r=e*n,i=t*n,a=Math.floor(r),o=Math.floor(i),s=r-a,c=i-o,l=s*s*(3-2*s),u=c*c*(3-2*c),d=Xp(a,o,n),f=Xp(a+1,o,n),p=Xp(a,o+1,n),m=Xp(a+1,o+1,n);return(d+(f-d)*l)*(1-u)+(p+(m-p)*l)*u}function Qp(){let t=Yp,n=document.createElement(`canvas`);n.width=n.height=t;let r=n.getContext(`2d`);if(!r)throw Error(`canvas 2d indisponível`);let i=r.createImageData(t,t);for(let e=0;e<t;e++)for(let n=0;n<t;n++){let r=n/t,a=e/t,o=Zp(r,a,3)*.52+Zp(r,a,6)*.26+Zp(r,a,12)*.14+Zp(r,a,24)*.08,s=Math.min(1,Math.max(0,(o-.44)/.17)),c=(e*t+n)*4;i.data[c]=255,i.data[c+1]=255,i.data[c+2]=255,i.data[c+3]=Math.round(s*235)}r.putImageData(i,0,0);let a=new Ni(n);a.wrapS=a.wrapT=e;let o=Kp/qp;return a.repeat.set(o,o),a}var $p=new U,em=new U,tm=e=>Math.min(Math.max(e,0),1),nm=class{sun;ambient;scene;camera;hora=12;ciclo=!1;nuvemScrollU=0;nuvemScrollV=0;skyGroup=new ln;sunDisc;sunGlow;moonDisc;stars;nuvens;sunMat;glowMat;moonMat;starsMat;nuvemMat;nuvemTex;constructor(e,t,n,r,i=!0){this.sun=e,this.ambient=t,this.scene=n,this.camera=r,this.sunMat=new Hr({color:16768875,transparent:!0,depthWrite:!1}),this.sunDisc=new ei(new Ri(30,24),this.sunMat),this.glowMat=new Hr({color:16756816,transparent:!0,opacity:.28,depthWrite:!1,blending:2}),this.sunGlow=new ei(new Ri(52,24),this.glowMat),this.moonMat=new Hr({color:14673650,transparent:!0,depthWrite:!1}),this.moonDisc=new ei(new Ri(20,24),this.moonMat);let a=new Float32Array(Wp*3),o=20260719,s=()=>(o=Math.imul(o,1664525)+1013904223>>>0,o/4294967296);for(let e=0;e<Wp;e++){let t=s()*2-1,n=s()*Math.PI*2,r=Math.sqrt(1-t*t);a[e*3]=Math.cos(n)*r*Up,a[e*3+1]=t*Up,a[e*3+2]=Math.sin(n)*r*Up}let c=new fr;c.setAttribute(`position`,new Zn(a,3)),this.starsMat=new Ti({color:15922431,size:2,sizeAttenuation:!1,transparent:!0,opacity:0,depthWrite:!1}),this.stars=new Ai(c,this.starsMat),this.nuvemTex=Qp(),this.nuvemMat=new Hr({map:this.nuvemTex,transparent:!0,alphaTest:.02,depthWrite:!1,side:2,fog:!1}),this.nuvens=new ei(new Wi(Kp,Kp),this.nuvemMat),this.nuvens.rotation.x=-Math.PI/2,this.nuvens.position.y=Gp,this.nuvens.visible=i,this.skyGroup.add(this.sunDisc,this.sunGlow,this.moonDisc,this.stars,this.nuvens),n.add(this.skyGroup)}setNuvens(e){this.nuvens.visible=e}dispose(){this.nuvemTex.dispose(),this.nuvemMat.dispose(),this.nuvens.geometry.dispose()}sync(e,t){Number.isFinite(e)&&(this.hora=(e%24+24)%24),this.ciclo=t}update(e,t){if(this.ciclo&&(this.hora=(this.hora+e*24/uu)%24),t&&this.nuvens.visible){let n=e*Jp*t.forca/qp;this.nuvemScrollU-=t.x*n,this.nuvemScrollV+=t.z*n}this.apply()}apply(){let e=this.hora,t=Vp[0],n=Vp[Vp.length-1];for(let r=0;r<Vp.length-1;r++)if(e>=Vp[r].hora&&e<=Vp[r+1].hora){t=Vp[r],n=Vp[r+1];break}let r=n.hora-t.hora||1,i=tm((e-t.hora)/r);i=i*i*(3-2*i),$p.copy(t.ceu).lerp(n.ceu,i),this.scene.background.copy($p),em.copy(t.sol).lerp(n.sol,i),this.sun.color.copy(em),this.sun.intensity=t.solInt+(n.solInt-t.solInt)*i,this.ambient.intensity=t.ambInt+(n.ambInt-t.ambInt)*i;let a=(e-6)/12*Math.PI,o=Math.cos(a),s=Math.sin(a);this.sun.position.set(o*100,Math.max(s*100,-40),40),this.skyGroup.position.copy(this.camera.position);let c=Math.hypot(o,s,.35),l=o/c*Hp,u=s/c*Hp,d=.35/c*Hp;this.sunDisc.position.set(l,u,d),this.sunGlow.position.set(l,u,d),this.moonDisc.position.set(-l,-u,d),this.sunDisc.lookAt(this.camera.position),this.sunGlow.lookAt(this.camera.position),this.moonDisc.lookAt(this.camera.position);let f=tm((s+.14)/.28);this.sunMat.opacity=f,this.glowMat.opacity=.28*f,this.sunDisc.visible=this.sunGlow.visible=f>0;let p=tm((-s+.14)/.28);this.moonMat.opacity=.92*p,this.moonDisc.visible=p>0;let m=tm((-s-.08)/.3);this.starsMat.opacity=m,this.stars.visible=m>0,this.stars.rotation.z=a*.5,this.nuvens.visible&&(this.nuvemMat.color.copy(em).multiplyScalar(.92),this.nuvemMat.opacity=.5+.35*tm(s+.35),this.nuvemTex.offset.set(this.camera.position.x/qp+this.nuvemScrollU,-this.camera.position.z/qp+this.nuvemScrollV))}},rm=Math.PI*2,im=2,am=class{dir=0;forca=0;ativo=!1;fase=0;alvoDir=0;alvoForca=0;sync(e,t,n){Number.isFinite(e)&&(this.alvoDir=(e%rm+rm)%rm),Number.isFinite(t)&&(this.alvoForca=Math.min(1,Math.max(0,t))),this.ativo=n}update(e){let t=1-Math.exp(-e*im),n=this.alvoDir-this.dir;n>Math.PI&&(n-=rm),n<-Math.PI&&(n+=rm),this.dir=(this.dir+n*t+rm)%rm,this.forca+=(this.alvoForca-this.forca)*t,this.fase+=e*(.35+this.forca*.4)}get x(){return Math.cos(this.dir)}get z(){return Math.sin(this.dir)}get setor(){return Math.floor(this.dir/(rm/8))%8}get ondaAgua(){return Iu(this.dir)}};function om(e,t){e.onBeforeCompile=e=>{e.uniforms.ventoTempo=t.ventoTempo,e.uniforms.ventoDir=t.ventoDir,e.uniforms.ventoForca=t.ventoForca,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
`;function wm(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function Tm(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function Em(e){return`${(e/1e3).toFixed(1)} s`}var Dm=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=Cm,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(Sm*.25).toFixed(1)} ${Sm.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,Sm.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(Sm*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=Em(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${Em(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=wm(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=Tm(n.bytes)}e.forcar.classList.toggle(`hidden`,o<bm||this.fase===`pronto`)}},Om={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`}},km={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`},Am=`lj-config`;function jm(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function Mm(e,t){return typeof e==`boolean`?e:t}function Nm(){let e=null;try{e=JSON.parse(localStorage.getItem(Am)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...Om.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:jm(t.sensitivity,Om.sensitivity,.2,3),fov:jm(t.fov,Om.fov,60,100),pixelRatioCap:jm(t.pixelRatioCap,Om.pixelRatioCap,1,2),volume:jm(t.volume,Om.volume,0,1),raioRender:jm(t.raioRender,Om.raioRender,2,12),meshMsPorFrame:jm(t.meshMsPorFrame,Om.meshMsPorFrame,1,16),uiScale:jm(t.uiScale,Om.uiScale,.6,1.8),nuvens:Mm(t.nuvens,Om.nuvens),balanco:Mm(t.balanco,Om.balanco),keys:r}}function Pm(e){localStorage.setItem(Am,JSON.stringify(e))}function Fm(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var Im=`logica-em-jogo`,Lm=`worlds`;function Rm(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var zm=null;function Bm(){return zm??=new Promise((e,t)=>{let n=indexedDB.open(Im,1);n.onupgradeneeded=()=>{n.result.createObjectStore(Lm,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),zm}async function Vm(){return(await Rm((await Bm()).transaction(Lm).objectStore(Lm).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function Hm(e){await Rm((await Bm()).transaction(Lm,`readwrite`).objectStore(Lm).put(e))}async function Um(e){await Rm((await Bm()).transaction(Lm,`readwrite`).objectStore(Lm).delete(e))}function Wm(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function Gm(e){let t=await e.arrayBuffer();tf(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function Km(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function qm(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var Jm=`
:root { --ts: 1; }
...
`,Ym=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Jm,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.tapButton(`⛶`,`tela cheia`,()=>qm()),this.tapButton(`📊`,`hud`,()=>this.actions.hud())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){document.documentElement.style.setProperty(`--ts`,String(e))}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},Xm=`lj-nome`;function Zm(){let e=localStorage.getItem(Xm),t=e?yu(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(Xm,t),t}function Qm(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function $m(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function eh(e){document.getElementById(e)?.classList.add(`hidden`)}function th(e){let t=Qm(`menu`),n={home:Qm(`menu-home`),worlds:Qm(`menu-worlds`),multi:Qm(`menu-multi`),config:Qm(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),Qm(`menu-version`).textContent=`v${af}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&$f(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),$m(`menu-erro`,i));let a=Qm(`menu-nome`);a.value=Zm(),a.addEventListener(`change`,()=>{let e=yu(a.value);localStorage.setItem(Xm,e),a.value=e}),Qm(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),Qm(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),Qm(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=Qm(`menu-world-list`);async function c(){let e=[];try{e=await Vm()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>Wm(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){Um(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=Qm(`menu-new-nome`),u=Qm(`menu-new-tipo`);Qm(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){$m(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}eh(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:Eu(u.value),tamanho:Du(Qm(`menu-new-tamanho`).value)})});let d=Qm(`menu-import-file`);Qm(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&Gm(e).then(async e=>{await Hm(e),await c(),eh(`menu-worlds-erro`)}).catch(e=>{$m(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=Qm(`menu-endereco`),p=Qm(`menu-pin`),m=Qm(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,Qm(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){$m(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){$m(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}eh(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),nh(Qm(`menu-config-body`),void 0,()=>r(`home`))}function nh(e,t,n){ah(e,t,n)}function rh(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var ih=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function ah(e,t,n){e.textContent=``;for(let r of ih){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>oh(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{Pm(structuredClone(Om)),t?.(),ah(e,t,n)}),e.appendChild(r),n&&rh(e,n)}function oh(e,t,n,r){e.textContent=``;let i=Nm(),a=()=>{Pm(i),n?.()},o=document.createElement(`h2`);o.textContent=ih.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),Km()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(km)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=km[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=Fm(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=Fm(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Zf(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>$f(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t);let r=(t,n,r)=>{let i=document.createElement(`label`);i.className=`config-row`,i.textContent=`${t} `;let o=document.createElement(`input`);o.type=`checkbox`,o.checked=n,o.addEventListener(`change`,()=>{r(o.checked),a()}),i.appendChild(o),e.appendChild(i)};r(`nuvens no céu`,i.nuvens,e=>i.nuvens=e),r(`balanço de folhas e grama`,i.balanco,e=>i.balanco=e),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`tempo de montagem de malha por frame`,1,16,1,i.meshMsPorFrame,e=>i.meshMsPorFrame=e,e=>`${e} ms`)}rh(e,()=>ah(e,n,r))}var sh=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},ch=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&$f(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},lh=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&$f(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},uh=class extends lh{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(gp[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=bu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=bu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...gp.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},dh=class extends lh{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},fh=class{fixedColor;group=new ln;cornerMarks=[];boxes=[];constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new wi(new Ui(new Li(1.01,1.01,1.01)),new fi({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new wi(new Ui(new Li(n+.04,r+.04,i+.04)),new fi({color:this.fixedColor??new U().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a})}},ph=1/16,mh=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*ph-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*ph-.004,ry:Math.PI}];function hh(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var gh=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(wd(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=wd(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=gu(t,e.x,e.y,e.z);if(!Rl(r))return;let i=mh[r-K.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,hh(a,e,null);let o=new Ni(a);o.colorSpace=Re;let s=new ei(new Wi(12*ph,12*ph),new Hr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{hh(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=wd(e,t,n);if(this.conteudos.has(a))if(!Rl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Rl(gu(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function _h(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var vh=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,_h(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},yh=null;function bh(e){e.preventDefault(),e.returnValue=``}var xh=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function Sh(e){yh?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||xh.has(e.code))&&e.preventDefault())}function Ch(e){yh?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function wh(e){yh||(yh=e,window.addEventListener(`beforeunload`,bh),window.addEventListener(`keydown`,Sh,!0),window.addEventListener(`keyup`,Ch,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function Th(){yh=null,window.removeEventListener(`beforeunload`,bh),window.removeEventListener(`keydown`,Sh,!0),window.removeEventListener(`keyup`,Ch,!0),navigator.keyboard?.unlock?.()}var Eh=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Ni(t);i.minFilter=o,this.material=new vr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[pu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===K.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===K.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===K.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Mr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function Dh(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Tp(n)}var Oh=new _l({antialias:!0});Oh.setPixelRatio(Math.min(window.devicePixelRatio,2)),Oh.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Oh.domElement);var kh=new vn;kh.background=new U(8900331);var Ah=new Ma(75,window.innerWidth/window.innerHeight,.1,512);Ah.rotation.order=`YXZ`;var jh=new Fa(16777215,2.2);jh.position.set(60,100,40);var Mh=new Ia(16777215,.55);kh.add(jh,Mh);var Nh=new nm(jh,Mh,kh,Ah),Ph=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();Ph!==null&&Nh.sync(Ph,!1);var Fh=new am,Ih=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();Ih&&Fh.sync(Ih.dir,Ih.forca,!0);var Lh=sm(),$=new ym(Oh.domElement),Rh=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},zh=Rh(`yaw`),Bh=Rh(`pitch`);zh!==null&&($.yaw=zh),Bh!==null&&($.pitch=Bh);var Vh=lp(new URLSearchParams(location.search));function Hh(){let e=Vh?{...Nm(),...up(Vh)}:Nm();return $.sensitivity=e.sensitivity,Ah.fov=e.fov,Ah.updateProjectionMatrix(),Oh.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Zf(e.volume),Uh?.setScale(e.uiScale),Nh.setNuvens(e.nuvens),e}var Uh=null,Wh=Hh();tp(Wh.volume);var Gh=null,Kh=null,qh=null,Jh=new Dm(()=>{rg(),Zh?.setFase(`jogando`),Zh?.marcar(`carga concluída`),Yh?.()}),Yh=null,Xh=!1,Zh=null,Qh=document.getElementById(`overlay`),$h=document.getElementById(`overlay-main`),eg=document.getElementById(`overlay-config`),tg=document.getElementById(`crosshair`);function ng(){$h?.classList.remove(`hidden`),eg?.classList.add(`hidden`)}function rg(){let e=(Gh?.open??!1)||(Kh?.open??!1)||(qh?.open??!1);Qh?.classList.toggle(`hidden`,Xh||Jh.ativo||$.active||fg.open||e),tg?.classList.toggle(`hidden`,!$.active),$.locked&&ng(),Uh?.setShown($.touch&&!fg.open&&!e&&!Jh.ativo)}document.addEventListener(`pointerlockchange`,rg);function ig(){Km()?($.touch=!0,qm(),rg()):$.lock()}function ag(){let e=Wh.keys;Wh=Hh();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],Wh.keys[t]);sg()}var og=-1;function sg(){if(!cg||Wh.raioRender===og)return;let e=og;og=Wh.raioRender,cg.send(JSON.stringify({type:`radius`,chunks:og})),Zh?.marcar(`raio`,`${e<0?`join`:e} → ${og}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>ig()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&nh(e,ag,ng),$h?.classList.add(`hidden`),eg?.classList.remove(`hidden`)}),Qh?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&$f(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{Ah.aspect=window.innerWidth/window.innerHeight,Ah.updateProjectionMatrix(),Oh.setSize(window.innerWidth,window.innerHeight)});var cg=null,lg=`?`,ug=null;function dg(){return new URLSearchParams(location.search).get(`nome`)??Zm()}var fg=new Mp(e=>cg?.send(JSON.stringify({type:`chat`,text:e})),e=>{rg(),e||$.lock()});rg(),Oh.domElement.addEventListener(`pointerdown`,()=>{$.touch&&fg.open&&fg.close()});var pg={tickAvgMs:0,tickMaxMs:0},mg=null,hg=0,gg=[];function _g(){let e=performance.now();hg>0&&(gg.push(e-hg),gg.length>300&&gg.shift()),hg=e}function vg(){let e=gg.length;if(e<2)return 0;let t=gg.reduce((e,t)=>e+t,0)/e,n=gg.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var yg=!1,bg=null,xg=null,Sg=null,Cg=null,wg=null,Tg=null,Eg=null,Dg=`aluno`,Og=!1,kg=!1;function Ag(){return Dg===`professor`||Og}var jg=[],Mg=null,Ng=!1,Pg=[],Fg=null,Ig=null,Lg=null,Rg=new sh,zg=null,Bg=null,Vg=null,Hg=[],Ug=new Set,Wg=!1,Gg=null,Kg=null,qg=!1,Jg=new Map;function Yg(){Gh?.update({regions:jg,modo:zg?.modo??`sequencial`,objetivos:zg?.objetivos??[],grupos:Hg,myGrupo:Vg})}function Xg(e){return e.porGrupo&&Dg!==`professor`?Vg===null?!1:e.porGrupo.find(e=>e.grupo===Vg)?.completo??!1:e.completo}function Zg(e){if(zg){for(let t of zg.objetivos)Xg(t)?Ug.has(t.id)||(Ug.add(t.id),e&&Wg&&Kf({kind:`objective_complete`})):Ug.delete(t.id);Wg=!0,Rg.update(zg.modo,zg.objetivos,{grupo:Vg,professor:Dg===`professor`,painelKey:Fm(Wh.keys.painel)}),Bg?.(zg.objetivos)}}var Qg=null;function $g(){let e=Qg;if(e){Qg=null;for(let t of e)t_(t)}}function e_(){Qg||(Qg=[],requestAnimationFrame(()=>requestAnimationFrame($g)),setTimeout($g,500))}function t_(e){if(Qg){Qg.push(e);return}if(_g(),yg||Jh.setFase(`mundo`),typeof e==`string`){let t=Gd(e);if(!t)return;t.type===`debug_stats`?(pg={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},mg=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0}):t.type===`block_changed`?bg?.(t):t.type===`blocks_filled`?xg?.(t):t.type===`player_moved`?(t.name&&Jg.get(t.id)!==t.name&&(Jg.set(t.id,t.name),Ep([...new Set(Jg.values())])),Sg?.(t)):t.type===`player_left`?(Jg.delete(t.id),Ep([...new Set(Jg.values())]),Cg?.(t.id)):t.type===`spawn`?(Eg={x:t.x,y:t.y,z:t.z},Dg=t.papel??`aluno`):t.type===`regions`?(jg=t.regions,Mg?.(t.regions),Yg()):t.type===`objectives`?(zg={modo:t.modo,objetivos:t.objetivos},Zg(!0),Yg()):t.type===`group`?(Vg=t.grupo,Ug.clear(),Zg(!1),Yg()):t.type===`groups`?(Hg=t.grupos,Yg()):t.type===`quadros`?Ig?.(t.lista):t.type===`quadro_changed`?Lg?.(t):t.type===`claims`?(Ng=t.ativo,Pg=t.claims,Fg?.(t.claims)):t.type===`friends`||(t.type===`players`?qh?.update({conectados:t.conectados,banidos:t.banidos}):t.type===`mundo_trocando`?(wg?.(t.nome),e_()):t.type===`teleport`?Tg?.(t):t.type===`time`?Ph===null&&Nh.sync(t.hora,t.ciclo):t.type===`vento`?Ih===null&&Fh.sync(t.dir,t.forca,t.ativo):t.type===`voo`?(Og=t.liberado,Ag()||(kg=!1),fg.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?($f(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),Th(),location.href=location.pathname):t.type===`join_denied`?($f(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),Th(),location.href=location.pathname):t.type===`chat`&&(fg.addMessage(t.author,t.text),t.author===`servidor`&&Dh(t.text),Kf({kind:`chat_message`})));return}let t=Yd(e);if(t===809716300){Kg?.(e);return}let n=()=>(qg=t===qd,qg?Xd(e):Kd(e));if(yg){Gg?.(n());return}yg=!0,c_(n())}function n_(e,t){Wh=Hh(),cg=e,Jh.abrir({host:lg,rede:!(e instanceof cm)}),Jh.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),rg(),e.onMessage(t_),$.onKey(Wh.keys.chat,()=>{fg.open||(document.exitPointerLock(),fg.openInput())}),e.send(JSON.stringify({type:`join`,name:dg(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),og=-1,sg()}function r_(e,t){lg=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),n_(new lm(e,t=>{yg||!Jh.ativo||Jh.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function i_(e,t){ug={id:e.id,name:e.name,createdAt:e.createdAt},lg=`web-worker (${e.name})`;let n=new cm(new Worker(new URL(`/assets/worker-DLhUghOl.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho}),n_(n)}async function a_(){if(!(cg instanceof cm)||!ug)return;let e=await cg.requestSave();await Hm({...ug,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{Th(),a_().finally(()=>location.reload())});var o_=new URLSearchParams(location.search),s_=o_.get(`server`);if(s_){let e=o_.get(`codigo`);r_(s_,{pin:o_.get(`pin`)??``,...e?{codigo:e}:{}})}else Vh?i_({id:`bench-${np}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:Du(o_.get(`tamanho`)??`E`)},np):th({onPlayWorld:i_,onPlayMulti:r_});function c_(e){let t=cg;if(!t)return;wh(()=>$.active);let n=e.world,r=e.seed,i=qg,a=new Set,s=0,c=new Map,l=0,u=0,d=0,f=zf(),p=new ta({map:f,alphaTest:.5});om(p,Lh);let m=new ta({map:f,transparent:!0,opacity:.72,depthWrite:!1}),h=new ta({map:f,transparent:!0,opacity:.4,depthWrite:!1});if(new URLSearchParams(location.search).has(`atlas`)){let e=p.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let g=new URLSearchParams(location.search),_=g.has(`semworker`),v=Number(g.get(`meshdepth`)),y=new zp(n,[p,m,h],kh,!_,Number.isFinite(v)&&v>0?v:void 0),b=new Hf(kh),x=-1,S=0,C=-1,w=-1;i||y.buildAll(),Kg=e=>{let t=[];try{t=Qd(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;a.add(t),c.delete(t),y.enfileirarColuna(e,r),E.varrerColuna(n,e,r)}u+=t.length};let T=(e,r,i)=>{let o=n.dims,s=Wh.raioRender,u=0;for(let d=e-s;d<=e+s;d++)for(let e=r-s;e<=r+s;e++){if(d<0||e<0||d>=o.x||e>=o.z)continue;let r=e*o.x+d;if(a.has(r))continue;let s=c.get(r);if(!s){c.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||u>=4)){y.descartarColuna(d,e),E.descartarColuna(d,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+d]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:d,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),u++,l++}}for(let t of c.keys()){let n=t%o.x,i=(t-n)/o.x;(a.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&c.delete(t)}},E=new Eh(kh);E.setFromWorld(n);let D=new fh(kh);D.setRegions(jg),Mg=e=>{D.setRegions(e),D.clearCorners()};let ee=new fh(kh,16747546),te=e=>{ee.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};te(Pg),Fg=e=>{te(e),D.clearCorners(),!Ng&&Dg!==`professor`&&ve&&(ve=!1),Se()};let O=new gh(kh),ne=new vh;Ig=e=>O.setAll(e,n),Lg=e=>O.aplicar(e,n);let k=new fh(kh,3066993),A=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Vg!==null&&r.grupo===Vg;(Dg===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});k.setRegions(t)};Bg=A,zg&&A(zg.objetivos);let re=e=>t.send(JSON.stringify({type:`chat`,text:e})),ie=e=>{e?document.exitPointerLock():$.lock(),rg()};Dg===`professor`&&(qh=new ch(re,ie)),Gh=Dg===`professor`?new uh(re,ie,()=>{Gh?.hide(),Kh?.hide(),qh?.show()}):new dh(re,ie),Yg(),$.onKey(Wh.keys.painel,()=>{if(!fg.open){if(Dg!==`professor`&&Hg.length===0){fg.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}Kh?.hide(),qh?.hide(),Gh?.toggle()}}),Dg===`professor`&&fg.addMessage(`jogo`,`tecla ${Fm(Wh.keys.painel)} abre o painel de autoria`);let j=Eg??{x:n.sizeX/2+.5,y:vu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},M=ud(j.x,j.y,j.z),ae=()=>{if(!i)return 0;let e=Wh.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(M.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(M.pos.z/16))),a=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,o=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,a*o)},oe=ae(),se=()=>{Jh.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:a.size,total:oe,faltando:c.size>0?c.size:Math.max(0,oe-a.size),fila:y.filaPendente}))};se(),Jh.setFase(i?`mundo`:`malha`),wg=e=>{oe=0,Jh.abrir({host:lg,rede:!(t instanceof cm),titulo:`trocando de aula`,alvo:e}),se(),Jh.setFase(`preparando`),Te.setFase(`carregando`),Te.marcar(`troca de aula`,e),rg()};function ce(){M.pos.x=j.x,M.pos.y=j.y,M.pos.z=j.z,M.vel.x=M.vel.y=M.vel.z=0}Gg=e=>{n=e.world,r=e.seed,i=qg,a=new Set,c.clear(),y.trocarMundo(n,!i),E.setFromWorld(n),jg=[],D.setRegions([]),D.clearCorners(),O.setAll([],n),zg=null,Bg?.([]),Rg.update(`livre`,[],{grupo:null,professor:Dg===`professor`,painelKey:Fm(Wh.keys.painel)}),Ug.clear(),Wg=!1,Hg=[],Vg=null,Yg(),j=Eg??j,ce(),fg.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),og=-1,sg(),Te.setMeta({worldChunks:n.dims,worldSeed:e.seed}),oe=ae(),Jh.abrir({host:lg,rede:!(t instanceof cm),titulo:`trocando de aula`}),se(),Jh.setFase(i?`mundo`:`malha`),Te.setFase(`carregando`),rg(),i||Jh.concluir()},Tg=e=>{M.pos.x=e.x,M.pos.y=e.y,M.pos.z=e.z,M.vel.x=M.vel.y=M.vel.z=0,$.yaw=zh??e.yaw,$.pitch=Bh??e.pitch},bg=e=>{_u(n,e.x,e.y,e.z,e.blockId),y.remeshBlock(e.x,e.y,e.z),E.onBlockChanged(e.x,e.y,e.z,e.blockId),O.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Kf(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},xg=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)_u(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};y.remeshBox(t,r),E.onRegionFilled(t,r,e.blockId),O.validarTodos(n),Kf(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let le=new Map,ue=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Ni(t);i.minFilter=o;let a=new Mr(new vr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Z.height/2+.35,0),a},N=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};Sg=e=>{let t=le.get(e.id);if(!t){let n=new ei(new Li(Z.width,Z.height,Z.width),new ta({color:new U().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Z.height/2,e.z),n.rotation.y=e.yaw,kh.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},le.set(e.id,t)}e.name&&e.name!==t.labelName&&(N(t),t.label=ue(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Z.height/2,e.z),t.targetYaw=e.yaw},Cg=e=>{let t=le.get(e);t&&(N(t),kh.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),le.delete(e))};let de=new wi(new Ui(new Li(1,1,1)),new fi({color:0}));de.visible=!1,kh.add(de);let P=null,fe=new V,pe=`lj-hotbar`,me=_p(Dg),he=()=>me.slice(0,9).map(e=>e.id),ge=(()=>{let e=new Set(me.map(e=>e.id));e.add(900);let t=he();try{let n=JSON.parse(localStorage.getItem(pe)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),_e=0,ve=!1,ye=document.getElementById(`hotbar`),be=pp(p.map?.image,[...gp.map(e=>e.id),900]),xe=e=>e===900?`balde vazio`:e===901?`balde de água`:gp.find(t=>t.id===e)?.name??`?`,Se=()=>{if(!ye)return;if(ve){ye.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${Dg===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=ge.map((e,t)=>`<span class="slot${t===_e?` sel`:``}"><small>${t+1}</small><img src="${be.get(e)??``}" alt=""></span>`).join(``);ye.innerHTML=`<span class="bar-nome">${xe(ge[_e]??K.Grass)}</span><span class="slots">${e}</span>`,Kh?.refresh()};Se();let Ce=()=>{Dg!==`professor`&&!Ng||(ve=!ve,Se())};$.onKey(Wh.keys.varinha,Ce);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{_e=e,Se()});$.onWheel(e=>{_e=(_e+e+ge.length)%ge.length,Se()}),ye?.addEventListener(`pointerdown`,e=>{let t=e.target?.closest?.(`.slot`);if(!t)return;let n=[...ye.querySelectorAll(`.slot`)].indexOf(t);n<0||(e.preventDefault(),_e=n,Se())}),Kh=new vp(be,()=>me,()=>({hotbar:ge,selected:_e}),e=>{ge[_e]=e,localStorage.setItem(pe,JSON.stringify(ge)),Se()},e=>{_e=e,Se()},e=>{e?(Gh?.hide(),qh?.hide(),document.exitPointerLock()):$.lock(),rg()}),$.onKey(Wh.keys.inventario,()=>{fg.open||Kh?.toggle()});let we=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),D.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(P){if(ve){we(1,P);return}Cl(ge[_e]??-1)||t.send(JSON.stringify({type:`break_block`,x:P.x,y:P.y,z:P.z}))}}),$.onMouseButton(2,()=>{if(!P)return;if(ve){we(2,P);return}{let e=ge[_e];if(Cl(e??-1)){if(e===901)t.send(JSON.stringify({type:`balde`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,encher:!1})),ge[_e]=900;else{if(gu(n,P.x,P.y,P.z)!==K.Agua)return;t.send(JSON.stringify({type:`balde`,x:P.x,y:P.y,z:P.z,encher:!0})),ge[_e]=901}localStorage.setItem(pe,JSON.stringify(ge)),Se();return}}if(Rl(gu(n,P.x,P.y,P.z))){let{x:e,y:n,z:r}=P;ne.open(O.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(eu(gu(n,P.x,P.y,P.z))){t.send(JSON.stringify({type:`use_block`,x:P.x,y:P.y,z:P.z}));return}let e=ge[_e];if(e!==void 0){if((e===K.PortaXFechada||e===K.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.PortaXFechada:K.PortaZFechada),(e===K.JanelaXFechada||e===K.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.JanelaXFechada:K.JanelaZFechada),zl(e)||Bl(e)||Vl(e)||Rl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(zl(e)?K.CadeiraXP:Bl(e)?K.SofaXP:Vl(e)?K.CamaXP:K.QuadroXP)+r}if(Ol(e)){let t=e-+!!kl(e);e=P.ny<0?t+1:t}if(jl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Fl(Pl(e),r,P.ny<0)}t.send(JSON.stringify({type:`place_block`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!P||ve)return;let e=gu(n,P.x,P.y,P.z);Kl(e)&&(e=K.PortaXFechada),Xl(e)&&(e=K.JanelaXFechada),zl(e)&&(e=K.CadeiraXP),Bl(e)&&(e=K.SofaXP),Vl(e)&&(e=K.CamaXP),Rl(e)&&(e=K.QuadroXP),Ol(e)&&(e=K.LajePedraBaixo+Al(e)*2),jl(e)&&(e=K.EscadaPedraXP+Pl(e)*8),ru(e)&&(iu(e)&&Dg!==`professor`||(ge[_e]=e,localStorage.setItem(pe,JSON.stringify(ge)),Se()))});let Te=new vm(Oh,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:lg});Zh=Te,Te.contexto=()=>({x:M.pos.x,y:M.pos.y,z:M.pos.z,yaw:$.yaw,pitch:$.pitch,voando:kg&&Ag(),noChao:M.onGround,raioRender:Wh.raioRender,meshMsPorFrame:Wh.meshMsPorFrame,pixelRatioCap:Wh.pixelRatioCap,fov:Wh.fov,nuvens:Wh.nuvens,balanco:Wh.balanco,distanciaTotal:d,colunasRecebidas:u,bytesRecebidos:t.stats.bytesIn}),Te.setRemesh({count:y.remeshCount,totalMs:y.remeshMsTotal,workerMs:y.remeshWorkerMsTotal,config:y.meshConfig,lastMs:y.lastRemeshMs,porCaminho:y.porCaminho}),Te.carga=()=>Jh.relatorio(),Te.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Ee=null;if(Vh){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);fg.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let t=Vh.semVida?`bench-semvida`:`bench`;Te.baixar(e,t),fg.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${t}-*.json)`)}};Yh=()=>{if(Ee)return;Ee=dp.paraMundo(Vh,j,n.dims),Te.setMeta({bench:Ee.meta()}),Te.marcar(`bench: início`,`${Vh.duracaoS}s · raio ${Ee.trajeto.raio}${Vh.semVida?` · sem vida ambiental`:``}`),Xh=!0,kg=!0,rg(),Ee.iniciar(performance.now());let t=Ee.amostra(performance.now());M.pos.x=je=t.x,M.pos.y=Me=t.y,M.pos.z=Ne=t.z,Te.record(t=>{Xh=!1,rg(),window.__benchPerfil=t,e(t)},Vh.duracaoS*1e3)}}$.onKey(Wh.keys.hud,()=>Te.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{Te.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),Km()&&(ye&&(ye.style.pointerEvents=`auto`,ye.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(_e=n,Se())})),Uh=new Ym($,{keys:()=>Wh.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>Kh?.toggle(),chat:()=>{fg.open||(document.exitPointerLock(),fg.openInput())},menu:()=>{$.touch=!1,ng(),rg()},hud:()=>Te.toggle(),varinha:()=>Ce()}),Uh.setScale(Wh.uiScale),rg()),Te.extra=()=>{let e=$.mouseStats,t=M.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=Mu(i,a,r),s=ou(o),c=su(o),l=Math.min(ju(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&o.temp<.6?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===K.GramaSeca?`grama seca`:c===K.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se temp<0.60 · chapada ≥85]\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let De={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},Oe=0;setInterval(()=>{let e={x:M.pos.x,y:M.pos.y,z:M.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==De.x||e.y!==De.y||e.z!==De.z||e.yaw!==De.yaw||e.pitch!==De.pitch,r=performance.now();!n&&r-Oe<2e3||(De=e,Oe=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof cm&&ug&&!Vh&&(a_(),setInterval(()=>void a_(),3e4));let ke={...t.stats};setInterval(()=>{let e=t.stats;Te.net={msgsPerSec:e.msgsIn+e.msgsOut-(ke.msgsIn+ke.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(ke.bytesIn+ke.bytesOut),tickAvgMs:pg.tickAvgMs,tickMaxMs:pg.tickMaxMs,jitterMs:vg()},Te.regras=mg,Te.stream={colunas:a.size,fila:y.filaPendente,faltando:c.size,repedidas:l,ultimoLote:y.ultimoLote},ke={...e}},1e3);let Ae=performance.now(),je=M.pos.x,Me=M.pos.y,Ne=M.pos.z,F=!1,Pe=!1,Fe=0,Ie=!1,I=0,Le=Z.eyeHeight,L=0;Oh.setAnimationLoop(()=>{let e=performance.now(),t=e-Ae;Ae=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(Wh.keys.forward)-+!!$.down(Wh.keys.back):0,c=$.active?!!$.down(Wh.keys.right)-+!!$.down(Wh.keys.left):0,l=$.active&&$.down(Wh.keys.jump),u=$.active&&$.down(Wh.keys.forward);u&&!Pe&&(e-Fe<300&&(F=!0),Fe=e),u||(F=!1),Pe=u;let p=$.active&&$.down(Wh.keys.agachar),m=o>0&&!p&&(F||$.active&&$.down(Wh.keys.correr));l&&!Ie&&(Ag()&&e-I<300&&(kg=!kg),I=e),Ie=l;let h=kg&&Ag(),g=!0;if(i){y.modoCarga=Jh.ativo,y.processarFila(Wh.meshMsPorFrame,(e,t)=>{a.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(M.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(M.pos.z/16)));if(g=a.has(r*n.dims.x+t),(s=(s+1)%60)==0){for(let e of a){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>Wh.raioRender+2){a.delete(e),y.descartarColuna(i,o),E.descartarColuna(i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}T(t,r,e)}Jh.ativo&&a.size>=oe&&y.filaPendente===0&&Jh.concluir()}if(Ee?.ativo){let t=Ee.amostra(e);M.pos.x=t.x,M.pos.y=t.y,M.pos.z=t.z,M.vel.x=M.vel.y=M.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Ee.terminou(e)&&(Ee.parar(),Te.marcar(`bench: fim`))}let _=M.pos.y;g&&!Ee?.ativo&&xd(n,M,{forward:o,strafe:c,jump:l,yaw:$.yaw,sprint:m,sneak:p,fly:h},r);let v=M.pos.y-_;M.onGround&&!h&&v>.01&&v<=.56&&(L=Math.min(L+v,cd)),L*=Math.exp(-r*14),L<.002&&(L=0),d+=Math.hypot(M.pos.x-je,M.pos.y-Me,M.pos.z-Ne),je=M.pos.x,Me=M.pos.y,Ne=M.pos.z,M.pos.y<-16&&ce();let D=1-Math.exp(-r*12);for(let e of le.values()){e.mesh.position.lerp(e.target,D);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*D}let ee=1-Math.exp(-r*20);Le+=((p&&!h?Z.sneakEyeHeight:Z.eyeHeight)-Le)*ee;let te=Wh.fov*(M.sprinting?1.1:1);if(Math.abs(Ah.fov-te)>.01&&(Ah.fov+=(te-Ah.fov)*ee,Ah.updateProjectionMatrix()),Ah.position.set(M.pos.x,M.pos.y+Le-L,M.pos.z),Ah.rotation.set($.pitch,$.yaw,0),Ah.getWorldDirection(fe),P=$.active?Cd(n,Ah.position.x,Ah.position.y,Ah.position.z,fe.x,fe.y,fe.z,5,ge[_e]===900):null,de.visible=P!==null,P){let[e,t,r,i,a,o]=Hu(gu(n,P.x,P.y,P.z));de.position.set(P.x+(e+i)/2,P.y+(t+a)/2,P.z+(r+o)/2),de.scale.set(i-e+.004,a-t+.004,o-r+.004)}Te.setRemesh({count:y.remeshCount,totalMs:y.remeshMsTotal,workerMs:y.remeshWorkerMsTotal,config:y.meshConfig,lastMs:y.lastRemeshMs,porCaminho:y.porCaminho}),Fh.update(r),Lh.ventoTempo.value=Fh.fase*Math.PI*2,Lh.ventoDir.value.set(Fh.x,Fh.z),Lh.ventoForca.value=Wh.balanco?Fh.forca:0,Nh.update(r,Fh),b.update(n,Ah.position.x,Ah.position.y,Ah.position.z);let O=Math.floor(Fh.fase*16)%16;S+=r;let ne=Math.floor(S*8)%16;(O!==x||ne!==C)&&S-w>=1/12&&(w=S,x=O,C=ne,Rf(f,O,Fh.ondaAgua,ne));let k=performance.now();Te.gpuInicio(),Oh.render(kh,Ah),Te.gpuFim(),Te.frame(t,performance.now()-k)}),i||Jh.concluir(),o_.has(`hud`)&&Te.toggle(),new URLSearchParams(location.search).has(`painel`)&&Gh?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Kh?.toggle(),o_.has(`touch`)&&ig()}