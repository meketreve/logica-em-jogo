...
`;function ry(e){return`url("data:image/svg+xml,${encodeURIComponent(e)}")`}var iy=ry(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#e23b3b" stroke="#5a0d0d" stroke-width="1.2"/></svg>`),ay=ry(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#1a1a1a" stroke="#000" stroke-width="1.2"/></svg>`),oy=ry(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#7fd4ff" stroke="#0a3550" stroke-width="1.2"/><circle cx="5.8" cy="5.8" r="1.6" fill="#fff" opacity="0.9"/></svg>`),sy=(e,t,n)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M12.8 12.8 8.6 8.6" stroke="${t}" stroke-width="3" stroke-linecap="round"/><circle cx="12.9" cy="12.9" r="2.1" fill="${t}" stroke="${n}" stroke-width="0.9"/><circle cx="6" cy="6" r="4.7" fill="${e}" stroke="${n}" stroke-width="1.1"/></svg>`,cy=ry(sy(`#b2601f`,`#f3e7cf`,`#4d2a10`)),ly=ry(sy(`#1a1a1a`,`#1a1a1a`,`#000`));function uy(e,t,n){let r=document.createElement(`div`);r.className=`linha`;let i=[];for(let a=0;a<e;a++){let e=document.createElement(`div`);if(e.className=`casa`,n!==void 0){let t=document.createElement(`div`);t.className=`icone fundo`,t.style.backgroundImage=n,e.appendChild(t)}let a=document.createElement(`div`);a.className=`icone`,a.style.backgroundImage=t,e.appendChild(a),r.appendChild(e),i.push(e)}return{linha:r,casas:i}}function dy(e,t){for(let[n,r]of e.entries()){let e=r.lastElementChild;if(!e)continue;let i=t>=(n+1)*2,a=!i&&t===n*2+1;e.style.display=i||a?`block`:`none`,e.classList.toggle(`meio`,a)}}var fy=class{raiz;linhaVida;linhaFome;linhaAr;dano;morte;casasVida;casasFome;casasAr;morteTimer=null;danoTimer=null;ultimaVida=20;visivel=!1;constructor(){let e=document.createElement(`style`);e.textContent=ny,document.head.appendChild(e),this.raiz=document.createElement(`div`),this.raiz.id=`lj-vitals`;let t=uy(Qv,iy,ay),n=uy($v,cy,ly),r=uy(ey,oy);this.linhaVida=t.linha,this.casasVida=t.casas,this.linhaFome=n.linha,this.casasFome=n.casas,this.linhaAr=r.linha,this.casasAr=r.casas,this.linhaAr.classList.add(`vazia`),this.linhaFome.classList.add(`vazia`);let i=document.createElement(`div`);i.className=`barras`,i.append(this.linhaVida,this.linhaFome),this.raiz.append(this.linhaAr,i),document.body.appendChild(this.raiz),this.dano=document.createElement(`div`),this.dano.id=`lj-dano`,this.morte=document.createElement(`div`),this.morte.id=`lj-morte`,document.body.append(this.dano,this.morte)}setVisivel(e){this.visivel=e,this.raiz.classList.toggle(`ativo`,e),e||this.esconderMorte()}aplicar(e){let t=Math.max(0,Math.min(20,Math.round(e.vida)));dy(this.casasVida,t),this.desenharFome(e.fome),this.desenharAr(e.folego),t<this.ultimaVida&&this.visivel&&this.piscarDano(),e.morreu&&this.visivel&&this.mostrarMorte(e.causa),this.ultimaVida=t}desenharFome(e){this.linhaFome.classList.toggle(`vazia`,e===void 0),e!==void 0&&dy(this.casasFome,Math.max(0,Math.min(20,Math.round(e))))}desenharAr(e){let t=e===void 0||e>=150;if(this.linhaAr.classList.toggle(`vazia`,t),t)return;let n=Math.max(0,Math.ceil(e/ty));for(let[e,t]of this.casasAr.entries()){let r=t.lastElementChild;r&&(r.style.display=e<n?`block`:`none`)}}piscarDano(){this.dano.classList.add(`piscar`),this.danoTimer!==null&&clearTimeout(this.danoTimer),this.danoTimer=setTimeout(()=>this.dano.classList.remove(`piscar`),90)}mostrarMorte(e){this.morte.textContent=e===`queda`?`Você caiu de muito alto`:e===`afogamento`?`Você ficou sem ar`:e===`fome`?`Você passou fome demais`:`Você não sobreviveu`,this.morte.classList.add(`ativo`),this.morteTimer!==null&&clearTimeout(this.morteTimer),this.morteTimer=setTimeout(()=>this.esconderMorte(),2600)}esconderMorte(){this.morte.classList.remove(`ativo`)}},py=class{send;onToggle;root=document.getElementById(`amigos`);isOpen=!1;data={eu:``,equipe:null,convites:[],enviados:[],online:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&$m(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=this.btn(e,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)});return n}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}linha(e,...t){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);return r.className=`jog-nome`,r.textContent=e,n.append(r,...t),n}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`amigos`,t.append(n,this.btn(`✕ fechar`,()=>this.hide()));let r=document.createElement(`div`);r.className=`jog-lista`,this.renderConvites(r),this.renderGrupo(r),this.renderConvidar(r),r.append(this.hint(`pelo chat também dá: /amigos convidar nome · /amigos aceitar · /amigos recusar · /amigos sair · /amigos expulsar nome · /amigos lista`)),e.append(t,r)}renderConvites(e){if(this.data.convites.length!==0){e.append(this.sec(`✉ convites para você (${this.data.convites.length})`));for(let t of this.data.convites)e.append(this.linha(`${t} convidou você`,this.btn(`aceitar`,()=>this.send(`/amigos aceitar ${t}`)),this.btn(`recusar`,()=>this.send(`/amigos recusar ${t}`))));e.append(this.hint(`aceitar um convite descarta os outros — você fica em UM grupo só.`))}}renderGrupo(e){let{eu:t,equipe:n}=this.data;if(!n){e.append(this.sec(`👥 seu grupo`)),e.append(this.hint(`Você não está em nenhum grupo. Quem está no seu grupo pode construir na sua ÁREA PROTEGIDA (e você na dele). Cabem 6 pessoas, contando você.`));return}let r=n.dono===t;e.append(this.sec(`👥 grupo de ${n.dono} — ${n.membros.length}/6`));for(let i of n.membros){let a=[i===n.dono?`dono`:``,i===t?`você`:``].filter(e=>e),o=a.length?`${i} (${a.join(`, `)})`:i;e.append(r&&i!==t?this.linha(o,this.armedBtn(`expulsar`,()=>this.send(`/amigos expulsar ${i}`))):this.linha(o))}let i=document.createElement(`div`);i.className=`painel-row`,i.append(r?this.armedBtn(`sair e DESFAZER o grupo`,()=>this.send(`/amigos sair`)):this.armedBtn(`sair do grupo`,()=>this.send(`/amigos sair`))),e.append(i),r&&e.append(this.hint(`você é o dono: se sair, o grupo acaba para todo mundo.`))}renderConvidar(e){let{eu:t,equipe:n,enviados:r,online:i}=this.data;if(e.append(this.sec(`＋ convidar`)),n&&n.dono!==t){e.append(this.hint(`Só ${n.dono} convida para este grupo. Saia dele para montar o seu.`));return}if(n&&n.membros.length>=6){e.append(this.hint(`Grupo cheio (6/6).`));return}for(let t of r)e.append(this.linha(`${t} — convite enviado, aguardando`));let a=new Set(n?.membros??[]),o=i.filter(e=>e!==t&&!a.has(e)&&!r.includes(e));for(let t of o)e.append(this.linha(t,this.btn(`convidar`,()=>this.send(`/amigos convidar ${t}`))));o.length===0&&r.length===0&&e.append(this.hint(`ninguém mais está na aula agora.`))}},my=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&$m(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`},{id:`grupos`,label:`grupos`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.aba===`grupos`?this.renderGrupos(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderGrupos(e){e.append(this.hint(`quantos grupos a turma tem? aumentar cria as áreas; diminuir apaga as que sobram.`));let t=document.createElement(`div`);t.className=`jog-row`;for(let e=1;e<=20;e++)t.append(this.armedBtn(String(e),()=>this.send(`/aula grupos ${e} confirmar`)));e.append(t)}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},hy=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;corpo=null;scrollCorpo=0;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&$m(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.redesenhar())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.redesenhar()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.scrollCorpo=0,this.redesenhar(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}redesenhar(){this.scrollCorpo=this.corpo?.scrollTop??this.scrollCorpo,this.render(),this.corpo&&(this.corpo.scrollTop=this.scrollCorpo)}abrir(e){let t=this.root;if(!t)return null;t.textContent=``,t.append(this.head(e));let n=document.createElement(`div`);return n.className=`painel-corpo`,t.append(n),this.corpo=n,n}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},gy=class extends hy{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(Ih[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=Zu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.abrir(`painel de autoria`);if(e){if(this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=Zu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...Ih.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},_y=class extends hy{render(){let e=this.abrir(`grupos`);if(!e)return;if(this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},vy=class{fixedColor;group=new un;cornerMarks=[];boxes=[];bounds=[];culling=null;constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Ti(new Wi(new Ri(1.01,1.01,1.01)),new pi({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();if(this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Ti(new Wi(new Ri(n+.04,r+.04,i+.04)),new pi({color:this.fixedColor??new H().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a}),this.bounds=e,this.culling){let{px:e,pz:t,raio:n}=this.culling;this.cularPorDistancia(e,t,n)}}cularPorDistancia(e,t,n){this.culling={px:e,pz:t,raio:n};for(let r=0;r<this.boxes.length;r++){let i=this.boxes[r],a=this.bounds[r];if(!i||!a)continue;let o=Math.max(a.min.x-e,0,e-(a.max.x+1)),s=Math.max(a.min.z-t,0,t-(a.max.z+1));i.visible=Math.max(o,s)<=n}}},yy=1/16,by=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*yy-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*yy-.004,ry:Math.PI}];function xy(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var Sy=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(nd(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=nd(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=K(t,e.x,e.y,e.z);if(!lu(r))return;let i=by[r-G.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,xy(a,e,null);let o=new Pi(a);o.colorSpace=ze;let s=new ti(new Gi(12*yy,12*yy),new Ur({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{xy(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=nd(e,t,n);if(this.conteudos.has(a))if(!lu(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])lu(K(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function Cy(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var wy=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,Cy(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},Ty=null;function Ey(e){e.preventDefault(),e.returnValue=``}var Dy=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function Oy(e){Ty?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||Dy.has(e.code))&&e.preventDefault())}function ky(e){Ty?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function Ay(e){Ty||(Ty=e,window.addEventListener(`beforeunload`,Ey),window.addEventListener(`keydown`,Oy,!0),window.addEventListener(`keyup`,ky,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function jy(){Ty=null,window.removeEventListener(`beforeunload`,Ey),window.removeEventListener(`keydown`,Oy,!0),window.removeEventListener(`keyup`,ky,!0),navigator.keyboard?.unlock?.()}var My=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Pi(t);i.minFilter=o,this.material=new yr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[Gu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===G.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===G.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===G.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Nr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function Ny(e){return _d(e)!==null||Du(e)||fu(e)}function Py(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Kh(n)}var Fy=new Cl({antialias:!0});Fy.setPixelRatio(Math.min(window.devicePixelRatio,2)),Fy.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Fy.domElement);var Iy=new yn;Iy.background=new H(8900331);var Ly=new Ra(75,window.innerWidth/window.innerHeight,.1,512);Ly.rotation.order=`YXZ`;var Ry=new Va(16777215,2.2);Ry.position.set(60,100,40);var zy=new Ha(16777215,.55);Iy.add(Ry,zy);var By=new qg(Ry,zy,Iy,Ly),Vy=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();Vy!==null&&By.sync(Vy,!1);var Hy=new Xg,Uy=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();Uy&&Hy.sync(Uy.dir,Uy.forca,!0);var $=new iv(Fy.domElement);$.touchDevice=Zh();var Wy=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},Gy=Wy(`yaw`),Ky=Wy(`pitch`);Gy!==null&&($.yaw=Gy),Ky!==null&&($.pitch=Ky);var qy=lh(new URLSearchParams(location.search)),Jy=Wy(`foto`);function Yy(){let e=qy?{...vv(),...uh(qy)}:Jy===null?vv():{...vv(),raioRender:12,meshMsPorFrame:16,fov:90};return $.sensitivity=e.sensitivity,Ly.fov=e.fov,Ly.updateProjectionMatrix(),Fy.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Zm(e.volume),Xy?.setScale(e.uiScale),By.setNuvens(e.nuvens),e}var Xy=null,Zy=Yy();th(Zy.volume);var Qy=new G_(()=>ub()||Tb.open);$.podeTravar=()=>!Qy.algumAberto;var $y={equipe:null,convites:[],enviados:[]},eb=new fv(()=>{db(),tb?.hud.setFase(`jogando`),tb?.hud.marcar(`carga concluída`),tb?.iniciarBench(),tb?.iniciarFoto()}),tb=null,nb=!1,rb=!1,ib=document.getElementById(`overlay`),ab=document.getElementById(`overlay-main`),ob=document.getElementById(`overlay-config`),sb=document.getElementById(`crosshair`),cb=document.getElementById(`hotbar`);function lb(){ab?.classList.remove(`hidden`),ob?.classList.add(`hidden`)}function ub(){return ib!==null&&!ib.classList.contains(`hidden`)}function db(){let e=Qy.algumAberto;ib?.classList.toggle(`hidden`,nb||rb||eb.ativo||$.active||$.retomando||Tb.open||e);let t=nb||$.active||$.retomando;cb?.classList.toggle(`hidden`,!(t&&!Tb.open&&!e&&!eb.ativo)),sb?.classList.toggle(`hidden`,!$.active),$.locked&&lb(),Xy?.setShown($.touch&&!Tb.open&&!e&&!eb.ativo)}document.addEventListener(`pointerlockchange`,db),document.addEventListener(`pointerlockerror`,db);function fb(){Zh()?($.touch=!0,Qh(),db()):$.lock()}window.addEventListener(`keydown`,e=>{e.code===`Escape`&&(!ub()||Tb.open||(document.getElementById(`menu`)?.classList.contains(`hidden`)??!1)&&(e.preventDefault(),fb()))});function pb(){let e=Zy.keys;Zy=Yy();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`,`amigos`])$.rebind(e[t],Zy.keys[t]);hb()}var mb=-1;function hb(){if(!gb||Zy.raioRender===mb)return;let e=mb;mb=Zy.raioRender,gb.send(JSON.stringify({type:`radius`,chunks:mb})),tb?.hud.marcar(`raio`,`${e<0?`join`:e} → ${mb}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>fb()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Uv(e,pb,lb),ab?.classList.add(`hidden`),ob?.classList.remove(`hidden`)}),document.getElementById(`overlay-telacheia`)?.addEventListener(`click`,()=>{Qh()}),document.getElementById(`overlay-hud`)?.addEventListener(`click`,()=>{tb?.hud.toggle()}),ib?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&$m(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{Ly.aspect=window.innerWidth/window.innerHeight,Ly.updateProjectionMatrix(),Fy.setSize(window.innerWidth,window.innerHeight)});var gb=null,_b=`?`,vb=null;function yb(){return new URLSearchParams(location.search).get(`nome`)??Rv()}function bb(e){return e.trim().toLowerCase()===`/amigos`&&Qy.trocarParaAmigos()}function xb(){return Nb===`professor`||$b.length>0?!0:(Tb.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`),!1)}function Sb(){Qy.podeAlternar(Qy.cp14)&&xb()&&Qy.cp14?.toggle()}function Cb(e){return e.trim().toLowerCase()!==`/painel`||!Qy.cp14?!1:!xb()||Qy.trocarParaPainel()}function wb(e,t,n){return Zh()?`botão ${t} da barra de cima (ou o comando ${n})`:`tecla ${e} (ou o comando ${n})`}var Tb=new og(e=>{bb(e)||Cb(e)||gb?.send(JSON.stringify({type:`chat`,text:e}))},e=>{db(),!e&&!Qy.algumAberto&&$.lock()});db(),Fy.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Tb.open&&Tb.close()});var Eb={tickAvgMs:0,tickMaxMs:0},Db=null,Ob=0,kb=[];function Ab(){let e=performance.now();Ob>0&&(kb.push(e-Ob),kb.length>300&&kb.shift()),Ob=e}function jb(){let e=kb.length;if(e<2)return 0;let t=kb.reduce((e,t)=>e+t,0)/e,n=kb.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var Mb=null,Nb=`aluno`,Pb=!1,Fb=!1,Ib=`criativo`,Lb=!1;function Rb(){return Sd(Ib)&&(Nb===`professor`||Pb)}var zb=new Zv,Bb=null;function Vb(){return Bb??=new fy,Bb}var Hb=null,Ub=(()=>{let e=new URLSearchParams(location.search).get(`vida`);if(e===null)return null;let[t,n,r]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{vida:t,...Number.isFinite(n)?{folego:n}:{},...Number.isFinite(r)?{fome:r}:{}}})();Ub&&(Vb().setVisivel(!0),Vb().aplicar(Ub));{let e=new URLSearchParams(location.search).get(`mochila`);if(e!==null){let t=[];e.split(`,`).forEach((e,n)=>{let[r,i]=e.split(`x`).map(Number);r===void 0||!Number.isInteger(r)||r<=0||t.push({slot:n,id:r,qtd:Number.isInteger(i)&&i>0?i:1})}),zb.travar(t)}}var Wb=[],Gb=!1,Kb=!1,qb=[],Jb=new Jv,Yb=!1,Xb=new Xv,Zb=null,Qb=null,$b=[],ex=new Set,tx=!1,nx=!1,rx=new Map;function ix(){Qy.cp14?.update({regions:Wb,modo:Zb?.modo??`sequencial`,objetivos:Zb?.objetivos??[],grupos:$b,myGrupo:Qb})}function ax(){Qy.amigos?.update({eu:yb(),equipe:$y.equipe,convites:$y.convites,enviados:$y.enviados,online:[...new Set(rx.values())].sort()})}function ox(e){return e.porGrupo&&Nb!==`professor`?Qb===null?!1:e.porGrupo.find(e=>e.grupo===Qb)?.completo??!1:e.completo}function sx(e){if(Zb){for(let t of Zb.objetivos)ox(t)?ex.has(t.id)||(ex.add(t.id),e&&tx&&Km({kind:`objective_complete`})):ex.delete(t.id);tx=!0,Jb.update(Zb.modo,Zb.objetivos,{grupo:Qb,professor:Nb===`professor`,painelComo:wb(bv(Zy.keys.painel),`📋`,`/painel`)}),tb?.applyObjectiveBoxes(Zb.objetivos)}}var cx=null;function lx(){let e=cx;if(e){cx=null;for(let t of e)dx(t)}}function ux(){cx||(cx=[],requestAnimationFrame(()=>requestAnimationFrame(lx)),setTimeout(lx,500))}function dx(e){if(cx){cx.push(e);return}if(Ab(),tb||eb.setFase(`mundo`),typeof e==`string`){let t=Nd(e);if(!t)return;if(t.type===`debug_stats`)Eb={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},Db=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0};else if(t.type===`block_changed`)tb?.applyBlockChanged(t);else if(t.type===`blocks_filled`)tb?.applyBlocksFilled(t);else if(t.type===`player_moved`)t.name&&rx.get(t.id)!==t.name&&(rx.set(t.id,t.name),qh([...new Set(rx.values())]),ax()),tb?.applyPlayerMoved(t);else if(t.type===`dormindo`)tb?.aoDormir(t.dormindo,t.cama);else if(t.type===`player_left`)rx.delete(t.id),qh([...new Set(rx.values())]),ax(),tb?.applyPlayerLeft(t.id);else if(t.type===`spawn`)Mb={x:t.x,y:t.y,z:t.z},Nb=t.papel??`aluno`;else if(t.type===`regions`)Wb=t.regions,tb?.applyRegions(t.regions),ix();else if(t.type===`objectives`)Zb={modo:t.modo,objetivos:t.objetivos},sx(!0),ix();else if(t.type===`group`)Qb=t.grupo,ex.clear(),sx(!1),ix();else if(t.type===`groups`)$b=t.grupos,ix();else if(t.type===`quadros`)tb?.applyQuadros(t.lista);else if(t.type===`quadro_changed`)tb?.applyQuadroChanged(t);else if(t.type===`container`)Qy.container?.atualizar(t);else if(t.type===`container_fechado`)Qy.container?.fecharSemAvisar();else if(t.type===`claims`)Gb=t.ativo,t.ativo&&!Kb&&(Kb=!0,Tb.addMessage(`jogo`,`${wb(bv(Zy.keys.amigos),`👥`,`/amigos`)} abre o painel de amigos — quem está no seu grupo constrói na sua área`)),qb=t.claims,tb?.applyClaims(t.claims);else if(t.type===`friends`)$y={equipe:t.equipe,convites:t.convites,enviados:t.enviados},ax();else if(t.type===`players`)Qy.jogadores?.update({conectados:t.conectados,banidos:t.banidos});else if(t.type===`mundo_trocando`)tb?.iniciarTroca(t.nome),ux();else if(t.type===`teleport`)tb?.applyTeleport(t);else if(t.type===`time`)Vy===null&&By.sync(t.hora,t.ciclo);else if(t.type===`vento`)Uy===null&&Hy.sync(t.dir,t.forca,t.ativo);else if(t.type===`voo`)Pb=t.liberado,Rb()||(Fb=!1),Tb.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`);else if(t.type===`invisivel`)Yb=t.ativo,Xb.mostrar(t.ativo),t.ativo&&Rb()&&(Fb=!0);else if(t.type===`modo`){let e=Ib!==t.efetivo;Ib=t.efetivo,Xy?.setCopiarDisponivel(t.efetivo!==`sobrevivencia`),Xy?.setMochilaRotulo(t.efetivo===`sobrevivencia`),tb?.atualizarComerToque(),Lb=t.pvp===!0,Rb()||(Fb=!1),Ub===null&&(t.efetivo===`sobrevivencia`?Vb().setVisivel(!0):Bb?.setVisivel(!1)),t.efetivo===`criativo`&&zb.ativa&&(zb.desligar(),tb?.aoMudarMochila()),e&&Tb.addMessage(`jogo`,t.efetivo===`sobrevivencia`?`modo sobrevivência — não dá para voar`:`modo criativo`)}else if(t.type===`inventario`)zb.aplicar(t.slots),tb?.aoMudarMochila();else if(t.type===`vida`){if(Ub!==null)return;Hb=t,Vb().aplicar(t),tb?.atualizarComerToque(),t.causa&&Km({kind:`dano`}),t.morreu&&(Km({kind:`morte`}),Tb.addMessage(`jogo`,t.causa===`queda`?`você caiu de muito alto — voltou ao ponto de partida`:t.causa===`afogamento`?`você ficou sem ar — voltou ao ponto de partida`:t.causa===`fome`?`você passou fome demais — voltou ao ponto de partida`:t.causa===`sufocamento`?`você ficou soterrado — voltou ao ponto de partida`:t.causa===`pvp`?`você foi derrubado por outro jogador — voltou ao ponto de partida`:`você não sobreviveu — voltou ao ponto de partida`))}else t.type===`kicked`?($m(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),jy(),location.href=location.pathname):t.type===`join_denied`?($m(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),jy(),location.href=location.pathname):t.type===`chat`&&(Tb.addMessage(t.author,t.text),t.author===`servidor`&&Py(t.text),Km({kind:`chat_message`}));return}let t=Ld(e);if(t===809716300){tb?.aplicarColunas(e);return}let n=()=>(nx=t===Fd,nx?Rd(e):Pd(e));if(tb){tb.reloadWorld(n());return}bx(n())}function fx(e,t){Zy=Yy(),gb=e,eb.abrir({host:_b,rede:!(e instanceof q_)}),eb.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),db(),e.onMessage(dx),$.onKey(Zy.keys.chat,()=>{Tb.open||Qy.podeAbrir&&(document.exitPointerLock(),Tb.openInput())}),e.send(JSON.stringify({type:`join`,name:yb(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),mb=-1,hb()}function px(e,t){_b=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),fx(new J_(e,t=>{tb||!eb.ativo||eb.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function mx(e,t){vb={id:e.id,name:e.name,createdAt:e.createdAt},_b=`web-worker (${e.name})`;let n=new q_(new Worker(new URL(`/assets/worker-Cpw8KYHF.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho,sobrevivencia:e.sobrevivencia}),fx(n)}async function hx(){if(!(gb instanceof q_)||!vb)return;let e=await gb.requestSave();await Dv({...vb,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{jy(),hx().finally(()=>location.reload())});var gx=new URLSearchParams(location.search),_x=gx.get(`server`);if(_x){let e=gx.get(`codigo`);px(_x,{pin:gx.get(`pin`)??``,...e?{codigo:e}:{}})}else qy?mx({id:`bench-${nh}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:wf(gx.get(`tamanho`)??`E`)},nh):Jy===null?Hv({onPlayWorld:mx,onPlayMulti:px}):mx({id:`foto-${Jy}`,name:`fundo do menu`,createdAt:0,data:null,preset:`normal`,tamanho:`E`},Jy);var vx=3,yx=class{activeConn;world;worldSeed;luz;mundoLazy;colunasCarregadas=new Set;frameCount=0;colunasRecebidas=0;materiais;chunkRenderer;aguaFx;torchGlow;colunasFaltando;regionRenderer;claimRenderer;quadroRenderer;objectiveBoxes;spawn;player;movimento;progresso;outros;dormindo=null;ultimaCama=null;dormirT=0;highlight;lookDir=new B;hotbarUi;hud;target=null;alvoJogador=null;ultimoIdMirado=-1;bench=null;foto=!1;constructor(e,t){if(this.activeConn=t,Ay(()=>$.active),this.world=e.world,this.worldSeed=e.seed,this.mundoLazy=nx,this.luz=new Eg(this.world.dims,new URLSearchParams(location.search).has(`semluz`)),this.materiais=new U_,new URLSearchParams(location.search).has(`atlas`)){let e=this.materiais.canvas;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let n=new URLSearchParams(location.search),r=n.has(`semworker`),i=Number(n.get(`meshdepth`));this.chunkRenderer=new mg(this.world,this.materiais.paraChunks,Iy,!r,Number.isFinite(i)&&i>0?i:void 0,this.luz.paraMesher),this.aguaFx=new Hm(Iy),this.mundoLazy||(this.luz.acenderTudo(this.world),this.chunkRenderer.buildAll()),this.torchGlow=new My(Iy),this.torchGlow.setFromWorld(this.world),this.colunasFaltando=new hg(this.descartarColuna,(e,t)=>{this.activeConn.send(JSON.stringify({type:`pedir_coluna`,cx:e,cz:t}))}),this.regionRenderer=new vy(Iy),this.regionRenderer.setRegions(Wb),this.claimRenderer=new vy(Iy,16747546),this.drawClaims(qb),this.quadroRenderer=new Sy(Iy);let a=new wy;this.objectiveBoxes=new vy(Iy,3066993),Zb&&this.updateObjectiveBoxes(Zb.objetivos);let o=e=>this.activeConn.send(JSON.stringify({type:`chat`,text:e})),s=e=>{e?document.exitPointerLock():$.lock(),db()};Nb===`professor`&&(Qy.jogadores=new my(o,s)),Qy.amigos=new py(o,s),ax(),Qy.cp14=Nb===`professor`?new gy(o,s,()=>Qy.trocarParaJogadores()):new _y(o,s),ix(),$.onKey(Zy.keys.painel,Sb),$.onKey(Zy.keys.amigos,()=>Qy.alternar(Qy.amigos)),Nb===`professor`&&Tb.addMessage(`jogo`,`${wb(bv(Zy.keys.painel),`📋`,`/painel`)} abre o painel de autoria`),this.spawn=Mb??{x:this.world.sizeX/2+.5,y:Yu(this.world,Math.floor(this.world.sizeX/2),Math.floor(this.world.sizeZ/2)),z:this.world.sizeZ/2+.5},this.player=tf(this.spawn.x,this.spawn.y,this.spawn.z),this.movimento=new W_($,()=>Zy.keys),this.movimento.ancorar(this.player.pos),this.progresso=new K_(eb,()=>({bytes:this.activeConn.stats.bytesIn+this.activeConn.stats.bytesOut,prontas:this.colunasCarregadas.size,buracos:this.colunasFaltando.tamanho,fila:this.chunkRenderer.filaPendente})),this.recalcularCarga(),this.progresso.observar(),eb.setFase(this.mundoLazy?`mundo`:`malha`),this.outros=new Dg(Iy),this.highlight=new Ti(new Wi(new Ri(1,1,1)),new pi({color:0})),this.highlight.visible=!1,Iy.add(this.highlight),this.hotbarUi=new Tg(Nb,zb,this.materiais.canvas,{claimsAtivo:()=>Gb,setVarinhaToque:e=>Xy?.setVarinha(e),aoRedesenhar:()=>{Qy.mochila?.refresh(),Qy.container?.refresh(),this.atualizarComerToque()}}),this.hotbarUi.refresh(),Ah({nameOf:e=>this.hotbarUi.nome(e),sobrevivencia:()=>zb.ativa}),$.onKey(Zy.keys.varinha,()=>this.hotbarUi.toggleVarinha());for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>this.hotbarUi.selecionar(e));$.onWheel(e=>this.hotbarUi.ciclar(e)),Qy.mochila=new zh(this.hotbarUi.icons,()=>this.hotbarUi.meusBlocos,()=>({hotbar:this.hotbarUi.paleta,selected:this.hotbarUi.selected}),e=>this.hotbarUi.definirSlotLocal(e),e=>this.hotbarUi.selecionar(e),e=>{e?document.exitPointerLock():$.lock(),db()},zb,(e,t,n)=>this.activeConn.send(JSON.stringify({type:`mover_item`,de:e,para:t,qtd:n})),e=>this.hotbarUi.nome(e),e=>this.activeConn.send(JSON.stringify({type:`fabricar`,receita:e}))),$.onKey(Zy.keys.inventario,()=>Qy.alternar(Qy.mochila)),Qy.container=new Nh(this.hotbarUi.icons,zb,(e,t,n,r,i,a)=>this.activeConn.send(JSON.stringify({type:`mover_container`,x:e,y:t,z:n,de:r,para:i,qtd:a})),()=>this.activeConn.send(JSON.stringify({type:`fechar_container`})),e=>{e?(Qy.aoAbrirContainer(),document.exitPointerLock()):$.lock(),db()});let c=(e,t)=>{this.activeConn.send(JSON.stringify({type:`wand_mark`,corner:e,x:t.x,y:t.y,z:t.z})),this.regionRenderer.setCorner(e,t.x,t.y,t.z)};$.onMouseButton(0,()=>{if(this.alvoJogador&&!this.hotbarUi.varinhaAtiva){this.activeConn.send(JSON.stringify({type:`atacar`,alvo:this.alvoJogador.id}));return}if(this.target){if(this.hotbarUi.varinhaAtiva){c(1,this.target);return}Il(this.hotbarUi.idNaMao()??-1)&&Ib!==`criativo`||this.activeConn.send(JSON.stringify({type:`break_block`,x:this.target.x,y:this.target.y,z:this.target.z}))}}),$.onMouseButton(2,()=>{if(zb.ativa&&Yd(this.hotbarUi.idNaMao()??-1)){let e=this.target?K(this.world,this.target.x,this.target.y,this.target.z):null;if(e===null||!Ny(e)){this.activeConn.send(JSON.stringify({type:`comer`,slot:this.hotbarUi.selected}));return}}if(!this.target)return;if(this.hotbarUi.varinhaAtiva){c(2,this.target);return}let e=K(this.world,this.target.x,this.target.y,this.target.z);if(Ny(e)){this.activeConn.send(JSON.stringify({type:`use_block`,x:this.target.x,y:this.target.y,z:this.target.z}));return}{let e=this.hotbarUi.idNaMao();if(Il(e??-1)){let t=zb.ativa?{slot:this.hotbarUi.selected}:{};if(e===901)this.activeConn.send(JSON.stringify({type:`balde`,x:this.target.x+this.target.nx,y:this.target.y+this.target.ny,z:this.target.z+this.target.nz,encher:!1,...t})),zb.ativa||this.hotbarUi.definirSlotLocal(900);else{if(K(this.world,this.target.x,this.target.y,this.target.z)!==G.Agua)return;this.activeConn.send(JSON.stringify({type:`balde`,x:this.target.x,y:this.target.y,z:this.target.z,encher:!0,...t})),zb.ativa||this.hotbarUi.definirSlotLocal(901)}return}}if(lu(e)){let{x:e,y:t,z:n}=this.target;a.open(this.quadroRenderer.get(e,t,n),r=>{$.lock(),r&&this.activeConn.send(JSON.stringify({type:`quadro_set`,x:e,y:t,z:n,texto:r.texto,...r.imagem?{imagem:r.imagem}:{}}))});return}let t=this.hotbarUi.idNaMao();if(t===null)return;let n=Lp(t,$.yaw,this.target.ny<0);this.activeConn.send(JSON.stringify({type:`place_block`,x:this.target.x+this.target.nx,y:this.target.y+this.target.ny,z:this.target.z+this.target.nz,blockId:n}))}),$.onMouseButton(1,()=>{if(!this.target||this.hotbarUi.varinhaAtiva||zb.ativa)return;let e=Rp(K(this.world,this.target.x,this.target.y,this.target.z));Au(e)&&(ju(e)&&Nb!==`professor`||this.hotbarUi.definirSlotLocal(e))}),this.hud=new rv(Fy,{checkpoint:14,worldChunks:this.world.dims,worldSeed:e.seed,serverHost:_b}),this.hud.contexto=()=>({x:this.player.pos.x,y:this.player.pos.y,z:this.player.pos.z,yaw:$.yaw,pitch:$.pitch,voando:Fb&&Rb(),noChao:this.player.onGround,raioRender:Zy.raioRender,meshMsPorFrame:Zy.meshMsPorFrame,pixelRatioCap:Zy.pixelRatioCap,fov:Zy.fov,nuvens:Zy.nuvens,balanco:Zy.balanco,distanciaTotal:this.movimento.distanciaTotal,colunasRecebidas:this.colunasRecebidas,bytesRecebidos:this.activeConn.stats.bytesIn}),this.hud.setRemesh({count:this.chunkRenderer.remeshCount,totalMs:this.chunkRenderer.remeshMsTotal,workerMs:this.chunkRenderer.remeshWorkerMsTotal,config:this.chunkRenderer.meshConfig,lastMs:this.chunkRenderer.lastRemeshMs,porCaminho:this.chunkRenderer.porCaminho}),this.hud.carga=()=>eb.relatorio(),this.hud.marcar(`join`,`${this.world.dims.x}×${this.world.dims.z}×${this.world.dims.y} chunks · seed ${e.seed}`),$.onKey(Zy.keys.hud,()=>this.hud.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{this.hud.record(e=>{this.activeConn.send(JSON.stringify({type:`profile_report`,stats:e}))})}),Zh()&&(this.hotbarUi.habilitarToque(),Xy=new tg($,{keys:()=>Zy.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),comer:()=>this.activeConn.send(JSON.stringify({type:`comer`,slot:this.hotbarUi.selected})),copiar:()=>$.press(1),inventario:()=>Qy.alternar(Qy.mochila),chat:()=>{Tb.open||(document.exitPointerLock(),Tb.openInput())},menu:()=>{$.touch=!1,lb(),db()},hud:()=>this.hud.toggle(),varinha:()=>this.hotbarUi.toggleVarinha(),amigos:()=>Qy.alternar(Qy.amigos),painel:()=>Sb()}),Xy.setVarinhaDisponivel(Nb===`professor`||Gb),Xy.setAmigosDisponivel(Gb),Xy.setCopiarDisponivel(Ib!==`sobrevivencia`),Xy.setMochilaRotulo(Ib===`sobrevivencia`),Xy.setScale(Zy.uiScale),this.atualizarComerToque(),db()),this.hud.extra=()=>{let e=$.mouseStats,t=this.player.pos,n=Math.floor(t.x),r=Math.floor(t.z),i=kf(n,r,this.worldSeed),a=Nu(i),o=Pu(i),s=Math.min(Of(n,r,this.worldSeed,this.world.sizeY),this.world.sizeY-2),c=s<=23?`areia (praia)`:s>=58&&a.neve?`neve`:s>=85?`pedra (chapada)`:a.topo===`grama`?o===G.GramaSeca?`grama seca`:o===G.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${a.nome}  temp ${i.temp.toFixed(2)}  umid ${i.umid.toFixed(2)}  seed ${this.worldSeed}\nterreno h ${s}  topo ${c}  [praia ≤23 · neve ≥58 se o bioma neva · chapada ≥85]\nrelevo ${Ru(i).toFixed(2)} (teto do bioma ${a.relevo})\nmodo ${Ib===`sobrevivencia`?`sobrevivência`:`criativo`}  voo ${Rb()?Fb?`voando`:`liberado`:`trancado`}`+(Hb?`  vida ${Hb.vida}/20`+(Hb.fome===void 0?`  sem fome`:`  fome ${Hb.fome}/20`):``)+`
mouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let l=new qd;setInterval(()=>{let e={x:this.player.pos.x,y:this.player.pos.y,z:this.player.pos.z,yaw:$.yaw,pitch:$.pitch};l.aEnviar(e,performance.now())&&this.activeConn.send(JSON.stringify({type:`move`,...e}))},1e3/10),this.activeConn instanceof q_&&vb&&!qy&&(hx(),setInterval(()=>void hx(),3e4));let u={...t.stats};setInterval(()=>{let e=this.activeConn.stats;this.hud.net={msgsPerSec:e.msgsIn+e.msgsOut-(u.msgsIn+u.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(u.bytesIn+u.bytesOut),tickAvgMs:Eb.tickAvgMs,tickMaxMs:Eb.tickMaxMs,jitterMs:jb()},this.hud.regras=Db,this.hud.stream={colunas:this.colunasCarregadas.size,fila:this.chunkRenderer.filaPendente,faltando:this.colunasFaltando.tamanho,repedidas:this.colunasFaltando.repedidas,ultimoLote:this.chunkRenderer.ultimoLote},this.hud.luz=this.luz.medidas,u={...e}},1e3)}async entregarPerfilDoBench(e,t){try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);Tb.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let n=t?`bench-semvida`:`bench`;this.hud.baixar(e,n),Tb.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${n}-*.json)`)}}iniciarBench(){if(!qy||this.bench)return;let e=this.bench=dh.paraMundo(qy,this.spawn,this.world.dims),t=qy;this.hud.setMeta({bench:e.meta()}),this.hud.marcar(`bench: início`,`${t.duracaoS}s · raio ${e.trajeto.raio}${t.semVida?` · sem vida ambiental`:``}`),nb=!0,window.__benchRodando=!0,Fb=!0,db(),this.hud.marcar(`foto: câmera liberada`),e.iniciar(performance.now());let n=e.amostra(performance.now());this.player.pos.x=n.x,this.player.pos.y=n.y,this.player.pos.z=n.z,this.movimento.ancorar(this.player.pos),this.hud.record(e=>{nb=!1,window.__benchRodando=!1,db(),window.__benchPerfil=e,this.entregarPerfilDoBench(e,t.semVida)},t.duracaoS*1e3)}iniciarFoto(){if(Jy===null||this.foto)return;this.foto=!0,rb=!0,Fb=!0,this.player.pos.y=Math.max(this.player.pos.y,this.spawn.y??this.player.pos.y)+40,this.movimento.ancorar(this.player.pos),db();let e=(e,t)=>{$.yaw=e,$.pitch=t},t=window;t.__fotoApontar=e,t.__fotoCam=()=>({fov:Ly.fov,aspect:Ly.aspect}),t.__fotoRodando=!0}iniciar(){let e=performance.now();Fy.setAnimationLoop(()=>{let t=performance.now(),n=t-e;e=t;let r=Math.min(n/1e3,.05),i=this.movimento.comando(t,{voando:Fb,podeVoar:Rb()});Fb=i.voando;let a=!0;if(this.chunkRenderer.modoCarga=eb.ativo,this.mundoLazy){{let e=this.luz.drenar(this.world,eb.ativo?16:vx,e=>this.colunasCarregadas.has(e));for(let t of e)this.chunkRenderer.enfileirarColuna(t.cx,t.cz)}this.chunkRenderer.processarFila(Zy.meshMsPorFrame,(e,t)=>{this.colunasCarregadas.delete(t*this.world.dims.x+e)});let{cx:e,cz:n}=Vd(this.world.dims,this.player.pos.x,this.player.pos.z);if(a=this.colunasCarregadas.has(Wd(this.world.dims,e,n)),(this.frameCount=(this.frameCount+1)%60)==0){for(let t of this.colunasCarregadas){let{cx:r,cz:i}=Gd(this.world.dims,t);Ud(r,i,e,n,Zy.raioRender)||(this.colunasCarregadas.delete(t),this.descartarColuna(r,i))}this.colunasFaltando.varrer(e,n,t,this.world.dims,Zy.raioRender,this.colunasCarregadas);let r=Zy.raioRender*16;this.claimRenderer.cularPorDistancia(this.player.pos.x,this.player.pos.z,r),this.regionRenderer.cularPorDistancia(this.player.pos.x,this.player.pos.z,r)}}else this.chunkRenderer.processarFila(eb.ativo?50:Zy.meshMsPorFrame);if(eb.ativo&&this.progresso.raioCompleto&&this.luz.filaVazia&&this.chunkRenderer.filaPendente===0&&eb.concluir(),this.bench?.ativo){let e=this.bench.amostra(t);this.player.pos.x=e.x,this.player.pos.y=e.y,this.player.pos.z=e.z,this.player.vel.x=this.player.vel.y=this.player.vel.z=0,$.yaw=e.yaw,$.pitch=e.pitch,this.bench.terminou(t)&&(this.bench.parar(),this.hud.marcar(`bench: fim`))}let o=this.player.pos.y;a&&!this.bench?.ativo&&!this.foto&&pf(this.world,this.player,{...i,noclip:Yb},r),this.movimento.aposOPasso(r,this.player,o,i),this.player.pos.y<-16&&this.respawn(),this.outros.interpolar(r);let s=Zy.fov*(this.player.sprinting?1.1:1);Math.abs(Ly.fov-s)>.01&&(Ly.fov+=(s-Ly.fov)*(1-Math.exp(-r*20)),Ly.updateProjectionMatrix()),Ly.position.set(this.player.pos.x,this.player.pos.y+this.movimento.alturaOlho,this.player.pos.z),Ly.rotation.set($.pitch,$.yaw,0);let c=+!!this.dormindo;this.dormirT+=(c-this.dormirT)*(1-Math.exp(-r*6));let l=this.dormindo??this.ultimaCama;if(l&&this.dormirT>.002){let e=this.dormirT;Ly.position.set(Ly.position.x+(l.x+.5-Ly.position.x)*e,Ly.position.y+(l.y+1+q.width/2-Ly.position.y)*e,Ly.position.z+(l.z+.5-Ly.position.z)*e),Ly.rotation.x=$.pitch+(Math.PI/3-$.pitch)*e}else this.dormirT<=.002&&(this.ultimaCama=null);Ly.getWorldDirection(this.lookDir),this.target=$.active?gm(this.world,Ly.position.x,Ly.position.y,Ly.position.z,this.lookDir.x,this.lookDir.y,this.lookDir.z,5,this.hotbarUi.idNaMao()===900):null;let u=this.target?K(this.world,this.target.x,this.target.y,this.target.z):null;if(u!==this.ultimoIdMirado&&(this.ultimoIdMirado=u??-1,Xy?.setModoInteragir(u!==null&&Ny(u))),this.alvoJogador=$.active&&Ib===`sobrevivencia`&&Lb?mm(Ly.position.x,Ly.position.y,Ly.position.z,this.lookDir.x,this.lookDir.y,this.lookDir.z,this.outros.alvosParaMira(),5):null,this.alvoJogador&&this.target){let e=Math.hypot(this.target.x+.5-Ly.position.x,this.target.y+.5-Ly.position.y,this.target.z+.5-Ly.position.z);this.alvoJogador.dist>e&&(this.alvoJogador=null)}if(sb?.classList.toggle(`alvo`,this.alvoJogador!==null),this.highlight.visible=this.target!==null&&this.alvoJogador===null,this.target){let[e,t,n,r,i,a]=_p(K(this.world,this.target.x,this.target.y,this.target.z));this.highlight.position.set(this.target.x+(e+r)/2,this.target.y+(t+i)/2,this.target.z+(n+a)/2),this.highlight.scale.set(r-e+.004,i-t+.004,a-n+.004)}this.hud.setRemesh({count:this.chunkRenderer.remeshCount,totalMs:this.chunkRenderer.remeshMsTotal,workerMs:this.chunkRenderer.remeshWorkerMsTotal,config:this.chunkRenderer.meshConfig,lastMs:this.chunkRenderer.lastRemeshMs,porCaminho:this.chunkRenderer.porCaminho}),Hy.update(r),By.update(r,Hy),this.materiais.atualizar(r,Hy,By.nivelCeu,Zy.balanco),this.aguaFx.update(this.world,Ly.position.x,Ly.position.y,Ly.position.z);let d=performance.now();this.hud.gpuInicio(),Fy.render(Iy,Ly),this.hud.gpuFim(),this.hud.frame(n,performance.now()-d)}),gx.has(`hud`)&&this.hud.toggle(),new URLSearchParams(location.search).has(`painel`)&&Qy.cp14?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Qy.mochila?.toggle(),new URLSearchParams(location.search).has(`amigos`)&&Qy.amigos?.toggle(),gx.has(`touch`)&&fb()}descartarColuna=(e,t)=>{this.chunkRenderer.descartarColuna(e,t),this.torchGlow.descartarColuna(e,t),this.luz.descartar(e,t);for(let n=0;n<this.world.dims.y;n++)this.world.chunks[(n*this.world.dims.z+t)*this.world.dims.x+e]=void 0};drawClaims=e=>{this.claimRenderer.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};updateObjectiveBoxes=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Qb!==null&&r.grupo===Qb;(Nb===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});this.objectiveBoxes.setRegions(t)};recalcularCarga=()=>this.progresso.recalcular(this.world.dims,this.player.pos.x,this.player.pos.z,Zy.raioRender,this.mundoLazy);respawn(){this.player.pos.x=this.spawn.x,this.player.pos.y=this.spawn.y,this.player.pos.z=this.spawn.z,this.player.vel.x=this.player.vel.y=this.player.vel.z=0}aplicarColunas(e){let t=[];try{t=Bd(e,this.world)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:n}of t){let t=n*this.world.dims.x+e;this.colunasCarregadas.add(t),this.colunasFaltando.chegou(t),this.luz.enfileirar(e,n,this.world.dims.x),this.torchGlow.varrerColuna(this.world,e,n)}this.colunasRecebidas+=t.length}applyRegions(e){this.regionRenderer.setRegions(e),this.regionRenderer.clearCorners()}applyClaims(e){this.drawClaims(e),this.regionRenderer.clearCorners(),this.hotbarUi.revalidarVarinha(),Xy?.setVarinhaDisponivel(Nb===`professor`||Gb),Xy?.setAmigosDisponivel(Gb),this.hotbarUi.refresh()}applyQuadros(e){this.quadroRenderer.setAll(e,this.world)}applyQuadroChanged(e){this.quadroRenderer.aplicar(e,this.world)}applyObjectiveBoxes(e){this.updateObjectiveBoxes(e)}iniciarTroca(e){this.progresso.indeterminar(),eb.abrir({host:_b,rede:!(this.activeConn instanceof q_),titulo:`trocando de aula`,alvo:e}),this.progresso.observar(),eb.setFase(`preparando`),this.hud.setFase(`carregando`),this.hud.marcar(`troca de aula`,e),db()}reloadWorld(e){this.world=e.world,this.worldSeed=e.seed,this.mundoLazy=nx,this.colunasCarregadas=new Set,this.colunasFaltando.limpar(),this.luz.trocarMundo(this.world.dims),this.mundoLazy||this.luz.acenderTudo(this.world),this.chunkRenderer.trocarMundo(this.world,!this.mundoLazy,this.luz.paraMesher),this.torchGlow.setFromWorld(this.world),Wb=[],this.regionRenderer.setRegions([]),this.regionRenderer.clearCorners(),this.quadroRenderer.setAll([],this.world),Zb=null,this.updateObjectiveBoxes([]),Jb.update(`livre`,[],{grupo:null,professor:Nb===`professor`,painelComo:wb(bv(Zy.keys.painel),`📋`,`/painel`)}),ex.clear(),tx=!1,$b=[],Qb=null,ix(),this.spawn=Mb??this.spawn,this.respawn(),Tb.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),mb=-1,hb(),this.hud.setMeta({worldChunks:this.world.dims,worldSeed:e.seed}),this.recalcularCarga(),eb.abrir({host:_b,rede:!(this.activeConn instanceof q_),titulo:`trocando de aula`}),this.progresso.observar(),eb.setFase(this.mundoLazy?`mundo`:`malha`),this.hud.setFase(`carregando`),db()}applyTeleport(e){this.player.pos.x=e.x,this.player.pos.y=e.y,this.player.pos.z=e.z,this.player.vel.x=this.player.vel.y=this.player.vel.z=0,$.yaw=Gy??e.yaw,$.pitch=Ky??e.pitch}applyBlockChanged(e){Ju(this.world,e.x,e.y,e.z,e.blockId),this.chunkRenderer.remeshBlock(e.x,e.y,e.z),this.chunkRenderer.remeshSujos(this.luz.aoMudarBloco(this.world,e.x,e.y,e.z)),this.torchGlow.onBlockChanged(e.x,e.y,e.z,e.blockId),this.quadroRenderer.onBlockChanged(e.x,e.y,e.z,e.blockId,this.world),Km(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})}applyBlocksFilled(e){for(let t=e.y0;t<=e.y1;t++)for(let n=e.z0;n<=e.z1;n++)for(let r=e.x0;r<=e.x1;r++)Ju(this.world,r,t,n,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},n={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(this.world.dims.x-1,e.x1/16|0);t++)for(let n=Math.max(0,e.z0/16|0);n<=Math.min(this.world.dims.z-1,e.z1/16|0);n++)this.chunkRenderer.remeshSujos(this.luz.aoChegarColuna(this.world,t,n));this.chunkRenderer.remeshBox(t,n),this.torchGlow.onRegionFilled(t,n,e.blockId),this.quadroRenderer.validarTodos(this.world),Km(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})}applyPlayerMoved(e){this.outros.aoMover(e)}applyPlayerLeft(e){this.outros.aoSair(e)}aoDormir(e,t){this.dormindo=e&&t?t:null,this.dormindo&&(this.ultimaCama=this.dormindo)}aoMudarMochila(){this.hotbarUi.refresh(),this.atualizarComerToque()}atualizarComerToque(){let e=this.hotbarUi.idNaMao(),t=Hb?.fome,n=zb.ativa&&e!==null&&Yd(e)&&t!==void 0&&t<20;Xy?.setModoComer(n)}};function bx(e){let t=gb;t&&(tb=new yx(e,t),tb.iniciar())}