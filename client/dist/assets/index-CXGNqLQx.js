...
`,Yf=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Jf,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.tapButton(`⛶`,`tela cheia`,()=>qf()),this.tapButton(`📊`,`hud`,()=>this.actions.hud())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){this.root.style.setProperty(`--ts`,String(e))}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},Xf=`lj-nome`;function Zf(){let e=localStorage.getItem(Xf),t=e?eu(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(Xf,t),t}function Qf(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function $f(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function ep(e){document.getElementById(e)?.classList.add(`hidden`)}function tp(e){let t=Qf(`menu`),n={home:Qf(`menu-home`),worlds:Qf(`menu-worlds`),multi:Qf(`menu-multi`),config:Qf(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),Qf(`menu-version`).textContent=`v${sd}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Ud(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),$f(`menu-erro`,i));let a=Qf(`menu-nome`);a.value=Zf(),a.addEventListener(`change`,()=>{let e=eu(a.value);localStorage.setItem(Xf,e),a.value=e}),Qf(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),Qf(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),Qf(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=Qf(`menu-world-list`);async function c(){let e=[];try{e=await Vf()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>Wf(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){Uf(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=Qf(`menu-new-nome`),u=Qf(`menu-new-tipo`);Qf(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){$f(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}ep(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:su(u.value),tamanho:cu(Qf(`menu-new-tamanho`).value)})});let d=Qf(`menu-import-file`);Qf(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&Gf(e).then(async e=>{await Hf(e),await c(),ep(`menu-worlds-erro`)}).catch(e=>{$f(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=Qf(`menu-endereco`),p=Qf(`menu-pin`),m=Qf(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,Qf(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){$f(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){$f(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}ep(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),np(Qf(`menu-config-body`),void 0,()=>r(`home`))}function np(e,t,n){ap(e,t,n)}function rp(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var ip=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function ap(e,t,n){e.textContent=``;for(let r of ip){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>op(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{Pf(structuredClone(kf)),t?.(),ap(e,t,n)}),e.appendChild(r),n&&rp(e,n)}function op(e,t,n,r){e.textContent=``;let i=Nf(),a=()=>{Pf(i),n?.()},o=document.createElement(`h2`);o.textContent=ip.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),Kf()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(Af)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=Af[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=Ff(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=Ff(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Vd(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>Ud(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`chunks re-meshados por frame`,2,32,1,i.meshPorFrame,e=>i.meshPorFrame=e,e=>`${e}`)}rp(e,()=>ap(e,n,r))}var sp=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},cp=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Ud(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},lp=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Ud(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},up=class extends lp{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(Yd[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=tu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=tu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...Yd.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},dp=class extends lp{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},fp=class{fixedColor;group=new cn;cornerMarks=[];boxes=[];constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Si(new Vi(new Fi(1.01,1.01,1.01)),new ui({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Si(new Vi(new Fi(n+.04,r+.04,i+.04)),new ui({color:this.fixedColor??new W().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a})}},pp=1/16,mp=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*pp-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*pp-.004,ry:Math.PI}];function hp(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var gp=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(Fu(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=Fu(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=Zl(t,e.x,e.y,e.z);if(!yl(r))return;let i=mp[r-q.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,hp(a,e,null);let o=new ji(a);o.colorSpace=ze;let s=new Qr(new Hi(12*pp,12*pp),new Br({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{hp(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=Fu(e,t,n);if(this.conteudos.has(a))if(!yl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])yl(Zl(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function _p(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var vp=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,_p(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},yp=null;function bp(e){e.preventDefault(),e.returnValue=``}var xp=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function Sp(e){yp?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||xp.has(e.code))&&e.preventDefault())}function Cp(e){yp?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function wp(e){yp||(yp=e,window.addEventListener(`beforeunload`,bp),window.addEventListener(`keydown`,Sp,!0),window.addEventListener(`keyup`,Cp,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function Tp(){yp=null,window.removeEventListener(`beforeunload`,bp),window.removeEventListener(`keydown`,Sp,!0),window.removeEventListener(`keyup`,Cp,!0),navigator.keyboard?.unlock?.()}var Ep=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new ji(t);i.minFilter=o,this.material=new gr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();for(let t=0;t<e.sizeY;t++)for(let n=0;n<e.sizeZ;n++)for(let r=0;r<e.sizeX;r++)Zl(e,r,t,n)===q.Tocha&&this.add(r,t,n)}onBlockChanged(e,t,n,r){r===q.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===q.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Ar(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function Dp(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&af(n)}var Op=new hl({antialias:!0});Op.setPixelRatio(Math.min(window.devicePixelRatio,2)),Op.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Op.domElement);var kp=new gn;kp.background=new W(8900331);var Ap=new Aa(75,window.innerWidth/window.innerHeight,.1,512);Ap.rotation.order=`YXZ`;var jp=new Na(16777215,2.2);jp.position.set(60,100,40);var Mp=new Pa(16777215,.55);kp.add(jp,Mp);var Np=new xf(jp,Mp,kp,Ap),Pp=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();Pp!==null&&Np.sync(Pp,!1);var $=new Of(Op.domElement),Fp=new URLSearchParams(location.search).get(`yaw`);Fp!==null&&Number.isFinite(Number(Fp))&&($.yaw=Number(Fp));function Ip(){let e=Nf();return $.sensitivity=e.sensitivity,Ap.fov=e.fov,Ap.updateProjectionMatrix(),Op.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Vd(e.volume),Vp?.setScale(e.uiScale),e}var Lp=Ip();Gd(Lp.volume);var Rp=null,zp=null,Bp=null,Vp=null,Hp=document.getElementById(`overlay`),Up=document.getElementById(`overlay-main`),Wp=document.getElementById(`overlay-config`),Gp=document.getElementById(`crosshair`);function Kp(){Up?.classList.remove(`hidden`),Wp?.classList.add(`hidden`)}function qp(){let e=(Rp?.open??!1)||(zp?.open??!1)||(Bp?.open??!1);Hp?.classList.toggle(`hidden`,$.active||em.open||e),Gp?.classList.toggle(`hidden`,!$.active),$.locked&&Kp(),Vp?.setShown($.touch&&!em.open&&!e)}document.addEventListener(`pointerlockchange`,qp);function Jp(){Kf()?($.touch=!0,qf(),qp()):$.lock()}function Yp(){let e=Lp.keys;Lp=Ip();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],Lp.keys[t])}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Jp()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&np(e,Yp,Kp),Up?.classList.add(`hidden`),Wp?.classList.remove(`hidden`)}),Hp?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Ud(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{Ap.aspect=window.innerWidth/window.innerHeight,Ap.updateProjectionMatrix(),Op.setSize(window.innerWidth,window.innerHeight)});var Xp=null,Zp=`?`,Qp=null;function $p(){return new URLSearchParams(location.search).get(`nome`)??Zf()}var em=new df(e=>Xp?.send(JSON.stringify({type:`chat`,text:e})),e=>{qp(),e||$.lock()});qp(),Op.domElement.addEventListener(`pointerdown`,()=>{$.touch&&em.open&&em.close()});var tm={tickAvgMs:0,tickMaxMs:0},nm=0,rm=[];function im(){let e=performance.now();nm>0&&(rm.push(e-nm),rm.length>300&&rm.shift()),nm=e}function am(){let e=rm.length;if(e<2)return 0;let t=rm.reduce((e,t)=>e+t,0)/e,n=rm.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var om=!1,sm=null,cm=null,lm=null,um=null,dm=null,fm=null,pm=`aluno`,mm=!1,hm=!1;function gm(){return pm===`professor`||mm}var _m=[],vm=null,ym=!1,bm=[],xm=null,Sm=null,Cm=null,wm=new sp,Tm=null,Em=null,Dm=null,Om=[],km=new Set,Am=!1,jm=null,Mm=null,Nm=!1,Pm=new Map;function Fm(){Rp?.update({regions:_m,modo:Tm?.modo??`sequencial`,objetivos:Tm?.objetivos??[],grupos:Om,myGrupo:Dm})}function Im(e){return e.porGrupo&&pm!==`professor`?Dm===null?!1:e.porGrupo.find(e=>e.grupo===Dm)?.completo??!1:e.completo}function Lm(e){if(Tm){for(let t of Tm.objetivos)Im(t)?km.has(t.id)||(km.add(t.id),e&&Am&&Id({kind:`objective_complete`})):km.delete(t.id);Am=!0,wm.update(Tm.modo,Tm.objetivos,{grupo:Dm,professor:pm===`professor`,painelKey:Ff(Lp.keys.painel)}),Em?.(Tm.objetivos)}}function Rm(e){if(im(),typeof e==`string`){let t=Ju(e);if(!t)return;t.type===`debug_stats`?tm={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs}:t.type===`block_changed`?sm?.(t):t.type===`blocks_filled`?cm?.(t):t.type===`player_moved`?(t.name&&Pm.get(t.id)!==t.name&&(Pm.set(t.id,t.name),of([...new Set(Pm.values())])),lm?.(t)):t.type===`player_left`?(Pm.delete(t.id),of([...new Set(Pm.values())]),um?.(t.id)):t.type===`spawn`?(fm={x:t.x,y:t.y,z:t.z},pm=t.papel??`aluno`):t.type===`regions`?(_m=t.regions,vm?.(t.regions),Fm()):t.type===`objectives`?(Tm={modo:t.modo,objetivos:t.objetivos},Lm(!0),Fm()):t.type===`group`?(Dm=t.grupo,km.clear(),Lm(!1),Fm()):t.type===`groups`?(Om=t.grupos,Fm()):t.type===`quadros`?Sm?.(t.lista):t.type===`quadro_changed`?Cm?.(t):t.type===`claims`?(ym=t.ativo,bm=t.claims,xm?.(t.claims)):t.type===`friends`||(t.type===`players`?Bp?.update({conectados:t.conectados,banidos:t.banidos}):t.type===`teleport`?dm?.(t):t.type===`time`?Pp===null&&Np.sync(t.hora,t.ciclo):t.type===`voo`?(mm=t.liberado,gm()||(hm=!1),em.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(Ud(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),Tp(),location.href=location.pathname):t.type===`join_denied`?(Ud(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),Tp(),location.href=location.pathname):t.type===`chat`&&(em.addMessage(t.author,t.text),t.author===`servidor`&&Dp(t.text),Id({kind:`chat_message`})));return}let t=Qu(e);if(t===809716300){Mm?.(e);return}let n=()=>(Nm=t===Xu,Nm?$u(e):Yu(e));if(om){jm?.(n());return}om=!0,Gm(n())}function zm(e,t){Lp=Ip(),Xp=e,e.onMessage(Rm),$.onKey(Lp.keys.chat,()=>{em.open||(document.exitPointerLock(),em.openInput())}),e.send(JSON.stringify({type:`join`,name:$p(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),e.send(JSON.stringify({type:`radius`,chunks:Lp.raioRender}))}function Bm(e,t){Zp=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),zm(new Cf(e),t)}function Vm(e){Qp={id:e.id,name:e.name,createdAt:e.createdAt},Zp=`web-worker (${e.name})`;let t=new Sf(new Worker(new URL(`/assets/worker-D8qQI-uY.js`,``+import.meta.url),{type:`module`})),n=crypto.getRandomValues(new Uint32Array(1))[0]??1;t.init({save:e.data??void 0,seed:n,preset:e.preset,tamanho:e.tamanho}),zm(t)}async function Hm(){if(!(Xp instanceof Sf)||!Qp)return;let e=await Xp.requestSave();await Hf({...Qp,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{Tp(),Hm().finally(()=>location.reload())});var Um=new URLSearchParams(location.search),Wm=Um.get(`server`);if(Wm){let e=Um.get(`codigo`);Bm(Wm,{pin:Um.get(`pin`)??``,...e?{codigo:e}:{}})}else tp({onPlayWorld:Vm,onPlayMulti:Bm});function Gm(e){let t=Xp;if(!t)return;wp(()=>$.active);let n=e.world,r=e.seed,i=Nm,a=new Set,s=0,c=new $i({map:Nd(),alphaTest:.5});if(new URLSearchParams(location.search).has(`atlas`)){let e=c.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let l=new ff(n,c,kp);i||l.buildAll(),Mm=e=>{let t=td(e,n);for(let{cx:e,cz:r}of t)a.add(r*n.dims.x+e),l.enfileirarColuna(e,r)};let u=new Ep(kp);u.setFromWorld(n);let d=new fp(kp);d.setRegions(_m),vm=e=>{d.setRegions(e),d.clearCorners()};let f=new fp(kp,16747546),p=e=>{f.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};p(bm),xm=e=>{p(e),d.clearCorners(),!ym&&pm!==`professor`&&ne&&(ne=!1),ae()};let m=new gp(kp),h=new vp;Sm=e=>m.setAll(e,n),Cm=e=>m.aplicar(e,n);let g=new fp(kp,3066993),_=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Dm!==null&&r.grupo===Dm;(pm===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});g.setRegions(t)};Em=_,Tm&&_(Tm.objetivos);let v=e=>t.send(JSON.stringify({type:`chat`,text:e})),y=e=>{e?document.exitPointerLock():$.lock(),qp()};pm===`professor`&&(Bp=new cp(v,y)),Rp=pm===`professor`?new up(v,y,()=>{Rp?.hide(),zp?.hide(),Bp?.show()}):new dp(v,y),Fm(),$.onKey(Lp.keys.painel,()=>{if(!em.open){if(pm!==`professor`&&Om.length===0){em.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}zp?.hide(),Bp?.hide(),Rp?.toggle()}}),pm===`professor`&&em.addMessage(`jogo`,`tecla ${Ff(Lp.keys.painel)} abre o painel de autoria`);let b=fm??{x:n.sizeX/2+.5,y:$l(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},x=Du(b.x,b.y,b.z);function S(){x.pos.x=b.x,x.pos.y=b.y,x.pos.z=b.z,x.vel.x=x.vel.y=x.vel.z=0}jm=e=>{n=e.world,r=e.seed,i=Nm,a=new Set,l.trocarMundo(n),u.setFromWorld(n),_m=[],d.setRegions([]),d.clearCorners(),m.setAll([],n),Tm=null,Em?.([]),wm.update(`livre`,[],{grupo:null,professor:pm===`professor`,painelKey:Ff(Lp.keys.painel)}),km.clear(),Am=!1,Om=[],Dm=null,Fm(),b=fm??b,S(),em.addMessage(`jogo`,`a aula mudou — mundo novo carregado`)},dm=e=>{x.pos.x=e.x,x.pos.y=e.y,x.pos.z=e.z,x.vel.x=x.vel.y=x.vel.z=0,$.yaw=e.yaw,$.pitch=e.pitch},sm=e=>{Ql(n,e.x,e.y,e.z,e.blockId),l.remeshBlock(e.x,e.y,e.z),u.onBlockChanged(e.x,e.y,e.z,e.blockId),m.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Id(e.blockId===q.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},cm=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)Ql(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};l.remeshBox(t,r),u.onRegionFilled(t,r,e.blockId),m.validarTodos(n),Id(e.blockId===q.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let C=new Map,w=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new ji(t);i.minFilter=o;let a=new Ar(new gr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,wu.height/2+.35,0),a},T=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};lm=e=>{let t=C.get(e.id);if(!t){let n=new Qr(new Fi(wu.width,wu.height,wu.width),new $i({color:new W().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+wu.height/2,e.z),n.rotation.y=e.yaw,kp.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},C.set(e.id,t)}e.name&&e.name!==t.labelName&&(T(t),t.label=w(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+wu.height/2,e.z),t.targetYaw=e.yaw},um=e=>{let t=C.get(e);t&&(T(t),kp.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),C.delete(e))};let E=new Si(new Vi(new Fi(1,1,1)),new ui({color:0}));E.visible=!1,kp.add(E);let D=null,ee=new H,O=`lj-hotbar`,k=Xd(pm),te=()=>k.slice(0,9).map(e=>e.id),A=(()=>{let e=new Set(k.map(e=>e.id)),t=te();try{let n=JSON.parse(localStorage.getItem(O)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),j=0,ne=!1,re=document.getElementById(`hotbar`),M=Kd(c.map?.image,Yd.map(e=>e.id)),ie=e=>Yd.find(t=>t.id===e)?.name??`?`,ae=()=>{if(!re)return;if(ne){re.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${pm===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=A.map((e,t)=>`<span class="slot${t===j?` sel`:``}"><small>${t+1}</small><img src="${M.get(e)??``}" alt=""></span>`).join(``);re.innerHTML=`<span class="bar-nome">${ie(A[j]??q.Grass)}</span><span class="slots">${e}</span>`,zp?.refresh()};ae();let oe=()=>{pm!==`professor`&&!ym||(ne=!ne,ae())};$.onKey(Lp.keys.varinha,oe);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{j=e,ae()});$.onWheel(e=>{j=(j+e+A.length)%A.length,ae()}),zp=new Zd(M,()=>k,()=>({hotbar:A,selected:j}),e=>{A[j]=e,localStorage.setItem(O,JSON.stringify(A)),ae()},e=>{j=e,ae()},e=>{e?(Rp?.hide(),Bp?.hide(),document.exitPointerLock()):$.lock(),qp()}),$.onKey(Lp.keys.inventario,()=>{em.open||zp?.toggle()});let se=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),d.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(D){if(ne){se(1,D);return}t.send(JSON.stringify({type:`break_block`,x:D.x,y:D.y,z:D.z}))}}),$.onMouseButton(2,()=>{if(!D)return;if(ne){se(2,D);return}if(yl(Zl(n,D.x,D.y,D.z))){let{x:e,y:n,z:r}=D;h.open(m.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(Fl(Zl(n,D.x,D.y,D.z))){t.send(JSON.stringify({type:`use_block`,x:D.x,y:D.y,z:D.z}));return}let e=A[j];if(e!==void 0){if((e===q.PortaXFechada||e===q.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?q.PortaXFechada:q.PortaZFechada),(e===q.JanelaXFechada||e===q.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?q.JanelaXFechada:q.JanelaZFechada),bl(e)||xl(e)||Sl(e)||yl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(bl(e)?q.CadeiraXP:xl(e)?q.SofaXP:Sl(e)?q.CamaXP:q.QuadroXP)+r}t.send(JSON.stringify({type:`place_block`,x:D.x+D.nx,y:D.y+D.ny,z:D.z+D.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!D||ne)return;let e=Zl(n,D.x,D.y,D.z);Dl(e)&&(e=q.PortaXFechada),jl(e)&&(e=q.JanelaXFechada),bl(e)&&(e=q.CadeiraXP),xl(e)&&(e=q.SofaXP),Sl(e)&&(e=q.CamaXP),yl(e)&&(e=q.QuadroXP),Rl(e)&&(zl(e)&&pm!==`professor`||(A[j]=e,localStorage.setItem(O,JSON.stringify(A)),ae()))});let ce=new Df(Op,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Zp});ce.setRemesh({count:l.remeshCount,totalMs:l.remeshMsTotal,lastMs:l.lastRemeshMs}),$.onKey(Lp.keys.hud,()=>ce.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{ce.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),Kf()&&(re&&(re.style.pointerEvents=`auto`,re.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(j=n,ae())})),Vp=new Yf($,{keys:()=>Lp.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>zp?.toggle(),chat:()=>{em.open||(document.exitPointerLock(),em.openInput())},menu:()=>{$.touch=!1,Kp(),qp()},hud:()=>ce.toggle(),varinha:()=>oe()}),Vp.setScale(Lp.uiScale),qp()),ce.extra=()=>{let e=$.mouseStats,t=x.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=pu(i,a,r),s=Vl(o),c=Hl(o),l=Math.min(fu(i,a,r,n.sizeY),n.sizeY-2),u=l<=18?`areia (praia)`:l>=58&&o.temp<.6?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===q.GramaSeca?`grama seca`:c===q.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤18 · neve ≥58 se temp<0.60 · chapada ≥85]\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let le={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},ue=0;setInterval(()=>{let e={x:x.pos.x,y:x.pos.y,z:x.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==le.x||e.y!==le.y||e.z!==le.z||e.yaw!==le.yaw||e.pitch!==le.pitch,r=performance.now();!n&&r-ue<2e3||(le=e,ue=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof Sf&&Qp&&(Hm(),setInterval(()=>void Hm(),3e4));let N={...t.stats};setInterval(()=>{let e=t.stats;ce.net={msgsPerSec:e.msgsIn+e.msgsOut-(N.msgsIn+N.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(N.bytesIn+N.bytesOut),tickAvgMs:tm.tickAvgMs,tickMaxMs:tm.tickMaxMs,jitterMs:am()},ce.stream={colunas:a.size,fila:l.filaPendente},N={...e}},1e3);let de=performance.now(),fe=!1,pe=!1,me=0,he=!1,ge=0,_e=wu.eyeHeight;Op.setAnimationLoop(()=>{let e=performance.now(),t=e-de;de=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(Lp.keys.forward)-+!!$.down(Lp.keys.back):0,c=$.active?!!$.down(Lp.keys.right)-+!!$.down(Lp.keys.left):0,u=$.active&&$.down(Lp.keys.jump),d=$.active&&$.down(Lp.keys.forward);d&&!pe&&(e-me<300&&(fe=!0),me=e),d||(fe=!1),pe=d;let f=$.active&&$.down(Lp.keys.agachar),p=o>0&&!f&&(fe||$.active&&$.down(Lp.keys.correr));u&&!he&&(gm()&&e-ge<300&&(hm=!hm),ge=e),he=u;let m=hm&&gm(),h=!0;if(i){l.processarFila(Lp.meshPorFrame);let e=Math.max(0,Math.min(n.dims.x-1,Math.floor(x.pos.x/16))),t=Math.max(0,Math.min(n.dims.z-1,Math.floor(x.pos.z/16)));if(h=a.has(t*n.dims.x+e),(s=(s+1)%60)==0)for(let r of a){let i=r%n.dims.x,o=(r-i)/n.dims.x;if(Math.max(Math.abs(i-e),Math.abs(o-t))>Lp.raioRender+2){a.delete(r),l.descartarColuna(i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}}h&&Nu(n,x,{forward:o,strafe:c,jump:u,yaw:$.yaw,sprint:p,sneak:f,fly:m},r),x.pos.y<-16&&S();let g=1-Math.exp(-r*12);for(let e of C.values()){e.mesh.position.lerp(e.target,g);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*g}let _=1-Math.exp(-r*20);_e+=((f&&!m?wu.sneakEyeHeight:wu.eyeHeight)-_e)*_;let v=Lp.fov*(x.sprinting?1.1:1);if(Math.abs(Ap.fov-v)>.01&&(Ap.fov+=(v-Ap.fov)*_,Ap.updateProjectionMatrix()),Ap.position.set(x.pos.x,x.pos.y+_e,x.pos.z),Ap.rotation.set($.pitch,$.yaw,0),Ap.getWorldDirection(ee),D=$.active?Pu(n,Ap.position.x,Ap.position.y,Ap.position.z,ee.x,ee.y,ee.z,5):null,E.visible=D!==null,D){let[e,t,r,i,a,o]=vu(Zl(n,D.x,D.y,D.z));E.position.set(D.x+(e+i)/2,D.y+(t+a)/2,D.z+(r+o)/2),E.scale.set(i-e+.004,a-t+.004,o-r+.004)}ce.setRemesh({count:l.remeshCount,totalMs:l.remeshMsTotal,lastMs:l.lastRemeshMs}),Np.update(r),ce.frame(t),Op.render(kp,Ap)}),new URLSearchParams(location.search).has(`painel`)&&Rp?.toggle(),new URLSearchParams(location.search).has(`inv`)&&zp?.toggle(),Um.has(`touch`)&&Jp()}