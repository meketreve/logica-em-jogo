...
`)}var ec=new H;function tc(e){vt._getMatrix(ec,vt.workingColorSpace,e);let t=`mat3( ${ec.elements.map(e=>e.toFixed(4))} )`;switch(vt.getTransfer(e)){case Ve:return[t,`LinearTransferOETF`];case He:return[t,`sRGBTransferOETF`];default:return L(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function nc(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`
...
`)}var ic={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ac(e,t){let n=ic[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var oc=new V;function sc(){return vt.getLuminanceCoefficients(oc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${oc.x.toFixed(4)}, ${oc.y.toFixed(4)}, ${oc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Xs(i,i.VERTEX_SHADER,y),S=Xs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=nc(i,x,`vertex`),n=nc(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,cl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Ii(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new $i({vertexShader:ol,fragmentShader:sl,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ei(new Wi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ll=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new cl,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new B,te=null,O=new Ma;O.viewport=new kt;let ne=new Ma;ne.viewport=new kt;let k=[O,ne],A=new Ba,re=null,j=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new dn,C[e]=t),t.getHandSpace()};function M(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,j=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(te),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),te=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new jt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new Pi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new jt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new V,se=new V;function ce(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function le(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=ne.near=O.near=t,A.far=ne.far=O.far=n,(re!==A.near||j!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,j=A.far),A.layers.mask=e.layers.mask|6,O.layers.mask=A.layers.mask&-5,ne.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;le(A,i);for(let e=0;e<a.length;e++)le(a[e],i);a.length===2?ce(A,O,ne):A.projectionMatrix.copy(O.projectionMatrix),ue(e,A,i)};function ue(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=at*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let N=null;function de(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=k[n];o===void 0&&(o=new Ma,o.layers.enable(n),o.viewport=new kt,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Ii,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}N&&N(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let fe=new to;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){N=e},this.dispose=function(){}}},ul=new Pt,dl=new H;dl.set(-1,0,0,0,1,0,0,0,1);function fl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Yi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(ul.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(dl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function pl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var ml=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),hl=null;function gl(){return hl===null&&(hl=new ri(ml,16,16,te,g),hl.name=`DFG_LUT`,hl.minFilter=o,hl.magFilter=o,hl.wrapS=t,hl.wrapT=t,hl.generateMipmaps=!1,hl.needsUpdate=!0),hl}var _l=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([ne,O,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new V,te=null,k=null,A=[],re=[],j=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,ie=!1,ae=null,oe=null,se=null,ce=null;this._outputColorSpace=ze;let le=0,ue=0,N=null,de=-1,fe=null,pe=new kt,me=new kt,he=null,ge=new U(0),_e=0,ve=t.width,ye=t.height,be=1,xe=null,Se=null,Ce=new kt(0,0,ve,ye),we=new kt(0,0,ve,ye),Te=!1,Ee=new di,De=!1,Oe=!1,ke=new Pt,Ae=new V,je=new kt,Me={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ne=!1;function Pe(){return N===null?be:1}let P=n;function Fe(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,lt,!1),t.addEventListener(`webglcontextrestored`,ut,!1),t.addEventListener(`webglcontextcreationerror`,B,!1),P===null){let t=`webgl2`;if(P=Fe(t,e),P===null)throw Fe(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Ie,Le,F,Re,I,Be,Ve,He,Ue,We,Ke,qe,Je,Xe,Qe,$e,tt,nt,rt,it,at,ot,z;function st(){Ie=new Fo(P),Ie.init(),at=new al(P,Ie),Le=new uo(P,Ie,e,at),F=new rl(P,Ie),Le.reversedDepthBuffer&&h&&F.buffers.depth.setReversed(!0),oe=P.createFramebuffer(),se=P.createFramebuffer(),ce=P.createFramebuffer(),Re=new Ro(P),I=new Lc,Be=new il(P,Ie,F,I,Le,at,Re),Ve=new Po(M),He=new no(P),ot=new co(P,He),Ue=new Io(P,He,Re,ot),We=new Bo(P,Ue,He,ot,Re),nt=new zo(P,Le,Be),Qe=new fo(I),Ke=new Ic(M,Ve,Ie,Le,ot,Qe),qe=new fl(M,I),Je=new Vc,Xe=new Jc(Ie),tt=new so(M,Ve,F,We,x,s),$e=new nl(M,We,Le),z=new pl(P,Re,Le,F),rt=new lo(P,Ie,Re),it=new Lo(P,Ie,Re),Re.programs=Ke.programs,M.capabilities=Le,M.extensions=Ie,M.properties=I,M.renderLists=Je,M.shadowMap=$e,M.state=F,M.info=Re}st(),S!==1009&&(j=new Ho(S,t.width,t.height,o,r,i));let ct=new ll(M,P);this.xr=ct,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let e=Ie.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Ie.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return be},this.setPixelRatio=function(e){e!==void 0&&(be=e,this.setSize(ve,ye,!1))},this.getSize=function(e){return e.set(ve,ye)},this.setSize=function(e,n,r=!0){if(ct.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ve=e,ye=n,t.width=Math.floor(e*be),t.height=Math.floor(n*be),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),j!==null&&j.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ve*be,ye*be).floor()},this.setDrawingBufferSize=function(e,n,r){ve=e,ye=n,be=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){R(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){L(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}j.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(pe)},this.getViewport=function(e){return e.copy(Ce)},this.setViewport=function(e,t,n,r){e.isVector4?Ce.set(e.x,e.y,e.z,e.w):Ce.set(e,t,n,r),F.viewport(pe.copy(Ce).multiplyScalar(be).round())},this.getScissor=function(e){return e.copy(we)},this.setScissor=function(e,t,n,r){e.isVector4?we.set(e.x,e.y,e.z,e.w):we.set(e,t,n,r),F.scissor(me.copy(we).multiplyScalar(be).round())},this.getScissorTest=function(){return Te},this.setScissorTest=function(e){F.setScissorTest(Te=e)},this.setOpaqueSort=function(e){xe=e},this.setTransparentSort=function(e){Se=e},this.getClearColor=function(e){return e.copy(tt.getClearColor())},this.setClearColor=function(){tt.setClearColor(...arguments)},this.getClearAlpha=function(){return tt.getClearAlpha()},this.setClearAlpha=function(){tt.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=tt.getClearColor(),r=tt.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,P.clearBufferuiv(P.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,P.clearBufferiv(P.COLOR,0,E))}else r|=P.COLOR_BUFFER_BIT}t&&(r|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&P.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,lt,!1),t.removeEventListener(`webglcontextrestored`,ut,!1),t.removeEventListener(`webglcontextcreationerror`,B,!1),tt.dispose(),Je.dispose(),Xe.dispose(),I.dispose(),Ve.dispose(),We.dispose(),ot.dispose(),z.dispose(),Ke.dispose(),ct.dispose(),ct.removeEventListener(`sessionstart`,gt),ct.removeEventListener(`sessionend`,_t),yt.stop()};function lt(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),ie=!0}function ut(){Ze(`WebGLRenderer: Context Restored.`),ie=!1;let e=Re.autoReset,t=$e.enabled,n=$e.autoUpdate,r=$e.needsUpdate,i=$e.type;st(),Re.autoReset=e,$e.enabled=t,$e.autoUpdate=n,$e.needsUpdate=r,$e.type=i}function B(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function dt(e){let t=e.target;t.removeEventListener(`dispose`,dt),ft(t)}function ft(e){pt(e),I.remove(e)}function pt(e){let t=I.get(e).programs;t!==void 0&&(t.forEach(function(e){Ke.releaseProgram(e)}),e.isShaderMaterial&&Ke.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Me);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=At(e,t,n,r,i);F.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ue.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;ot.setup(i,r,s,n,c);let h,g=rt;if(c!==null&&(h=He.get(c),g=it,g.setIndex(h)),i.isMesh)r.wireframe===!0?(F.setLineWidth(r.wireframeLinewidth*Pe()),g.setMode(P.LINES)):g.setMode(P.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),F.setLineWidth(e*Pe()),i.isLineSegments?g.setMode(P.LINES):i.isLineLoop?g.setMode(P.LINE_LOOP):g.setMode(P.LINE_STRIP)}else i.isPoints?g.setMode(P.POINTS):i.isSprite&&g.setMode(P.TRIANGLES);if(i.isBatchedMesh)if(Ie.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?He.get(c).bytesPerElement:1,o=I.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(P,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function H(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Tt(e,t,n),e.side=0,e.needsUpdate=!0,Tt(e,t,n),e.side=2):Tt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Xe.get(n),k.init(t),re.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];H(a,n,e),r.add(a)}else H(t,n,e),r.add(t)}),k=re.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){I.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Ie.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let mt=null;function ht(e){mt&&mt(e)}function gt(){yt.stop()}function _t(){yt.start()}let yt=new to;yt.setAnimationLoop(ht),typeof self<`u`&&yt.setContext(self),this.setAnimationLoop=function(e){mt=e,ct.setAnimationLoop(e),e===null?yt.stop():yt.start()},ct.addEventListener(`sessionstart`,gt),ct.addEventListener(`sessionend`,_t),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;ae!==null&&ae.renderStart(e,t);let n=ct.enabled===!0&&ct.isPresenting===!0,r=j!==null&&(N===null||n)&&j.begin(M,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ct.enabled===!0&&ct.isPresenting===!0&&(j===null||j.isCompositing()===!1)&&(ct.cameraAutoUpdate===!0&&ct.updateCamera(t),t=ct.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,N),k=Xe.get(e,re.length),k.init(t),k.state.textureUnits=Be.getTextureUnits(),re.push(k),ke.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ee.setFromProjectionMatrix(ke,Ge,t.reversedDepth),Oe=this.localClippingEnabled,De=Qe.init(this.clippingPlanes,Oe),te=Je.get(e,A.length),te.init(),A.push(te),ct.enabled===!0&&ct.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&bt(e,t,-1/0,M.sortObjects)}bt(e,t,0,M.sortObjects),te.finish(),M.sortObjects===!0&&te.sort(xe,Se,t.reversedDepth),Ne=ct.enabled===!1||ct.isPresenting===!1||ct.hasDepthSensing()===!1,Ne&&tt.addToRenderList(te,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),De===!0&&Qe.beginShadows();let i=k.state.shadowsArray;if($e.render(i,e,t),De===!0&&Qe.endShadows(),(r&&j.hasRenderPass())===!1){let n=te.opaque,r=te.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];St(n,r,e,a)}Ne&&tt.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];xt(te,e,n,n.viewport)}}else r.length>0&&St(n,r,e,t),Ne&&tt.render(e),xt(te,e,t)}N!==null&&ue===0&&(Be.updateMultisampleRenderTarget(N),Be.updateRenderTargetMipmap(N)),r&&j.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),ot.resetDefaultState(),de=-1,fe=null,re.pop(),re.length>0?(k=re[re.length-1],Be.setTextureUnits(k.state.textureUnits),De===!0&&Qe.setGlobalState(M.clippingPlanes,k.state.camera)):k=null,A.pop(),te=A.length>0?A[A.length-1]:null,ae!==null&&ae.renderEnd()};function bt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Ee.intersectsSprite(e)){r&&je.setFromMatrixPosition(e.matrixWorld).applyMatrix4(ke);let t=We.update(e),i=e.material;i.visible&&te.push(e,t,i,n,je.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Ee.intersectsObject(e))){let t=We.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),je.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),je.copy(e.boundingSphere.center)),je.applyMatrix4(e.matrixWorld).applyMatrix4(ke)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&te.push(e,t,s,n,je.z,o)}}else i.visible&&te.push(e,t,i,n,je.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)bt(i[e],t,n,r)}function xt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),De===!0&&Qe.setGlobalState(M.clippingPlanes,n),r&&F.viewport(pe.copy(r)),i.length>0&&Ct(i,t,n),a.length>0&&Ct(a,t,n),o.length>0&&Ct(o,t,n),F.buffers.depth.setTest(!0),F.buffers.depth.setMask(!0),F.buffers.color.setMask(!0),F.setPolygonOffset(!1)}function St(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Ie.has(`EXT_color_buffer_half_float`)||Ie.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new jt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Le.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:vt.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||pe;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),u=M.getActiveCubeFace(),d=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(ge),_e=M.getClearAlpha(),_e<1&&M.setClearColor(16777215,.5),M.clear(),Ne&&tt.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),De===!0&&Qe.setGlobalState(M.clippingPlanes,r),Ct(e,n,r),Be.updateMultisampleRenderTarget(a),Be.updateRenderTargetMipmap(a),Ie.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,wt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(Be.updateMultisampleRenderTarget(a),Be.updateRenderTargetMipmap(a))}M.setRenderTarget(s,u,d),M.setClearColor(ge,_e),p!==void 0&&(r.viewport=p),M.toneMapping=f}function Ct(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&wt(o,t,n,s,l,c)}}function wt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function Tt(e,t,n){t.isScene!==!0&&(t=Me);let r=I.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ke.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ke.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ve.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,dt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Dt(e,s),d}else s.uniforms=Ke.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,M),d=Ke.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Qe.uniform),Dt(e,s),r.needsLights=Nt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Et(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Ys.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Dt(e,t){let n=I.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Ot(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function At(e,t,n,r,i){t.isScene!==!0&&(t=Me),Be.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:vt.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ve.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=I.get(r),y=k.state.lights;if(De===!0&&(Oe===!0||e!==fe)){let t=e===fe&&r.id===de;Qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Qe.numPlanes||v.numIntersection!==Qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Tt(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(F.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==de&&(de=r.id,C=!0),v.needsLights){let e=Ot(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||fe!==e){F.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(P,`projectionMatrix`,e.projectionMatrix),T.setValue(P,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(P,Ae.setFromMatrixPosition(e.matrixWorld)),Le.logarithmicDepthBuffer&&T.setValue(P,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(P,`isOrthographic`,e.isOrthographicCamera===!0),fe!==e&&(fe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(P,`directionalShadowMap`,y.state.directionalShadowMap,Be),y.state.spotShadowMap.length>0&&T.setValue(P,`spotShadowMap`,y.state.spotShadowMap,Be),y.state.pointShadowMap.length>0&&T.setValue(P,`pointShadowMap`,y.state.pointShadowMap,Be)),i.isSkinnedMesh){T.setOptional(P,i,`bindMatrix`),T.setOptional(P,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(P,`boneTexture`,e.boneTexture,Be))}i.isBatchedMesh&&(T.setOptional(P,i,`batchingTexture`),T.setValue(P,`batchingTexture`,i._matricesTexture,Be),T.setOptional(P,i,`batchingIdTexture`),T.setValue(P,`batchingIdTexture`,i._indirectTexture,Be),T.setOptional(P,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(P,`batchingColorTexture`,i._colorsTexture,Be));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&nt.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(P,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=gl()),C){if(T.setValue(P,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&Mt(E,w),a&&r.fog===!0&&qe.refreshFogUniforms(E,a),qe.refreshMaterialUniforms(E,r,be,ye,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Ys.upload(P,Et(v),E,Be)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Ys.upload(P,Et(v),E,Be),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(P,`center`,i.center),T.setValue(P,`modelViewMatrix`,i.modelViewMatrix),T.setValue(P,`normalMatrix`,i.normalMatrix),T.setValue(P,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];z.update(n,x),z.bind(n,x)}}return x}function Mt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Nt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return le},this.getActiveMipmapLevel=function(){return ue},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=I.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),I.get(e.texture).__webglTexture=t,I.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=I.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){N=e,le=t,ue=n;let r=null,i=!1,a=!1;if(e){let o=I.get(e);if(o.__useDefaultFramebuffer!==void 0){F.bindFramebuffer(P.FRAMEBUFFER,o.__webglFramebuffer),pe.copy(e.viewport),me.copy(e.scissor),he=e.scissorTest,F.viewport(pe),F.scissor(me),F.setScissorTest(he),de=-1;return}else if(o.__webglFramebuffer===void 0)Be.setupRenderTarget(e);else if(o.__hasExternalTextures)Be.rebindTextures(e,I.get(e.texture).__webglTexture,I.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&I.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);Be.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=I.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&Be.useMultisampledRTT(e)===!1?I.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,pe.copy(e.viewport),me.copy(e.scissor),he=e.scissorTest}else pe.copy(Ce).multiplyScalar(be).floor(),me.copy(we).multiplyScalar(be).floor(),he=Te;if(n!==0&&(r=oe),F.bindFramebuffer(P.FRAMEBUFFER,r)&&F.drawBuffers(e,r),F.viewport(pe),F.scissor(me),F.setScissorTest(he),i){let r=I.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=I.get(e.textures[t]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=I.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,t.__webglTexture,n)}de=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=I.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){F.bindFramebuffer(P.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Le.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Le.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&P.readPixels(t,n,r,i,at.convert(c),at.convert(l),a)}finally{let e=N===null?null:I.get(N).__webglFramebuffer;F.bindFramebuffer(P.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=I.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){F.bindFramebuffer(P.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Le.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Le.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.bufferData(P.PIXEL_PACK_BUFFER,a.byteLength,P.STREAM_READ),P.readPixels(t,n,r,i,at.convert(l),at.convert(u),0);let f=N===null?null:I.get(N).__webglFramebuffer;F.bindFramebuffer(P.FRAMEBUFFER,f);let p=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await et(P,p,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,a),P.deleteBuffer(d),P.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;Be.setTexture2D(e,0),P.copyTexSubImage2D(P.TEXTURE_2D,n,0,0,o,s,i,a),F.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=at.convert(t.format),_=at.convert(t.type),v;t.isData3DTexture?(Be.setTexture3D(t,0),v=P.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(Be.setTexture2DArray(t,0),v=P.TEXTURE_2D_ARRAY):(Be.setTexture2D(t,0),v=P.TEXTURE_2D),F.activeTexture(P.TEXTURE0),F.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,t.flipY),F.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),F.pixelStorei(P.UNPACK_ALIGNMENT,t.unpackAlignment);let y=F.getParameter(P.UNPACK_ROW_LENGTH),b=F.getParameter(P.UNPACK_IMAGE_HEIGHT),x=F.getParameter(P.UNPACK_SKIP_PIXELS),S=F.getParameter(P.UNPACK_SKIP_ROWS),C=F.getParameter(P.UNPACK_SKIP_IMAGES);F.pixelStorei(P.UNPACK_ROW_LENGTH,h.width),F.pixelStorei(P.UNPACK_IMAGE_HEIGHT,h.height),F.pixelStorei(P.UNPACK_SKIP_PIXELS,l),F.pixelStorei(P.UNPACK_SKIP_ROWS,u),F.pixelStorei(P.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=I.get(e),r=I.get(t),h=I.get(n.__renderTarget),g=I.get(r.__renderTarget);F.bindFramebuffer(P.READ_FRAMEBUFFER,h.__webglFramebuffer),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,I.get(e).__webglTexture,i,d+n),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,I.get(t).__webglTexture,a,m+n)),P.blitFramebuffer(l,u,o,s,f,p,o,s,P.DEPTH_BUFFER_BIT,P.NEAREST);F.bindFramebuffer(P.READ_FRAMEBUFFER,null),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||I.has(e)){let n=I.get(e),r=I.get(t);F.bindFramebuffer(P.READ_FRAMEBUFFER,se),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,ce);for(let e=0;e<c;e++)w?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,n.__webglTexture,i),T?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,r.__webglTexture,a),i===0?T?P.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):P.copyTexSubImage2D(v,a,f,p,l,u,o,s):P.blitFramebuffer(l,u,o,s,f,p,o,s,P.COLOR_BUFFER_BIT,P.NEAREST);F.bindFramebuffer(P.READ_FRAMEBUFFER,null),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?P.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h);F.pixelStorei(P.UNPACK_ROW_LENGTH,y),F.pixelStorei(P.UNPACK_IMAGE_HEIGHT,b),F.pixelStorei(P.UNPACK_SKIP_PIXELS,x),F.pixelStorei(P.UNPACK_SKIP_ROWS,S),F.pixelStorei(P.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&P.generateMipmap(v),F.unbindTexture()},this.initRenderTarget=function(e){I.get(e).__webglFramebuffer===void 0&&Be.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?Be.setTextureCube(e,0):e.isData3DTexture?Be.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?Be.setTexture2DArray(e,0):Be.setTexture2D(e,0),F.unbindTexture()},this.resetState=function(){le=0,ue=0,N=null,F.reset(),ot.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=vt._getDrawingBufferColorSpace(e),t.unpackColorSpace=vt._getUnpackColorSpace()}},K={Air:0,Grass:1,Stone:2,Cobblestone:3,Sand:4,Dirt:5,Log:6,Planks:7,Brick:8,Gravel:9,Bedrock:10,WoolWhite:11,WoolBlack:12,WoolRed:13,WoolOrange:14,WoolYellow:15,WoolGreen:16,WoolBlue:17,WoolPurple:18,Sandstone:19,StoneBricks:20,Snow:21,Obsidian:22,WoolPink:23,WoolCyan:24,WoolGray:25,WoolBrown:26,Glass:27,Leaves:28,LetterA:29,LetterB:30,LetterC:31,LetterD:32,LetterE:33,LetterF:34,LetterG:35,LetterH:36,LetterI:37,LetterJ:38,LetterK:39,LetterL:40,LetterM:41,LetterN:42,LetterO:43,LetterP:44,LetterQ:45,LetterR:46,LetterS:47,LetterT:48,LetterU:49,LetterV:50,LetterW:51,LetterX:52,LetterY:53,LetterZ:54,Digit0:55,Digit1:56,Digit2:57,Digit3:58,Digit4:59,Digit5:60,Digit6:61,Digit7:62,Digit8:63,Digit9:64,Cerca:65,PortaXFechada:66,PortaXAberta:67,PortaZFechada:68,PortaZAberta:69,Tocha:70,TapeteBranco:71,TapetePreto:72,TapeteVermelho:73,TapeteLaranja:74,TapeteAmarelo:75,TapeteVerde:76,TapeteAzul:77,TapeteRoxo:78,TapeteRosa:79,TapeteCiano:80,TapeteCinza:81,TapeteMarrom:82,JanelaXFechada:83,JanelaXAberta:84,JanelaZFechada:85,JanelaZAberta:86,Mesa:87,CadeiraXP:88,CadeiraZP:89,CadeiraXN:90,CadeiraZN:91,SofaXP:92,SofaZP:93,SofaXN:94,SofaZN:95,CamaXP:96,CamaZP:97,CamaXN:98,CamaZN:99,QuadroXP:100,QuadroZP:101,QuadroXN:102,QuadroZN:103,FlorVermelha:104,FlorAmarela:105,FlorAzul:106,FlorBranca:107,PortaXFechadaR:108,PortaXAbertaR:109,PortaZFechadaR:110,PortaZAbertaR:111,JanelaXFechadaR:112,JanelaXAbertaR:113,JanelaZFechadaR:114,JanelaZAbertaR:115,MinerioCarvao:116,MinerioFerro:117,MinerioOuro:118,MinerioDiamante:119,GramaSeca:120,GramaFria:121,LogIpe:122,FolhasIpe:123,LogAraucaria:124,FolhasAraucaria:125,LogPauBrasil:126,FolhasPauBrasil:127,Mandacaru:128,Agua:129,AguaFluida1:130,AguaFluida2:131,AguaFluida3:132,AguaFluida4:133,AguaFluida5:134,AguaFluida6:135,AguaFluida7:136,VidroBranco:137,VidroPreto:138,VidroVermelho:139,VidroLaranja:140,VidroAmarelo:141,VidroVerde:142,VidroAzul:143,VidroRoxo:144,VidroRosa:145,VidroCiano:146,VidroCinza:147,VidroMarrom:148,LajePedraBaixo:149,LajePedraCima:150,LajeTabuaBaixo:151,LajeTabuaCima:152,LajeTijoloBaixo:153,LajeTijoloCima:154,EscadaPedraXP:155,EscadaPedraZP:156,EscadaPedraXN:157,EscadaPedraZN:158,EscadaPedraXPC:159,EscadaPedraZPC:160,EscadaPedraXNC:161,EscadaPedraZNC:162,EscadaTabuaXP:163,EscadaTabuaZP:164,EscadaTabuaXN:165,EscadaTabuaZN:166,EscadaTabuaXPC:167,EscadaTabuaZPC:168,EscadaTabuaXNC:169,EscadaTabuaZNC:170,EscadaTijoloXP:171,EscadaTijoloZP:172,EscadaTijoloXN:173,EscadaTijoloZN:174,EscadaTijoloXPC:175,EscadaTijoloZPC:176,EscadaTijoloXNC:177,EscadaTijoloZNC:178},vl=K.EscadaTijoloZNC;function yl(e){return e>=K.Agua&&e<=K.AguaFluida7}function bl(e){return e===K.Agua}function xl(e){return e===K.Agua?8:e>=K.AguaFluida1&&e<=K.AguaFluida7?e-K.AguaFluida1+1:0}function Sl(e){return e>=8?K.Agua:e>=1?K.AguaFluida1+(e-1):K.Air}function Cl(e){return e===900||e===901}function wl(e){return e>=K.FlorVermelha&&e<=K.FlorBranca}function Tl(e){return e>=K.VidroBranco&&e<=K.VidroMarrom}function El(e){return e>=K.LajePedraBaixo&&e<=K.LajeTijoloCima}function Dl(e){return(e-K.LajePedraBaixo&1)==1}function Ol(e){return e-K.LajePedraBaixo>>1}function kl(e){return e>=K.EscadaPedraXP&&e<=K.EscadaTijoloZNC}function Al(e){return(e-K.EscadaPedraXP)%4}function jl(e){return(e-K.EscadaPedraXP)%8>=4}function Ml(e){return(e-K.EscadaPedraXP)/8|0}function Nl(e,t,n){return K.EscadaPedraXP+e*8+(n?4:0)+(t&3)}function Pl(e){switch(e&3){case 1:return[0,.5,1,1];case 2:return[0,0,.5,1];case 3:return[0,0,1,.5];default:return[.5,0,1,1]}}function Fl(e){if(El(e))return Dl(e)?[[0,.5,0,1,1,1]]:[[0,0,0,1,.5,1]];if(kl(e)){let[t,n,r,i]=Pl(Al(e));return jl(e)?[[0,.5,0,1,1,1],[t,0,n,r,.5,i]]:[[0,0,0,1,.5,1],[t,.5,n,r,1,i]]}return[[0,0,0,1,1,1]]}function Il(e){return e>=K.QuadroXP&&e<=K.QuadroZN}function Ll(e){return e>=K.CadeiraXP&&e<=K.CadeiraZN}function Rl(e){return e>=K.SofaXP&&e<=K.SofaZN}function zl(e){return e>=K.CamaXP&&e<=K.CamaZN}function Bl(e){switch(e-K.CamaXP){case 0:return{dx:-1,dz:0};case 1:return{dx:0,dz:-1};case 2:return{dx:1,dz:0};default:return{dx:0,dz:1}}}function Vl(e){return e>=K.Mesa&&e<=K.CamaZN}function Hl(e){return e>=K.TapeteBranco&&e<=K.TapeteMarrom}function Ul(e){return e===K.Glass||e===K.Leaves||e===K.FolhasIpe||e===K.FolhasAraucaria||e===K.FolhasPauBrasil||yl(e)||Tl(e)}function Wl(e){return e>=K.PortaXFechada&&e<=K.PortaZAberta||e>=K.PortaXFechadaR&&e<=K.PortaZAbertaR}function Gl(e){return e===K.PortaXAberta||e===K.PortaZAberta||e===K.PortaXAbertaR||e===K.PortaZAbertaR}function Kl(e){return e===K.PortaXFechada||e===K.PortaXAberta||e===K.PortaXFechadaR||e===K.PortaXAbertaR}function ql(e){return e>=K.PortaXFechadaR&&e<=K.PortaZAbertaR}K.PortaXFechadaR-K.PortaXFechada;function Jl(e){return e>=K.JanelaXFechada&&e<=K.JanelaZAberta||e>=K.JanelaXFechadaR&&e<=K.JanelaZAbertaR}function Yl(e){return e===K.JanelaXAberta||e===K.JanelaZAberta||e===K.JanelaXAbertaR||e===K.JanelaZAbertaR}function Xl(e){return e===K.JanelaXFechada||e===K.JanelaXAberta||e===K.JanelaXFechadaR||e===K.JanelaXAbertaR}function Zl(e){return e>=K.JanelaXFechadaR&&e<=K.JanelaZAbertaR}K.JanelaXFechadaR-K.JanelaXFechada;function Ql(e){return Wl(e)||Jl(e)}function $l(e){return e!==K.Air&&!(e>=K.Cerca&&e<=K.Tocha)&&!Wl(e)&&!Hl(e)&&!Jl(e)&&!Vl(e)&&!Il(e)&&!wl(e)&&!El(e)&&!kl(e)}function eu(e){return e!==K.Air&&!Gl(e)&&!Yl(e)&&e!==K.Tocha&&!Hl(e)&&!Il(e)&&!wl(e)&&!yl(e)}function tu(e){return Gl(e)||Yl(e)||yl(e)?!1:Number.isInteger(e)&&e>=K.Grass&&e<=vl}function nu(e){return e===K.Bedrock}var ru={caatinga:{nome:`caatinga`,topo:K.Sand,subsolo:K.Sandstone,profundidadeSubsolo:3,arvores:[],flores:0,mandacaru:1/16},cerrado:{nome:`cerrado`,topo:`grama`,subsolo:K.Dirt,profundidadeSubsolo:3,arvores:[[`ipe`,1/160]],flores:1/64,mandacaru:0},mata:{nome:`mata`,topo:`grama`,subsolo:K.Dirt,profundidadeSubsolo:3,arvores:[[`comum`,1/28],[`paubrasil`,1/80]],flores:1/48,mandacaru:0},araucarias:{nome:`araucárias`,topo:`grama`,subsolo:K.Dirt,profundidadeSubsolo:3,arvores:[[`araucaria`,1/48]],flores:1/128,mandacaru:0}};function iu(e){return e.temp<.35?ru.araucarias:e.temp>.65&&e.umid<.4?ru.caatinga:e.umid>.55?ru.mata:ru.cerrado}function au(e){return e.temp<.42?K.GramaFria:e.temp>.58&&e.umid<.5?K.GramaSeca:K.Grass}var ou=16**3,su={x:16,z:16,y:8},cu=1200;function lu(e,t=!0){let n=e.x*e.y*e.z,r=Array(n);if(t)for(let e=0;e<n;e++)r[e]=new Uint8Array(ou);return{dims:e,sizeX:e.x*16,sizeY:e.y*16,sizeZ:e.z*16,chunks:r}}function uu(e,t,n){for(let r=0;r<e.dims.y;r++){let i=du(e,t,r,n);e.chunks[i]||(e.chunks[i]=new Uint8Array(ou))}}function du(e,t,n,r){return(n*e.dims.z+r)*e.dims.x+t}function fu(e,t,n){return(t*16+n)*16+e}function pu(e,t,n,r){return t>=0&&n>=0&&r>=0&&t<e.sizeX&&n<e.sizeY&&r<e.sizeZ}function mu(e,t,n,r){if(!pu(e,t,n,r))return K.Air;let i=t/16|0,a=n/16|0,o=r/16|0,s=e.chunks[du(e,i,a,o)];return s?s[fu(t-i*16,n-a*16,r-o*16)]??K.Air:K.Air}function hu(e,t,n,r,i){if(!pu(e,t,n,r))return;let a=t/16|0,o=n/16|0,s=r/16|0,c=e.chunks[du(e,a,o,s)];c&&(c[fu(t-a*16,n-o*16,r-s*16)]=i)}function gu(e,t,n){for(let r=e.sizeY-1;r>=0;r--)if(mu(e,t,r,n)!==K.Air)return r+1;return 1}K.Log,K.LogIpe,K.LogAraucaria,K.LogPauBrasil,K.Leaves,K.FolhasIpe,K.FolhasAraucaria,K.FolhasPauBrasil;function _u(e){return[...e.trim()].filter(e=>/[\p{L}\p{N}\p{M}_-]/u.test(e)).join(``).slice(0,24)||`jogador`}function vu(e){return{x:e.max.x-e.min.x+1,y:e.max.y-e.min.y+1,z:e.max.z-e.min.z+1}}function yu(e){if(typeof e!=`object`||!e)return null;let t=e;return[t.x,t.y,t.z].every(e=>typeof e==`number`&&Number.isInteger(e))?{x:t.x,y:t.y,z:t.z}:null}function bu(e){if(typeof e!=`object`||!e)return null;let t=e,n=t.nome;if(typeof n!=`string`||!n||n.length>24)return null;let r=yu(t.min),i=yu(t.max);return!r||!i||r.x>i.x||r.y>i.y||r.z>i.z?null:{nome:n,min:r,max:i}}function xu(e){if(typeof e!=`object`||!e)return null;let t=e,n=t.dono;if(typeof n!=`string`||!n)return null;let r=yu(t.min),i=yu(t.max);if(!r||!i||r.x>i.x||r.y>i.y||r.z>i.z)return null;let a={dono:n,min:r,max:i},o=t.nome;return typeof o==`string`&&o&&o.length<=24&&(a.nome=o),a}function Su(e){if(typeof e!=`object`||!e)return null;let t=e,n=t.dono;if(typeof n!=`string`||!n)return null;let r=[];if(Array.isArray(t.membros))for(let e of t.membros)typeof e==`string`&&e&&e!==n&&!r.includes(e)&&r.push(e);return{dono:n,membros:r.slice(0,5)}}function Cu(e){if(!Array.isArray(e))return[];let t=[];for(let n of e){if(typeof n!=`object`||!n)continue;let e=n,r=e.id;if(typeof r!=`number`||!Number.isInteger(r)||r<1||r>20)continue;let i=Array.isArray(e.membros)?e.membros.filter(e=>typeof e==`string`&&e.length>0):[];t.push({id:r,membros:i})}return t}function wu(e){return e===`plano`||e===`cabines`?e:`normal`}function Tu(e){return e===`M`||e===`G`||e===`E`?e:`P`}function Eu(e,t,n){let r=n^Math.imul(e,374761393)^Math.imul(t,668265263);return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function Du(e){return e*e*(3-2*e)}function Ou(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=Du(e-r),o=Du(t-i),s=Eu(r,i,n),c=Eu(r+1,i,n),l=Eu(r,i+1,n),u=Eu(r+1,i+1,n),d=s+(c-s)*a;return d+(l+(u-l)*a-d)*o}function ku(e,t,n,r=128){let i=Ou(e/24,t/24,n),a=Ou(e/7,t/7,n^2654435769),o=16+i*12+a*4;if(r<128)return Math.floor(o);let s=Ou(e/90,t/90,n^6191009),c=Du(Math.min(1,Math.max(0,(s-.52)/.3))),l=Ou(e/28,t/28,n^9516923);return Math.floor(o+c*(28+l*60))}function Au(e,t,n){return{temp:Ou(e/80,t/80,n^1375183809),umid:Ou(e/80,t/80,n^731782471)}}K.MinerioCarvao,K.MinerioFerro,K.MinerioOuro,K.MinerioDiamante,K.StoneBricks;var q={tilesPerRow:16,tilePx:16},J={grassTop:0,grassSide:1,dirt:2,stone:3,cobblestone:4,sand:5,logTop:6,logSide:7,planks:8,brick:9,gravel:10,bedrock:11,woolWhite:12,woolBlack:13,woolRed:14,woolOrange:15,woolYellow:16,woolGreen:17,woolBlue:18,woolPurple:19,sandstone:20,stoneBricks:21,snow:22,obsidian:23,woolPink:24,woolCyan:25,woolGray:26,woolBrown:27,glass:28,leaves:29,cerca:66,portaBaixo:67,portaCima:68,tocha:69,janela:70,estofado:71,colchao:72,quadro:73,florVermelha:74,florAmarela:75,florAzul:76,florBranca:77,minerioCarvao:78,minerioFerro:79,minerioOuro:80,minerioDiamante:81,gramaSecaTop:82,gramaSecaSide:83,gramaFriaTop:84,gramaFriaSide:85,logIpe:86,folhasIpe:87,logAraucaria:88,folhasAraucaria:89,logPauBrasil:90,folhasPauBrasil:91,mandacaruSide:92,mandacaruTop:93,agua:94,vidroBranco:95,vidroPreto:96,vidroVermelho:97,vidroLaranja:98,vidroAmarelo:99,vidroVerde:100,vidroAzul:101,vidroRoxo:102,vidroRosa:103,vidroCiano:104,vidroCinza:105,vidroMarrom:106},ju={base:30,letters:`ABCDEFGHIJKLMNOPQRSTUVWXYZ`,digits:`0123456789`},Y=e=>({top:e,bottom:e,side:e}),Mu={[K.Grass]:{top:J.grassTop,bottom:J.dirt,side:J.grassSide},[K.Stone]:Y(J.stone),[K.Cobblestone]:Y(J.cobblestone),[K.Sand]:Y(J.sand),[K.Dirt]:Y(J.dirt),[K.Log]:{top:J.logTop,bottom:J.logTop,side:J.logSide},[K.Planks]:Y(J.planks),[K.Brick]:Y(J.brick),[K.Gravel]:Y(J.gravel),[K.Bedrock]:Y(J.bedrock),[K.WoolWhite]:Y(J.woolWhite),[K.WoolBlack]:Y(J.woolBlack),[K.WoolRed]:Y(J.woolRed),[K.WoolOrange]:Y(J.woolOrange),[K.WoolYellow]:Y(J.woolYellow),[K.WoolGreen]:Y(J.woolGreen),[K.WoolBlue]:Y(J.woolBlue),[K.WoolPurple]:Y(J.woolPurple),[K.Sandstone]:Y(J.sandstone),[K.StoneBricks]:Y(J.stoneBricks),[K.Snow]:Y(J.snow),[K.Obsidian]:Y(J.obsidian),[K.WoolPink]:Y(J.woolPink),[K.WoolCyan]:Y(J.woolCyan),[K.WoolGray]:Y(J.woolGray),[K.WoolBrown]:Y(J.woolBrown),[K.Glass]:Y(J.glass),[K.Leaves]:Y(J.leaves),[K.Cerca]:Y(J.cerca),[K.PortaXFechada]:Y(J.portaCima),[K.PortaXAberta]:Y(J.portaCima),[K.PortaZFechada]:Y(J.portaCima),[K.PortaZAberta]:Y(J.portaCima),[K.PortaXFechadaR]:Y(J.portaCima),[K.PortaXAbertaR]:Y(J.portaCima),[K.PortaZFechadaR]:Y(J.portaCima),[K.PortaZAbertaR]:Y(J.portaCima),[K.Tocha]:Y(J.tocha),[K.JanelaXFechada]:Y(J.janela),[K.JanelaXAberta]:Y(J.janela),[K.JanelaZFechada]:Y(J.janela),[K.JanelaZAberta]:Y(J.janela),[K.JanelaXFechadaR]:Y(J.janela),[K.JanelaXAbertaR]:Y(J.janela),[K.JanelaZFechadaR]:Y(J.janela),[K.JanelaZAbertaR]:Y(J.janela),[K.Mesa]:Y(J.planks),[K.MinerioCarvao]:Y(J.minerioCarvao),[K.MinerioFerro]:Y(J.minerioFerro),[K.MinerioOuro]:Y(J.minerioOuro),[K.MinerioDiamante]:Y(J.minerioDiamante),[K.GramaSeca]:{top:J.gramaSecaTop,bottom:J.dirt,side:J.gramaSecaSide},[K.GramaFria]:{top:J.gramaFriaTop,bottom:J.dirt,side:J.gramaFriaSide},[K.LogIpe]:{top:J.logTop,bottom:J.logTop,side:J.logIpe},[K.FolhasIpe]:Y(J.folhasIpe),[K.LogAraucaria]:{top:J.logTop,bottom:J.logTop,side:J.logAraucaria},[K.FolhasAraucaria]:Y(J.folhasAraucaria),[K.LogPauBrasil]:{top:J.logTop,bottom:J.logTop,side:J.logPauBrasil},[K.FolhasPauBrasil]:Y(J.folhasPauBrasil),[K.Mandacaru]:{top:J.mandacaruTop,bottom:J.mandacaruTop,side:J.mandacaruSide},[K.Agua]:Y(J.agua)};for(let e=K.AguaFluida1;e<=K.AguaFluida7;e++)Mu[e]=Y(J.agua);for(let e=0;e<12;e++)Mu[K.VidroBranco+e]=Y(J.vidroBranco+e);var Nu=[J.stone,J.planks,J.brick];for(let e=K.LajePedraBaixo;e<=K.LajeTijoloCima;e++)Mu[e]=Y(Nu[Ol(e)]);for(let e=K.EscadaPedraXP;e<=K.EscadaTijoloZNC;e++)Mu[e]=Y(Nu[Ml(e)]);for(let e=0;e<4;e++)Mu[K.CadeiraXP+e]=Y(J.planks),Mu[K.SofaXP+e]=Y(J.estofado),Mu[K.CamaXP+e]=Y(J.colchao),Mu[K.QuadroXP+e]=Y(J.quadro);for(let e=0;e<4;e++)Mu[K.FlorVermelha+e]=Y(J.florVermelha+e);for(let e=0;e<ju.letters.length;e++)Mu[K.LetterA+e]=Y(ju.base+e);for(let e=0;e<ju.digits.length;e++)Mu[K.Digit0+e]=Y(ju.base+ju.letters.length+e);var Pu=[J.woolWhite,J.woolBlack,J.woolRed,J.woolOrange,J.woolYellow,J.woolGreen,J.woolBlue,J.woolPurple,J.woolPink,J.woolCyan,J.woolGray,J.woolBrown];for(let e=0;e<Pu.length;e++)Mu[K.TapeteBranco+e]=Y(Pu[e]);function Fu(e){return Mu[e]?.side??J.stone}function Iu(e){if(wl(e))return[4*X,0,4*X,12*X,1,12*X];if(Hl(e))return[0,0,0,1,X,1];if(e===K.Tocha)return[7*X,0,7*X,9*X,10*X,9*X];if(e===K.Cerca)return[6*X,0,6*X,10*X,1,10*X];if(Wl(e)){if(!Gl(e))return Kl(e)?[0,0,0,2*X,1,1]:[0,0,0,1,1,2*X];let t=ql(e)?1-2*X:0;return Kl(e)?[0,0,t,1,1,t+2*X]:[t,0,0,t+2*X,1,1]}if(Jl(e)){if(!Yl(e))return Xl(e)?[0,0,0,2*X,1,1]:[0,0,0,1,1,2*X];let t=Zl(e)?1-2*X:0;return Xl(e)?[0,0,t,1,1,t+2*X]:[t,0,0,t+2*X,1,1]}if(Il(e)){let[t,n,r,i]=Vu(0,1*X,2*X,15*X,e-K.QuadroXP);return[Math.min(t,r),1*X,Math.min(n,i),Math.max(t,r),15*X,Math.max(n,i)]}return e===K.Mesa?[0,0,0,1,14*X,1]:Ll(e)?[3*X,0,3*X,13*X,1,13*X]:Rl(e)?[0,0,0,1,15*X,1]:zl(e)?[0,0,0,1,9*X,1]:El(e)?Fl(e)[0]:(kl(e),[0,0,0,1,1,1])}var Lu=[{dir:[-1,0,0],corners:[{pos:[0,1,0],uv:[0,1]},{pos:[0,0,0],uv:[0,0]},{pos:[0,1,1],uv:[1,1]},{pos:[0,0,1],uv:[1,0]}]},{dir:[1,0,0],corners:[{pos:[1,1,1],uv:[0,1]},{pos:[1,0,1],uv:[0,0]},{pos:[1,1,0],uv:[1,1]},{pos:[1,0,0],uv:[1,0]}]},{dir:[0,-1,0],corners:[{pos:[1,0,1],uv:[1,0]},{pos:[0,0,1],uv:[0,0]},{pos:[1,0,0],uv:[1,1]},{pos:[0,0,0],uv:[0,1]}]},{dir:[0,1,0],corners:[{pos:[0,1,1],uv:[1,1]},{pos:[1,1,1],uv:[0,1]},{pos:[0,1,0],uv:[1,0]},{pos:[1,1,0],uv:[0,0]}]},{dir:[0,0,-1],corners:[{pos:[1,0,0],uv:[0,0]},{pos:[0,0,0],uv:[1,0]},{pos:[1,1,0],uv:[0,1]},{pos:[0,1,0],uv:[1,1]}]},{dir:[0,0,1],corners:[{pos:[0,0,1],uv:[0,0]},{pos:[1,0,1],uv:[1,0]},{pos:[0,1,1],uv:[0,1]},{pos:[1,1,1],uv:[1,1]}]}];function Ru(e,t){for(let n of[0,1,2])if(e.pos[n]!==t.pos[n])return{axis:n,flip:e.pos[n]===1};return{axis:0,flip:!1}}var zu=Lu.map(e=>{let t=(t,n)=>e.corners.find(e=>e.uv[0]===t&&e.uv[1]===n)??e.corners[0];return{u:Ru(t(0,0),t(1,0)),v:Ru(t(0,0),t(0,1))}}),X=1/16,Bu=.875;function Vu(e,t,n,r,i){for(let a=0;a<i;a++){let i=1-r,a=n,o=1-t,s=e;e=i,t=s,n=o,r=a}return[e,t,n,r]}var Hu=18,Uu=Hu*Hu*Hu;function Wu(e,t,n){return((t+1)*Hu+(n+1))*Hu+(e+1)}var Gu=()=>({positions:new Float32Array,normals:new Float32Array,uvs:new Float32Array,indices:new Uint32Array,opaqueIndexCount:0,aguaIndexCount:0});function Ku(e,t,n,r){let i=e.chunks[du(e,t,n,r)];if(!i||i.every(e=>e===0))return null;let a=new Uint8Array(Uu);for(let e=0;e<16;e++)for(let t=0;t<16;t++){let n=(e*16+t)*16;a.set(i.subarray(n,n+16),Wu(0,e,t))}let o=t*16,s=n*16,c=r*16;for(let t=-1;t<=16;t++){let n=t>=0&&t<16;for(let r=-1;r<=16;r++){let i=n&&r>=0&&r<16;for(let n=-1;n<=16;n++)i&&n===0&&(n=16),a[Wu(n,t,r)]=mu(e,o+n,s+t,c+r)}}return a}function qu(e,t,n,r){let i=Ku(e,t,n,r);return i?Ju(i):Gu()}function Ju(e){let t=(t,n,r)=>e[Wu(t,n,r)]??K.Air,n=[],r=[],i=[],a=[],o=[],s=[],c=q.tilesPerRow,l=.5/(c*q.tilePx),u=(e,o,s,u,d,f,p,m,h,g,_)=>{let v=d%c,y=d/c|0,b=[f,p,m],x=[h,g,_];for(let d=0;d<Lu.length;d++){let S=Lu[d],C=zu[d];if(!S||!C)continue;if(S.dir[0]===-1?f===0:S.dir[0]===1?h===1:S.dir[1]===-1?p===0:S.dir[1]===1?g===1:S.dir[2]===-1?m===0:_===1){let n=t(e+S.dir[0],o+S.dir[1],s+S.dir[2]);if(n===u||$l(n)&&!Ul(n))continue}let w=n.length/3;for(let t of S.corners){let a=t.pos[0]===0?f:h,u=t.pos[1]===0?p:g,d=t.pos[2]===0?m:_;n.push(e+a,o+u,s+d),r.push(S.dir[0],S.dir[1],S.dir[2]);let w=(e,t)=>{let n=t===0?e.flip?x[e.axis]:b[e.axis]:e.flip?b[e.axis]:x[e.axis];return e.flip?1-n:n},T=w(C.u,t.uv[0]),E=w(C.v,t.uv[1]);i.push(v/c+l+T*(1/c-2*l),1-(y+1)/c+l+E*(1/c-2*l))}a.push(w,w+1,w+2,w+2,w+1,w+3)}},d=(e,t,o,s,u,d,f,p)=>{let m=s%c,h=s/c|0,g=m/c+l,_=(m+1)/c-l,v=1-(h+1)/c+l,y=1-h/c-l,b=[[e+u,t,o+d],[e+f,t,o+p],[e+f,t+1,o+p],[e+u,t+1,o+d]],x=[g,_,_,g],S=[v,v,y,y],C=p-d,w=-(f-u),T=Math.hypot(C,w)||1;C/=T,w/=T;for(let e of[1,-1]){let t=n.length/3;for(let t=0;t<4;t++){let a=b[t];n.push(a[0],a[1],a[2]),r.push(C*e,0,w*e),i.push(x[t],S[t])}e>0?a.push(t,t+1,t+2,t,t+2,t+3):a.push(t,t+2,t+1,t,t+3,t+2)}},f=(e,n,r)=>{let i=t(e,n,r);return i===K.Cerca||$l(i)},p=(e,n,r,i)=>{switch(e){case K.Cerca:{u(n,r,i,e,J.cerca,6*X,0,6*X,10*X,1,10*X);let t=(t,a,o,s)=>{u(n,r,i,e,J.cerca,t,12*X,a,o,15*X,s),u(n,r,i,e,J.cerca,t,6*X,a,o,9*X,s)};return f(n-1,r,i)&&t(0,7*X,6*X,9*X),f(n+1,r,i)&&t(10*X,7*X,1,9*X),f(n,r,i-1)&&t(7*X,0,9*X,6*X),f(n,r,i+1)&&t(7*X,10*X,9*X,1),!0}case K.PortaXFechada:case K.PortaXAberta:case K.PortaZFechada:case K.PortaZAberta:case K.PortaXFechadaR:case K.PortaXAbertaR:case K.PortaZFechadaR:case K.PortaZAbertaR:{let a=t(n,r-1,i)===e?J.portaCima:J.portaBaixo,o=Kl(e);if(!Gl(e))o?u(n,r,i,e,a,0,0,0,2*X,1,1):u(n,r,i,e,a,0,0,0,1,1,2*X);else{let t=ql(e)?1-2*X:0;o?u(n,r,i,e,a,0,0,t,1,1,t+2*X):u(n,r,i,e,a,t,0,0,t+2*X,1,1)}return!0}case K.Tocha:return u(n,r,i,e,J.tocha,7*X,0,7*X,9*X,10*X,9*X),!0;case K.JanelaXFechada:case K.JanelaXAberta:case K.JanelaZFechada:case K.JanelaZAberta:case K.JanelaXFechadaR:case K.JanelaXAbertaR:case K.JanelaZFechadaR:case K.JanelaZAbertaR:{let t=Xl(e);if(!Yl(e))t?u(n,r,i,e,J.janela,0,0,0,2*X,1,1):u(n,r,i,e,J.janela,0,0,0,1,1,2*X);else{let a=Zl(e)?1-2*X:0;t?u(n,r,i,e,J.janela,0,0,a,1,1,a+2*X):u(n,r,i,e,J.janela,a,0,0,a+2*X,1,1)}return!0}case K.Mesa:u(n,r,i,e,J.planks,0,12*X,0,1,14*X,1);for(let[t,a]of[[1,1],[13,1],[1,13],[13,13]])u(n,r,i,e,J.planks,t*X,0,a*X,(t+2)*X,12*X,(a+2)*X);return!0;default:if(El(e)||kl(e)){let t=Nu[El(e)?Ol(e):Ml(e)];for(let[a,o,s,c,l,d]of Fl(e))u(n,r,i,e,t,a,o,s,c,l,d);return!0}if(Il(e)){let[t,a,o,s]=Vu(0,1*X,2*X,15*X,e-K.QuadroXP);return u(n,r,i,e,J.quadro,t,1*X,a,o,15*X,s),!0}if(wl(e)){let t=J.florVermelha+(e-K.FlorVermelha);return d(n,r,i,t,0,0,1,1),d(n,r,i,t,0,1,1,0),!0}if(zl(e)){let a=e-K.CamaXP,{dx:o,dz:s}=Bl(e),c=t(n+o,r,i+s)===e?[[J.planks,0,0,0,1,3*X,1],[J.colchao,0,3*X,1*X,1,7*X,15*X]]:[[J.planks,0,0,0,1,3*X,1],[J.colchao,0,3*X,1*X,1,7*X,15*X],[J.woolWhite,1*X,7*X,3*X,6*X,9*X,13*X]];for(let[t,o,s,l,d,f,p]of c){let[c,m,h,g]=Vu(o,l,d,p,a);u(n,r,i,e,t,c,s,m,h,f,g)}return!0}if(Ll(e)||Rl(e)){let t=Ll(e)?e-K.CadeiraXP:e-K.SofaXP,a=Ll(e)?[[J.planks,3*X,6*X,3*X,13*X,8*X,13*X],[J.planks,3*X,0,3*X,5*X,6*X,5*X],[J.planks,11*X,0,3*X,13*X,6*X,5*X],[J.planks,3*X,0,11*X,5*X,6*X,13*X],[J.planks,11*X,0,11*X,13*X,6*X,13*X],[J.planks,3*X,8*X,3*X,5*X,1,13*X]]:[[J.estofado,0,0,0,1,8*X,1],[J.estofado,0,8*X,0,4*X,15*X,1],[J.estofado,4*X,8*X,0,1,12*X,2*X],[J.estofado,4*X,8*X,14*X,1,12*X,1]];for(let[o,s,c,l,d,f,p]of a){let[a,m,h,g]=Vu(s,l,d,p,t);u(n,r,i,e,o,a,c,m,h,f,g)}return!0}return Hl(e)?(u(n,r,i,e,Pu[e-K.TapeteBranco],0,0,0,1,X,1),!0):!1}},m=(e,n,r,i,a)=>{let o=0,s=0;for(let c=0;c<2;c++)for(let l=0;l<2;l++){let u=e+i-1+c,d=r+a-1+l,f=t(u,n,d);if(yl(f)){if(yl(t(u,n+1,d)))return 1;o+=xl(f),s++}}return s===0?Bu:o/s/8*Bu};for(let e=0;e<16;e++)for(let u=0;u<16;u++)for(let d=0;d<16;d++){let f=t(d,e,u);if(f===K.Air)continue;if(!$l(f)){p(f,d,e,u);continue}let h=Mu[f];if(!h)continue;let g=yl(f)?o:Tl(f)?s:a,_=yl(f)?[[m(d,e,u,0,0),m(d,e,u,0,1)],[m(d,e,u,1,0),m(d,e,u,1,1)]]:null;for(let a of Lu){let o=t(d+a.dir[0],e+a.dir[1],u+a.dir[2]);if(o!==K.Air&&$l(o)&&(yl(f)&&yl(o)||!Ul(o)||o===f))continue;let s=a.dir[1]===1?h.top:a.dir[1]===-1?h.bottom:h.side,p=s%c,m=s/c|0,v=p/c+l,y=(p+1)/c-l,b=1-(m+1)/c+l,x=1-m/c-l,S=n.length/3;for(let t of a.corners){let o=_&&t.pos[1]===1?_[t.pos[0]]?.[t.pos[2]]??1:t.pos[1];n.push(d+t.pos[0],e+o,u+t.pos[2]),r.push(a.dir[0],a.dir[1],a.dir[2]),i.push(t.uv[0]===1?y:v,t.uv[1]===1?x:b)}g.push(S,S+1,S+2,S+2,S+1,S+3)}}let h=o.length||s.length?a.concat(o,s):a;return{positions:new Float32Array(n),normals:new Float32Array(r),uvs:new Float32Array(i),indices:new Uint32Array(h),opaqueIndexCount:a.length,aguaIndexCount:o.length}}var Z={width:.6,height:1.8,eyeHeight:1.62,sneakEyeHeight:1.32,walkSpeed:4.3,sprintFactor:1.6,sneakFactor:.3,jumpSpeed:8.4,gravity:25,terminalVelocity:40,flySpeed:9,flyVertSpeed:7,waterFactor:.5,waterGravity:8,swimSpeed:4,waterJumpSpeed:7.5,waterSinkMax:3},Yu=.001,Xu=.4,Zu=.55;function Qu(e){return El(e)||kl(e)}function $u(e,t,n){return{pos:{x:e,y:t,z:n},vel:{x:0,y:0,z:0},onGround:!1,sprinting:!1}}function ed(e,t){let n=Z.width/2,r=t.x-n,i=t.x+n,a=t.y,o=t.y+Z.height,s=t.z-n,c=t.z+n,l=Math.floor(r),u=Math.floor(i),d=Math.floor(a),f=Math.floor(o),p=Math.floor(s),m=Math.floor(c);for(let t=d;t<=f;t++)for(let n=p;n<=m;n++)for(let d=l;d<=u;d++){let l=mu(e,d,t,n);if(eu(l)){if(!Qu(l))return!0;for(let e of Fl(l))if(i>d+e[0]&&r<d+e[3]&&o>t+e[1]&&a<t+e[4]&&c>n+e[2]&&s<n+e[5])return!0}}return!1}var td=[[0,0,0,1,1,1]];function nd(e,t,n){let r=Z.width/2,i=t.x-r,a=t.x+r,o=t.z-r,s=t.z+r,c=Math.floor(i),l=Math.floor(a),u=Math.floor(o),d=Math.floor(s),f=Math.floor(t.y)-1,p=Math.floor(t.y+Z.height)+1,m=t.y,h=t.y+Z.height,g=NaN;for(let t=f;t<=p;t++)for(let r=u;r<=d;r++)for(let u=c;u<=l;u++){let c=mu(e,u,t,r);if(!eu(c))continue;let l=Qu(c)?Fl(c):td;for(let e of l){if(a<=u+e[0]||i>=u+e[3]||s<=r+e[2]||o>=r+e[5])continue;let c=t+e[1],l=t+e[4];n<0?c<=m+Yu&&(Number.isNaN(g)||l>g)&&(g=l):l>=h-Yu&&(Number.isNaN(g)||c<g)&&(g=c)}}return g}function rd(e,t,n,r){let i=Z.width/2,a=n===`x`,o=a?0:2,s=a?3:5,c=a?2:0,l=a?5:3,u=t[n]-i,d=t[n]+i,f=a?t.z:t.x,p=f-i,m=f+i,h=t.y,g=t.y+Z.height,_=Math.floor(u),v=Math.floor(d),y=Math.floor(p),b=Math.floor(m),x=Math.floor(h),S=Math.floor(g),C=NaN;for(let t=x;t<=S;t++)for(let n=y;n<=b;n++)for(let i=_;i<=v;i++){let f=mu(e,a?i:n,t,a?n:i);if(!eu(f))continue;let _=Qu(f)?Fl(f):td;for(let e of _)if(!(g<=t+e[1]||h>=t+e[4])&&!(m<=n+e[c]||p>=n+e[l])&&!(d<=i+e[o]||u>=i+e[s]))if(r>0){let t=i+e[o];(Number.isNaN(C)||t<C)&&(C=t)}else{let t=i+e[s];(Number.isNaN(C)||t>C)&&(C=t)}}return C}function id(e,t,n,r){if(r===0||(t.pos[n]+=r,!ed(e,t.pos)))return;let i=Z.width/2;if(n===`y`){if(r<0){let n=nd(e,t.pos,-1);t.pos.y=(Number.isNaN(n)?Math.floor(t.pos.y)+1:n)+Yu,t.onGround=!0}else{let n=nd(e,t.pos,1);t.pos.y=(Number.isNaN(n)?Math.floor(t.pos.y+Z.height):n)-Z.height-Yu}t.vel.y=0}else{let a=rd(e,t.pos,n,r);r>0?t.pos[n]=(Number.isNaN(a)?Math.floor(t.pos[n]+i):a)-i-Yu:t.pos[n]=(Number.isNaN(a)?Math.floor(t.pos[n]-i)+1:a)+i+Yu,t.vel[n]=0}}function ad(e,t){return yl(mu(e,Math.floor(t.x),Math.floor(t.y+Z.height*.5),Math.floor(t.z)))}function od(e,t){let n=Z.width/2,r=t.x-n,i=t.x+n,a=t.z-n,o=t.z+n,s=Math.floor(r),c=Math.floor(i),l=Math.floor(a),u=Math.floor(o),d=Math.floor(t.y-.06),f=Math.floor(t.y);for(let n=d;n<=f;n++)for(let d=l;d<=u;d++)for(let l=s;l<=c;l++){let s=mu(e,l,n,d);if(!eu(s))continue;let c=Qu(s)?Fl(s):td;for(let e of c){if(i<=l+e[0]||r>=l+e[3]||o<=d+e[2]||a>=d+e[5])continue;let s=n+e[4];if(s<=t.y+Yu&&s>=t.y-.06)return!0}}return!1}function sd(e,t,n,r,i,a){let o=t.pos[n];ld(e,t,n,r,i);let s=t.pos[n]-o;if(!a||Math.abs(s)>=Math.abs(r)-Yu)return;let c=t.pos[n],l=t.pos.y;if(t.pos.y=l+Zu,ed(e,t.pos)){t.pos.y=l;return}if(t.pos[n]+=r-s,ed(e,t.pos)){t.pos[n]=c,t.pos.y=l;return}id(e,t,`y`,-.55),i&&!od(e,t.pos)&&(t.pos[n]=c,t.pos.y=l)}function cd(e,t){let n=Z.width/2,r=Math.floor(t.x),i=Math.floor(t.z),a=Math.floor(t.x+n)+1,o=Math.floor(t.x-n)-1,s=Math.floor(t.z+n)+1,c=Math.floor(t.z-n)-1,l=Math.floor(t.y),u=Math.floor(t.y+Z.height*.5);for(let t=l;t<=u;t++)if(eu(mu(e,a,t,i))||eu(mu(e,o,t,i))||eu(mu(e,r,t,s))||eu(mu(e,r,t,c)))return!0;return!1}function ld(e,t,n,r,i){let a=t.pos[n];id(e,t,n,r),i&&!od(e,t.pos)&&(t.pos[n]=a,t.vel[n]=0)}function ud(e,t,n,r){let i=n.forward,a=n.strafe;if(n.fly===!0){t.sprinting=!1,t.onGround=!1;let o=Math.sin(n.yaw),s=Math.cos(n.yaw),c=Math.hypot(i,a),l=(c>1?1/c:1)*Z.flySpeed;t.vel.x=(a*s-i*o)*l,t.vel.z=(-i*s-a*o)*l,t.vel.y=(!!n.jump-+(n.sneak===!0))*Z.flyVertSpeed;let u=Math.max(Math.abs(t.vel.x),Math.abs(t.vel.y),Math.abs(t.vel.z))*r,d=Math.max(1,Math.ceil(u/Xu)),f=r/d;for(let n=0;n<d;n++)id(e,t,`y`,t.vel.y*f),id(e,t,`x`,t.vel.x*f),id(e,t,`z`,t.vel.z*f);return}let o=n.sneak===!0,s=ad(e,t.pos);o||i<=0||s?t.sprinting=!1:n.sprint===!0&&t.onGround&&(t.sprinting=!0);let c=(o?Z.sneakFactor:t.sprinting?Z.sprintFactor:1)*(s?Z.waterFactor:1),l=Math.hypot(i,a),u=(l>1?1/l:1)*Z.walkSpeed*c,d=Math.sin(n.yaw),f=Math.cos(n.yaw);t.vel.x=(a*f-i*d)*u,t.vel.z=(-i*f-a*d)*u,s?n.jump?t.vel.y=cd(e,t.pos)?Z.waterJumpSpeed:Z.swimSpeed:o?t.vel.y=-Z.swimSpeed:(t.vel.y-=Z.waterGravity*r,t.vel.y<-Z.waterSinkMax&&(t.vel.y=-Z.waterSinkMax),t.vel.y>Z.waterSinkMax&&(t.vel.y=Z.waterSinkMax)):(n.jump&&t.onGround&&(t.vel.y=Z.jumpSpeed),t.vel.y-=Z.gravity*r,t.vel.y<-Z.terminalVelocity&&(t.vel.y=-Z.terminalVelocity)),t.onGround=!1;let p=Math.max(Math.abs(t.vel.x),Math.abs(t.vel.y),Math.abs(t.vel.z))*r,m=Math.max(1,Math.ceil(p/Xu)),h=r/m;for(let n=0;n<m;n++){id(e,t,`y`,t.vel.y*h);let n=o&&t.onGround,r=t.onGround&&!s;sd(e,t,`x`,t.vel.x*h,n,r),sd(e,t,`z`,t.vel.z*h,n,r)}}function dd(e,t,n,r,i,a,o,s,c,l,u){let d=0,f=u,p=-1;{let t=o+l[0],n=o+l[3];if(r!==0){let i=1/r,a=(t-e)*i,o=(n-e)*i;if(a>o){let e=a;a=o,o=e}if(a>d&&(d=a,p=0),o<f&&(f=o),d>f)return null}else if(e<t||e>n)return null}{let e=s+l[1],n=s+l[4];if(i!==0){let r=1/i,a=(e-t)*r,o=(n-t)*r;if(a>o){let e=a;a=o,o=e}if(a>d&&(d=a,p=1),o<f&&(f=o),d>f)return null}else if(t<e||t>n)return null}{let e=c+l[2],t=c+l[5];if(a!==0){let r=1/a,i=(e-n)*r,o=(t-n)*r;if(i>o){let e=i;i=o,o=e}if(i>d&&(d=i,p=2),o<f&&(f=o),d>f)return null}else if(n<e||n>t)return null}return d>u?null:p===0?[r>0?-1:1,0,0]:p===1?[0,i>0?-1:1,0]:p===2?[0,0,a>0?-1:1]:[0,0,0]}function fd(e,t,n,r,i,a,o,s,c=!1){let l=Math.hypot(i,a,o);if(l===0||!Number.isFinite(l))return null;i/=l,a/=l,o/=l;let u=Math.floor(t),d=Math.floor(n),f=Math.floor(r),p=i>0?1:-1,m=a>0?1:-1,h=o>0?1:-1,g=i===0?1/0:Math.abs(1/i),_=a===0?1/0:Math.abs(1/a),v=o===0?1/0:Math.abs(1/o),y=i===0?1/0:(i>0?u+1-t:t-u)*g,b=a===0?1/0:(a>0?d+1-n:n-d)*_,x=o===0?1/0:(o>0?f+1-r:r-f)*v,S=0,C=0,w=0,T=0;for(;T<=s;){let l=mu(e,u,d,f);if(c&&yl(l))return{x:u,y:d,z:f,nx:S,ny:C,nz:w};if(l!==K.Air&&!yl(l)){if($l(l))return{x:u,y:d,z:f,nx:S,ny:C,nz:w};let e=dd(t,n,r,i,a,o,u,d,f,Iu(l),s);if(e)return{x:u,y:d,z:f,nx:e[0],ny:e[1],nz:e[2]}}y<b&&y<x?(u+=p,T=y,y+=g,S=-p,C=0,w=0):b<x?(d+=m,T=b,b+=_,S=0,C=-m,w=0):(f+=h,T=x,x+=v,S=0,C=0,w=-h)}return null}function pd(e,t,n){return`${e},${t},${n}`}function md(e){if(typeof e!=`object`||!e)return null;let t=e,{x:n,y:r,z:i}=t;if(typeof n!=`number`||!Number.isInteger(n)||typeof r!=`number`||!Number.isInteger(r)||typeof i!=`number`||!Number.isInteger(i)||typeof t.texto!=`string`)return null;let a=t.texto.slice(0,300),o=t.imagem;return o===void 0?{x:n,y:r,z:i,texto:a}:typeof o!=`string`||!o.startsWith(`data:image/`)||o.length>32768?null:{x:n,y:r,z:i,texto:a,imagem:o}}var hd=(e,t,n,r)=>n===0||mu(e,t,n-1,r)!==K.Air?null:[{x:t,y:n-1,z:r,blockId:mu(e,t,n,r)},{x:t,y:n,z:r,blockId:K.Air}],gd=(e,t,n,r)=>{let i=mu(e,t,n,r);return mu(e,t,n+1,r)===i||mu(e,t,n-1,r)===i?null:[{x:t,y:n,z:r,blockId:K.Air}]},_d=(e,t,n,r)=>{let i=mu(e,t,n,r),{dx:a,dz:o}=Bl(i);return mu(e,t+a,n,r+o)===i||mu(e,t-a,n,r-o)===i?null:[{x:t,y:n,z:r,blockId:K.Air}]},vd=(e,t,n,r)=>$l(mu(e,t,n-1,r))?null:[{x:t,y:n,z:r,blockId:K.Air}],yd=[[1,0],[-1,0],[0,1],[0,-1]];function bd(e,t,n,r){let i=0;for(let[a,o]of yd)bl(mu(e,t+a,n,r+o))&&i++;return i}function xd(e,t,n,r){if(yl(mu(e,t,n+1,r)))return 7;let i=0;for(let[a,o]of yd){let s=xl(mu(e,t+a,n,r+o));s>0&&(i=Math.max(i,s-1))}return i}var Sd=4;function Cd(e,t,n,r){if(!pu(e,t,n-1,r))return!1;let i=mu(e,t,n-1,r);return i===K.Air||yl(i)&&!bl(i)}function wd(e,t,n,r){if(!pu(e,t,n,r))return!1;let i=mu(e,t,n,r);return i===K.Air||yl(i)&&!bl(i)}function Td(e,t,n,r,i,a,o){let s=1/0;for(let[c,l]of yd){if(c===a&&l===o)continue;let u=t+c,d=r+l;if(!wd(e,u,n,d))continue;if(Cd(e,u,n,d))return i;if(i>=Sd)continue;let f=Td(e,u,n,d,i+1,-c,-l);f<s&&(s=f)}return s}var Ed=(e,t,n,r)=>{let i=mu(e,t,n,r),a=[],o=mu(e,t,n-1,r),s;if(bl(i))s=8;else if($l(o)&&!yl(o)&&bd(e,t,n,r)>=2)a.push({x:t,y:n,z:r,blockId:K.Agua}),s=8;else{let o=xd(e,t,n,r);if(o<=0)return[{x:t,y:n,z:r,blockId:K.Air}];o!==xl(i)&&a.push({x:t,y:n,z:r,blockId:Sl(o)}),s=o}if(o===K.Air)a.push({x:t,y:n-1,z:r,blockId:K.AguaFluida7});else if($l(o)&&!yl(o)){let i=s-1;if(i>=1){let o=[1/0,1/0,1/0,1/0],s=[!1,!1,!1,!1],c=1/0;for(let[a,[l,u]]of yd.entries()){let d=t+l,f=r+u,p=mu(e,d,n,f);if(s[a]=pu(e,d,n,f)&&(p===K.Air||yl(p)&&!bl(p)&&xl(p)<i),!wd(e,d,n,f))continue;let m=Cd(e,d,n,f)?0:Td(e,d,n,f,1,-l,-u);o[a]=m,m<c&&(c=m)}let l=c!==1/0;for(let[e,[u,d]]of yd.entries())s[e]&&(l&&(o[e]??1/0)>c||a.push({x:t+u,y:n,z:r+d,blockId:Sl(i)}))}}return a.length?a:null},Dd=new Map([[K.Sand,hd],[K.Gravel,hd],[K.PortaXFechada,gd],[K.PortaXAberta,gd],[K.PortaZFechada,gd],[K.PortaZAberta,gd],[K.PortaXFechadaR,gd],[K.PortaXAbertaR,gd],[K.PortaZFechadaR,gd],[K.PortaZAbertaR,gd],[K.Tocha,vd]]);for(let e=K.TapeteBranco;e<=K.TapeteMarrom;e++)Dd.set(e,vd);for(let e of[K.CamaXP,K.CamaZP,K.CamaXN,K.CamaZN])Dd.set(e,_d);for(let e=K.FlorVermelha;e<=K.FlorBranca;e++)Dd.set(e,vd);for(let e=K.Agua;e<=K.AguaFluida7;e++)Dd.set(e,Ed);function Od(e){return(e.max.x-e.min.x+1)*(e.max.y-e.min.y+1)*(e.max.z-e.min.z+1)}function kd(e){return e===`construir`||e===`chegar`||e===`limpar`}function Ad(e,t){let n=yu(e),r=yu(t);return!n||!r||n.x>r.x||n.y>r.y||n.z>r.z?null:{min:n,max:r}}function jd(e){if(typeof e!=`object`||!e)return null;let t=e;if(typeof t.id!=`number`||!Number.isInteger(t.id)||t.id<1||!kd(t.kind)||typeof t.regiao!=`string`||!t.regiao||typeof t.texto!=`string`)return null;let n=Ad(t.min,t.max);if(!n)return null;let r;if(t.kind===`construir`){if(!Array.isArray(t.gabarito)||t.gabarito.length!==Od(n)||!t.gabarito.every(e=>typeof e==`number`&&Number.isInteger(e)&&e>=0))return null;r=t.gabarito}let i;if(t.alvos!==void 0){if(!Array.isArray(t.alvos)||t.alvos.length===0)return null;i=[];for(let e of t.alvos){let t=e,a=t?Ad(t.min,t.max):null;if(!a||r&&Od(a)!==Od(n))return null;i.push(a)}}let a;if(Array.isArray(t.baseline)){let e=i??[n],r=t.baseline;r.length===e.length&&r.every((t,n)=>Array.isArray(t)&&t.length===Od(e[n])&&t.every(e=>typeof e==`number`&&Number.isInteger(e)&&e>=0))&&(a=r)}return{id:t.id,kind:t.kind,regiao:t.regiao,texto:t.texto.slice(0,120),min:n.min,max:n.max,...typeof t.modelo==`string`?{modelo:t.modelo}:{},...r?{gabarito:r}:{},...i?{alvos:i}:{},...t.regra===`todos`||t.regra===`um`?{regra:t.regra}:{},...a?{baseline:a}:{}}}function Md(e){if(typeof e!=`object`||!e)return null;let t=e,n=[];if(Array.isArray(t.objetivos))for(let e of t.objetivos){let t=jd(e);t&&n.push(t)}let r=Array.isArray(t.completos)?t.completos.filter(e=>typeof e==`number`&&Number.isInteger(e)):[],i=[];if(Array.isArray(t.completosGrupos))for(let e of t.completosGrupos){if(typeof e!=`object`||!e)continue;let t=e;typeof t.grupo!=`number`||!Number.isInteger(t.grupo)||i.push({grupo:t.grupo,objetivos:Array.isArray(t.objetivos)?t.objetivos.filter(e=>typeof e==`number`&&Number.isInteger(e)):[]})}return{modo:t.modo===`livre`?`livre`:`sequencial`,objetivos:n,completos:r,...i.length?{completosGrupos:i}:{}}}function Nd(e){if(typeof e!=`object`||!e)return null;let t=e;if(typeof t.id!=`number`||!Number.isInteger(t.id)||!kd(t.kind)||typeof t.regiao!=`string`||typeof t.texto!=`string`)return null;let n=yu(t.min),r=yu(t.max);if(!n||!r||typeof t.completo!=`boolean`||typeof t.ativo!=`boolean`||![t.atual,t.total,t.extras].every(e=>typeof e==`number`&&Number.isInteger(e)))return null;let i;if(t.porGrupo!==void 0){if(!Array.isArray(t.porGrupo))return null;i=[];for(let e of t.porGrupo){if(typeof e!=`object`||!e)return null;let t=e,n=Ad(t.min,t.max);if(!n||typeof t.grupo!=`number`||!Number.isInteger(t.grupo)||typeof t.completo!=`boolean`||typeof t.ativo!=`boolean`||![t.atual,t.total,t.extras].every(e=>typeof e==`number`&&Number.isInteger(e)))return null;i.push({grupo:t.grupo,min:n.min,max:n.max,atual:t.atual,total:t.total,extras:t.extras,completo:t.completo,ativo:t.ativo})}}return{id:t.id,kind:t.kind,regiao:t.regiao,texto:t.texto,min:n,max:r,completo:t.completo,ativo:t.ativo,atual:t.atual,total:t.total,extras:t.extras,...i?{porGrupo:i}:{}}}function Pd(e){let t;try{t=JSON.parse(e)}catch{return null}if(typeof t!=`object`||!t)return null;let n=t;switch(n.type){case`debug_stats`:{if(![n.tickAvgMs,n.tickMaxMs,n.tps].every(e=>typeof e==`number`&&Number.isFinite(e)))return null;let e=e=>{let t=n[e];return typeof t==`number`&&Number.isFinite(t)?t:void 0};return{type:`debug_stats`,tickAvgMs:n.tickAvgMs,tickMaxMs:n.tickMaxMs,tps:n.tps,...e(`regrasCelulasAvg`)===void 0?{}:{regrasCelulasAvg:e(`regrasCelulasAvg`)},...e(`regrasCelulasMax`)===void 0?{}:{regrasCelulasMax:e(`regrasCelulasMax`)},...e(`regrasMudancasAvg`)===void 0?{}:{regrasMudancasAvg:e(`regrasMudancasAvg`)},...e(`regrasAguaAvg`)===void 0?{}:{regrasAguaAvg:e(`regrasAguaAvg`)}}}case`block_changed`:return[n.x,n.y,n.z,n.blockId].every(e=>typeof e==`number`&&Number.isInteger(e))?{type:`block_changed`,x:n.x,y:n.y,z:n.z,blockId:n.blockId}:null;case`blocks_filled`:return[n.x0,n.y0,n.z0,n.x1,n.y1,n.z1,n.blockId].every(e=>typeof e==`number`&&Number.isInteger(e))?{type:`blocks_filled`,x0:n.x0,y0:n.y0,z0:n.z0,x1:n.x1,y1:n.y1,z1:n.z1,blockId:n.blockId}:null;case`player_moved`:return typeof n.id!=`number`||!Number.isInteger(n.id)||![n.x,n.y,n.z,n.yaw,n.pitch].every(e=>typeof e==`number`&&Number.isFinite(e))?null:{type:`player_moved`,id:n.id,x:n.x,y:n.y,z:n.z,yaw:n.yaw,pitch:n.pitch,...typeof n.name==`string`?{name:n.name}:{}};case`player_left`:return typeof n.id!=`number`||!Number.isInteger(n.id)?null:{type:`player_left`,id:n.id};case`spawn`:return[n.x,n.y,n.z].every(e=>typeof e==`number`&&Number.isFinite(e))?{type:`spawn`,x:n.x,y:n.y,z:n.z,...n.papel===`professor`||n.papel===`aluno`?{papel:n.papel}:{}}:null;case`regions`:{if(!Array.isArray(n.regions))return null;let e=[];for(let t of n.regions){let n=bu(t);n&&e.push(n)}return{type:`regions`,regions:e}}case`objectives`:{if(n.modo!==`sequencial`&&n.modo!==`livre`||!Array.isArray(n.objetivos))return null;let e=[];for(let t of n.objetivos){let n=Nd(t);n&&e.push(n)}return{type:`objectives`,modo:n.modo,objetivos:e}}case`group`:{let e=n.grupo;return e!==null&&(typeof e!=`number`||!Number.isInteger(e))?null:{type:`group`,grupo:e}}case`groups`:return{type:`groups`,grupos:Cu(n.grupos)};case`claims`:{if(typeof n.ativo!=`boolean`||!Array.isArray(n.claims))return null;let e=[];for(let t of n.claims){let n=xu(t);n&&e.push(n)}return{type:`claims`,ativo:n.ativo,claims:e}}case`friends`:{let e=e=>Array.isArray(e)?e.filter(e=>typeof e==`string`):[],t=null,r=n.equipe;if(r&&typeof r==`object`){let n=r;typeof n.dono==`string`&&(t={dono:n.dono,membros:e(n.membros)})}return{type:`friends`,equipe:t,convites:e(n.convites)}}case`players`:{if(!Array.isArray(n.conectados)||!Array.isArray(n.banidos))return null;let e=[];for(let t of n.conectados){if(!t||typeof t!=`object`)continue;let n=t;typeof n.name==`string`&&e.push({name:n.name,papel:n.papel===`professor`?`professor`:`aluno`})}return{type:`players`,conectados:e,banidos:n.banidos.filter(e=>typeof e==`string`)}}case`quadro_changed`:{let e=md(n);return e?{type:`quadro_changed`,...e}:null}case`quadros`:{if(!Array.isArray(n.lista))return null;let e=[];for(let t of n.lista){let n=md(t);n&&e.push(n)}return{type:`quadros`,lista:e}}case`chat`:return typeof n.author!=`string`||typeof n.text!=`string`?null:{type:`chat`,author:n.author,text:n.text};case`join_denied`:return typeof n.reason==`string`?{type:`join_denied`,reason:n.reason}:null;case`teleport`:return[n.x,n.y,n.z,n.yaw,n.pitch].every(e=>typeof e==`number`&&Number.isFinite(e))?{type:`teleport`,x:n.x,y:n.y,z:n.z,yaw:n.yaw,pitch:n.pitch}:null;case`time`:return typeof n.hora!=`number`||!Number.isFinite(n.hora)||typeof n.ciclo!=`boolean`?null:{type:`time`,hora:n.hora,ciclo:n.ciclo};case`mundo_trocando`:return typeof n.nome==`string`?{type:`mundo_trocando`,nome:n.nome}:null;case`voo`:return typeof n.liberado==`boolean`?{type:`voo`,liberado:n.liberado}:null;case`kicked`:return typeof n.reason==`string`?{type:`kicked`,reason:n.reason}:null;default:return null}}function Fd(e){if(e.byteLength<12)throw Error(`snapshot menor que o header (${e.byteLength} bytes)`);let t=new DataView(e);if(t.getUint32(0,!0)!==810178380)throw Error(`snapshot com magic inválido — não é um world_snapshot`);let n={x:t.getUint8(4),z:t.getUint8(5),y:t.getUint8(6)};if(n.x<1||n.z<1||n.y<1||n.x>su.x||n.z>su.z||n.y>su.y)throw Error(`snapshot com dims fora do limite: ${n.x}×${n.z}×${n.y}`);let r=t.getUint32(8,!0),i=lu(n),a=12+i.chunks.length*ou;if(e.byteLength!==a)throw Error(`snapshot com tamanho errado: ${e.byteLength} bytes (esperado ${a})`);for(let t=0;t<i.chunks.length;t++)i.chunks[t]?.set(new Uint8Array(e,12+t*ou,ou));return{world:i,seed:r}}var Id=809847372,Ld={x:240,z:240,y:8};function Rd(e){return e.byteLength<4?0:new DataView(e).getUint32(0,!0)}function zd(e){if(e.byteLength!==16)throw Error(`LJE0 com tamanho errado (${e.byteLength} bytes)`);let t=new DataView(e);if(t.getUint32(0,!0)!==809847372)throw Error(`LJE0 com magic inválido`);let n={x:t.getUint16(4,!0),z:t.getUint16(6,!0),y:t.getUint16(8,!0)};if(n.x<1||n.z<1||n.y<1||n.x>Ld.x||n.z>Ld.z||n.y>Ld.y)throw Error(`LJE0 com dims fora do limite: ${n.x}×${n.z}×${n.y}`);return{world:lu(n,!1),seed:t.getUint32(12,!0)}}var Bd=8;function Vd(e,t){if(e.byteLength<Bd)throw Error(`LJC0 menor que o header (${e.byteLength} bytes)`);let n=new DataView(e);if(n.getUint32(0,!0)!==809716300)throw Error(`LJC0 com magic inválido`);let r=n.getUint16(4,!0),i=4+t.dims.y*ou;if(e.byteLength!==Bd+r*i)throw Error(`LJC0 com tamanho errado (${e.byteLength} bytes p/ ${r} colunas)`);let a=[],o=Bd;for(let i=0;i<r;i++){let r=n.getUint16(o,!0),i=n.getUint16(o+2,!0);if(o+=4,r>=t.dims.x||i>=t.dims.z)throw Error(`LJC0 com coluna fora do mundo: ${r},${i}`);uu(t,r,i);for(let n=0;n<t.dims.y;n++)t.chunks[du(t,r,n,i)]?.set(new Uint8Array(e,o,ou)),o+=ou;a.push({cx:r,cz:i})}return a}var Hd=8;function Ud(e){if(typeof e!=`object`||!e)return!1;let t=e;return[`x`,`y`,`z`].every(e=>typeof t[e]==`number`&&Number.isFinite(t[e]))}function Wd(e){if(e.byteLength<Hd)throw Error(`save menor que o header (${e.byteLength} bytes)`);let t=new DataView(e),n=t.getUint32(0,!0);if(n===844319308)return Gd(e,t);if(n!==827542092)throw Error(`save com magic inválido — não é um arquivo .ljw`);let{jsonLen:r,meta:i}=Kd(e,t),a=Fd(e.slice(Hd+r));return{...i,world:a.world}}function Gd(e,t){let{jsonLen:n,m:r,meta:i}=Kd(e,t),a=r.dims,o=typeof a==`object`&&a&&typeof a.x==`number`&&typeof a.z==`number`&&typeof a.y==`number`?a:null;if(!o||o.x<1||o.z<1||o.y<1||o.x>Ld.x||o.z>Ld.z||o.y>Ld.y)throw Error(`save esparso sem dims válidas`);let s=Hd+n;if(s+4>e.byteLength)throw Error(`save esparso truncado (sem contagem)`);let c=t.getUint32(s,!0);if(s+=4,s+c*4100>e.byteLength)throw Error(`save esparso truncado (${c} chunks não cabem)`);let l=o.x*o.y*o.z,u=[];for(let n=0;n<c;n++){let n=t.getUint32(s,!0);s+=4,n<l&&u.push({index:n,bytes:new Uint8Array(e.slice(s,s+ou))}),s+=ou}return{...i,dims:o,world:lu(o,!1),editedChunks:u}}function Kd(e,t){let n=t.getUint32(4,!0);if(Hd+n>e.byteLength)throw Error(`save truncado: JSON de metadados maior que o arquivo`);let r;try{r=JSON.parse(new TextDecoder().decode(new Uint8Array(e,Hd,n)))}catch{throw Error(`save com JSON de metadados quebrado`)}if(typeof r!=`object`||!r)throw Error(`metadados não são objeto`);let i=r;if(typeof i.seed!=`number`||!Number.isFinite(i.seed))throw Error(`save sem seed válida`);if(!Ud(i.spawn))throw Error(`save sem spawn válido`);let a=[];if(Array.isArray(i.roster)){for(let e of i.roster)if(typeof e==`object`&&e&&typeof e.name==`string`&&Ud(e)){let t=e,n=e=>typeof e==`number`&&Number.isFinite(e)?e:0;a.push({name:t.name,x:t.x,y:t.y,z:t.z,yaw:n(t.yaw),pitch:n(t.pitch),...typeof t.pin==`string`?{pin:t.pin}:{},...t.papel===`professor`?{papel:`professor`}:{}})}}let o=[];if(Array.isArray(i.regioes))for(let e of i.regioes){let t=bu(e);t&&o.push(t)}let s=Md(i.cenario),c=Cu(i.grupos),l=[];if(Array.isArray(i.claims))for(let e of i.claims){let t=xu(e);t&&l.push(t)}let u=[];if(Array.isArray(i.amigos))for(let e of i.amigos){let t=Su(e);t&&u.push(t)}let d=[];if(Array.isArray(i.banidos))for(let e of i.banidos)typeof e==`string`&&e&&!d.includes(e)&&d.push(e);let f=[];if(Array.isArray(i.quadros))for(let e of i.quadros){let t=md(e);t&&f.push(t)}return{jsonLen:n,m:i,meta:{seed:i.seed,spawn:{x:i.spawn.x,y:i.spawn.y,z:i.spawn.z},roster:a,...typeof i.codigo==`string`?{codigo:i.codigo}:{},...o.length?{regioes:o}:{},...s?.objetivos.length?{cenario:s}:{},...c.length?{grupos:c}:{},...i.claimsAtivo===!0?{claimsAtivo:!0}:{},...l.length?{claims:l}:{},...u.length?{amigos:u}:{},...d.length?{banidos:d}:{},...i.confinamento===!0?{confinamento:!0}:{},...f.length?{quadros:f}:{},...typeof i.hora==`number`&&Number.isFinite(i.hora)?{hora:i.hora}:{},...typeof i.ciclo==`boolean`?{ciclo:i.ciclo}:{}}}}var qd=`0.8.0`;function Jd(e,t,n){let r=n^Math.imul(e,374761393)^Math.imul(t,668265263);return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function Q(e,t,n,r,i=0,a=q.tilePx){let o=q.tilePx,s=t%q.tilesPerRow*o,c=(t/q.tilesPerRow|0)*o;for(let l=i;l<a;l++)for(let i=0;i<o;i++){let a=(Jd(i,l,t*7919+1)-.5)*2*r;e.fillStyle=`rgb(${Math.round(n[0]+a)},${Math.round(n[1]+a)},${Math.round(n[2]+a)})`,e.fillRect(s+i,c+l,1,1)}}function Yd(e,t){let n=q.tilePx,r=t%q.tilesPerRow*n,i=(t/q.tilesPerRow|0)*n;e.fillStyle=`rgb(72,72,72)`;for(let t=0;t<n;t++)e.fillRect(r+t,i+(t%2==0?4:5),1,1),e.fillRect(r+t,i+(t%3==0?11:10),1,1),e.fillRect(r+(t%2==0?7:8),i+t,1,1)}function Xd(e){let t=q.tilePx;return[e%q.tilesPerRow*t,(e/q.tilesPerRow|0)*t]}function Zd(e,t){let[n,r]=Xd(t);e.fillStyle=`rgb(74,54,34)`;for(let i=1;i<q.tilePx;i+=4)for(let a=0;a<q.tilePx;a++)Jd(i,a,t*31+3)<.8&&e.fillRect(n+i,r+a,1,a===0?2:1)}function Qd(e,t){let[n,r]=Xd(t),i=q.tilePx/2-.5;e.fillStyle=`rgb(120,90,52)`;for(let t=0;t<q.tilePx;t++)for(let a=0;a<q.tilePx;a++){let o=Math.hypot(a-i,t-i);Math.round(o)%3==0&&o<7.5&&e.fillRect(n+a,r+t,1,1)}}function $d(e,t){let[n,r]=Xd(t);e.fillStyle=`rgb(122,92,56)`;for(let t=3;t<q.tilePx;t+=4)e.fillRect(n,r+t,q.tilePx,1);for(let t=0;t<4;t++)e.fillRect(n+(t%2==0?4:11),r+t*4,1,3)}function ef(e,t){let[n,r]=Xd(t);e.fillStyle=`rgb(196,178,124)`;for(let i=3;i<q.tilePx;i+=5)for(let a=0;a<q.tilePx;a++)Jd(a,i,t*41+5)<.7&&e.fillRect(n+a,r+i,1,1)}function tf(e,t){let[n,r]=Xd(t);e.fillStyle=`rgb(96,96,96)`;for(let t=3;t<q.tilePx;t+=4)e.fillRect(n,r+t,q.tilePx,1);for(let t=0;t<4;t++){let i=t%2==0?7:3;e.fillRect(n+i,r+t*4,1,3),e.fillRect(n+(i+8)%q.tilePx,r+t*4,1,3)}}function nf(e,t){let[n,r]=Xd(t);e.fillStyle=`rgb(92,58,128)`;for(let i=0;i<q.tilePx;i++)for(let a=0;a<q.tilePx;a++)Jd(a,i,t*67+11)<.06&&e.fillRect(n+a,r+i,1,1)}function rf(e,t){let[n,r]=Xd(t);for(let i=0;i<4;i++)for(let a=0;a<q.tilePx;a++){let o=(a+(i%2==0?0:4))%8;for(let s=0;s<3;s++){if(o===7)continue;let c=(Jd(a,i*4+s,t*53+9)-.5)*20;e.fillStyle=`rgb(${Math.round(158+c)},${Math.round(64+c)},${Math.round(52+c)})`,e.fillRect(n+a,r+i*4+s,1,1)}}}function af(e,t){let[n,r]=Xd(t),i=q.tilePx;e.clearRect(n,r,i,i),e.fillStyle=`rgb(214,232,240)`,e.fillRect(n,r,i,1),e.fillRect(n,r+i-1,i,1),e.fillRect(n,r,1,i),e.fillRect(n+i-1,r,1,i);for(let t=2;t<6;t++)e.fillRect(n+t,r+8-t,1,1);for(let t=4;t<10;t++)e.fillRect(n+t,r+14-t,1,1)}function of(e,t,n){let[r,i]=Xd(t),a=q.tilePx;e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`,e.fillRect(r,i,a,a),e.fillStyle=`rgb(${Math.round((n[0]+255)/2)},${Math.round((n[1]+255)/2)},${Math.round((n[2]+255)/2)})`,e.fillRect(r,i,a,1),e.fillRect(r,i+a-1,a,1),e.fillRect(r,i,1,a),e.fillRect(r+a-1,i,1,a),e.fillStyle=`rgb(240,246,250)`;for(let t=3;t<8;t++)e.fillRect(r+t,i+11-t,1,1)}function sf(e,t,n,r){Q(e,t,r,6);let[i,a]=Xd(t),o=q.tilePx;e.fillStyle=`rgb(28,28,32)`,e.font=`bold ${o-3}px sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(n,i+o/2,a+o/2+1)}function cf(e,t){Q(e,t,[146,112,66],10);let[n,r]=Xd(t);e.fillStyle=`rgb(116,86,48)`;for(let i=2;i<q.tilePx;i+=3)for(let a=0;a<q.tilePx;a++)Jd(i,a,t*29+7)<.6&&e.fillRect(n+i,r+a,1,1)}function lf(e,t,n){Q(e,t,[164,126,76],8);let[r,i]=Xd(t),a=q.tilePx;e.fillStyle=`rgb(112,82,46)`,e.fillRect(r,i,a,1),e.fillRect(r,i+a-1,a,1),e.fillRect(r,i,1,a),e.fillRect(r+a-1,i,1,a),e.fillRect(r+8,i,1,a),n&&(e.fillRect(r+3,i+3,10,1),e.fillRect(r+3,i+9,10,1),e.fillRect(r+3,i+3,1,7),e.fillRect(r+12,i+3,1,7),e.clearRect(r+4,i+4,8,5))}function uf(e,t){Q(e,t,[255,232,122],14,0,10),Q(e,t,[122,92,56],10,10,q.tilePx)}function df(e,t){Q(e,t,[164,126,76],8);let[n,r]=Xd(t),i=q.tilePx;e.clearRect(n+2,r+2,i-4,i-4),e.fillStyle=`rgb(112,82,46)`,e.fillRect(n+7,r+2,2,i-4),e.fillRect(n+2,r+7,i-4,2),e.fillStyle=`rgb(214,232,240)`;for(let t=0;t<3;t++)e.fillRect(n+3+t,r+6-t,1,1);for(let t=0;t<3;t++)e.fillRect(n+10+t,r+13-t,1,1)}function ff(e,t){Q(e,t,[72,104,168],8);let[n,r]=Xd(t);e.fillStyle=`rgb(54,80,132)`;for(let t=5;t<q.tilePx;t+=6)e.fillRect(n,r+t,q.tilePx,1),e.fillRect(n+t,r,1,q.tilePx)}function pf(e,t){Q(e,t,[178,54,48],8);let[n,r]=Xd(t);e.fillStyle=`rgb(140,40,36)`;for(let t=4;t<q.tilePx;t+=5)e.fillRect(n,r+t,q.tilePx,1)}function mf(e,t){Q(e,t,[242,238,228],4);let[n,r]=Xd(t),i=q.tilePx;e.fillStyle=`rgb(122,86,50)`,e.fillRect(n,r,i,2),e.fillRect(n,r+i-2,i,2),e.fillRect(n,r,2,i),e.fillRect(n+i-2,r,2,i)}function hf(e,t,n=[52,118,44]){Q(e,t,n,16);let[r,i]=Xd(t);for(let n=0;n<q.tilePx;n++)for(let a=0;a<q.tilePx;a++)Jd(a,n,t*97+13)<.22&&e.clearRect(r+a,i+n,1,1)}function gf(e,t,n,r){Q(e,t,[136,136,136],12);let[i,a]=Xd(t);e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`;for(let n=1;n<q.tilePx-2;n++)for(let r=1;r<q.tilePx-2;r++)Jd(r,n,t*131+17)<.07&&e.fillRect(i+r,a+n,2,2);let o=i+q.tilePx/2,s=a+q.tilePx/2;e.font=`bold 8px sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillStyle=`rgb(20,20,24)`,e.fillText(r,o+1,s+2),e.fillStyle=`rgb(244,244,248)`,e.fillText(r,o,s+1)}function _f(e,t){Q(e,t,[66,138,74],10);let[n,r]=Xd(t);e.fillStyle=`rgb(48,104,56)`;for(let t=2;t<q.tilePx;t+=4)e.fillRect(n+t,r,1,q.tilePx);e.fillStyle=`rgb(230,238,214)`;for(let i=1;i<q.tilePx;i+=3)for(let a=3;a<q.tilePx;a+=4)Jd(a,i,t*61+19)<.5&&e.fillRect(n+a,r+i,1,1)}function vf(e,t){Q(e,t,[96,168,100],8);let[n,r]=Xd(t),i=q.tilePx;e.fillStyle=`rgb(48,104,56)`,e.fillRect(n,r,i,1),e.fillRect(n,r+i-1,i,1),e.fillRect(n,r,1,i),e.fillRect(n+i-1,r,1,i)}function yf(e,t,n){let[r,i]=Xd(t),a=q.tilePx;e.clearRect(r,i,a,a);let o=r+(a>>1);e.fillStyle=`rgb(56,132,52)`,e.fillRect(o-1,i+(a>>1),2,a>>1),e.fillRect(o-3,i+a-5,2,2),e.fillRect(o+1,i+a-7,2,2),e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`,e.fillRect(o-3,i+2,6,6),e.fillRect(o-4,i+4,8,2),e.fillRect(o-2,i+1,4,8),e.fillStyle=`rgb(250,214,74)`,e.fillRect(o-1,i+4,2,2)}function bf(e,t,n=0){let[r,i]=Xd(t),a=q.tilePx;for(let o=0;o<a;o++)for(let s=0;s<a;s++){let a=Math.sin((s+o)*.9+n)*6,c=(Jd(s,o,t*7919+1)-.5)*2*8+a;e.fillStyle=`rgb(${Math.round(46+c)},${Math.round(108+c)},${Math.round(182+c)})`,e.fillRect(r+s,i+o,1,1)}}function xf(e,t){let n=e.image.getContext(`2d`);n&&(bf(n,J.agua,t%16*(Math.PI*2/16)),e.needsUpdate=!0)}function Sf(){let e=q.tilesPerRow*q.tilePx,t=document.createElement(`canvas`);t.width=e,t.height=e;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);Q(n,J.grassTop,[92,158,60],14),Q(n,J.grassSide,[121,88,58],12),Q(n,J.grassSide,[92,158,60],14,0,4),Q(n,J.dirt,[121,88,58],12),Q(n,J.stone,[136,136,136],12),Q(n,J.cobblestone,[120,120,120],20),Yd(n,J.cobblestone),Q(n,J.sand,[219,207,142],10),Q(n,J.logSide,[104,78,48],10),Zd(n,J.logSide),Q(n,J.logTop,[168,132,82],8),Qd(n,J.logTop),Q(n,J.planks,[172,136,86],8),$d(n,J.planks),Q(n,J.brick,[186,180,172],8),rf(n,J.brick),Q(n,J.gravel,[112,106,100],30),Q(n,J.bedrock,[42,42,46],24),Q(n,J.woolWhite,[232,232,230],6),Q(n,J.woolBlack,[38,38,42],6),Q(n,J.woolRed,[196,52,46],8),Q(n,J.woolOrange,[226,132,38],8),Q(n,J.woolYellow,[232,206,58],8),Q(n,J.woolGreen,[74,164,62],8),Q(n,J.woolBlue,[58,94,194],8),Q(n,J.woolPurple,[142,72,182],8),Q(n,J.sandstone,[214,198,146],8),ef(n,J.sandstone),Q(n,J.stoneBricks,[128,128,128],10),tf(n,J.stoneBricks),Q(n,J.snow,[240,244,248],5),Q(n,J.obsidian,[30,24,42],8),nf(n,J.obsidian),Q(n,J.woolPink,[226,140,170],8),Q(n,J.woolCyan,[70,178,190],8),Q(n,J.woolGray,[130,130,134],6),Q(n,J.woolBrown,[110,80,54],8),af(n,J.glass),hf(n,J.leaves),cf(n,J.cerca),lf(n,J.portaBaixo,!1),lf(n,J.portaCima,!0),uf(n,J.tocha),df(n,J.janela),ff(n,J.estofado),pf(n,J.colchao),mf(n,J.quadro),yf(n,J.florVermelha,[214,58,54]),yf(n,J.florAmarela,[242,206,62]),yf(n,J.florAzul,[86,122,220]),yf(n,J.florBranca,[238,240,246]),gf(n,J.minerioCarvao,[40,40,44],`C`),gf(n,J.minerioFerro,[216,162,122],`Fe`),gf(n,J.minerioOuro,[244,208,64],`Au`),gf(n,J.minerioDiamante,[108,226,222],`D`),Q(n,J.gramaSecaTop,[178,162,66],14),Q(n,J.gramaSecaSide,[121,88,58],12),Q(n,J.gramaSecaSide,[178,162,66],14,0,4),Q(n,J.gramaFriaTop,[96,138,116],12),Q(n,J.gramaFriaSide,[121,88,58],12),Q(n,J.gramaFriaSide,[96,138,116],12,0,4),Q(n,J.logIpe,[128,110,86],10),Zd(n,J.logIpe),Q(n,J.logAraucaria,[86,60,42],10),Zd(n,J.logAraucaria),Q(n,J.logPauBrasil,[124,66,46],10),Zd(n,J.logPauBrasil),hf(n,J.folhasIpe,[222,186,48]),hf(n,J.folhasAraucaria,[34,88,46]),hf(n,J.folhasPauBrasil,[42,130,54]),_f(n,J.mandacaruSide),vf(n,J.mandacaruTop),bf(n,J.agua);let i=[[232,232,230],[38,38,42],[196,52,46],[226,132,38],[232,206,58],[74,164,62],[58,94,194],[142,72,182],[226,140,170],[70,178,190],[130,130,134],[110,80,54]];for(let e=0;e<i.length;e++)of(n,J.vidroBranco+e,i[e]);for(let e=0;e<ju.letters.length;e++)sf(n,ju.base+e,ju.letters[e],[236,228,206]);for(let e=0;e<ju.digits.length;e++)sf(n,ju.base+ju.letters.length+e,ju.digits[e],[206,222,240]);let a=new Ni(t);return a.magFilter=r,a.minFilter=r,a.generateMipmaps=!1,a.colorSpace=ze,a}var Cf=.11,wf=3042486,Tf=class{scene;fog=new _n(wf,Cf);tint;submerso=!1;constructor(e){this.scene=e,this.tint=document.createElement(`div`),this.tint.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:1;opacity:0;transition:opacity .18s linear;background:rgba(38,104,170,.3)`,document.body.appendChild(this.tint)}update(e,t,n,r){let i=Ef(e,t,n,r);i!==this.submerso&&(this.submerso=i,this.scene.fog=i?this.fog:null,this.tint.style.opacity=i?`1`:`0`)}get estaSubmerso(){return this.submerso}};function Ef(e,t,n,r){let i=Math.floor(t),a=Math.floor(n),o=Math.floor(r),s=mu(e,i,a,o);return yl(s)?yl(mu(e,i,a+1,o))?!0:n-a<xl(s)/8*Bu:!1}var Df=new Set;function Of(e){Df.add(e)}function kf(e){for(let t of Df)t(e)}var Af=null,jf=null,Mf=.8;function Nf(){if(!Af)try{Af=new AudioContext,jf=Af.createGain(),jf.gain.value=Mf,jf.connect(Af.destination)}catch{return null}return Af.state===`suspended`&&Af.resume(),Af}function Pf(e){Mf=e,jf&&(jf.gain.value=e)}function Ff(e,t,n,r,i,a=0){if(!Af||!jf)return;let o=Af.currentTime+a/1e3,s=o+n/1e3,c=Af.createOscillator();c.type=r,c.frequency.setValueAtTime(e,o),c.frequency.exponentialRampToValueAtTime(Math.max(t,1),s);let l=Af.createGain();l.gain.setValueAtTime(0,o),l.gain.linearRampToValueAtTime(i,o+.008),l.gain.exponentialRampToValueAtTime(1e-4,s),c.connect(l).connect(jf),c.start(o),c.stop(s+.01)}function If(e){if(Nf())switch(e){case`click`:Ff(700,980,70,`triangle`,.22);break;case`back`:Ff(520,340,90,`triangle`,.2);break;case`confirm`:Ff(660,660,80,`sine`,.22),Ff(990,990,110,`sine`,.2,85);break;case`notify`:Ff(880,880,90,`sine`,.18),Ff(1175,1175,130,`sine`,.16,100);break;case`denied`:Ff(220,160,180,`sawtooth`,.15);break}}function Lf(e){Af&&If(e)}function Rf(e){Pf(e),window.addEventListener(`pointerdown`,()=>void Nf(),{capture:!0});let t=-1/0;Of(e=>{if(e.kind===`objective_complete`)t=performance.now(),Lf(`confirm`);else if(e.kind===`chat_message`){if(performance.now()-t<800)return;Lf(`notify`)}})}var zf=20260726,Bf=.75,Vf=24,Hf=96,Uf=18,Wf=-.25,Gf={raioRender:6,meshMsPorFrame:6,pixelRatioCap:1,fov:75};function Kf(e){if(!e.has(`bench`))return null;let t=Number(e.get(`bench`));return{duracaoS:Number.isFinite(t)&&t>=10?Math.min(t,300):30}}var qf=class e{duracaoS;trajeto;t0=0;rodando=!1;constructor(e,t){this.duracaoS=e,this.trajeto=t}static paraMundo(t,n,r){let i=Math.min(r.x,r.z)*16,a=Math.max(16,Math.min(Hf,i/2-16)),o=(e,t)=>Math.min(Math.max(e,a+8),Math.max(a+8,t*16-a-8));return new e(t,{centroX:+o(n.x,r.x).toFixed(2),centroZ:+o(n.z,r.z).toFixed(2),y:+(n.y+Vf).toFixed(2),raio:+a.toFixed(2)})}get ativo(){return this.rodando}iniciar(e){this.t0=e,this.rodando=!0}terminou(e){return this.rodando&&(e-this.t0)/1e3>=this.duracaoS}parar(){this.rodando=!1}pontoDoVoo(e){let{centroX:t,centroZ:n,raio:r}=this.trajeto,i=Uf*e/r,a=-Math.sin(i),o=Math.cos(i);return{x:t+Math.cos(i)*r,z:n+Math.sin(i)*r,yaw:Math.atan2(-a,-o)}}amostra(e){let t=Math.min((e-this.t0)/1e3,this.duracaoS),n=this.duracaoS*Bf;if(t<n){let e=this.pontoDoVoo(t);return{x:e.x,y:this.trajeto.y,z:e.z,yaw:e.yaw,pitch:Wf,fase:`voo`,t:+t.toFixed(2)}}let r=this.pontoDoVoo(n),i=(t-n)/(this.duracaoS-n)*Math.PI*2;return{x:r.x,y:this.trajeto.y,z:r.z,yaw:r.yaw+i,pitch:Wf,fase:`giro`,t:+t.toFixed(2)}}meta(){return{versaoTrajeto:1,duracaoS:this.duracaoS,seed:zf,trajeto:{...this.trajeto,fracaoVoo:Bf,velocidadeBlocosS:Uf,pitch:Wf},config:{...Gf},viewport:`${window.innerWidth}×${window.innerHeight}`,dpr:window.devicePixelRatio}}};function Jf(e,t,n){e.clearRect(0,0,t,t);let r=t*.28,i=t*.82,a=t*.2,o=t*.8,s=t*.32,c=t*.68;n&&(e.fillStyle=`#2e6fd6`,e.beginPath(),e.moveTo(a+t*.03,r+t*.03),e.lineTo(o-t*.03,r+t*.03),e.lineTo(c,i),e.lineTo(s,i),e.closePath(),e.fill()),e.strokeStyle=`#4a4a52`,e.fillStyle=n?`rgba(120,124,132,0.35)`:`#9a9ea8`,e.lineWidth=Math.max(1,t*.06),e.beginPath(),e.moveTo(a,r),e.lineTo(o,r),e.lineTo(c,i),e.lineTo(s,i),e.closePath(),n||e.fill(),e.stroke(),e.beginPath(),e.arc(t*.5,r,(o-a)/2,Math.PI,2*Math.PI),e.stroke()}function Yf(e,t){let n=q.tilePx,r=new Map,i=document.createElement(`canvas`);i.width=n,i.height=n;let a=i.getContext(`2d`);if(!a)return r;for(let o of t){if(Cl(o)){Jf(a,n,o===901),r.set(o,i.toDataURL());continue}let t=Fu(o),s=t%q.tilesPerRow*n,c=(t/q.tilesPerRow|0)*n;a.clearRect(0,0,n,n),a.drawImage(e,s,c,n,n,0,0,n,n),r.set(o,i.toDataURL())}return r}var Xf=[{id:`blocos`,label:`blocos`},{id:`vegetacao`,label:`vegetação`},{id:`mobilia`,label:`mobília`},{id:`minerios`,label:`minérios`},{id:`ferramentas`,label:`ferramentas`},{id:`glifos`,label:`letras e números`}],Zf=[...Array.from(ju.letters,(e,t)=>({id:K.LetterA+t,name:`letra ${e}`,cat:`glifos`})),...Array.from(ju.digits,(e,t)=>({id:K.Digit0+t,name:`número ${e}`,cat:`glifos`}))],Qf=[{id:K.Grass,name:`grama`,cat:`blocos`},{id:K.Stone,name:`pedra`,cat:`blocos`},{id:K.Cobblestone,name:`pedregulho`,cat:`blocos`},{id:K.Sand,name:`areia`,cat:`blocos`},{id:K.Dirt,name:`terra`,cat:`blocos`},{id:K.Log,name:`tronco`,cat:`vegetacao`},{id:K.Planks,name:`tábuas`,cat:`blocos`},{id:K.Brick,name:`tijolo`,cat:`blocos`},{id:K.Gravel,name:`cascalho`,cat:`blocos`},{id:K.Bedrock,name:`rocha-matriz`,cat:`blocos`},{id:K.WoolWhite,name:`lã branca`,cat:`blocos`},{id:K.WoolBlack,name:`lã preta`,cat:`blocos`},{id:K.WoolRed,name:`lã vermelha`,cat:`blocos`},{id:K.WoolOrange,name:`lã laranja`,cat:`blocos`},{id:K.WoolYellow,name:`lã amarela`,cat:`blocos`},{id:K.WoolGreen,name:`lã verde`,cat:`blocos`},{id:K.WoolBlue,name:`lã azul`,cat:`blocos`},{id:K.WoolPurple,name:`lã roxa`,cat:`blocos`},{id:K.Sandstone,name:`arenito`,cat:`blocos`},{id:K.StoneBricks,name:`pedra-lavrada`,cat:`blocos`},{id:K.Snow,name:`neve`,cat:`blocos`},{id:K.Obsidian,name:`obsidiana`,cat:`blocos`},{id:K.WoolPink,name:`lã rosa`,cat:`blocos`},{id:K.WoolCyan,name:`lã ciano`,cat:`blocos`},{id:K.WoolGray,name:`lã cinza`,cat:`blocos`},{id:K.WoolBrown,name:`lã marrom`,cat:`blocos`},{id:K.Glass,name:`vidro`,cat:`blocos`},{id:K.Leaves,name:`folhas`,cat:`vegetacao`},...Zf,{id:K.Cerca,name:`cerca`,cat:`mobilia`},{id:K.PortaXFechada,name:`porta`,cat:`mobilia`},{id:K.Tocha,name:`tocha`,cat:`mobilia`},{id:K.JanelaXFechada,name:`janela`,cat:`mobilia`},{id:K.Mesa,name:`mesa`,cat:`mobilia`},{id:K.CadeiraXP,name:`cadeira`,cat:`mobilia`},{id:K.SofaXP,name:`sofá`,cat:`mobilia`},{id:K.CamaXP,name:`cama`,cat:`mobilia`},{id:K.QuadroXP,name:`quadro`,cat:`mobilia`},...[`branco`,`preto`,`vermelho`,`laranja`,`amarelo`,`verde`,`azul`,`roxo`,`rosa`,`ciano`,`cinza`,`marrom`].map((e,t)=>({id:K.TapeteBranco+t,name:`tapete ${e}`,cat:`mobilia`})),...[`vermelha`,`amarela`,`azul`,`branca`].map((e,t)=>({id:K.FlorVermelha+t,name:`flor ${e}`,cat:`vegetacao`})),{id:K.MinerioCarvao,name:`minério de carvão`,cat:`minerios`},{id:K.MinerioFerro,name:`minério de ferro`,cat:`minerios`},{id:K.MinerioOuro,name:`minério de ouro`,cat:`minerios`},{id:K.MinerioDiamante,name:`minério de diamante`,cat:`minerios`},{id:K.GramaSeca,name:`grama seca`,cat:`blocos`},{id:K.GramaFria,name:`grama fria`,cat:`blocos`},{id:K.LogIpe,name:`tronco de ipê`,cat:`vegetacao`},{id:K.FolhasIpe,name:`folhas de ipê`,cat:`vegetacao`},{id:K.LogAraucaria,name:`tronco de araucária`,cat:`vegetacao`},{id:K.FolhasAraucaria,name:`folhas de araucária`,cat:`vegetacao`},{id:K.LogPauBrasil,name:`tronco de pau-brasil`,cat:`vegetacao`},{id:K.FolhasPauBrasil,name:`folhas de pau-brasil`,cat:`vegetacao`},{id:K.Mandacaru,name:`mandacaru`,cat:`vegetacao`},...[`branco`,`preto`,`vermelho`,`laranja`,`amarelo`,`verde`,`azul`,`roxo`,`rosa`,`ciano`,`cinza`,`marrom`].map((e,t)=>({id:K.VidroBranco+t,name:`vidro ${e}`,cat:`blocos`})),{id:K.LajePedraBaixo,name:`laje de pedra`,cat:`blocos`},{id:K.LajeTabuaBaixo,name:`laje de tábuas`,cat:`blocos`},{id:K.LajeTijoloBaixo,name:`laje de tijolo`,cat:`blocos`},{id:K.EscadaPedraXP,name:`escada de pedra`,cat:`blocos`},{id:K.EscadaTabuaXP,name:`escada de tábuas`,cat:`blocos`},{id:K.EscadaTijoloXP,name:`escada de tijolo`,cat:`blocos`},{id:901,name:`balde de água`,cat:`ferramentas`}];function $f(e){return e===`professor`?Qf:Qf.filter(e=>!nu(e.id))}var ep=class{icons;blocks;state;pick;select;onToggle;root=document.getElementById(`inventario`);isOpen=!1;cat=`blocos`;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t,n,r,i,a){this.icons=e,this.blocks=t,this.state=n,this.pick=r,this.select=i,this.onToggle=a,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&If(`click`)})}get open(){return this.isOpen}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}refresh(){this.isOpen&&this.render()}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`inventário de blocos`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`p`);i.className=`inv-dica`,i.textContent=`clique num bloco pra pôr no slot selecionado · 1–9 ou clique escolhem o slot`;let a=this.blocks(),o=document.createElement(`div`);o.className=`inv-abas`;for(let e of Xf){if(!a.some(t=>t.cat===e.id))continue;let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.cat?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.cat=e.id,this.render()}),o.appendChild(t)}let s=document.createElement(`div`);s.className=`inv-grid`;for(let e of a.filter(e=>e.cat===this.cat)){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-bloco`,t.title=e.name;let n=document.createElement(`img`);n.src=this.icons.get(e.id)??``,n.alt=e.name;let r=document.createElement(`small`);r.textContent=e.name,t.append(n,r),t.addEventListener(`click`,()=>{this.pick(e.id),this.render()}),s.appendChild(t)}let c=document.createElement(`div`);c.className=`inv-hotbar`;let{hotbar:l,selected:u}=this.state();l.forEach((e,t)=>{let n=document.createElement(`button`);n.type=`button`,n.className=`inv-slot`+(t===u?` sel`:``);let r=document.createElement(`small`);r.textContent=String(t+1);let i=document.createElement(`img`);i.src=this.icons.get(e)??``,i.alt=``,n.append(r,i),n.addEventListener(`click`,()=>{this.select(t),this.render()}),c.appendChild(n)}),e.append(t,i,o,s,c)}},tp=[`bloco`,`resetpin`,`regiao`,`objetivo`,`grupo`,`mundo`,`tp`,`tpr`,`tpa`,`iniciar`,`hora`,`ciclo`,`voo`,`confinar`,`kicar`,`claim`,`amigos`],np={regiao:[`criar`,`apagar`,`lista`,`encher`,`sortear`,`carimbar`],objetivo:[`add`,`lista`,`texto`,`mover`,`remover`,`modo`,`resetar`],grupo:[`criar`,`entrar`,`sair`,`lista`],mundo:[`lista`,`atual`,`carregar`],tp:[`grupos`],hora:[`dia`,`noite`,`amanhecer`,`entardecer`,`meio-dia`,`meia-noite`],ciclo:[`ligar`,`desligar`],voo:[`ligar`,`desligar`],confinar:[`ligar`,`desligar`,`status`],claim:[`ligar`,`desligar`,`criar`,`remover`,`lista`],amigos:[`convidar`,`aceitar`,`recusar`,`sair`,`expulsar`,`lista`]},rp=new Set([`kicar`,`resetpin`,`tpr`,`tpa`]),ip=new Set([`convidar`,`aceitar`,`recusar`,`expulsar`]),ap=[],op=[];function sp(e){ap=e}function cp(e){op=e}function lp(e,t){return e===`objetivo`&&t===`add`?[`construir`,`chegar`,`limpar`]:e===`objetivo`&&t===`modo`?[`sequencial`,`livre`]:e===`mundo`&&t===`carregar`?ap:e===`amigos`&&ip.has(t)?op:[]}function up(e){if(e.length===0)return tp.map(e=>`/${e}`);let t=(e[0]??``).replace(/^\//,``);return e.length===1?rp.has(t)?op:t===`tp`?[`grupos`,...op]:np[t]??[]:e.length===2?lp(t,e[1]??``):[]}var dp=1e4,fp=50,pp=class{onToggle;root=document.getElementById(`chat`);log=document.getElementById(`chat-log`);field=document.getElementById(`chat-input`);hint=document.getElementById(`chat-hint`);cycle=null;constructor(e,t){this.onToggle=t,this.field&&(this.field.maxLength=200,this.field.addEventListener(`keydown`,t=>{if(t.stopPropagation(),t.code===`Tab`){t.preventDefault(),this.autocomplete();return}if(t.code===`Enter`||t.key===`Enter`){let t=this.field?.value.trim()??``;t&&e(t),this.close()}else t.code===`Escape`?this.close():this.resetCycle()}))}get open(){return this.field!==null&&!this.field.classList.contains(`hidden`)}openInput(){this.field&&(this.field.value=``,this.resetCycle(),this.field.classList.remove(`hidden`),this.root?.classList.add(`open`),this.field.focus(),this.onToggle(!0))}close(){this.field&&(this.field.value=``,this.resetCycle(),this.field.classList.add(`hidden`),this.root?.classList.remove(`open`),this.field.blur(),this.onToggle(!1))}autocomplete(){let e=this.field;if(!e)return;let t=e.value;if(!t.startsWith(`/`))return;if(this.cycle&&t===this.cycle.produced&&this.cycle.matches.length>1){let t=this.cycle;t.index=(t.index+1)%t.matches.length,t.produced=t.base+t.matches[t.index],e.value=t.produced,this.showHint(t.matches,t.index);return}let n=/\s$/.test(t),r=t.replace(/\s+$/,``),i=r.length?r.split(/\s+/):[],a=n?i:i.slice(0,-1),o=n?``:i[i.length-1]??``,s=up(a).filter(e=>e.toLowerCase().startsWith(o.toLowerCase()));if(s.length===0){this.resetCycle();return}let c=a.length?`${a.join(` `)} `:``;s.length===1?(e.value=`${c}${s[0]} `,this.resetCycle()):(e.value=c+s[0],this.cycle={produced:e.value,matches:s,index:0,base:c},this.showHint(s,0))}showHint(e,t){this.hint&&(this.hint.textContent=``,e.forEach((e,n)=>{let r=document.createElement(`span`);r.textContent=e,n===t&&(r.className=`sel`),this.hint?.appendChild(r)}),this.hint.classList.remove(`hidden`))}resetCycle(){this.cycle=null,this.hint?.classList.add(`hidden`)}addMessage(e,t){if(!this.log)return;let n=document.createElement(`div`);for(n.className=`msg`,n.textContent=`<${e}> ${t}`,this.log.appendChild(n);this.log.childElementCount>fp;)this.log.firstElementChild?.remove();setTimeout(()=>n.classList.add(`old`),dp)}},mp=4,hp=8,gp=2,_p=class{onColapso;workers=[];carga=[];prontos=[];proximoId=1;dono=new Map;msTotal=0;profundidadeJogo;constructor(e,t){this.onColapso=e,this.profundidadeJogo=Math.max(1,t??gp);let n=navigator.hardwareConcurrency??4,r=Math.max(1,Math.min(mp,n-1));for(let e=0;e<r;e++)try{let e=new Worker(new URL(`/assets/meshWorker-Db8mqnIn.js`,``+import.meta.url),{type:`module`});e.onmessage=e=>{let t=e.data,n=this.dono.get(t.id);n!==void 0&&(this.carga[n]=Math.max(0,(this.carga[n]??0)-1),this.dono.delete(t.id)),this.msTotal+=t.ms,this.prontos.push(t)},e.onerror=()=>this.colapsar(),this.workers.push(e),this.carga.push(0)}catch{break}}get disponivel(){return this.workers.length>0}get emVoo(){return this.dono.size}get prontosPendentes(){return this.prontos.length}modoCarga=!0;get temVaga(){let e=this.modoCarga?hp:this.profundidadeJogo;return this.disponivel&&this.emVoo<this.workers.length*e}enviar(e){if(e.length!==Uu)throw Error(`vizinhança ${e.length} ≠ ${Uu}`);let t=0;for(let e=1;e<this.workers.length;e++)(this.carga[e]??0)<(this.carga[t]??0)&&(t=e);let n=this.proximoId++;return this.dono.set(n,t),this.carga[t]=(this.carga[t]??0)+1,this.workers[t].postMessage({id:n,viz:e},[e.buffer]),n}colher(){return this.prontos.shift()}colapsar(){let e=[...this.dono.keys()];for(let e of this.workers)e.terminate();this.workers=[],this.carga=[],this.dono.clear(),this.prontos=[],console.warn(`[mesh] pool de workers caiu — ${e.length} chunks voltam pro caminho síncrono`),this.onColapso?.(e)}encerrar(){for(let e of this.workers)e.terminate();this.workers=[],this.carga=[],this.dono.clear(),this.prontos=[]}},vp=64,yp={positions:new Float32Array,normals:new Float32Array,uvs:new Float32Array,indices:new Uint32Array,opaqueIndexCount:0,aguaIndexCount:0},bp=class{world;materials;scene;meshes=new Map;fila=[];filaSet=new Set;remeshCount=0;remeshMsTotal=0;lastRemeshMs=0;porCaminho={fila:{n:0,ms:0},bloco:{n:0,ms:0},area:{n:0,ms:0}};caminho=`bloco`;pool=null;versaoAtual=new Map;seq=0;emVoo=new Map;chavesEmVoo=new Set;sujosEmVoo=new Set;onFalha;get remeshWorkerMsTotal(){return this.pool?.msTotal??0}set modoCarga(e){this.pool&&(this.pool.modoCarga=e)}constructor(e,t,n,r=!0,i){if(this.world=e,this.materials=t,this.scene=n,r&&typeof Worker<`u`){let e=new _p(e=>{this.chavesEmVoo.clear(),this.sujosEmVoo.clear();for(let t of e){let e=this.emVoo.get(t);e&&this.enfileirar(e.cx,e.cy,e.cz)}this.emVoo.clear(),this.pool=null},i);this.pool=e.disponivel?e:null}}novaVersao(e){let t=++this.seq;return this.versaoAtual.set(e,t),t}trocarMundo(e,t=!0){for(let e of this.meshes.values())this.scene.remove(e),e.geometry.dispose();this.meshes.clear(),this.versaoAtual.clear(),this.fila.length=0,this.filaSet.clear(),this.sujosEmVoo.clear(),this.chavesEmVoo.clear(),this.world=e,t&&this.buildAll()}buildAll(){this.caminho=`fila`;for(let e=0;e<this.world.dims.y;e++)for(let t=0;t<this.world.dims.z;t++)for(let n=0;n<this.world.dims.x;n++)this.remesh(n,e,t)}remesh(e,t,n){let r=performance.now(),i=du(this.world,e,t,n);this.novaVersao(i);let a=qu(this.world,e,t,n);this.aplicar(i,e,t,n,a),this.contabilizar(performance.now()-r)}aplicar(e,t,n,r,i){let a=this.meshes.get(e);if(a&&(this.scene.remove(a),a.geometry.dispose(),this.meshes.delete(e)),i.indices.length===0)return;let o=new fr;o.setAttribute(`position`,new Zn(i.positions,3)),o.setAttribute(`normal`,new Zn(i.normals,3)),o.setAttribute(`uv`,new Zn(i.uvs,2)),o.setIndex(new Zn(i.indices,1));let s=i.opaqueIndexCount+i.aguaIndexCount;o.addGroup(0,i.opaqueIndexCount,0),o.addGroup(i.opaqueIndexCount,i.aguaIndexCount,1),o.addGroup(s,i.indices.length-s,2);let c=new ei(o,this.materials);c.position.set(t*16,n*16,r*16),this.scene.add(c),this.meshes.set(e,c)}contabilizar(e){this.lastRemeshMs=e,this.remeshMsTotal+=e,this.remeshCount++;let t=this.porCaminho[this.caminho];t.n++,t.ms+=e}remeshBox(e,t){this.caminho=`area`;let n=(e,t)=>Math.max(0,Math.min(Math.floor(e/16),t-1)),r=n(e.x-1,this.world.dims.x),i=n(t.x+1,this.world.dims.x),a=n(e.y-1,this.world.dims.y),o=n(t.y+1,this.world.dims.y),s=n(e.z-1,this.world.dims.z),c=n(t.z+1,this.world.dims.z);for(let e=a;e<=o;e++)for(let t=s;t<=c;t++)for(let n=r;n<=i;n++)this.remesh(n,e,t)}enfileirar(e,t,n){let r=du(this.world,e,t,n);if(!this.filaSet.has(r)){if(this.chavesEmVoo.has(r)){this.sujosEmVoo.add(r);return}this.filaSet.add(r),this.fila.push({cx:e,cy:t,cz:n})}}enfileirarColuna(e,t){let n=(e,t,n)=>this.enfileirar(e,t,n);for(let r=0;r<this.world.dims.y;r++)n(e,r,t);for(let[r,i]of[[1,0],[-1,0],[0,1],[0,-1]]){let a=e+r,o=t+i;if(!(a<0||o<0||a>=this.world.dims.x||o>=this.world.dims.z)&&this.world.chunks[du(this.world,a,0,o)])for(let e=0;e<this.world.dims.y;e++)n(a,e,o)}}processarFila(e,t){this.caminho=`fila`,this.onFalha=t;let n=performance.now()+e,r=0;if(this.pool){let e=this.pool.colher();for(;e&&r<vp;){let t=performance.now(),i=this.emVoo.get(e.id);if(this.emVoo.delete(e.id),i&&(this.chavesEmVoo.delete(i.key),this.sujosEmVoo.delete(i.key)&&this.enfileirar(i.cx,i.cy,i.cz),e.erro?(console.warn(`[mesh] chunk ${i.cx},${i.cy},${i.cz} falhou no worker: ${e.erro}`),this.onFalha?.(i.cx,i.cz)):this.versaoAtual.get(i.key)===i.versao&&this.aplicar(i.key,i.cx,i.cy,i.cz,{positions:e.positions,normals:e.normals,uvs:e.uvs,indices:e.indices,opaqueIndexCount:e.opaqueIndexCount,aguaIndexCount:e.aguaIndexCount}),this.contabilizar(i.msExtracao+(performance.now()-t))),++r>=1&&performance.now()>=n)break;e=this.pool.colher()}for(;this.fila.length>0&&this.pool.temVaga&&r<vp;){let e=this.fila.shift(),t=du(this.world,e.cx,e.cy,e.cz);this.filaSet.delete(t);let i=performance.now(),a=this.novaVersao(t),o;try{o=Ku(this.world,e.cx,e.cy,e.cz)}catch(t){console.warn(`[mesh] vizinhança ${e.cx},${e.cy},${e.cz} falhou:`,t),this.onFalha?.(e.cx,e.cz);continue}if(!o)this.aplicar(t,e.cx,e.cy,e.cz,yp),this.contabilizar(performance.now()-i);else{let n=this.pool.enviar(o);this.emVoo.set(n,{key:t,cx:e.cx,cy:e.cy,cz:e.cz,versao:a,msExtracao:performance.now()-i}),this.chavesEmVoo.add(t)}if(++r>=1&&performance.now()>=n)break}this.ultimoLote=r;return}for(;this.fila.length>0&&r<vp;){let e=this.fila.shift();this.filaSet.delete(du(this.world,e.cx,e.cy,e.cz));try{this.remesh(e.cx,e.cy,e.cz)}catch(n){console.warn(`[mesh] chunk ${e.cx},${e.cy},${e.cz} falhou:`,n),t?.(e.cx,e.cz)}if(++r>=1&&performance.now()>=n)break}this.ultimoLote=r}ultimoLote=0;get filaPendente(){return this.fila.length+(this.pool?.emVoo??0)+(this.pool?.prontosPendentes??0)}descartarColuna(e,t){for(let n=0;n<this.world.dims.y;n++){let r=du(this.world,e,n,t);this.versaoAtual.delete(r),this.sujosEmVoo.delete(r);let i=this.meshes.get(r);i&&(this.scene.remove(i),i.geometry.dispose(),this.meshes.delete(r))}}remeshBlock(e,t,n){this.caminho=`bloco`;let r=e/16|0,i=t/16|0,a=n/16|0;this.remesh(r,i,a);let o=e-r*16,s=t-i*16,c=n-a*16;o===0&&r>0&&this.remesh(r-1,i,a),o===15&&r<this.world.dims.x-1&&this.remesh(r+1,i,a),s===0&&i>0&&this.remesh(r,i-1,a),s===15&&i<this.world.dims.y-1&&this.remesh(r,i+1,a),c===0&&a>0&&this.remesh(r,i,a-1),c===15&&a<this.world.dims.z-1&&this.remesh(r,i,a+1)}},xp=(e,t,n,r,i)=>({hora:e,ceu:new U(t),sol:new U(n),solInt:r,ambInt:i}),Sp=[xp(0,263695,3819392,.14,.3),xp(4.5,660016,4544666,.18,.31),xp(5.5,2569582,8022682,.35,.34),xp(6.5,14715470,16763274,1.15,.44),xp(7.5,11062764,16772300,1.9,.5),xp(12,8900331,16777215,2.4,.55),xp(16.5,9421800,16774106,2.1,.51),xp(17.8,14260572,16760954,1.5,.46),xp(18.7,14248516,16747093,.9,.4),xp(19.6,1778768,4871568,.3,.33),xp(21,659494,3819392,.17,.3),xp(24,263695,3819392,.14,.3)],Cp=420,wp=460,Tp=400,Ep=new U,Dp=new U,Op=e=>Math.min(Math.max(e,0),1),kp=class{sun;ambient;scene;camera;hora=12;ciclo=!1;skyGroup=new ln;sunDisc;sunGlow;moonDisc;stars;sunMat;glowMat;moonMat;starsMat;constructor(e,t,n,r){this.sun=e,this.ambient=t,this.scene=n,this.camera=r,this.sunMat=new Hr({color:16768875,transparent:!0,depthWrite:!1}),this.sunDisc=new ei(new Ri(30,24),this.sunMat),this.glowMat=new Hr({color:16756816,transparent:!0,opacity:.28,depthWrite:!1,blending:2}),this.sunGlow=new ei(new Ri(52,24),this.glowMat),this.moonMat=new Hr({color:14673650,transparent:!0,depthWrite:!1}),this.moonDisc=new ei(new Ri(20,24),this.moonMat);let i=new Float32Array(Tp*3),a=20260719,o=()=>(a=Math.imul(a,1664525)+1013904223>>>0,a/4294967296);for(let e=0;e<Tp;e++){let t=o()*2-1,n=o()*Math.PI*2,r=Math.sqrt(1-t*t);i[e*3]=Math.cos(n)*r*wp,i[e*3+1]=t*wp,i[e*3+2]=Math.sin(n)*r*wp}let s=new fr;s.setAttribute(`position`,new Zn(i,3)),this.starsMat=new Ti({color:15922431,size:2,sizeAttenuation:!1,transparent:!0,opacity:0,depthWrite:!1}),this.stars=new Ai(s,this.starsMat),this.skyGroup.add(this.sunDisc,this.sunGlow,this.moonDisc,this.stars),n.add(this.skyGroup)}sync(e,t){Number.isFinite(e)&&(this.hora=(e%24+24)%24),this.ciclo=t}update(e){this.ciclo&&(this.hora=(this.hora+e*24/cu)%24),this.apply()}apply(){let e=this.hora,t=Sp[0],n=Sp[Sp.length-1];for(let r=0;r<Sp.length-1;r++)if(e>=Sp[r].hora&&e<=Sp[r+1].hora){t=Sp[r],n=Sp[r+1];break}let r=n.hora-t.hora||1,i=Op((e-t.hora)/r);i=i*i*(3-2*i),Ep.copy(t.ceu).lerp(n.ceu,i),this.scene.background.copy(Ep),Dp.copy(t.sol).lerp(n.sol,i),this.sun.color.copy(Dp),this.sun.intensity=t.solInt+(n.solInt-t.solInt)*i,this.ambient.intensity=t.ambInt+(n.ambInt-t.ambInt)*i;let a=(e-6)/12*Math.PI,o=Math.cos(a),s=Math.sin(a);this.sun.position.set(o*100,Math.max(s*100,-40),40),this.skyGroup.position.copy(this.camera.position);let c=Math.hypot(o,s,.35),l=o/c*Cp,u=s/c*Cp,d=.35/c*Cp;this.sunDisc.position.set(l,u,d),this.sunGlow.position.set(l,u,d),this.moonDisc.position.set(-l,-u,d),this.sunDisc.lookAt(this.camera.position),this.sunGlow.lookAt(this.camera.position),this.moonDisc.lookAt(this.camera.position);let f=Op((s+.14)/.28);this.sunMat.opacity=f,this.glowMat.opacity=.28*f,this.sunDisc.visible=this.sunGlow.visible=f>0;let p=Op((-s+.14)/.28);this.moonMat.opacity=.92*p,this.moonDisc.visible=p>0;let m=Op((-s-.08)/.3);this.starsMat.opacity=m,this.stars.visible=m>0,this.stars.rotation.z=a*.5}},Ap=class{worker;stats={msgsIn:0,msgsOut:0,bytesIn:0,bytesOut:0};cb=null;savePending=null;constructor(e){this.worker=e,e.onmessage=e=>{let t=e.data;if(typeof t==`string`)this.stats.msgsIn++,this.stats.bytesIn+=t.length,this.cb?.(t);else if(t instanceof ArrayBuffer)this.stats.msgsIn++,this.stats.bytesIn+=t.byteLength,this.cb?.(t);else if(typeof t==`object`&&t){let e=t;e.hostType===`save`&&e.data instanceof ArrayBuffer&&(this.savePending?.(e.data),this.savePending=null)}}}init(e){this.worker.postMessage({hostType:`init`,save:e.save,seed:e.seed,preset:e.preset,tamanho:e.tamanho})}requestSave(){return new Promise(e=>{this.savePending=e,this.worker.postMessage({hostType:`save_request`})})}send(e){this.stats.msgsOut++,this.stats.bytesOut+=e.length,this.worker.postMessage(e)}onMessage(e){this.cb=e}},jp=class{aoFalhar;stats={msgsIn:0,msgsOut:0,bytesIn:0,bytesOut:0};cb=null;socket;queue=[];avisouFalha=!1;constructor(e,t){this.aoFalhar=t,this.socket=new WebSocket(e),this.socket.binaryType=`arraybuffer`,this.socket.onopen=()=>{for(let e of this.queue)this.socket.send(e);this.queue=[]},this.socket.onmessage=e=>{let t=e.data;typeof t==`string`?(this.stats.msgsIn++,this.stats.bytesIn+=t.length,this.cb?.(t)):t instanceof ArrayBuffer&&(this.stats.msgsIn++,this.stats.bytesIn+=t.byteLength,this.cb?.(t))},this.socket.onclose=()=>{console.warn(`[conn] conexão com ${e} fechou`),this.falhou(`a conexão com o servidor caiu`)},this.socket.onerror=()=>{this.falhou(`não deu pra falar com o servidor`)}}falhou(e){this.avisouFalha||(this.avisouFalha=!0,this.aoFalhar?.(e))}send(e){this.stats.msgsOut++,this.stats.bytesOut+=e.length,this.socket.readyState===WebSocket.OPEN?this.socket.send(e):this.socket.readyState===WebSocket.CONNECTING&&this.queue.push(e)}onMessage(e){this.cb=e}},Mp=120,Np=250,Pp=1e4,Fp=[8,16,33,50,100],Ip=60,Lp=240;function Rp(e){let t=Array(Fp.length+1).fill(0);for(let n of e){let e=Fp.findIndex(e=>n<=e);e<0&&(e=Fp.length),t[e]++}let n=e.length||1;return t.map((e,t)=>({faixa:t<Fp.length?`≤${Fp[t]}ms`:`>${Fp[Fp.length-1]}ms`,frames:e,pct:+(e/n*100).toFixed(1)}))}var zp=()=>({frames:0,tempoMs:0,renderMs:0,longTasks:0,longTasksMs:0}),Bp=class{renderer;meta;net={msgsPerSec:0,bytesPerSec:0,tickAvgMs:0,tickMaxMs:0,jitterMs:0};fase=`carregando`;contexto=null;stream={colunas:0,fila:0,faltando:0,repedidas:0,ultimoLote:0};regras=null;carga=null;extra=null;frameTimes=[];remesh={count:0,totalMs:0,lastMs:0};lastRefresh=0;recording=null;gpuCache;sessionStartMs=performance.now();longTasks=0;longTasksMs=0;porFase={carregando:zp(),jogando:zp()};pioresTravadas=[];marcadores=[];gpuExt;gpuQueries=[];gpuAtiva=null;gpuSamples=[];contextLost=0;batteryMgr=null;el;textEl;constructor(e,t){this.renderer=e,this.meta=t;let n=document.getElementById(`hud`),r=document.getElementById(`hud-text`),i=document.getElementById(`hud-export`);if(!n||!r||!i)throw Error(`elementos do HUD ausentes no index.html`);this.el=n,this.textEl=r,i.addEventListener(`click`,()=>this.record(e=>this.baixar(e)));try{new PerformanceObserver(e=>{for(let t of e.getEntries()){this.longTasks++,this.longTasksMs+=t.duration;let e=this.porFase[this.fase];e.longTasks++,e.longTasksMs+=t.duration,this.pioresTravadas.push({ms:+t.duration.toFixed(1),fase:this.fase,emS:+((performance.now()-this.sessionStartMs)/1e3).toFixed(1)}),this.pioresTravadas.sort((e,t)=>t.ms-e.ms),this.pioresTravadas.length=Math.min(this.pioresTravadas.length,5)}}).observe({entryTypes:[`longtask`]})}catch{}e.domElement.addEventListener(`webglcontextlost`,()=>{this.contextLost++}),navigator.getBattery?.().then(e=>{this.batteryMgr=e}).catch(()=>{})}get visible(){return!this.el.classList.contains(`hidden`)}toggle(){this.el.classList.toggle(`hidden`)}setFase(e){this.fase=e}setRemesh(e){this.remesh={...e}}marcar(e,t){this.marcadores.length>=Ip||this.marcadores.push({emS:+((performance.now()-this.sessionStartMs)/1e3).toFixed(1),fase:this.fase,evento:e,...t?{detalhe:t}:{}})}gpuInicio(){if(!(!this.recording&&!this.visible))try{let e=this.renderer.getContext();if(!(e instanceof WebGL2RenderingContext))return;if(this.gpuExt===void 0){let t=e.getExtension(`EXT_disjoint_timer_query_webgl2`);this.gpuExt=t??null}if(!this.gpuExt||this.gpuAtiva||this.gpuQueries.length>=4)return;let t=e.createQuery();if(!t)return;e.beginQuery(this.gpuExt.TIME_ELAPSED_EXT,t),this.gpuAtiva=t}catch{this.desligarGpu()}}gpuFim(){if(!(!this.gpuAtiva||!this.gpuExt))try{this.renderer.getContext().endQuery(this.gpuExt.TIME_ELAPSED_EXT),this.gpuQueries.push(this.gpuAtiva),this.gpuAtiva=null}catch{this.desligarGpu()}}desligarGpu(){this.gpuExt=null,this.gpuQueries.length=0,this.gpuAtiva=null}gpuColher(){if(!(!this.gpuExt||this.gpuQueries.length===0))try{let e=this.renderer.getContext();if(e.getParameter(this.gpuExt.GPU_DISJOINT_EXT)){for(let t of this.gpuQueries)e.deleteQuery(t);this.gpuQueries.length=0;return}let t=[];for(let n of this.gpuQueries){if(!e.getQueryParameter(n,e.QUERY_RESULT_AVAILABLE)){t.push(n);continue}let r=e.getQueryParameter(n,e.QUERY_RESULT);e.deleteQuery(n);let i=r/1e6;this.gpuSamples.push(i),this.gpuSamples.length>Lp&&this.gpuSamples.shift(),this.recording?.gpuSamples.push(i)}this.gpuQueries=t}catch{this.desligarGpu()}}gpuStats(e){if(this.gpuExt===null||e.length===0)return null;let t=[...e].sort((e,t)=>e-t);return{medioMs:+(e.reduce((e,t)=>e+t,0)/e.length).toFixed(2),p95Ms:+(t[Math.min(t.length-1,Math.floor(t.length*.95))]??0).toFixed(2),amostras:e.length}}frame(e,t=0){this.frameTimes.push(e),this.frameTimes.length>Mp&&this.frameTimes.shift();let n=this.porFase[this.fase];n.frames++,n.tempoMs+=e,n.renderMs+=t;let r=performance.now();if(this.gpuColher(),this.recording){this.recording.frames.push(e);let t=this.memoryUsedMB();if(t!==null&&this.recording.memSamples.push(t),r>=this.recording.endAt){let e=this.recording;this.recording=null,e.onDone(this.buildRecordingReport(e))}}this.visible&&r-this.lastRefresh>=Np&&(this.lastRefresh=r,this.refresh())}record(e,t=Pp){this.recording||(this.recording={frames:[],memSamples:[],gpuSamples:[],endAt:performance.now()+t,onDone:e,longTasksStart:this.longTasks,longTasksMsStart:this.longTasksMs,contextoStart:this.contexto?.()??null,marcadoresStart:this.marcadores.length},this.visible||this.toggle(),this.refresh())}frameStats(){let e=this.frameTimes;if(e.length===0)return{fps:0,avgMs:0,p95Ms:0};let t=e.reduce((e,t)=>e+t,0)/e.length,n=[...e].sort((e,t)=>e-t),r=n[Math.min(n.length-1,Math.floor(n.length*.95))]??0;return{fps:1e3/t,avgMs:t,p95Ms:r}}memoriaJs(){let e=performance.memory;return e?{usadaMB:Math.round(e.usedJSHeapSize/1048576),limiteMB:Math.round(e.jsHeapSizeLimit/1048576)}:null}memoryUsedMB(){return this.memoriaJs()?.usadaMB??null}gpu(){if(this.gpuCache!==void 0)return this.gpuCache;try{let e=this.renderer.getContext(),t=e.getExtension(`WEBGL_debug_renderer_info`);this.gpuCache=t?String(e.getParameter(t.UNMASKED_RENDERER_WEBGL)):null}catch{this.gpuCache=null}return this.gpuCache}dispositivo(){let e=navigator;return{nucleos:e.hardwareConcurrency??null,ramGB:e.deviceMemory??null,dpr:window.devicePixelRatio,tela:`${window.screen.width}×${window.screen.height}`,gpu:this.gpu(),bateria:this.batteryMgr?{nivelPct:Math.round(this.batteryMgr.level*100),carregando:this.batteryMgr.charging}:null}}conexao(){let e=navigator.connection;return e?{tipo:e.effectiveType??null,downlinkMbps:e.downlink??null,rttMs:e.rtt??null}:null}setMeta(e){this.meta={...this.meta,...e}}stats(){let{fps:e,avgMs:t,p95Ms:n}=this.frameStats(),r=this.renderer.info;return{versao:qd,timestamp:new Date().toISOString(),userAgent:navigator.userAgent,meta:this.meta,...this.contexto?(()=>{let e=this.contexto();return{jogador:{x:+e.x.toFixed(1),y:+e.y.toFixed(1),z:+e.z.toFixed(1),yaw:+e.yaw.toFixed(2),pitch:+e.pitch.toFixed(2),voando:e.voando,noChao:e.noChao,chunk:{cx:Math.floor(e.x/16),cz:Math.floor(e.z/16)}},config:{raioRender:e.raioRender,meshMsPorFrame:e.meshMsPorFrame,pixelRatioCap:e.pixelRatioCap,fov:e.fov}}})():{},fps:Math.round(e),frametimeAvgMs:+t.toFixed(2),frametimeP95Ms:+n.toFixed(2),drawCalls:r.render.calls,triangles:r.render.triangles,points:r.render.points,lines:r.render.lines,remeshCount:this.remesh.count,remeshPorCaminho:this.remesh.porCaminho??null,remeshTotalMs:+this.remesh.totalMs.toFixed(1),remeshWorkerMs:+(this.remesh.workerMs??0).toFixed(1),remeshLastMs:+this.remesh.lastMs.toFixed(2),longTasksTotal:this.longTasks,fases:Object.keys(this.porFase).map(e=>{let t=this.porFase[e];return{fase:e,segundos:+(t.tempoMs/1e3).toFixed(1),frames:t.frames,fpsMedio:t.tempoMs>0?Math.round(t.frames/(t.tempoMs/1e3)):0,renderMsMedio:t.frames>0?+(t.renderMs/t.frames).toFixed(2):0,renderPct:t.tempoMs>0?Math.round(t.renderMs/t.tempoMs*100):0,longTasks:t.longTasks,longTasksMs:+t.longTasksMs.toFixed(1)}}),pioresTravadas:this.pioresTravadas,marcadores:this.marcadores,carga:this.carga?.()??null,gpu:this.gpuStats(this.gpuSamples),longTasksMsTotal:+this.longTasksMs.toFixed(1),contextLost:this.contextLost,sessaoS:Math.round((performance.now()-this.sessionStartMs)/1e3),memoriaJsMB:this.memoriaJs(),video:{geometrias:r.memory.geometries,texturas:r.memory.textures},stream:{...this.stream},regrasServidor:this.regras,rede:this.conexao(),dispositivo:this.dispositivo(),net:{...this.net}}}buildRecordingReport(e){let{frames:t,memSamples:n}=e,r=this.stats(),i=t.length;if(i===0)return{...r,gravacao:{duracaoS:0,frames:0}};let a=[...t].sort((e,t)=>e-t),o=t.reduce((e,t)=>e+t,0),s=e=>a[Math.min(i-1,Math.floor(i*e))]??0,c=o/1e3,l=e.contextoStart,u=this.contexto?.()??null,d=l&&u?(()=>{let e=u.distanciaTotal-l.distanciaTotal,t=c>0?e/c:0;return{estado:u.voando?`voando`:t>.5?`andando`:`parado`,distanciaBlocos:+e.toFixed(1),velocidadeBlocosS:+t.toFixed(2),colunasNovas:u.colunasRecebidas-l.colunasRecebidas,bytesRecebidos:u.bytesRecebidos-l.bytesRecebidos}})():null;return{...r,gravacao:{duracaoS:+c.toFixed(1),frames:i,movimento:d,fpsMedio:Math.round(i/(o/1e3)),frametimeMs:{min:+(a[0]??0).toFixed(2),med:+(o/i).toFixed(2),p50:+s(.5).toFixed(2),p95:+s(.95).toFixed(2),p99:+s(.99).toFixed(2),max:+(a[i-1]??0).toFixed(2)},framesLentos50ms:t.filter(e=>e>50).length,framesLentos100ms:t.filter(e=>e>100).length,histogramaMs:Rp(t),gpu:this.gpuStats(e.gpuSamples),marcadores:this.marcadores.slice(e.marcadoresStart),longTasks:this.longTasks-e.longTasksStart,longTasksMs:+(this.longTasksMs-e.longTasksMsStart).toFixed(1),memoriaMB:n.length?{min:Math.min(...n),max:Math.max(...n),med:Math.round(n.reduce((e,t)=>e+t,0)/n.length)}:null}}}refresh(){let e=this.stats(),t=e.memoriaJsMB,n=[`FPS ${e.fps}  frame ${e.frametimeAvgMs}ms méd / ${e.frametimeP95Ms}ms p95`,`draw calls ${e.drawCalls}  triângulos ${e.triangles}  long tasks ${e.longTasksTotal}×`,`remesh ${e.remeshCount}× / ${e.remeshTotalMs}ms main / ${e.remeshWorkerMs??0}ms worker / ${e.remeshLastMs}ms último`,`stream ${e.stream.colunas} colunas · fila ${e.stream.fila} · faltando ${e.stream.faltando} · repedidas ${e.stream.repedidas}`,`malha ${e.stream.ultimoLote} chunks no último frame (orçamento ${e.config?.meshMsPorFrame??`?`} ms)`,e.remeshPorCaminho?`remesh por caminho: fila ${e.remeshPorCaminho.fila.n}× (${Math.round(e.remeshPorCaminho.fila.ms)}ms) · bloco ${e.remeshPorCaminho.bloco.n}× (${Math.round(e.remeshPorCaminho.bloco.ms)}ms) · área ${e.remeshPorCaminho.area.n}× (${Math.round(e.remeshPorCaminho.area.ms)}ms)`:`remesh por caminho: n/d`,`fase ${this.fase} · ${e.fases.map(e=>`${e.fase} ${e.segundos}s ${e.fpsMedio}fps render ${e.renderPct}% travadas ${e.longTasks}×/${Math.round(e.longTasksMs)}ms`).join(` · `)}`,e.gpu?`GPU ${e.gpu.medioMs}ms méd / ${e.gpu.p95Ms}ms p95 (${e.gpu.amostras} amostras)`:`GPU: n/d (sem EXT_disjoint_timer_query_webgl2)`,e.regrasServidor?`regras (servidor) ${e.regrasServidor.celulasPorTick} cél/tick (máx ${e.regrasServidor.celulasMaxTick}) · ${e.regrasServidor.mudancasPorTick} mudanças · água ${e.regrasServidor.aguaPorTick}`:`regras (servidor): n/d`,t?`RAM (JS) ${t.usadaMB}/${t.limiteMB} MB`:`RAM (JS): n/d (só no Chrome)`,`vídeo ${e.video.geometrias} geometrias · ${e.video.texturas} texturas`,`rede ${e.net.msgsPerSec} msg/s  ${e.net.bytesPerSec} B/s  jitter ${e.net.jitterMs}ms  tick ${e.net.tickAvgMs}/${e.net.tickMaxMs}ms`];if(this.extra&&n.push(this.extra()),this.recording){let e=Math.max(0,Math.ceil((this.recording.endAt-performance.now())/1e3));n.push(`⏺ GRAVANDO perfil de 10 s… faltam ${e}s`)}this.textEl.textContent=n.join(`
`)}baixar(e,t=`perf`){let n=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),r=document.createElement(`a`);r.href=URL.createObjectURL(n),r.download=`perf-${t===`perf`?``:`${t}-`}${new Date().toISOString().replace(/[:.]/g,`-`)}.json`,r.click(),URL.revokeObjectURL(r.href)}},Vp=class e{canvas;yaw=0;pitch=0;sensitivity=1;touch=!1;keys=new Set;keyHandlers=new Map;mouseHandlers=new Map;wheelHandler=null;static SENSITIVITY=.0025;static TOUCH_LOOK=.004;static PITCH_LIMIT=Math.PI/2-.01;static MAX_DELTA=200;mouseStats={maxDelta:0,dropped:0,lastDropped:0};constructor(t){this.canvas=t,window.addEventListener(`keydown`,e=>{if(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement)return;let t=this.keyHandlers.get(e.code);if(t){e.preventDefault(),t();return}this.keys.add(e.code)}),window.addEventListener(`keyup`,e=>this.keys.delete(e.code)),window.addEventListener(`blur`,()=>this.keys.clear()),t.addEventListener(`contextmenu`,e=>e.preventDefault()),t.addEventListener(`mousedown`,e=>{this.locked&&(e.button===1&&e.preventDefault(),this.mouseHandlers.get(e.button)?.())}),t.addEventListener(`wheel`,e=>{this.locked&&(e.preventDefault(),this.wheelHandler?.(e.deltaY>0?1:-1))},{passive:!1}),t.addEventListener(`click`,()=>this.lock()),document.addEventListener(`mousemove`,t=>{if(!this.locked)return;let n=Math.max(Math.abs(t.movementX),Math.abs(t.movementY));if(n>this.mouseStats.maxDelta&&(this.mouseStats.maxDelta=n),n>e.MAX_DELTA){this.mouseStats.dropped++,this.mouseStats.lastDropped=n,console.warn(`[input] spike de mouse descartado: ${t.movementX},${t.movementY}`);return}this.yaw-=t.movementX*e.SENSITIVITY*this.sensitivity,this.pitch-=t.movementY*e.SENSITIVITY*this.sensitivity;let r=e.PITCH_LIMIT;this.pitch>r&&(this.pitch=r),this.pitch<-r&&(this.pitch=-r)})}get locked(){return document.pointerLockElement===this.canvas}get active(){return this.locked||this.touch}lock(){this.touch||this.locked||this.canvas.requestPointerLock({unadjustedMovement:!0})?.catch(()=>this.canvas.requestPointerLock())}down(e){return this.keys.has(e)}setKey(e,t){t?this.keys.add(e):this.keys.delete(e)}applyLook(t,n){this.yaw-=t*e.TOUCH_LOOK*this.sensitivity,this.pitch-=n*e.TOUCH_LOOK*this.sensitivity;let r=e.PITCH_LIMIT;this.pitch>r&&(this.pitch=r),this.pitch<-r&&(this.pitch=-r)}press(e){this.mouseHandlers.get(e)?.()}onKey(e,t){this.keyHandlers.set(e,t)}rebind(e,t){if(e===t)return;let n=this.keyHandlers.get(e);n&&(this.keyHandlers.delete(e),this.keyHandlers.set(t,n))}onMouseButton(e,t){this.mouseHandlers.set(e,t)}onWheel(e){this.wheelHandler=e}},Hp=2e4,Up=54,Wp=2*Math.PI*Up,Gp=`
#load-tela {
...
`;function Kp(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function qp(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function Jp(e){return`${(e/1e3).toFixed(1)} s`}var Yp=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=Gp,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(Wp*.25).toFixed(1)} ${Wp.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,Wp.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(Wp*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=Jp(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${Jp(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=Kp(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=qp(n.bytes)}e.forcar.classList.toggle(`hidden`,o<Hp||this.fase===`pronto`)}},Xp={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`}},Zp={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`},Qp=`lj-config`;function $p(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function em(){let e=null;try{e=JSON.parse(localStorage.getItem(Qp)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...Xp.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:$p(t.sensitivity,Xp.sensitivity,.2,3),fov:$p(t.fov,Xp.fov,60,100),pixelRatioCap:$p(t.pixelRatioCap,Xp.pixelRatioCap,1,2),volume:$p(t.volume,Xp.volume,0,1),raioRender:$p(t.raioRender,Xp.raioRender,2,12),meshMsPorFrame:$p(t.meshMsPorFrame,Xp.meshMsPorFrame,1,16),uiScale:$p(t.uiScale,Xp.uiScale,.6,1.8),keys:r}}function tm(e){localStorage.setItem(Qp,JSON.stringify(e))}function nm(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var rm=`logica-em-jogo`,im=`worlds`;function am(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var om=null;function sm(){return om??=new Promise((e,t)=>{let n=indexedDB.open(rm,1);n.onupgradeneeded=()=>{n.result.createObjectStore(im,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),om}async function cm(){return(await am((await sm()).transaction(im).objectStore(im).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function lm(e){await am((await sm()).transaction(im,`readwrite`).objectStore(im).put(e))}async function um(e){await am((await sm()).transaction(im,`readwrite`).objectStore(im).delete(e))}function dm(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function fm(e){let t=await e.arrayBuffer();Wd(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function pm(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function mm(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var hm=`
#touch-ui { --ts: 1; }
...
`,gm=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=hm,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.tapButton(`⛶`,`tela cheia`,()=>mm()),this.tapButton(`📊`,`hud`,()=>this.actions.hud())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){this.root.style.setProperty(`--ts`,String(e))}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},_m=`lj-nome`;function vm(){let e=localStorage.getItem(_m),t=e?_u(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(_m,t),t}function ym(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function bm(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function xm(e){document.getElementById(e)?.classList.add(`hidden`)}function Sm(e){let t=ym(`menu`),n={home:ym(`menu-home`),worlds:ym(`menu-worlds`),multi:ym(`menu-multi`),config:ym(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),ym(`menu-version`).textContent=`v${qd}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&If(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),bm(`menu-erro`,i));let a=ym(`menu-nome`);a.value=vm(),a.addEventListener(`change`,()=>{let e=_u(a.value);localStorage.setItem(_m,e),a.value=e}),ym(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),ym(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),ym(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=ym(`menu-world-list`);async function c(){let e=[];try{e=await cm()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>dm(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){um(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=ym(`menu-new-nome`),u=ym(`menu-new-tipo`);ym(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){bm(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}xm(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:wu(u.value),tamanho:Tu(ym(`menu-new-tamanho`).value)})});let d=ym(`menu-import-file`);ym(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&fm(e).then(async e=>{await lm(e),await c(),xm(`menu-worlds-erro`)}).catch(e=>{bm(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=ym(`menu-endereco`),p=ym(`menu-pin`),m=ym(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,ym(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){bm(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){bm(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}xm(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),Cm(ym(`menu-config-body`),void 0,()=>r(`home`))}function Cm(e,t,n){Em(e,t,n)}function wm(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var Tm=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function Em(e,t,n){e.textContent=``;for(let r of Tm){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>Dm(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{tm(structuredClone(Xp)),t?.(),Em(e,t,n)}),e.appendChild(r),n&&wm(e,n)}function Dm(e,t,n,r){e.textContent=``;let i=em(),a=()=>{tm(i),n?.()},o=document.createElement(`h2`);o.textContent=Tm.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),pm()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(Zp)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=Zp[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=nm(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=nm(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Pf(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>If(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`tempo de montagem de malha por frame`,1,16,1,i.meshMsPorFrame,e=>i.meshMsPorFrame=e,e=>`${e} ms`)}wm(e,()=>Em(e,n,r))}var Om=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},km=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&If(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},Am=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&If(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},jm=class extends Am{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(Qf[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=vu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=vu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...Qf.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},Mm=class extends Am{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},Nm=class{fixedColor;group=new ln;cornerMarks=[];boxes=[];constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new wi(new Ui(new Li(1.01,1.01,1.01)),new fi({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new wi(new Ui(new Li(n+.04,r+.04,i+.04)),new fi({color:this.fixedColor??new U().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a})}},Pm=1/16,Fm=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*Pm-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*Pm-.004,ry:Math.PI}];function Im(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var Lm=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(pd(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=pd(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=mu(t,e.x,e.y,e.z);if(!Il(r))return;let i=Fm[r-K.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,Im(a,e,null);let o=new Ni(a);o.colorSpace=ze;let s=new ei(new Wi(12*Pm,12*Pm),new Hr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{Im(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=pd(e,t,n);if(this.conteudos.has(a))if(!Il(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Il(mu(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function Rm(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var zm=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,Rm(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},Bm=null;function Vm(e){e.preventDefault(),e.returnValue=``}var Hm=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function Um(e){Bm?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||Hm.has(e.code))&&e.preventDefault())}function Wm(e){Bm?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function Gm(e){Bm||(Bm=e,window.addEventListener(`beforeunload`,Vm),window.addEventListener(`keydown`,Um,!0),window.addEventListener(`keyup`,Wm,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function Km(){Bm=null,window.removeEventListener(`beforeunload`,Vm),window.removeEventListener(`keydown`,Um,!0),window.removeEventListener(`keyup`,Wm,!0),navigator.keyboard?.unlock?.()}var qm=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Ni(t);i.minFilter=o,this.material=new vr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[du(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===K.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===K.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===K.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Mr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function Jm(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&sp(n)}var Ym=new _l({antialias:!0});Ym.setPixelRatio(Math.min(window.devicePixelRatio,2)),Ym.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Ym.domElement);var Xm=new vn;Xm.background=new U(8900331);var Zm=new Ma(75,window.innerWidth/window.innerHeight,.1,512);Zm.rotation.order=`YXZ`;var Qm=new Fa(16777215,2.2);Qm.position.set(60,100,40);var $m=new Ia(16777215,.55);Xm.add(Qm,$m);var eh=new kp(Qm,$m,Xm,Zm),th=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();th!==null&&eh.sync(th,!1);var $=new Vp(Ym.domElement),nh=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},rh=nh(`yaw`),ih=nh(`pitch`);rh!==null&&($.yaw=rh),ih!==null&&($.pitch=ih);var ah=Kf(new URLSearchParams(location.search));function oh(){let e=ah?{...em(),...Gf}:em();return $.sensitivity=e.sensitivity,Zm.fov=e.fov,Zm.updateProjectionMatrix(),Ym.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Pf(e.volume),sh?.setScale(e.uiScale),e}var sh=null,ch=oh();Rf(ch.volume);var lh=null,uh=null,dh=null,fh=new Yp(()=>{xh(),hh?.setFase(`jogando`),hh?.marcar(`carga concluída`),ph?.()}),ph=null,mh=!1,hh=null,gh=document.getElementById(`overlay`),_h=document.getElementById(`overlay-main`),vh=document.getElementById(`overlay-config`),yh=document.getElementById(`crosshair`);function bh(){_h?.classList.remove(`hidden`),vh?.classList.add(`hidden`)}function xh(){let e=(lh?.open??!1)||(uh?.open??!1)||(dh?.open??!1);gh?.classList.toggle(`hidden`,mh||fh.ativo||$.active||Ah.open||e),yh?.classList.toggle(`hidden`,!$.active),$.locked&&bh(),sh?.setShown($.touch&&!Ah.open&&!e&&!fh.ativo)}document.addEventListener(`pointerlockchange`,xh);function Sh(){pm()?($.touch=!0,mm(),xh()):$.lock()}function Ch(){let e=ch.keys;ch=oh();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],ch.keys[t]);Th()}var wh=-1;function Th(){if(!Eh||ch.raioRender===wh)return;let e=wh;wh=ch.raioRender,Eh.send(JSON.stringify({type:`radius`,chunks:wh})),hh?.marcar(`raio`,`${e<0?`join`:e} → ${wh}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Sh()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Cm(e,Ch,bh),_h?.classList.add(`hidden`),vh?.classList.remove(`hidden`)}),gh?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&If(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{Zm.aspect=window.innerWidth/window.innerHeight,Zm.updateProjectionMatrix(),Ym.setSize(window.innerWidth,window.innerHeight)});var Eh=null,Dh=`?`,Oh=null;function kh(){return new URLSearchParams(location.search).get(`nome`)??vm()}var Ah=new pp(e=>Eh?.send(JSON.stringify({type:`chat`,text:e})),e=>{xh(),e||$.lock()});xh(),Ym.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Ah.open&&Ah.close()});var jh={tickAvgMs:0,tickMaxMs:0},Mh=null,Nh=0,Ph=[];function Fh(){let e=performance.now();Nh>0&&(Ph.push(e-Nh),Ph.length>300&&Ph.shift()),Nh=e}function Ih(){let e=Ph.length;if(e<2)return 0;let t=Ph.reduce((e,t)=>e+t,0)/e,n=Ph.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var Lh=!1,Rh=null,zh=null,Bh=null,Vh=null,Hh=null,Uh=null,Wh=null,Gh=`aluno`,Kh=!1,qh=!1;function Jh(){return Gh===`professor`||Kh}var Yh=[],Xh=null,Zh=!1,Qh=[],$h=null,eg=null,tg=null,ng=new Om,rg=null,ig=null,ag=null,og=[],sg=new Set,cg=!1,lg=null,ug=null,dg=!1,fg=new Map;function pg(){lh?.update({regions:Yh,modo:rg?.modo??`sequencial`,objetivos:rg?.objetivos??[],grupos:og,myGrupo:ag})}function mg(e){return e.porGrupo&&Gh!==`professor`?ag===null?!1:e.porGrupo.find(e=>e.grupo===ag)?.completo??!1:e.completo}function hg(e){if(rg){for(let t of rg.objetivos)mg(t)?sg.has(t.id)||(sg.add(t.id),e&&cg&&kf({kind:`objective_complete`})):sg.delete(t.id);cg=!0,ng.update(rg.modo,rg.objetivos,{grupo:ag,professor:Gh===`professor`,painelKey:nm(ch.keys.painel)}),ig?.(rg.objetivos)}}var gg=null;function _g(){let e=gg;if(e){gg=null;for(let t of e)yg(t)}}function vg(){gg||(gg=[],requestAnimationFrame(()=>requestAnimationFrame(_g)),setTimeout(_g,500))}function yg(e){if(gg){gg.push(e);return}if(Fh(),Lh||fh.setFase(`mundo`),typeof e==`string`){let t=Pd(e);if(!t)return;t.type===`debug_stats`?(jh={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},Mh=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0}):t.type===`block_changed`?Rh?.(t):t.type===`blocks_filled`?zh?.(t):t.type===`player_moved`?(t.name&&fg.get(t.id)!==t.name&&(fg.set(t.id,t.name),cp([...new Set(fg.values())])),Bh?.(t)):t.type===`player_left`?(fg.delete(t.id),cp([...new Set(fg.values())]),Vh?.(t.id)):t.type===`spawn`?(Wh={x:t.x,y:t.y,z:t.z},Gh=t.papel??`aluno`):t.type===`regions`?(Yh=t.regions,Xh?.(t.regions),pg()):t.type===`objectives`?(rg={modo:t.modo,objetivos:t.objetivos},hg(!0),pg()):t.type===`group`?(ag=t.grupo,sg.clear(),hg(!1),pg()):t.type===`groups`?(og=t.grupos,pg()):t.type===`quadros`?eg?.(t.lista):t.type===`quadro_changed`?tg?.(t):t.type===`claims`?(Zh=t.ativo,Qh=t.claims,$h?.(t.claims)):t.type===`friends`||(t.type===`players`?dh?.update({conectados:t.conectados,banidos:t.banidos}):t.type===`mundo_trocando`?(Hh?.(t.nome),vg()):t.type===`teleport`?Uh?.(t):t.type===`time`?th===null&&eh.sync(t.hora,t.ciclo):t.type===`voo`?(Kh=t.liberado,Jh()||(qh=!1),Ah.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(If(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),Km(),location.href=location.pathname):t.type===`join_denied`?(If(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),Km(),location.href=location.pathname):t.type===`chat`&&(Ah.addMessage(t.author,t.text),t.author===`servidor`&&Jm(t.text),kf({kind:`chat_message`})));return}let t=Rd(e);if(t===809716300){ug?.(e);return}let n=()=>(dg=t===Id,dg?zd(e):Fd(e));if(Lh){lg?.(n());return}Lh=!0,Eg(n())}function bg(e,t){ch=oh(),Eh=e,fh.abrir({host:Dh,rede:!(e instanceof Ap)}),fh.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),xh(),e.onMessage(yg),$.onKey(ch.keys.chat,()=>{Ah.open||(document.exitPointerLock(),Ah.openInput())}),e.send(JSON.stringify({type:`join`,name:kh(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),wh=-1,Th()}function xg(e,t){Dh=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),bg(new jp(e,t=>{Lh||!fh.ativo||fh.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function Sg(e,t){Oh={id:e.id,name:e.name,createdAt:e.createdAt},Dh=`web-worker (${e.name})`;let n=new Ap(new Worker(new URL(`/assets/worker-70lg6efm.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho}),bg(n)}async function Cg(){if(!(Eh instanceof Ap)||!Oh)return;let e=await Eh.requestSave();await lm({...Oh,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{Km(),Cg().finally(()=>location.reload())});var wg=new URLSearchParams(location.search),Tg=wg.get(`server`);if(Tg){let e=wg.get(`codigo`);xg(Tg,{pin:wg.get(`pin`)??``,...e?{codigo:e}:{}})}else ah?Sg({id:`bench-${zf}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:Tu(wg.get(`tamanho`)??`E`)},zf):Sm({onPlayWorld:Sg,onPlayMulti:xg});function Eg(e){let t=Eh;if(!t)return;Gm(()=>$.active);let n=e.world,r=e.seed,i=dg,a=new Set,s=0,c=new Map,l=0,u=0,d=0,f=Sf(),p=new ta({map:f,alphaTest:.5}),m=new ta({map:f,transparent:!0,opacity:.72,depthWrite:!1}),h=new ta({map:f,transparent:!0,opacity:.4,depthWrite:!1});if(new URLSearchParams(location.search).has(`atlas`)){let e=p.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let g=new URLSearchParams(location.search),_=g.has(`semworker`),v=Number(g.get(`meshdepth`)),y=new bp(n,[p,m,h],Xm,!_,Number.isFinite(v)&&v>0?v:void 0),b=new Tf(Xm),x=0,S=-1;i||y.buildAll(),ug=e=>{let t=[];try{t=Vd(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;a.add(t),c.delete(t),y.enfileirarColuna(e,r),w.varrerColuna(n,e,r)}u+=t.length};let C=(e,r,i)=>{let o=n.dims,s=ch.raioRender,u=0;for(let d=e-s;d<=e+s;d++)for(let e=r-s;e<=r+s;e++){if(d<0||e<0||d>=o.x||e>=o.z)continue;let r=e*o.x+d;if(a.has(r))continue;let s=c.get(r);if(!s){c.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||u>=4)){y.descartarColuna(d,e),w.descartarColuna(d,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+d]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:d,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),u++,l++}}for(let t of c.keys()){let n=t%o.x,i=(t-n)/o.x;(a.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&c.delete(t)}},w=new qm(Xm);w.setFromWorld(n);let T=new Nm(Xm);T.setRegions(Yh),Xh=e=>{T.setRegions(e),T.clearCorners()};let E=new Nm(Xm,16747546),D=e=>{E.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};D(Qh),$h=e=>{D(e),T.clearCorners(),!Zh&&Gh!==`professor`&&_e&&(_e=!1),xe()};let ee=new Lm(Xm),te=new zm;eg=e=>ee.setAll(e,n),tg=e=>ee.aplicar(e,n);let O=new Nm(Xm,3066993),ne=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=ag!==null&&r.grupo===ag;(Gh===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});O.setRegions(t)};ig=ne,rg&&ne(rg.objetivos);let k=e=>t.send(JSON.stringify({type:`chat`,text:e})),A=e=>{e?document.exitPointerLock():$.lock(),xh()};Gh===`professor`&&(dh=new km(k,A)),lh=Gh===`professor`?new jm(k,A,()=>{lh?.hide(),uh?.hide(),dh?.show()}):new Mm(k,A),pg(),$.onKey(ch.keys.painel,()=>{if(!Ah.open){if(Gh!==`professor`&&og.length===0){Ah.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}uh?.hide(),dh?.hide(),lh?.toggle()}}),Gh===`professor`&&Ah.addMessage(`jogo`,`tecla ${nm(ch.keys.painel)} abre o painel de autoria`);let re=Wh??{x:n.sizeX/2+.5,y:gu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},j=$u(re.x,re.y,re.z),M=()=>{if(!i)return 0;let e=ch.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(j.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(j.pos.z/16))),a=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,o=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,a*o)},ie=M(),ae=()=>{fh.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:a.size,total:ie,faltando:c.size>0?c.size:Math.max(0,ie-a.size),fila:y.filaPendente}))};ae(),fh.setFase(i?`mundo`:`malha`),Hh=e=>{ie=0,fh.abrir({host:Dh,rede:!(t instanceof Ap),titulo:`trocando de aula`,alvo:e}),ae(),fh.setFase(`preparando`),we.setFase(`carregando`),we.marcar(`troca de aula`,e),xh()};function oe(){j.pos.x=re.x,j.pos.y=re.y,j.pos.z=re.z,j.vel.x=j.vel.y=j.vel.z=0}lg=e=>{n=e.world,r=e.seed,i=dg,a=new Set,c.clear(),y.trocarMundo(n,!i),w.setFromWorld(n),Yh=[],T.setRegions([]),T.clearCorners(),ee.setAll([],n),rg=null,ig?.([]),ng.update(`livre`,[],{grupo:null,professor:Gh===`professor`,painelKey:nm(ch.keys.painel)}),sg.clear(),cg=!1,og=[],ag=null,pg(),re=Wh??re,oe(),Ah.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),wh=-1,Th(),we.setMeta({worldChunks:n.dims,worldSeed:e.seed}),ie=M(),fh.abrir({host:Dh,rede:!(t instanceof Ap),titulo:`trocando de aula`}),ae(),fh.setFase(i?`mundo`:`malha`),we.setFase(`carregando`),xh(),i||fh.concluir()},Uh=e=>{j.pos.x=e.x,j.pos.y=e.y,j.pos.z=e.z,j.vel.x=j.vel.y=j.vel.z=0,$.yaw=rh??e.yaw,$.pitch=ih??e.pitch},Rh=e=>{hu(n,e.x,e.y,e.z,e.blockId),y.remeshBlock(e.x,e.y,e.z),w.onBlockChanged(e.x,e.y,e.z,e.blockId),ee.onBlockChanged(e.x,e.y,e.z,e.blockId,n),kf(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},zh=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)hu(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};y.remeshBox(t,r),w.onRegionFilled(t,r,e.blockId),ee.validarTodos(n),kf(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let se=new Map,ce=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Ni(t);i.minFilter=o;let a=new Mr(new vr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Z.height/2+.35,0),a},le=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};Bh=e=>{let t=se.get(e.id);if(!t){let n=new ei(new Li(Z.width,Z.height,Z.width),new ta({color:new U().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Z.height/2,e.z),n.rotation.y=e.yaw,Xm.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},se.set(e.id,t)}e.name&&e.name!==t.labelName&&(le(t),t.label=ce(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Z.height/2,e.z),t.targetYaw=e.yaw},Vh=e=>{let t=se.get(e);t&&(le(t),Xm.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),se.delete(e))};let ue=new wi(new Ui(new Li(1,1,1)),new fi({color:0}));ue.visible=!1,Xm.add(ue);let N=null,de=new V,fe=`lj-hotbar`,pe=$f(Gh),me=()=>pe.slice(0,9).map(e=>e.id),he=(()=>{let e=new Set(pe.map(e=>e.id));e.add(900);let t=me();try{let n=JSON.parse(localStorage.getItem(fe)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),ge=0,_e=!1,ve=document.getElementById(`hotbar`),ye=Yf(p.map?.image,[...Qf.map(e=>e.id),900]),be=e=>e===900?`balde vazio`:e===901?`balde de água`:Qf.find(t=>t.id===e)?.name??`?`,xe=()=>{if(!ve)return;if(_e){ve.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${Gh===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=he.map((e,t)=>`<span class="slot${t===ge?` sel`:``}"><small>${t+1}</small><img src="${ye.get(e)??``}" alt=""></span>`).join(``);ve.innerHTML=`<span class="bar-nome">${be(he[ge]??K.Grass)}</span><span class="slots">${e}</span>`,uh?.refresh()};xe();let Se=()=>{Gh!==`professor`&&!Zh||(_e=!_e,xe())};$.onKey(ch.keys.varinha,Se);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{ge=e,xe()});$.onWheel(e=>{ge=(ge+e+he.length)%he.length,xe()}),uh=new ep(ye,()=>pe,()=>({hotbar:he,selected:ge}),e=>{he[ge]=e,localStorage.setItem(fe,JSON.stringify(he)),xe()},e=>{ge=e,xe()},e=>{e?(lh?.hide(),dh?.hide(),document.exitPointerLock()):$.lock(),xh()}),$.onKey(ch.keys.inventario,()=>{Ah.open||uh?.toggle()});let Ce=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),T.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(N){if(_e){Ce(1,N);return}Cl(he[ge]??-1)||t.send(JSON.stringify({type:`break_block`,x:N.x,y:N.y,z:N.z}))}}),$.onMouseButton(2,()=>{if(!N)return;if(_e){Ce(2,N);return}{let e=he[ge];if(Cl(e??-1)){if(e===901)t.send(JSON.stringify({type:`balde`,x:N.x+N.nx,y:N.y+N.ny,z:N.z+N.nz,encher:!1})),he[ge]=900;else{if(mu(n,N.x,N.y,N.z)!==K.Agua)return;t.send(JSON.stringify({type:`balde`,x:N.x,y:N.y,z:N.z,encher:!0})),he[ge]=901}localStorage.setItem(fe,JSON.stringify(he)),xe();return}}if(Il(mu(n,N.x,N.y,N.z))){let{x:e,y:n,z:r}=N;te.open(ee.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(Ql(mu(n,N.x,N.y,N.z))){t.send(JSON.stringify({type:`use_block`,x:N.x,y:N.y,z:N.z}));return}let e=he[ge];if(e!==void 0){if((e===K.PortaXFechada||e===K.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.PortaXFechada:K.PortaZFechada),(e===K.JanelaXFechada||e===K.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.JanelaXFechada:K.JanelaZFechada),Ll(e)||Rl(e)||zl(e)||Il(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Ll(e)?K.CadeiraXP:Rl(e)?K.SofaXP:zl(e)?K.CamaXP:K.QuadroXP)+r}if(El(e)){let t=e-+!!Dl(e);e=N.ny<0?t+1:t}if(kl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Nl(Ml(e),r,N.ny<0)}t.send(JSON.stringify({type:`place_block`,x:N.x+N.nx,y:N.y+N.ny,z:N.z+N.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!N||_e)return;let e=mu(n,N.x,N.y,N.z);Wl(e)&&(e=K.PortaXFechada),Jl(e)&&(e=K.JanelaXFechada),Ll(e)&&(e=K.CadeiraXP),Rl(e)&&(e=K.SofaXP),zl(e)&&(e=K.CamaXP),Il(e)&&(e=K.QuadroXP),El(e)&&(e=K.LajePedraBaixo+Ol(e)*2),kl(e)&&(e=K.EscadaPedraXP+Ml(e)*8),tu(e)&&(nu(e)&&Gh!==`professor`||(he[ge]=e,localStorage.setItem(fe,JSON.stringify(he)),xe()))});let we=new Bp(Ym,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Dh});hh=we,we.contexto=()=>({x:j.pos.x,y:j.pos.y,z:j.pos.z,yaw:$.yaw,pitch:$.pitch,voando:qh&&Jh(),noChao:j.onGround,raioRender:ch.raioRender,meshMsPorFrame:ch.meshMsPorFrame,pixelRatioCap:ch.pixelRatioCap,fov:ch.fov,distanciaTotal:d,colunasRecebidas:u,bytesRecebidos:t.stats.bytesIn}),we.setRemesh({count:y.remeshCount,totalMs:y.remeshMsTotal,workerMs:y.remeshWorkerMsTotal,lastMs:y.lastRemeshMs,porCaminho:y.porCaminho}),we.carga=()=>fh.relatorio(),we.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Te=null;if(ah){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);Ah.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{we.baixar(e,`bench`),Ah.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-bench-*.json)`)}};ph=()=>{if(Te)return;Te=qf.paraMundo(ah.duracaoS,re,n.dims),we.setMeta({bench:Te.meta()}),we.marcar(`bench: início`,`${ah.duracaoS}s · raio ${Te.trajeto.raio}`),mh=!0,qh=!0,xh(),Te.iniciar(performance.now());let t=Te.amostra(performance.now());j.pos.x=Ae=t.x,j.pos.y=je=t.y,j.pos.z=Me=t.z,we.record(t=>{mh=!1,xh(),window.__benchPerfil=t,e(t)},ah.duracaoS*1e3)}}$.onKey(ch.keys.hud,()=>we.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{we.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),pm()&&(ve&&(ve.style.pointerEvents=`auto`,ve.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(ge=n,xe())})),sh=new gm($,{keys:()=>ch.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>uh?.toggle(),chat:()=>{Ah.open||(document.exitPointerLock(),Ah.openInput())},menu:()=>{$.touch=!1,bh(),xh()},hud:()=>we.toggle(),varinha:()=>Se()}),sh.setScale(ch.uiScale),xh()),we.extra=()=>{let e=$.mouseStats,t=j.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=Au(i,a,r),s=iu(o),c=au(o),l=Math.min(ku(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&o.temp<.6?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===K.GramaSeca?`grama seca`:c===K.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se temp<0.60 · chapada ≥85]\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let Ee={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},De=0;setInterval(()=>{let e={x:j.pos.x,y:j.pos.y,z:j.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==Ee.x||e.y!==Ee.y||e.z!==Ee.z||e.yaw!==Ee.yaw||e.pitch!==Ee.pitch,r=performance.now();!n&&r-De<2e3||(Ee=e,De=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof Ap&&Oh&&!ah&&(Cg(),setInterval(()=>void Cg(),3e4));let Oe={...t.stats};setInterval(()=>{let e=t.stats;we.net={msgsPerSec:e.msgsIn+e.msgsOut-(Oe.msgsIn+Oe.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(Oe.bytesIn+Oe.bytesOut),tickAvgMs:jh.tickAvgMs,tickMaxMs:jh.tickMaxMs,jitterMs:Ih()},we.regras=Mh,we.stream={colunas:a.size,fila:y.filaPendente,faltando:c.size,repedidas:l,ultimoLote:y.ultimoLote},Oe={...e}},1e3);let ke=performance.now(),Ae=j.pos.x,je=j.pos.y,Me=j.pos.z,Ne=!1,Pe=!1,P=0,Fe=!1,Ie=0,Le=Z.eyeHeight,F=0;Ym.setAnimationLoop(()=>{let e=performance.now(),t=e-ke;ke=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(ch.keys.forward)-+!!$.down(ch.keys.back):0,c=$.active?!!$.down(ch.keys.right)-+!!$.down(ch.keys.left):0,l=$.active&&$.down(ch.keys.jump),u=$.active&&$.down(ch.keys.forward);u&&!Pe&&(e-P<300&&(Ne=!0),P=e),u||(Ne=!1),Pe=u;let p=$.active&&$.down(ch.keys.agachar),m=o>0&&!p&&(Ne||$.active&&$.down(ch.keys.correr));l&&!Fe&&(Jh()&&e-Ie<300&&(qh=!qh),Ie=e),Fe=l;let h=qh&&Jh(),g=!0;if(i){y.modoCarga=fh.ativo,y.processarFila(ch.meshMsPorFrame,(e,t)=>{a.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(j.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(j.pos.z/16)));if(g=a.has(r*n.dims.x+t),(s=(s+1)%60)==0){for(let e of a){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>ch.raioRender+2){a.delete(e),y.descartarColuna(i,o),w.descartarColuna(i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}C(t,r,e)}fh.ativo&&a.size>=ie&&y.filaPendente===0&&fh.concluir()}if(Te?.ativo){let t=Te.amostra(e);j.pos.x=t.x,j.pos.y=t.y,j.pos.z=t.z,j.vel.x=j.vel.y=j.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Te.terminou(e)&&(Te.parar(),we.marcar(`bench: fim`))}let _=j.pos.y;g&&!Te?.ativo&&ud(n,j,{forward:o,strafe:c,jump:l,yaw:$.yaw,sprint:m,sneak:p,fly:h},r);let v=j.pos.y-_;j.onGround&&!h&&v>.01&&v<=.56&&(F=Math.min(F+v,Zu)),F*=Math.exp(-r*14),F<.002&&(F=0),d+=Math.hypot(j.pos.x-Ae,j.pos.y-je,j.pos.z-Me),Ae=j.pos.x,je=j.pos.y,Me=j.pos.z,j.pos.y<-16&&oe();let T=1-Math.exp(-r*12);for(let e of se.values()){e.mesh.position.lerp(e.target,T);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*T}let E=1-Math.exp(-r*20);Le+=((p&&!h?Z.sneakEyeHeight:Z.eyeHeight)-Le)*E;let D=ch.fov*(j.sprinting?1.1:1);if(Math.abs(Zm.fov-D)>.01&&(Zm.fov+=(D-Zm.fov)*E,Zm.updateProjectionMatrix()),Zm.position.set(j.pos.x,j.pos.y+Le-F,j.pos.z),Zm.rotation.set($.pitch,$.yaw,0),Zm.getWorldDirection(de),N=$.active?fd(n,Zm.position.x,Zm.position.y,Zm.position.z,de.x,de.y,de.z,5,he[ge]===900):null,ue.visible=N!==null,N){let[e,t,r,i,a,o]=Iu(mu(n,N.x,N.y,N.z));ue.position.set(N.x+(e+i)/2,N.y+(t+a)/2,N.z+(r+o)/2),ue.scale.set(i-e+.004,a-t+.004,o-r+.004)}we.setRemesh({count:y.remeshCount,totalMs:y.remeshMsTotal,workerMs:y.remeshWorkerMsTotal,lastMs:y.lastRemeshMs,porCaminho:y.porCaminho}),eh.update(r),b.update(n,Zm.position.x,Zm.position.y,Zm.position.z),x+=r;let ee=Math.floor(x*8)%16;ee!==S&&(S=ee,xf(f,ee));let te=performance.now();we.gpuInicio(),Ym.render(Xm,Zm),we.gpuFim(),we.frame(t,performance.now()-te)}),i||fh.concluir(),wg.has(`hud`)&&we.toggle(),new URLSearchParams(location.search).has(`painel`)&&lh?.toggle(),new URLSearchParams(location.search).has(`inv`)&&uh?.toggle(),wg.has(`touch`)&&Sh()}