...
}`)},e.needsUpdate=!0}function zm(){return{ventoTempo:{value:0},ventoDir:{value:new H(1,0)},ventoForca:{value:0}}}function Bm(){return{nivelCeu:{value:1},luzMin:{value:.05}}}function Vm(e,t){let n=e.onBeforeCompile;e.onBeforeCompile=(r,i)=>{n?.call(e,r,i),r.uniforms.nivelCeu=t.nivelCeu,r.uniforms.luzMin=t.luzMin,r.vertexShader=r.vertexShader.replace(`#include <common>`,`#include <common>
attribute float luz;
...
`;function ih(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function ah(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function oh(e){return`${(e/1e3).toFixed(1)} s`}var sh=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=rh,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(nh*.25).toFixed(1)} ${nh.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,nh.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(nh*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=oh(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${oh(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=ih(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=ah(n.bytes)}e.forcar.classList.toggle(`hidden`,o<eh||this.fase===`pronto`)}},ch={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`}},lh={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`},uh=`lj-config`;function dh(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function fh(e,t){return typeof e==`boolean`?e:t}function ph(){let e=null;try{e=JSON.parse(localStorage.getItem(uh)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...ch.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:dh(t.sensitivity,ch.sensitivity,.2,3),fov:dh(t.fov,ch.fov,60,100),pixelRatioCap:dh(t.pixelRatioCap,ch.pixelRatioCap,1,2),volume:dh(t.volume,ch.volume,0,1),raioRender:dh(t.raioRender,ch.raioRender,2,12),meshMsPorFrame:dh(t.meshMsPorFrame,ch.meshMsPorFrame,1,16),uiScale:dh(t.uiScale,ch.uiScale,.6,1.8),nuvens:fh(t.nuvens,ch.nuvens),balanco:fh(t.balanco,ch.balanco),keys:r}}function mh(e){localStorage.setItem(uh,JSON.stringify(e))}function hh(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var gh=`logica-em-jogo`,_h=`worlds`;function vh(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var yh=null;function bh(){return yh??=new Promise((e,t)=>{let n=indexedDB.open(gh,1);n.onupgradeneeded=()=>{n.result.createObjectStore(_h,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),yh}async function xh(){return(await vh((await bh()).transaction(_h).objectStore(_h).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function Sh(e){await vh((await bh()).transaction(_h,`readwrite`).objectStore(_h).put(e))}async function Ch(e){await vh((await bh()).transaction(_h,`readwrite`).objectStore(_h).delete(e))}function wh(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function Th(e){let t=await e.arrayBuffer();jf(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function Eh(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function Dh(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var Oh=`
:root { --ts: 1; }
...
`,kh=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Oh,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.tapButton(`⛶`,`tela cheia`,()=>Dh()),this.tapButton(`📊`,`hud`,()=>this.actions.hud())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){document.documentElement.style.setProperty(`--ts`,String(e))}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},Ah=`lj-nome`;function jh(){let e=localStorage.getItem(Ah),t=e?yu(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(Ah,t),t}function Mh(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function Nh(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function Ph(e){document.getElementById(e)?.classList.add(`hidden`)}function Fh(e){let t=Mh(`menu`),n={home:Mh(`menu-home`),worlds:Mh(`menu-worlds`),multi:Mh(`menu-multi`),config:Mh(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),Mh(`menu-version`).textContent=`v${Pf}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Op(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),Nh(`menu-erro`,i));let a=Mh(`menu-nome`);a.value=jh(),a.addEventListener(`change`,()=>{let e=yu(a.value);localStorage.setItem(Ah,e),a.value=e}),Mh(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),Mh(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),Mh(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=Mh(`menu-world-list`);async function c(){let e=[];try{e=await xh()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>wh(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){Ch(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=Mh(`menu-new-nome`),u=Mh(`menu-new-tipo`);Mh(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){Nh(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}Ph(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:Eu(u.value),tamanho:Du(Mh(`menu-new-tamanho`).value)})});let d=Mh(`menu-import-file`);Mh(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&Th(e).then(async e=>{await Sh(e),await c(),Ph(`menu-worlds-erro`)}).catch(e=>{Nh(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=Mh(`menu-endereco`),p=Mh(`menu-pin`),m=Mh(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,Mh(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){Nh(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){Nh(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}Ph(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),Ih(Mh(`menu-config-body`),void 0,()=>r(`home`))}function Ih(e,t,n){zh(e,t,n)}function Lh(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var Rh=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function zh(e,t,n){e.textContent=``;for(let r of Rh){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>Bh(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{mh(structuredClone(ch)),t?.(),zh(e,t,n)}),e.appendChild(r),n&&Lh(e,n)}function Bh(e,t,n,r){e.textContent=``;let i=ph(),a=()=>{mh(i),n?.()},o=document.createElement(`h2`);o.textContent=Rh.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),Eh()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(lh)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=lh[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=hh(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=hh(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Ep(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>Op(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t);let r=(t,n,r)=>{let i=document.createElement(`label`);i.className=`config-row`,i.textContent=`${t} `;let o=document.createElement(`input`);o.type=`checkbox`,o.checked=n,o.addEventListener(`change`,()=>{r(o.checked),a()}),i.appendChild(o),e.appendChild(i)};r(`nuvens no céu`,i.nuvens,e=>i.nuvens=e),r(`balanço de folhas e grama`,i.balanco,e=>i.balanco=e),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`tempo de montagem de malha por frame`,1,16,1,i.meshMsPorFrame,e=>i.meshMsPorFrame=e,e=>`${e} ms`)}Lh(e,()=>zh(e,n,r))}var Vh=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},Hh=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Op(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},Uh=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Op(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},Wh=class extends Uh{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(Gp[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=bu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=bu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...Gp.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},Gh=class extends Uh{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},Kh=class{fixedColor;group=new sn;cornerMarks=[];boxes=[];constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Si(new Vi(new Fi(1.01,1.01,1.01)),new ui({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Si(new Vi(new Fi(n+.04,r+.04,i+.04)),new ui({color:this.fixedColor??new G().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a})}},qh=1/16,Jh=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*qh-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*qh-.004,ry:Math.PI}];function Yh(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var Xh=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get($d(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=$d(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=gu(t,e.x,e.y,e.z);if(!Ll(r))return;let i=Jh[r-q.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,Yh(a,e,null);let o=new ji(a);o.colorSpace=Ie;let s=new Qr(new Hi(12*qh,12*qh),new Br({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{Yh(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=$d(e,t,n);if(this.conteudos.has(a))if(!Ll(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Ll(gu(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function Zh(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var Qh=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,Zh(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},$h=null;function eg(e){e.preventDefault(),e.returnValue=``}var tg=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function ng(e){$h?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||tg.has(e.code))&&e.preventDefault())}function rg(e){$h?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function ig(e){$h||($h=e,window.addEventListener(`beforeunload`,eg),window.addEventListener(`keydown`,ng,!0),window.addEventListener(`keyup`,rg,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function ag(){$h=null,window.removeEventListener(`beforeunload`,eg),window.removeEventListener(`keydown`,ng,!0),window.removeEventListener(`keyup`,rg,!0),navigator.keyboard?.unlock?.()}var og=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new ji(t);i.minFilter=o,this.material=new gr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[pu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===q.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===q.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===q.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Ar(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function sg(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&em(n)}var cg=new gl({antialias:!0});cg.setPixelRatio(Math.min(window.devicePixelRatio,2)),cg.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(cg.domElement);var lg=new gn;lg.background=new G(8900331);var ug=new Aa(75,window.innerWidth/window.innerHeight,.1,512);ug.rotation.order=`YXZ`;var dg=new Na(16777215,2.2);dg.position.set(60,100,40);var fg=new Pa(16777215,.55);lg.add(dg,fg);var pg=new Pm(dg,fg,lg,ug),mg=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();mg!==null&&pg.sync(mg,!1);var hg=new Lm,gg=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();gg&&hg.sync(gg.dir,gg.forca,!0);var _g=zm(),$=new $m(cg.domElement),vg=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},yg=vg(`yaw`),bg=vg(`pitch`);yg!==null&&($.yaw=yg),bg!==null&&($.pitch=bg);var xg=Rp(new URLSearchParams(location.search));function Sg(){let e=xg?{...ph(),...zp(xg)}:ph();return $.sensitivity=e.sensitivity,ug.fov=e.fov,ug.updateProjectionMatrix(),cg.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Ep(e.volume),Cg?.setScale(e.uiScale),pg.setNuvens(e.nuvens),e}var Cg=null,wg=Sg();Ap(wg.volume);var Tg=null,Eg=null,Dg=null,Og=new sh(()=>{Lg(),jg?.setFase(`jogando`),jg?.marcar(`carga concluída`),kg?.()}),kg=null,Ag=!1,jg=null,Mg=document.getElementById(`overlay`),Ng=document.getElementById(`overlay-main`),Pg=document.getElementById(`overlay-config`),Fg=document.getElementById(`crosshair`);function Ig(){Ng?.classList.remove(`hidden`),Pg?.classList.add(`hidden`)}function Lg(){let e=(Tg?.open??!1)||(Eg?.open??!1)||(Dg?.open??!1);Mg?.classList.toggle(`hidden`,Ag||Og.ativo||$.active||Kg.open||e),Fg?.classList.toggle(`hidden`,!$.active),$.locked&&Ig(),Cg?.setShown($.touch&&!Kg.open&&!e&&!Og.ativo)}document.addEventListener(`pointerlockchange`,Lg);function Rg(){Eh()?($.touch=!0,Dh(),Lg()):$.lock()}function zg(){let e=wg.keys;wg=Sg();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],wg.keys[t]);Vg()}var Bg=-1;function Vg(){if(!Hg||wg.raioRender===Bg)return;let e=Bg;Bg=wg.raioRender,Hg.send(JSON.stringify({type:`radius`,chunks:Bg})),jg?.marcar(`raio`,`${e<0?`join`:e} → ${Bg}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Rg()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Ih(e,zg,Ig),Ng?.classList.add(`hidden`),Pg?.classList.remove(`hidden`)}),Mg?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Op(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{ug.aspect=window.innerWidth/window.innerHeight,ug.updateProjectionMatrix(),cg.setSize(window.innerWidth,window.innerHeight)});var Hg=null,Ug=`?`,Wg=null;function Gg(){return new URLSearchParams(location.search).get(`nome`)??jh()}var Kg=new sm(e=>Hg?.send(JSON.stringify({type:`chat`,text:e})),e=>{Lg(),e||$.lock()});Lg(),cg.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Kg.open&&Kg.close()});var qg={tickAvgMs:0,tickMaxMs:0},Jg=null,Yg=0,Xg=[];function Zg(){let e=performance.now();Yg>0&&(Xg.push(e-Yg),Xg.length>300&&Xg.shift()),Yg=e}function Qg(){let e=Xg.length;if(e<2)return 0;let t=Xg.reduce((e,t)=>e+t,0)/e,n=Xg.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var $g=!1,e_=null,t_=null,n_=null,r_=null,i_=null,a_=null,o_=null,s_=`aluno`,c_=!1,l_=!1;function u_(){return s_===`professor`||c_}var d_=[],f_=null,p_=!1,m_=[],h_=null,g_=null,__=null,v_=new Vh,y_=null,b_=null,x_=null,S_=[],C_=new Set,w_=!1,T_=null,E_=null,D_=!1,O_=new Map;function k_(){Tg?.update({regions:d_,modo:y_?.modo??`sequencial`,objetivos:y_?.objetivos??[],grupos:S_,myGrupo:x_})}function A_(e){return e.porGrupo&&s_!==`professor`?x_===null?!1:e.porGrupo.find(e=>e.grupo===x_)?.completo??!1:e.completo}function j_(e){if(y_){for(let t of y_.objetivos)A_(t)?C_.has(t.id)||(C_.add(t.id),e&&w_&&xp({kind:`objective_complete`})):C_.delete(t.id);w_=!0,v_.update(y_.modo,y_.objetivos,{grupo:x_,professor:s_===`professor`,painelKey:hh(wg.keys.painel)}),b_?.(y_.objetivos)}}var M_=null;function N_(){let e=M_;if(e){M_=null;for(let t of e)F_(t)}}function P_(){M_||(M_=[],requestAnimationFrame(()=>requestAnimationFrame(N_)),setTimeout(N_,500))}function F_(e){if(M_){M_.push(e);return}if(Zg(),$g||Og.setFase(`mundo`),typeof e==`string`){let t=xf(e);if(!t)return;t.type===`debug_stats`?(qg={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},Jg=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0}):t.type===`block_changed`?e_?.(t):t.type===`blocks_filled`?t_?.(t):t.type===`player_moved`?(t.name&&O_.get(t.id)!==t.name&&(O_.set(t.id,t.name),tm([...new Set(O_.values())])),n_?.(t)):t.type===`player_left`?(O_.delete(t.id),tm([...new Set(O_.values())]),r_?.(t.id)):t.type===`spawn`?(o_={x:t.x,y:t.y,z:t.z},s_=t.papel??`aluno`):t.type===`regions`?(d_=t.regions,f_?.(t.regions),k_()):t.type===`objectives`?(y_={modo:t.modo,objetivos:t.objetivos},j_(!0),k_()):t.type===`group`?(x_=t.grupo,C_.clear(),j_(!1),k_()):t.type===`groups`?(S_=t.grupos,k_()):t.type===`quadros`?g_?.(t.lista):t.type===`quadro_changed`?__?.(t):t.type===`claims`?(p_=t.ativo,m_=t.claims,h_?.(t.claims)):t.type===`friends`||(t.type===`players`?Dg?.update({conectados:t.conectados,banidos:t.banidos}):t.type===`mundo_trocando`?(i_?.(t.nome),P_()):t.type===`teleport`?a_?.(t):t.type===`time`?mg===null&&pg.sync(t.hora,t.ciclo):t.type===`vento`?gg===null&&hg.sync(t.dir,t.forca,t.ativo):t.type===`voo`?(c_=t.liberado,u_()||(l_=!1),Kg.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(Op(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),ag(),location.href=location.pathname):t.type===`join_denied`?(Op(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),ag(),location.href=location.pathname):t.type===`chat`&&(Kg.addMessage(t.author,t.text),t.author===`servidor`&&sg(t.text),xp({kind:`chat_message`})));return}let t=Tf(e);if(t===809716300){E_?.(e);return}let n=()=>(D_=t===Cf,D_?Ef(e):Sf(e));if($g){T_?.(n());return}$g=!0,H_(n())}function I_(e,t){wg=Sg(),Hg=e,Og.abrir({host:Ug,rede:!(e instanceof Hm)}),Og.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),Lg(),e.onMessage(F_),$.onKey(wg.keys.chat,()=>{Kg.open||(document.exitPointerLock(),Kg.openInput())}),e.send(JSON.stringify({type:`join`,name:Gg(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),Bg=-1,Vg()}function L_(e,t){Ug=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),I_(new Um(e,t=>{$g||!Og.ativo||Og.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function R_(e,t){Wg={id:e.id,name:e.name,createdAt:e.createdAt},Ug=`web-worker (${e.name})`;let n=new Hm(new Worker(new URL(`/assets/worker-BOUKWtNc.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho}),I_(n)}async function z_(){if(!(Hg instanceof Hm)||!Wg)return;let e=await Hg.requestSave();await Sh({...Wg,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{ag(),z_().finally(()=>location.reload())});var B_=new URLSearchParams(location.search),V_=B_.get(`server`);if(V_){let e=B_.get(`codigo`);L_(V_,{pin:B_.get(`pin`)??``,...e?{codigo:e}:{}})}else xg?R_({id:`bench-${jp}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:Du(B_.get(`tamanho`)??`E`)},jp):Fh({onPlayWorld:R_,onPlayMulti:L_});function H_(e){let t=Hg;if(!t)return;ig(()=>$.active);let n=e.world,r=e.seed,i=new URLSearchParams(location.search).has(`semluz`),a=Iu(n.dims),s=[],c=new Set,l=0,u=0,d=D_,f=new Set,p=0,m=new Map,h=0,g=0,_=0,v=mp(),y=new $i({map:v,alphaTest:.5});Rm(y,_g);let b=Bm();Vm(y,b);let x=new $i({map:v,transparent:!0,opacity:.72,depthWrite:!1}),S=new $i({map:v,transparent:!0,opacity:.4,depthWrite:!1});if(Vm(x,b),Vm(S,b),new URLSearchParams(location.search).has(`atlas`)){let e=y.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let C=new URLSearchParams(location.search),w=C.has(`semworker`),T=Number(C.get(`meshdepth`)),E=new mm(n,[y,x,S],lg,!w,Number.isFinite(T)&&T>0?T:void 0,i?void 0:a),D=new _p(lg),ee=-1,O=0,k=-1,te=-1,A=(e,t)=>{for(let n=0;n<e.dims.x;n++)for(let r=0;r<e.dims.z;r++)id(e,t,n,r)};d||(i||A(n,a),E.buildAll()),E_=e=>{let t=[];try{t=Of(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;f.add(t),m.delete(t),c.has(t)||(c.add(t),s.push({cx:e,cz:r})),ne.varrerColuna(n,e,r)}g+=t.length};let j=(e,r,i)=>{let o=n.dims,s=wg.raioRender,c=0;for(let l=e-s;l<=e+s;l++)for(let e=r-s;e<=r+s;e++){if(l<0||e<0||l>=o.x||e>=o.z)continue;let r=e*o.x+l;if(f.has(r))continue;let s=m.get(r);if(!s){m.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||c>=4)){E.descartarColuna(l,e),ne.descartarColuna(l,e),Bu(a,l,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+l]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:l,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),c++,h++}}for(let t of m.keys()){let n=t%o.x,i=(t-n)/o.x;(f.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&m.delete(t)}},ne=new og(lg);ne.setFromWorld(n);let re=new Kh(lg);re.setRegions(d_),f_=e=>{re.setRegions(e),re.clearCorners()};let M=new Kh(lg,16747546),ie=e=>{M.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};ie(m_),h_=e=>{ie(e),re.clearCorners(),!p_&&s_!==`professor`&&Te&&(Te=!1),ke()};let ae=new Xh(lg),oe=new Qh;g_=e=>ae.setAll(e,n),__=e=>ae.aplicar(e,n);let se=new Kh(lg,3066993),ce=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=x_!==null&&r.grupo===x_;(s_===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});se.setRegions(t)};b_=ce,y_&&ce(y_.objetivos);let le=e=>t.send(JSON.stringify({type:`chat`,text:e})),ue=e=>{e?document.exitPointerLock():$.lock(),Lg()};s_===`professor`&&(Dg=new Hh(le,ue)),Tg=s_===`professor`?new Wh(le,ue,()=>{Tg?.hide(),Eg?.hide(),Dg?.show()}):new Gh(le,ue),k_(),$.onKey(wg.keys.painel,()=>{if(!Kg.open){if(s_!==`professor`&&S_.length===0){Kg.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}Eg?.hide(),Dg?.hide(),Tg?.toggle()}}),s_===`professor`&&Kg.addMessage(`jogo`,`tecla ${hh(wg.keys.painel)} abre o painel de autoria`);let N=o_??{x:n.sizeX/2+.5,y:vu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},P=zd(N.x,N.y,N.z),de=()=>{if(!d)return 0;let e=wg.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(P.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(P.pos.z/16))),i=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,a=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,i*a)},fe=de(),pe=()=>{Og.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:f.size,total:fe,faltando:m.size>0?m.size:Math.max(0,fe-f.size),fila:E.filaPendente}))};pe(),Og.setFase(d?`mundo`:`malha`),i_=e=>{fe=0,Og.abrir({host:Ug,rede:!(t instanceof Hm),titulo:`trocando de aula`,alvo:e}),pe(),Og.setFase(`preparando`),I.setFase(`carregando`),I.marcar(`troca de aula`,e),Lg()};function me(){P.pos.x=N.x,P.pos.y=N.y,P.pos.z=N.z,P.vel.x=P.vel.y=P.vel.z=0}T_=e=>{n=e.world,r=e.seed,d=D_,f=new Set,m.clear(),a=Iu(n.dims),s.length=0,c.clear(),!d&&!i&&A(n,a),E.trocarMundo(n,!d,i?void 0:a),ne.setFromWorld(n),d_=[],re.setRegions([]),re.clearCorners(),ae.setAll([],n),y_=null,b_?.([]),v_.update(`livre`,[],{grupo:null,professor:s_===`professor`,painelKey:hh(wg.keys.painel)}),C_.clear(),w_=!1,S_=[],x_=null,k_(),N=o_??N,me(),Kg.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),Bg=-1,Vg(),I.setMeta({worldChunks:n.dims,worldSeed:e.seed}),fe=de(),Og.abrir({host:Ug,rede:!(t instanceof Hm),titulo:`trocando de aula`}),pe(),Og.setFase(d?`mundo`:`malha`),I.setFase(`carregando`),Lg(),d||Og.concluir()},a_=e=>{P.pos.x=e.x,P.pos.y=e.y,P.pos.z=e.z,P.vel.x=P.vel.y=P.vel.z=0,$.yaw=yg??e.yaw,$.pitch=bg??e.pitch},e_=e=>{_u(n,e.x,e.y,e.z,e.blockId),E.remeshBlock(e.x,e.y,e.z),i||E.remeshSujos(ad(n,a,e.x,e.y,e.z)),ne.onBlockChanged(e.x,e.y,e.z,e.blockId),ae.onBlockChanged(e.x,e.y,e.z,e.blockId,n),xp(e.blockId===q.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},t_=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)_u(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(n.dims.x-1,e.x1/16|0);t++)for(let r=Math.max(0,e.z0/16|0);r<=Math.min(n.dims.z-1,e.z1/16|0);r++)i||E.remeshSujos(id(n,a,t,r));E.remeshBox(t,r),ne.onRegionFilled(t,r,e.blockId),ae.validarTodos(n),xp(e.blockId===q.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let he=new Map,ge=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new ji(t);i.minFilter=o;let a=new Ar(new gr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Pd.height/2+.35,0),a},_e=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};n_=e=>{let t=he.get(e.id);if(!t){let n=new Qr(new Fi(Pd.width,Pd.height,Pd.width),new $i({color:new G().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Pd.height/2,e.z),n.rotation.y=e.yaw,lg.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},he.set(e.id,t)}e.name&&e.name!==t.labelName&&(_e(t),t.label=ge(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Pd.height/2,e.z),t.targetYaw=e.yaw},r_=e=>{let t=he.get(e);t&&(_e(t),lg.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),he.delete(e))};let ve=new Si(new Vi(new Fi(1,1,1)),new ui({color:0}));ve.visible=!1,lg.add(ve);let F=null,ye=new U,be=`lj-hotbar`,xe=Kp(s_),Se=()=>xe.slice(0,9).map(e=>e.id),Ce=(()=>{let e=new Set(xe.map(e=>e.id));e.add(900);let t=Se();try{let n=JSON.parse(localStorage.getItem(be)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),we=0,Te=!1,Ee=document.getElementById(`hotbar`),De=Hp(y.map?.image,[...Gp.map(e=>e.id),900]),Oe=e=>e===900?`balde vazio`:e===901?`balde de água`:Gp.find(t=>t.id===e)?.name??`?`,ke=()=>{if(!Ee)return;if(Te){Ee.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${s_===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=Ce.map((e,t)=>`<span class="slot${t===we?` sel`:``}"><small>${t+1}</small><img src="${De.get(e)??``}" alt=""></span>`).join(``);Ee.innerHTML=`<span class="bar-nome">${Oe(Ce[we]??q.Grass)}</span><span class="slots">${e}</span>`,Eg?.refresh()};ke();let Ae=()=>{s_!==`professor`&&!p_||(Te=!Te,ke())};$.onKey(wg.keys.varinha,Ae);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{we=e,ke()});$.onWheel(e=>{we=(we+e+Ce.length)%Ce.length,ke()}),Ee?.addEventListener(`pointerdown`,e=>{let t=e.target?.closest?.(`.slot`);if(!t)return;let n=[...Ee.querySelectorAll(`.slot`)].indexOf(t);n<0||(e.preventDefault(),we=n,ke())}),Eg=new qp(De,()=>xe,()=>({hotbar:Ce,selected:we}),e=>{Ce[we]=e,localStorage.setItem(be,JSON.stringify(Ce)),ke()},e=>{we=e,ke()},e=>{e?(Tg?.hide(),Dg?.hide(),document.exitPointerLock()):$.lock(),Lg()}),$.onKey(wg.keys.inventario,()=>{Kg.open||Eg?.toggle()});let je=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),re.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(F){if(Te){je(1,F);return}Sl(Ce[we]??-1)||t.send(JSON.stringify({type:`break_block`,x:F.x,y:F.y,z:F.z}))}}),$.onMouseButton(2,()=>{if(!F)return;if(Te){je(2,F);return}{let e=Ce[we];if(Sl(e??-1)){if(e===901)t.send(JSON.stringify({type:`balde`,x:F.x+F.nx,y:F.y+F.ny,z:F.z+F.nz,encher:!1})),Ce[we]=900;else{if(gu(n,F.x,F.y,F.z)!==q.Agua)return;t.send(JSON.stringify({type:`balde`,x:F.x,y:F.y,z:F.z,encher:!0})),Ce[we]=901}localStorage.setItem(be,JSON.stringify(Ce)),ke();return}}if(Ll(gu(n,F.x,F.y,F.z))){let{x:e,y:n,z:r}=F;oe.open(ae.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if($l(gu(n,F.x,F.y,F.z))){t.send(JSON.stringify({type:`use_block`,x:F.x,y:F.y,z:F.z}));return}let e=Ce[we];if(e!==void 0){if((e===q.PortaXFechada||e===q.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?q.PortaXFechada:q.PortaZFechada),(e===q.JanelaXFechada||e===q.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?q.JanelaXFechada:q.JanelaZFechada),Rl(e)||zl(e)||Bl(e)||Ll(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Rl(e)?q.CadeiraXP:zl(e)?q.SofaXP:Bl(e)?q.CamaXP:q.QuadroXP)+r}if(Dl(e)){let t=e-+!!Ol(e);e=F.ny<0?t+1:t}if(Al(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Pl(Nl(e),r,F.ny<0)}t.send(JSON.stringify({type:`place_block`,x:F.x+F.nx,y:F.y+F.ny,z:F.z+F.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!F||Te)return;let e=gu(n,F.x,F.y,F.z);Gl(e)&&(e=q.PortaXFechada),Yl(e)&&(e=q.JanelaXFechada),Rl(e)&&(e=q.CadeiraXP),zl(e)&&(e=q.SofaXP),Bl(e)&&(e=q.CamaXP),Ll(e)&&(e=q.QuadroXP),Dl(e)&&(e=q.LajePedraBaixo+kl(e)*2),Al(e)&&(e=q.EscadaPedraXP+Nl(e)*8),nu(e)&&(ru(e)&&s_!==`professor`||(Ce[we]=e,localStorage.setItem(be,JSON.stringify(Ce)),ke()))});let I=new Qm(cg,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Ug});jg=I,I.contexto=()=>({x:P.pos.x,y:P.pos.y,z:P.pos.z,yaw:$.yaw,pitch:$.pitch,voando:l_&&u_(),noChao:P.onGround,raioRender:wg.raioRender,meshMsPorFrame:wg.meshMsPorFrame,pixelRatioCap:wg.pixelRatioCap,fov:wg.fov,nuvens:wg.nuvens,balanco:wg.balanco,distanciaTotal:_,colunasRecebidas:g,bytesRecebidos:t.stats.bytesIn}),I.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),I.carga=()=>Og.relatorio(),I.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let L=null;if(xg){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);Kg.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let t=xg.semVida?`bench-semvida`:`bench`;I.baixar(e,t),Kg.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${t}-*.json)`)}};kg=()=>{if(L)return;L=Bp.paraMundo(xg,N,n.dims),I.setMeta({bench:L.meta()}),I.marcar(`bench: início`,`${xg.duracaoS}s · raio ${L.trajeto.raio}${xg.semVida?` · sem vida ambiental`:``}`),Ag=!0,window.__benchRodando=!0,l_=!0,Lg(),L.iniciar(performance.now());let t=L.amostra(performance.now());P.pos.x=Fe=t.x,P.pos.y=z=t.y,P.pos.z=Ie=t.z,I.record(t=>{Ag=!1,window.__benchRodando=!1,Lg(),window.__benchPerfil=t,e(t)},xg.duracaoS*1e3)}}$.onKey(wg.keys.hud,()=>I.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{I.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),Eh()&&(Ee&&(Ee.style.pointerEvents=`auto`,Ee.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(we=n,ke())})),Cg=new kh($,{keys:()=>wg.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>Eg?.toggle(),chat:()=>{Kg.open||(document.exitPointerLock(),Kg.openInput())},menu:()=>{$.touch=!1,Ig(),Lg()},hud:()=>I.toggle(),varinha:()=>Ae()}),Cg.setScale(wg.uiScale),Lg()),I.extra=()=>{let e=$.mouseStats,t=P.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=Mu(i,a,r),s=au(o),c=ou(o),l=Math.min(ju(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&o.temp<.6?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===q.GramaSeca?`grama seca`:c===q.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se temp<0.60 · chapada ≥85]\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let Me={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},Ne=0;setInterval(()=>{let e={x:P.pos.x,y:P.pos.y,z:P.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==Me.x||e.y!==Me.y||e.z!==Me.z||e.yaw!==Me.yaw||e.pitch!==Me.pitch,r=performance.now();!n&&r-Ne<2e3||(Me=e,Ne=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof Hm&&Wg&&!xg&&(z_(),setInterval(()=>void z_(),3e4));let Pe={...t.stats};setInterval(()=>{let e=t.stats;I.net={msgsPerSec:e.msgsIn+e.msgsOut-(Pe.msgsIn+Pe.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(Pe.bytesIn+Pe.bytesOut),tickAvgMs:qg.tickAvgMs,tickMaxMs:qg.tickMaxMs,jitterMs:Qg()},I.regras=Jg,I.stream={colunas:f.size,fila:E.filaPendente,faltando:m.size,repedidas:h,ultimoLote:E.ultimoLote},I.luz={colunas:u,totalMs:l,fila:s.length},Pe={...e}},1e3);let R=performance.now(),Fe=P.pos.x,z=P.pos.y,Ie=P.pos.z,Le=!1,Re=!1,ze=0,Be=!1,Ve=0,He=Pd.eyeHeight,Ue=0;cg.setAnimationLoop(()=>{let e=performance.now(),t=e-R;R=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(wg.keys.forward)-+!!$.down(wg.keys.back):0,m=$.active?!!$.down(wg.keys.right)-+!!$.down(wg.keys.left):0,h=$.active&&$.down(wg.keys.jump),g=$.active&&$.down(wg.keys.forward);g&&!Re&&(e-ze<300&&(Le=!0),ze=e),g||(Le=!1),Re=g;let y=$.active&&$.down(wg.keys.agachar),x=o>0&&!y&&(Le||$.active&&$.down(wg.keys.correr));h&&!Be&&(u_()&&e-Ve<300&&(l_=!l_),Ve=e),Be=h;let S=l_&&u_(),C=!0;if(d){E.modoCarga=Og.ativo;{let e=Og.ativo?16:3,t=performance.now()+e,r=0;for(;s.length>0;){let e=s.shift(),o=e.cz*n.dims.x+e.cx;if(c.delete(o),f.has(o)){if(!i){let t=performance.now();id(n,a,e.cx,e.cz),l+=performance.now()-t,u++}if(E.enfileirarColuna(e.cx,e.cz),++r>=1&&performance.now()>=t)break}}}E.processarFila(wg.meshMsPorFrame,(e,t)=>{f.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(P.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(P.pos.z/16)));if(C=f.has(r*n.dims.x+t),(p=(p+1)%60)==0){for(let e of f){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>wg.raioRender+2){f.delete(e),E.descartarColuna(i,o),ne.descartarColuna(i,o),Bu(a,i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}j(t,r,e)}Og.ativo&&f.size>=fe&&s.length===0&&E.filaPendente===0&&Og.concluir()}if(L?.ativo){let t=L.amostra(e);P.pos.x=t.x,P.pos.y=t.y,P.pos.z=t.z,P.vel.x=P.vel.y=P.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,L.terminou(e)&&(L.parar(),I.marcar(`bench: fim`))}let w=P.pos.y;C&&!L?.ativo&&Xd(n,P,{forward:o,strafe:m,jump:h,yaw:$.yaw,sprint:x,sneak:y,fly:S},r);let T=P.pos.y-w;P.onGround&&!S&&T>.01&&T<=.56&&(Ue=Math.min(Ue+T,Ld)),Ue*=Math.exp(-r*14),Ue<.002&&(Ue=0),_+=Math.hypot(P.pos.x-Fe,P.pos.y-z,P.pos.z-Ie),Fe=P.pos.x,z=P.pos.y,Ie=P.pos.z,P.pos.y<-16&&me();let A=1-Math.exp(-r*12);for(let e of he.values()){e.mesh.position.lerp(e.target,A);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*A}let re=1-Math.exp(-r*20);He+=((y&&!S?Pd.sneakEyeHeight:Pd.eyeHeight)-He)*re;let M=wg.fov*(P.sprinting?1.1:1);if(Math.abs(ug.fov-M)>.01&&(ug.fov+=(M-ug.fov)*re,ug.updateProjectionMatrix()),ug.position.set(P.pos.x,P.pos.y+He-Ue,P.pos.z),ug.rotation.set($.pitch,$.yaw,0),ug.getWorldDirection(ye),F=$.active?Qd(n,ug.position.x,ug.position.y,ug.position.z,ye.x,ye.y,ye.z,5,Ce[we]===900):null,ve.visible=F!==null,F){let[e,t,r,i,a,o]=hd(gu(n,F.x,F.y,F.z));ve.position.set(F.x+(e+i)/2,F.y+(t+a)/2,F.z+(r+o)/2),ve.scale.set(i-e+.004,a-t+.004,o-r+.004)}I.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),hg.update(r),_g.ventoTempo.value=hg.fase*Math.PI*2,_g.ventoDir.value.set(hg.x,hg.z),_g.ventoForca.value=wg.balanco?hg.forca:0,pg.update(r,hg),b.nivelCeu.value=pg.nivelCeu,D.update(n,ug.position.x,ug.position.y,ug.position.z);let ie=Math.floor(hg.fase*16)%16;O+=r;let ae=Math.floor(O*8)%16;(ie!==ee||ae!==k)&&O-te>=1/12&&(te=O,ee=ie,k=ae,pp(v,ie,hg.ondaAgua,ae));let oe=performance.now();I.gpuInicio(),cg.render(lg,ug),I.gpuFim(),I.frame(t,performance.now()-oe)}),d||Og.concluir(),B_.has(`hud`)&&I.toggle(),new URLSearchParams(location.search).has(`painel`)&&Tg?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Eg?.toggle(),B_.has(`touch`)&&Rg()}