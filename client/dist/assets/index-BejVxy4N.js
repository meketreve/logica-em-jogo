...
}`)},e.needsUpdate=!0}function _g(){return{ventoTempo:{value:0},ventoDir:{value:new V(1,0)},ventoForca:{value:0}}}function vg(){return{nivelCeu:{value:1},luzMin:{value:.05}}}function yg(e,t){let n=e.onBeforeCompile;e.onBeforeCompile=(r,i)=>{n?.call(e,r,i),r.uniforms.nivelCeu=t.nivelCeu,r.uniforms.luzMin=t.luzMin,r.vertexShader=r.vertexShader.replace(`#include <common>`,`#include <common>
attribute float luz;
...
`;function Ig(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function Lg(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function Rg(e){return`${(e/1e3).toFixed(1)} s`}var zg=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=Fg,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(Pg*.25).toFixed(1)} ${Pg.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,Pg.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(Pg*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=Rg(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${Rg(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=Ig(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=Lg(n.bytes)}e.forcar.classList.toggle(`hidden`,o<Mg||this.fase===`pronto`)}},Bg={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`,amigos:`KeyG`}},Vg={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`,amigos:`painel de amigos (áreas compartilhadas)`},Hg=`lj-config`;function Ug(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function Wg(e,t){return typeof e==`boolean`?e:t}function Gg(){let e=null;try{e=JSON.parse(localStorage.getItem(Hg)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...Bg.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:Ug(t.sensitivity,Bg.sensitivity,.2,3),fov:Ug(t.fov,Bg.fov,60,100),pixelRatioCap:Ug(t.pixelRatioCap,Bg.pixelRatioCap,1,2),volume:Ug(t.volume,Bg.volume,0,1),raioRender:Ug(t.raioRender,Bg.raioRender,2,12),meshMsPorFrame:Ug(t.meshMsPorFrame,Bg.meshMsPorFrame,1,16),uiScale:Ug(t.uiScale,Bg.uiScale,.6,1.8),nuvens:Wg(t.nuvens,Bg.nuvens),balanco:Wg(t.balanco,Bg.balanco),keys:r}}function Kg(e){localStorage.setItem(Hg,JSON.stringify(e))}function qg(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var Jg=`logica-em-jogo`,Yg=`worlds`;function Xg(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var Zg=null;function Qg(){return Zg??=new Promise((e,t)=>{let n=indexedDB.open(Jg,1);n.onupgradeneeded=()=>{n.result.createObjectStore(Yg,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),Zg}async function $g(){return(await Xg((await Qg()).transaction(Yg).objectStore(Yg).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function e_(e){await Xg((await Qg()).transaction(Yg,`readwrite`).objectStore(Yg).put(e))}async function t_(e){await Xg((await Qg()).transaction(Yg,`readwrite`).objectStore(Yg).delete(e))}function n_(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function r_(e){let t=await e.arrayBuffer();Yp(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function i_(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function a_(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var o_=`
:root { --ts: 1; }
...
`;function D_(e){return`url("data:image/svg+xml,${encodeURIComponent(e)}")`}var O_=D_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#e23b3b" stroke="#5a0d0d" stroke-width="1.2"/></svg>`),k_=D_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#1a1a1a" stroke="#000" stroke-width="1.2"/></svg>`),A_=D_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#7fd4ff" stroke="#0a3550" stroke-width="1.2"/><circle cx="5.8" cy="5.8" r="1.6" fill="#fff" opacity="0.9"/></svg>`),j_=(e,t,n)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M12.8 12.8 8.6 8.6" stroke="${t}" stroke-width="3" stroke-linecap="round"/><circle cx="12.9" cy="12.9" r="2.1" fill="${t}" stroke="${n}" stroke-width="0.9"/><circle cx="6" cy="6" r="4.7" fill="${e}" stroke="${n}" stroke-width="1.1"/></svg>`,M_=D_(j_(`#b2601f`,`#f3e7cf`,`#4d2a10`)),N_=D_(j_(`#1a1a1a`,`#1a1a1a`,`#000`));function P_(e,t,n){let r=document.createElement(`div`);r.className=`linha`;let i=[];for(let a=0;a<e;a++){let e=document.createElement(`div`);if(e.className=`casa`,n!==void 0){let t=document.createElement(`div`);t.className=`icone fundo`,t.style.backgroundImage=n,e.appendChild(t)}let a=document.createElement(`div`);a.className=`icone`,a.style.backgroundImage=t,e.appendChild(a),r.appendChild(e),i.push(e)}return{linha:r,casas:i}}function F_(e,t){for(let[n,r]of e.entries()){let e=r.lastElementChild;if(!e)continue;let i=t>=(n+1)*2,a=!i&&t===n*2+1;e.style.display=i||a?`block`:`none`,e.classList.toggle(`meio`,a)}}var I_=class{raiz;linhaVida;linhaFome;linhaAr;dano;morte;casasVida;casasFome;casasAr;morteTimer=null;danoTimer=null;ultimaVida=20;visivel=!1;constructor(){let e=document.createElement(`style`);e.textContent=E_,document.head.appendChild(e),this.raiz=document.createElement(`div`),this.raiz.id=`lj-vitals`;let t=P_(S_,O_,k_),n=P_(C_,M_,N_),r=P_(w_,A_);this.linhaVida=t.linha,this.casasVida=t.casas,this.linhaFome=n.linha,this.casasFome=n.casas,this.linhaAr=r.linha,this.casasAr=r.casas,this.linhaAr.classList.add(`vazia`),this.linhaFome.classList.add(`vazia`);let i=document.createElement(`div`);i.className=`barras`,i.append(this.linhaVida,this.linhaFome),this.raiz.append(this.linhaAr,i),document.body.appendChild(this.raiz),this.dano=document.createElement(`div`),this.dano.id=`lj-dano`,this.morte=document.createElement(`div`),this.morte.id=`lj-morte`,document.body.append(this.dano,this.morte)}setVisivel(e){this.visivel=e,this.raiz.classList.toggle(`ativo`,e),e||this.esconderMorte()}aplicar(e){let t=Math.max(0,Math.min(20,Math.round(e.vida)));F_(this.casasVida,t),this.desenharFome(e.fome),this.desenharAr(e.folego),t<this.ultimaVida&&this.visivel&&this.piscarDano(),e.morreu&&this.visivel&&this.mostrarMorte(e.causa),this.ultimaVida=t}desenharFome(e){this.linhaFome.classList.toggle(`vazia`,e===void 0),e!==void 0&&F_(this.casasFome,Math.max(0,Math.min(20,Math.round(e))))}desenharAr(e){let t=e===void 0||e>=150;if(this.linhaAr.classList.toggle(`vazia`,t),t)return;let n=Math.max(0,Math.ceil(e/T_));for(let[e,t]of this.casasAr.entries()){let r=t.lastElementChild;r&&(r.style.display=e<n?`block`:`none`)}}piscarDano(){this.dano.classList.add(`piscar`),this.danoTimer!==null&&clearTimeout(this.danoTimer),this.danoTimer=setTimeout(()=>this.dano.classList.remove(`piscar`),90)}mostrarMorte(e){this.morte.textContent=e===`queda`?`Você caiu de muito alto`:e===`afogamento`?`Você ficou sem ar`:e===`fome`?`Você passou fome demais`:`Você não sobreviveu`,this.morte.classList.add(`ativo`),this.morteTimer!==null&&clearTimeout(this.morteTimer),this.morteTimer=setTimeout(()=>this.esconderMorte(),2600)}esconderMorte(){this.morte.classList.remove(`ativo`)}},L_=class{send;onToggle;root=document.getElementById(`amigos`);isOpen=!1;data={eu:``,equipe:null,convites:[],enviados:[],online:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Qm(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=this.btn(e,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)});return n}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}linha(e,...t){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);return r.className=`jog-nome`,r.textContent=e,n.append(r,...t),n}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`amigos`,t.append(n,this.btn(`✕ fechar`,()=>this.hide()));let r=document.createElement(`div`);r.className=`jog-lista`,this.renderConvites(r),this.renderGrupo(r),this.renderConvidar(r),r.append(this.hint(`pelo chat também dá: /amigos convidar nome · /amigos aceitar · /amigos recusar · /amigos sair · /amigos expulsar nome · /amigos lista`)),e.append(t,r)}renderConvites(e){if(this.data.convites.length!==0){e.append(this.sec(`✉ convites para você (${this.data.convites.length})`));for(let t of this.data.convites)e.append(this.linha(`${t} convidou você`,this.btn(`aceitar`,()=>this.send(`/amigos aceitar ${t}`)),this.btn(`recusar`,()=>this.send(`/amigos recusar ${t}`))));e.append(this.hint(`aceitar um convite descarta os outros — você fica em UM grupo só.`))}}renderGrupo(e){let{eu:t,equipe:n}=this.data;if(!n){e.append(this.sec(`👥 seu grupo`)),e.append(this.hint(`Você não está em nenhum grupo. Quem está no seu grupo pode construir na sua ÁREA PROTEGIDA (e você na dele). Cabem 6 pessoas, contando você.`));return}let r=n.dono===t;e.append(this.sec(`👥 grupo de ${n.dono} — ${n.membros.length}/6`));for(let i of n.membros){let a=[i===n.dono?`dono`:``,i===t?`você`:``].filter(e=>e),o=a.length?`${i} (${a.join(`, `)})`:i;e.append(r&&i!==t?this.linha(o,this.armedBtn(`expulsar`,()=>this.send(`/amigos expulsar ${i}`))):this.linha(o))}let i=document.createElement(`div`);i.className=`painel-row`,i.append(r?this.armedBtn(`sair e DESFAZER o grupo`,()=>this.send(`/amigos sair`)):this.armedBtn(`sair do grupo`,()=>this.send(`/amigos sair`))),e.append(i),r&&e.append(this.hint(`você é o dono: se sair, o grupo acaba para todo mundo.`))}renderConvidar(e){let{eu:t,equipe:n,enviados:r,online:i}=this.data;if(e.append(this.sec(`＋ convidar`)),n&&n.dono!==t){e.append(this.hint(`Só ${n.dono} convida para este grupo. Saia dele para montar o seu.`));return}if(n&&n.membros.length>=6){e.append(this.hint(`Grupo cheio (6/6).`));return}for(let t of r)e.append(this.linha(`${t} — convite enviado, aguardando`));let a=new Set(n?.membros??[]),o=i.filter(e=>e!==t&&!a.has(e)&&!r.includes(e));for(let t of o)e.append(this.linha(t,this.btn(`convidar`,()=>this.send(`/amigos convidar ${t}`))));o.length===0&&r.length===0&&e.append(this.hint(`ninguém mais está na aula agora.`))}},R_=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Qm(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},z_=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Qm(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},B_=class extends z_{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(bh[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=zu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=zu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...bh.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},V_=class extends z_{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},H_=class{fixedColor;group=new cn;cornerMarks=[];boxes=[];bounds=[];culling=null;constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Ci(new Hi(new Ii(1.01,1.01,1.01)),new di({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();if(this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Ci(new Hi(new Ii(n+.04,r+.04,i+.04)),new di({color:this.fixedColor??new W().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a}),this.bounds=e,this.culling){let{px:e,pz:t,raio:n}=this.culling;this.cularPorDistancia(e,t,n)}}cularPorDistancia(e,t,n){this.culling={px:e,pz:t,raio:n};for(let r=0;r<this.boxes.length;r++){let i=this.boxes[r],a=this.bounds[r];if(!i||!a)continue;let o=Math.max(a.min.x-e,0,e-(a.max.x+1)),s=Math.max(a.min.z-t,0,t-(a.max.z+1));i.visible=Math.max(o,s)<=n}}},U_=1/16,W_=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*U_-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*U_-.004,ry:Math.PI}];function G_(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var K_=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(_p(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=_p(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=Fu(t,e.x,e.y,e.z);if(!Xl(r))return;let i=W_[r-K.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,G_(a,e,null);let o=new Mi(a);o.colorSpace=Le;let s=new $r(new Ui(12*U_,12*U_),new Vr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{G_(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=_p(e,t,n);if(this.conteudos.has(a))if(!Xl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Xl(Fu(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function q_(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var J_=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,q_(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},Y_=null;function X_(e){e.preventDefault(),e.returnValue=``}var Z_=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function Q_(e){Y_?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||Z_.has(e.code))&&e.preventDefault())}function $_(e){Y_?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function ev(e){Y_||(Y_=e,window.addEventListener(`beforeunload`,X_),window.addEventListener(`keydown`,Q_,!0),window.addEventListener(`keyup`,$_,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function tv(){Y_=null,window.removeEventListener(`beforeunload`,X_),window.removeEventListener(`keydown`,Q_,!0),window.removeEventListener(`keyup`,$_,!0),navigator.keyboard?.unlock?.()}var nv=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Mi(t);i.minFilter=o,this.material=new _r({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[Mu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===K.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===K.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===K.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new jr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function rv(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Ah(n)}var iv=new _l({antialias:!0});iv.setPixelRatio(Math.min(window.devicePixelRatio,2)),iv.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(iv.domElement);var av=new _n;av.background=new W(8900331);var ov=new ja(75,window.innerWidth/window.innerHeight,.1,512);ov.rotation.order=`YXZ`;var sv=new Pa(16777215,2.2);sv.position.set(60,100,40);var cv=new Fa(16777215,.55);av.add(sv,cv);var lv=new fg(sv,cv,av,ov),uv=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();uv!==null&&lv.sync(uv,!1);var dv=new hg,fv=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();fv&&dv.sync(fv.dir,fv.forca,!0);var pv=_g(),$=new jg(iv.domElement);$.touchDevice=i_();var mv=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},hv=mv(`yaw`),gv=mv(`pitch`);hv!==null&&($.yaw=hv),gv!==null&&($.pitch=gv);var _v=ch(new URLSearchParams(location.search));function vv(){let e=_v?{...Gg(),...lh(_v)}:Gg();return $.sensitivity=e.sensitivity,ov.fov=e.fov,ov.updateProjectionMatrix(),iv.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Xm(e.volume),yv?.setScale(e.uiScale),lv.setNuvens(e.nuvens),e}var yv=null,bv=vv();eh(bv.volume);var xv=null,Sv=null,Cv=null,wv=null,Tv=null,Ev={equipe:null,convites:[],enviados:[]},Dv=new zg(()=>{zv(),Av?.setFase(`jogando`),Av?.marcar(`carga concluída`),Ov?.()}),Ov=null,kv=!1,Av=null,jv=document.getElementById(`overlay`),Mv=document.getElementById(`overlay-main`),Nv=document.getElementById(`overlay-config`),Pv=document.getElementById(`crosshair`);function Fv(){Mv?.classList.remove(`hidden`),Nv?.classList.add(`hidden`)}function Iv(){return(xv?.open??!1)||(Sv?.open??!1)||(Cv?.open??!1)||(wv?.open??!1)||(Tv?.open??!1)}function Lv(){return jv!==null&&!jv.classList.contains(`hidden`)}function Rv(){return!Iv()&&!Lv()&&!Yv.open}function zv(){let e=Iv();jv?.classList.toggle(`hidden`,kv||Dv.ativo||$.active||Yv.open||e),Pv?.classList.toggle(`hidden`,!$.active),$.locked&&Fv(),yv?.setShown($.touch&&!Yv.open&&!e&&!Dv.ativo)}document.addEventListener(`pointerlockchange`,zv);function Bv(){i_()?($.touch=!0,a_(),zv()):$.lock()}window.addEventListener(`keydown`,e=>{e.code===`Escape`&&(!Lv()||Yv.open||(document.getElementById(`menu`)?.classList.contains(`hidden`)??!1)&&(e.preventDefault(),Bv()))});function Vv(){let e=bv.keys;bv=vv();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`,`amigos`])$.rebind(e[t],bv.keys[t]);Uv()}var Hv=-1;function Uv(){if(!Wv||bv.raioRender===Hv)return;let e=Hv;Hv=bv.raioRender,Wv.send(JSON.stringify({type:`radius`,chunks:Hv})),Av?.marcar(`raio`,`${e<0?`join`:e} → ${Hv}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Bv()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&h_(e,Vv,Fv),Mv?.classList.add(`hidden`),Nv?.classList.remove(`hidden`)}),document.getElementById(`overlay-telacheia`)?.addEventListener(`click`,()=>{a_()}),document.getElementById(`overlay-hud`)?.addEventListener(`click`,()=>{Av?.toggle()}),jv?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Qm(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{ov.aspect=window.innerWidth/window.innerHeight,ov.updateProjectionMatrix(),iv.setSize(window.innerWidth,window.innerHeight)});var Wv=null,Gv=`?`,Kv=null;function qv(){return new URLSearchParams(location.search).get(`nome`)??u_()}function Jv(e){return e.trim().toLowerCase()!==`/amigos`||!wv?!1:(xv?.hide(),Sv?.hide(),Cv?.hide(),wv.toggle(),!0)}var Yv=new Lh(e=>{Jv(e)||Wv?.send(JSON.stringify({type:`chat`,text:e}))},e=>{zv(),e||$.lock()});zv(),iv.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Yv.open&&Yv.close()});var Xv={tickAvgMs:0,tickMaxMs:0},Zv=null,Qv=0,$v=[];function ey(){let e=performance.now();Qv>0&&($v.push(e-Qv),$v.length>300&&$v.shift()),Qv=e}function ty(){let e=$v.length;if(e<2)return 0;let t=$v.reduce((e,t)=>e+t,0)/e,n=$v.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var ny=!1,ry=null,iy=null,ay=null,oy=null,sy=null,cy=null,ly=null,uy=`aluno`,dy=!1,fy=!1,py=`criativo`,my=!1;function hy(){return bf(py)&&(uy===`professor`||dy)}var gy=new x_,_y=null,vy=null;function yy(){return vy??=new I_,vy}var by=null,xy=(()=>{let e=new URLSearchParams(location.search).get(`vida`);if(e===null)return null;let[t,n,r]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{vida:t,...Number.isFinite(n)?{folego:n}:{},...Number.isFinite(r)?{fome:r}:{}}})();xy&&(yy().setVisivel(!0),yy().aplicar(xy));{let e=new URLSearchParams(location.search).get(`mochila`);if(e!==null){let t=[];e.split(`,`).forEach((e,n)=>{let[r,i]=e.split(`x`).map(Number);r===void 0||!Number.isInteger(r)||r<=0||t.push({slot:n,id:r,qtd:Number.isInteger(i)&&i>0?i:1})}),gy.travar(t)}}var Sy=[],Cy=null,wy=!1,Ty=!1,Ey=[],Dy=null,Oy=null,ky=null,Ay=new b_,jy=null,My=null,Ny=null,Py=[],Fy=new Set,Iy=!1,Ly=null,Ry=null,zy=!1,By=new Map;function Vy(){xv?.update({regions:Sy,modo:jy?.modo??`sequencial`,objetivos:jy?.objetivos??[],grupos:Py,myGrupo:Ny})}function Hy(){wv?.update({eu:qv(),equipe:Ev.equipe,convites:Ev.convites,enviados:Ev.enviados,online:[...new Set(By.values())].sort()})}function Uy(e){return e.porGrupo&&uy!==`professor`?Ny===null?!1:e.porGrupo.find(e=>e.grupo===Ny)?.completo??!1:e.completo}function Wy(e){if(jy){for(let t of jy.objetivos)Uy(t)?Fy.has(t.id)||(Fy.add(t.id),e&&Iy&&Gm({kind:`objective_complete`})):Fy.delete(t.id);Iy=!0,Ay.update(jy.modo,jy.objetivos,{grupo:Ny,professor:uy===`professor`,painelKey:qg(bv.keys.painel)}),My?.(jy.objetivos)}}var Gy=null;function Ky(){let e=Gy;if(e){Gy=null;for(let t of e)Jy(t)}}function qy(){Gy||(Gy=[],requestAnimationFrame(()=>requestAnimationFrame(Ky)),setTimeout(Ky,500))}function Jy(e){if(Gy){Gy.push(e);return}if(ey(),ny||Dv.setFase(`mundo`),typeof e==`string`){let t=Rp(e);if(!t)return;if(t.type===`debug_stats`)Xv={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},Zv=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0};else if(t.type===`block_changed`)ry?.(t);else if(t.type===`blocks_filled`)iy?.(t);else if(t.type===`player_moved`)t.name&&By.get(t.id)!==t.name&&(By.set(t.id,t.name),jh([...new Set(By.values())]),Hy()),ay?.(t);else if(t.type===`player_left`)By.delete(t.id),jh([...new Set(By.values())]),Hy(),oy?.(t.id);else if(t.type===`spawn`)ly={x:t.x,y:t.y,z:t.z},uy=t.papel??`aluno`;else if(t.type===`regions`)Sy=t.regions,Cy?.(t.regions),Vy();else if(t.type===`objectives`)jy={modo:t.modo,objetivos:t.objetivos},Wy(!0),Vy();else if(t.type===`group`)Ny=t.grupo,Fy.clear(),Wy(!1),Vy();else if(t.type===`groups`)Py=t.grupos,Vy();else if(t.type===`quadros`)Oy?.(t.lista);else if(t.type===`quadro_changed`)ky?.(t);else if(t.type===`container`)Tv?.atualizar(t);else if(t.type===`container_fechado`)Tv?.fecharSemAvisar();else if(t.type===`claims`)wy=t.ativo,t.ativo&&!Ty&&(Ty=!0,Yv.addMessage(`jogo`,`tecla ${qg(bv.keys.amigos)} abre o painel de amigos — quem está no seu grupo constrói na sua área`)),Ey=t.claims,Dy?.(t.claims);else if(t.type===`friends`)Ev={equipe:t.equipe,convites:t.convites,enviados:t.enviados},Hy();else if(t.type===`players`)Cv?.update({conectados:t.conectados,banidos:t.banidos});else if(t.type===`mundo_trocando`)sy?.(t.nome),qy();else if(t.type===`teleport`)cy?.(t);else if(t.type===`time`)uv===null&&lv.sync(t.hora,t.ciclo);else if(t.type===`vento`)fv===null&&dv.sync(t.dir,t.forca,t.ativo);else if(t.type===`voo`)dy=t.liberado,hy()||(fy=!1),Yv.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`);else if(t.type===`modo`){let e=py!==t.efetivo;py=t.efetivo,my=t.pvp===!0,hy()||(fy=!1),xy===null&&(t.efetivo===`sobrevivencia`?yy().setVisivel(!0):vy?.setVisivel(!1)),t.efetivo===`criativo`&&gy.ativa&&(gy.desligar(),_y?.()),e&&Yv.addMessage(`jogo`,t.efetivo===`sobrevivencia`?`modo sobrevivência — não dá para voar`:`modo criativo`)}else if(t.type===`inventario`)gy.aplicar(t.slots),_y?.();else if(t.type===`vida`){if(xy!==null)return;by=t,yy().aplicar(t),t.causa&&Gm({kind:`dano`}),t.morreu&&(Gm({kind:`morte`}),Yv.addMessage(`jogo`,t.causa===`queda`?`você caiu de muito alto — voltou ao ponto de partida`:t.causa===`afogamento`?`você ficou sem ar — voltou ao ponto de partida`:t.causa===`fome`?`você passou fome demais — voltou ao ponto de partida`:t.causa===`pvp`?`você foi derrubado por outro jogador — voltou ao ponto de partida`:`você não sobreviveu — voltou ao ponto de partida`))}else t.type===`kicked`?(Qm(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),tv(),location.href=location.pathname):t.type===`join_denied`?(Qm(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),tv(),location.href=location.pathname):t.type===`chat`&&(Yv.addMessage(t.author,t.text),t.author===`servidor`&&rv(t.text),Gm({kind:`chat_message`}));return}let t=Hp(e);if(t===809716300){Ry?.(e);return}let n=()=>(zy=t===Bp,zy?Up(e):zp(e));if(ny){Ly?.(n());return}ny=!0,tb(n())}function Yy(e,t){bv=vv(),Wv=e,Dv.abrir({host:Gv,rede:!(e instanceof bg)}),Dv.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),zv(),e.onMessage(Jy),$.onKey(bv.keys.chat,()=>{Yv.open||Rv()&&(document.exitPointerLock(),Yv.openInput())}),e.send(JSON.stringify({type:`join`,name:qv(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),Hv=-1,Uv()}function Xy(e,t){Gv=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Yy(new xg(e,t=>{ny||!Dv.ativo||Dv.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function Zy(e,t){Kv={id:e.id,name:e.name,createdAt:e.createdAt},Gv=`web-worker (${e.name})`;let n=new bg(new Worker(new URL(`/assets/worker-BiZsD0p9.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho,sobrevivencia:e.sobrevivencia}),Yy(n)}async function Qy(){if(!(Wv instanceof bg)||!Kv)return;let e=await Wv.requestSave();await e_({...Kv,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{tv(),Qy().finally(()=>location.reload())});var $y=new URLSearchParams(location.search),eb=$y.get(`server`);if(eb){let e=$y.get(`codigo`);Xy(eb,{pin:$y.get(`pin`)??``,...e?{codigo:e}:{}})}else _v?Zy({id:`bench-${th}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:cd($y.get(`tamanho`)??`E`)},th):m_({onPlayWorld:Zy,onPlayMulti:Xy});function tb(e){let t=Wv;if(!t)return;ev(()=>$.active);let n=e.world,r=e.seed,i=new Gh(n.dims,new URLSearchParams(location.search).has(`semluz`)),a=zy,o=new Set,s=0,c=new Map,l=0,u=0,d=0,f=Rm(),p=new ea({map:f,alphaTest:.5});gg(p,pv);let m=vg();yg(p,m);let h=new ea({map:f,transparent:!0,opacity:.72,depthWrite:!1}),g=new ea({map:f,transparent:!0,opacity:.4,depthWrite:!1});if(yg(h,m),yg(g,m),new URLSearchParams(location.search).has(`atlas`)){let e=p.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let _=new URLSearchParams(location.search),v=_.has(`semworker`),y=Number(_.get(`meshdepth`)),b=new Wh(n,[p,h,g],av,!v,Number.isFinite(y)&&y>0?y:void 0,i.paraMesher),x=new Vm(av),S=-1,C=0,w=-1,T=-1;a||(i.acenderTudo(n),b.buildAll()),Ry=e=>{let t=[];try{t=Gp(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;o.add(t),c.delete(t),i.enfileirar(e,r,n.dims.x),D.varrerColuna(n,e,r)}u+=t.length};let E=(e,r,a)=>{let s=n.dims,u=bv.raioRender,d=0;for(let f=e-u;f<=e+u;f++)for(let e=r-u;e<=r+u;e++){if(f<0||e<0||f>=s.x||e>=s.z)continue;let r=e*s.x+f;if(o.has(r))continue;let u=c.get(r);if(!u){c.set(r,{tentativas:0,proximo:a+4e3});continue}if(!(a<u.proximo||d>=4)){b.descartarColuna(f,e),D.descartarColuna(f,e),i.descartar(f,e);for(let t=0;t<s.y;t++)n.chunks[(t*s.z+e)*s.x+f]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:f,cz:e})),u.tentativas++,u.proximo=a+Math.min(3e4,2e3*2**(u.tentativas-1)),d++,l++}}for(let t of c.keys()){let n=t%s.x,i=(t-n)/s.x;(o.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>u)&&c.delete(t)}},D=new nv(av);D.setFromWorld(n);let ee=new H_(av);ee.setRegions(Sy),Cy=e=>{ee.setRegions(e),ee.clearCorners()};let O=new H_(av,16747546),k=e=>{O.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};k(Ey),Dy=e=>{k(e),ee.clearCorners(),!wy&&uy!==`professor`&&_e&&(_e=!1,yv?.setVarinha(!1)),yv?.setVarinhaDisponivel(uy===`professor`||wy),yv?.setAmigosDisponivel(wy),xe()};let te=new K_(av),A=new J_;Oy=e=>te.setAll(e,n),ky=e=>te.aplicar(e,n);let j=new H_(av,3066993),ne=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Ny!==null&&r.grupo===Ny;(uy===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});j.setRegions(t)};My=ne,jy&&ne(jy.objetivos);let re=e=>t.send(JSON.stringify({type:`chat`,text:e})),M=e=>{e?document.exitPointerLock():$.lock(),zv()};uy===`professor`&&(Cv=new R_(re,M)),wv=new L_(re,M),Hy(),xv=uy===`professor`?new B_(re,M,()=>{xv?.hide(),Sv?.hide(),wv?.hide(),Cv?.show()}):new V_(re,M),Vy(),$.onKey(bv.keys.painel,()=>{if(!(!(xv?.open??!1)&&!Rv())){if(uy!==`professor`&&Py.length===0){Yv.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}xv?.toggle()}}),$.onKey(bv.keys.amigos,()=>{!(wv?.open??!1)&&!Rv()||wv?.toggle()}),uy===`professor`&&Yv.addMessage(`jogo`,`tecla ${qg(bv.keys.painel)} abre o painel de autoria`);let ie=ly??{x:n.sizeX/2+.5,y:Lu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},N=tp(ie.x,ie.y,ie.z),ae=()=>{if(!a)return 0;let e=bv.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(N.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(N.pos.z/16))),i=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,o=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,i*o)},oe=ae(),se=()=>{Dv.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:o.size,total:oe,faltando:c.size>0?c.size:Math.max(0,oe-o.size),fila:b.filaPendente}))};se(),Dv.setFase(a?`mundo`:`malha`),sy=e=>{oe=0,Dv.abrir({host:Gv,rede:!(t instanceof bg),titulo:`trocando de aula`,alvo:e}),se(),Dv.setFase(`preparando`),Te.setFase(`carregando`),Te.marcar(`troca de aula`,e),zv()};function ce(){N.pos.x=ie.x,N.pos.y=ie.y,N.pos.z=ie.z,N.vel.x=N.vel.y=N.vel.z=0}Ly=e=>{n=e.world,r=e.seed,a=zy,o=new Set,c.clear(),i.trocarMundo(n.dims),a||i.acenderTudo(n),b.trocarMundo(n,!a,i.paraMesher),D.setFromWorld(n),Sy=[],ee.setRegions([]),ee.clearCorners(),te.setAll([],n),jy=null,My?.([]),Ay.update(`livre`,[],{grupo:null,professor:uy===`professor`,painelKey:qg(bv.keys.painel)}),Fy.clear(),Iy=!1,Py=[],Ny=null,Vy(),ie=ly??ie,ce(),Yv.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),Hv=-1,Uv(),Te.setMeta({worldChunks:n.dims,worldSeed:e.seed}),oe=ae(),Dv.abrir({host:Gv,rede:!(t instanceof bg),titulo:`trocando de aula`}),se(),Dv.setFase(a?`mundo`:`malha`),Te.setFase(`carregando`),zv(),a||Dv.concluir()},cy=e=>{N.pos.x=e.x,N.pos.y=e.y,N.pos.z=e.z,N.vel.x=N.vel.y=N.vel.z=0,$.yaw=hv??e.yaw,$.pitch=gv??e.pitch},ry=e=>{Iu(n,e.x,e.y,e.z,e.blockId),b.remeshBlock(e.x,e.y,e.z),b.remeshSujos(i.aoMudarBloco(n,e.x,e.y,e.z)),D.onBlockChanged(e.x,e.y,e.z,e.blockId),te.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Gm(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},iy=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)Iu(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(n.dims.x-1,e.x1/16|0);t++)for(let r=Math.max(0,e.z0/16|0);r<=Math.min(n.dims.z-1,e.z1/16|0);r++)b.remeshSujos(i.aoChegarColuna(n,t,r));b.remeshBox(t,r),D.onRegionFilled(t,r,e.blockId),te.validarTodos(n),Gm(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let le=new Kh(av);ay=e=>le.aoMover(e),oy=e=>le.aoSair(e);let P=new Ci(new Hi(new Ii(1,1,1)),new di({color:0}));P.visible=!1,av.add(P);let F=null,ue=null,de=new H,fe=`lj-hotbar`,pe=xh(uy),me=()=>pe.slice(0,9).map(e=>e.id),he=(()=>{let e=new Set(pe.map(e=>e.id));e.add(900);let t=me();try{let n=JSON.parse(localStorage.getItem(fe)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),ge=0,_e=!1,ve=document.getElementById(`hotbar`),ye=_h(p.map?.image,[...bh.map(e=>e.id),900,902,903,904,905,906,907,908,909,910,911,912,913,914,915]),be=e=>e===900?`balde vazio`:e===901?`balde de água`:e===902?`fruta`:e===903?`trigo`:e===904?`pão`:e===905?`carvão`:e===906?`diamante`:e===907?`graveto`:e===908?`carvão vegetal`:e===909?`lingote de ferro`:e===910?`lingote de ouro`:e===911?`algodão`:e===912?`picareta de madeira`:e===913?`picareta de pedra`:e===914?`picareta de ferro`:e===915?`picareta de diamante`:bh.find(t=>t.id===e)?.name??`?`,xe=()=>{if(!ve)return;if(_e){ve.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${uy===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=gy.ativa?gy.hotbar():he,t=e.map((e,t)=>{let n=t===ge?` sel`:``;if(e==null)return`<span class="slot${n} vazio"><small>${t+1}</small></span>`;let r=gy.ativa?gy.qtdDoSlot(t):0,i=r>1?`<b class="qtd">${r}</b>`:``;return`<span class="slot${n}"><small>${t+1}</small><img src="${ye.get(e)??``}" alt="">${i}</span>`}).join(``),n=e[ge];ve.innerHTML=`<span class="bar-nome">${n==null?`mão vazia`:be(n)}</span><span class="slots">${t}</span>`,Sv?.refresh(),Tv?.refresh()},Se=()=>gy.ativa?gy.idDoSlot(ge):he[ge]??null;_y=()=>xe(),xe();let Ce=()=>{uy!==`professor`&&!wy||(_e=!_e,yv?.setVarinha(_e),xe())};$.onKey(bv.keys.varinha,Ce);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{ge=e,xe()});$.onWheel(e=>{ge=(ge+e+he.length)%he.length,xe()}),ve?.addEventListener(`pointerdown`,e=>{let t=e.target?.closest?.(`.slot`);if(!t)return;let n=[...ve.querySelectorAll(`.slot`)].indexOf(t);n<0||(e.preventDefault(),ge=n,xe())}),Sv=new Ch(ye,()=>pe,()=>({hotbar:he,selected:ge}),e=>{he[ge]=e,localStorage.setItem(fe,JSON.stringify(he)),xe()},e=>{ge=e,xe()},e=>{e?document.exitPointerLock():$.lock(),zv()},gy,(e,n)=>t.send(JSON.stringify({type:`mover_item`,de:e,para:n})),be,e=>t.send(JSON.stringify({type:`fabricar`,receita:e}))),$.onKey(bv.keys.inventario,()=>{!(Sv?.open??!1)&&!Rv()||Sv?.toggle()}),Tv=new Sh(ye,gy,be,(e,n,r,i,a)=>t.send(JSON.stringify({type:`mover_container`,x:e,y:n,z:r,de:i,para:a})),()=>t.send(JSON.stringify({type:`fechar_container`})),e=>{e?(xv?.hide(),Cv?.hide(),wv?.hide(),Sv?.hide(),document.exitPointerLock()):$.lock(),zv()});let we=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),ee.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(ue&&!_e){t.send(JSON.stringify({type:`atacar`,alvo:ue.id}));return}if(F){if(_e){we(1,F);return}Al(Se()??-1)&&py!==`criativo`||t.send(JSON.stringify({type:`break_block`,x:F.x,y:F.y,z:F.z}))}}),$.onMouseButton(2,()=>{if(gy.ativa&&Gu(Se()??-1)){t.send(JSON.stringify({type:`comer`,slot:ge}));return}if(!F)return;if(_e){we(2,F);return}{let e=Se();if(Al(e??-1)){let r=gy.ativa?{slot:ge}:{};if(e===901)t.send(JSON.stringify({type:`balde`,x:F.x+F.nx,y:F.y+F.ny,z:F.z+F.nz,encher:!1,...r})),gy.ativa||(he[ge]=900);else{if(Fu(n,F.x,F.y,F.z)!==K.Agua)return;t.send(JSON.stringify({type:`balde`,x:F.x,y:F.y,z:F.z,encher:!0,...r})),gy.ativa||(he[ge]=901)}gy.ativa||(localStorage.setItem(fe,JSON.stringify(he)),xe());return}}if(Xl(Fu(n,F.x,F.y,F.z))){let{x:e,y:n,z:r}=F;A.open(te.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(rd(Fu(n,F.x,F.y,F.z))!==null){t.send(JSON.stringify({type:`use_block`,x:F.x,y:F.y,z:F.z}));return}if(mu(Fu(n,F.x,F.y,F.z))){t.send(JSON.stringify({type:`use_block`,x:F.x,y:F.y,z:F.z}));return}let e=Se();if(e!==null){if((e===K.PortaXFechada||e===K.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.PortaXFechada:K.PortaZFechada),(e===K.JanelaXFechada||e===K.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.JanelaXFechada:K.JanelaZFechada),Zl(e)||Ql(e)||$l(e)||Xl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Zl(e)?K.CadeiraXP:Ql(e)?K.SofaXP:$l(e)?K.CamaXP:K.QuadroXP)+r}if(El(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw);e=kl(((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4)}if(Bl(e)){let t=e-+!!Vl(e);e=F.ny<0?t+1:t}if(Ul(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=ql(Kl(e),r,F.ny<0)}t.send(JSON.stringify({type:`place_block`,x:F.x+F.nx,y:F.y+F.ny,z:F.z+F.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!F||_e||gy.ativa)return;let e=Fu(n,F.x,F.y,F.z);ou(e)&&(e=K.PortaXFechada),uu(e)&&(e=K.JanelaXFechada),Zl(e)&&(e=K.CadeiraXP),Ql(e)&&(e=K.SofaXP),$l(e)&&(e=K.CamaXP),Xl(e)&&(e=K.QuadroXP),El(e)&&(e=K.Fornalha),Bl(e)&&(e=K.LajePedraBaixo+Hl(e)*2),Ul(e)&&(e=K.EscadaPedraXP+Kl(e)*8),_u(e)&&(vu(e)&&uy!==`professor`||(he[ge]=e,localStorage.setItem(fe,JSON.stringify(he)),xe()))});let Te=new Ag(iv,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Gv});Av=Te,Te.contexto=()=>({x:N.pos.x,y:N.pos.y,z:N.pos.z,yaw:$.yaw,pitch:$.pitch,voando:fy&&hy(),noChao:N.onGround,raioRender:bv.raioRender,meshMsPorFrame:bv.meshMsPorFrame,pixelRatioCap:bv.pixelRatioCap,fov:bv.fov,nuvens:bv.nuvens,balanco:bv.balanco,distanciaTotal:d,colunasRecebidas:u,bytesRecebidos:t.stats.bytesIn}),Te.setRemesh({count:b.remeshCount,totalMs:b.remeshMsTotal,workerMs:b.remeshWorkerMsTotal,config:b.meshConfig,lastMs:b.lastRemeshMs,porCaminho:b.porCaminho}),Te.carga=()=>Dv.relatorio(),Te.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Ee=null;if(_v){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);Yv.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let t=_v.semVida?`bench-semvida`:`bench`;Te.baixar(e,t),Yv.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${t}-*.json)`)}};Ov=()=>{if(Ee)return;Ee=uh.paraMundo(_v,ie,n.dims),Te.setMeta({bench:Ee.meta()}),Te.marcar(`bench: início`,`${_v.duracaoS}s · raio ${Ee.trajeto.raio}${_v.semVida?` · sem vida ambiental`:``}`),kv=!0,window.__benchRodando=!0,fy=!0,zv(),Ee.iniciar(performance.now());let t=Ee.amostra(performance.now());N.pos.x=je=t.x,N.pos.y=Me=t.y,N.pos.z=I=t.z,Te.record(t=>{kv=!1,window.__benchRodando=!1,zv(),window.__benchPerfil=t,e(t)},_v.duracaoS*1e3)}}$.onKey(bv.keys.hud,()=>Te.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{Te.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),i_()&&(ve&&(ve.style.pointerEvents=`auto`,ve.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(ge=n,xe())})),yv=new c_($,{keys:()=>bv.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>{!(Sv?.open??!1)&&!Rv()||Sv?.toggle()},chat:()=>{Yv.open||(document.exitPointerLock(),Yv.openInput())},menu:()=>{$.touch=!1,Fv(),zv()},hud:()=>Te.toggle(),varinha:()=>Ce(),amigos:()=>{!(wv?.open??!1)&&!Rv()||wv?.toggle()}}),yv.setVarinhaDisponivel(uy===`professor`||wy),yv.setAmigosDisponivel(wy),yv.setScale(bv.uiScale),zv()),Te.extra=()=>{let e=$.mouseStats,t=N.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=pd(i,a,r),s=bu(o),c=xu(o),l=Math.min(fd(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&s.neve?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===K.GramaSeca?`grama seca`:c===K.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se o bioma neva · chapada ≥85]\nrelevo ${Tu(o).toFixed(2)} (teto do bioma ${s.relevo})\nmodo ${py===`sobrevivencia`?`sobrevivência`:`criativo`}  voo ${hy()?fy?`voando`:`liberado`:`trancado`}`+(by?`  vida ${by.vida}/20`+(by.fome===void 0?`  sem fome`:`  fome ${by.fome}/20`):``)+`
mouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let De={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},Oe=0;setInterval(()=>{let e={x:N.pos.x,y:N.pos.y,z:N.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==De.x||e.y!==De.y||e.z!==De.z||e.yaw!==De.yaw||e.pitch!==De.pitch,r=performance.now();!n&&r-Oe<2e3||(De=e,Oe=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof bg&&Kv&&!_v&&(Qy(),setInterval(()=>void Qy(),3e4));let ke={...t.stats};setInterval(()=>{let e=t.stats;Te.net={msgsPerSec:e.msgsIn+e.msgsOut-(ke.msgsIn+ke.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(ke.bytesIn+ke.bytesOut),tickAvgMs:Xv.tickAvgMs,tickMaxMs:Xv.tickMaxMs,jitterMs:ty()},Te.regras=Zv,Te.stream={colunas:o.size,fila:b.filaPendente,faltando:c.size,repedidas:l,ultimoLote:b.ultimoLote},Te.luz=i.medidas,ke={...e}},1e3);let Ae=performance.now(),je=N.pos.x,Me=N.pos.y,I=N.pos.z,Ne=!1,Pe=!1,Fe=0,L=!1,Ie=0,R=Z.eyeHeight,Le=0;iv.setAnimationLoop(()=>{let e=performance.now(),t=e-Ae;Ae=e;let r=Math.min(t/1e3,.05),c=$.active?!!$.down(bv.keys.forward)-+!!$.down(bv.keys.back):0,l=$.active?!!$.down(bv.keys.right)-+!!$.down(bv.keys.left):0,u=$.active&&$.down(bv.keys.jump),p=$.active&&$.down(bv.keys.forward);p&&!Pe&&(e-Fe<300&&(Ne=!0),Fe=e),p||(Ne=!1),Pe=p;let h=$.active&&$.down(bv.keys.agachar),g=c>0&&!h&&(Ne||$.active&&$.down(bv.keys.correr));u&&!L&&(hy()&&e-Ie<300&&(fy=!fy),Ie=e),L=u;let _=fy&&hy(),v=!0;if(a){b.modoCarga=Dv.ativo;{let e=i.drenar(n,Dv.ativo?16:3,e=>o.has(e));for(let t of e)b.enfileirarColuna(t.cx,t.cz)}b.processarFila(bv.meshMsPorFrame,(e,t)=>{o.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(N.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(N.pos.z/16)));if(v=o.has(r*n.dims.x+t),(s=(s+1)%60)==0){for(let e of o){let a=e%n.dims.x,s=(e-a)/n.dims.x;if(Math.max(Math.abs(a-t),Math.abs(s-r))>bv.raioRender+2){o.delete(e),b.descartarColuna(a,s),D.descartarColuna(a,s),i.descartar(a,s);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+s)*n.dims.x+a]=void 0}}E(t,r,e);let a=bv.raioRender*16;O.cularPorDistancia(N.pos.x,N.pos.z,a),ee.cularPorDistancia(N.pos.x,N.pos.z,a)}Dv.ativo&&o.size>=oe&&i.filaVazia&&b.filaPendente===0&&Dv.concluir()}if(Ee?.ativo){let t=Ee.amostra(e);N.pos.x=t.x,N.pos.y=t.y,N.pos.z=t.z,N.vel.x=N.vel.y=N.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Ee.terminou(e)&&(Ee.parar(),Te.marcar(`bench: fim`))}let y=N.pos.y;v&&!Ee?.ativo&&fp(n,N,{forward:c,strafe:l,jump:u,yaw:$.yaw,sprint:g,sneak:h,fly:_},r);let k=N.pos.y-y;N.onGround&&!_&&k>.01&&k<=.56&&(Le=Math.min(Le+k,$f)),Le*=Math.exp(-r*14),Le<.002&&(Le=0),d+=Math.hypot(N.pos.x-je,N.pos.y-Me,N.pos.z-I),je=N.pos.x,Me=N.pos.y,I=N.pos.z,N.pos.y<-16&&ce(),le.interpolar(r);let te=1-Math.exp(-r*20);R+=((h&&!_?Z.sneakEyeHeight:Z.eyeHeight)-R)*te;let A=bv.fov*(N.sprinting?1.1:1);if(Math.abs(ov.fov-A)>.01&&(ov.fov+=(A-ov.fov)*te,ov.updateProjectionMatrix()),ov.position.set(N.pos.x,N.pos.y+R-Le,N.pos.z),ov.rotation.set($.pitch,$.yaw,0),ov.getWorldDirection(de),F=$.active?gp(n,ov.position.x,ov.position.y,ov.position.z,de.x,de.y,de.z,5,he[ge]===900):null,ue=$.active&&py===`sobrevivencia`&&my?mp(ov.position.x,ov.position.y,ov.position.z,de.x,de.y,de.z,le.alvosParaMira(),5):null,ue&&F){let e=Math.hypot(F.x+.5-ov.position.x,F.y+.5-ov.position.y,F.z+.5-ov.position.z);ue.dist>e&&(ue=null)}if(Pv?.classList.toggle(`alvo`,ue!==null),P.visible=F!==null&&ue===null,F){let[e,t,r,i,a,o]=$d(Fu(n,F.x,F.y,F.z));P.position.set(F.x+(e+i)/2,F.y+(t+a)/2,F.z+(r+o)/2),P.scale.set(i-e+.004,a-t+.004,o-r+.004)}Te.setRemesh({count:b.remeshCount,totalMs:b.remeshMsTotal,workerMs:b.remeshWorkerMsTotal,config:b.meshConfig,lastMs:b.lastRemeshMs,porCaminho:b.porCaminho}),dv.update(r),pv.ventoTempo.value=dv.fase*Math.PI*2,pv.ventoDir.value.set(dv.x,dv.z),pv.ventoForca.value=bv.balanco?dv.forca:0,lv.update(r,dv),m.nivelCeu.value=lv.nivelCeu,x.update(n,ov.position.x,ov.position.y,ov.position.z);let j=Math.floor(dv.fase*16)%16;C+=r;let ne=Math.floor(C*8)%16;(j!==S||ne!==w)&&C-T>=1/12&&(T=C,S=j,w=ne,Lm(f,j,dv.ondaAgua,ne));let re=performance.now();Te.gpuInicio(),iv.render(av,ov),Te.gpuFim(),Te.frame(t,performance.now()-re)}),a||Dv.concluir(),$y.has(`hud`)&&Te.toggle(),new URLSearchParams(location.search).has(`painel`)&&xv?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Sv?.toggle(),new URLSearchParams(location.search).has(`amigos`)&&wv?.toggle(),$y.has(`touch`)&&Bv()}