...
`;function fm(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function pm(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function mm(e){return`${(e/1e3).toFixed(1)} s`}var hm=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=dm,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(um*.25).toFixed(1)} ${um.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,um.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(um*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=mm(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${mm(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=fm(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=pm(n.bytes)}e.forcar.classList.toggle(`hidden`,o<cm||this.fase===`pronto`)}},gm={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`}},_m={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`},vm=`lj-config`;function ym(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function bm(e,t){return typeof e==`boolean`?e:t}function xm(){let e=null;try{e=JSON.parse(localStorage.getItem(vm)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...gm.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:ym(t.sensitivity,gm.sensitivity,.2,3),fov:ym(t.fov,gm.fov,60,100),pixelRatioCap:ym(t.pixelRatioCap,gm.pixelRatioCap,1,2),volume:ym(t.volume,gm.volume,0,1),raioRender:ym(t.raioRender,gm.raioRender,2,12),meshMsPorFrame:ym(t.meshMsPorFrame,gm.meshMsPorFrame,1,16),uiScale:ym(t.uiScale,gm.uiScale,.6,1.8),nuvens:bm(t.nuvens,gm.nuvens),balanco:bm(t.balanco,gm.balanco),keys:r}}function Sm(e){localStorage.setItem(vm,JSON.stringify(e))}function Cm(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var wm=`logica-em-jogo`,Tm=`worlds`;function Em(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var Dm=null;function Om(){return Dm??=new Promise((e,t)=>{let n=indexedDB.open(wm,1);n.onupgradeneeded=()=>{n.result.createObjectStore(Tm,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),Dm}async function km(){return(await Em((await Om()).transaction(Tm).objectStore(Tm).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function Am(e){await Em((await Om()).transaction(Tm,`readwrite`).objectStore(Tm).put(e))}async function jm(e){await Em((await Om()).transaction(Tm,`readwrite`).objectStore(Tm).delete(e))}function Mm(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function Nm(e){let t=await e.arrayBuffer();Jd(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function Pm(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function Fm(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var Im=`
#touch-ui { --ts: 1; }
...
`,Lm=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Im,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.tapButton(`⛶`,`tela cheia`,()=>Fm()),this.tapButton(`📊`,`hud`,()=>this.actions.hud())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){this.root.style.setProperty(`--ts`,String(e))}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},Rm=`lj-nome`;function zm(){let e=localStorage.getItem(Rm),t=e?yu(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(Rm,t),t}function Bm(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function Vm(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function Hm(e){document.getElementById(e)?.classList.add(`hidden`)}function Um(e){let t=Bm(`menu`),n={home:Bm(`menu-home`),worlds:Bm(`menu-worlds`),multi:Bm(`menu-multi`),config:Bm(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),Bm(`menu-version`).textContent=`v${Zd}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Hf(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),Vm(`menu-erro`,i));let a=Bm(`menu-nome`);a.value=zm(),a.addEventListener(`change`,()=>{let e=yu(a.value);localStorage.setItem(Rm,e),a.value=e}),Bm(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),Bm(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),Bm(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=Bm(`menu-world-list`);async function c(){let e=[];try{e=await km()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>Mm(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){jm(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=Bm(`menu-new-nome`),u=Bm(`menu-new-tipo`);Bm(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){Vm(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}Hm(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:Eu(u.value),tamanho:Du(Bm(`menu-new-tamanho`).value)})});let d=Bm(`menu-import-file`);Bm(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&Nm(e).then(async e=>{await Am(e),await c(),Hm(`menu-worlds-erro`)}).catch(e=>{Vm(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=Bm(`menu-endereco`),p=Bm(`menu-pin`),m=Bm(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,Bm(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){Vm(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){Vm(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}Hm(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),Wm(Bm(`menu-config-body`),void 0,()=>r(`home`))}function Wm(e,t,n){qm(e,t,n)}function Gm(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var Km=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function qm(e,t,n){e.textContent=``;for(let r of Km){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>Jm(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{Sm(structuredClone(gm)),t?.(),qm(e,t,n)}),e.appendChild(r),n&&Gm(e,n)}function Jm(e,t,n,r){e.textContent=``;let i=xm(),a=()=>{Sm(i),n?.()},o=document.createElement(`h2`);o.textContent=Km.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),Pm()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(_m)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=_m[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=Cm(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=Cm(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Bf(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>Hf(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t);let r=(t,n,r)=>{let i=document.createElement(`label`);i.className=`config-row`,i.textContent=`${t} `;let o=document.createElement(`input`);o.type=`checkbox`,o.checked=n,o.addEventListener(`change`,()=>{r(o.checked),a()}),i.appendChild(o),e.appendChild(i)};r(`nuvens no céu`,i.nuvens,e=>i.nuvens=e),r(`balanço de folhas e grama`,i.balanco,e=>i.balanco=e),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`tempo de montagem de malha por frame`,1,16,1,i.meshMsPorFrame,e=>i.meshMsPorFrame=e,e=>`${e} ms`)}Gm(e,()=>qm(e,n,r))}var Ym=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},Xm=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Hf(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},Zm=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Hf(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},Qm=class extends Zm{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(ip[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=bu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=bu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...ip.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},$m=class extends Zm{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},eh=class{fixedColor;group=new cn;cornerMarks=[];boxes=[];constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Ci(new Hi(new Ii(1.01,1.01,1.01)),new di({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Ci(new Hi(new Ii(n+.04,r+.04,i+.04)),new di({color:this.fixedColor??new W().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a})}},th=1/16,nh=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*th-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*th-.004,ry:Math.PI}];function rh(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var ih=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(_d(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=_d(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=gu(t,e.x,e.y,e.z);if(!Rl(r))return;let i=nh[r-K.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,rh(a,e,null);let o=new Mi(a);o.colorSpace=Le;let s=new $r(new Ui(12*th,12*th),new Vr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{rh(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=_d(e,t,n);if(this.conteudos.has(a))if(!Rl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Rl(gu(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function ah(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var oh=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,ah(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},sh=null;function ch(e){e.preventDefault(),e.returnValue=``}var lh=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function uh(e){sh?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||lh.has(e.code))&&e.preventDefault())}function dh(e){sh?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function fh(e){sh||(sh=e,window.addEventListener(`beforeunload`,ch),window.addEventListener(`keydown`,uh,!0),window.addEventListener(`keyup`,dh,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function ph(){sh=null,window.removeEventListener(`beforeunload`,ch),window.removeEventListener(`keydown`,uh,!0),window.removeEventListener(`keyup`,dh,!0),navigator.keyboard?.unlock?.()}var mh=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Mi(t);i.minFilter=o,this.material=new _r({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[pu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===K.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===K.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===K.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new jr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function hh(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&pp(n)}var gh=new _l({antialias:!0});gh.setPixelRatio(Math.min(window.devicePixelRatio,2)),gh.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(gh.domElement);var _h=new _n;_h.background=new W(8900331);var vh=new ja(75,window.innerWidth/window.innerHeight,.1,512);vh.rotation.order=`YXZ`;var yh=new Pa(16777215,2.2);yh.position.set(60,100,40);var bh=new Fa(16777215,.55);_h.add(yh,bh);var xh=new Up(yh,bh,_h,vh),Sh=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();Sh!==null&&xh.sync(Sh,!1);var Ch=new qp,wh=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();wh&&Ch.sync(wh.dir,wh.forca,!0);var Th=Yp(),$=new sm(gh.domElement),Eh=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},Dh=Eh(`yaw`),Oh=Eh(`pitch`);Dh!==null&&($.yaw=Dh),Oh!==null&&($.pitch=Oh);var kh=Qf(new URLSearchParams(location.search));function Ah(){let e=kh?{...xm(),...Zf}:xm();return $.sensitivity=e.sensitivity,vh.fov=e.fov,vh.updateProjectionMatrix(),gh.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Bf(e.volume),jh?.setScale(e.uiScale),xh.setNuvens(e.nuvens),e}var jh=null,Mh=Ah();Wf(Mh.volume);var Nh=null,Ph=null,Fh=null,Ih=new hm(()=>{Gh(),zh?.setFase(`jogando`),zh?.marcar(`carga concluída`),Lh?.()}),Lh=null,Rh=!1,zh=null,Bh=document.getElementById(`overlay`),Vh=document.getElementById(`overlay-main`),Hh=document.getElementById(`overlay-config`),Uh=document.getElementById(`crosshair`);function Wh(){Vh?.classList.remove(`hidden`),Hh?.classList.add(`hidden`)}function Gh(){let e=(Nh?.open??!1)||(Ph?.open??!1)||(Fh?.open??!1);Bh?.classList.toggle(`hidden`,Rh||Ih.ativo||$.active||eg.open||e),Uh?.classList.toggle(`hidden`,!$.active),$.locked&&Wh(),jh?.setShown($.touch&&!eg.open&&!e&&!Ih.ativo)}document.addEventListener(`pointerlockchange`,Gh);function Kh(){Pm()?($.touch=!0,Fm(),Gh()):$.lock()}function qh(){let e=Mh.keys;Mh=Ah();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],Mh.keys[t]);Yh()}var Jh=-1;function Yh(){if(!Xh||Mh.raioRender===Jh)return;let e=Jh;Jh=Mh.raioRender,Xh.send(JSON.stringify({type:`radius`,chunks:Jh})),zh?.marcar(`raio`,`${e<0?`join`:e} → ${Jh}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Kh()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Wm(e,qh,Wh),Vh?.classList.add(`hidden`),Hh?.classList.remove(`hidden`)}),Bh?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Hf(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{vh.aspect=window.innerWidth/window.innerHeight,vh.updateProjectionMatrix(),gh.setSize(window.innerWidth,window.innerHeight)});var Xh=null,Zh=`?`,Qh=null;function $h(){return new URLSearchParams(location.search).get(`nome`)??zm()}var eg=new yp(e=>Xh?.send(JSON.stringify({type:`chat`,text:e})),e=>{Gh(),e||$.lock()});Gh(),gh.domElement.addEventListener(`pointerdown`,()=>{$.touch&&eg.open&&eg.close()});var tg={tickAvgMs:0,tickMaxMs:0},ng=null,rg=0,ig=[];function ag(){let e=performance.now();rg>0&&(ig.push(e-rg),ig.length>300&&ig.shift()),rg=e}function og(){let e=ig.length;if(e<2)return 0;let t=ig.reduce((e,t)=>e+t,0)/e,n=ig.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var sg=!1,cg=null,lg=null,ug=null,dg=null,fg=null,pg=null,mg=null,hg=`aluno`,gg=!1,_g=!1;function vg(){return hg===`professor`||gg}var yg=[],bg=null,xg=!1,Sg=[],Cg=null,wg=null,Tg=null,Eg=new Ym,Dg=null,Og=null,kg=null,Ag=[],jg=new Set,Mg=!1,Ng=null,Pg=null,Fg=!1,Ig=new Map;function Lg(){Nh?.update({regions:yg,modo:Dg?.modo??`sequencial`,objetivos:Dg?.objetivos??[],grupos:Ag,myGrupo:kg})}function Rg(e){return e.porGrupo&&hg!==`professor`?kg===null?!1:e.porGrupo.find(e=>e.grupo===kg)?.completo??!1:e.completo}function zg(e){if(Dg){for(let t of Dg.objetivos)Rg(t)?jg.has(t.id)||(jg.add(t.id),e&&Mg&&Ff({kind:`objective_complete`})):jg.delete(t.id);Mg=!0,Eg.update(Dg.modo,Dg.objetivos,{grupo:kg,professor:hg===`professor`,painelKey:Cm(Mh.keys.painel)}),Og?.(Dg.objetivos)}}var Bg=null;function Vg(){let e=Bg;if(e){Bg=null;for(let t of e)Ug(t)}}function Hg(){Bg||(Bg=[],requestAnimationFrame(()=>requestAnimationFrame(Vg)),setTimeout(Vg,500))}function Ug(e){if(Bg){Bg.push(e);return}if(ag(),sg||Ih.setFase(`mundo`),typeof e==`string`){let t=Rd(e);if(!t)return;t.type===`debug_stats`?(tg={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},ng=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0}):t.type===`block_changed`?cg?.(t):t.type===`blocks_filled`?lg?.(t):t.type===`player_moved`?(t.name&&Ig.get(t.id)!==t.name&&(Ig.set(t.id,t.name),mp([...new Set(Ig.values())])),ug?.(t)):t.type===`player_left`?(Ig.delete(t.id),mp([...new Set(Ig.values())]),dg?.(t.id)):t.type===`spawn`?(mg={x:t.x,y:t.y,z:t.z},hg=t.papel??`aluno`):t.type===`regions`?(yg=t.regions,bg?.(t.regions),Lg()):t.type===`objectives`?(Dg={modo:t.modo,objetivos:t.objetivos},zg(!0),Lg()):t.type===`group`?(kg=t.grupo,jg.clear(),zg(!1),Lg()):t.type===`groups`?(Ag=t.grupos,Lg()):t.type===`quadros`?wg?.(t.lista):t.type===`quadro_changed`?Tg?.(t):t.type===`claims`?(xg=t.ativo,Sg=t.claims,Cg?.(t.claims)):t.type===`friends`||(t.type===`players`?Fh?.update({conectados:t.conectados,banidos:t.banidos}):t.type===`mundo_trocando`?(fg?.(t.nome),Hg()):t.type===`teleport`?pg?.(t):t.type===`time`?Sh===null&&xh.sync(t.hora,t.ciclo):t.type===`vento`?wh===null&&Ch.sync(t.dir,t.forca,t.ativo):t.type===`voo`?(gg=t.liberado,vg()||(_g=!1),eg.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(Hf(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),ph(),location.href=location.pathname):t.type===`join_denied`?(Hf(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),ph(),location.href=location.pathname):t.type===`chat`&&(eg.addMessage(t.author,t.text),t.author===`servidor`&&hh(t.text),Ff({kind:`chat_message`})));return}let t=Hd(e);if(t===809716300){Pg?.(e);return}let n=()=>(Fg=t===Bd,Fg?Ud(e):zd(e));if(sg){Ng?.(n());return}sg=!0,Xg(n())}function Wg(e,t){Mh=Ah(),Xh=e,Ih.abrir({host:Zh,rede:!(e instanceof Xp)}),Ih.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),Gh(),e.onMessage(Ug),$.onKey(Mh.keys.chat,()=>{eg.open||(document.exitPointerLock(),eg.openInput())}),e.send(JSON.stringify({type:`join`,name:$h(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),Jh=-1,Yh()}function Gg(e,t){Zh=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Wg(new Zp(e,t=>{sg||!Ih.ativo||Ih.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function Kg(e,t){Qh={id:e.id,name:e.name,createdAt:e.createdAt},Zh=`web-worker (${e.name})`;let n=new Xp(new Worker(new URL(`/assets/worker-CsiYWUCI.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho}),Wg(n)}async function qg(){if(!(Xh instanceof Xp)||!Qh)return;let e=await Xh.requestSave();await Am({...Qh,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{ph(),qg().finally(()=>location.reload())});var Jg=new URLSearchParams(location.search),Yg=Jg.get(`server`);if(Yg){let e=Jg.get(`codigo`);Gg(Yg,{pin:Jg.get(`pin`)??``,...e?{codigo:e}:{}})}else kh?Kg({id:`bench-${Gf}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:Du(Jg.get(`tamanho`)??`E`)},Gf):Um({onPlayWorld:Kg,onPlayMulti:Gg});function Xg(e){let t=Xh;if(!t)return;fh(()=>$.active);let n=e.world,r=e.seed,i=Fg,a=new Set,s=0,c=new Map,l=0,u=0,d=0,f=Of(),p=new ea({map:f,alphaTest:.5});Jp(p,Th);let m=new ea({map:f,transparent:!0,opacity:.72,depthWrite:!1}),h=new ea({map:f,transparent:!0,opacity:.4,depthWrite:!1});if(new URLSearchParams(location.search).has(`atlas`)){let e=p.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let g=new URLSearchParams(location.search),_=g.has(`semworker`),v=Number(g.get(`meshdepth`)),y=new Ep(n,[p,m,h],_h,!_,Number.isFinite(v)&&v>0?v:void 0),b=new jf(_h),x=-1;i||y.buildAll(),Pg=e=>{let t=[];try{t=Gd(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;a.add(t),c.delete(t),y.enfileirarColuna(e,r),C.varrerColuna(n,e,r)}u+=t.length};let S=(e,r,i)=>{let o=n.dims,s=Mh.raioRender,u=0;for(let d=e-s;d<=e+s;d++)for(let e=r-s;e<=r+s;e++){if(d<0||e<0||d>=o.x||e>=o.z)continue;let r=e*o.x+d;if(a.has(r))continue;let s=c.get(r);if(!s){c.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||u>=4)){y.descartarColuna(d,e),C.descartarColuna(d,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+d]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:d,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),u++,l++}}for(let t of c.keys()){let n=t%o.x,i=(t-n)/o.x;(a.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&c.delete(t)}},C=new mh(_h);C.setFromWorld(n);let w=new eh(_h);w.setRegions(yg),bg=e=>{w.setRegions(e),w.clearCorners()};let T=new eh(_h,16747546),E=e=>{T.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};E(Sg),Cg=e=>{E(e),w.clearCorners(),!xg&&hg!==`professor`&&he&&(he=!1),ye()};let D=new ih(_h),ee=new oh;wg=e=>D.setAll(e,n),Tg=e=>D.aplicar(e,n);let te=new eh(_h,3066993),O=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=kg!==null&&r.grupo===kg;(hg===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});te.setRegions(t)};Og=O,Dg&&O(Dg.objetivos);let ne=e=>t.send(JSON.stringify({type:`chat`,text:e})),k=e=>{e?document.exitPointerLock():$.lock(),Gh()};hg===`professor`&&(Fh=new Xm(ne,k)),Nh=hg===`professor`?new Qm(ne,k,()=>{Nh?.hide(),Ph?.hide(),Fh?.show()}):new $m(ne,k),Lg(),$.onKey(Mh.keys.painel,()=>{if(!eg.open){if(hg!==`professor`&&Ag.length===0){eg.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}Ph?.hide(),Fh?.hide(),Nh?.toggle()}}),hg===`professor`&&eg.addMessage(`jogo`,`tecla ${Cm(Mh.keys.painel)} abre o painel de autoria`);let A=mg??{x:n.sizeX/2+.5,y:vu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},j=rd(A.x,A.y,A.z),re=()=>{if(!i)return 0;let e=Mh.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(j.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(j.pos.z/16))),a=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,o=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,a*o)},M=re(),ie=()=>{Ih.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:a.size,total:M,faltando:c.size>0?c.size:Math.max(0,M-a.size),fila:y.filaPendente}))};ie(),Ih.setFase(i?`mundo`:`malha`),fg=e=>{M=0,Ih.abrir({host:Zh,rede:!(t instanceof Xp),titulo:`trocando de aula`,alvo:e}),ie(),Ih.setFase(`preparando`),F.setFase(`carregando`),F.marcar(`troca de aula`,e),Gh()};function ae(){j.pos.x=A.x,j.pos.y=A.y,j.pos.z=A.z,j.vel.x=j.vel.y=j.vel.z=0}Ng=e=>{n=e.world,r=e.seed,i=Fg,a=new Set,c.clear(),y.trocarMundo(n,!i),C.setFromWorld(n),yg=[],w.setRegions([]),w.clearCorners(),D.setAll([],n),Dg=null,Og?.([]),Eg.update(`livre`,[],{grupo:null,professor:hg===`professor`,painelKey:Cm(Mh.keys.painel)}),jg.clear(),Mg=!1,Ag=[],kg=null,Lg(),A=mg??A,ae(),eg.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),Jh=-1,Yh(),F.setMeta({worldChunks:n.dims,worldSeed:e.seed}),M=re(),Ih.abrir({host:Zh,rede:!(t instanceof Xp),titulo:`trocando de aula`}),ie(),Ih.setFase(i?`mundo`:`malha`),F.setFase(`carregando`),Gh(),i||Ih.concluir()},pg=e=>{j.pos.x=e.x,j.pos.y=e.y,j.pos.z=e.z,j.vel.x=j.vel.y=j.vel.z=0,$.yaw=Dh??e.yaw,$.pitch=Oh??e.pitch},cg=e=>{_u(n,e.x,e.y,e.z,e.blockId),y.remeshBlock(e.x,e.y,e.z),C.onBlockChanged(e.x,e.y,e.z,e.blockId),D.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Ff(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},lg=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)_u(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};y.remeshBox(t,r),C.onRegionFilled(t,r,e.blockId),D.validarTodos(n),Ff(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let oe=new Map,se=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Mi(t);i.minFilter=o;let a=new jr(new _r({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Z.height/2+.35,0),a},ce=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};ug=e=>{let t=oe.get(e.id);if(!t){let n=new $r(new Ii(Z.width,Z.height,Z.width),new ea({color:new W().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Z.height/2,e.z),n.rotation.y=e.yaw,_h.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},oe.set(e.id,t)}e.name&&e.name!==t.labelName&&(ce(t),t.label=se(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Z.height/2,e.z),t.targetYaw=e.yaw},dg=e=>{let t=oe.get(e);t&&(ce(t),_h.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),oe.delete(e))};let le=new Ci(new Hi(new Ii(1,1,1)),new di({color:0}));le.visible=!1,_h.add(le);let N=null,P=new H,ue=`lj-hotbar`,de=ap(hg),fe=()=>de.slice(0,9).map(e=>e.id),pe=(()=>{let e=new Set(de.map(e=>e.id));e.add(900);let t=fe();try{let n=JSON.parse(localStorage.getItem(ue)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),me=0,he=!1,ge=document.getElementById(`hotbar`),_e=tp(p.map?.image,[...ip.map(e=>e.id),900]),ve=e=>e===900?`balde vazio`:e===901?`balde de água`:ip.find(t=>t.id===e)?.name??`?`,ye=()=>{if(!ge)return;if(he){ge.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${hg===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=pe.map((e,t)=>`<span class="slot${t===me?` sel`:``}"><small>${t+1}</small><img src="${_e.get(e)??``}" alt=""></span>`).join(``);ge.innerHTML=`<span class="bar-nome">${ve(pe[me]??K.Grass)}</span><span class="slots">${e}</span>`,Ph?.refresh()};ye();let be=()=>{hg!==`professor`&&!xg||(he=!he,ye())};$.onKey(Mh.keys.varinha,be);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{me=e,ye()});$.onWheel(e=>{me=(me+e+pe.length)%pe.length,ye()}),Ph=new op(_e,()=>de,()=>({hotbar:pe,selected:me}),e=>{pe[me]=e,localStorage.setItem(ue,JSON.stringify(pe)),ye()},e=>{me=e,ye()},e=>{e?(Nh?.hide(),Fh?.hide(),document.exitPointerLock()):$.lock(),Gh()}),$.onKey(Mh.keys.inventario,()=>{eg.open||Ph?.toggle()});let xe=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),w.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(N){if(he){xe(1,N);return}Cl(pe[me]??-1)||t.send(JSON.stringify({type:`break_block`,x:N.x,y:N.y,z:N.z}))}}),$.onMouseButton(2,()=>{if(!N)return;if(he){xe(2,N);return}{let e=pe[me];if(Cl(e??-1)){if(e===901)t.send(JSON.stringify({type:`balde`,x:N.x+N.nx,y:N.y+N.ny,z:N.z+N.nz,encher:!1})),pe[me]=900;else{if(gu(n,N.x,N.y,N.z)!==K.Agua)return;t.send(JSON.stringify({type:`balde`,x:N.x,y:N.y,z:N.z,encher:!0})),pe[me]=901}localStorage.setItem(ue,JSON.stringify(pe)),ye();return}}if(Rl(gu(n,N.x,N.y,N.z))){let{x:e,y:n,z:r}=N;ee.open(D.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(eu(gu(n,N.x,N.y,N.z))){t.send(JSON.stringify({type:`use_block`,x:N.x,y:N.y,z:N.z}));return}let e=pe[me];if(e!==void 0){if((e===K.PortaXFechada||e===K.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.PortaXFechada:K.PortaZFechada),(e===K.JanelaXFechada||e===K.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.JanelaXFechada:K.JanelaZFechada),zl(e)||Bl(e)||Vl(e)||Rl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(zl(e)?K.CadeiraXP:Bl(e)?K.SofaXP:Vl(e)?K.CamaXP:K.QuadroXP)+r}if(Ol(e)){let t=e-+!!kl(e);e=N.ny<0?t+1:t}if(jl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Fl(Pl(e),r,N.ny<0)}t.send(JSON.stringify({type:`place_block`,x:N.x+N.nx,y:N.y+N.ny,z:N.z+N.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!N||he)return;let e=gu(n,N.x,N.y,N.z);Kl(e)&&(e=K.PortaXFechada),Xl(e)&&(e=K.JanelaXFechada),zl(e)&&(e=K.CadeiraXP),Bl(e)&&(e=K.SofaXP),Vl(e)&&(e=K.CamaXP),Rl(e)&&(e=K.QuadroXP),Ol(e)&&(e=K.LajePedraBaixo+Al(e)*2),jl(e)&&(e=K.EscadaPedraXP+Pl(e)*8),ru(e)&&(iu(e)&&hg!==`professor`||(pe[me]=e,localStorage.setItem(ue,JSON.stringify(pe)),ye()))});let F=new om(gh,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Zh});zh=F,F.contexto=()=>({x:j.pos.x,y:j.pos.y,z:j.pos.z,yaw:$.yaw,pitch:$.pitch,voando:_g&&vg(),noChao:j.onGround,raioRender:Mh.raioRender,meshMsPorFrame:Mh.meshMsPorFrame,pixelRatioCap:Mh.pixelRatioCap,fov:Mh.fov,distanciaTotal:d,colunasRecebidas:u,bytesRecebidos:t.stats.bytesIn}),F.setRemesh({count:y.remeshCount,totalMs:y.remeshMsTotal,workerMs:y.remeshWorkerMsTotal,config:y.meshConfig,lastMs:y.lastRemeshMs,porCaminho:y.porCaminho}),F.carga=()=>Ih.relatorio(),F.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Se=null;if(kh){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);eg.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{F.baixar(e,`bench`),eg.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-bench-*.json)`)}};Lh=()=>{if(Se)return;Se=$f.paraMundo(kh.duracaoS,A,n.dims),F.setMeta({bench:Se.meta()}),F.marcar(`bench: início`,`${kh.duracaoS}s · raio ${Se.trajeto.raio}`),Rh=!0,_g=!0,Gh(),Se.iniciar(performance.now());let t=Se.amostra(performance.now());j.pos.x=De=t.x,j.pos.y=Oe=t.y,j.pos.z=ke=t.z,F.record(t=>{Rh=!1,Gh(),window.__benchPerfil=t,e(t)},kh.duracaoS*1e3)}}$.onKey(Mh.keys.hud,()=>F.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{F.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),Pm()&&(ge&&(ge.style.pointerEvents=`auto`,ge.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(me=n,ye())})),jh=new Lm($,{keys:()=>Mh.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>Ph?.toggle(),chat:()=>{eg.open||(document.exitPointerLock(),eg.openInput())},menu:()=>{$.touch=!1,Wh(),Gh()},hud:()=>F.toggle(),varinha:()=>be()}),jh.setScale(Mh.uiScale),Gh()),F.extra=()=>{let e=$.mouseStats,t=j.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=Mu(i,a,r),s=ou(o),c=su(o),l=Math.min(ju(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&o.temp<.6?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===K.GramaSeca?`grama seca`:c===K.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se temp<0.60 · chapada ≥85]\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let Ce={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},we=0;setInterval(()=>{let e={x:j.pos.x,y:j.pos.y,z:j.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==Ce.x||e.y!==Ce.y||e.z!==Ce.z||e.yaw!==Ce.yaw||e.pitch!==Ce.pitch,r=performance.now();!n&&r-we<2e3||(Ce=e,we=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof Xp&&Qh&&!kh&&(qg(),setInterval(()=>void qg(),3e4));let Te={...t.stats};setInterval(()=>{let e=t.stats;F.net={msgsPerSec:e.msgsIn+e.msgsOut-(Te.msgsIn+Te.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(Te.bytesIn+Te.bytesOut),tickAvgMs:tg.tickAvgMs,tickMaxMs:tg.tickMaxMs,jitterMs:og()},F.regras=ng,F.stream={colunas:a.size,fila:y.filaPendente,faltando:c.size,repedidas:l,ultimoLote:y.ultimoLote},Te={...e}},1e3);let Ee=performance.now(),De=j.pos.x,Oe=j.pos.y,ke=j.pos.z,Ae=!1,je=!1,Me=0,I=!1,Ne=0,Pe=Z.eyeHeight,Fe=0;gh.setAnimationLoop(()=>{let e=performance.now(),t=e-Ee;Ee=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(Mh.keys.forward)-+!!$.down(Mh.keys.back):0,c=$.active?!!$.down(Mh.keys.right)-+!!$.down(Mh.keys.left):0,l=$.active&&$.down(Mh.keys.jump),u=$.active&&$.down(Mh.keys.forward);u&&!je&&(e-Me<300&&(Ae=!0),Me=e),u||(Ae=!1),je=u;let p=$.active&&$.down(Mh.keys.agachar),m=o>0&&!p&&(Ae||$.active&&$.down(Mh.keys.correr));l&&!I&&(vg()&&e-Ne<300&&(_g=!_g),Ne=e),I=l;let h=_g&&vg(),g=!0;if(i){y.modoCarga=Ih.ativo,y.processarFila(Mh.meshMsPorFrame,(e,t)=>{a.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(j.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(j.pos.z/16)));if(g=a.has(r*n.dims.x+t),(s=(s+1)%60)==0){for(let e of a){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>Mh.raioRender+2){a.delete(e),y.descartarColuna(i,o),C.descartarColuna(i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}S(t,r,e)}Ih.ativo&&a.size>=M&&y.filaPendente===0&&Ih.concluir()}if(Se?.ativo){let t=Se.amostra(e);j.pos.x=t.x,j.pos.y=t.y,j.pos.z=t.z,j.vel.x=j.vel.y=j.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Se.terminou(e)&&(Se.parar(),F.marcar(`bench: fim`))}let _=j.pos.y;g&&!Se?.ativo&&md(n,j,{forward:o,strafe:c,jump:l,yaw:$.yaw,sprint:m,sneak:p,fly:h},r);let v=j.pos.y-_;j.onGround&&!h&&v>.01&&v<=.56&&(Fe=Math.min(Fe+v,td)),Fe*=Math.exp(-r*14),Fe<.002&&(Fe=0),d+=Math.hypot(j.pos.x-De,j.pos.y-Oe,j.pos.z-ke),De=j.pos.x,Oe=j.pos.y,ke=j.pos.z,j.pos.y<-16&&ae();let w=1-Math.exp(-r*12);for(let e of oe.values()){e.mesh.position.lerp(e.target,w);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*w}let T=1-Math.exp(-r*20);Pe+=((p&&!h?Z.sneakEyeHeight:Z.eyeHeight)-Pe)*T;let E=Mh.fov*(j.sprinting?1.1:1);if(Math.abs(vh.fov-E)>.01&&(vh.fov+=(E-vh.fov)*T,vh.updateProjectionMatrix()),vh.position.set(j.pos.x,j.pos.y+Pe-Fe,j.pos.z),vh.rotation.set($.pitch,$.yaw,0),vh.getWorldDirection(P),N=$.active?gd(n,vh.position.x,vh.position.y,vh.position.z,P.x,P.y,P.z,5,pe[me]===900):null,le.visible=N!==null,N){let[e,t,r,i,a,o]=Ru(gu(n,N.x,N.y,N.z));le.position.set(N.x+(e+i)/2,N.y+(t+a)/2,N.z+(r+o)/2),le.scale.set(i-e+.004,a-t+.004,o-r+.004)}F.setRemesh({count:y.remeshCount,totalMs:y.remeshMsTotal,workerMs:y.remeshWorkerMsTotal,config:y.meshConfig,lastMs:y.lastRemeshMs,porCaminho:y.porCaminho}),Ch.update(r),Th.ventoTempo.value=Ch.fase*Math.PI*2,Th.ventoDir.value.set(Ch.x,Ch.z),Th.ventoForca.value=Mh.balanco?Ch.forca:0,xh.update(r,Ch),b.update(n,vh.position.x,vh.position.y,vh.position.z);let D=Math.floor(Ch.fase*16)%16;D!==x&&(x=D,Df(f,D,Ch.ondaAgua));let ee=performance.now();F.gpuInicio(),gh.render(_h,vh),F.gpuFim(),F.frame(t,performance.now()-ee)}),i||Ih.concluir(),Jg.has(`hud`)&&F.toggle(),new URLSearchParams(location.search).has(`painel`)&&Nh?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Ph?.toggle(),Jg.has(`touch`)&&Kh()}