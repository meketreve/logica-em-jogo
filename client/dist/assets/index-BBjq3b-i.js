...
}`)},e.needsUpdate=!0}function Sg(){return{ventoTempo:{value:0},ventoDir:{value:new V(1,0)},ventoForca:{value:0}}}function Cg(){return{nivelCeu:{value:1},luzMin:{value:.05}}}function wg(e,t){let n=e.onBeforeCompile;e.onBeforeCompile=(r,i)=>{n?.call(e,r,i),r.uniforms.nivelCeu=t.nivelCeu,r.uniforms.luzMin=t.luzMin,r.vertexShader=r.vertexShader.replace(`#include <common>`,`#include <common>
attribute float luz;
...
`;function Vg(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function Hg(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function Ug(e){return`${(e/1e3).toFixed(1)} s`}var Wg=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=Bg,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(zg*.25).toFixed(1)} ${zg.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,zg.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(zg*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=Ug(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${Ug(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=Vg(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=Hg(n.bytes)}e.forcar.classList.toggle(`hidden`,o<Lg||this.fase===`pronto`)}},Gg={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`,amigos:`KeyG`}},Kg={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`,amigos:`painel de amigos (áreas compartilhadas)`},qg=`lj-config`;function Jg(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function Yg(e,t){return typeof e==`boolean`?e:t}function Xg(){let e=null;try{e=JSON.parse(localStorage.getItem(qg)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...Gg.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:Jg(t.sensitivity,Gg.sensitivity,.2,3),fov:Jg(t.fov,Gg.fov,60,100),pixelRatioCap:Jg(t.pixelRatioCap,Gg.pixelRatioCap,1,2),volume:Jg(t.volume,Gg.volume,0,1),raioRender:Jg(t.raioRender,Gg.raioRender,2,12),meshMsPorFrame:Jg(t.meshMsPorFrame,Gg.meshMsPorFrame,1,16),uiScale:Jg(t.uiScale,Gg.uiScale,.6,1.8),nuvens:Yg(t.nuvens,Gg.nuvens),balanco:Yg(t.balanco,Gg.balanco),keys:r}}function Zg(e){localStorage.setItem(qg,JSON.stringify(e))}function Qg(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var $g=`logica-em-jogo`,e_=`worlds`;function t_(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var n_=null;function r_(){return n_??=new Promise((e,t)=>{let n=indexedDB.open($g,1);n.onupgradeneeded=()=>{n.result.createObjectStore(e_,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),n_}async function i_(){return(await t_((await r_()).transaction(e_).objectStore(e_).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function a_(e){await t_((await r_()).transaction(e_,`readwrite`).objectStore(e_).put(e))}async function o_(e){await t_((await r_()).transaction(e_,`readwrite`).objectStore(e_).delete(e))}function s_(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function c_(e){let t=await e.arrayBuffer();Qp(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function l_(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function u_(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var d_=`
:root { --ts: 1; }
...
`;function M_(e){return`url("data:image/svg+xml,${encodeURIComponent(e)}")`}var N_=M_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#e23b3b" stroke="#5a0d0d" stroke-width="1.2"/></svg>`),P_=M_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#1a1a1a" stroke="#000" stroke-width="1.2"/></svg>`),F_=M_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#7fd4ff" stroke="#0a3550" stroke-width="1.2"/><circle cx="5.8" cy="5.8" r="1.6" fill="#fff" opacity="0.9"/></svg>`),I_=(e,t,n)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M12.8 12.8 8.6 8.6" stroke="${t}" stroke-width="3" stroke-linecap="round"/><circle cx="12.9" cy="12.9" r="2.1" fill="${t}" stroke="${n}" stroke-width="0.9"/><circle cx="6" cy="6" r="4.7" fill="${e}" stroke="${n}" stroke-width="1.1"/></svg>`,L_=M_(I_(`#b2601f`,`#f3e7cf`,`#4d2a10`)),R_=M_(I_(`#1a1a1a`,`#1a1a1a`,`#000`));function z_(e,t,n){let r=document.createElement(`div`);r.className=`linha`;let i=[];for(let a=0;a<e;a++){let e=document.createElement(`div`);if(e.className=`casa`,n!==void 0){let t=document.createElement(`div`);t.className=`icone fundo`,t.style.backgroundImage=n,e.appendChild(t)}let a=document.createElement(`div`);a.className=`icone`,a.style.backgroundImage=t,e.appendChild(a),r.appendChild(e),i.push(e)}return{linha:r,casas:i}}function B_(e,t){for(let[n,r]of e.entries()){let e=r.lastElementChild;if(!e)continue;let i=t>=(n+1)*2,a=!i&&t===n*2+1;e.style.display=i||a?`block`:`none`,e.classList.toggle(`meio`,a)}}var V_=class{raiz;linhaVida;linhaFome;linhaAr;dano;morte;casasVida;casasFome;casasAr;morteTimer=null;danoTimer=null;ultimaVida=20;visivel=!1;constructor(){let e=document.createElement(`style`);e.textContent=j_,document.head.appendChild(e),this.raiz=document.createElement(`div`),this.raiz.id=`lj-vitals`;let t=z_(D_,N_,P_),n=z_(O_,L_,R_),r=z_(k_,F_);this.linhaVida=t.linha,this.casasVida=t.casas,this.linhaFome=n.linha,this.casasFome=n.casas,this.linhaAr=r.linha,this.casasAr=r.casas,this.linhaAr.classList.add(`vazia`),this.linhaFome.classList.add(`vazia`);let i=document.createElement(`div`);i.className=`barras`,i.append(this.linhaVida,this.linhaFome),this.raiz.append(this.linhaAr,i),document.body.appendChild(this.raiz),this.dano=document.createElement(`div`),this.dano.id=`lj-dano`,this.morte=document.createElement(`div`),this.morte.id=`lj-morte`,document.body.append(this.dano,this.morte)}setVisivel(e){this.visivel=e,this.raiz.classList.toggle(`ativo`,e),e||this.esconderMorte()}aplicar(e){let t=Math.max(0,Math.min(20,Math.round(e.vida)));B_(this.casasVida,t),this.desenharFome(e.fome),this.desenharAr(e.folego),t<this.ultimaVida&&this.visivel&&this.piscarDano(),e.morreu&&this.visivel&&this.mostrarMorte(e.causa),this.ultimaVida=t}desenharFome(e){this.linhaFome.classList.toggle(`vazia`,e===void 0),e!==void 0&&B_(this.casasFome,Math.max(0,Math.min(20,Math.round(e))))}desenharAr(e){let t=e===void 0||e>=150;if(this.linhaAr.classList.toggle(`vazia`,t),t)return;let n=Math.max(0,Math.ceil(e/A_));for(let[e,t]of this.casasAr.entries()){let r=t.lastElementChild;r&&(r.style.display=e<n?`block`:`none`)}}piscarDano(){this.dano.classList.add(`piscar`),this.danoTimer!==null&&clearTimeout(this.danoTimer),this.danoTimer=setTimeout(()=>this.dano.classList.remove(`piscar`),90)}mostrarMorte(e){this.morte.textContent=e===`queda`?`Você caiu de muito alto`:e===`afogamento`?`Você ficou sem ar`:e===`fome`?`Você passou fome demais`:`Você não sobreviveu`,this.morte.classList.add(`ativo`),this.morteTimer!==null&&clearTimeout(this.morteTimer),this.morteTimer=setTimeout(()=>this.esconderMorte(),2600)}esconderMorte(){this.morte.classList.remove(`ativo`)}},H_=class{send;onToggle;root=document.getElementById(`amigos`);isOpen=!1;data={eu:``,equipe:null,convites:[],enviados:[],online:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&th(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=this.btn(e,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)});return n}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}linha(e,...t){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);return r.className=`jog-nome`,r.textContent=e,n.append(r,...t),n}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`amigos`,t.append(n,this.btn(`✕ fechar`,()=>this.hide()));let r=document.createElement(`div`);r.className=`jog-lista`,this.renderConvites(r),this.renderGrupo(r),this.renderConvidar(r),r.append(this.hint(`pelo chat também dá: /amigos convidar nome · /amigos aceitar · /amigos recusar · /amigos sair · /amigos expulsar nome · /amigos lista`)),e.append(t,r)}renderConvites(e){if(this.data.convites.length!==0){e.append(this.sec(`✉ convites para você (${this.data.convites.length})`));for(let t of this.data.convites)e.append(this.linha(`${t} convidou você`,this.btn(`aceitar`,()=>this.send(`/amigos aceitar ${t}`)),this.btn(`recusar`,()=>this.send(`/amigos recusar ${t}`))));e.append(this.hint(`aceitar um convite descarta os outros — você fica em UM grupo só.`))}}renderGrupo(e){let{eu:t,equipe:n}=this.data;if(!n){e.append(this.sec(`👥 seu grupo`)),e.append(this.hint(`Você não está em nenhum grupo. Quem está no seu grupo pode construir na sua ÁREA PROTEGIDA (e você na dele). Cabem 6 pessoas, contando você.`));return}let r=n.dono===t;e.append(this.sec(`👥 grupo de ${n.dono} — ${n.membros.length}/6`));for(let i of n.membros){let a=[i===n.dono?`dono`:``,i===t?`você`:``].filter(e=>e),o=a.length?`${i} (${a.join(`, `)})`:i;e.append(r&&i!==t?this.linha(o,this.armedBtn(`expulsar`,()=>this.send(`/amigos expulsar ${i}`))):this.linha(o))}let i=document.createElement(`div`);i.className=`painel-row`,i.append(r?this.armedBtn(`sair e DESFAZER o grupo`,()=>this.send(`/amigos sair`)):this.armedBtn(`sair do grupo`,()=>this.send(`/amigos sair`))),e.append(i),r&&e.append(this.hint(`você é o dono: se sair, o grupo acaba para todo mundo.`))}renderConvidar(e){let{eu:t,equipe:n,enviados:r,online:i}=this.data;if(e.append(this.sec(`＋ convidar`)),n&&n.dono!==t){e.append(this.hint(`Só ${n.dono} convida para este grupo. Saia dele para montar o seu.`));return}if(n&&n.membros.length>=6){e.append(this.hint(`Grupo cheio (6/6).`));return}for(let t of r)e.append(this.linha(`${t} — convite enviado, aguardando`));let a=new Set(n?.membros??[]),o=i.filter(e=>e!==t&&!a.has(e)&&!r.includes(e));for(let t of o)e.append(this.linha(t,this.btn(`convidar`,()=>this.send(`/amigos convidar ${t}`))));o.length===0&&r.length===0&&e.append(this.hint(`ninguém mais está na aula agora.`))}},U_=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&th(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},W_=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&th(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},G_=class extends W_{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(_h[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=zu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=zu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},..._h.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},K_=class extends W_{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},q_=class{fixedColor;group=new cn;cornerMarks=[];boxes=[];bounds=[];culling=null;constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Ci(new Hi(new Ii(1.01,1.01,1.01)),new di({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();if(this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Ci(new Hi(new Ii(n+.04,r+.04,i+.04)),new di({color:this.fixedColor??new W().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a}),this.bounds=e,this.culling){let{px:e,pz:t,raio:n}=this.culling;this.cularPorDistancia(e,t,n)}}cularPorDistancia(e,t,n){this.culling={px:e,pz:t,raio:n};for(let r=0;r<this.boxes.length;r++){let i=this.boxes[r],a=this.bounds[r];if(!i||!a)continue;let o=Math.max(a.min.x-e,0,e-(a.max.x+1)),s=Math.max(a.min.z-t,0,t-(a.max.z+1));i.visible=Math.max(o,s)<=n}}},J_=1/16,Y_=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*J_-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*J_-.004,ry:Math.PI}];function X_(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var Z_=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(bp(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=bp(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=Fu(t,e.x,e.y,e.z);if(!Xl(r))return;let i=Y_[r-K.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,X_(a,e,null);let o=new Mi(a);o.colorSpace=Le;let s=new $r(new Ui(12*J_,12*J_),new Vr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{X_(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=bp(e,t,n);if(this.conteudos.has(a))if(!Xl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Xl(Fu(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function Q_(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var $_=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,Q_(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},ev=null;function tv(e){e.preventDefault(),e.returnValue=``}var nv=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function rv(e){ev?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||nv.has(e.code))&&e.preventDefault())}function iv(e){ev?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function av(e){ev||(ev=e,window.addEventListener(`beforeunload`,tv),window.addEventListener(`keydown`,rv,!0),window.addEventListener(`keyup`,iv,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function ov(){ev=null,window.removeEventListener(`beforeunload`,tv),window.removeEventListener(`keydown`,rv,!0),window.removeEventListener(`keyup`,iv,!0),navigator.keyboard?.unlock?.()}var sv=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Mi(t);i.minFilter=o,this.material=new _r({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[Mu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===K.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===K.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===K.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new jr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function cv(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Eh(n)}var lv=new _l({antialias:!0});lv.setPixelRatio(Math.min(window.devicePixelRatio,2)),lv.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(lv.domElement);var uv=new _n;uv.background=new W(8900331);var dv=new ja(75,window.innerWidth/window.innerHeight,.1,512);dv.rotation.order=`YXZ`;var fv=new Pa(16777215,2.2);fv.position.set(60,100,40);var pv=new Fa(16777215,.55);uv.add(fv,pv);var mv=new _g(fv,pv,uv,dv),hv=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();hv!==null&&mv.sync(hv,!1);var gv=new bg,_v=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();_v&&gv.sync(_v.dir,_v.forca,!0);var vv=Sg(),$=new Ig(lv.domElement);$.touchDevice=l_();var yv=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},bv=yv(`yaw`),xv=yv(`pitch`);bv!==null&&($.yaw=bv),xv!==null&&($.pitch=xv);var Sv=dh(new URLSearchParams(location.search));function Cv(){let e=Sv?{...Xg(),...fh(Sv)}:Xg();return $.sensitivity=e.sensitivity,dv.fov=e.fov,dv.updateProjectionMatrix(),lv.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),$m(e.volume),wv?.setScale(e.uiScale),mv.setNuvens(e.nuvens),e}var wv=null,Tv=Cv();rh(Tv.volume);var Ev=null,Dv=null,Ov=null,kv=null,Av=null,jv={equipe:null,convites:[],enviados:[]},Mv=new Wg(()=>{Wv(),Fv?.setFase(`jogando`),Fv?.marcar(`carga concluída`),Nv?.()}),Nv=null,Pv=!1,Fv=null,Iv=document.getElementById(`overlay`),Lv=document.getElementById(`overlay-main`),Rv=document.getElementById(`overlay-config`),zv=document.getElementById(`crosshair`);function Bv(){Lv?.classList.remove(`hidden`),Rv?.classList.add(`hidden`)}function Vv(){return(Ev?.open??!1)||(Dv?.open??!1)||(Ov?.open??!1)||(kv?.open??!1)||(Av?.open??!1)}function Hv(){return Iv!==null&&!Iv.classList.contains(`hidden`)}function Uv(){return!Vv()&&!Hv()&&!ey.open}function Wv(){let e=Vv();Iv?.classList.toggle(`hidden`,Pv||Mv.ativo||$.active||ey.open||e),zv?.classList.toggle(`hidden`,!$.active),$.locked&&Bv(),wv?.setShown($.touch&&!ey.open&&!e&&!Mv.ativo)}document.addEventListener(`pointerlockchange`,Wv);function Gv(){l_()?($.touch=!0,u_(),Wv()):$.lock()}window.addEventListener(`keydown`,e=>{e.code===`Escape`&&(!Hv()||ey.open||(document.getElementById(`menu`)?.classList.contains(`hidden`)??!1)&&(e.preventDefault(),Gv()))});function Kv(){let e=Tv.keys;Tv=Cv();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`,`amigos`])$.rebind(e[t],Tv.keys[t]);Jv()}var qv=-1;function Jv(){if(!Yv||Tv.raioRender===qv)return;let e=qv;qv=Tv.raioRender,Yv.send(JSON.stringify({type:`radius`,chunks:qv})),Fv?.marcar(`raio`,`${e<0?`join`:e} → ${qv}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Gv()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&b_(e,Kv,Bv),Lv?.classList.add(`hidden`),Rv?.classList.remove(`hidden`)}),document.getElementById(`overlay-telacheia`)?.addEventListener(`click`,()=>{u_()}),document.getElementById(`overlay-hud`)?.addEventListener(`click`,()=>{Fv?.toggle()}),Iv?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&th(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{dv.aspect=window.innerWidth/window.innerHeight,dv.updateProjectionMatrix(),lv.setSize(window.innerWidth,window.innerHeight)});var Yv=null,Xv=`?`,Zv=null;function Qv(){return new URLSearchParams(location.search).get(`nome`)??h_()}function $v(e){return e.trim().toLowerCase()!==`/amigos`||!kv?!1:(Ev?.hide(),Dv?.hide(),Ov?.hide(),kv.toggle(),!0)}var ey=new Nh(e=>{$v(e)||Yv?.send(JSON.stringify({type:`chat`,text:e}))},e=>{Wv(),e||$.lock()});Wv(),lv.domElement.addEventListener(`pointerdown`,()=>{$.touch&&ey.open&&ey.close()});var ty={tickAvgMs:0,tickMaxMs:0},ny=null,ry=0,iy=[];function ay(){let e=performance.now();ry>0&&(iy.push(e-ry),iy.length>300&&iy.shift()),ry=e}function oy(){let e=iy.length;if(e<2)return 0;let t=iy.reduce((e,t)=>e+t,0)/e,n=iy.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var sy=!1,cy=null,ly=null,uy=null,dy=null,fy=null,py=null,my=null,hy=`aluno`,gy=!1,_y=!1,vy=`criativo`,yy=!1;function by(){return bf(vy)&&(hy===`professor`||gy)}var xy=new E_,Sy=null,Cy=null;function wy(){return Cy??=new V_,Cy}var Ty=null,Ey=(()=>{let e=new URLSearchParams(location.search).get(`vida`);if(e===null)return null;let[t,n,r]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{vida:t,...Number.isFinite(n)?{folego:n}:{},...Number.isFinite(r)?{fome:r}:{}}})();Ey&&(wy().setVisivel(!0),wy().aplicar(Ey));{let e=new URLSearchParams(location.search).get(`mochila`);if(e!==null){let t=[];e.split(`,`).forEach((e,n)=>{let[r,i]=e.split(`x`).map(Number);r===void 0||!Number.isInteger(r)||r<=0||t.push({slot:n,id:r,qtd:Number.isInteger(i)&&i>0?i:1})}),xy.travar(t)}}var Dy=[],Oy=null,ky=!1,Ay=!1,jy=[],My=null,Ny=null,Py=null,Fy=new T_,Iy=null,Ly=null,Ry=null,zy=[],By=new Set,Vy=!1,Hy=null,Uy=null,Wy=!1,Gy=new Map;function Ky(){Ev?.update({regions:Dy,modo:Iy?.modo??`sequencial`,objetivos:Iy?.objetivos??[],grupos:zy,myGrupo:Ry})}function qy(){kv?.update({eu:Qv(),equipe:jv.equipe,convites:jv.convites,enviados:jv.enviados,online:[...new Set(Gy.values())].sort()})}function Jy(e){return e.porGrupo&&hy!==`professor`?Ry===null?!1:e.porGrupo.find(e=>e.grupo===Ry)?.completo??!1:e.completo}function Yy(e){if(Iy){for(let t of Iy.objetivos)Jy(t)?By.has(t.id)||(By.add(t.id),e&&Vy&&Jm({kind:`objective_complete`})):By.delete(t.id);Vy=!0,Fy.update(Iy.modo,Iy.objetivos,{grupo:Ry,professor:hy===`professor`,painelKey:Qg(Tv.keys.painel)}),Ly?.(Iy.objetivos)}}var Xy=null;function Zy(){let e=Xy;if(e){Xy=null;for(let t of e)$y(t)}}function Qy(){Xy||(Xy=[],requestAnimationFrame(()=>requestAnimationFrame(Zy)),setTimeout(Zy,500))}function $y(e){if(Xy){Xy.push(e);return}if(ay(),sy||Mv.setFase(`mundo`),typeof e==`string`){let t=Vp(e);if(!t)return;if(t.type===`debug_stats`)ty={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},ny=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0};else if(t.type===`block_changed`)cy?.(t);else if(t.type===`blocks_filled`)ly?.(t);else if(t.type===`player_moved`)t.name&&Gy.get(t.id)!==t.name&&(Gy.set(t.id,t.name),Dh([...new Set(Gy.values())]),qy()),uy?.(t);else if(t.type===`player_left`)Gy.delete(t.id),Dh([...new Set(Gy.values())]),qy(),dy?.(t.id);else if(t.type===`spawn`)my={x:t.x,y:t.y,z:t.z},hy=t.papel??`aluno`;else if(t.type===`regions`)Dy=t.regions,Oy?.(t.regions),Ky();else if(t.type===`objectives`)Iy={modo:t.modo,objetivos:t.objetivos},Yy(!0),Ky();else if(t.type===`group`)Ry=t.grupo,By.clear(),Yy(!1),Ky();else if(t.type===`groups`)zy=t.grupos,Ky();else if(t.type===`quadros`)Ny?.(t.lista);else if(t.type===`quadro_changed`)Py?.(t);else if(t.type===`container`)Av?.atualizar(t);else if(t.type===`container_fechado`)Av?.fecharSemAvisar();else if(t.type===`claims`)ky=t.ativo,t.ativo&&!Ay&&(Ay=!0,ey.addMessage(`jogo`,`tecla ${Qg(Tv.keys.amigos)} abre o painel de amigos — quem está no seu grupo constrói na sua área`)),jy=t.claims,My?.(t.claims);else if(t.type===`friends`)jv={equipe:t.equipe,convites:t.convites,enviados:t.enviados},qy();else if(t.type===`players`)Ov?.update({conectados:t.conectados,banidos:t.banidos});else if(t.type===`mundo_trocando`)fy?.(t.nome),Qy();else if(t.type===`teleport`)py?.(t);else if(t.type===`time`)hv===null&&mv.sync(t.hora,t.ciclo);else if(t.type===`vento`)_v===null&&gv.sync(t.dir,t.forca,t.ativo);else if(t.type===`voo`)gy=t.liberado,by()||(_y=!1),ey.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`);else if(t.type===`modo`){let e=vy!==t.efetivo;vy=t.efetivo,yy=t.pvp===!0,by()||(_y=!1),Ey===null&&(t.efetivo===`sobrevivencia`?wy().setVisivel(!0):Cy?.setVisivel(!1)),t.efetivo===`criativo`&&xy.ativa&&(xy.desligar(),Sy?.()),e&&ey.addMessage(`jogo`,t.efetivo===`sobrevivencia`?`modo sobrevivência — não dá para voar`:`modo criativo`)}else if(t.type===`inventario`)xy.aplicar(t.slots),Sy?.();else if(t.type===`vida`){if(Ey!==null)return;Ty=t,wy().aplicar(t),t.causa&&Jm({kind:`dano`}),t.morreu&&(Jm({kind:`morte`}),ey.addMessage(`jogo`,t.causa===`queda`?`você caiu de muito alto — voltou ao ponto de partida`:t.causa===`afogamento`?`você ficou sem ar — voltou ao ponto de partida`:t.causa===`fome`?`você passou fome demais — voltou ao ponto de partida`:t.causa===`pvp`?`você foi derrubado por outro jogador — voltou ao ponto de partida`:`você não sobreviveu — voltou ao ponto de partida`))}else t.type===`kicked`?(th(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),ov(),location.href=location.pathname):t.type===`join_denied`?(th(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),ov(),location.href=location.pathname):t.type===`chat`&&(ey.addMessage(t.author,t.text),t.author===`servidor`&&cv(t.text),Jm({kind:`chat_message`}));return}let t=Gp(e);if(t===809716300){Uy?.(e);return}let n=()=>(Wy=t===Up,Wy?Kp(e):Hp(e));if(sy){Hy?.(n());return}sy=!0,ob(n())}function eb(e,t){Tv=Cv(),Yv=e,Mv.abrir({host:Xv,rede:!(e instanceof Tg)}),Mv.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),Wv(),e.onMessage($y),$.onKey(Tv.keys.chat,()=>{ey.open||Uv()&&(document.exitPointerLock(),ey.openInput())}),e.send(JSON.stringify({type:`join`,name:Qv(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),qv=-1,Jv()}function tb(e,t){Xv=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),eb(new Eg(e,t=>{sy||!Mv.ativo||Mv.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function nb(e,t){Zv={id:e.id,name:e.name,createdAt:e.createdAt},Xv=`web-worker (${e.name})`;let n=new Tg(new Worker(new URL(`/assets/worker-BiZsD0p9.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho,sobrevivencia:e.sobrevivencia}),eb(n)}async function rb(){if(!(Yv instanceof Tg)||!Zv)return;let e=await Yv.requestSave();await a_({...Zv,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{ov(),rb().finally(()=>location.reload())});var ib=new URLSearchParams(location.search),ab=ib.get(`server`);if(ab){let e=ib.get(`codigo`);tb(ab,{pin:ib.get(`pin`)??``,...e?{codigo:e}:{}})}else Sv?nb({id:`bench-${ih}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:cd(ib.get(`tamanho`)??`E`)},ih):y_({onPlayWorld:nb,onPlayMulti:tb});function ob(e){let t=Yv;if(!t)return;av(()=>$.active);let n=e.world,r=e.seed,i=new Xh(n.dims,new URLSearchParams(location.search).has(`semluz`)),a=Wy,o=new Set,s=0,c=0,l=0,u=Vm(),d=new ea({map:u,alphaTest:.5});xg(d,vv);let f=Cg();wg(d,f);let p=new ea({map:u,transparent:!0,opacity:.72,depthWrite:!1}),m=new ea({map:u,transparent:!0,opacity:.4,depthWrite:!1});if(wg(p,f),wg(m,f),new URLSearchParams(location.search).has(`atlas`)){let e=d.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let h=new URLSearchParams(location.search),g=h.has(`semworker`),_=Number(h.get(`meshdepth`)),v=new Bh(n,[d,p,m],uv,!g,Number.isFinite(_)&&_>0?_:void 0,i.paraMesher),y=new Wm(uv),b=-1,x=0,S=-1,C=-1;a||(i.acenderTudo(n),v.buildAll()),Uy=e=>{let t=[];try{t=Jp(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;o.add(t),E.chegou(t),i.enfileirar(e,r,n.dims.x),w.varrerColuna(n,e,r)}c+=t.length};let w=new sv(uv);w.setFromWorld(n);let T=(e,t)=>{v.descartarColuna(e,t),w.descartarColuna(e,t),i.descartar(e,t);for(let r=0;r<n.dims.y;r++)n.chunks[(r*n.dims.z+t)*n.dims.x+e]=void 0},E=new Vh(T,(e,n)=>{t.send(JSON.stringify({type:`pedir_coluna`,cx:e,cz:n}))}),D=new q_(uv);D.setRegions(Dy),Oy=e=>{D.setRegions(e),D.clearCorners()};let ee=new q_(uv,16747546),O=e=>{ee.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};O(jy),My=e=>{O(e),D.clearCorners(),F.revalidarVarinha(),wv?.setVarinhaDisponivel(hy===`professor`||ky),wv?.setAmigosDisponivel(ky),F.refresh()};let k=new Z_(uv),te=new $_;Ny=e=>k.setAll(e,n),Py=e=>k.aplicar(e,n);let A=new q_(uv,3066993),j=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Ry!==null&&r.grupo===Ry;(hy===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});A.setRegions(t)};Ly=j,Iy&&j(Iy.objetivos);let ne=e=>t.send(JSON.stringify({type:`chat`,text:e})),re=e=>{e?document.exitPointerLock():$.lock(),Wv()};hy===`professor`&&(Ov=new U_(ne,re)),kv=new H_(ne,re),qy(),Ev=hy===`professor`?new G_(ne,re,()=>{Ev?.hide(),Dv?.hide(),kv?.hide(),Ov?.show()}):new K_(ne,re),Ky(),$.onKey(Tv.keys.painel,()=>{if(!(!(Ev?.open??!1)&&!Uv())){if(hy!==`professor`&&zy.length===0){ey.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}Ev?.toggle()}}),$.onKey(Tv.keys.amigos,()=>{!(kv?.open??!1)&&!Uv()||kv?.toggle()}),hy===`professor`&&ey.addMessage(`jogo`,`tecla ${Qg(Tv.keys.painel)} abre o painel de autoria`);let M=my??{x:n.sizeX/2+.5,y:Lu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},N=ip(M.x,M.y,M.z),ie=()=>{if(!a)return 0;let e=Tv.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(N.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(N.pos.z/16))),i=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,o=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,i*o)},ae=ie(),oe=()=>{Mv.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:o.size,total:ae,faltando:E.tamanho>0?E.tamanho:Math.max(0,ae-o.size),fila:v.filaPendente}))};oe(),Mv.setFase(a?`mundo`:`malha`),fy=e=>{ae=0,Mv.abrir({host:Xv,rede:!(t instanceof Tg),titulo:`trocando de aula`,alvo:e}),oe(),Mv.setFase(`preparando`),pe.setFase(`carregando`),pe.marcar(`troca de aula`,e),Wv()};function se(){N.pos.x=M.x,N.pos.y=M.y,N.pos.z=M.z,N.vel.x=N.vel.y=N.vel.z=0}Hy=e=>{n=e.world,r=e.seed,a=Wy,o=new Set,E.limpar(),i.trocarMundo(n.dims),a||i.acenderTudo(n),v.trocarMundo(n,!a,i.paraMesher),w.setFromWorld(n),Dy=[],D.setRegions([]),D.clearCorners(),k.setAll([],n),Iy=null,Ly?.([]),Fy.update(`livre`,[],{grupo:null,professor:hy===`professor`,painelKey:Qg(Tv.keys.painel)}),By.clear(),Vy=!1,zy=[],Ry=null,Ky(),M=my??M,se(),ey.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),qv=-1,Jv(),pe.setMeta({worldChunks:n.dims,worldSeed:e.seed}),ae=ie(),Mv.abrir({host:Xv,rede:!(t instanceof Tg),titulo:`trocando de aula`}),oe(),Mv.setFase(a?`mundo`:`malha`),pe.setFase(`carregando`),Wv(),a||Mv.concluir()},py=e=>{N.pos.x=e.x,N.pos.y=e.y,N.pos.z=e.z,N.vel.x=N.vel.y=N.vel.z=0,$.yaw=bv??e.yaw,$.pitch=xv??e.pitch},cy=e=>{Iu(n,e.x,e.y,e.z,e.blockId),v.remeshBlock(e.x,e.y,e.z),v.remeshSujos(i.aoMudarBloco(n,e.x,e.y,e.z)),w.onBlockChanged(e.x,e.y,e.z,e.blockId),k.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Jm(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},ly=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)Iu(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(n.dims.x-1,e.x1/16|0);t++)for(let r=Math.max(0,e.z0/16|0);r<=Math.min(n.dims.z-1,e.z1/16|0);r++)v.remeshSujos(i.aoChegarColuna(n,t,r));v.remeshBox(t,r),w.onRegionFilled(t,r,e.blockId),k.validarTodos(n),Jm(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let ce=new Zh(uv);uy=e=>ce.aoMover(e),dy=e=>ce.aoSair(e);let le=new Ci(new Hi(new Ii(1,1,1)),new di({color:0}));le.visible=!1,uv.add(le);let P=null,ue=null,de=new H,F=new Yh(hy,xy,d.map?.image,{claimsAtivo:()=>ky,setVarinhaToque:e=>wv?.setVarinha(e),aoRedesenhar:()=>{Dv?.refresh(),Av?.refresh()}});Sy=()=>F.refresh(),F.refresh(),$.onKey(Tv.keys.varinha,()=>F.toggleVarinha());for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>F.selecionar(e));$.onWheel(e=>F.ciclar(e)),Dv=new yh(F.icons,()=>F.meusBlocos,()=>({hotbar:F.paleta,selected:F.selected}),e=>F.definirSlotLocal(e),e=>F.selecionar(e),e=>{e?document.exitPointerLock():$.lock(),Wv()},xy,(e,n)=>t.send(JSON.stringify({type:`mover_item`,de:e,para:n})),e=>F.nome(e),e=>t.send(JSON.stringify({type:`fabricar`,receita:e}))),$.onKey(Tv.keys.inventario,()=>{!(Dv?.open??!1)&&!Uv()||Dv?.toggle()}),Av=new mh(F.icons,xy,e=>F.nome(e),(e,n,r,i,a)=>t.send(JSON.stringify({type:`mover_container`,x:e,y:n,z:r,de:i,para:a})),()=>t.send(JSON.stringify({type:`fechar_container`})),e=>{e?(Ev?.hide(),Ov?.hide(),kv?.hide(),Dv?.hide(),document.exitPointerLock()):$.lock(),Wv()});let fe=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),D.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(ue&&!F.varinhaAtiva){t.send(JSON.stringify({type:`atacar`,alvo:ue.id}));return}if(P){if(F.varinhaAtiva){fe(1,P);return}Al(F.idNaMao()??-1)&&vy!==`criativo`||t.send(JSON.stringify({type:`break_block`,x:P.x,y:P.y,z:P.z}))}}),$.onMouseButton(2,()=>{if(xy.ativa&&Gu(F.idNaMao()??-1)){t.send(JSON.stringify({type:`comer`,slot:F.selected}));return}if(!P)return;if(F.varinhaAtiva){fe(2,P);return}{let e=F.idNaMao();if(Al(e??-1)){let r=xy.ativa?{slot:F.selected}:{};if(e===901)t.send(JSON.stringify({type:`balde`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,encher:!1,...r})),xy.ativa||F.definirSlotLocal(900);else{if(Fu(n,P.x,P.y,P.z)!==K.Agua)return;t.send(JSON.stringify({type:`balde`,x:P.x,y:P.y,z:P.z,encher:!0,...r})),xy.ativa||F.definirSlotLocal(901)}return}}if(Xl(Fu(n,P.x,P.y,P.z))){let{x:e,y:n,z:r}=P;te.open(k.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(rd(Fu(n,P.x,P.y,P.z))!==null){t.send(JSON.stringify({type:`use_block`,x:P.x,y:P.y,z:P.z}));return}if(mu(Fu(n,P.x,P.y,P.z))){t.send(JSON.stringify({type:`use_block`,x:P.x,y:P.y,z:P.z}));return}let e=F.idNaMao();if(e===null)return;let r=Cf(e,$.yaw,P.ny<0);t.send(JSON.stringify({type:`place_block`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,blockId:r}))}),$.onMouseButton(1,()=>{if(!P||F.varinhaAtiva||xy.ativa)return;let e=wf(Fu(n,P.x,P.y,P.z));_u(e)&&(vu(e)&&hy!==`professor`||F.definirSlotLocal(e))});let pe=new Fg(lv,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Xv});Fv=pe,pe.contexto=()=>({x:N.pos.x,y:N.pos.y,z:N.pos.z,yaw:$.yaw,pitch:$.pitch,voando:_y&&by(),noChao:N.onGround,raioRender:Tv.raioRender,meshMsPorFrame:Tv.meshMsPorFrame,pixelRatioCap:Tv.pixelRatioCap,fov:Tv.fov,nuvens:Tv.nuvens,balanco:Tv.balanco,distanciaTotal:l,colunasRecebidas:c,bytesRecebidos:t.stats.bytesIn}),pe.setRemesh({count:v.remeshCount,totalMs:v.remeshMsTotal,workerMs:v.remeshWorkerMsTotal,config:v.meshConfig,lastMs:v.lastRemeshMs,porCaminho:v.porCaminho}),pe.carga=()=>Mv.relatorio(),pe.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let me=null;if(Sv){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);ey.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let t=Sv.semVida?`bench-semvida`:`bench`;pe.baixar(e,t),ey.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${t}-*.json)`)}};Nv=()=>{if(me)return;me=ph.paraMundo(Sv,M,n.dims),pe.setMeta({bench:me.meta()}),pe.marcar(`bench: início`,`${Sv.duracaoS}s · raio ${me.trajeto.raio}${Sv.semVida?` · sem vida ambiental`:``}`),Pv=!0,window.__benchRodando=!0,_y=!0,Wv(),me.iniciar(performance.now());let t=me.amostra(performance.now());N.pos.x=ye=t.x,N.pos.y=be=t.y,N.pos.z=xe=t.z,pe.record(t=>{Pv=!1,window.__benchRodando=!1,Wv(),window.__benchPerfil=t,e(t)},Sv.duracaoS*1e3)}}$.onKey(Tv.keys.hud,()=>pe.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{pe.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),l_()&&(F.habilitarToque(),wv=new p_($,{keys:()=>Tv.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>{!(Dv?.open??!1)&&!Uv()||Dv?.toggle()},chat:()=>{ey.open||(document.exitPointerLock(),ey.openInput())},menu:()=>{$.touch=!1,Bv(),Wv()},hud:()=>pe.toggle(),varinha:()=>F.toggleVarinha(),amigos:()=>{!(kv?.open??!1)&&!Uv()||kv?.toggle()}}),wv.setVarinhaDisponivel(hy===`professor`||ky),wv.setAmigosDisponivel(ky),wv.setScale(Tv.uiScale),Wv()),pe.extra=()=>{let e=$.mouseStats,t=N.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=pd(i,a,r),s=bu(o),c=xu(o),l=Math.min(fd(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&s.neve?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===K.GramaSeca?`grama seca`:c===K.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se o bioma neva · chapada ≥85]\nrelevo ${Tu(o).toFixed(2)} (teto do bioma ${s.relevo})\nmodo ${vy===`sobrevivencia`?`sobrevivência`:`criativo`}  voo ${by()?_y?`voando`:`liberado`:`trancado`}`+(Ty?`  vida ${Ty.vida}/20`+(Ty.fome===void 0?`  sem fome`:`  fome ${Ty.fome}/20`):``)+`
mouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let he={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},ge=0;setInterval(()=>{let e={x:N.pos.x,y:N.pos.y,z:N.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==he.x||e.y!==he.y||e.z!==he.z||e.yaw!==he.yaw||e.pitch!==he.pitch,r=performance.now();!n&&r-ge<2e3||(he=e,ge=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof Tg&&Zv&&!Sv&&(rb(),setInterval(()=>void rb(),3e4));let _e={...t.stats};setInterval(()=>{let e=t.stats;pe.net={msgsPerSec:e.msgsIn+e.msgsOut-(_e.msgsIn+_e.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(_e.bytesIn+_e.bytesOut),tickAvgMs:ty.tickAvgMs,tickMaxMs:ty.tickMaxMs,jitterMs:oy()},pe.regras=ny,pe.stream={colunas:o.size,fila:v.filaPendente,faltando:E.tamanho,repedidas:E.repedidas,ultimoLote:v.ultimoLote},pe.luz=i.medidas,_e={...e}},1e3);let ve=performance.now(),ye=N.pos.x,be=N.pos.y,xe=N.pos.z,Se=!1,Ce=!1,we=0,Te=!1,Ee=0,De=Z.eyeHeight,Oe=0;lv.setAnimationLoop(()=>{let e=performance.now(),t=e-ve;ve=e;let r=Math.min(t/1e3,.05),c=$.active?!!$.down(Tv.keys.forward)-+!!$.down(Tv.keys.back):0,d=$.active?!!$.down(Tv.keys.right)-+!!$.down(Tv.keys.left):0,p=$.active&&$.down(Tv.keys.jump),m=$.active&&$.down(Tv.keys.forward);m&&!Ce&&(e-we<300&&(Se=!0),we=e),m||(Se=!1),Ce=m;let h=$.active&&$.down(Tv.keys.agachar),g=c>0&&!h&&(Se||$.active&&$.down(Tv.keys.correr));p&&!Te&&(by()&&e-Ee<300&&(_y=!_y),Ee=e),Te=p;let _=_y&&by(),w=!0;if(a){v.modoCarga=Mv.ativo;{let e=i.drenar(n,Mv.ativo?16:3,e=>o.has(e));for(let t of e)v.enfileirarColuna(t.cx,t.cz)}v.processarFila(Tv.meshMsPorFrame,(e,t)=>{o.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(N.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(N.pos.z/16)));if(w=o.has(r*n.dims.x+t),(s=(s+1)%60)==0){for(let e of o){let i=e%n.dims.x,a=(e-i)/n.dims.x;Math.max(Math.abs(i-t),Math.abs(a-r))>Tv.raioRender+2&&(o.delete(e),T(i,a))}E.varrer(t,r,e,n.dims,Tv.raioRender,o);let i=Tv.raioRender*16;ee.cularPorDistancia(N.pos.x,N.pos.z,i),D.cularPorDistancia(N.pos.x,N.pos.z,i)}Mv.ativo&&o.size>=ae&&i.filaVazia&&v.filaPendente===0&&Mv.concluir()}if(me?.ativo){let t=me.amostra(e);N.pos.x=t.x,N.pos.y=t.y,N.pos.z=t.z,N.vel.x=N.vel.y=N.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,me.terminou(e)&&(me.parar(),pe.marcar(`bench: fim`))}let O=N.pos.y;w&&!me?.ativo&&hp(n,N,{forward:c,strafe:d,jump:p,yaw:$.yaw,sprint:g,sneak:h,fly:_},r);let k=N.pos.y-O;N.onGround&&!_&&k>.01&&k<=.56&&(Oe=Math.min(Oe+k,np)),Oe*=Math.exp(-r*14),Oe<.002&&(Oe=0),l+=Math.hypot(N.pos.x-ye,N.pos.y-be,N.pos.z-xe),ye=N.pos.x,be=N.pos.y,xe=N.pos.z,N.pos.y<-16&&se(),ce.interpolar(r);let te=1-Math.exp(-r*20);De+=((h&&!_?Z.sneakEyeHeight:Z.eyeHeight)-De)*te;let A=Tv.fov*(N.sprinting?1.1:1);if(Math.abs(dv.fov-A)>.01&&(dv.fov+=(A-dv.fov)*te,dv.updateProjectionMatrix()),dv.position.set(N.pos.x,N.pos.y+De-Oe,N.pos.z),dv.rotation.set($.pitch,$.yaw,0),dv.getWorldDirection(de),P=$.active?yp(n,dv.position.x,dv.position.y,dv.position.z,de.x,de.y,de.z,5,F.slotLocal===900):null,ue=$.active&&vy===`sobrevivencia`&&yy?_p(dv.position.x,dv.position.y,dv.position.z,de.x,de.y,de.z,ce.alvosParaMira(),5):null,ue&&P){let e=Math.hypot(P.x+.5-dv.position.x,P.y+.5-dv.position.y,P.z+.5-dv.position.z);ue.dist>e&&(ue=null)}if(zv?.classList.toggle(`alvo`,ue!==null),le.visible=P!==null&&ue===null,P){let[e,t,r,i,a,o]=$d(Fu(n,P.x,P.y,P.z));le.position.set(P.x+(e+i)/2,P.y+(t+a)/2,P.z+(r+o)/2),le.scale.set(i-e+.004,a-t+.004,o-r+.004)}pe.setRemesh({count:v.remeshCount,totalMs:v.remeshMsTotal,workerMs:v.remeshWorkerMsTotal,config:v.meshConfig,lastMs:v.lastRemeshMs,porCaminho:v.porCaminho}),gv.update(r),vv.ventoTempo.value=gv.fase*Math.PI*2,vv.ventoDir.value.set(gv.x,gv.z),vv.ventoForca.value=Tv.balanco?gv.forca:0,mv.update(r,gv),f.nivelCeu.value=mv.nivelCeu,y.update(n,dv.position.x,dv.position.y,dv.position.z);let j=Math.floor(gv.fase*16)%16;x+=r;let ne=Math.floor(x*8)%16;(j!==b||ne!==S)&&x-C>=1/12&&(C=x,b=j,S=ne,Bm(u,j,gv.ondaAgua,ne));let re=performance.now();pe.gpuInicio(),lv.render(uv,dv),pe.gpuFim(),pe.frame(t,performance.now()-re)}),a||Mv.concluir(),ib.has(`hud`)&&pe.toggle(),new URLSearchParams(location.search).has(`painel`)&&Ev?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Dv?.toggle(),new URLSearchParams(location.search).has(`amigos`)&&kv?.toggle(),ib.has(`touch`)&&Gv()}