...
`;function bm(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function xm(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function Sm(e){return`${(e/1e3).toFixed(1)} s`}var Cm=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=ym,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(vm*.25).toFixed(1)} ${vm.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,vm.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(vm*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=Sm(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${Sm(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=bm(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=xm(n.bytes)}e.forcar.classList.toggle(`hidden`,o<gm||this.fase===`pronto`)}},wm={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`}},Tm={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`},Em=`lj-config`;function Dm(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function Om(e,t){return typeof e==`boolean`?e:t}function km(){let e=null;try{e=JSON.parse(localStorage.getItem(Em)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...wm.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:Dm(t.sensitivity,wm.sensitivity,.2,3),fov:Dm(t.fov,wm.fov,60,100),pixelRatioCap:Dm(t.pixelRatioCap,wm.pixelRatioCap,1,2),volume:Dm(t.volume,wm.volume,0,1),raioRender:Dm(t.raioRender,wm.raioRender,2,12),meshMsPorFrame:Dm(t.meshMsPorFrame,wm.meshMsPorFrame,1,16),uiScale:Dm(t.uiScale,wm.uiScale,.6,1.8),nuvens:Om(t.nuvens,wm.nuvens),balanco:Om(t.balanco,wm.balanco),keys:r}}function Am(e){localStorage.setItem(Em,JSON.stringify(e))}function jm(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var Mm=`logica-em-jogo`,Nm=`worlds`;function Pm(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var Fm=null;function Im(){return Fm??=new Promise((e,t)=>{let n=indexedDB.open(Mm,1);n.onupgradeneeded=()=>{n.result.createObjectStore(Nm,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),Fm}async function Lm(){return(await Pm((await Im()).transaction(Nm).objectStore(Nm).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function Rm(e){await Pm((await Im()).transaction(Nm,`readwrite`).objectStore(Nm).put(e))}async function zm(e){await Pm((await Im()).transaction(Nm,`readwrite`).objectStore(Nm).delete(e))}function Bm(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function Vm(e){let t=await e.arrayBuffer();$d(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function Hm(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function Um(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var Wm=`
#touch-ui { --ts: 1; }
...
`,Gm=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Wm,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.tapButton(`⛶`,`tela cheia`,()=>Um()),this.tapButton(`📊`,`hud`,()=>this.actions.hud())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){this.root.style.setProperty(`--ts`,String(e))}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},Km=`lj-nome`;function qm(){let e=localStorage.getItem(Km),t=e?yu(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(Km,t),t}function Jm(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function Ym(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function Xm(e){document.getElementById(e)?.classList.add(`hidden`)}function Zm(e){let t=Jm(`menu`),n={home:Jm(`menu-home`),worlds:Jm(`menu-worlds`),multi:Jm(`menu-multi`),config:Jm(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),Jm(`menu-version`).textContent=`v${nf}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Zf(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),Ym(`menu-erro`,i));let a=Jm(`menu-nome`);a.value=qm(),a.addEventListener(`change`,()=>{let e=yu(a.value);localStorage.setItem(Km,e),a.value=e}),Jm(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),Jm(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),Jm(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=Jm(`menu-world-list`);async function c(){let e=[];try{e=await Lm()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>Bm(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){zm(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=Jm(`menu-new-nome`),u=Jm(`menu-new-tipo`);Jm(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){Ym(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}Xm(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:Eu(u.value),tamanho:Du(Jm(`menu-new-tamanho`).value)})});let d=Jm(`menu-import-file`);Jm(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&Vm(e).then(async e=>{await Rm(e),await c(),Xm(`menu-worlds-erro`)}).catch(e=>{Ym(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=Jm(`menu-endereco`),p=Jm(`menu-pin`),m=Jm(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,Jm(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){Ym(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){Ym(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}Xm(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),Qm(Jm(`menu-config-body`),void 0,()=>r(`home`))}function Qm(e,t,n){th(e,t,n)}function $m(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var eh=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function th(e,t,n){e.textContent=``;for(let r of eh){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>nh(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{Am(structuredClone(wm)),t?.(),th(e,t,n)}),e.appendChild(r),n&&$m(e,n)}function nh(e,t,n,r){e.textContent=``;let i=km(),a=()=>{Am(i),n?.()},o=document.createElement(`h2`);o.textContent=eh.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),Hm()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(Tm)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=Tm[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=jm(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=jm(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Yf(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>Zf(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t);let r=(t,n,r)=>{let i=document.createElement(`label`);i.className=`config-row`,i.textContent=`${t} `;let o=document.createElement(`input`);o.type=`checkbox`,o.checked=n,o.addEventListener(`change`,()=>{r(o.checked),a()}),i.appendChild(o),e.appendChild(i)};r(`nuvens no céu`,i.nuvens,e=>i.nuvens=e),r(`balanço de folhas e grama`,i.balanco,e=>i.balanco=e),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`tempo de montagem de malha por frame`,1,16,1,i.meshMsPorFrame,e=>i.meshMsPorFrame=e,e=>`${e} ms`)}$m(e,()=>th(e,n,r))}var rh=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},ih=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Zf(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},ah=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Zf(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},oh=class extends ah{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(pp[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=bu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=bu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...pp.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},sh=class extends ah{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},ch=class{fixedColor;group=new ln;cornerMarks=[];boxes=[];constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new wi(new Ui(new Li(1.01,1.01,1.01)),new fi({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new wi(new Ui(new Li(n+.04,r+.04,i+.04)),new fi({color:this.fixedColor??new U().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a})}},lh=1/16,uh=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*lh-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*lh-.004,ry:Math.PI}];function dh(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var fh=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(Sd(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=Sd(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=gu(t,e.x,e.y,e.z);if(!Rl(r))return;let i=uh[r-K.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,dh(a,e,null);let o=new Ni(a);o.colorSpace=Re;let s=new ei(new Wi(12*lh,12*lh),new Hr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{dh(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=Sd(e,t,n);if(this.conteudos.has(a))if(!Rl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Rl(gu(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function ph(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var mh=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,ph(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},hh=null;function gh(e){e.preventDefault(),e.returnValue=``}var _h=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function vh(e){hh?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||_h.has(e.code))&&e.preventDefault())}function yh(e){hh?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function bh(e){hh||(hh=e,window.addEventListener(`beforeunload`,gh),window.addEventListener(`keydown`,vh,!0),window.addEventListener(`keyup`,yh,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function xh(){hh=null,window.removeEventListener(`beforeunload`,gh),window.removeEventListener(`keydown`,vh,!0),window.removeEventListener(`keyup`,yh,!0),navigator.keyboard?.unlock?.()}var Sh=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Ni(t);i.minFilter=o,this.material=new vr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[pu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===K.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===K.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===K.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Mr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function Ch(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Sp(n)}var wh=new _l({antialias:!0});wh.setPixelRatio(Math.min(window.devicePixelRatio,2)),wh.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(wh.domElement);var Th=new vn;Th.background=new U(8900331);var Eh=new Ma(75,window.innerWidth/window.innerHeight,.1,512);Eh.rotation.order=`YXZ`;var Dh=new Fa(16777215,2.2);Dh.position.set(60,100,40);var Oh=new Ia(16777215,.55);Th.add(Dh,Oh);var kh=new Qp(Dh,Oh,Th,Eh),Ah=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();Ah!==null&&kh.sync(Ah,!1);var jh=new tm,Mh=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();Mh&&jh.sync(Mh.dir,Mh.forca,!0);var Nh=rm(),$=new hm(wh.domElement),Ph=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},Fh=Ph(`yaw`),Ih=Ph(`pitch`);Fh!==null&&($.yaw=Fh),Ih!==null&&($.pitch=Ih);var Lh=sp(new URLSearchParams(location.search));function Rh(){let e=Lh?{...km(),...op}:km();return $.sensitivity=e.sensitivity,Eh.fov=e.fov,Eh.updateProjectionMatrix(),wh.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Yf(e.volume),zh?.setScale(e.uiScale),kh.setNuvens(e.nuvens),e}var zh=null,Bh=Rh();$f(Bh.volume);var Vh=null,Hh=null,Uh=null,Wh=new Cm(()=>{$h(),qh?.setFase(`jogando`),qh?.marcar(`carga concluída`),Gh?.()}),Gh=null,Kh=!1,qh=null,Jh=document.getElementById(`overlay`),Yh=document.getElementById(`overlay-main`),Xh=document.getElementById(`overlay-config`),Zh=document.getElementById(`crosshair`);function Qh(){Yh?.classList.remove(`hidden`),Xh?.classList.add(`hidden`)}function $h(){let e=(Vh?.open??!1)||(Hh?.open??!1)||(Uh?.open??!1);Jh?.classList.toggle(`hidden`,Kh||Wh.ativo||$.active||cg.open||e),Zh?.classList.toggle(`hidden`,!$.active),$.locked&&Qh(),zh?.setShown($.touch&&!cg.open&&!e&&!Wh.ativo)}document.addEventListener(`pointerlockchange`,$h);function eg(){Hm()?($.touch=!0,Um(),$h()):$.lock()}function tg(){let e=Bh.keys;Bh=Rh();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],Bh.keys[t]);rg()}var ng=-1;function rg(){if(!ig||Bh.raioRender===ng)return;let e=ng;ng=Bh.raioRender,ig.send(JSON.stringify({type:`radius`,chunks:ng})),qh?.marcar(`raio`,`${e<0?`join`:e} → ${ng}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>eg()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Qm(e,tg,Qh),Yh?.classList.add(`hidden`),Xh?.classList.remove(`hidden`)}),Jh?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Zf(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{Eh.aspect=window.innerWidth/window.innerHeight,Eh.updateProjectionMatrix(),wh.setSize(window.innerWidth,window.innerHeight)});var ig=null,ag=`?`,og=null;function sg(){return new URLSearchParams(location.search).get(`nome`)??qm()}var cg=new Op(e=>ig?.send(JSON.stringify({type:`chat`,text:e})),e=>{$h(),e||$.lock()});$h(),wh.domElement.addEventListener(`pointerdown`,()=>{$.touch&&cg.open&&cg.close()});var lg={tickAvgMs:0,tickMaxMs:0},ug=null,dg=0,fg=[];function pg(){let e=performance.now();dg>0&&(fg.push(e-dg),fg.length>300&&fg.shift()),dg=e}function mg(){let e=fg.length;if(e<2)return 0;let t=fg.reduce((e,t)=>e+t,0)/e,n=fg.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var hg=!1,gg=null,_g=null,vg=null,yg=null,bg=null,xg=null,Sg=null,Cg=`aluno`,wg=!1,Tg=!1;function Eg(){return Cg===`professor`||wg}var Dg=[],Og=null,kg=!1,Ag=[],jg=null,Mg=null,Ng=null,Pg=new rh,Fg=null,Ig=null,Lg=null,Rg=[],zg=new Set,Bg=!1,Vg=null,Hg=null,Ug=!1,Wg=new Map;function Gg(){Vh?.update({regions:Dg,modo:Fg?.modo??`sequencial`,objetivos:Fg?.objetivos??[],grupos:Rg,myGrupo:Lg})}function Kg(e){return e.porGrupo&&Cg!==`professor`?Lg===null?!1:e.porGrupo.find(e=>e.grupo===Lg)?.completo??!1:e.completo}function qg(e){if(Fg){for(let t of Fg.objetivos)Kg(t)?zg.has(t.id)||(zg.add(t.id),e&&Bg&&Wf({kind:`objective_complete`})):zg.delete(t.id);Bg=!0,Pg.update(Fg.modo,Fg.objetivos,{grupo:Lg,professor:Cg===`professor`,painelKey:jm(Bh.keys.painel)}),Ig?.(Fg.objetivos)}}var Jg=null;function Yg(){let e=Jg;if(e){Jg=null;for(let t of e)Zg(t)}}function Xg(){Jg||(Jg=[],requestAnimationFrame(()=>requestAnimationFrame(Yg)),setTimeout(Yg,500))}function Zg(e){if(Jg){Jg.push(e);return}if(pg(),hg||Wh.setFase(`mundo`),typeof e==`string`){let t=Ud(e);if(!t)return;t.type===`debug_stats`?(lg={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},ug=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0}):t.type===`block_changed`?gg?.(t):t.type===`blocks_filled`?_g?.(t):t.type===`player_moved`?(t.name&&Wg.get(t.id)!==t.name&&(Wg.set(t.id,t.name),Cp([...new Set(Wg.values())])),vg?.(t)):t.type===`player_left`?(Wg.delete(t.id),Cp([...new Set(Wg.values())]),yg?.(t.id)):t.type===`spawn`?(Sg={x:t.x,y:t.y,z:t.z},Cg=t.papel??`aluno`):t.type===`regions`?(Dg=t.regions,Og?.(t.regions),Gg()):t.type===`objectives`?(Fg={modo:t.modo,objetivos:t.objetivos},qg(!0),Gg()):t.type===`group`?(Lg=t.grupo,zg.clear(),qg(!1),Gg()):t.type===`groups`?(Rg=t.grupos,Gg()):t.type===`quadros`?Mg?.(t.lista):t.type===`quadro_changed`?Ng?.(t):t.type===`claims`?(kg=t.ativo,Ag=t.claims,jg?.(t.claims)):t.type===`friends`||(t.type===`players`?Uh?.update({conectados:t.conectados,banidos:t.banidos}):t.type===`mundo_trocando`?(bg?.(t.nome),Xg()):t.type===`teleport`?xg?.(t):t.type===`time`?Ah===null&&kh.sync(t.hora,t.ciclo):t.type===`vento`?Mh===null&&jh.sync(t.dir,t.forca,t.ativo):t.type===`voo`?(wg=t.liberado,Eg()||(Tg=!1),cg.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(Zf(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),xh(),location.href=location.pathname):t.type===`join_denied`?(Zf(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),xh(),location.href=location.pathname):t.type===`chat`&&(cg.addMessage(t.author,t.text),t.author===`servidor`&&Ch(t.text),Wf({kind:`chat_message`})));return}let t=qd(e);if(t===809716300){Hg?.(e);return}let n=()=>(Ug=t===Gd,Ug?Jd(e):Wd(e));if(hg){Vg?.(n());return}hg=!0,i_(n())}function Qg(e,t){Bh=Rh(),ig=e,Wh.abrir({host:ag,rede:!(e instanceof im)}),Wh.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),$h(),e.onMessage(Zg),$.onKey(Bh.keys.chat,()=>{cg.open||(document.exitPointerLock(),cg.openInput())}),e.send(JSON.stringify({type:`join`,name:sg(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),ng=-1,rg()}function $g(e,t){ag=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Qg(new am(e,t=>{hg||!Wh.ativo||Wh.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function e_(e,t){og={id:e.id,name:e.name,createdAt:e.createdAt},ag=`web-worker (${e.name})`;let n=new im(new Worker(new URL(`/assets/worker-D-2eSaHB.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho}),Qg(n)}async function t_(){if(!(ig instanceof im)||!og)return;let e=await ig.requestSave();await Rm({...og,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{xh(),t_().finally(()=>location.reload())});var n_=new URLSearchParams(location.search),r_=n_.get(`server`);if(r_){let e=n_.get(`codigo`);$g(r_,{pin:n_.get(`pin`)??``,...e?{codigo:e}:{}})}else Lh?e_({id:`bench-${ep}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:Du(n_.get(`tamanho`)??`E`)},ep):Zm({onPlayWorld:e_,onPlayMulti:$g});function i_(e){let t=ig;if(!t)return;bh(()=>$.active);let n=e.world,r=e.seed,i=Ug,a=new Set,s=0,c=new Map,l=0,u=0,d=0,f=Lf(),p=new ta({map:f,alphaTest:.5});nm(p,Nh);let m=new ta({map:f,transparent:!0,opacity:.72,depthWrite:!1}),h=new ta({map:f,transparent:!0,opacity:.4,depthWrite:!1});if(new URLSearchParams(location.search).has(`atlas`)){let e=p.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let g=new URLSearchParams(location.search),_=g.has(`semworker`),v=Number(g.get(`meshdepth`)),y=new Fp(n,[p,m,h],Th,!_,Number.isFinite(v)&&v>0?v:void 0),b=new Bf(Th),x=-1,S=0,C=-1,w=-1;i||y.buildAll(),Hg=e=>{let t=[];try{t=Xd(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;a.add(t),c.delete(t),y.enfileirarColuna(e,r),E.varrerColuna(n,e,r)}u+=t.length};let T=(e,r,i)=>{let o=n.dims,s=Bh.raioRender,u=0;for(let d=e-s;d<=e+s;d++)for(let e=r-s;e<=r+s;e++){if(d<0||e<0||d>=o.x||e>=o.z)continue;let r=e*o.x+d;if(a.has(r))continue;let s=c.get(r);if(!s){c.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||u>=4)){y.descartarColuna(d,e),E.descartarColuna(d,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+d]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:d,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),u++,l++}}for(let t of c.keys()){let n=t%o.x,i=(t-n)/o.x;(a.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&c.delete(t)}},E=new Sh(Th);E.setFromWorld(n);let D=new ch(Th);D.setRegions(Dg),Og=e=>{D.setRegions(e),D.clearCorners()};let ee=new ch(Th,16747546),te=e=>{ee.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};te(Ag),jg=e=>{te(e),D.clearCorners(),!kg&&Cg!==`professor`&&ve&&(ve=!1),Se()};let O=new fh(Th),ne=new mh;Mg=e=>O.setAll(e,n),Ng=e=>O.aplicar(e,n);let k=new ch(Th,3066993),A=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Lg!==null&&r.grupo===Lg;(Cg===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});k.setRegions(t)};Ig=A,Fg&&A(Fg.objetivos);let re=e=>t.send(JSON.stringify({type:`chat`,text:e})),ie=e=>{e?document.exitPointerLock():$.lock(),$h()};Cg===`professor`&&(Uh=new ih(re,ie)),Vh=Cg===`professor`?new oh(re,ie,()=>{Vh?.hide(),Hh?.hide(),Uh?.show()}):new sh(re,ie),Gg(),$.onKey(Bh.keys.painel,()=>{if(!cg.open){if(Cg!==`professor`&&Rg.length===0){cg.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}Hh?.hide(),Uh?.hide(),Vh?.toggle()}}),Cg===`professor`&&cg.addMessage(`jogo`,`tecla ${jm(Bh.keys.painel)} abre o painel de autoria`);let j=Sg??{x:n.sizeX/2+.5,y:vu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},M=cd(j.x,j.y,j.z),ae=()=>{if(!i)return 0;let e=Bh.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(M.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(M.pos.z/16))),a=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,o=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,a*o)},oe=ae(),se=()=>{Wh.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:a.size,total:oe,faltando:c.size>0?c.size:Math.max(0,oe-a.size),fila:y.filaPendente}))};se(),Wh.setFase(i?`mundo`:`malha`),bg=e=>{oe=0,Wh.abrir({host:ag,rede:!(t instanceof im),titulo:`trocando de aula`,alvo:e}),se(),Wh.setFase(`preparando`),Te.setFase(`carregando`),Te.marcar(`troca de aula`,e),$h()};function ce(){M.pos.x=j.x,M.pos.y=j.y,M.pos.z=j.z,M.vel.x=M.vel.y=M.vel.z=0}Vg=e=>{n=e.world,r=e.seed,i=Ug,a=new Set,c.clear(),y.trocarMundo(n,!i),E.setFromWorld(n),Dg=[],D.setRegions([]),D.clearCorners(),O.setAll([],n),Fg=null,Ig?.([]),Pg.update(`livre`,[],{grupo:null,professor:Cg===`professor`,painelKey:jm(Bh.keys.painel)}),zg.clear(),Bg=!1,Rg=[],Lg=null,Gg(),j=Sg??j,ce(),cg.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),ng=-1,rg(),Te.setMeta({worldChunks:n.dims,worldSeed:e.seed}),oe=ae(),Wh.abrir({host:ag,rede:!(t instanceof im),titulo:`trocando de aula`}),se(),Wh.setFase(i?`mundo`:`malha`),Te.setFase(`carregando`),$h(),i||Wh.concluir()},xg=e=>{M.pos.x=e.x,M.pos.y=e.y,M.pos.z=e.z,M.vel.x=M.vel.y=M.vel.z=0,$.yaw=Fh??e.yaw,$.pitch=Ih??e.pitch},gg=e=>{_u(n,e.x,e.y,e.z,e.blockId),y.remeshBlock(e.x,e.y,e.z),E.onBlockChanged(e.x,e.y,e.z,e.blockId),O.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Wf(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},_g=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)_u(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};y.remeshBox(t,r),E.onRegionFilled(t,r,e.blockId),O.validarTodos(n),Wf(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let le=new Map,ue=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Ni(t);i.minFilter=o;let a=new Mr(new vr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Z.height/2+.35,0),a},N=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};vg=e=>{let t=le.get(e.id);if(!t){let n=new ei(new Li(Z.width,Z.height,Z.width),new ta({color:new U().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Z.height/2,e.z),n.rotation.y=e.yaw,Th.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},le.set(e.id,t)}e.name&&e.name!==t.labelName&&(N(t),t.label=ue(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Z.height/2,e.z),t.targetYaw=e.yaw},yg=e=>{let t=le.get(e);t&&(N(t),Th.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),le.delete(e))};let de=new wi(new Ui(new Li(1,1,1)),new fi({color:0}));de.visible=!1,Th.add(de);let P=null,fe=new V,pe=`lj-hotbar`,me=mp(Cg),he=()=>me.slice(0,9).map(e=>e.id),ge=(()=>{let e=new Set(me.map(e=>e.id));e.add(900);let t=he();try{let n=JSON.parse(localStorage.getItem(pe)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),_e=0,ve=!1,ye=document.getElementById(`hotbar`),be=up(p.map?.image,[...pp.map(e=>e.id),900]),xe=e=>e===900?`balde vazio`:e===901?`balde de água`:pp.find(t=>t.id===e)?.name??`?`,Se=()=>{if(!ye)return;if(ve){ye.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${Cg===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=ge.map((e,t)=>`<span class="slot${t===_e?` sel`:``}"><small>${t+1}</small><img src="${be.get(e)??``}" alt=""></span>`).join(``);ye.innerHTML=`<span class="bar-nome">${xe(ge[_e]??K.Grass)}</span><span class="slots">${e}</span>`,Hh?.refresh()};Se();let Ce=()=>{Cg!==`professor`&&!kg||(ve=!ve,Se())};$.onKey(Bh.keys.varinha,Ce);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{_e=e,Se()});$.onWheel(e=>{_e=(_e+e+ge.length)%ge.length,Se()}),Hh=new hp(be,()=>me,()=>({hotbar:ge,selected:_e}),e=>{ge[_e]=e,localStorage.setItem(pe,JSON.stringify(ge)),Se()},e=>{_e=e,Se()},e=>{e?(Vh?.hide(),Uh?.hide(),document.exitPointerLock()):$.lock(),$h()}),$.onKey(Bh.keys.inventario,()=>{cg.open||Hh?.toggle()});let we=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),D.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(P){if(ve){we(1,P);return}Cl(ge[_e]??-1)||t.send(JSON.stringify({type:`break_block`,x:P.x,y:P.y,z:P.z}))}}),$.onMouseButton(2,()=>{if(!P)return;if(ve){we(2,P);return}{let e=ge[_e];if(Cl(e??-1)){if(e===901)t.send(JSON.stringify({type:`balde`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,encher:!1})),ge[_e]=900;else{if(gu(n,P.x,P.y,P.z)!==K.Agua)return;t.send(JSON.stringify({type:`balde`,x:P.x,y:P.y,z:P.z,encher:!0})),ge[_e]=901}localStorage.setItem(pe,JSON.stringify(ge)),Se();return}}if(Rl(gu(n,P.x,P.y,P.z))){let{x:e,y:n,z:r}=P;ne.open(O.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(eu(gu(n,P.x,P.y,P.z))){t.send(JSON.stringify({type:`use_block`,x:P.x,y:P.y,z:P.z}));return}let e=ge[_e];if(e!==void 0){if((e===K.PortaXFechada||e===K.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.PortaXFechada:K.PortaZFechada),(e===K.JanelaXFechada||e===K.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.JanelaXFechada:K.JanelaZFechada),zl(e)||Bl(e)||Vl(e)||Rl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(zl(e)?K.CadeiraXP:Bl(e)?K.SofaXP:Vl(e)?K.CamaXP:K.QuadroXP)+r}if(Ol(e)){let t=e-+!!kl(e);e=P.ny<0?t+1:t}if(jl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Fl(Pl(e),r,P.ny<0)}t.send(JSON.stringify({type:`place_block`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!P||ve)return;let e=gu(n,P.x,P.y,P.z);Kl(e)&&(e=K.PortaXFechada),Xl(e)&&(e=K.JanelaXFechada),zl(e)&&(e=K.CadeiraXP),Bl(e)&&(e=K.SofaXP),Vl(e)&&(e=K.CamaXP),Rl(e)&&(e=K.QuadroXP),Ol(e)&&(e=K.LajePedraBaixo+Al(e)*2),jl(e)&&(e=K.EscadaPedraXP+Pl(e)*8),ru(e)&&(iu(e)&&Cg!==`professor`||(ge[_e]=e,localStorage.setItem(pe,JSON.stringify(ge)),Se()))});let Te=new mm(wh,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:ag});qh=Te,Te.contexto=()=>({x:M.pos.x,y:M.pos.y,z:M.pos.z,yaw:$.yaw,pitch:$.pitch,voando:Tg&&Eg(),noChao:M.onGround,raioRender:Bh.raioRender,meshMsPorFrame:Bh.meshMsPorFrame,pixelRatioCap:Bh.pixelRatioCap,fov:Bh.fov,distanciaTotal:d,colunasRecebidas:u,bytesRecebidos:t.stats.bytesIn}),Te.setRemesh({count:y.remeshCount,totalMs:y.remeshMsTotal,workerMs:y.remeshWorkerMsTotal,config:y.meshConfig,lastMs:y.lastRemeshMs,porCaminho:y.porCaminho}),Te.carga=()=>Wh.relatorio(),Te.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Ee=null;if(Lh){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);cg.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{Te.baixar(e,`bench`),cg.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-bench-*.json)`)}};Gh=()=>{if(Ee)return;Ee=cp.paraMundo(Lh.duracaoS,j,n.dims),Te.setMeta({bench:Ee.meta()}),Te.marcar(`bench: início`,`${Lh.duracaoS}s · raio ${Ee.trajeto.raio}`),Kh=!0,Tg=!0,$h(),Ee.iniciar(performance.now());let t=Ee.amostra(performance.now());M.pos.x=je=t.x,M.pos.y=Me=t.y,M.pos.z=Ne=t.z,Te.record(t=>{Kh=!1,$h(),window.__benchPerfil=t,e(t)},Lh.duracaoS*1e3)}}$.onKey(Bh.keys.hud,()=>Te.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{Te.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),Hm()&&(ye&&(ye.style.pointerEvents=`auto`,ye.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(_e=n,Se())})),zh=new Gm($,{keys:()=>Bh.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>Hh?.toggle(),chat:()=>{cg.open||(document.exitPointerLock(),cg.openInput())},menu:()=>{$.touch=!1,Qh(),$h()},hud:()=>Te.toggle(),varinha:()=>Ce()}),zh.setScale(Bh.uiScale),$h()),Te.extra=()=>{let e=$.mouseStats,t=M.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=Mu(i,a,r),s=ou(o),c=su(o),l=Math.min(ju(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&o.temp<.6?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===K.GramaSeca?`grama seca`:c===K.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se temp<0.60 · chapada ≥85]\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let De={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},Oe=0;setInterval(()=>{let e={x:M.pos.x,y:M.pos.y,z:M.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==De.x||e.y!==De.y||e.z!==De.z||e.yaw!==De.yaw||e.pitch!==De.pitch,r=performance.now();!n&&r-Oe<2e3||(De=e,Oe=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof im&&og&&!Lh&&(t_(),setInterval(()=>void t_(),3e4));let ke={...t.stats};setInterval(()=>{let e=t.stats;Te.net={msgsPerSec:e.msgsIn+e.msgsOut-(ke.msgsIn+ke.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(ke.bytesIn+ke.bytesOut),tickAvgMs:lg.tickAvgMs,tickMaxMs:lg.tickMaxMs,jitterMs:mg()},Te.regras=ug,Te.stream={colunas:a.size,fila:y.filaPendente,faltando:c.size,repedidas:l,ultimoLote:y.ultimoLote},ke={...e}},1e3);let Ae=performance.now(),je=M.pos.x,Me=M.pos.y,Ne=M.pos.z,F=!1,Pe=!1,Fe=0,Ie=!1,I=0,Le=Z.eyeHeight,L=0;wh.setAnimationLoop(()=>{let e=performance.now(),t=e-Ae;Ae=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(Bh.keys.forward)-+!!$.down(Bh.keys.back):0,c=$.active?!!$.down(Bh.keys.right)-+!!$.down(Bh.keys.left):0,l=$.active&&$.down(Bh.keys.jump),u=$.active&&$.down(Bh.keys.forward);u&&!Pe&&(e-Fe<300&&(F=!0),Fe=e),u||(F=!1),Pe=u;let p=$.active&&$.down(Bh.keys.agachar),m=o>0&&!p&&(F||$.active&&$.down(Bh.keys.correr));l&&!Ie&&(Eg()&&e-I<300&&(Tg=!Tg),I=e),Ie=l;let h=Tg&&Eg(),g=!0;if(i){y.modoCarga=Wh.ativo,y.processarFila(Bh.meshMsPorFrame,(e,t)=>{a.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(M.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(M.pos.z/16)));if(g=a.has(r*n.dims.x+t),(s=(s+1)%60)==0){for(let e of a){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>Bh.raioRender+2){a.delete(e),y.descartarColuna(i,o),E.descartarColuna(i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}T(t,r,e)}Wh.ativo&&a.size>=oe&&y.filaPendente===0&&Wh.concluir()}if(Ee?.ativo){let t=Ee.amostra(e);M.pos.x=t.x,M.pos.y=t.y,M.pos.z=t.z,M.vel.x=M.vel.y=M.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Ee.terminou(e)&&(Ee.parar(),Te.marcar(`bench: fim`))}let _=M.pos.y;g&&!Ee?.ativo&&yd(n,M,{forward:o,strafe:c,jump:l,yaw:$.yaw,sprint:m,sneak:p,fly:h},r);let v=M.pos.y-_;M.onGround&&!h&&v>.01&&v<=.56&&(L=Math.min(L+v,od)),L*=Math.exp(-r*14),L<.002&&(L=0),d+=Math.hypot(M.pos.x-je,M.pos.y-Me,M.pos.z-Ne),je=M.pos.x,Me=M.pos.y,Ne=M.pos.z,M.pos.y<-16&&ce();let D=1-Math.exp(-r*12);for(let e of le.values()){e.mesh.position.lerp(e.target,D);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*D}let ee=1-Math.exp(-r*20);Le+=((p&&!h?Z.sneakEyeHeight:Z.eyeHeight)-Le)*ee;let te=Bh.fov*(M.sprinting?1.1:1);if(Math.abs(Eh.fov-te)>.01&&(Eh.fov+=(te-Eh.fov)*ee,Eh.updateProjectionMatrix()),Eh.position.set(M.pos.x,M.pos.y+Le-L,M.pos.z),Eh.rotation.set($.pitch,$.yaw,0),Eh.getWorldDirection(fe),P=$.active?xd(n,Eh.position.x,Eh.position.y,Eh.position.z,fe.x,fe.y,fe.z,5,ge[_e]===900):null,de.visible=P!==null,P){let[e,t,r,i,a,o]=Hu(gu(n,P.x,P.y,P.z));de.position.set(P.x+(e+i)/2,P.y+(t+a)/2,P.z+(r+o)/2),de.scale.set(i-e+.004,a-t+.004,o-r+.004)}Te.setRemesh({count:y.remeshCount,totalMs:y.remeshMsTotal,workerMs:y.remeshWorkerMsTotal,config:y.meshConfig,lastMs:y.lastRemeshMs,porCaminho:y.porCaminho}),jh.update(r),Nh.ventoTempo.value=jh.fase*Math.PI*2,Nh.ventoDir.value.set(jh.x,jh.z),Nh.ventoForca.value=Bh.balanco?jh.forca:0,kh.update(r,jh),b.update(n,Eh.position.x,Eh.position.y,Eh.position.z);let O=Math.floor(jh.fase*16)%16;S+=r;let ne=Math.floor(S*8)%16;(O!==x||ne!==C)&&S-w>=1/12&&(w=S,x=O,C=ne,If(f,O,jh.ondaAgua,ne));let k=performance.now();Te.gpuInicio(),wh.render(Th,Eh),Te.gpuFim(),Te.frame(t,performance.now()-k)}),i||Wh.concluir(),n_.has(`hud`)&&Te.toggle(),new URLSearchParams(location.search).has(`painel`)&&Vh?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Hh?.toggle(),n_.has(`touch`)&&eg()}