...
}`)},e.needsUpdate=!0}function Gh(){return{ventoTempo:{value:0},ventoDir:{value:new z(1,0)},ventoForca:{value:0}}}function Kh(e,t,n){let r=n^Math.imul(e,374761393)^Math.imul(t,668265263);return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function Q(e,t,n,r,i=0,a=J.tilePx){let o=J.tilePx,s=t%J.tilesPerRow*o,c=(t/J.tilesPerRow|0)*o;for(let l=i;l<a;l++)for(let i=0;i<o;i++){let a=(Kh(i,l,t*7919+1)-.5)*2*r;e.fillStyle=`rgb(${Math.round(n[0]+a)},${Math.round(n[1]+a)},${Math.round(n[2]+a)})`,e.fillRect(s+i,c+l,1,1)}}function qh(e,t){let n=J.tilePx,r=t%J.tilesPerRow*n,i=(t/J.tilesPerRow|0)*n;e.fillStyle=`rgb(72,72,72)`;for(let t=0;t<n;t++)e.fillRect(r+t,i+(t%2==0?4:5),1,1),e.fillRect(r+t,i+(t%3==0?11:10),1,1),e.fillRect(r+(t%2==0?7:8),i+t,1,1)}function Jh(e){let t=J.tilePx;return[e%J.tilesPerRow*t,(e/J.tilesPerRow|0)*t]}function Yh(e,t){let[n,r]=Jh(t);e.fillStyle=`rgb(74,54,34)`;for(let i=1;i<J.tilePx;i+=4)for(let a=0;a<J.tilePx;a++)Kh(i,a,t*31+3)<.8&&e.fillRect(n+i,r+a,1,a===0?2:1)}function Xh(e,t){let[n,r]=Jh(t),i=J.tilePx/2-.5;e.fillStyle=`rgb(120,90,52)`;for(let t=0;t<J.tilePx;t++)for(let a=0;a<J.tilePx;a++){let o=Math.hypot(a-i,t-i);Math.round(o)%3==0&&o<7.5&&e.fillRect(n+a,r+t,1,1)}}function Zh(e,t){let[n,r]=Jh(t);e.fillStyle=`rgb(122,92,56)`;for(let t=3;t<J.tilePx;t+=4)e.fillRect(n,r+t,J.tilePx,1);for(let t=0;t<4;t++)e.fillRect(n+(t%2==0?4:11),r+t*4,1,3)}function Qh(e,t){let[n,r]=Jh(t);e.fillStyle=`rgb(196,178,124)`;for(let i=3;i<J.tilePx;i+=5)for(let a=0;a<J.tilePx;a++)Kh(a,i,t*41+5)<.7&&e.fillRect(n+a,r+i,1,1)}function $h(e,t){let[n,r]=Jh(t);e.fillStyle=`rgb(96,96,96)`;for(let t=3;t<J.tilePx;t+=4)e.fillRect(n,r+t,J.tilePx,1);for(let t=0;t<4;t++){let i=t%2==0?7:3;e.fillRect(n+i,r+t*4,1,3),e.fillRect(n+(i+8)%J.tilePx,r+t*4,1,3)}}function eg(e,t){let[n,r]=Jh(t);e.fillStyle=`rgb(92,58,128)`;for(let i=0;i<J.tilePx;i++)for(let a=0;a<J.tilePx;a++)Kh(a,i,t*67+11)<.06&&e.fillRect(n+a,r+i,1,1)}function tg(e,t){let[n,r]=Jh(t);for(let i=0;i<4;i++)for(let a=0;a<J.tilePx;a++){let o=(a+(i%2==0?0:4))%8;for(let s=0;s<3;s++){if(o===7)continue;let c=(Kh(a,i*4+s,t*53+9)-.5)*20;e.fillStyle=`rgb(${Math.round(158+c)},${Math.round(64+c)},${Math.round(52+c)})`,e.fillRect(n+a,r+i*4+s,1,1)}}}function ng(e,t){let[n,r]=Jh(t),i=J.tilePx;e.clearRect(n,r,i,i),e.fillStyle=`rgb(214,232,240)`,e.fillRect(n,r,i,1),e.fillRect(n,r+i-1,i,1),e.fillRect(n,r,1,i),e.fillRect(n+i-1,r,1,i);for(let t=2;t<6;t++)e.fillRect(n+t,r+8-t,1,1);for(let t=4;t<10;t++)e.fillRect(n+t,r+14-t,1,1)}function rg(e,t,n){let[r,i]=Jh(t),a=J.tilePx;e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`,e.fillRect(r,i,a,a),e.fillStyle=`rgb(${Math.round((n[0]+255)/2)},${Math.round((n[1]+255)/2)},${Math.round((n[2]+255)/2)})`,e.fillRect(r,i,a,1),e.fillRect(r,i+a-1,a,1),e.fillRect(r,i,1,a),e.fillRect(r+a-1,i,1,a),e.fillStyle=`rgb(240,246,250)`;for(let t=3;t<8;t++)e.fillRect(r+t,i+11-t,1,1)}function ig(e,t,n,r){Q(e,t,r,6);let[i,a]=Jh(t),o=J.tilePx;e.fillStyle=`rgb(28,28,32)`,e.font=`bold ${o-3}px sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(n,i+o/2,a+o/2+1)}function ag(e,t){Q(e,t,[146,112,66],10);let[n,r]=Jh(t);e.fillStyle=`rgb(116,86,48)`;for(let i=2;i<J.tilePx;i+=3)for(let a=0;a<J.tilePx;a++)Kh(i,a,t*29+7)<.6&&e.fillRect(n+i,r+a,1,1)}function og(e,t,n){Q(e,t,[164,126,76],8);let[r,i]=Jh(t),a=J.tilePx;e.fillStyle=`rgb(112,82,46)`,e.fillRect(r,i,a,1),e.fillRect(r,i+a-1,a,1),e.fillRect(r,i,1,a),e.fillRect(r+a-1,i,1,a),e.fillRect(r+8,i,1,a),n&&(e.fillRect(r+3,i+3,10,1),e.fillRect(r+3,i+9,10,1),e.fillRect(r+3,i+3,1,7),e.fillRect(r+12,i+3,1,7),e.clearRect(r+4,i+4,8,5))}function sg(e,t){Q(e,t,[255,232,122],14,0,10),Q(e,t,[122,92,56],10,10,J.tilePx)}function cg(e,t){Q(e,t,[164,126,76],8);let[n,r]=Jh(t),i=J.tilePx;e.clearRect(n+2,r+2,i-4,i-4),e.fillStyle=`rgb(112,82,46)`,e.fillRect(n+7,r+2,2,i-4),e.fillRect(n+2,r+7,i-4,2),e.fillStyle=`rgb(214,232,240)`;for(let t=0;t<3;t++)e.fillRect(n+3+t,r+6-t,1,1);for(let t=0;t<3;t++)e.fillRect(n+10+t,r+13-t,1,1)}function lg(e,t){Q(e,t,[72,104,168],8);let[n,r]=Jh(t);e.fillStyle=`rgb(54,80,132)`;for(let t=5;t<J.tilePx;t+=6)e.fillRect(n,r+t,J.tilePx,1),e.fillRect(n+t,r,1,J.tilePx)}function ug(e,t){Q(e,t,[178,54,48],8);let[n,r]=Jh(t);e.fillStyle=`rgb(140,40,36)`;for(let t=4;t<J.tilePx;t+=5)e.fillRect(n,r+t,J.tilePx,1)}function dg(e,t){Q(e,t,[242,238,228],4);let[n,r]=Jh(t),i=J.tilePx;e.fillStyle=`rgb(122,86,50)`,e.fillRect(n,r,i,2),e.fillRect(n,r+i-2,i,2),e.fillRect(n,r,2,i),e.fillRect(n+i-2,r,2,i)}function fg(e,t,n=[52,118,44]){Q(e,t,n,16);let[r,i]=Jh(t);for(let n=0;n<J.tilePx;n++)for(let a=0;a<J.tilePx;a++)Kh(a,n,t*97+13)<.22&&e.clearRect(r+a,i+n,1,1)}function pg(e,t,n,r){Q(e,t,[136,136,136],12);let[i,a]=Jh(t);e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`;for(let n=1;n<J.tilePx-2;n++)for(let r=1;r<J.tilePx-2;r++)Kh(r,n,t*131+17)<.07&&e.fillRect(i+r,a+n,2,2);let o=i+J.tilePx/2,s=a+J.tilePx/2;e.font=`bold 8px sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillStyle=`rgb(20,20,24)`,e.fillText(r,o+1,s+2),e.fillStyle=`rgb(244,244,248)`,e.fillText(r,o,s+1)}function mg(e,t){Q(e,t,[66,138,74],10);let[n,r]=Jh(t);e.fillStyle=`rgb(48,104,56)`;for(let t=2;t<J.tilePx;t+=4)e.fillRect(n+t,r,1,J.tilePx);e.fillStyle=`rgb(230,238,214)`;for(let i=1;i<J.tilePx;i+=3)for(let a=3;a<J.tilePx;a+=4)Kh(a,i,t*61+19)<.5&&e.fillRect(n+a,r+i,1,1)}function hg(e,t){Q(e,t,[96,168,100],8);let[n,r]=Jh(t),i=J.tilePx;e.fillStyle=`rgb(48,104,56)`,e.fillRect(n,r,i,1),e.fillRect(n,r+i-1,i,1),e.fillRect(n,r,1,i),e.fillRect(n+i-1,r,1,i)}function gg(e,t,n){let[r,i]=Jh(t),a=J.tilePx;e.clearRect(r,i,a,a);let o=r+(a>>1);e.fillStyle=`rgb(56,132,52)`,e.fillRect(o-1,i+(a>>1),2,a>>1),e.fillRect(o-3,i+a-5,2,2),e.fillRect(o+1,i+a-7,2,2),e.fillStyle=`rgb(${n[0]},${n[1]},${n[2]})`,e.fillRect(o-3,i+2,6,6),e.fillRect(o-4,i+4,8,2),e.fillRect(o-2,i+1,4,8),e.fillStyle=`rgb(250,214,74)`,e.fillRect(o-1,i+4,2,2)}function _g(e,t,n){let[r,i]=Jh(t),a=J.tilePx;e.clearRect(r,i,a,a);for(let o=0;o<7;o++){let s=1+Math.floor(Kh(o,0,t*17+3)*(a-2)),c=7+Math.floor(Kh(o,1,t*17+5)*7),l=Kh(o,2,t*17+7)<.5?-1:1,u=.72+Kh(o,3,t*17+9)*.5;e.fillStyle=`rgb(${Math.round(n[0]*u)},${Math.round(n[1]*u)},${Math.round(n[2]*u)})`;for(let t=0;t<c;t++){let n=a-1-t,o=t/c,u=s+Math.round(o*o*3)*l;u<0||u>=a||(e.fillRect(r+u,i+n,1,1),o<.45&&u+1<a&&e.fillRect(r+u+1,i+n,1,1))}}}function vg(e,t,n){let[r,i]=Jh(t),a=J.tilePx;e.clearRect(r,i,a,a);let o=[[96,176,74],[104,172,62],[156,176,56],[206,176,60]],s=o[n]??o[0],c=4+n*4;for(let t=0;t<5;t++){let o=2+Math.floor(Kh(t,0,91)*(a-4)),l=Math.max(2,c-Math.floor(Kh(t,1,93)*3)),u=.78+Kh(t,2,95)*.42;e.fillStyle=`rgb(${Math.round(s[0]*u)},${Math.round(s[1]*u)},${Math.round(s[2]*u)})`;for(let t=0;t<l;t++)e.fillRect(r+o,i+a-1-t,1,1);n===3&&(e.fillStyle=`rgb(226,196,88)`,e.fillRect(r+o-1,i+a-l,3,3))}}function yg(e,t,n){Q(e,t,[128,128,130],16),qh(e,t);let[r,i]=Jh(t),a=J.tilePx,o=r+3,s=i+6,c=a-6,l=a-9;e.fillStyle=`rgb(168,168,170)`,e.fillRect(o-1,s-1,c+2,l+2),e.fillStyle=n?`rgb(58,20,8)`:`rgb(38,36,38)`,e.fillRect(o,s,c,l),n&&(e.fillStyle=`rgb(220,96,26)`,e.fillRect(o,s+l-3,c,3),e.fillStyle=`rgb(248,190,60)`,e.fillRect(o+2,s+l-5,2,3),e.fillRect(o+c-4,s+l-6,2,4))}function bg(e,t){Q(e,t,[112,112,116],14),qh(e,t)}function xg(e,t){Q(e,t,[140,140,142],12);let[n,r]=Jh(t),i=J.tilePx;e.strokeStyle=`rgb(74,70,68)`,e.lineWidth=1,e.strokeRect(n+2.5,r+2.5,i-5,i-5)}function Sg(e,t,n){Q(e,t,[116,78,40],14);let[r,i]=Jh(t),a=J.tilePx;e.fillStyle=`rgb(84, 54, 26)`;for(let t of[4,8,12])e.fillRect(r+t,i,1,a);if(n){e.strokeStyle=`rgb(70, 46, 22)`,e.lineWidth=1,e.strokeRect(r+1.5,i+1.5,a-3,a-3),e.fillStyle=`rgb(150, 150, 158)`,e.fillRect(r+2,i+7,a-4,2);return}e.fillStyle=`rgb(146, 100, 52)`,e.fillRect(r,i+4,a,1),e.fillStyle=`rgb(64, 40, 18)`,e.fillRect(r,i+5,a,1),e.fillStyle=`rgb(158, 158, 166)`,e.fillRect(r+6,i+3,4,5),e.fillStyle=`rgb(52, 52, 58)`,e.fillRect(r+7,i+5,2,2)}function Cg(e,t,n,r=!1){let[i,a]=Jh(t),o=J.tilePx;e.clearRect(i,a,o,o);let s=r?[126,140,74]:[88,152,78],c=r?11:4+n*3;for(let t=0;t<4;t++){let l=3+Math.floor(Kh(t,0,61)*(o-6)),u=Math.max(2,c-Math.floor(Kh(t,1,67)*3)),d=.8+Kh(t,2,71)*.4;e.fillStyle=`rgb(${Math.round(s[0]*d)},${Math.round(s[1]*d)},${Math.round(s[2]*d)})`;for(let t=0;t<u;t++)e.fillRect(i+l,a+o-1-t,1,1);(n===3||r)&&(e.fillStyle=`rgb(244,244,238)`,e.fillRect(i+l-1,a+o-u-2,3,3),e.fillStyle=`rgb(206,206,198)`,e.fillRect(i+l+1,a+o-u,1,1))}}var wg={a:[-3,0],b:[-3,0],mistura:0},Tg=Y.agua*7919+1;function Eg(e,t,n,r,i){let a=J.tilePx,o=Math.PI*2/a,s=i.mistura,c=(e,t,n)=>{let i=Math.sin((e[0]*t+e[1]*n)*o-r),a=Math.sin((-e[1]*t+e[0]*n)*o*2-r*.55);return[i*6+a*3,+(i>.82&&a>.1)]};for(let r=0;r<a;r++)for(let o=0;o<a;o++){let[a,l]=c(i.a,o,r),[u,d]=c(i.b,o,r),f=a+(u-a)*s,p=l+(d-l)*s,m=(Kh(o,r,Tg)-.5)*2*6,h=(r*t+n+o)*4;e[h]=46+f+m+p*52,e[h+1]=108+f+m+p*44,e[h+2]=182+f*.6+m+p*28,e[h+3]=255}}var Dg=null,Og=null;function kg(e,t,n,r){let i=J.tilePx,a=Math.PI*2/16;Dg??=e.createImageData(i,i),Eg(Dg.data,i,0,t%16*a,n);let[o,s]=Jh(Y.agua);e.putImageData(Dg,o,s);let c=Ff.length;Og??=e.createImageData(i*c,i);let l=r%16*a;for(let e=0;e<c;e++){let t=Ff[e];Eg(Og.data,i*c,e*i,l,{a:t,b:t,mistura:0})}let[u,d]=Jh(Y.aguaFluxo);e.putImageData(Og,u,d)}function Ag(e,t,n,r){let i=e.image.getContext(`2d`);i&&(kg(i,t,n??wg,r),e.needsUpdate=!0)}function jg(){let e=J.tilesPerRow*J.tilePx,t=document.createElement(`canvas`);t.width=e,t.height=e;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);Q(n,Y.grassTop,[92,158,60],14),Q(n,Y.grassSide,[121,88,58],12),Q(n,Y.grassSide,[92,158,60],14,0,4),Q(n,Y.dirt,[121,88,58],12),Q(n,Y.stone,[136,136,136],12),Q(n,Y.cobblestone,[120,120,120],20),qh(n,Y.cobblestone),Q(n,Y.sand,[219,207,142],10),Q(n,Y.logSide,[104,78,48],10),Yh(n,Y.logSide),Q(n,Y.logTop,[168,132,82],8),Xh(n,Y.logTop),Q(n,Y.planks,[172,136,86],8),Zh(n,Y.planks),Q(n,Y.brick,[186,180,172],8),tg(n,Y.brick),Q(n,Y.gravel,[112,106,100],30),Q(n,Y.bedrock,[42,42,46],24),Q(n,Y.woolWhite,[232,232,230],6),Q(n,Y.woolBlack,[38,38,42],6),Q(n,Y.woolRed,[196,52,46],8),Q(n,Y.woolOrange,[226,132,38],8),Q(n,Y.woolYellow,[232,206,58],8),Q(n,Y.woolGreen,[74,164,62],8),Q(n,Y.woolBlue,[58,94,194],8),Q(n,Y.woolPurple,[142,72,182],8),Q(n,Y.sandstone,[214,198,146],8),Qh(n,Y.sandstone),Q(n,Y.stoneBricks,[128,128,128],10),$h(n,Y.stoneBricks),Q(n,Y.snow,[240,244,248],5),Q(n,Y.obsidian,[30,24,42],8),eg(n,Y.obsidian),Q(n,Y.woolPink,[226,140,170],8),Q(n,Y.woolCyan,[70,178,190],8),Q(n,Y.woolGray,[130,130,134],6),Q(n,Y.woolBrown,[110,80,54],8),ng(n,Y.glass),fg(n,Y.leaves),ag(n,Y.cerca),og(n,Y.portaBaixo,!1),og(n,Y.portaCima,!0),sg(n,Y.tocha),cg(n,Y.janela),lg(n,Y.estofado),ug(n,Y.colchao),dg(n,Y.quadro),gg(n,Y.florVermelha,[214,58,54]),gg(n,Y.florAmarela,[242,206,62]),gg(n,Y.florAzul,[86,122,220]),gg(n,Y.florBranca,[238,240,246]),pg(n,Y.minerioCarvao,[40,40,44],`C`),pg(n,Y.minerioFerro,[216,162,122],`Fe`),pg(n,Y.minerioOuro,[244,208,64],`Au`),pg(n,Y.minerioDiamante,[108,226,222],`D`),Q(n,Y.gramaSecaTop,[178,162,66],14),Q(n,Y.gramaSecaSide,[121,88,58],12),Q(n,Y.gramaSecaSide,[178,162,66],14,0,4),Q(n,Y.gramaFriaTop,[96,138,116],12),Q(n,Y.gramaFriaSide,[121,88,58],12),Q(n,Y.gramaFriaSide,[96,138,116],12,0,4),Q(n,Y.logIpe,[128,110,86],10),Yh(n,Y.logIpe),Q(n,Y.logAraucaria,[86,60,42],10),Yh(n,Y.logAraucaria),Q(n,Y.logPauBrasil,[124,66,46],10),Yh(n,Y.logPauBrasil),fg(n,Y.folhasIpe,[222,186,48]),fg(n,Y.folhasAraucaria,[34,88,46]),fg(n,Y.folhasPauBrasil,[42,130,54]),mg(n,Y.mandacaruSide),hg(n,Y.mandacaruTop),kg(n,0,wg,0),_g(n,Y.gramaAlta,[92,158,60]),_g(n,Y.gramaAltaSeca,[178,162,66]),_g(n,Y.gramaAltaFria,[96,138,116]);for(let e=0;e<4;e++)vg(n,Y.plantacao0+e,e);xg(n,Y.fornalhaTopo),yg(n,Y.fornalhaLado,!1),yg(n,Y.fornalhaLadoAcesa,!0),bg(n,Y.fornalhaCostas),Sg(n,Y.bauTopo,!0),Sg(n,Y.bauLado,!1);for(let e=0;e<4;e++)Cg(n,Y.algodao0+e,e);Cg(n,Y.algodaoSelvagem,3,!0);let i=[[232,232,230],[38,38,42],[196,52,46],[226,132,38],[232,206,58],[74,164,62],[58,94,194],[142,72,182],[226,140,170],[70,178,190],[130,130,134],[110,80,54]];for(let e=0;e<i.length;e++)rg(n,Y.vidroBranco+e,i[e]);for(let e=0;e<Rf.letters.length;e++)ig(n,Rf.base+e,Rf.letters[e],[236,228,206]);for(let e=0;e<Rf.digits.length;e++)ig(n,Rf.base+Rf.letters.length+e,Rf.digits[e],[206,222,240]);let a=new Pi(t);return a.magFilter=r,a.minFilter=r,a.generateMipmaps=!1,a.colorSpace=ze,a}function Mg(){return{nivelCeu:{value:1},luzMin:{value:.05}}}function Ng(e,t){let n=e.onBeforeCompile;e.onBeforeCompile=(r,i)=>{n?.call(e,r,i),r.uniforms.nivelCeu=t.nivelCeu,r.uniforms.luzMin=t.luzMin,r.vertexShader=r.vertexShader.replace(`#include <common>`,`#include <common>
attribute float luz;
...
`;function e_(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function t_(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function n_(e){return`${(e/1e3).toFixed(1)} s`}var r_=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=$g,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(Qg*.25).toFixed(1)} ${Qg.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,Qg.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(Qg*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=n_(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${n_(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=e_(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=t_(n.bytes)}e.forcar.classList.toggle(`hidden`,o<Xg||this.fase===`pronto`)}},i_={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`,amigos:`KeyG`}},a_={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`,amigos:`painel de amigos (áreas compartilhadas)`},o_=`lj-config`;function s_(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function c_(e,t){return typeof e==`boolean`?e:t}function l_(){let e=null;try{e=JSON.parse(localStorage.getItem(o_)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...i_.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:s_(t.sensitivity,i_.sensitivity,.2,3),fov:s_(t.fov,i_.fov,60,100),pixelRatioCap:s_(t.pixelRatioCap,i_.pixelRatioCap,1,2),volume:s_(t.volume,i_.volume,0,1),raioRender:s_(t.raioRender,i_.raioRender,2,12),meshMsPorFrame:s_(t.meshMsPorFrame,i_.meshMsPorFrame,1,16),uiScale:s_(t.uiScale,i_.uiScale,.6,1.8),nuvens:c_(t.nuvens,i_.nuvens),balanco:c_(t.balanco,i_.balanco),keys:r}}function u_(e){localStorage.setItem(o_,JSON.stringify(e))}function d_(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var f_=`logica-em-jogo`,p_=`worlds`;function m_(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var h_=null;function g_(){return h_??=new Promise((e,t)=>{let n=indexedDB.open(f_,1);n.onupgradeneeded=()=>{n.result.createObjectStore(p_,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),h_}async function __(){return(await m_((await g_()).transaction(p_).objectStore(p_).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function v_(e){await m_((await g_()).transaction(p_,`readwrite`).objectStore(p_).put(e))}async function y_(e){await m_((await g_()).transaction(p_,`readwrite`).objectStore(p_).delete(e))}function b_(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function x_(e){let t=await e.arrayBuffer();sm(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function S_(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function C_(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var w_=`
:root { --ts: 1; }
...
`;function T_(e,t,n){let r=e.querySelector(`span`),i=e.querySelector(`small`);r&&(r.textContent=t),i&&(i.textContent=n)}var E_=class{input;actions;root;heldKeys=new Set;btnVarinha=null;btnAmigos=null;btnQuebrar=null;btnColocar=null;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=w_,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.btnQuebrar=this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.btnColocar=this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.btnVarinha=this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.btnAmigos=this.tapButton(`👥`,`amigos`,()=>this.actions.amigos())),this.btnVarinha.classList.add(`hidden`),this.btnAmigos.classList.add(`hidden`),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){document.documentElement.style.setProperty(`--ts`,String(e))}setVarinhaDisponivel(e){this.btnVarinha?.classList.toggle(`hidden`,!e)}setAmigosDisponivel(e){this.btnAmigos?.classList.toggle(`hidden`,!e)}setVarinha(e){this.btnVarinha?.classList.toggle(`ativo`,e),this.btnQuebrar&&T_(this.btnQuebrar,e?`①`:`⛏`,e?`canto 1`:`quebrar`),this.btnColocar&&T_(this.btnColocar,e?`②`:`▣`,e?`canto 2`:`colocar`)}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},D_=`lj-nome`;function O_(){let e=localStorage.getItem(D_),t=e?Ru(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(D_,t),t}function k_(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function A_(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function j_(e){document.getElementById(e)?.classList.add(`hidden`)}function M_(e){let t=k_(`menu`),n={home:k_(`menu-home`),worlds:k_(`menu-worlds`),multi:k_(`menu-multi`),config:k_(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),k_(`menu-version`).textContent=`v${um}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&wm(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),A_(`menu-erro`,i));let a=k_(`menu-nome`);a.value=O_(),a.addEventListener(`change`,()=>{let e=Ru(a.value);localStorage.setItem(D_,e),a.value=e}),k_(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),k_(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),k_(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=k_(`menu-world-list`);async function c(){let e=[];try{e=await __()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>b_(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){y_(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=k_(`menu-new-nome`),u=k_(`menu-new-tipo`);k_(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){A_(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}j_(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:$d(u.value),tamanho:ef(k_(`menu-new-tamanho`).value),sobrevivencia:ld(k_(`menu-new-jogo`).value)})});let d=k_(`menu-import-file`);k_(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&x_(e).then(async e=>{await v_(e),await c(),j_(`menu-worlds-erro`)}).catch(e=>{A_(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=k_(`menu-endereco`),p=k_(`menu-pin`),m=k_(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,k_(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){A_(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){A_(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}j_(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),N_(k_(`menu-config-body`),void 0,()=>r(`home`))}function N_(e,t,n){I_(e,t,n)}function P_(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var F_=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function I_(e,t,n){e.textContent=``;for(let r of F_){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>L_(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{u_(structuredClone(i_)),t?.(),I_(e,t,n)}),e.appendChild(r),n&&P_(e,n)}function L_(e,t,n,r){e.textContent=``;let i=l_(),a=()=>{u_(i),n?.()},o=document.createElement(`h2`);o.textContent=F_.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),S_()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(a_)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=a_[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=d_(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=d_(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Sm(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>wm(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t);let r=(t,n,r)=>{let i=document.createElement(`label`);i.className=`config-row`,i.textContent=`${t} `;let o=document.createElement(`input`);o.type=`checkbox`,o.checked=n,o.addEventListener(`change`,()=>{r(o.checked),a()}),i.appendChild(o),e.appendChild(i)};r(`nuvens no céu`,i.nuvens,e=>i.nuvens=e),r(`balanço de folhas e grama`,i.balanco,e=>i.balanco=e),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`tempo de montagem de malha por frame`,1,16,1,i.meshMsPorFrame,e=>i.meshMsPorFrame=e,e=>`${e} ms`)}P_(e,()=>I_(e,n,r))}var R_=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},z_=class{inv=qu();ligada=!1;travada=!1;get ativa(){return this.ligada}aplicar(e){this.travada||(this.inv=td(e),this.ligada=!0)}travar(e){this.inv=td(e),this.ligada=!0,this.travada=!0}desligar(){this.travada||(this.ligada=!1,this.inv=qu())}idDoSlot(e){return this.inv[e]?.id??null}qtdDoSlot(e){return this.inv[e]?.qtd??0}hotbar(){return Array.from({length:9},(e,t)=>this.idDoSlot(t))}estado(){return this.inv}contar(e){let t=0;for(let n of this.inv)n?.id===e&&(t+=n.qtd);return t}},B_=10,V_=10,H_=10,U_=150/H_,W_=`
#lj-vitals {
  position: fixed;
  left: 50%;
...
`;function G_(e){return`url("data:image/svg+xml,${encodeURIComponent(e)}")`}var K_=G_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#e23b3b" stroke="#5a0d0d" stroke-width="1.2"/></svg>`),q_=G_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#1a1a1a" stroke="#000" stroke-width="1.2"/></svg>`),J_=G_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#7fd4ff" stroke="#0a3550" stroke-width="1.2"/><circle cx="5.8" cy="5.8" r="1.6" fill="#fff" opacity="0.9"/></svg>`),Y_=(e,t,n)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M12.8 12.8 8.6 8.6" stroke="${t}" stroke-width="3" stroke-linecap="round"/><circle cx="12.9" cy="12.9" r="2.1" fill="${t}" stroke="${n}" stroke-width="0.9"/><circle cx="6" cy="6" r="4.7" fill="${e}" stroke="${n}" stroke-width="1.1"/></svg>`,X_=G_(Y_(`#b2601f`,`#f3e7cf`,`#4d2a10`)),Z_=G_(Y_(`#1a1a1a`,`#1a1a1a`,`#000`));function Q_(e,t,n){let r=document.createElement(`div`);r.className=`linha`;let i=[];for(let a=0;a<e;a++){let e=document.createElement(`div`);if(e.className=`casa`,n!==void 0){let t=document.createElement(`div`);t.className=`icone fundo`,t.style.backgroundImage=n,e.appendChild(t)}let a=document.createElement(`div`);a.className=`icone`,a.style.backgroundImage=t,e.appendChild(a),r.appendChild(e),i.push(e)}return{linha:r,casas:i}}function $_(e,t){for(let[n,r]of e.entries()){let e=r.lastElementChild;if(!e)continue;let i=t>=(n+1)*2,a=!i&&t===n*2+1;e.style.display=i||a?`block`:`none`,e.classList.toggle(`meio`,a)}}var ev=class{raiz;linhaVida;linhaFome;linhaAr;dano;morte;casasVida;casasFome;casasAr;morteTimer=null;danoTimer=null;ultimaVida=20;visivel=!1;constructor(){let e=document.createElement(`style`);e.textContent=W_,document.head.appendChild(e),this.raiz=document.createElement(`div`),this.raiz.id=`lj-vitals`;let t=Q_(B_,K_,q_),n=Q_(V_,X_,Z_),r=Q_(H_,J_);this.linhaVida=t.linha,this.casasVida=t.casas,this.linhaFome=n.linha,this.casasFome=n.casas,this.linhaAr=r.linha,this.casasAr=r.casas,this.linhaAr.classList.add(`vazia`),this.linhaFome.classList.add(`vazia`);let i=document.createElement(`div`);i.className=`barras`,i.append(this.linhaVida,this.linhaFome),this.raiz.append(this.linhaAr,i),document.body.appendChild(this.raiz),this.dano=document.createElement(`div`),this.dano.id=`lj-dano`,this.morte=document.createElement(`div`),this.morte.id=`lj-morte`,document.body.append(this.dano,this.morte)}setVisivel(e){this.visivel=e,this.raiz.classList.toggle(`ativo`,e),e||this.esconderMorte()}aplicar(e){let t=Math.max(0,Math.min(20,Math.round(e.vida)));$_(this.casasVida,t),this.desenharFome(e.fome),this.desenharAr(e.folego),t<this.ultimaVida&&this.visivel&&this.piscarDano(),e.morreu&&this.visivel&&this.mostrarMorte(e.causa),this.ultimaVida=t}desenharFome(e){this.linhaFome.classList.toggle(`vazia`,e===void 0),e!==void 0&&$_(this.casasFome,Math.max(0,Math.min(20,Math.round(e))))}desenharAr(e){let t=e===void 0||e>=150;if(this.linhaAr.classList.toggle(`vazia`,t),t)return;let n=Math.max(0,Math.ceil(e/U_));for(let[e,t]of this.casasAr.entries()){let r=t.lastElementChild;r&&(r.style.display=e<n?`block`:`none`)}}piscarDano(){this.dano.classList.add(`piscar`),this.danoTimer!==null&&clearTimeout(this.danoTimer),this.danoTimer=setTimeout(()=>this.dano.classList.remove(`piscar`),90)}mostrarMorte(e){this.morte.textContent=e===`queda`?`Você caiu de muito alto`:e===`afogamento`?`Você ficou sem ar`:e===`fome`?`Você passou fome demais`:`Você não sobreviveu`,this.morte.classList.add(`ativo`),this.morteTimer!==null&&clearTimeout(this.morteTimer),this.morteTimer=setTimeout(()=>this.esconderMorte(),2600)}esconderMorte(){this.morte.classList.remove(`ativo`)}},tv=class{send;onToggle;root=document.getElementById(`amigos`);isOpen=!1;data={eu:``,equipe:null,convites:[],enviados:[],online:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&wm(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=this.btn(e,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)});return n}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}linha(e,...t){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);return r.className=`jog-nome`,r.textContent=e,n.append(r,...t),n}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`amigos`,t.append(n,this.btn(`✕ fechar`,()=>this.hide()));let r=document.createElement(`div`);r.className=`jog-lista`,this.renderConvites(r),this.renderGrupo(r),this.renderConvidar(r),r.append(this.hint(`pelo chat também dá: /amigos convidar nome · /amigos aceitar · /amigos recusar · /amigos sair · /amigos expulsar nome · /amigos lista`)),e.append(t,r)}renderConvites(e){if(this.data.convites.length!==0){e.append(this.sec(`✉ convites para você (${this.data.convites.length})`));for(let t of this.data.convites)e.append(this.linha(`${t} convidou você`,this.btn(`aceitar`,()=>this.send(`/amigos aceitar ${t}`)),this.btn(`recusar`,()=>this.send(`/amigos recusar ${t}`))));e.append(this.hint(`aceitar um convite descarta os outros — você fica em UM grupo só.`))}}renderGrupo(e){let{eu:t,equipe:n}=this.data;if(!n){e.append(this.sec(`👥 seu grupo`)),e.append(this.hint(`Você não está em nenhum grupo. Quem está no seu grupo pode construir na sua ÁREA PROTEGIDA (e você na dele). Cabem 6 pessoas, contando você.`));return}let r=n.dono===t;e.append(this.sec(`👥 grupo de ${n.dono} — ${n.membros.length}/6`));for(let i of n.membros){let a=[i===n.dono?`dono`:``,i===t?`você`:``].filter(e=>e),o=a.length?`${i} (${a.join(`, `)})`:i;e.append(r&&i!==t?this.linha(o,this.armedBtn(`expulsar`,()=>this.send(`/amigos expulsar ${i}`))):this.linha(o))}let i=document.createElement(`div`);i.className=`painel-row`,i.append(r?this.armedBtn(`sair e DESFAZER o grupo`,()=>this.send(`/amigos sair`)):this.armedBtn(`sair do grupo`,()=>this.send(`/amigos sair`))),e.append(i),r&&e.append(this.hint(`você é o dono: se sair, o grupo acaba para todo mundo.`))}renderConvidar(e){let{eu:t,equipe:n,enviados:r,online:i}=this.data;if(e.append(this.sec(`＋ convidar`)),n&&n.dono!==t){e.append(this.hint(`Só ${n.dono} convida para este grupo. Saia dele para montar o seu.`));return}if(n&&n.membros.length>=6){e.append(this.hint(`Grupo cheio (6/6).`));return}for(let t of r)e.append(this.linha(`${t} — convite enviado, aguardando`));let a=new Set(n?.membros??[]),o=i.filter(e=>e!==t&&!a.has(e)&&!r.includes(e));for(let t of o)e.append(this.linha(t,this.btn(`convidar`,()=>this.send(`/amigos convidar ${t}`))));o.length===0&&r.length===0&&e.append(this.hint(`ninguém mais está na aula agora.`))}},nv=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&wm(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},rv=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&wm(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},iv=class extends rv{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(Bm[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=zu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=zu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...Bm.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},av=class extends rv{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},ov=class{fixedColor;group=new un;cornerMarks=[];boxes=[];bounds=[];culling=null;constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Ti(new Wi(new Ri(1.01,1.01,1.01)),new pi({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();if(this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Ti(new Wi(new Ri(n+.04,r+.04,i+.04)),new pi({color:this.fixedColor??new H().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a}),this.bounds=e,this.culling){let{px:e,pz:t,raio:n}=this.culling;this.cularPorDistancia(e,t,n)}}cularPorDistancia(e,t,n){this.culling={px:e,pz:t,raio:n};for(let r=0;r<this.boxes.length;r++){let i=this.boxes[r],a=this.bounds[r];if(!i||!a)continue;let o=Math.max(a.min.x-e,0,e-(a.max.x+1)),s=Math.max(a.min.z-t,0,t-(a.max.z+1));i.visible=Math.max(o,s)<=n}}},sv=1/16,cv=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*sv-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*sv-.004,ry:Math.PI}];function lv(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var uv=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(Wu(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=Wu(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=K(t,e.x,e.y,e.z);if(!Zl(r))return;let i=cv[r-G.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,lv(a,e,null);let o=new Pi(a);o.colorSpace=ze;let s=new ti(new Gi(12*sv,12*sv),new Ur({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{lv(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=Wu(e,t,n);if(this.conteudos.has(a))if(!Zl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Zl(K(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function dv(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var fv=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,dv(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},pv=null;function mv(e){e.preventDefault(),e.returnValue=``}var hv=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function gv(e){pv?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||hv.has(e.code))&&e.preventDefault())}function _v(e){pv?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function vv(e){pv||(pv=e,window.addEventListener(`beforeunload`,mv),window.addEventListener(`keydown`,gv,!0),window.addEventListener(`keyup`,_v,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function yv(){pv=null,window.removeEventListener(`beforeunload`,mv),window.removeEventListener(`keydown`,gv,!0),window.removeEventListener(`keyup`,_v,!0),navigator.keyboard?.unlock?.()}var bv=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Pi(t);i.minFilter=o,this.material=new yr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[Nu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===G.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===G.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===G.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Nr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function xv(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Ym(n)}var Sv=new vl({antialias:!0});Sv.setPixelRatio(Math.min(window.devicePixelRatio,2)),Sv.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Sv.domElement);var Cv=new yn;Cv.background=new H(8900331);var wv=new Na(75,window.innerWidth/window.innerHeight,.1,512);wv.rotation.order=`YXZ`;var Tv=new Ia(16777215,2.2);Tv.position.set(60,100,40);var Ev=new La(16777215,.55);Cv.add(Tv,Ev);var Dv=new Bh(Tv,Ev,Cv,wv),Ov=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();Ov!==null&&Dv.sync(Ov,!1);var kv=new Uh,Av=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();Av&&kv.sync(Av.dir,Av.forca,!0);var $=new Yg(Sv.domElement);$.touchDevice=S_();var jv=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},Mv=jv(`yaw`),Nv=jv(`pitch`);Mv!==null&&($.yaw=Mv),Nv!==null&&($.pitch=Nv);var Pv=Pm(new URLSearchParams(location.search));function Fv(){let e=Pv?{...l_(),...Fm(Pv)}:l_();return $.sensitivity=e.sensitivity,wv.fov=e.fov,wv.updateProjectionMatrix(),Sv.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Sm(e.volume),Iv?.setScale(e.uiScale),Dv.setNuvens(e.nuvens),e}var Iv=null,Lv=Fv();Em(Lv.volume);var Rv=new Ig(()=>Jv()||ay.open),zv={equipe:null,convites:[],enviados:[]},Bv=new r_(()=>{Yv(),Vv?.hud.setFase(`jogando`),Vv?.hud.marcar(`carga concluída`),Vv?.iniciarBench()}),Vv=null,Hv=!1,Uv=document.getElementById(`overlay`),Wv=document.getElementById(`overlay-main`),Gv=document.getElementById(`overlay-config`),Kv=document.getElementById(`crosshair`);function qv(){Wv?.classList.remove(`hidden`),Gv?.classList.add(`hidden`)}function Jv(){return Uv!==null&&!Uv.classList.contains(`hidden`)}function Yv(){let e=Rv.algumAberto;Uv?.classList.toggle(`hidden`,Hv||Bv.ativo||$.active||ay.open||e),Kv?.classList.toggle(`hidden`,!$.active),$.locked&&qv(),Iv?.setShown($.touch&&!ay.open&&!e&&!Bv.ativo)}document.addEventListener(`pointerlockchange`,Yv);function Xv(){S_()?($.touch=!0,C_(),Yv()):$.lock()}window.addEventListener(`keydown`,e=>{e.code===`Escape`&&(!Jv()||ay.open||(document.getElementById(`menu`)?.classList.contains(`hidden`)??!1)&&(e.preventDefault(),Xv()))});function Zv(){let e=Lv.keys;Lv=Fv();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`,`amigos`])$.rebind(e[t],Lv.keys[t]);$v()}var Qv=-1;function $v(){if(!ey||Lv.raioRender===Qv)return;let e=Qv;Qv=Lv.raioRender,ey.send(JSON.stringify({type:`radius`,chunks:Qv})),Vv?.hud.marcar(`raio`,`${e<0?`join`:e} → ${Qv}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Xv()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&N_(e,Zv,qv),Wv?.classList.add(`hidden`),Gv?.classList.remove(`hidden`)}),document.getElementById(`overlay-telacheia`)?.addEventListener(`click`,()=>{C_()}),document.getElementById(`overlay-hud`)?.addEventListener(`click`,()=>{Vv?.hud.toggle()}),Uv?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&wm(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{wv.aspect=window.innerWidth/window.innerHeight,wv.updateProjectionMatrix(),Sv.setSize(window.innerWidth,window.innerHeight)});var ey=null,ty=`?`,ny=null;function ry(){return new URLSearchParams(location.search).get(`nome`)??O_()}function iy(e){return e.trim().toLowerCase()===`/amigos`&&Rv.trocarParaAmigos()}var ay=new nh(e=>{iy(e)||ey?.send(JSON.stringify({type:`chat`,text:e}))},e=>{Yv(),e||$.lock()});Yv(),Sv.domElement.addEventListener(`pointerdown`,()=>{$.touch&&ay.open&&ay.close()});var oy={tickAvgMs:0,tickMaxMs:0},sy=null,cy=0,ly=[];function uy(){let e=performance.now();cy>0&&(ly.push(e-cy),ly.length>300&&ly.shift()),cy=e}function dy(){let e=ly.length;if(e<2)return 0;let t=ly.reduce((e,t)=>e+t,0)/e,n=ly.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var fy=null,py=`aluno`,my=!1,hy=!1,gy=`criativo`,_y=!1;function vy(){return cd(gy)&&(py===`professor`||my)}var yy=new z_,by=null;function xy(){return by??=new ev,by}var Sy=null,Cy=(()=>{let e=new URLSearchParams(location.search).get(`vida`);if(e===null)return null;let[t,n,r]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{vida:t,...Number.isFinite(n)?{folego:n}:{},...Number.isFinite(r)?{fome:r}:{}}})();Cy&&(xy().setVisivel(!0),xy().aplicar(Cy));{let e=new URLSearchParams(location.search).get(`mochila`);if(e!==null){let t=[];e.split(`,`).forEach((e,n)=>{let[r,i]=e.split(`x`).map(Number);r===void 0||!Number.isInteger(r)||r<=0||t.push({slot:n,id:r,qtd:Number.isInteger(i)&&i>0?i:1})}),yy.travar(t)}}var wy=[],Ty=!1,Ey=!1,Dy=[],Oy=new R_,ky=null,Ay=null,jy=[],My=new Set,Ny=!1,Py=!1,Fy=new Map;function Iy(){Rv.cp14?.update({regions:wy,modo:ky?.modo??`sequencial`,objetivos:ky?.objetivos??[],grupos:jy,myGrupo:Ay})}function Ly(){Rv.amigos?.update({eu:ry(),equipe:zv.equipe,convites:zv.convites,enviados:zv.enviados,online:[...new Set(Fy.values())].sort()})}function Ry(e){return e.porGrupo&&py!==`professor`?Ay===null?!1:e.porGrupo.find(e=>e.grupo===Ay)?.completo??!1:e.completo}function zy(e){if(ky){for(let t of ky.objetivos)Ry(t)?My.has(t.id)||(My.add(t.id),e&&Ny&&_m({kind:`objective_complete`})):My.delete(t.id);Ny=!0,Oy.update(ky.modo,ky.objetivos,{grupo:Ay,professor:py===`professor`,painelKey:d_(Lv.keys.painel)}),Vv?.applyObjectiveBoxes(ky.objetivos)}}var By=null;function Vy(){let e=By;if(e){By=null;for(let t of e)Uy(t)}}function Hy(){By||(By=[],requestAnimationFrame(()=>requestAnimationFrame(Vy)),setTimeout(Vy,500))}function Uy(e){if(By){By.push(e);return}if(uy(),Vv||Bv.setFase(`mundo`),typeof e==`string`){let t=vd(e);if(!t)return;if(t.type===`debug_stats`)oy={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},sy=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0};else if(t.type===`block_changed`)Vv?.applyBlockChanged(t);else if(t.type===`blocks_filled`)Vv?.applyBlocksFilled(t);else if(t.type===`player_moved`)t.name&&Fy.get(t.id)!==t.name&&(Fy.set(t.id,t.name),Xm([...new Set(Fy.values())]),Ly()),Vv?.applyPlayerMoved(t);else if(t.type===`player_left`)Fy.delete(t.id),Xm([...new Set(Fy.values())]),Ly(),Vv?.applyPlayerLeft(t.id);else if(t.type===`spawn`)fy={x:t.x,y:t.y,z:t.z},py=t.papel??`aluno`;else if(t.type===`regions`)wy=t.regions,Vv?.applyRegions(t.regions),Iy();else if(t.type===`objectives`)ky={modo:t.modo,objetivos:t.objetivos},zy(!0),Iy();else if(t.type===`group`)Ay=t.grupo,My.clear(),zy(!1),Iy();else if(t.type===`groups`)jy=t.grupos,Iy();else if(t.type===`quadros`)Vv?.applyQuadros(t.lista);else if(t.type===`quadro_changed`)Vv?.applyQuadroChanged(t);else if(t.type===`container`)Rv.container?.atualizar(t);else if(t.type===`container_fechado`)Rv.container?.fecharSemAvisar();else if(t.type===`claims`)Ty=t.ativo,t.ativo&&!Ey&&(Ey=!0,ay.addMessage(`jogo`,`tecla ${d_(Lv.keys.amigos)} abre o painel de amigos — quem está no seu grupo constrói na sua área`)),Dy=t.claims,Vv?.applyClaims(t.claims);else if(t.type===`friends`)zv={equipe:t.equipe,convites:t.convites,enviados:t.enviados},Ly();else if(t.type===`players`)Rv.jogadores?.update({conectados:t.conectados,banidos:t.banidos});else if(t.type===`mundo_trocando`)Vv?.iniciarTroca(t.nome),Hy();else if(t.type===`teleport`)Vv?.applyTeleport(t);else if(t.type===`time`)Ov===null&&Dv.sync(t.hora,t.ciclo);else if(t.type===`vento`)Av===null&&kv.sync(t.dir,t.forca,t.ativo);else if(t.type===`voo`)my=t.liberado,vy()||(hy=!1),ay.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`);else if(t.type===`modo`){let e=gy!==t.efetivo;gy=t.efetivo,_y=t.pvp===!0,vy()||(hy=!1),Cy===null&&(t.efetivo===`sobrevivencia`?xy().setVisivel(!0):by?.setVisivel(!1)),t.efetivo===`criativo`&&yy.ativa&&(yy.desligar(),Vv?.aoMudarMochila()),e&&ay.addMessage(`jogo`,t.efetivo===`sobrevivencia`?`modo sobrevivência — não dá para voar`:`modo criativo`)}else if(t.type===`inventario`)yy.aplicar(t.slots),Vv?.aoMudarMochila();else if(t.type===`vida`){if(Cy!==null)return;Sy=t,xy().aplicar(t),t.causa&&_m({kind:`dano`}),t.morreu&&(_m({kind:`morte`}),ay.addMessage(`jogo`,t.causa===`queda`?`você caiu de muito alto — voltou ao ponto de partida`:t.causa===`afogamento`?`você ficou sem ar — voltou ao ponto de partida`:t.causa===`fome`?`você passou fome demais — voltou ao ponto de partida`:t.causa===`pvp`?`você foi derrubado por outro jogador — voltou ao ponto de partida`:`você não sobreviveu — voltou ao ponto de partida`))}else t.type===`kicked`?(wm(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),yv(),location.href=location.pathname):t.type===`join_denied`?(wm(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),yv(),location.href=location.pathname):t.type===`chat`&&(ay.addMessage(t.author,t.text),t.author===`servidor`&&xv(t.text),_m({kind:`chat_message`}));return}let t=Sd(e);if(t===809716300){Vv?.aplicarColunas(e);return}let n=()=>(Py=t===bd,Py?Cd(e):yd(e));if(Vv){Vv.reloadWorld(n());return}Qy(n())}function Wy(e,t){Lv=Fv(),ey=e,Bv.abrir({host:ty,rede:!(e instanceof Rg)}),Bv.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),Yv(),e.onMessage(Uy),$.onKey(Lv.keys.chat,()=>{ay.open||Rv.podeAbrir&&(document.exitPointerLock(),ay.openInput())}),e.send(JSON.stringify({type:`join`,name:ry(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),Qv=-1,$v()}function Gy(e,t){ty=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Wy(new zg(e,t=>{Vv||!Bv.ativo||Bv.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function Ky(e,t){ny={id:e.id,name:e.name,createdAt:e.createdAt},ty=`web-worker (${e.name})`;let n=new Rg(new Worker(new URL(`/assets/worker-UiQnLUgb.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho,sobrevivencia:e.sobrevivencia}),Wy(n)}async function qy(){if(!(ey instanceof Rg)||!ny)return;let e=await ey.requestSave();await v_({...ny,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{yv(),qy().finally(()=>location.reload())});var Jy=new URLSearchParams(location.search),Yy=Jy.get(`server`);if(Yy){let e=Jy.get(`codigo`);Gy(Yy,{pin:Jy.get(`pin`)??``,...e?{codigo:e}:{}})}else Pv?Ky({id:`bench-${Dm}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:ef(Jy.get(`tamanho`)??`E`)},Dm):M_({onPlayWorld:Ky,onPlayMulti:Gy});var Xy=3,Zy=class{activeConn;world;worldSeed;luz;mundoLazy;colunasCarregadas=new Set;frameCount=0;colunasRecebidas=0;materiais;chunkRenderer;aguaFx;torchGlow;colunasFaltando;regionRenderer;claimRenderer;quadroRenderer;objectiveBoxes;spawn;player;movimento;progresso;outros;highlight;lookDir=new B;hotbarUi;hud;target=null;alvoJogador=null;bench=null;constructor(e,t){if(this.activeConn=t,vv(()=>$.active),this.world=e.world,this.worldSeed=e.seed,this.mundoLazy=Py,this.luz=new yh(this.world.dims,new URLSearchParams(location.search).has(`semluz`)),this.materiais=new Pg,new URLSearchParams(location.search).has(`atlas`)){let e=this.materiais.canvas;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let n=new URLSearchParams(location.search),r=n.has(`semworker`),i=Number(n.get(`meshdepth`));this.chunkRenderer=new lh(this.world,this.materiais.paraChunks,Cv,!r,Number.isFinite(i)&&i>0?i:void 0,this.luz.paraMesher),this.aguaFx=new pm(Cv),this.mundoLazy||(this.luz.acenderTudo(this.world),this.chunkRenderer.buildAll()),this.torchGlow=new bv(Cv),this.torchGlow.setFromWorld(this.world),this.colunasFaltando=new uh(this.descartarColuna,(e,t)=>{this.activeConn.send(JSON.stringify({type:`pedir_coluna`,cx:e,cz:t}))}),this.regionRenderer=new ov(Cv),this.regionRenderer.setRegions(wy),this.claimRenderer=new ov(Cv,16747546),this.drawClaims(Dy),this.quadroRenderer=new uv(Cv);let a=new fv;this.objectiveBoxes=new ov(Cv,3066993),ky&&this.updateObjectiveBoxes(ky.objetivos);let o=e=>this.activeConn.send(JSON.stringify({type:`chat`,text:e})),s=e=>{e?document.exitPointerLock():$.lock(),Yv()};py===`professor`&&(Rv.jogadores=new nv(o,s)),Rv.amigos=new tv(o,s),Ly(),Rv.cp14=py===`professor`?new iv(o,s,()=>Rv.trocarParaJogadores()):new av(o,s),Iy(),$.onKey(Lv.keys.painel,()=>{if(Rv.podeAlternar(Rv.cp14)){if(py!==`professor`&&jy.length===0){ay.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}Rv.cp14?.toggle()}}),$.onKey(Lv.keys.amigos,()=>Rv.alternar(Rv.amigos)),py===`professor`&&ay.addMessage(`jogo`,`tecla ${d_(Lv.keys.painel)} abre o painel de autoria`),this.spawn=fy??{x:this.world.sizeX/2+.5,y:Lu(this.world,Math.floor(this.world.sizeX/2),Math.floor(this.world.sizeZ/2)),z:this.world.sizeZ/2+.5},this.player=zd(this.spawn.x,this.spawn.y,this.spawn.z),this.movimento=new Fg($,()=>Lv.keys),this.movimento.ancorar(this.player.pos),this.progresso=new Lg(Bv,()=>({bytes:this.activeConn.stats.bytesIn+this.activeConn.stats.bytesOut,prontas:this.colunasCarregadas.size,buracos:this.colunasFaltando.tamanho,fila:this.chunkRenderer.filaPendente})),this.recalcularCarga(),this.progresso.observar(),Bv.setFase(this.mundoLazy?`mundo`:`malha`),this.outros=new bh(Cv),this.highlight=new Ti(new Wi(new Ri(1,1,1)),new pi({color:0})),this.highlight.visible=!1,Cv.add(this.highlight),this.hotbarUi=new vh(py,yy,this.materiais.canvas,{claimsAtivo:()=>Ty,setVarinhaToque:e=>Iv?.setVarinha(e),aoRedesenhar:()=>{Rv.mochila?.refresh(),Rv.container?.refresh()}}),this.hotbarUi.refresh(),$.onKey(Lv.keys.varinha,()=>this.hotbarUi.toggleVarinha());for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>this.hotbarUi.selecionar(e));$.onWheel(e=>this.hotbarUi.ciclar(e)),Rv.mochila=new Hm(this.hotbarUi.icons,()=>this.hotbarUi.meusBlocos,()=>({hotbar:this.hotbarUi.paleta,selected:this.hotbarUi.selected}),e=>this.hotbarUi.definirSlotLocal(e),e=>this.hotbarUi.selecionar(e),e=>{e?document.exitPointerLock():$.lock(),Yv()},yy,(e,t)=>this.activeConn.send(JSON.stringify({type:`mover_item`,de:e,para:t})),e=>this.hotbarUi.nome(e),e=>this.activeConn.send(JSON.stringify({type:`fabricar`,receita:e}))),$.onKey(Lv.keys.inventario,()=>Rv.alternar(Rv.mochila)),Rv.container=new Lm(this.hotbarUi.icons,yy,e=>this.hotbarUi.nome(e),(e,t,n,r,i)=>this.activeConn.send(JSON.stringify({type:`mover_container`,x:e,y:t,z:n,de:r,para:i})),()=>this.activeConn.send(JSON.stringify({type:`fechar_container`})),e=>{e?(Rv.aoAbrirContainer(),document.exitPointerLock()):$.lock(),Yv()});let c=(e,t)=>{this.activeConn.send(JSON.stringify({type:`wand_mark`,corner:e,x:t.x,y:t.y,z:t.z})),this.regionRenderer.setCorner(e,t.x,t.y,t.z)};$.onMouseButton(0,()=>{if(this.alvoJogador&&!this.hotbarUi.varinhaAtiva){this.activeConn.send(JSON.stringify({type:`atacar`,alvo:this.alvoJogador.id}));return}if(this.target){if(this.hotbarUi.varinhaAtiva){c(1,this.target);return}jl(this.hotbarUi.idNaMao()??-1)&&gy!==`criativo`||this.activeConn.send(JSON.stringify({type:`break_block`,x:this.target.x,y:this.target.y,z:this.target.z}))}}),$.onMouseButton(2,()=>{if(yy.ativa&&Pd(this.hotbarUi.idNaMao()??-1)){this.activeConn.send(JSON.stringify({type:`comer`,slot:this.hotbarUi.selected}));return}if(!this.target)return;if(this.hotbarUi.varinhaAtiva){c(2,this.target);return}{let e=this.hotbarUi.idNaMao();if(jl(e??-1)){let t=yy.ativa?{slot:this.hotbarUi.selected}:{};if(e===901)this.activeConn.send(JSON.stringify({type:`balde`,x:this.target.x+this.target.nx,y:this.target.y+this.target.ny,z:this.target.z+this.target.nz,encher:!1,...t})),yy.ativa||this.hotbarUi.definirSlotLocal(900);else{if(K(this.world,this.target.x,this.target.y,this.target.z)!==G.Agua)return;this.activeConn.send(JSON.stringify({type:`balde`,x:this.target.x,y:this.target.y,z:this.target.z,encher:!0,...t})),yy.ativa||this.hotbarUi.definirSlotLocal(901)}return}}if(Zl(K(this.world,this.target.x,this.target.y,this.target.z))){let{x:e,y:t,z:n}=this.target;a.open(this.quadroRenderer.get(e,t,n),r=>{$.lock(),r&&this.activeConn.send(JSON.stringify({type:`quadro_set`,x:e,y:t,z:n,texto:r.texto,...r.imagem?{imagem:r.imagem}:{}}))});return}if(rd(K(this.world,this.target.x,this.target.y,this.target.z))!==null){this.activeConn.send(JSON.stringify({type:`use_block`,x:this.target.x,y:this.target.y,z:this.target.z}));return}if(hu(K(this.world,this.target.x,this.target.y,this.target.z))){this.activeConn.send(JSON.stringify({type:`use_block`,x:this.target.x,y:this.target.y,z:this.target.z}));return}let e=this.hotbarUi.idNaMao();if(e===null)return;let t=fp(e,$.yaw,this.target.ny<0);this.activeConn.send(JSON.stringify({type:`place_block`,x:this.target.x+this.target.nx,y:this.target.y+this.target.ny,z:this.target.z+this.target.nz,blockId:t}))}),$.onMouseButton(1,()=>{if(!this.target||this.hotbarUi.varinhaAtiva||yy.ativa)return;let e=pp(K(this.world,this.target.x,this.target.y,this.target.z));vu(e)&&(yu(e)&&py!==`professor`||this.hotbarUi.definirSlotLocal(e))}),this.hud=new Jg(Sv,{checkpoint:14,worldChunks:this.world.dims,worldSeed:e.seed,serverHost:ty}),this.hud.contexto=()=>({x:this.player.pos.x,y:this.player.pos.y,z:this.player.pos.z,yaw:$.yaw,pitch:$.pitch,voando:hy&&vy(),noChao:this.player.onGround,raioRender:Lv.raioRender,meshMsPorFrame:Lv.meshMsPorFrame,pixelRatioCap:Lv.pixelRatioCap,fov:Lv.fov,nuvens:Lv.nuvens,balanco:Lv.balanco,distanciaTotal:this.movimento.distanciaTotal,colunasRecebidas:this.colunasRecebidas,bytesRecebidos:this.activeConn.stats.bytesIn}),this.hud.setRemesh({count:this.chunkRenderer.remeshCount,totalMs:this.chunkRenderer.remeshMsTotal,workerMs:this.chunkRenderer.remeshWorkerMsTotal,config:this.chunkRenderer.meshConfig,lastMs:this.chunkRenderer.lastRemeshMs,porCaminho:this.chunkRenderer.porCaminho}),this.hud.carga=()=>Bv.relatorio(),this.hud.marcar(`join`,`${this.world.dims.x}×${this.world.dims.z}×${this.world.dims.y} chunks · seed ${e.seed}`),$.onKey(Lv.keys.hud,()=>this.hud.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{this.hud.record(e=>{this.activeConn.send(JSON.stringify({type:`profile_report`,stats:e}))})}),S_()&&(this.hotbarUi.habilitarToque(),Iv=new E_($,{keys:()=>Lv.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>Rv.alternar(Rv.mochila),chat:()=>{ay.open||(document.exitPointerLock(),ay.openInput())},menu:()=>{$.touch=!1,qv(),Yv()},hud:()=>this.hud.toggle(),varinha:()=>this.hotbarUi.toggleVarinha(),amigos:()=>Rv.alternar(Rv.amigos)}),Iv.setVarinhaDisponivel(py===`professor`||Ty),Iv.setAmigosDisponivel(Ty),Iv.setScale(Lv.uiScale),Yv()),this.hud.extra=()=>{let e=$.mouseStats,t=this.player.pos,n=Math.floor(t.x),r=Math.floor(t.z),i=of(n,r,this.worldSeed),a=xu(i),o=Su(i),s=Math.min(af(n,r,this.worldSeed,this.world.sizeY),this.world.sizeY-2),c=s<=23?`areia (praia)`:s>=58&&a.neve?`neve`:s>=85?`pedra (chapada)`:a.topo===`grama`?o===G.GramaSeca?`grama seca`:o===G.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${a.nome}  temp ${i.temp.toFixed(2)}  umid ${i.umid.toFixed(2)}  seed ${this.worldSeed}\nterreno h ${s}  topo ${c}  [praia ≤23 · neve ≥58 se o bioma neva · chapada ≥85]\nrelevo ${Eu(i).toFixed(2)} (teto do bioma ${a.relevo})\nmodo ${gy===`sobrevivencia`?`sobrevivência`:`criativo`}  voo ${vy()?hy?`voando`:`liberado`:`trancado`}`+(Sy?`  vida ${Sy.vida}/20`+(Sy.fome===void 0?`  sem fome`:`  fome ${Sy.fome}/20`):``)+`
mouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let l=new Md;setInterval(()=>{let e={x:this.player.pos.x,y:this.player.pos.y,z:this.player.pos.z,yaw:$.yaw,pitch:$.pitch};l.aEnviar(e,performance.now())&&this.activeConn.send(JSON.stringify({type:`move`,...e}))},1e3/10),this.activeConn instanceof Rg&&ny&&!Pv&&(qy(),setInterval(()=>void qy(),3e4));let u={...t.stats};setInterval(()=>{let e=this.activeConn.stats;this.hud.net={msgsPerSec:e.msgsIn+e.msgsOut-(u.msgsIn+u.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(u.bytesIn+u.bytesOut),tickAvgMs:oy.tickAvgMs,tickMaxMs:oy.tickMaxMs,jitterMs:dy()},this.hud.regras=sy,this.hud.stream={colunas:this.colunasCarregadas.size,fila:this.chunkRenderer.filaPendente,faltando:this.colunasFaltando.tamanho,repedidas:this.colunasFaltando.repedidas,ultimoLote:this.chunkRenderer.ultimoLote},this.hud.luz=this.luz.medidas,u={...e}},1e3)}async entregarPerfilDoBench(e,t){try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);ay.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let n=t?`bench-semvida`:`bench`;this.hud.baixar(e,n),ay.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${n}-*.json)`)}}iniciarBench(){if(!Pv||this.bench)return;let e=this.bench=Im.paraMundo(Pv,this.spawn,this.world.dims),t=Pv;this.hud.setMeta({bench:e.meta()}),this.hud.marcar(`bench: início`,`${t.duracaoS}s · raio ${e.trajeto.raio}${t.semVida?` · sem vida ambiental`:``}`),Hv=!0,window.__benchRodando=!0,hy=!0,Yv(),e.iniciar(performance.now());let n=e.amostra(performance.now());this.player.pos.x=n.x,this.player.pos.y=n.y,this.player.pos.z=n.z,this.movimento.ancorar(this.player.pos),this.hud.record(e=>{Hv=!1,window.__benchRodando=!1,Yv(),window.__benchPerfil=e,this.entregarPerfilDoBench(e,t.semVida)},t.duracaoS*1e3)}iniciar(){let e=performance.now();Sv.setAnimationLoop(()=>{let t=performance.now(),n=t-e;e=t;let r=Math.min(n/1e3,.05),i=this.movimento.comando(t,{voando:hy,podeVoar:vy()});hy=i.voando;let a=!0;if(this.mundoLazy){this.chunkRenderer.modoCarga=Bv.ativo;{let e=this.luz.drenar(this.world,Bv.ativo?16:Xy,e=>this.colunasCarregadas.has(e));for(let t of e)this.chunkRenderer.enfileirarColuna(t.cx,t.cz)}this.chunkRenderer.processarFila(Lv.meshMsPorFrame,(e,t)=>{this.colunasCarregadas.delete(t*this.world.dims.x+e)});let{cx:e,cz:n}=Ed(this.world.dims,this.player.pos.x,this.player.pos.z);if(a=this.colunasCarregadas.has(kd(this.world.dims,e,n)),(this.frameCount=(this.frameCount+1)%60)==0){for(let t of this.colunasCarregadas){let{cx:r,cz:i}=Ad(this.world.dims,t);Od(r,i,e,n,Lv.raioRender)||(this.colunasCarregadas.delete(t),this.descartarColuna(r,i))}this.colunasFaltando.varrer(e,n,t,this.world.dims,Lv.raioRender,this.colunasCarregadas);let r=Lv.raioRender*16;this.claimRenderer.cularPorDistancia(this.player.pos.x,this.player.pos.z,r),this.regionRenderer.cularPorDistancia(this.player.pos.x,this.player.pos.z,r)}Bv.ativo&&this.progresso.raioCompleto&&this.luz.filaVazia&&this.chunkRenderer.filaPendente===0&&Bv.concluir()}if(this.bench?.ativo){let e=this.bench.amostra(t);this.player.pos.x=e.x,this.player.pos.y=e.y,this.player.pos.z=e.z,this.player.vel.x=this.player.vel.y=this.player.vel.z=0,$.yaw=e.yaw,$.pitch=e.pitch,this.bench.terminou(t)&&(this.bench.parar(),this.hud.marcar(`bench: fim`))}let o=this.player.pos.y;a&&!this.bench?.ativo&&Xd(this.world,this.player,i,r),this.movimento.aposOPasso(r,this.player,o,i),this.player.pos.y<-16&&this.respawn(),this.outros.interpolar(r);let s=Lv.fov*(this.player.sprinting?1.1:1);if(Math.abs(wv.fov-s)>.01&&(wv.fov+=(s-wv.fov)*(1-Math.exp(-r*20)),wv.updateProjectionMatrix()),wv.position.set(this.player.pos.x,this.player.pos.y+this.movimento.alturaOlho,this.player.pos.z),wv.rotation.set($.pitch,$.yaw,0),wv.getWorldDirection(this.lookDir),this.target=$.active?Wp(this.world,wv.position.x,wv.position.y,wv.position.z,this.lookDir.x,this.lookDir.y,this.lookDir.z,5,this.hotbarUi.slotLocal===900):null,this.alvoJogador=$.active&&gy===`sobrevivencia`&&_y?Hp(wv.position.x,wv.position.y,wv.position.z,this.lookDir.x,this.lookDir.y,this.lookDir.z,this.outros.alvosParaMira(),5):null,this.alvoJogador&&this.target){let e=Math.hypot(this.target.x+.5-wv.position.x,this.target.y+.5-wv.position.y,this.target.z+.5-wv.position.z);this.alvoJogador.dist>e&&(this.alvoJogador=null)}if(Kv?.classList.toggle(`alvo`,this.alvoJogador!==null),this.highlight.visible=this.target!==null&&this.alvoJogador===null,this.target){let[e,t,n,r,i,a]=Kf(K(this.world,this.target.x,this.target.y,this.target.z));this.highlight.position.set(this.target.x+(e+r)/2,this.target.y+(t+i)/2,this.target.z+(n+a)/2),this.highlight.scale.set(r-e+.004,i-t+.004,a-n+.004)}this.hud.setRemesh({count:this.chunkRenderer.remeshCount,totalMs:this.chunkRenderer.remeshMsTotal,workerMs:this.chunkRenderer.remeshWorkerMsTotal,config:this.chunkRenderer.meshConfig,lastMs:this.chunkRenderer.lastRemeshMs,porCaminho:this.chunkRenderer.porCaminho}),kv.update(r),Dv.update(r,kv),this.materiais.atualizar(r,kv,Dv.nivelCeu,Lv.balanco),this.aguaFx.update(this.world,wv.position.x,wv.position.y,wv.position.z);let c=performance.now();this.hud.gpuInicio(),Sv.render(Cv,wv),this.hud.gpuFim(),this.hud.frame(n,performance.now()-c)}),this.mundoLazy||Bv.concluir(),Jy.has(`hud`)&&this.hud.toggle(),new URLSearchParams(location.search).has(`painel`)&&Rv.cp14?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Rv.mochila?.toggle(),new URLSearchParams(location.search).has(`amigos`)&&Rv.amigos?.toggle(),Jy.has(`touch`)&&Xv()}descartarColuna=(e,t)=>{this.chunkRenderer.descartarColuna(e,t),this.torchGlow.descartarColuna(e,t),this.luz.descartar(e,t);for(let n=0;n<this.world.dims.y;n++)this.world.chunks[(n*this.world.dims.z+t)*this.world.dims.x+e]=void 0};drawClaims=e=>{this.claimRenderer.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};updateObjectiveBoxes=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Ay!==null&&r.grupo===Ay;(py===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});this.objectiveBoxes.setRegions(t)};recalcularCarga=()=>this.progresso.recalcular(this.world.dims,this.player.pos.x,this.player.pos.z,Lv.raioRender,this.mundoLazy);respawn(){this.player.pos.x=this.spawn.x,this.player.pos.y=this.spawn.y,this.player.pos.z=this.spawn.z,this.player.vel.x=this.player.vel.y=this.player.vel.z=0}aplicarColunas(e){let t=[];try{t=Td(e,this.world)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:n}of t){let t=n*this.world.dims.x+e;this.colunasCarregadas.add(t),this.colunasFaltando.chegou(t),this.luz.enfileirar(e,n,this.world.dims.x),this.torchGlow.varrerColuna(this.world,e,n)}this.colunasRecebidas+=t.length}applyRegions(e){this.regionRenderer.setRegions(e),this.regionRenderer.clearCorners()}applyClaims(e){this.drawClaims(e),this.regionRenderer.clearCorners(),this.hotbarUi.revalidarVarinha(),Iv?.setVarinhaDisponivel(py===`professor`||Ty),Iv?.setAmigosDisponivel(Ty),this.hotbarUi.refresh()}applyQuadros(e){this.quadroRenderer.setAll(e,this.world)}applyQuadroChanged(e){this.quadroRenderer.aplicar(e,this.world)}applyObjectiveBoxes(e){this.updateObjectiveBoxes(e)}iniciarTroca(e){this.progresso.indeterminar(),Bv.abrir({host:ty,rede:!(this.activeConn instanceof Rg),titulo:`trocando de aula`,alvo:e}),this.progresso.observar(),Bv.setFase(`preparando`),this.hud.setFase(`carregando`),this.hud.marcar(`troca de aula`,e),Yv()}reloadWorld(e){this.world=e.world,this.worldSeed=e.seed,this.mundoLazy=Py,this.colunasCarregadas=new Set,this.colunasFaltando.limpar(),this.luz.trocarMundo(this.world.dims),this.mundoLazy||this.luz.acenderTudo(this.world),this.chunkRenderer.trocarMundo(this.world,!this.mundoLazy,this.luz.paraMesher),this.torchGlow.setFromWorld(this.world),wy=[],this.regionRenderer.setRegions([]),this.regionRenderer.clearCorners(),this.quadroRenderer.setAll([],this.world),ky=null,this.updateObjectiveBoxes([]),Oy.update(`livre`,[],{grupo:null,professor:py===`professor`,painelKey:d_(Lv.keys.painel)}),My.clear(),Ny=!1,jy=[],Ay=null,Iy(),this.spawn=fy??this.spawn,this.respawn(),ay.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),Qv=-1,$v(),this.hud.setMeta({worldChunks:this.world.dims,worldSeed:e.seed}),this.recalcularCarga(),Bv.abrir({host:ty,rede:!(this.activeConn instanceof Rg),titulo:`trocando de aula`}),this.progresso.observar(),Bv.setFase(this.mundoLazy?`mundo`:`malha`),this.hud.setFase(`carregando`),Yv(),this.mundoLazy||Bv.concluir()}applyTeleport(e){this.player.pos.x=e.x,this.player.pos.y=e.y,this.player.pos.z=e.z,this.player.vel.x=this.player.vel.y=this.player.vel.z=0,$.yaw=Mv??e.yaw,$.pitch=Nv??e.pitch}applyBlockChanged(e){Iu(this.world,e.x,e.y,e.z,e.blockId),this.chunkRenderer.remeshBlock(e.x,e.y,e.z),this.chunkRenderer.remeshSujos(this.luz.aoMudarBloco(this.world,e.x,e.y,e.z)),this.torchGlow.onBlockChanged(e.x,e.y,e.z,e.blockId),this.quadroRenderer.onBlockChanged(e.x,e.y,e.z,e.blockId,this.world),_m(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})}applyBlocksFilled(e){for(let t=e.y0;t<=e.y1;t++)for(let n=e.z0;n<=e.z1;n++)for(let r=e.x0;r<=e.x1;r++)Iu(this.world,r,t,n,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},n={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(this.world.dims.x-1,e.x1/16|0);t++)for(let n=Math.max(0,e.z0/16|0);n<=Math.min(this.world.dims.z-1,e.z1/16|0);n++)this.chunkRenderer.remeshSujos(this.luz.aoChegarColuna(this.world,t,n));this.chunkRenderer.remeshBox(t,n),this.torchGlow.onRegionFilled(t,n,e.blockId),this.quadroRenderer.validarTodos(this.world),_m(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})}applyPlayerMoved(e){this.outros.aoMover(e)}applyPlayerLeft(e){this.outros.aoSair(e)}aoMudarMochila(){this.hotbarUi.refresh()}};function Qy(e){let t=ey;t&&(Vv=new Zy(e,t),Vv.iniciar())}