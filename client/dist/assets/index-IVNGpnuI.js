...
`;function Mg(e){return`url("data:image/svg+xml,${encodeURIComponent(e)}")`}var Ng=Mg(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#e23b3b" stroke="#5a0d0d" stroke-width="1.2"/></svg>`),Pg=Mg(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#1a1a1a" stroke="#000" stroke-width="1.2"/></svg>`),Fg=Mg(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#7fd4ff" stroke="#0a3550" stroke-width="1.2"/><circle cx="5.8" cy="5.8" r="1.6" fill="#fff" opacity="0.9"/></svg>`),Ig=(e,t,n)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M12.8 12.8 8.6 8.6" stroke="${t}" stroke-width="3" stroke-linecap="round"/><circle cx="12.9" cy="12.9" r="2.1" fill="${t}" stroke="${n}" stroke-width="0.9"/><circle cx="6" cy="6" r="4.7" fill="${e}" stroke="${n}" stroke-width="1.1"/></svg>`,Lg=Mg(Ig(`#b2601f`,`#f3e7cf`,`#4d2a10`)),Rg=Mg(Ig(`#1a1a1a`,`#1a1a1a`,`#000`));function zg(e,t,n){let r=document.createElement(`div`);r.className=`linha`;let i=[];for(let a=0;a<e;a++){let e=document.createElement(`div`);if(e.className=`casa`,n!==void 0){let t=document.createElement(`div`);t.className=`icone fundo`,t.style.backgroundImage=n,e.appendChild(t)}let a=document.createElement(`div`);a.className=`icone`,a.style.backgroundImage=t,e.appendChild(a),r.appendChild(e),i.push(e)}return{linha:r,casas:i}}function Bg(e,t){for(let[n,r]of e.entries()){let e=r.lastElementChild;if(!e)continue;let i=t>=(n+1)*2,a=!i&&t===n*2+1;e.style.display=i||a?`block`:`none`,e.classList.toggle(`meio`,a)}}var Vg=class{raiz;linhaVida;linhaFome;linhaAr;dano;morte;casasVida;casasFome;casasAr;morteTimer=null;danoTimer=null;ultimaVida=20;visivel=!1;constructor(){let e=document.createElement(`style`);e.textContent=jg,document.head.appendChild(e),this.raiz=document.createElement(`div`),this.raiz.id=`lj-vitals`;let t=zg(Dg,Ng,Pg),n=zg(Og,Lg,Rg),r=zg(kg,Fg);this.linhaVida=t.linha,this.casasVida=t.casas,this.linhaFome=n.linha,this.casasFome=n.casas,this.linhaAr=r.linha,this.casasAr=r.casas,this.linhaAr.classList.add(`vazia`),this.linhaFome.classList.add(`vazia`);let i=document.createElement(`div`);i.className=`barras`,i.append(this.linhaVida,this.linhaFome),this.raiz.append(this.linhaAr,i),document.body.appendChild(this.raiz),this.dano=document.createElement(`div`),this.dano.id=`lj-dano`,this.morte=document.createElement(`div`),this.morte.id=`lj-morte`,document.body.append(this.dano,this.morte)}setVisivel(e){this.visivel=e,this.raiz.classList.toggle(`ativo`,e),e||this.esconderMorte()}aplicar(e){let t=Math.max(0,Math.min(20,Math.round(e.vida)));Bg(this.casasVida,t),this.desenharFome(e.fome),this.desenharAr(e.folego),t<this.ultimaVida&&this.visivel&&this.piscarDano(),e.morreu&&this.visivel&&this.mostrarMorte(e.causa),this.ultimaVida=t}desenharFome(e){this.linhaFome.classList.toggle(`vazia`,e===void 0),e!==void 0&&Bg(this.casasFome,Math.max(0,Math.min(20,Math.round(e))))}desenharAr(e){let t=e===void 0||e>=150;if(this.linhaAr.classList.toggle(`vazia`,t),t)return;let n=Math.max(0,Math.ceil(e/Ag));for(let[e,t]of this.casasAr.entries()){let r=t.lastElementChild;r&&(r.style.display=e<n?`block`:`none`)}}piscarDano(){this.dano.classList.add(`piscar`),this.danoTimer!==null&&clearTimeout(this.danoTimer),this.danoTimer=setTimeout(()=>this.dano.classList.remove(`piscar`),90)}mostrarMorte(e){this.morte.textContent=e===`queda`?`Você caiu de muito alto`:e===`afogamento`?`Você ficou sem ar`:e===`fome`?`Você passou fome demais`:`Você não sobreviveu`,this.morte.classList.add(`ativo`),this.morteTimer!==null&&clearTimeout(this.morteTimer),this.morteTimer=setTimeout(()=>this.esconderMorte(),2600)}esconderMorte(){this.morte.classList.remove(`ativo`)}},Hg=class{send;onToggle;root=document.getElementById(`amigos`);isOpen=!1;data={eu:``,equipe:null,convites:[],enviados:[],online:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&um(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=this.btn(e,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)});return n}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}linha(e,...t){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);return r.className=`jog-nome`,r.textContent=e,n.append(r,...t),n}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`amigos`,t.append(n,this.btn(`✕ fechar`,()=>this.hide()));let r=document.createElement(`div`);r.className=`jog-lista`,this.renderConvites(r),this.renderGrupo(r),this.renderConvidar(r),r.append(this.hint(`pelo chat também dá: /amigos convidar nome · /amigos aceitar · /amigos recusar · /amigos sair · /amigos expulsar nome · /amigos lista`)),e.append(t,r)}renderConvites(e){if(this.data.convites.length!==0){e.append(this.sec(`✉ convites para você (${this.data.convites.length})`));for(let t of this.data.convites)e.append(this.linha(`${t} convidou você`,this.btn(`aceitar`,()=>this.send(`/amigos aceitar ${t}`)),this.btn(`recusar`,()=>this.send(`/amigos recusar ${t}`))));e.append(this.hint(`aceitar um convite descarta os outros — você fica em UM grupo só.`))}}renderGrupo(e){let{eu:t,equipe:n}=this.data;if(!n){e.append(this.sec(`👥 seu grupo`)),e.append(this.hint(`Você não está em nenhum grupo. Quem está no seu grupo pode construir na sua ÁREA PROTEGIDA (e você na dele). Cabem 6 pessoas, contando você.`));return}let r=n.dono===t;e.append(this.sec(`👥 grupo de ${n.dono} — ${n.membros.length}/6`));for(let i of n.membros){let a=[i===n.dono?`dono`:``,i===t?`você`:``].filter(e=>e),o=a.length?`${i} (${a.join(`, `)})`:i;e.append(r&&i!==t?this.linha(o,this.armedBtn(`expulsar`,()=>this.send(`/amigos expulsar ${i}`))):this.linha(o))}let i=document.createElement(`div`);i.className=`painel-row`,i.append(r?this.armedBtn(`sair e DESFAZER o grupo`,()=>this.send(`/amigos sair`)):this.armedBtn(`sair do grupo`,()=>this.send(`/amigos sair`))),e.append(i),r&&e.append(this.hint(`você é o dono: se sair, o grupo acaba para todo mundo.`))}renderConvidar(e){let{eu:t,equipe:n,enviados:r,online:i}=this.data;if(e.append(this.sec(`＋ convidar`)),n&&n.dono!==t){e.append(this.hint(`Só ${n.dono} convida para este grupo. Saia dele para montar o seu.`));return}if(n&&n.membros.length>=6){e.append(this.hint(`Grupo cheio (6/6).`));return}for(let t of r)e.append(this.linha(`${t} — convite enviado, aguardando`));let a=new Set(n?.membros??[]),o=i.filter(e=>e!==t&&!a.has(e)&&!r.includes(e));for(let t of o)e.append(this.linha(t,this.btn(`convidar`,()=>this.send(`/amigos convidar ${t}`))));o.length===0&&r.length===0&&e.append(this.hint(`ninguém mais está na aula agora.`))}},Ug=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&um(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},Wg=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&um(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},Gg=class extends Wg{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(km[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=Ou(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=Ou(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...km.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},Kg=class extends Wg{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},qg=class{fixedColor;group=new cn;cornerMarks=[];boxes=[];bounds=[];culling=null;constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Ci(new Hi(new Ii(1.01,1.01,1.01)),new di({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();if(this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Ci(new Hi(new Ii(n+.04,r+.04,i+.04)),new di({color:this.fixedColor??new W().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a}),this.bounds=e,this.culling){let{px:e,pz:t,raio:n}=this.culling;this.cularPorDistancia(e,t,n)}}cularPorDistancia(e,t,n){this.culling={px:e,pz:t,raio:n};for(let r=0;r<this.boxes.length;r++){let i=this.boxes[r],a=this.bounds[r];if(!i||!a)continue;let o=Math.max(a.min.x-e,0,e-(a.max.x+1)),s=Math.max(a.min.z-t,0,t-(a.max.z+1));i.visible=Math.max(o,s)<=n}}},Jg=1/16,Yg=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*Jg-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*Jg-.004,ry:Math.PI}];function Xg(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var Zg=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(Pf(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=Pf(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=q(t,e.x,e.y,e.z);if(!Vl(r))return;let i=Yg[r-K.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,Xg(a,e,null);let o=new Mi(a);o.colorSpace=Le;let s=new $r(new Ui(12*Jg,12*Jg),new Vr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{Xg(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=Pf(e,t,n);if(this.conteudos.has(a))if(!Vl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Vl(q(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function Qg(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var $g=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,Qg(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},e_=null;function t_(e){e.preventDefault(),e.returnValue=``}var n_=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function r_(e){e_?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||n_.has(e.code))&&e.preventDefault())}function i_(e){e_?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function a_(e){e_||(e_=e,window.addEventListener(`beforeunload`,t_),window.addEventListener(`keydown`,r_,!0),window.addEventListener(`keyup`,i_,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function o_(){e_=null,window.removeEventListener(`beforeunload`,t_),window.removeEventListener(`keydown`,r_,!0),window.removeEventListener(`keyup`,i_,!0),navigator.keyboard?.unlock?.()}var s_=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Mi(t);i.minFilter=o,this.material=new _r({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[Su(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===K.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===K.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===K.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new jr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function c_(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Rm(n)}var l_=new _l({antialias:!0});l_.setPixelRatio(Math.min(window.devicePixelRatio,2)),l_.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(l_.domElement);var u_=new _n;u_.background=new W(8900331);var d_=new ja(75,window.innerWidth/window.innerHeight,.1,512);d_.rotation.order=`YXZ`;var f_=new Pa(16777215,2.2);f_.position.set(60,100,40);var p_=new Fa(16777215,.55);u_.add(f_,p_);var m_=new vh(f_,p_,u_,d_),h_=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();h_!==null&&m_.sync(h_,!1);var g_=new xh,__=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();__&&g_.sync(__.dir,__.forca,!0);var v_=Ch(),$=new Lh(l_.domElement),y_=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},b_=y_(`yaw`),x_=y_(`pitch`);b_!==null&&($.yaw=b_),x_!==null&&($.pitch=x_);var S_=bm(new URLSearchParams(location.search));function C_(){let e=S_?{...Zh(),...xm(S_)}:Zh();return $.sensitivity=e.sensitivity,d_.fov=e.fov,d_.updateProjectionMatrix(),l_.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),cm(e.volume),w_?.setScale(e.uiScale),m_.setNuvens(e.nuvens),e}var w_=null,T_=C_();fm(T_.volume);var E_=null,D_=null,O_=null,k_=null,A_={equipe:null,convites:[],enviados:[]},j_=new Gh(()=>{B_(),P_?.setFase(`jogando`),P_?.marcar(`carga concluída`),M_?.()}),M_=null,N_=!1,P_=null,F_=document.getElementById(`overlay`),I_=document.getElementById(`overlay-main`),L_=document.getElementById(`overlay-config`),R_=document.getElementById(`crosshair`);function z_(){I_?.classList.remove(`hidden`),L_?.classList.add(`hidden`)}function B_(){let e=(E_?.open??!1)||(D_?.open??!1)||(O_?.open??!1)||(k_?.open??!1);F_?.classList.toggle(`hidden`,N_||j_.ativo||$.active||Y_.open||e),R_?.classList.toggle(`hidden`,!$.active),$.locked&&z_(),w_?.setShown($.touch&&!Y_.open&&!e&&!j_.ativo)}document.addEventListener(`pointerlockchange`,B_);function V_(){ug()?($.touch=!0,dg(),B_()):$.lock()}function H_(){let e=T_.keys;T_=C_();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`,`amigos`])$.rebind(e[t],T_.keys[t]);W_()}var U_=-1;function W_(){if(!G_||T_.raioRender===U_)return;let e=U_;U_=T_.raioRender,G_.send(JSON.stringify({type:`radius`,chunks:U_})),P_?.marcar(`raio`,`${e<0?`join`:e} → ${U_}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>V_()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&bg(e,H_,z_),I_?.classList.add(`hidden`),L_?.classList.remove(`hidden`)}),F_?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&um(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{d_.aspect=window.innerWidth/window.innerHeight,d_.updateProjectionMatrix(),l_.setSize(window.innerWidth,window.innerHeight)});var G_=null,K_=`?`,q_=null;function J_(){return new URLSearchParams(location.search).get(`nome`)??hg()}var Y_=new Gm(e=>G_?.send(JSON.stringify({type:`chat`,text:e})),e=>{B_(),e||$.lock()});B_(),l_.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Y_.open&&Y_.close()});var X_={tickAvgMs:0,tickMaxMs:0},Z_=null,Q_=0,$_=[];function ev(){let e=performance.now();Q_>0&&($_.push(e-Q_),$_.length>300&&$_.shift()),Q_=e}function tv(){let e=$_.length;if(e<2)return 0;let t=$_.reduce((e,t)=>e+t,0)/e,n=$_.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var nv=!1,rv=null,iv=null,av=null,ov=null,sv=null,cv=null,lv=null,uv=`aluno`,dv=!1,fv=!1,pv=`criativo`;function mv(){return tf(pv)&&(uv===`professor`||dv)}var hv=new Eg,gv=null,_v=null;function vv(){return _v??=new Vg,_v}var yv=null,bv=(()=>{let e=new URLSearchParams(location.search).get(`vida`);if(e===null)return null;let[t,n,r]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{vida:t,...Number.isFinite(n)?{folego:n}:{},...Number.isFinite(r)?{fome:r}:{}}})();bv&&(vv().setVisivel(!0),vv().aplicar(bv));{let e=new URLSearchParams(location.search).get(`mochila`);if(e!==null){let t=[];e.split(`,`).forEach((e,n)=>{let[r,i]=e.split(`x`).map(Number);r===void 0||!Number.isInteger(r)||r<=0||t.push({slot:n,id:r,qtd:Number.isInteger(i)&&i>0?i:1})}),hv.travar(t)}}var xv=[],Sv=null,Cv=!1,wv=!1,Tv=[],Ev=null,Dv=null,Ov=null,kv=new Tg,Av=null,jv=null,Mv=null,Nv=[],Pv=new Set,Fv=!1,Iv=null,Lv=null,Rv=!1,zv=new Map;function Bv(){E_?.update({regions:xv,modo:Av?.modo??`sequencial`,objetivos:Av?.objetivos??[],grupos:Nv,myGrupo:Mv})}function Vv(){k_?.update({eu:J_(),equipe:A_.equipe,convites:A_.convites,enviados:A_.enviados,online:[...new Set(zv.values())].sort()})}function Hv(e){return e.porGrupo&&uv!==`professor`?Mv===null?!1:e.porGrupo.find(e=>e.grupo===Mv)?.completo??!1:e.completo}function Uv(e){if(Av){for(let t of Av.objetivos)Hv(t)?Pv.has(t.id)||(Pv.add(t.id),e&&Fv&&rm({kind:`objective_complete`})):Pv.delete(t.id);Fv=!0,kv.update(Av.modo,Av.objetivos,{grupo:Mv,professor:uv===`professor`,painelKey:$h(T_.keys.painel)}),jv?.(Av.objetivos)}}var Wv=null;function Gv(){let e=Wv;if(e){Wv=null;for(let t of e)qv(t)}}function Kv(){Wv||(Wv=[],requestAnimationFrame(()=>requestAnimationFrame(Gv)),setTimeout(Gv,500))}function qv(e){if(Wv){Wv.push(e);return}if(ev(),nv||j_.setFase(`mundo`),typeof e==`string`){let t=tp(e);if(!t)return;if(t.type===`debug_stats`)X_={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},Z_=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0};else if(t.type===`block_changed`)rv?.(t);else if(t.type===`blocks_filled`)iv?.(t);else if(t.type===`player_moved`)t.name&&zv.get(t.id)!==t.name&&(zv.set(t.id,t.name),zm([...new Set(zv.values())]),Vv()),av?.(t);else if(t.type===`player_left`)zv.delete(t.id),zm([...new Set(zv.values())]),Vv(),ov?.(t.id);else if(t.type===`spawn`)lv={x:t.x,y:t.y,z:t.z},uv=t.papel??`aluno`;else if(t.type===`regions`)xv=t.regions,Sv?.(t.regions),Bv();else if(t.type===`objectives`)Av={modo:t.modo,objetivos:t.objetivos},Uv(!0),Bv();else if(t.type===`group`)Mv=t.grupo,Pv.clear(),Uv(!1),Bv();else if(t.type===`groups`)Nv=t.grupos,Bv();else if(t.type===`quadros`)Dv?.(t.lista);else if(t.type===`quadro_changed`)Ov?.(t);else if(t.type===`claims`)Cv=t.ativo,t.ativo&&!wv&&(wv=!0,Y_.addMessage(`jogo`,`tecla ${$h(T_.keys.amigos)} abre o painel de amigos — quem está no seu grupo constrói na sua área`)),Tv=t.claims,Ev?.(t.claims);else if(t.type===`friends`)A_={equipe:t.equipe,convites:t.convites,enviados:t.enviados},Vv();else if(t.type===`players`)O_?.update({conectados:t.conectados,banidos:t.banidos});else if(t.type===`mundo_trocando`)sv?.(t.nome),Kv();else if(t.type===`teleport`)cv?.(t);else if(t.type===`time`)h_===null&&m_.sync(t.hora,t.ciclo);else if(t.type===`vento`)__===null&&g_.sync(t.dir,t.forca,t.ativo);else if(t.type===`voo`)dv=t.liberado,mv()||(fv=!1),Y_.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`);else if(t.type===`modo`){let e=pv!==t.efetivo;pv=t.efetivo,mv()||(fv=!1),bv===null&&(t.efetivo===`sobrevivencia`?vv().setVisivel(!0):_v?.setVisivel(!1)),t.efetivo===`criativo`&&hv.ativa&&(hv.desligar(),gv?.()),e&&Y_.addMessage(`jogo`,t.efetivo===`sobrevivencia`?`modo sobrevivência — não dá para voar`:`modo criativo`)}else if(t.type===`inventario`)hv.aplicar(t.slots),gv?.();else if(t.type===`vida`){if(bv!==null)return;yv=t,vv().aplicar(t),t.causa&&rm({kind:`dano`}),t.morreu&&(rm({kind:`morte`}),Y_.addMessage(`jogo`,t.causa===`queda`?`você caiu de muito alto — voltou ao ponto de partida`:t.causa===`afogamento`?`você ficou sem ar — voltou ao ponto de partida`:t.causa===`fome`?`você passou fome demais — voltou ao ponto de partida`:`você não sobreviveu — voltou ao ponto de partida`))}else t.type===`kicked`?(um(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),o_(),location.href=location.pathname):t.type===`join_denied`?(um(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),o_(),location.href=location.pathname):t.type===`chat`&&(Y_.addMessage(t.author,t.text),t.author===`servidor`&&c_(t.text),rm({kind:`chat_message`}));return}let t=ap(e);if(t===809716300){Lv?.(e);return}let n=()=>(Rv=t===rp,Rv?op(e):np(e));if(nv){Iv?.(n());return}nv=!0,ey(n())}function Jv(e,t){T_=C_(),G_=e,j_.abrir({host:K_,rede:!(e instanceof Eh)}),j_.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),B_(),e.onMessage(qv),$.onKey(T_.keys.chat,()=>{Y_.open||(document.exitPointerLock(),Y_.openInput())}),e.send(JSON.stringify({type:`join`,name:J_(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),U_=-1,W_()}function Yv(e,t){K_=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Jv(new Dh(e,t=>{nv||!j_.ativo||j_.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function Xv(e,t){q_={id:e.id,name:e.name,createdAt:e.createdAt},K_=`web-worker (${e.name})`;let n=new Eh(new Worker(new URL(`/assets/worker-wDBWIVl0.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho,sobrevivencia:e.sobrevivencia}),Jv(n)}async function Zv(){if(!(G_ instanceof Eh)||!q_)return;let e=await G_.requestSave();await og({...q_,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{o_(),Zv().finally(()=>location.reload())});var Qv=new URLSearchParams(location.search),$v=Qv.get(`server`);if($v){let e=Qv.get(`codigo`);Yv($v,{pin:Qv.get(`pin`)??``,...e?{codigo:e}:{}})}else S_?Xv({id:`bench-${pm}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:qu(Qv.get(`tamanho`)??`E`)},pm):yg({onPlayWorld:Xv,onPlayMulti:Yv});function ey(e){let t=G_;if(!t)return;a_(()=>$.active);let n=e.world,r=e.seed,i=new URLSearchParams(location.search).has(`semluz`),a=nd(n.dims),s=[],c=new Set,l=0,u=0,d=Rv,f=new Set,p=0,m=new Map,h=0,g=0,_=0,v=Xp(),y=new ea({map:v,alphaTest:.5});Sh(y,v_);let b=wh();Th(y,b);let x=new ea({map:v,transparent:!0,opacity:.72,depthWrite:!1}),S=new ea({map:v,transparent:!0,opacity:.4,depthWrite:!1});if(Th(x,b),Th(S,b),new URLSearchParams(location.search).has(`atlas`)){let e=y.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let C=new URLSearchParams(location.search),w=C.has(`semworker`),T=Number(C.get(`meshdepth`)),E=new Qm(n,[y,x,S],u_,!w,Number.isFinite(T)&&T>0?T:void 0,i?void 0:a),D=new $p(u_),ee=-1,O=0,k=-1,te=-1,A=(e,t)=>{for(let n=0;n<e.dims.x;n++)for(let r=0;r<e.dims.z;r++)wd(e,t,n,r)};d||(i||A(n,a),E.buildAll()),Lv=e=>{let t=[];try{t=cp(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;f.add(t),m.delete(t),c.has(t)||(c.add(t),s.push({cx:e,cz:r})),ne.varrerColuna(n,e,r)}g+=t.length};let j=(e,r,i)=>{let o=n.dims,s=T_.raioRender,c=0;for(let l=e-s;l<=e+s;l++)for(let e=r-s;e<=r+s;e++){if(l<0||e<0||l>=o.x||e>=o.z)continue;let r=e*o.x+l;if(f.has(r))continue;let s=m.get(r);if(!s){m.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||c>=4)){E.descartarColuna(l,e),ne.descartarColuna(l,e),od(a,l,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+l]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:l,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),c++,h++}}for(let t of m.keys()){let n=t%o.x,i=(t-n)/o.x;(f.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&m.delete(t)}},ne=new s_(u_);ne.setFromWorld(n);let re=new qg(u_);re.setRegions(xv),Sv=e=>{re.setRegions(e),re.clearCorners()};let M=new qg(u_,16747546),ie=e=>{M.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};ie(Tv),Ev=e=>{ie(e),re.clearCorners(),!Cv&&uv!==`professor`&&Te&&(Te=!1),ke()};let ae=new Zg(u_),oe=new $g;Dv=e=>ae.setAll(e,n),Ov=e=>ae.aplicar(e,n);let se=new qg(u_,3066993),ce=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Mv!==null&&r.grupo===Mv;(uv===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});se.setRegions(t)};jv=ce,Av&&ce(Av.objetivos);let le=e=>t.send(JSON.stringify({type:`chat`,text:e})),ue=e=>{e?document.exitPointerLock():$.lock(),B_()};uv===`professor`&&(O_=new Ug(le,ue)),k_=new Hg(le,ue),Vv(),E_=uv===`professor`?new Gg(le,ue,()=>{E_?.hide(),D_?.hide(),k_?.hide(),O_?.show()}):new Kg(le,ue),Bv(),$.onKey(T_.keys.painel,()=>{if(!Y_.open){if(uv!==`professor`&&Nv.length===0){Y_.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}D_?.hide(),O_?.hide(),k_?.hide(),E_?.toggle()}}),$.onKey(T_.keys.amigos,()=>{Y_.open||(E_?.hide(),D_?.hide(),O_?.hide(),k_?.toggle())}),uv===`professor`&&Y_.addMessage(`jogo`,`tecla ${$h(T_.keys.painel)} abre o painel de autoria`);let N=lv??{x:n.sizeX/2+.5,y:Eu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},P=bf(N.x,N.y,N.z),de=()=>{if(!d)return 0;let e=T_.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(P.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(P.pos.z/16))),i=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,a=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,i*a)},fe=de(),pe=()=>{j_.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:f.size,total:fe,faltando:m.size>0?m.size:Math.max(0,fe-f.size),fila:E.filaPendente}))};pe(),j_.setFase(d?`mundo`:`malha`),sv=e=>{fe=0,j_.abrir({host:K_,rede:!(t instanceof Eh),titulo:`trocando de aula`,alvo:e}),pe(),j_.setFase(`preparando`),I.setFase(`carregando`),I.marcar(`troca de aula`,e),B_()};function me(){P.pos.x=N.x,P.pos.y=N.y,P.pos.z=N.z,P.vel.x=P.vel.y=P.vel.z=0}Iv=e=>{n=e.world,r=e.seed,d=Rv,f=new Set,m.clear(),a=nd(n.dims),s.length=0,c.clear(),!d&&!i&&A(n,a),E.trocarMundo(n,!d,i?void 0:a),ne.setFromWorld(n),xv=[],re.setRegions([]),re.clearCorners(),ae.setAll([],n),Av=null,jv?.([]),kv.update(`livre`,[],{grupo:null,professor:uv===`professor`,painelKey:$h(T_.keys.painel)}),Pv.clear(),Fv=!1,Nv=[],Mv=null,Bv(),N=lv??N,me(),Y_.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),U_=-1,W_(),I.setMeta({worldChunks:n.dims,worldSeed:e.seed}),fe=de(),j_.abrir({host:K_,rede:!(t instanceof Eh),titulo:`trocando de aula`}),pe(),j_.setFase(d?`mundo`:`malha`),I.setFase(`carregando`),B_(),d||j_.concluir()},cv=e=>{P.pos.x=e.x,P.pos.y=e.y,P.pos.z=e.z,P.vel.x=P.vel.y=P.vel.z=0,$.yaw=b_??e.yaw,$.pitch=x_??e.pitch},rv=e=>{Tu(n,e.x,e.y,e.z,e.blockId),E.remeshBlock(e.x,e.y,e.z),i||E.remeshSujos(Td(n,a,e.x,e.y,e.z)),ne.onBlockChanged(e.x,e.y,e.z,e.blockId),ae.onBlockChanged(e.x,e.y,e.z,e.blockId,n),rm(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},iv=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)Tu(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(n.dims.x-1,e.x1/16|0);t++)for(let r=Math.max(0,e.z0/16|0);r<=Math.min(n.dims.z-1,e.z1/16|0);r++)i||E.remeshSujos(wd(n,a,t,r));E.remeshBox(t,r),ne.onRegionFilled(t,r,e.blockId),ae.validarTodos(n),rm(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let he=new Map,ge=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Mi(t);i.minFilter=o;let a=new jr(new _r({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,hf.height/2+.35,0),a},_e=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};av=e=>{let t=he.get(e.id);if(!t){let n=new $r(new Ii(hf.width,hf.height,hf.width),new ea({color:new W().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+hf.height/2,e.z),n.rotation.y=e.yaw,u_.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},he.set(e.id,t)}e.name&&e.name!==t.labelName&&(_e(t),t.label=ge(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+hf.height/2,e.z),t.targetYaw=e.yaw},ov=e=>{let t=he.get(e);t&&(_e(t),u_.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),he.delete(e))};let ve=new Ci(new Hi(new Ii(1,1,1)),new di({color:0}));ve.visible=!1,u_.add(ve);let F=null,ye=new H,be=`lj-hotbar`,xe=Am(uv),Se=()=>xe.slice(0,9).map(e=>e.id),Ce=(()=>{let e=new Set(xe.map(e=>e.id));e.add(900);let t=Se();try{let n=JSON.parse(localStorage.getItem(be)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),we=0,Te=!1,Ee=document.getElementById(`hotbar`),De=Em(y.map?.image,[...km.map(e=>e.id),900,902,903,904]),Oe=e=>e===900?`balde vazio`:e===901?`balde de água`:e===902?`fruta`:e===903?`trigo`:e===904?`pão`:km.find(t=>t.id===e)?.name??`?`,ke=()=>{if(!Ee)return;if(Te){Ee.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${uv===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=hv.ativa?hv.hotbar():Ce,t=e.map((e,t)=>{let n=t===we?` sel`:``;if(e==null)return`<span class="slot${n} vazio"><small>${t+1}</small></span>`;let r=hv.ativa?hv.qtdDoSlot(t):0,i=r>1?`<b class="qtd">${r}</b>`:``;return`<span class="slot${n}"><small>${t+1}</small><img src="${De.get(e)??``}" alt="">${i}</span>`}).join(``),n=e[we];Ee.innerHTML=`<span class="bar-nome">${n==null?`mão vazia`:Oe(n)}</span><span class="slots">${t}</span>`,D_?.refresh()},Ae=()=>hv.ativa?hv.idDoSlot(we):Ce[we]??null;gv=()=>ke(),ke();let je=()=>{uv!==`professor`&&!Cv||(Te=!Te,ke())};$.onKey(T_.keys.varinha,je);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{we=e,ke()});$.onWheel(e=>{we=(we+e+Ce.length)%Ce.length,ke()}),Ee?.addEventListener(`pointerdown`,e=>{let t=e.target?.closest?.(`.slot`);if(!t)return;let n=[...Ee.querySelectorAll(`.slot`)].indexOf(t);n<0||(e.preventDefault(),we=n,ke())}),D_=new jm(De,()=>xe,()=>({hotbar:Ce,selected:we}),e=>{Ce[we]=e,localStorage.setItem(be,JSON.stringify(Ce)),ke()},e=>{we=e,ke()},e=>{e?(E_?.hide(),O_?.hide(),k_?.hide(),document.exitPointerLock()):$.lock(),B_()},hv,(e,n)=>t.send(JSON.stringify({type:`mover_item`,de:e,para:n})),Oe,e=>t.send(JSON.stringify({type:`fabricar`,receita:e}))),$.onKey(T_.keys.inventario,()=>{Y_.open||D_?.toggle()});let Me=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),re.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(F){if(Te){Me(1,F);return}Cl(Ae()??-1)&&pv!==`criativo`||t.send(JSON.stringify({type:`break_block`,x:F.x,y:F.y,z:F.z}))}}),$.onMouseButton(2,()=>{if(hv.ativa&&Pu(Ae()??-1)){t.send(JSON.stringify({type:`comer`,slot:we}));return}if(!F)return;if(Te){Me(2,F);return}{let e=Ae();if(Cl(e??-1)){let r=hv.ativa?{slot:we}:{};if(e===901)t.send(JSON.stringify({type:`balde`,x:F.x+F.nx,y:F.y+F.ny,z:F.z+F.nz,encher:!1,...r})),hv.ativa||(Ce[we]=900);else{if(q(n,F.x,F.y,F.z)!==K.Agua)return;t.send(JSON.stringify({type:`balde`,x:F.x,y:F.y,z:F.z,encher:!0,...r})),hv.ativa||(Ce[we]=901)}hv.ativa||(localStorage.setItem(be,JSON.stringify(Ce)),ke());return}}if(Vl(q(n,F.x,F.y,F.z))){let{x:e,y:n,z:r}=F;oe.open(ae.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(iu(q(n,F.x,F.y,F.z))){t.send(JSON.stringify({type:`use_block`,x:F.x,y:F.y,z:F.z}));return}let e=Ae();if(e!==null){if((e===K.PortaXFechada||e===K.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.PortaXFechada:K.PortaZFechada),(e===K.JanelaXFechada||e===K.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.JanelaXFechada:K.JanelaZFechada),Hl(e)||Ul(e)||Wl(e)||Vl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Hl(e)?K.CadeiraXP:Ul(e)?K.SofaXP:Wl(e)?K.CamaXP:K.QuadroXP)+r}if(jl(e)){let t=e-+!!Ml(e);e=F.ny<0?t+1:t}if(Pl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Rl(Ll(e),r,F.ny<0)}t.send(JSON.stringify({type:`place_block`,x:F.x+F.nx,y:F.y+F.ny,z:F.z+F.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!F||Te||hv.ativa)return;let e=q(n,F.x,F.y,F.z);Xl(e)&&(e=K.PortaXFechada),eu(e)&&(e=K.JanelaXFechada),Hl(e)&&(e=K.CadeiraXP),Ul(e)&&(e=K.SofaXP),Wl(e)&&(e=K.CamaXP),Vl(e)&&(e=K.QuadroXP),jl(e)&&(e=K.LajePedraBaixo+Nl(e)*2),Pl(e)&&(e=K.EscadaPedraXP+Ll(e)*8),su(e)&&(cu(e)&&uv!==`professor`||(Ce[we]=e,localStorage.setItem(be,JSON.stringify(Ce)),ke()))});let I=new Ih(l_,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:K_});P_=I,I.contexto=()=>({x:P.pos.x,y:P.pos.y,z:P.pos.z,yaw:$.yaw,pitch:$.pitch,voando:fv&&mv(),noChao:P.onGround,raioRender:T_.raioRender,meshMsPorFrame:T_.meshMsPorFrame,pixelRatioCap:T_.pixelRatioCap,fov:T_.fov,nuvens:T_.nuvens,balanco:T_.balanco,distanciaTotal:_,colunasRecebidas:g,bytesRecebidos:t.stats.bytesIn}),I.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),I.carga=()=>j_.relatorio(),I.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Ne=null;if(S_){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);Y_.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let t=S_.semVida?`bench-semvida`:`bench`;I.baixar(e,t),Y_.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${t}-*.json)`)}};M_=()=>{if(Ne)return;Ne=Sm.paraMundo(S_,N,n.dims),I.setMeta({bench:Ne.meta()}),I.marcar(`bench: início`,`${S_.duracaoS}s · raio ${Ne.trajeto.raio}${S_.semVida?` · sem vida ambiental`:``}`),N_=!0,window.__benchRodando=!0,fv=!0,B_(),Ne.iniciar(performance.now());let t=Ne.amostra(performance.now());P.pos.x=R=t.x,P.pos.y=Le=t.y,P.pos.z=Re=t.z,I.record(t=>{N_=!1,window.__benchRodando=!1,B_(),window.__benchPerfil=t,e(t)},S_.duracaoS*1e3)}}$.onKey(T_.keys.hud,()=>I.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{I.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),ug()&&(Ee&&(Ee.style.pointerEvents=`auto`,Ee.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(we=n,ke())})),w_=new pg($,{keys:()=>T_.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>D_?.toggle(),chat:()=>{Y_.open||(document.exitPointerLock(),Y_.openInput())},menu:()=>{$.touch=!1,z_(),B_()},hud:()=>I.toggle(),varinha:()=>je()}),w_.setScale(T_.uiScale),B_()),I.extra=()=>{let e=$.mouseStats,t=P.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=Qu(i,a,r),s=uu(o),c=du(o),l=Math.min(Zu(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&s.neve?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===K.GramaSeca?`grama seca`:c===K.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se o bioma neva · chapada ≥85]\nrelevo ${hu(o).toFixed(2)} (teto do bioma ${s.relevo})\nmodo ${pv===`sobrevivencia`?`sobrevivência`:`criativo`}  voo ${mv()?fv?`voando`:`liberado`:`trancado`}`+(yv?`  vida ${yv.vida}/20`+(yv.fome===void 0?`  sem fome`:`  fome ${yv.fome}/20`):``)+`
mouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let Pe={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},Fe=0;setInterval(()=>{let e={x:P.pos.x,y:P.pos.y,z:P.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==Pe.x||e.y!==Pe.y||e.z!==Pe.z||e.yaw!==Pe.yaw||e.pitch!==Pe.pitch,r=performance.now();!n&&r-Fe<2e3||(Pe=e,Fe=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof Eh&&q_&&!S_&&(Zv(),setInterval(()=>void Zv(),3e4));let L={...t.stats};setInterval(()=>{let e=t.stats;I.net={msgsPerSec:e.msgsIn+e.msgsOut-(L.msgsIn+L.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(L.bytesIn+L.bytesOut),tickAvgMs:X_.tickAvgMs,tickMaxMs:X_.tickMaxMs,jitterMs:tv()},I.regras=Z_,I.stream={colunas:f.size,fila:E.filaPendente,faltando:m.size,repedidas:h,ultimoLote:E.ultimoLote},I.luz={colunas:u,totalMs:l,fila:s.length},L={...e}},1e3);let Ie=performance.now(),R=P.pos.x,Le=P.pos.y,Re=P.pos.z,ze=!1,Be=!1,Ve=0,He=!1,Ue=0,We=hf.eyeHeight,Ge=0;l_.setAnimationLoop(()=>{let e=performance.now(),t=e-Ie;Ie=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(T_.keys.forward)-+!!$.down(T_.keys.back):0,m=$.active?!!$.down(T_.keys.right)-+!!$.down(T_.keys.left):0,h=$.active&&$.down(T_.keys.jump),g=$.active&&$.down(T_.keys.forward);g&&!Be&&(e-Ve<300&&(ze=!0),Ve=e),g||(ze=!1),Be=g;let y=$.active&&$.down(T_.keys.agachar),x=o>0&&!y&&(ze||$.active&&$.down(T_.keys.correr));h&&!He&&(mv()&&e-Ue<300&&(fv=!fv),Ue=e),He=h;let S=fv&&mv(),C=!0;if(d){E.modoCarga=j_.ativo;{let e=j_.ativo?16:3,t=performance.now()+e,r=0;for(;s.length>0;){let e=s.shift(),o=e.cz*n.dims.x+e.cx;if(c.delete(o),f.has(o)){if(!i){let t=performance.now();wd(n,a,e.cx,e.cz),l+=performance.now()-t,u++}if(E.enfileirarColuna(e.cx,e.cz),++r>=1&&performance.now()>=t)break}}}E.processarFila(T_.meshMsPorFrame,(e,t)=>{f.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(P.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(P.pos.z/16)));if(C=f.has(r*n.dims.x+t),(p=(p+1)%60)==0){for(let e of f){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>T_.raioRender+2){f.delete(e),E.descartarColuna(i,o),ne.descartarColuna(i,o),od(a,i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}j(t,r,e);let i=T_.raioRender*16;M.cularPorDistancia(P.pos.x,P.pos.z,i),re.cularPorDistancia(P.pos.x,P.pos.z,i)}j_.ativo&&f.size>=fe&&s.length===0&&E.filaPendente===0&&j_.concluir()}if(Ne?.ativo){let t=Ne.amostra(e);P.pos.x=t.x,P.pos.y=t.y,P.pos.z=t.z,P.vel.x=P.vel.y=P.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Ne.terminou(e)&&(Ne.parar(),I.marcar(`bench: fim`))}let w=P.pos.y;C&&!Ne?.ativo&&jf(n,P,{forward:o,strafe:m,jump:h,yaw:$.yaw,sprint:x,sneak:y,fly:S},r);let T=P.pos.y-w;P.onGround&&!S&&T>.01&&T<=.56&&(Ge=Math.min(Ge+T,vf)),Ge*=Math.exp(-r*14),Ge<.002&&(Ge=0),_+=Math.hypot(P.pos.x-R,P.pos.y-Le,P.pos.z-Re),R=P.pos.x,Le=P.pos.y,Re=P.pos.z,P.pos.y<-16&&me();let A=1-Math.exp(-r*12);for(let e of he.values()){e.mesh.position.lerp(e.target,A);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*A}let ie=1-Math.exp(-r*20);We+=((y&&!S?hf.sneakEyeHeight:hf.eyeHeight)-We)*ie;let ae=T_.fov*(P.sprinting?1.1:1);if(Math.abs(d_.fov-ae)>.01&&(d_.fov+=(ae-d_.fov)*ie,d_.updateProjectionMatrix()),d_.position.set(P.pos.x,P.pos.y+We-Ge,P.pos.z),d_.rotation.set($.pitch,$.yaw,0),d_.getWorldDirection(ye),F=$.active?Nf(n,d_.position.x,d_.position.y,d_.position.z,ye.x,ye.y,ye.z,5,Ce[we]===900):null,ve.visible=F!==null,F){let[e,t,r,i,a,o]=Fd(q(n,F.x,F.y,F.z));ve.position.set(F.x+(e+i)/2,F.y+(t+a)/2,F.z+(r+o)/2),ve.scale.set(i-e+.004,a-t+.004,o-r+.004)}I.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),g_.update(r),v_.ventoTempo.value=g_.fase*Math.PI*2,v_.ventoDir.value.set(g_.x,g_.z),v_.ventoForca.value=T_.balanco?g_.forca:0,m_.update(r,g_),b.nivelCeu.value=m_.nivelCeu,D.update(n,d_.position.x,d_.position.y,d_.position.z);let oe=Math.floor(g_.fase*16)%16;O+=r;let se=Math.floor(O*8)%16;(oe!==ee||se!==k)&&O-te>=1/12&&(te=O,ee=oe,k=se,Yp(v,oe,g_.ondaAgua,se));let ce=performance.now();I.gpuInicio(),l_.render(u_,d_),I.gpuFim(),I.frame(t,performance.now()-ce)}),d||j_.concluir(),Qv.has(`hud`)&&I.toggle(),new URLSearchParams(location.search).has(`painel`)&&E_?.toggle(),new URLSearchParams(location.search).has(`inv`)&&D_?.toggle(),new URLSearchParams(location.search).has(`amigos`)&&k_?.toggle(),Qv.has(`touch`)&&V_()}