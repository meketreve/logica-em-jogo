...
`,zd=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Rd,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`⛶`,`tela cheia`,()=>Ld())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t){let n=this.makeButton(e,t);n.addEventListener(`pointerdown`,e=>{e.preventDefault(),n.setPointerCapture(e.pointerId),this.syncKey(this.actions.keys().jump,!0)});let r=()=>this.syncKey(this.actions.keys().jump,!1);return n.addEventListener(`pointerup`,r),n.addEventListener(`pointercancel`,r),n}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}};function Bd(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Ru(n)}var Vd=new ol({antialias:!0});Vd.setPixelRatio(Math.min(window.devicePixelRatio,2)),Vd.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Vd.domElement);var Hd=new hn;Hd.background=new G(8900331);var Ud=new xa(75,window.innerWidth/window.innerHeight,.1,512);Ud.rotation.order=`YXZ`;var Wd=new wa(16777215,2.2);Wd.position.set(60,100,40);var Gd=new Ta(16777215,.55);Hd.add(Wd,Gd);var Kd=new Yu(Wd,Gd,Hd),$=new td(Vd.domElement);function qd(){let e=od();return $.sensitivity=e.sensitivity,Ud.fov=e.fov,Ud.updateProjectionMatrix(),Vd.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Eu(e.volume),e}var Jd=qd();Au(Jd.volume);var Yd=null,Xd=null,Zd=null,Qd=document.getElementById(`overlay`),$d=document.getElementById(`overlay-main`),ef=document.getElementById(`overlay-config`),tf=document.getElementById(`crosshair`);function nf(){$d?.classList.remove(`hidden`),ef?.classList.add(`hidden`)}function rf(){let e=(Yd?.open??!1)||(Xd?.open??!1);Qd?.classList.toggle(`hidden`,$.active||df.open||e),tf?.classList.toggle(`hidden`,!$.active),$.locked&&nf(),Zd?.setShown($.touch&&!df.open&&!e)}document.addEventListener(`pointerlockchange`,rf);function af(){Id()?($.touch=!0,Ld(),rf()):$.lock()}function of(){let e=Jd.keys;Jd=qd();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],Jd.keys[t])}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>af()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Td(e,of,nf),$d?.classList.add(`hidden`),ef?.classList.remove(`hidden`)}),Qd?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Ou(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{Ud.aspect=window.innerWidth/window.innerHeight,Ud.updateProjectionMatrix(),Vd.setSize(window.innerWidth,window.innerHeight)});var sf=null,cf=`?`,lf=null;function uf(){return new URLSearchParams(location.search).get(`nome`)??bd()}var df=new Uu(e=>sf?.send(JSON.stringify({type:`chat`,text:e})),e=>{rf(),e||$.lock()});rf(),Vd.domElement.addEventListener(`pointerdown`,()=>{$.touch&&df.open&&df.close()});var ff={tickAvgMs:0,tickMaxMs:0},pf=!1,mf=null,hf=null,gf=null,_f=null,vf=null,yf=null,bf=`aluno`,xf=!1,Sf=!1;function Cf(){return bf===`professor`||xf}var wf=[],Tf=null,Ef=new Ad,Df=null,Of=null,kf=null,Af=[],jf=new Set,Mf=!1,Nf=null;function Pf(){Yd?.update({regions:wf,modo:Df?.modo??`sequencial`,objetivos:Df?.objetivos??[],grupos:Af,myGrupo:kf})}function Ff(e){return e.porGrupo&&bf!==`professor`?kf===null?!1:e.porGrupo.find(e=>e.grupo===kf)?.completo??!1:e.completo}function If(e){if(Df){for(let t of Df.objetivos)Ff(t)?jf.has(t.id)||(jf.add(t.id),e&&Mf&&xu({kind:`objective_complete`})):jf.delete(t.id);Mf=!0,Ef.update(Df.modo,Df.objetivos,{grupo:kf,professor:bf===`professor`,painelKey:cd(Jd.keys.painel)}),Of?.(Df.objetivos)}}function Lf(e){if(typeof e==`string`){let t=Zl(e);if(!t)return;t.type===`debug_stats`?ff={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs}:t.type===`block_changed`?mf?.(t):t.type===`blocks_filled`?hf?.(t):t.type===`player_moved`?gf?.(t):t.type===`player_left`?_f?.(t.id):t.type===`spawn`?(yf={x:t.x,y:t.y,z:t.z},bf=t.papel??`aluno`):t.type===`regions`?(wf=t.regions,Tf?.(t.regions),Pf()):t.type===`objectives`?(Df={modo:t.modo,objetivos:t.objetivos},If(!0),Pf()):t.type===`group`?(kf=t.grupo,jf.clear(),If(!1),Pf()):t.type===`groups`?(Af=t.grupos,Pf()):t.type===`teleport`?vf?.(t):t.type===`time`?Kd.sync(t.hora,t.ciclo):t.type===`voo`?(xf=t.liberado,Cf()||(Sf=!1),df.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(Ou(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),location.href=location.pathname):t.type===`join_denied`?(Ou(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),location.href=location.pathname):t.type===`chat`&&(df.addMessage(t.author,t.text),t.author===`servidor`&&Bd(t.text),xu({kind:`chat_message`}));return}if(pf){Nf?.(Ql(e));return}pf=!0,Wf(Ql(e))}function Rf(e,t){Jd=qd(),sf=e,e.onMessage(Lf),$.onKey(Jd.keys.chat,()=>{df.open||(document.exitPointerLock(),df.openInput())}),e.send(JSON.stringify({type:`join`,name:uf(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}}))}function zf(e,t){cf=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Rf(new Zu(e),t)}function Bf(e){lf={id:e.id,name:e.name,createdAt:e.createdAt},cf=`web-worker (${e.name})`;let t=new Xu(new Worker(new URL(`/assets/worker-xBR_vk89.js`,``+import.meta.url),{type:`module`})),n=crypto.getRandomValues(new Uint32Array(1))[0]??1;t.init({save:e.data??void 0,seed:n,preset:e.preset}),Rf(t)}async function Vf(){if(!(sf instanceof Xu)||!lf)return;let e=await sf.requestSave();await hd({...lf,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{Vf().finally(()=>location.reload())});var Hf=new URLSearchParams(location.search),Uf=Hf.get(`server`);if(Uf){let e=Hf.get(`codigo`);zf(Uf,{pin:Hf.get(`pin`)??``,...e?{codigo:e}:{}})}else wd({onPlayWorld:Bf,onPlayMulti:zf});function Wf(e){let t=sf;if(!t)return;let n=e.world,r=new Wi({map:vu(),alphaTest:.5});if(new URLSearchParams(location.search).has(`atlas`)){let e=r.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let i=new Wu(n,r,Hd);i.buildAll();let a=new Fd(Hd);a.setFromWorld(n);let s=new Pd(Hd);s.setRegions(wf),Tf=e=>{s.setRegions(e),s.clearCorners()};let c=new Pd(Hd,3066993),l=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=kf!==null&&r.grupo===kf;(bf===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});c.setRegions(t)};Of=l,Df&&l(Df.objetivos);let u=e=>t.send(JSON.stringify({type:`chat`,text:e})),d=e=>{e?document.exitPointerLock():$.lock(),rf()};Yd=bf===`professor`?new Md(u,d):new Nd(u,d),Pf(),$.onKey(Jd.keys.painel,()=>{if(!df.open){if(bf!==`professor`&&Af.length===0){df.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}Xd?.hide(),Yd?.toggle()}}),bf===`professor`&&df.addMessage(`jogo`,`tecla ${cd(Jd.keys.painel)} abre o painel de autoria`);let f=yf??{x:n.sizeX/2+.5,y:Sl(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},p=Fl(f.x,f.y,f.z);function m(){p.pos.x=f.x,p.pos.y=f.y,p.pos.z=f.z,p.vel.x=p.vel.y=p.vel.z=0}Nf=e=>{n=e.world,i.trocarMundo(n),a.setFromWorld(n),wf=[],s.setRegions([]),s.clearCorners(),Df=null,Of?.([]),Ef.update(`livre`,[],{grupo:null,professor:bf===`professor`,painelKey:cd(Jd.keys.painel)}),jf.clear(),Mf=!1,Af=[],kf=null,Pf(),f=yf??f,m(),df.addMessage(`jogo`,`a aula mudou — mundo novo carregado`)},vf=e=>{p.pos.x=e.x,p.pos.y=e.y,p.pos.z=e.z,p.vel.x=p.vel.y=p.vel.z=0,$.yaw=e.yaw,$.pitch=e.pitch},mf=e=>{xl(n,e.x,e.y,e.z,e.blockId),i.remeshBlock(e.x,e.y,e.z),a.onBlockChanged(e.x,e.y,e.z,e.blockId),xu(e.blockId===J.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},hf=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)xl(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};i.remeshBox(t,r),a.onRegionFilled(t,r,e.blockId),xu(e.blockId===J.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let h=new Map,g=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Ci(t);i.minFilter=o;let a=new kr(new hr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Ml.height/2+.35,0),a},_=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};gf=e=>{let t=h.get(e.id);if(!t){let n=new Zr(new Di(Ml.width,Ml.height,Ml.width),new Wi({color:new G().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Ml.height/2,e.z),n.rotation.y=e.yaw,Hd.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},h.set(e.id,t)}e.name&&e.name!==t.labelName&&(_(t),t.label=g(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Ml.height/2,e.z),t.targetYaw=e.yaw},_f=e=>{let t=h.get(e);t&&(_(t),Hd.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),h.delete(e))};let v=new xi(new Mi(new Di(1.002,1.002,1.002)),new li({color:0}));v.visible=!1,Hd.add(v);let y=null,b=new H,x=`lj-hotbar`,S=()=>Nu.slice(0,9).map(e=>e.id),C=(()=>{let e=new Set(Nu.map(e=>e.id)),t=S();try{let n=JSON.parse(localStorage.getItem(x)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),w=0,T=!1,E=document.getElementById(`hotbar`),D=ju(r.map?.image,Nu.map(e=>e.id)),ee=e=>Nu.find(t=>t.id===e)?.name??`?`,O=()=>{if(!E)return;if(T){E.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · /regiao criar nome · R volta`;return}let e=C.map((e,t)=>`<span class="slot${t===w?` sel`:``}"><small>${t+1}</small><img src="${D.get(e)??``}" alt=""></span>`).join(``);E.innerHTML=`<span class="bar-nome">${ee(C[w]??J.Grass)}</span><span class="slots">${e}</span>`,Xd?.refresh()};O(),$.onKey(Jd.keys.varinha,()=>{bf===`professor`&&(T=!T,O())});for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{w=e,O()});$.onWheel(e=>{w=(w+e+C.length)%C.length,O()}),Xd=new Pu(D,()=>({hotbar:C,selected:w}),e=>{C[w]=e,localStorage.setItem(x,JSON.stringify(C)),O()},e=>{w=e,O()},e=>{e?(Yd?.hide(),document.exitPointerLock()):$.lock(),rf()}),$.onKey(Jd.keys.inventario,()=>{df.open||Xd?.toggle()});let k=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),s.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(y){if(T){k(1,y);return}t.send(JSON.stringify({type:`break_block`,x:y.x,y:y.y,z:y.z}))}}),$.onMouseButton(2,()=>{if(!y)return;if(T){k(2,y);return}if(ll(bl(n,y.x,y.y,y.z))){t.send(JSON.stringify({type:`use_block`,x:y.x,y:y.y,z:y.z}));return}let e=C[w];e!==void 0&&((e===J.PortaXFechada||e===J.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?J.PortaXFechada:J.PortaZFechada),t.send(JSON.stringify({type:`place_block`,x:y.x+y.nx,y:y.y+y.ny,z:y.z+y.nz,blockId:e})))}),$.onMouseButton(1,()=>{if(!y||T)return;let e=bl(n,y.x,y.y,y.z);ll(e)&&(e=J.PortaXFechada),fl(e)&&(C[w]=e,localStorage.setItem(x,JSON.stringify(C)),O())}),Id()&&(E&&(E.style.pointerEvents=`auto`,E.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(w=n,O())})),Zd=new zd($,{keys:()=>Jd.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>Xd?.toggle(),chat:()=>{df.open||(document.exitPointerLock(),df.openInput())},menu:()=>{$.touch=!1,nf(),rf()}}),rf());let te=new ed(Vd,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:cf});te.setRemesh({count:i.remeshCount,totalMs:i.remeshMsTotal,lastMs:i.lastRemeshMs}),$.onKey(Jd.keys.hud,()=>te.toggle()),te.extra=()=>{let e=$.mouseStats,t=p.pos;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let A={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},j=0;setInterval(()=>{let e={x:p.pos.x,y:p.pos.y,z:p.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==A.x||e.y!==A.y||e.z!==A.z||e.yaw!==A.yaw||e.pitch!==A.pitch,r=performance.now();!n&&r-j<2e3||(A=e,j=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof Xu&&lf&&(Vf(),setInterval(()=>void Vf(),3e4));let ne={...t.stats};setInterval(()=>{let e=t.stats;te.net={msgsPerSec:e.msgsIn+e.msgsOut-(ne.msgsIn+ne.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(ne.bytesIn+ne.bytesOut),tickAvgMs:ff.tickAvgMs,tickMaxMs:ff.tickMaxMs},ne={...e}},1e3);let re=performance.now(),M=!1,ie=!1,ae=0,oe=!1,se=0,ce=Ml.eyeHeight;Vd.setAnimationLoop(()=>{let e=performance.now(),t=e-re;re=e;let r=Math.min(t/1e3,.05),a=$.active?!!$.down(Jd.keys.forward)-+!!$.down(Jd.keys.back):0,o=$.active?!!$.down(Jd.keys.right)-+!!$.down(Jd.keys.left):0,s=$.active&&$.down(Jd.keys.jump),c=$.active&&$.down(Jd.keys.forward);c&&!ie&&(e-ae<300&&(M=!0),ae=e),c||(M=!1),ie=c;let l=$.active&&$.down(Jd.keys.agachar),u=a>0&&!l&&(M||$.active&&$.down(Jd.keys.correr));s&&!oe&&(Cf()&&e-se<300&&(Sf=!Sf),se=e),oe=s;let d=Sf&&Cf();Bl(n,p,{forward:a,strafe:o,jump:s,yaw:$.yaw,sprint:u,sneak:l,fly:d},r),p.pos.y<-16&&m();let f=1-Math.exp(-r*12);for(let e of h.values()){e.mesh.position.lerp(e.target,f);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*f}let g=1-Math.exp(-r*20);ce+=((l&&!d?Ml.sneakEyeHeight:Ml.eyeHeight)-ce)*g;let _=Jd.fov*(p.sprinting?1.1:1);Math.abs(Ud.fov-_)>.01&&(Ud.fov+=(_-Ud.fov)*g,Ud.updateProjectionMatrix()),Ud.position.set(p.pos.x,p.pos.y+ce,p.pos.z),Ud.rotation.set($.pitch,$.yaw,0),Ud.getWorldDirection(b),y=$.active?Vl(n,Ud.position.x,Ud.position.y,Ud.position.z,b.x,b.y,b.z,5):null,v.visible=y!==null,y&&v.position.set(y.x+.5,y.y+.5,y.z+.5),te.setRemesh({count:i.remeshCount,totalMs:i.remeshMsTotal,lastMs:i.lastRemeshMs}),Kd.update(r),te.frame(t),Vd.render(Hd,Ud)}),new URLSearchParams(location.search).has(`painel`)&&Yd?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Xd?.toggle(),Hf.has(`touch`)&&af()}