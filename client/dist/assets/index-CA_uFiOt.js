...
`,kd=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Od,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`⛶`,`tela cheia`,()=>Dd())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t){let n=this.makeButton(e,t);n.addEventListener(`pointerdown`,e=>{e.preventDefault(),n.setPointerCapture(e.pointerId),this.syncKey(this.actions.keys().jump,!0)});let r=()=>this.syncKey(this.actions.keys().jump,!1);return n.addEventListener(`pointerup`,r),n.addEventListener(`pointercancel`,r),n}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}};function Ad(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&ku(n)}var jd=new al({antialias:!0});jd.setPixelRatio(Math.min(window.devicePixelRatio,2)),jd.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(jd.domElement);var Md=new mn;Md.background=new K(8900331);var Nd=new ba(75,window.innerWidth/window.innerHeight,.1,512);Nd.rotation.order=`YXZ`;var Pd=new Ca(16777215,2.2);Pd.position.set(60,100,40);var Fd=new wa(16777215,.55);Md.add(Pd,Fd);var Id=new Bu(Pd,Fd,Md),$=new Ku(jd.domElement);function Ld(){let e=Zu();return $.sensitivity=e.sensitivity,Nd.fov=e.fov,Nd.updateProjectionMatrix(),jd.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),_u(e.volume),e}var Rd=Ld();xu(Rd.volume);var zd=null,Bd=null,Vd=null,Hd=document.getElementById(`overlay`),Ud=document.getElementById(`overlay-main`),Wd=document.getElementById(`overlay-config`),Gd=document.getElementById(`crosshair`);function Kd(){Ud?.classList.remove(`hidden`),Wd?.classList.add(`hidden`)}function qd(){let e=(zd?.open??!1)||(Bd?.open??!1);Hd?.classList.toggle(`hidden`,$.active||ef.open||e),Gd?.classList.toggle(`hidden`,!$.active),$.locked&&Kd(),Vd?.setShown($.touch&&!ef.open&&!e)}document.addEventListener(`pointerlockchange`,qd);function Jd(){Ed()?($.touch=!0,Dd(),qd()):$.lock()}function Yd(){let e=Rd.keys;Rd=Ld();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],Rd.keys[t])}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Jd()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&gd(e,Yd,Kd),Ud?.classList.add(`hidden`),Wd?.classList.remove(`hidden`)}),Hd?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&yu(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{Nd.aspect=window.innerWidth/window.innerHeight,Nd.updateProjectionMatrix(),jd.setSize(window.innerWidth,window.innerHeight)});var Xd=null,Zd=`?`,Qd=null;function $d(){return new URLSearchParams(location.search).get(`nome`)??dd()}var ef=new Pu(e=>Xd?.send(JSON.stringify({type:`chat`,text:e})),e=>{qd(),e||$.lock()});qd(),jd.domElement.addEventListener(`pointerdown`,()=>{$.touch&&ef.open&&ef.close()});var tf={tickAvgMs:0,tickMaxMs:0},nf=!1,rf=null,af=null,of=null,sf=null,cf=null,lf=`aluno`,uf=[],df=null,ff=new xd,pf=null,mf=null,hf=null,gf=[],_f=new Set,vf=!1,yf=null;function bf(){zd?.update({regions:uf,modo:pf?.modo??`sequencial`,objetivos:pf?.objetivos??[],grupos:gf,myGrupo:hf})}function xf(e){return e.porGrupo&&lf!==`professor`?hf===null?!1:e.porGrupo.find(e=>e.grupo===hf)?.completo??!1:e.completo}function Sf(e){if(pf){for(let t of pf.objetivos)xf(t)?_f.has(t.id)||(_f.add(t.id),e&&vf&&fu({kind:`objective_complete`})):_f.delete(t.id);vf=!0,ff.update(pf.modo,pf.objetivos,{grupo:hf,professor:lf===`professor`,painelKey:$u(Rd.keys.painel)}),mf?.(pf.objetivos)}}function Cf(e){if(typeof e==`string`){let t=Gl(e);if(!t)return;t.type===`debug_stats`?tf={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs}:t.type===`block_changed`?rf?.(t):t.type===`player_moved`?af?.(t):t.type===`player_left`?of?.(t.id):t.type===`spawn`?(cf={x:t.x,y:t.y,z:t.z},lf=t.papel??`aluno`):t.type===`regions`?(uf=t.regions,df?.(t.regions),bf()):t.type===`objectives`?(pf={modo:t.modo,objetivos:t.objetivos},Sf(!0),bf()):t.type===`group`?(hf=t.grupo,_f.clear(),Sf(!1),bf()):t.type===`groups`?(gf=t.grupos,bf()):t.type===`teleport`?sf?.(t):t.type===`time`?Id.sync(t.hora,t.ciclo):t.type===`kicked`?(yu(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),location.href=location.pathname):t.type===`join_denied`?(yu(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),location.href=location.pathname):t.type===`chat`&&(ef.addMessage(t.author,t.text),t.author===`servidor`&&Ad(t.text),fu({kind:`chat_message`}));return}if(nf){yf?.(Kl(e));return}nf=!0,Af(Kl(e))}function wf(e,t){Rd=Ld(),Xd=e,e.onMessage(Cf),$.onKey(Rd.keys.chat,()=>{ef.open||(document.exitPointerLock(),ef.openInput())}),e.send(JSON.stringify({type:`join`,name:$d(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}}))}function Tf(e,t){Zd=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),wf(new Hu(e),t)}function Ef(e){Qd={id:e.id,name:e.name,createdAt:e.createdAt},Zd=`web-worker (${e.name})`;let t=new Vu(new Worker(new URL(`/assets/worker-Ncsc-QO1.js`,``+import.meta.url),{type:`module`})),n=crypto.getRandomValues(new Uint32Array(1))[0]??1;t.init({save:e.data??void 0,seed:n,preset:e.preset}),wf(t)}async function Df(){if(!(Xd instanceof Vu)||!Qd)return;let e=await Xd.requestSave();await od({...Qd,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{Df().finally(()=>location.reload())});var Of=new URLSearchParams(location.search),kf=Of.get(`server`);if(kf){let e=Of.get(`codigo`);Tf(kf,{pin:Of.get(`pin`)??``,...e?{codigo:e}:{}})}else hd({onPlayWorld:Ef,onPlayMulti:Tf});function Af(e){let t=Xd;if(!t)return;let n=e.world,r=new Ui({map:lu(),alphaTest:.5});if(new URLSearchParams(location.search).has(`atlas`)){let e=r.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let i=new Fu(n,r,Md);i.buildAll();let a=new Td(Md);a.setRegions(uf),df=e=>{a.setRegions(e),a.clearCorners()};let s=new Td(Md,3066993),c=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=hf!==null&&r.grupo===hf;(lf===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});s.setRegions(t)};mf=c,pf&&c(pf.objetivos);let l=e=>t.send(JSON.stringify({type:`chat`,text:e})),u=e=>{e?document.exitPointerLock():$.lock(),qd()};zd=lf===`professor`?new Cd(l,u):new wd(l,u),bf(),$.onKey(Rd.keys.painel,()=>{if(!ef.open){if(lf!==`professor`&&gf.length===0){ef.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}Bd?.hide(),zd?.toggle()}}),lf===`professor`&&ef.addMessage(`jogo`,`tecla ${$u(Rd.keys.painel)} abre o painel de autoria`);let d=cf??{x:n.sizeX/2+.5,y:vl(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},f=kl(d.x,d.y,d.z);function p(){f.pos.x=d.x,f.pos.y=d.y,f.pos.z=d.z,f.vel.x=f.vel.y=f.vel.z=0}yf=e=>{n=e.world,i.trocarMundo(n),uf=[],a.setRegions([]),a.clearCorners(),pf=null,mf?.([]),ff.update(`livre`,[],{grupo:null,professor:lf===`professor`,painelKey:$u(Rd.keys.painel)}),_f.clear(),vf=!1,gf=[],hf=null,bf(),d=cf??d,p(),ef.addMessage(`jogo`,`a aula mudou — mundo novo carregado`)},sf=e=>{f.pos.x=e.x,f.pos.y=e.y,f.pos.z=e.z,f.vel.x=f.vel.y=f.vel.z=0,$.yaw=e.yaw,$.pitch=e.pitch},rf=e=>{_l(n,e.x,e.y,e.z,e.blockId),i.remeshBlock(e.x,e.y,e.z),fu(e.blockId===Y.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let m=new Map,h=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Si(t);i.minFilter=o;let a=new Or(new mr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,El.height/2+.35,0),a},g=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};af=e=>{let t=m.get(e.id);if(!t){let n=new Xr(new Ei(El.width,El.height,El.width),new Ui({color:new K().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+El.height/2,e.z),n.rotation.y=e.yaw,Md.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},m.set(e.id,t)}e.name&&e.name!==t.labelName&&(g(t),t.label=h(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+El.height/2,e.z),t.targetYaw=e.yaw},of=e=>{let t=m.get(e);t&&(g(t),Md.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),m.delete(e))};let _=new bi(new ji(new Ei(1.002,1.002,1.002)),new ci({color:0}));_.visible=!1,Md.add(_);let v=null,y=new U,b=`lj-hotbar`,x=()=>wu.slice(0,9).map(e=>e.id),S=(()=>{let e=new Set(wu.map(e=>e.id)),t=x();try{let n=JSON.parse(localStorage.getItem(b)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),C=0,w=!1,T=document.getElementById(`hotbar`),E=Su(r.map?.image,wu.map(e=>e.id)),D=e=>wu.find(t=>t.id===e)?.name??`?`,O=()=>{if(!T)return;if(w){T.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · /regiao criar nome · R volta`;return}let e=S.map((e,t)=>`<span class="slot${t===C?` sel`:``}"><small>${t+1}</small><img src="${E.get(e)??``}" alt=""></span>`).join(``);T.innerHTML=`<span class="bar-nome">${D(S[C]??Y.Grass)}</span><span class="slots">${e}</span>`,Bd?.refresh()};O(),$.onKey(Rd.keys.varinha,()=>{lf===`professor`&&(w=!w,O())});for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{C=e,O()});$.onWheel(e=>{C=(C+e+S.length)%S.length,O()}),Bd=new Tu(E,()=>({hotbar:S,selected:C}),e=>{S[C]=e,localStorage.setItem(b,JSON.stringify(S)),O()},e=>{C=e,O()},e=>{e?(zd?.hide(),document.exitPointerLock()):$.lock(),qd()}),$.onKey(Rd.keys.inventario,()=>{ef.open||Bd?.toggle()});let k=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),a.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(v){if(w){k(1,v);return}t.send(JSON.stringify({type:`break_block`,x:v.x,y:v.y,z:v.z}))}}),$.onMouseButton(2,()=>{if(!v)return;if(w){k(2,v);return}let e=S[C];e!==void 0&&t.send(JSON.stringify({type:`place_block`,x:v.x+v.nx,y:v.y+v.ny,z:v.z+v.nz,blockId:e}))}),$.onMouseButton(1,()=>{if(!v||w)return;let e=gl(n,v.x,v.y,v.z);cl(e)&&(S[C]=e,localStorage.setItem(b,JSON.stringify(S)),O())}),Ed()&&(T&&(T.style.pointerEvents=`auto`,T.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(C=n,O())})),Vd=new kd($,{keys:()=>Rd.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>Bd?.toggle(),chat:()=>{ef.open||(document.exitPointerLock(),ef.openInput())},menu:()=>{$.touch=!1,Kd(),qd()}}),qd());let A=new Gu(jd,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Zd});A.setRemesh({count:i.remeshCount,totalMs:i.remeshMsTotal,lastMs:i.lastRemeshMs}),$.onKey(Rd.keys.hud,()=>A.toggle()),A.extra=()=>{let e=$.mouseStats,t=f.pos;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let ee={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},j=0;setInterval(()=>{let e={x:f.pos.x,y:f.pos.y,z:f.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==ee.x||e.y!==ee.y||e.z!==ee.z||e.yaw!==ee.yaw||e.pitch!==ee.pitch,r=performance.now();!n&&r-j<2e3||(ee=e,j=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof Vu&&Qd&&(Df(),setInterval(()=>void Df(),3e4));let M={...t.stats};setInterval(()=>{let e=t.stats;A.net={msgsPerSec:e.msgsIn+e.msgsOut-(M.msgsIn+M.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(M.bytesIn+M.bytesOut),tickAvgMs:tf.tickAvgMs,tickMaxMs:tf.tickMaxMs},M={...e}},1e3);let te=performance.now(),ne=!1,N=!1,re=0,ie=El.eyeHeight;jd.setAnimationLoop(()=>{let e=performance.now(),t=e-te;te=e;let r=Math.min(t/1e3,.05),a=$.active?!!$.down(Rd.keys.forward)-+!!$.down(Rd.keys.back):0,o=$.active?!!$.down(Rd.keys.right)-+!!$.down(Rd.keys.left):0,s=$.active&&$.down(Rd.keys.jump),c=$.active&&$.down(Rd.keys.forward);c&&!N&&(e-re<300&&(ne=!0),re=e),c||(ne=!1),N=c;let l=$.active&&$.down(Rd.keys.agachar),u=a>0&&!l&&(ne||$.active&&$.down(Rd.keys.correr));Pl(n,f,{forward:a,strafe:o,jump:s,yaw:$.yaw,sprint:u,sneak:l},r),f.pos.y<-16&&p();let d=1-Math.exp(-r*12);for(let e of m.values()){e.mesh.position.lerp(e.target,d);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*d}let h=1-Math.exp(-r*20);ie+=((l?El.sneakEyeHeight:El.eyeHeight)-ie)*h;let g=Rd.fov*(f.sprinting?1.1:1);Math.abs(Nd.fov-g)>.01&&(Nd.fov+=(g-Nd.fov)*h,Nd.updateProjectionMatrix()),Nd.position.set(f.pos.x,f.pos.y+ie,f.pos.z),Nd.rotation.set($.pitch,$.yaw,0),Nd.getWorldDirection(y),v=$.active?Fl(n,Nd.position.x,Nd.position.y,Nd.position.z,y.x,y.y,y.z,5):null,_.visible=v!==null,v&&_.position.set(v.x+.5,v.y+.5,v.z+.5),A.setRemesh({count:i.remeshCount,totalMs:i.remeshMsTotal,lastMs:i.lastRemeshMs}),Id.update(r),A.frame(t),jd.render(Md,Nd)}),new URLSearchParams(location.search).has(`painel`)&&zd?.toggle(),new URLSearchParams(location.search).has(`inv`)&&Bd?.toggle(),Of.has(`touch`)&&Jd()}