...
`,Wd=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Ud,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`⛶`,`tela cheia`,()=>Hd())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t){let n=this.makeButton(e,t);n.addEventListener(`pointerdown`,e=>{e.preventDefault(),n.setPointerCapture(e.pointerId),this.syncKey(this.actions.keys().jump,!0)});let r=()=>this.syncKey(this.actions.keys().jump,!1);return n.addEventListener(`pointerup`,r),n.addEventListener(`pointercancel`,r),n}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}};function Gd(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Uu(n)}var Kd=new ol({antialias:!0});Kd.setPixelRatio(Math.min(window.devicePixelRatio,2)),Kd.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Kd.domElement);var qd=new hn;qd.background=new G(8900331);var Jd=new xa(75,window.innerWidth/window.innerHeight,.1,512);Jd.rotation.order=`YXZ`;var Yd=new wa(16777215,2.2);Yd.position.set(60,100,40);var Xd=new Ta(16777215,.55);qd.add(Yd,Xd);var Zd=new ed(Yd,Xd,qd),$=new od(Kd.domElement);function Qd(){let e=dd();return $.sensitivity=e.sensitivity,Jd.fov=e.fov,Jd.updateProjectionMatrix(),Kd.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Au(e.volume),e}var $d=Qd();Pu($d.volume);var ef=null,tf=null,nf=null,rf=document.getElementById(`overlay`),af=document.getElementById(`overlay-main`),of=document.getElementById(`overlay-config`),sf=document.getElementById(`crosshair`);function cf(){af?.classList.remove(`hidden`),of?.classList.add(`hidden`)}function lf(){let e=(ef?.open??!1)||(tf?.open??!1);rf?.classList.toggle(`hidden`,$.active||gf.open||e),sf?.classList.toggle(`hidden`,!$.active),$.locked&&cf(),nf?.setShown($.touch&&!gf.open&&!e)}document.addEventListener(`pointerlockchange`,lf);function uf(){Vd()?($.touch=!0,Hd(),lf()):$.lock()}function df(){let e=$d.keys;$d=Qd();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],$d.keys[t])}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>uf()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Ad(e,df,cf),af?.classList.add(`hidden`),of?.classList.remove(`hidden`)}),rf?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Mu(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{Jd.aspect=window.innerWidth/window.innerHeight,Jd.updateProjectionMatrix(),Kd.setSize(window.innerWidth,window.innerHeight)});var ff=null,pf=`?`,mf=null;function hf(){return new URLSearchParams(location.search).get(`nome`)??Td()}var gf=new Ju(e=>ff?.send(JSON.stringify({type:`chat`,text:e})),e=>{lf(),e||$.lock()});lf(),Kd.domElement.addEventListener(`pointerdown`,()=>{$.touch&&gf.open&&gf.close()});var _f={tickAvgMs:0,tickMaxMs:0},vf=!1,yf=null,bf=null,xf=null,Sf=null,Cf=null,wf=null,Tf=`aluno`,Ef=!1,Df=!1;function Of(){return Tf===`professor`||Ef}var kf=[],Af=null,jf=!1,Mf=[],Nf=null,Pf=new Fd,Ff=null,If=null,Lf=null,Rf=[],zf=new Set,Bf=!1,Vf=null;function Hf(){ef?.update({regions:kf,modo:Ff?.modo??`sequencial`,objetivos:Ff?.objetivos??[],grupos:Rf,myGrupo:Lf})}function Uf(e){return e.porGrupo&&Tf!==`professor`?Lf===null?!1:e.porGrupo.find(e=>e.grupo===Lf)?.completo??!1:e.completo}function Wf(e){if(Ff){for(let t of Ff.objetivos)Uf(t)?zf.has(t.id)||(zf.add(t.id),e&&Bf&&Tu({kind:`objective_complete`})):zf.delete(t.id);Bf=!0,Pf.update(Ff.modo,Ff.objetivos,{grupo:Lf,professor:Tf===`professor`,painelKey:pd($d.keys.painel)}),If?.(Ff.objetivos)}}function Gf(e){if(typeof e==`string`){let t=tu(e);if(!t)return;t.type===`debug_stats`?_f={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs}:t.type===`block_changed`?yf?.(t):t.type===`blocks_filled`?bf?.(t):t.type===`player_moved`?xf?.(t):t.type===`player_left`?Sf?.(t.id):t.type===`spawn`?(wf={x:t.x,y:t.y,z:t.z},Tf=t.papel??`aluno`):t.type===`regions`?(kf=t.regions,Af?.(t.regions),Hf()):t.type===`objectives`?(Ff={modo:t.modo,objetivos:t.objetivos},Wf(!0),Hf()):t.type===`group`?(Lf=t.grupo,zf.clear(),Wf(!1),Hf()):t.type===`groups`?(Rf=t.grupos,Hf()):t.type===`claims`?(jf=t.ativo,Mf=t.claims,Nf?.(t.claims)):t.type===`friends`||(t.type===`teleport`?Cf?.(t):t.type===`time`?Zd.sync(t.hora,t.ciclo):t.type===`voo`?(Ef=t.liberado,Of()||(Df=!1),gf.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(Mu(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),location.href=location.pathname):t.type===`join_denied`?(Mu(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),location.href=location.pathname):t.type===`chat`&&(gf.addMessage(t.author,t.text),t.author===`servidor`&&Gd(t.text),Tu({kind:`chat_message`})));return}if(vf){Vf?.(nu(e));return}vf=!0,Qf(nu(e))}function Kf(e,t){$d=Qd(),ff=e,e.onMessage(Gf),$.onKey($d.keys.chat,()=>{gf.open||(document.exitPointerLock(),gf.openInput())}),e.send(JSON.stringify({type:`join`,name:hf(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}}))}function qf(e,t){pf=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Kf(new nd(e),t)}function Jf(e){mf={id:e.id,name:e.name,createdAt:e.createdAt},pf=`web-worker (${e.name})`;let t=new td(new Worker(new URL(`/assets/worker-BxMtbVzN.js`,``+import.meta.url),{type:`module`})),n=crypto.getRandomValues(new Uint32Array(1))[0]??1;t.init({save:e.data??void 0,seed:n,preset:e.preset}),Kf(t)}async function Yf(){if(!(ff instanceof td)||!mf)return;let e=await ff.requestSave();await bd({...mf,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{Yf().finally(()=>location.reload())});var Xf=new URLSearchParams(location.search),Zf=Xf.get(`server`);if(Zf){let e=Xf.get(`codigo`);qf(Zf,{pin:Xf.get(`pin`)??``,...e?{codigo:e}:{}})}else kd({onPlayWorld:Jf,onPlayMulti:qf});function Qf(e){let t=ff;if(!t)return;let n=e.world,r=new Wi({map:Su(),alphaTest:.5});if(new URLSearchParams(location.search).has(`atlas`)){let e=r.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let i=new Yu(n,r,qd);i.buildAll();let a=new Bd(qd);a.setFromWorld(n);let s=new zd(qd);s.setRegions(kf),Af=e=>{s.setRegions(e),s.clearCorners()};let c=new zd(qd,16747546),l=e=>{c.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};l(Mf),Nf=e=>{l(e),s.clearCorners(),!jf&&Tf!==`professor`&&ee&&(ee=!1),A()};let u=new zd(qd,3066993),d=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Lf!==null&&r.grupo===Lf;(Tf===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});u.setRegions(t)};If=d,Ff&&d(Ff.objetivos);let f=e=>t.send(JSON.stringify({type:`chat`,text:e})),p=e=>{e?document.exitPointerLock():$.lock(),lf()};ef=Tf===`professor`?new Ld(f,p):new Rd(f,p),Hf(),$.onKey($d.keys.painel,()=>{if(!gf.open){if(Tf!==`professor`&&Rf.length===0){gf.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}tf?.hide(),ef?.toggle()}}),Tf===`professor`&&gf.addMessage(`jogo`,`tecla ${pd($d.keys.painel)} abre o painel de autoria`);let m=wf??{x:n.sizeX/2+.5,y:kl(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},h=Hl(m.x,m.y,m.z);function g(){h.pos.x=m.x,h.pos.y=m.y,h.pos.z=m.z,h.vel.x=h.vel.y=h.vel.z=0}Vf=e=>{n=e.world,i.trocarMundo(n),a.setFromWorld(n),kf=[],s.setRegions([]),s.clearCorners(),Ff=null,If?.([]),Pf.update(`livre`,[],{grupo:null,professor:Tf===`professor`,painelKey:pd($d.keys.painel)}),zf.clear(),Bf=!1,Rf=[],Lf=null,Hf(),m=wf??m,g(),gf.addMessage(`jogo`,`a aula mudou — mundo novo carregado`)},Cf=e=>{h.pos.x=e.x,h.pos.y=e.y,h.pos.z=e.z,h.vel.x=h.vel.y=h.vel.z=0,$.yaw=e.yaw,$.pitch=e.pitch},yf=e=>{Ol(n,e.x,e.y,e.z,e.blockId),i.remeshBlock(e.x,e.y,e.z),a.onBlockChanged(e.x,e.y,e.z,e.blockId),Tu(e.blockId===J.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},bf=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)Ol(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};i.remeshBox(t,r),a.onRegionFilled(t,r,e.blockId),Tu(e.blockId===J.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let _=new Map,v=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Ci(t);i.minFilter=o;let a=new kr(new hr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,zl.height/2+.35,0),a},y=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};xf=e=>{let t=_.get(e.id);if(!t){let n=new Zr(new Di(zl.width,zl.height,zl.width),new Wi({color:new G().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+zl.height/2,e.z),n.rotation.y=e.yaw,qd.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},_.set(e.id,t)}e.name&&e.name!==t.labelName&&(y(t),t.label=v(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+zl.height/2,e.z),t.targetYaw=e.yaw},Sf=e=>{let t=_.get(e);t&&(y(t),qd.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),_.delete(e))};let b=new xi(new Mi(new Di(1.002,1.002,1.002)),new li({color:0}));b.visible=!1,qd.add(b);let x=null,S=new H,C=`lj-hotbar`,w=Ru(Tf),T=()=>w.slice(0,9).map(e=>e.id),E=(()=>{let e=new Set(w.map(e=>e.id)),t=T();try{let n=JSON.parse(localStorage.getItem(C)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),D=0,ee=!1,O=document.getElementById(`hotbar`),k=Fu(r.map?.image,Lu.map(e=>e.id)),te=e=>Lu.find(t=>t.id===e)?.name??`?`,A=()=>{if(!O)return;if(ee){O.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${Tf===`professor`?`/regiao criar nome`:`/claim criar`} · R volta`;return}let e=E.map((e,t)=>`<span class="slot${t===D?` sel`:``}"><small>${t+1}</small><img src="${k.get(e)??``}" alt=""></span>`).join(``);O.innerHTML=`<span class="bar-nome">${te(E[D]??J.Grass)}</span><span class="slots">${e}</span>`,tf?.refresh()};A(),$.onKey($d.keys.varinha,()=>{Tf!==`professor`&&!jf||(ee=!ee,A())});for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{D=e,A()});$.onWheel(e=>{D=(D+e+E.length)%E.length,A()}),tf=new zu(k,()=>w,()=>({hotbar:E,selected:D}),e=>{E[D]=e,localStorage.setItem(C,JSON.stringify(E)),A()},e=>{D=e,A()},e=>{e?(ef?.hide(),document.exitPointerLock()):$.lock(),lf()}),$.onKey($d.keys.inventario,()=>{gf.open||tf?.toggle()});let j=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),s.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(x){if(ee){j(1,x);return}t.send(JSON.stringify({type:`break_block`,x:x.x,y:x.y,z:x.z}))}}),$.onMouseButton(2,()=>{if(!x)return;if(ee){j(2,x);return}if(fl(Dl(n,x.x,x.y,x.z))){t.send(JSON.stringify({type:`use_block`,x:x.x,y:x.y,z:x.z}));return}let e=E[D];e!==void 0&&((e===J.PortaXFechada||e===J.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?J.PortaXFechada:J.PortaZFechada),t.send(JSON.stringify({type:`place_block`,x:x.x+x.nx,y:x.y+x.ny,z:x.z+x.nz,blockId:e})))}),$.onMouseButton(1,()=>{if(!x||ee)return;let e=Dl(n,x.x,x.y,x.z);fl(e)&&(e=J.PortaXFechada),hl(e)&&(gl(e)&&Tf!==`professor`||(E[D]=e,localStorage.setItem(C,JSON.stringify(E)),A()))}),Vd()&&(O&&(O.style.pointerEvents=`auto`,O.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(D=n,A())})),nf=new Wd($,{keys:()=>$d.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>tf?.toggle(),chat:()=>{gf.open||(document.exitPointerLock(),gf.openInput())},menu:()=>{$.touch=!1,cf(),lf()}}),lf());let ne=new ad(Kd,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:pf});ne.setRemesh({count:i.remeshCount,totalMs:i.remeshMsTotal,lastMs:i.lastRemeshMs}),$.onKey($d.keys.hud,()=>ne.toggle()),ne.extra=()=>{let e=$.mouseStats,t=h.pos;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let re={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},M=0;setInterval(()=>{let e={x:h.pos.x,y:h.pos.y,z:h.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==re.x||e.y!==re.y||e.z!==re.z||e.yaw!==re.yaw||e.pitch!==re.pitch,r=performance.now();!n&&r-M<2e3||(re=e,M=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof td&&mf&&(Yf(),setInterval(()=>void Yf(),3e4));let ie={...t.stats};setInterval(()=>{let e=t.stats;ne.net={msgsPerSec:e.msgsIn+e.msgsOut-(ie.msgsIn+ie.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(ie.bytesIn+ie.bytesOut),tickAvgMs:_f.tickAvgMs,tickMaxMs:_f.tickMaxMs},ie={...e}},1e3);let ae=performance.now(),oe=!1,se=!1,ce=0,le=!1,ue=0,N=zl.eyeHeight;Kd.setAnimationLoop(()=>{let e=performance.now(),t=e-ae;ae=e;let r=Math.min(t/1e3,.05),a=$.active?!!$.down($d.keys.forward)-+!!$.down($d.keys.back):0,o=$.active?!!$.down($d.keys.right)-+!!$.down($d.keys.left):0,s=$.active&&$.down($d.keys.jump),c=$.active&&$.down($d.keys.forward);c&&!se&&(e-ce<300&&(oe=!0),ce=e),c||(oe=!1),se=c;let l=$.active&&$.down($d.keys.agachar),u=a>0&&!l&&(oe||$.active&&$.down($d.keys.correr));s&&!le&&(Of()&&e-ue<300&&(Df=!Df),ue=e),le=s;let d=Df&&Of();ql(n,h,{forward:a,strafe:o,jump:s,yaw:$.yaw,sprint:u,sneak:l,fly:d},r),h.pos.y<-16&&g();let f=1-Math.exp(-r*12);for(let e of _.values()){e.mesh.position.lerp(e.target,f);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*f}let p=1-Math.exp(-r*20);N+=((l&&!d?zl.sneakEyeHeight:zl.eyeHeight)-N)*p;let m=$d.fov*(h.sprinting?1.1:1);Math.abs(Jd.fov-m)>.01&&(Jd.fov+=(m-Jd.fov)*p,Jd.updateProjectionMatrix()),Jd.position.set(h.pos.x,h.pos.y+N,h.pos.z),Jd.rotation.set($.pitch,$.yaw,0),Jd.getWorldDirection(S),x=$.active?Jl(n,Jd.position.x,Jd.position.y,Jd.position.z,S.x,S.y,S.z,5):null,b.visible=x!==null,x&&b.position.set(x.x+.5,x.y+.5,x.z+.5),ne.setRemesh({count:i.remeshCount,totalMs:i.remeshMsTotal,lastMs:i.lastRemeshMs}),Zd.update(r),ne.frame(t),Kd.render(qd,Jd)}),new URLSearchParams(location.search).has(`painel`)&&ef?.toggle(),new URLSearchParams(location.search).has(`inv`)&&tf?.toggle(),Xf.has(`touch`)&&uf()}