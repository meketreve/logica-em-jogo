...
}`)},e.needsUpdate=!0}function ng(){return{ventoTempo:{value:0},ventoDir:{value:new B(1,0)},ventoForca:{value:0}}}function rg(){return{nivelCeu:{value:1},luzMin:{value:.05}}}function ig(e,t){let n=e.onBeforeCompile;e.onBeforeCompile=(r,i)=>{n?.call(e,r,i),r.uniforms.nivelCeu=t.nivelCeu,r.uniforms.luzMin=t.luzMin,r.vertexShader=r.vertexShader.replace(`#include <common>`,`#include <common>
attribute float luz;
...
`;function xg(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function Sg(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function Cg(e){return`${(e/1e3).toFixed(1)} s`}var wg=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=bg,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(yg*.25).toFixed(1)} ${yg.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,yg.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(yg*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=Cg(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${Cg(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=xg(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=Sg(n.bytes)}e.forcar.classList.toggle(`hidden`,o<_g||this.fase===`pronto`)}},Tg={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`,amigos:`KeyG`}},Eg={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`,amigos:`painel de amigos (áreas compartilhadas)`},Dg=`lj-config`;function Og(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function kg(e,t){return typeof e==`boolean`?e:t}function Ag(){let e=null;try{e=JSON.parse(localStorage.getItem(Dg)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...Tg.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:Og(t.sensitivity,Tg.sensitivity,.2,3),fov:Og(t.fov,Tg.fov,60,100),pixelRatioCap:Og(t.pixelRatioCap,Tg.pixelRatioCap,1,2),volume:Og(t.volume,Tg.volume,0,1),raioRender:Og(t.raioRender,Tg.raioRender,2,12),meshMsPorFrame:Og(t.meshMsPorFrame,Tg.meshMsPorFrame,1,16),uiScale:Og(t.uiScale,Tg.uiScale,.6,1.8),nuvens:kg(t.nuvens,Tg.nuvens),balanco:kg(t.balanco,Tg.balanco),keys:r}}function jg(e){localStorage.setItem(Dg,JSON.stringify(e))}function Mg(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var Ng=`logica-em-jogo`,Pg=`worlds`;function Fg(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var Ig=null;function Lg(){return Ig??=new Promise((e,t)=>{let n=indexedDB.open(Ng,1);n.onupgradeneeded=()=>{n.result.createObjectStore(Pg,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),Ig}async function Rg(){return(await Fg((await Lg()).transaction(Pg).objectStore(Pg).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function zg(e){await Fg((await Lg()).transaction(Pg,`readwrite`).objectStore(Pg).put(e))}async function Bg(e){await Fg((await Lg()).transaction(Pg,`readwrite`).objectStore(Pg).delete(e))}function Vg(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function Hg(e){let t=await e.arrayBuffer();Rp(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function Ug(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function Wg(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var Gg=`
:root { --ts: 1; }
...
`;function f_(e){return`url("data:image/svg+xml,${encodeURIComponent(e)}")`}var p_=f_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#e23b3b" stroke="#5a0d0d" stroke-width="1.2"/></svg>`),m_=f_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#1a1a1a" stroke="#000" stroke-width="1.2"/></svg>`),h_=f_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#7fd4ff" stroke="#0a3550" stroke-width="1.2"/><circle cx="5.8" cy="5.8" r="1.6" fill="#fff" opacity="0.9"/></svg>`),g_=(e,t,n)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M12.8 12.8 8.6 8.6" stroke="${t}" stroke-width="3" stroke-linecap="round"/><circle cx="12.9" cy="12.9" r="2.1" fill="${t}" stroke="${n}" stroke-width="0.9"/><circle cx="6" cy="6" r="4.7" fill="${e}" stroke="${n}" stroke-width="1.1"/></svg>`,__=f_(g_(`#b2601f`,`#f3e7cf`,`#4d2a10`)),v_=f_(g_(`#1a1a1a`,`#1a1a1a`,`#000`));function y_(e,t,n){let r=document.createElement(`div`);r.className=`linha`;let i=[];for(let a=0;a<e;a++){let e=document.createElement(`div`);if(e.className=`casa`,n!==void 0){let t=document.createElement(`div`);t.className=`icone fundo`,t.style.backgroundImage=n,e.appendChild(t)}let a=document.createElement(`div`);a.className=`icone`,a.style.backgroundImage=t,e.appendChild(a),r.appendChild(e),i.push(e)}return{linha:r,casas:i}}function b_(e,t){for(let[n,r]of e.entries()){let e=r.lastElementChild;if(!e)continue;let i=t>=(n+1)*2,a=!i&&t===n*2+1;e.style.display=i||a?`block`:`none`,e.classList.toggle(`meio`,a)}}var x_=class{raiz;linhaVida;linhaFome;linhaAr;dano;morte;casasVida;casasFome;casasAr;morteTimer=null;danoTimer=null;ultimaVida=20;visivel=!1;constructor(){let e=document.createElement(`style`);e.textContent=d_,document.head.appendChild(e),this.raiz=document.createElement(`div`),this.raiz.id=`lj-vitals`;let t=y_(s_,p_,m_),n=y_(c_,__,v_),r=y_(l_,h_);this.linhaVida=t.linha,this.casasVida=t.casas,this.linhaFome=n.linha,this.casasFome=n.casas,this.linhaAr=r.linha,this.casasAr=r.casas,this.linhaAr.classList.add(`vazia`),this.linhaFome.classList.add(`vazia`);let i=document.createElement(`div`);i.className=`barras`,i.append(this.linhaVida,this.linhaFome),this.raiz.append(this.linhaAr,i),document.body.appendChild(this.raiz),this.dano=document.createElement(`div`),this.dano.id=`lj-dano`,this.morte=document.createElement(`div`),this.morte.id=`lj-morte`,document.body.append(this.dano,this.morte)}setVisivel(e){this.visivel=e,this.raiz.classList.toggle(`ativo`,e),e||this.esconderMorte()}aplicar(e){let t=Math.max(0,Math.min(20,Math.round(e.vida)));b_(this.casasVida,t),this.desenharFome(e.fome),this.desenharAr(e.folego),t<this.ultimaVida&&this.visivel&&this.piscarDano(),e.morreu&&this.visivel&&this.mostrarMorte(e.causa),this.ultimaVida=t}desenharFome(e){this.linhaFome.classList.toggle(`vazia`,e===void 0),e!==void 0&&b_(this.casasFome,Math.max(0,Math.min(20,Math.round(e))))}desenharAr(e){let t=e===void 0||e>=150;if(this.linhaAr.classList.toggle(`vazia`,t),t)return;let n=Math.max(0,Math.ceil(e/u_));for(let[e,t]of this.casasAr.entries()){let r=t.lastElementChild;r&&(r.style.display=e<n?`block`:`none`)}}piscarDano(){this.dano.classList.add(`piscar`),this.danoTimer!==null&&clearTimeout(this.danoTimer),this.danoTimer=setTimeout(()=>this.dano.classList.remove(`piscar`),90)}mostrarMorte(e){this.morte.textContent=e===`queda`?`Você caiu de muito alto`:e===`afogamento`?`Você ficou sem ar`:e===`fome`?`Você passou fome demais`:`Você não sobreviveu`,this.morte.classList.add(`ativo`),this.morteTimer!==null&&clearTimeout(this.morteTimer),this.morteTimer=setTimeout(()=>this.esconderMorte(),2600)}esconderMorte(){this.morte.classList.remove(`ativo`)}},S_=class{send;onToggle;root=document.getElementById(`amigos`);isOpen=!1;data={eu:``,equipe:null,convites:[],enviados:[],online:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Bm(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=this.btn(e,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)});return n}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}linha(e,...t){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);return r.className=`jog-nome`,r.textContent=e,n.append(r,...t),n}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`amigos`,t.append(n,this.btn(`✕ fechar`,()=>this.hide()));let r=document.createElement(`div`);r.className=`jog-lista`,this.renderConvites(r),this.renderGrupo(r),this.renderConvidar(r),r.append(this.hint(`pelo chat também dá: /amigos convidar nome · /amigos aceitar · /amigos recusar · /amigos sair · /amigos expulsar nome · /amigos lista`)),e.append(t,r)}renderConvites(e){if(this.data.convites.length!==0){e.append(this.sec(`✉ convites para você (${this.data.convites.length})`));for(let t of this.data.convites)e.append(this.linha(`${t} convidou você`,this.btn(`aceitar`,()=>this.send(`/amigos aceitar ${t}`)),this.btn(`recusar`,()=>this.send(`/amigos recusar ${t}`))));e.append(this.hint(`aceitar um convite descarta os outros — você fica em UM grupo só.`))}}renderGrupo(e){let{eu:t,equipe:n}=this.data;if(!n){e.append(this.sec(`👥 seu grupo`)),e.append(this.hint(`Você não está em nenhum grupo. Quem está no seu grupo pode construir na sua ÁREA PROTEGIDA (e você na dele). Cabem 6 pessoas, contando você.`));return}let r=n.dono===t;e.append(this.sec(`👥 grupo de ${n.dono} — ${n.membros.length}/6`));for(let i of n.membros){let a=[i===n.dono?`dono`:``,i===t?`você`:``].filter(e=>e),o=a.length?`${i} (${a.join(`, `)})`:i;e.append(r&&i!==t?this.linha(o,this.armedBtn(`expulsar`,()=>this.send(`/amigos expulsar ${i}`))):this.linha(o))}let i=document.createElement(`div`);i.className=`painel-row`,i.append(r?this.armedBtn(`sair e DESFAZER o grupo`,()=>this.send(`/amigos sair`)):this.armedBtn(`sair do grupo`,()=>this.send(`/amigos sair`))),e.append(i),r&&e.append(this.hint(`você é o dono: se sair, o grupo acaba para todo mundo.`))}renderConvidar(e){let{eu:t,equipe:n,enviados:r,online:i}=this.data;if(e.append(this.sec(`＋ convidar`)),n&&n.dono!==t){e.append(this.hint(`Só ${n.dono} convida para este grupo. Saia dele para montar o seu.`));return}if(n&&n.membros.length>=6){e.append(this.hint(`Grupo cheio (6/6).`));return}for(let t of r)e.append(this.linha(`${t} — convite enviado, aguardando`));let a=new Set(n?.membros??[]),o=i.filter(e=>e!==t&&!a.has(e)&&!r.includes(e));for(let t of o)e.append(this.linha(t,this.btn(`convidar`,()=>this.send(`/amigos convidar ${t}`))));o.length===0&&r.length===0&&e.append(this.hint(`ninguém mais está na aula agora.`))}},C_=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Bm(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},w_=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Bm(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},T_=class extends w_{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(sh[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=Mu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=Mu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...sh.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},E_=class extends w_{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},D_=class{fixedColor;group=new ln;cornerMarks=[];boxes=[];bounds=[];culling=null;constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new wi(new Ui(new Li(1.01,1.01,1.01)),new fi({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();if(this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new wi(new Ui(new Li(n+.04,r+.04,i+.04)),new fi({color:this.fixedColor??new U().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a}),this.bounds=e,this.culling){let{px:e,pz:t,raio:n}=this.culling;this.cularPorDistancia(e,t,n)}}cularPorDistancia(e,t,n){this.culling={px:e,pz:t,raio:n};for(let r=0;r<this.boxes.length;r++){let i=this.boxes[r],a=this.bounds[r];if(!i||!a)continue;let o=Math.max(a.min.x-e,0,e-(a.max.x+1)),s=Math.max(a.min.z-t,0,t-(a.max.z+1));i.visible=Math.max(o,s)<=n}}},O_=1/16,k_=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*O_-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*O_-.004,ry:Math.PI}];function A_(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var j_=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(op(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=op(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=K(t,e.x,e.y,e.z);if(!Gl(r))return;let i=k_[r-G.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,A_(a,e,null);let o=new Ni(a);o.colorSpace=Re;let s=new ei(new Wi(12*O_,12*O_),new Hr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{A_(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=op(e,t,n);if(this.conteudos.has(a))if(!Gl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Gl(K(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function M_(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var N_=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,M_(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},P_=null;function F_(e){e.preventDefault(),e.returnValue=``}var I_=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function L_(e){P_?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||I_.has(e.code))&&e.preventDefault())}function R_(e){P_?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function z_(e){P_||(P_=e,window.addEventListener(`beforeunload`,F_),window.addEventListener(`keydown`,L_,!0),window.addEventListener(`keyup`,R_,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function B_(){P_=null,window.removeEventListener(`beforeunload`,F_),window.removeEventListener(`keydown`,L_,!0),window.removeEventListener(`keyup`,R_,!0),navigator.keyboard?.unlock?.()}var V_=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Ni(t);i.minFilter=o,this.material=new vr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[Eu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===G.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===G.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===G.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Mr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function H_(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&_h(n)}var U_=new vl({antialias:!0});U_.setPixelRatio(Math.min(window.devicePixelRatio,2)),U_.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(U_.domElement);var W_=new vn;W_.background=new U(8900331);var G_=new Ma(75,window.innerWidth/window.innerHeight,.1,512);G_.rotation.order=`YXZ`;var K_=new Fa(16777215,2.2);K_.position.set(60,100,40);var q_=new Ia(16777215,.55);W_.add(K_,q_);var J_=new Zh(K_,q_,W_,G_),Y_=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();Y_!==null&&J_.sync(Y_,!1);var X_=new eg,Z_=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();Z_&&X_.sync(Z_.dir,Z_.forca,!0);var Q_=ng(),$=new gg(U_.domElement);$.touchDevice=Ug();var $_=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},ev=$_(`yaw`),tv=$_(`pitch`);ev!==null&&($.yaw=ev),tv!==null&&($.pitch=tv);var nv=Xm(new URLSearchParams(location.search));function rv(){let e=nv?{...Ag(),...Zm(nv)}:Ag();return $.sensitivity=e.sensitivity,G_.fov=e.fov,G_.updateProjectionMatrix(),U_.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Rm(e.volume),iv?.setScale(e.uiScale),J_.setNuvens(e.nuvens),e}var iv=null,av=rv();Hm(av.volume);var ov=null,sv=null,cv=null,lv=null,uv=null,dv={equipe:null,convites:[],enviados:[]},fv=new wg(()=>{xv(),hv?.setFase(`jogando`),hv?.marcar(`carga concluída`),pv?.()}),pv=null,mv=!1,hv=null,gv=document.getElementById(`overlay`),_v=document.getElementById(`overlay-main`),vv=document.getElementById(`overlay-config`),yv=document.getElementById(`crosshair`);function bv(){_v?.classList.remove(`hidden`),vv?.classList.add(`hidden`)}function xv(){let e=(ov?.open??!1)||(sv?.open??!1)||(cv?.open??!1)||(lv?.open??!1)||(uv?.open??!1);gv?.classList.toggle(`hidden`,mv||fv.ativo||$.active||jv.open||e),yv?.classList.toggle(`hidden`,!$.active),$.locked&&bv(),iv?.setShown($.touch&&!jv.open&&!e&&!fv.ativo)}document.addEventListener(`pointerlockchange`,xv);function Sv(){Ug()?($.touch=!0,Wg(),xv()):$.lock()}function Cv(){let e=av.keys;av=rv();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`,`amigos`])$.rebind(e[t],av.keys[t]);Tv()}var wv=-1;function Tv(){if(!Ev||av.raioRender===wv)return;let e=wv;wv=av.raioRender,Ev.send(JSON.stringify({type:`radius`,chunks:wv})),hv?.marcar(`raio`,`${e<0?`join`:e} → ${wv}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Sv()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&e_(e,Cv,bv),_v?.classList.add(`hidden`),vv?.classList.remove(`hidden`)}),document.getElementById(`overlay-telacheia`)?.addEventListener(`click`,()=>{Wg()}),document.getElementById(`overlay-hud`)?.addEventListener(`click`,()=>{hv?.toggle()}),gv?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Bm(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{G_.aspect=window.innerWidth/window.innerHeight,G_.updateProjectionMatrix(),U_.setSize(window.innerWidth,window.innerHeight)});var Ev=null,Dv=`?`,Ov=null;function kv(){return new URLSearchParams(location.search).get(`nome`)??Yg()}function Av(e){return e.trim().toLowerCase()!==`/amigos`||!lv?!1:(ov?.hide(),sv?.hide(),cv?.hide(),lv.toggle(),!0)}var jv=new wh(e=>{Av(e)||Ev?.send(JSON.stringify({type:`chat`,text:e}))},e=>{xv(),e||$.lock()});xv(),U_.domElement.addEventListener(`pointerdown`,()=>{$.touch&&jv.open&&jv.close()});var Mv={tickAvgMs:0,tickMaxMs:0},Nv=null,Pv=0,Fv=[];function Iv(){let e=performance.now();Pv>0&&(Fv.push(e-Pv),Fv.length>300&&Fv.shift()),Pv=e}function Lv(){let e=Fv.length;if(e<2)return 0;let t=Fv.reduce((e,t)=>e+t,0)/e,n=Fv.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var Rv=!1,zv=null,Bv=null,Vv=null,Hv=null,Uv=null,Wv=null,Gv=null,Kv=`aluno`,qv=!1,Jv=!1,Yv=`criativo`,Xv=!1;function Zv(){return df(Yv)&&(Kv===`professor`||qv)}var Qv=new o_,$v=null,ey=null;function ty(){return ey??=new x_,ey}var ny=null,ry=(()=>{let e=new URLSearchParams(location.search).get(`vida`);if(e===null)return null;let[t,n,r]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{vida:t,...Number.isFinite(n)?{folego:n}:{},...Number.isFinite(r)?{fome:r}:{}}})();ry&&(ty().setVisivel(!0),ty().aplicar(ry));{let e=new URLSearchParams(location.search).get(`mochila`);if(e!==null){let t=[];e.split(`,`).forEach((e,n)=>{let[r,i]=e.split(`x`).map(Number);r===void 0||!Number.isInteger(r)||r<=0||t.push({slot:n,id:r,qtd:Number.isInteger(i)&&i>0?i:1})}),Qv.travar(t)}}var iy=[],ay=null,oy=!1,sy=!1,cy=[],ly=null,uy=null,dy=null,fy=new a_,py=null,my=null,hy=null,gy=[],_y=new Set,vy=!1,yy=null,by=null,xy=!1,Sy=new Map;function Cy(){ov?.update({regions:iy,modo:py?.modo??`sequencial`,objetivos:py?.objetivos??[],grupos:gy,myGrupo:hy})}function wy(){lv?.update({eu:kv(),equipe:dv.equipe,convites:dv.convites,enviados:dv.enviados,online:[...new Set(Sy.values())].sort()})}function Ty(e){return e.porGrupo&&Kv!==`professor`?hy===null?!1:e.porGrupo.find(e=>e.grupo===hy)?.completo??!1:e.completo}function Ey(e){if(py){for(let t of py.objetivos)Ty(t)?_y.has(t.id)||(_y.add(t.id),e&&vy&&Nm({kind:`objective_complete`})):_y.delete(t.id);vy=!0,fy.update(py.modo,py.objetivos,{grupo:hy,professor:Kv===`professor`,painelKey:Mg(av.keys.painel)}),my?.(py.objetivos)}}var Dy=null;function Oy(){let e=Dy;if(e){Dy=null;for(let t of e)Ay(t)}}function ky(){Dy||(Dy=[],requestAnimationFrame(()=>requestAnimationFrame(Oy)),setTimeout(Oy,500))}function Ay(e){if(Dy){Dy.push(e);return}if(Iv(),Rv||fv.setFase(`mundo`),typeof e==`string`){let t=Dp(e);if(!t)return;if(t.type===`debug_stats`)Mv={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},Nv=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0};else if(t.type===`block_changed`)zv?.(t);else if(t.type===`blocks_filled`)Bv?.(t);else if(t.type===`player_moved`)t.name&&Sy.get(t.id)!==t.name&&(Sy.set(t.id,t.name),vh([...new Set(Sy.values())]),wy()),Vv?.(t);else if(t.type===`player_left`)Sy.delete(t.id),vh([...new Set(Sy.values())]),wy(),Hv?.(t.id);else if(t.type===`spawn`)Gv={x:t.x,y:t.y,z:t.z},Kv=t.papel??`aluno`;else if(t.type===`regions`)iy=t.regions,ay?.(t.regions),Cy();else if(t.type===`objectives`)py={modo:t.modo,objetivos:t.objetivos},Ey(!0),Cy();else if(t.type===`group`)hy=t.grupo,_y.clear(),Ey(!1),Cy();else if(t.type===`groups`)gy=t.grupos,Cy();else if(t.type===`quadros`)uy?.(t.lista);else if(t.type===`quadro_changed`)dy?.(t);else if(t.type===`container`)uv?.atualizar(t);else if(t.type===`container_fechado`)uv?.fecharSemAvisar();else if(t.type===`claims`)oy=t.ativo,t.ativo&&!sy&&(sy=!0,jv.addMessage(`jogo`,`tecla ${Mg(av.keys.amigos)} abre o painel de amigos — quem está no seu grupo constrói na sua área`)),cy=t.claims,ly?.(t.claims);else if(t.type===`friends`)dv={equipe:t.equipe,convites:t.convites,enviados:t.enviados},wy();else if(t.type===`players`)cv?.update({conectados:t.conectados,banidos:t.banidos});else if(t.type===`mundo_trocando`)Uv?.(t.nome),ky();else if(t.type===`teleport`)Wv?.(t);else if(t.type===`time`)Y_===null&&J_.sync(t.hora,t.ciclo);else if(t.type===`vento`)Z_===null&&X_.sync(t.dir,t.forca,t.ativo);else if(t.type===`voo`)qv=t.liberado,Zv()||(Jv=!1),jv.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`);else if(t.type===`modo`){let e=Yv!==t.efetivo;Yv=t.efetivo,Xv=t.pvp===!0,Zv()||(Jv=!1),ry===null&&(t.efetivo===`sobrevivencia`?ty().setVisivel(!0):ey?.setVisivel(!1)),t.efetivo===`criativo`&&Qv.ativa&&(Qv.desligar(),$v?.()),e&&jv.addMessage(`jogo`,t.efetivo===`sobrevivencia`?`modo sobrevivência — não dá para voar`:`modo criativo`)}else if(t.type===`inventario`)Qv.aplicar(t.slots),$v?.();else if(t.type===`vida`){if(ry!==null)return;ny=t,ty().aplicar(t),t.causa&&Nm({kind:`dano`}),t.morreu&&(Nm({kind:`morte`}),jv.addMessage(`jogo`,t.causa===`queda`?`você caiu de muito alto — voltou ao ponto de partida`:t.causa===`afogamento`?`você ficou sem ar — voltou ao ponto de partida`:t.causa===`fome`?`você passou fome demais — voltou ao ponto de partida`:t.causa===`pvp`?`você foi derrubado por outro jogador — voltou ao ponto de partida`:`você não sobreviveu — voltou ao ponto de partida`))}else t.type===`kicked`?(Bm(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),B_(),location.href=location.pathname):t.type===`join_denied`?(Bm(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),B_(),location.href=location.pathname):t.type===`chat`&&(jv.addMessage(t.author,t.text),t.author===`servidor`&&H_(t.text),Nm({kind:`chat_message`}));return}let t=jp(e);if(t===809716300){by?.(e);return}let n=()=>(xy=t===kp,xy?Mp(e):Op(e));if(Rv){yy?.(n());return}Rv=!0,Ly(n())}function jy(e,t){av=rv(),Ev=e,fv.abrir({host:Dv,rede:!(e instanceof ag)}),fv.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),xv(),e.onMessage(Ay),$.onKey(av.keys.chat,()=>{jv.open||(document.exitPointerLock(),jv.openInput())}),e.send(JSON.stringify({type:`join`,name:kv(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),wv=-1,Tv()}function My(e,t){Dv=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),jy(new og(e,t=>{Rv||!fv.ativo||fv.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function Ny(e,t){Ov={id:e.id,name:e.name,createdAt:e.createdAt},Dv=`web-worker (${e.name})`;let n=new ag(new Worker(new URL(`/assets/worker-6qrZZGQm.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho,sobrevivencia:e.sobrevivencia}),jy(n)}async function Py(){if(!(Ev instanceof ag)||!Ov)return;let e=await Ev.requestSave();await zg({...Ov,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{B_(),Py().finally(()=>location.reload())});var Fy=new URLSearchParams(location.search),Iy=Fy.get(`server`);if(Iy){let e=Fy.get(`codigo`);My(Iy,{pin:Fy.get(`pin`)??``,...e?{codigo:e}:{}})}else nv?Ny({id:`bench-${Um}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:td(Fy.get(`tamanho`)??`E`)},Um):$g({onPlayWorld:Ny,onPlayMulti:My});function Ly(e){let t=Ev;if(!t)return;z_(()=>$.active);let n=e.world,r=e.seed,i=new URLSearchParams(location.search).has(`semluz`),a=ud(n.dims),s=[],c=new Set,l=0,u=0,d=xy,f=new Set,p=0,m=new Map,h=0,g=0,_=0,v=Em(),y=new ta({map:v,alphaTest:.5});tg(y,Q_);let b=rg();ig(y,b);let x=new ta({map:v,transparent:!0,opacity:.72,depthWrite:!1}),S=new ta({map:v,transparent:!0,opacity:.4,depthWrite:!1});if(ig(x,b),ig(S,b),new URLSearchParams(location.search).has(`atlas`)){let e=y.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let C=new URLSearchParams(location.search),w=C.has(`semworker`),T=Number(C.get(`meshdepth`)),E=new jh(n,[y,x,S],W_,!w,Number.isFinite(T)&&T>0?T:void 0,i?void 0:a),D=new km(W_),ee=-1,O=0,te=-1,ne=-1,k=(e,t)=>{for(let n=0;n<e.dims.x;n++)for(let r=0;r<e.dims.z;r++)Md(e,t,n,r)};d||(i||k(n,a),E.buildAll()),by=e=>{let t=[];try{t=Pp(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;f.add(t),m.delete(t),c.has(t)||(c.add(t),s.push({cx:e,cz:r})),re.varrerColuna(n,e,r)}g+=t.length};let A=(e,r,i)=>{let o=n.dims,s=av.raioRender,c=0;for(let l=e-s;l<=e+s;l++)for(let e=r-s;e<=r+s;e++){if(l<0||e<0||l>=o.x||e>=o.z)continue;let r=e*o.x+l;if(f.has(r))continue;let s=m.get(r);if(!s){m.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||c>=4)){E.descartarColuna(l,e),re.descartarColuna(l,e),md(a,l,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+l]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:l,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),c++,h++}}for(let t of m.keys()){let n=t%o.x,i=(t-n)/o.x;(f.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&m.delete(t)}},re=new V_(W_);re.setFromWorld(n);let ie=new D_(W_);ie.setRegions(iy),ay=e=>{ie.setRegions(e),ie.clearCorners()};let j=new D_(W_,16747546),ae=e=>{j.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};ae(cy),ly=e=>{ae(e),ie.clearCorners(),!oy&&Kv!==`professor`&&De&&(De=!1,iv?.setVarinha(!1)),iv?.setVarinhaDisponivel(Kv===`professor`||oy),iv?.setAmigosDisponivel(oy),je()};let oe=new j_(W_),se=new N_;uy=e=>oe.setAll(e,n),dy=e=>oe.aplicar(e,n);let ce=new D_(W_,3066993),le=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=hy!==null&&r.grupo===hy;(Kv===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});ce.setRegions(t)};my=le,py&&le(py.objetivos);let ue=e=>t.send(JSON.stringify({type:`chat`,text:e})),de=e=>{e?document.exitPointerLock():$.lock(),xv()};Kv===`professor`&&(cv=new C_(ue,de)),lv=new S_(ue,de),wy(),ov=Kv===`professor`?new T_(ue,de,()=>{ov?.hide(),sv?.hide(),lv?.hide(),cv?.show()}):new E_(ue,de),Cy(),$.onKey(av.keys.painel,()=>{if(!jv.open){if(Kv!==`professor`&&gy.length===0){jv.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}sv?.hide(),cv?.hide(),lv?.hide(),ov?.toggle()}}),$.onKey(av.keys.amigos,()=>{jv.open||(ov?.hide(),sv?.hide(),cv?.hide(),lv?.toggle())}),Kv===`professor`&&jv.addMessage(`jogo`,`tecla ${Mg(av.keys.painel)} abre o painel de autoria`);let M=Gv??{x:n.sizeX/2+.5,y:Au(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},N=Wf(M.x,M.y,M.z),fe=()=>{if(!d)return 0;let e=av.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(N.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(N.pos.z/16))),i=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,a=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,i*a)},pe=fe(),me=()=>{fv.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:f.size,total:pe,faltando:m.size>0?m.size:Math.max(0,pe-f.size),fila:E.filaPendente}))};me(),fv.setFase(d?`mundo`:`malha`),Uv=e=>{pe=0,fv.abrir({host:Dv,rede:!(t instanceof ag),titulo:`trocando de aula`,alvo:e}),me(),fv.setFase(`preparando`),Pe.setFase(`carregando`),Pe.marcar(`troca de aula`,e),xv()};function he(){N.pos.x=M.x,N.pos.y=M.y,N.pos.z=M.z,N.vel.x=N.vel.y=N.vel.z=0}yy=e=>{n=e.world,r=e.seed,d=xy,f=new Set,m.clear(),a=ud(n.dims),s.length=0,c.clear(),!d&&!i&&k(n,a),E.trocarMundo(n,!d,i?void 0:a),re.setFromWorld(n),iy=[],ie.setRegions([]),ie.clearCorners(),oe.setAll([],n),py=null,my?.([]),fy.update(`livre`,[],{grupo:null,professor:Kv===`professor`,painelKey:Mg(av.keys.painel)}),_y.clear(),vy=!1,gy=[],hy=null,Cy(),M=Gv??M,he(),jv.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),wv=-1,Tv(),Pe.setMeta({worldChunks:n.dims,worldSeed:e.seed}),pe=fe(),fv.abrir({host:Dv,rede:!(t instanceof ag),titulo:`trocando de aula`}),me(),fv.setFase(d?`mundo`:`malha`),Pe.setFase(`carregando`),xv(),d||fv.concluir()},Wv=e=>{N.pos.x=e.x,N.pos.y=e.y,N.pos.z=e.z,N.vel.x=N.vel.y=N.vel.z=0,$.yaw=ev??e.yaw,$.pitch=tv??e.pitch},zv=e=>{ku(n,e.x,e.y,e.z,e.blockId),E.remeshBlock(e.x,e.y,e.z),i||E.remeshSujos(Nd(n,a,e.x,e.y,e.z)),re.onBlockChanged(e.x,e.y,e.z,e.blockId),oe.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Nm(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},Bv=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)ku(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(n.dims.x-1,e.x1/16|0);t++)for(let r=Math.max(0,e.z0/16|0);r<=Math.min(n.dims.z-1,e.z1/16|0);r++)i||E.remeshSujos(Md(n,a,t,r));E.remeshBox(t,r),re.onRegionFilled(t,r,e.blockId),oe.validarTodos(n),Nm(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let ge=new Map,_e=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Ni(t);i.minFilter=o;let a=new Mr(new vr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Z.height/2+.35,0),a},ve=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};Vv=e=>{let t=ge.get(e.id);if(!t){let n=new ei(new Li(Z.width,Z.height,Z.width),new ta({color:new U().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Z.height/2,e.z),n.rotation.y=e.yaw,W_.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},ge.set(e.id,t)}e.name&&e.name!==t.labelName&&(ve(t),t.label=_e(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Z.height/2,e.z),t.targetYaw=e.yaw},Hv=e=>{let t=ge.get(e);t&&(ve(t),W_.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),ge.delete(e))};let ye=new wi(new Ui(new Li(1,1,1)),new fi({color:0}));ye.visible=!1,W_.add(ye);let P=null,be=null,xe=new V,Se=`lj-hotbar`,Ce=ch(Kv),we=()=>Ce.slice(0,9).map(e=>e.id),Te=(()=>{let e=new Set(Ce.map(e=>e.id));e.add(900);let t=we();try{let n=JSON.parse(localStorage.getItem(Se)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),Ee=0,De=!1,Oe=document.getElementById(`hotbar`),ke=ih(y.map?.image,[...sh.map(e=>e.id),900,902,903,904,905,906,907,908,909,910,911]),Ae=e=>e===900?`balde vazio`:e===901?`balde de água`:e===902?`fruta`:e===903?`trigo`:e===904?`pão`:e===905?`carvão`:e===906?`diamante`:e===907?`graveto`:e===908?`carvão vegetal`:e===909?`lingote de ferro`:e===910?`lingote de ouro`:e===911?`algodão`:sh.find(t=>t.id===e)?.name??`?`,je=()=>{if(!Oe)return;if(De){Oe.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${Kv===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=Qv.ativa?Qv.hotbar():Te,t=e.map((e,t)=>{let n=t===Ee?` sel`:``;if(e==null)return`<span class="slot${n} vazio"><small>${t+1}</small></span>`;let r=Qv.ativa?Qv.qtdDoSlot(t):0,i=r>1?`<b class="qtd">${r}</b>`:``;return`<span class="slot${n}"><small>${t+1}</small><img src="${ke.get(e)??``}" alt="">${i}</span>`}).join(``),n=e[Ee];Oe.innerHTML=`<span class="bar-nome">${n==null?`mão vazia`:Ae(n)}</span><span class="slots">${t}</span>`,sv?.refresh(),uv?.refresh()},Me=()=>Qv.ativa?Qv.idDoSlot(Ee):Te[Ee]??null;$v=()=>je(),je();let Ne=()=>{Kv!==`professor`&&!oy||(De=!De,iv?.setVarinha(De),je())};$.onKey(av.keys.varinha,Ne);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{Ee=e,je()});$.onWheel(e=>{Ee=(Ee+e+Te.length)%Te.length,je()}),Oe?.addEventListener(`pointerdown`,e=>{let t=e.target?.closest?.(`.slot`);if(!t)return;let n=[...Oe.querySelectorAll(`.slot`)].indexOf(t);n<0||(e.preventDefault(),Ee=n,je())}),sv=new uh(ke,()=>Ce,()=>({hotbar:Te,selected:Ee}),e=>{Te[Ee]=e,localStorage.setItem(Se,JSON.stringify(Te)),je()},e=>{Ee=e,je()},e=>{e?(ov?.hide(),cv?.hide(),lv?.hide(),document.exitPointerLock()):$.lock(),xv()},Qv,(e,n)=>t.send(JSON.stringify({type:`mover_item`,de:e,para:n})),Ae,e=>t.send(JSON.stringify({type:`fabricar`,receita:e}))),$.onKey(av.keys.inventario,()=>{jv.open||sv?.toggle()}),uv=new lh(ke,Qv,Ae,(e,n,r,i,a)=>t.send(JSON.stringify({type:`mover_container`,x:e,y:n,z:r,de:i,para:a})),()=>t.send(JSON.stringify({type:`fechar_container`})),e=>{e?(ov?.hide(),cv?.hide(),lv?.hide(),sv?.hide(),document.exitPointerLock()):$.lock(),xv()});let F=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),ie.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(be&&!De){t.send(JSON.stringify({type:`atacar`,alvo:be.id}));return}if(P){if(De){F(1,P);return}Tl(Me()??-1)&&Yv!==`criativo`||t.send(JSON.stringify({type:`break_block`,x:P.x,y:P.y,z:P.z}))}}),$.onMouseButton(2,()=>{if(Qv.ativa&&Ru(Me()??-1)){t.send(JSON.stringify({type:`comer`,slot:Ee}));return}if(!P)return;if(De){F(2,P);return}{let e=Me();if(Tl(e??-1)){let r=Qv.ativa?{slot:Ee}:{};if(e===901)t.send(JSON.stringify({type:`balde`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,encher:!1,...r})),Qv.ativa||(Te[Ee]=900);else{if(K(n,P.x,P.y,P.z)!==G.Agua)return;t.send(JSON.stringify({type:`balde`,x:P.x,y:P.y,z:P.z,encher:!0,...r})),Qv.ativa||(Te[Ee]=901)}Qv.ativa||(localStorage.setItem(Se,JSON.stringify(Te)),je());return}}if(Gl(K(n,P.x,P.y,P.z))){let{x:e,y:n,z:r}=P;se.open(oe.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(Xu(K(n,P.x,P.y,P.z))!==null){t.send(JSON.stringify({type:`use_block`,x:P.x,y:P.y,z:P.z}));return}if(cu(K(n,P.x,P.y,P.z))){t.send(JSON.stringify({type:`use_block`,x:P.x,y:P.y,z:P.z}));return}let e=Me();if(e!==null){if((e===G.PortaXFechada||e===G.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?G.PortaXFechada:G.PortaZFechada),(e===G.JanelaXFechada||e===G.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?G.JanelaXFechada:G.JanelaZFechada),Kl(e)||ql(e)||Jl(e)||Gl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Kl(e)?G.CadeiraXP:ql(e)?G.SofaXP:Jl(e)?G.CamaXP:G.QuadroXP)+r}if(Fl(e)){let t=e-+!!Il(e);e=P.ny<0?t+1:t}if(Rl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Hl(Vl(e),r,P.ny<0)}t.send(JSON.stringify({type:`place_block`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!P||De||Qv.ativa)return;let e=K(n,P.x,P.y,P.z);eu(e)&&(e=G.PortaXFechada),iu(e)&&(e=G.JanelaXFechada),Kl(e)&&(e=G.CadeiraXP),ql(e)&&(e=G.SofaXP),Jl(e)&&(e=G.CamaXP),Gl(e)&&(e=G.QuadroXP),Fl(e)&&(e=G.LajePedraBaixo+Ll(e)*2),Rl(e)&&(e=G.EscadaPedraXP+Vl(e)*8),du(e)&&(fu(e)&&Kv!==`professor`||(Te[Ee]=e,localStorage.setItem(Se,JSON.stringify(Te)),je()))});let Pe=new hg(U_,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Dv});hv=Pe,Pe.contexto=()=>({x:N.pos.x,y:N.pos.y,z:N.pos.z,yaw:$.yaw,pitch:$.pitch,voando:Jv&&Zv(),noChao:N.onGround,raioRender:av.raioRender,meshMsPorFrame:av.meshMsPorFrame,pixelRatioCap:av.pixelRatioCap,fov:av.fov,nuvens:av.nuvens,balanco:av.balanco,distanciaTotal:_,colunasRecebidas:g,bytesRecebidos:t.stats.bytesIn}),Pe.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),Pe.carga=()=>fv.relatorio(),Pe.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Fe=null;if(nv){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);jv.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let t=nv.semVida?`bench-semvida`:`bench`;Pe.baixar(e,t),jv.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${t}-*.json)`)}};pv=()=>{if(Fe)return;Fe=Qm.paraMundo(nv,M,n.dims),Pe.setMeta({bench:Fe.meta()}),Pe.marcar(`bench: início`,`${nv.duracaoS}s · raio ${Fe.trajeto.raio}${nv.semVida?` · sem vida ambiental`:``}`),mv=!0,window.__benchRodando=!0,Jv=!0,xv(),Fe.iniciar(performance.now());let t=Fe.amostra(performance.now());N.pos.x=Re=t.x,N.pos.y=ze=t.y,N.pos.z=Be=t.z,Pe.record(t=>{mv=!1,window.__benchRodando=!1,xv(),window.__benchPerfil=t,e(t)},nv.duracaoS*1e3)}}$.onKey(av.keys.hud,()=>Pe.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{Pe.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),Ug()&&(Oe&&(Oe.style.pointerEvents=`auto`,Oe.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(Ee=n,je())})),iv=new qg($,{keys:()=>av.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>sv?.toggle(),chat:()=>{jv.open||(document.exitPointerLock(),jv.openInput())},menu:()=>{$.touch=!1,bv(),xv()},hud:()=>Pe.toggle(),varinha:()=>Ne(),amigos:()=>{ov?.hide(),sv?.hide(),cv?.hide(),lv?.toggle()}}),iv.setVarinhaDisponivel(Kv===`professor`||oy),iv.setAmigosDisponivel(oy),iv.setScale(av.uiScale),xv()),Pe.extra=()=>{let e=$.mouseStats,t=N.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=od(i,a,r),s=mu(o),c=hu(o),l=Math.min(ad(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&s.neve?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===G.GramaSeca?`grama seca`:c===G.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se o bioma neva · chapada ≥85]\nrelevo ${yu(o).toFixed(2)} (teto do bioma ${s.relevo})\nmodo ${Yv===`sobrevivencia`?`sobrevivência`:`criativo`}  voo ${Zv()?Jv?`voando`:`liberado`:`trancado`}`+(ny?`  vida ${ny.vida}/20`+(ny.fome===void 0?`  sem fome`:`  fome ${ny.fome}/20`):``)+`
mouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let Ie={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},I=0;setInterval(()=>{let e={x:N.pos.x,y:N.pos.y,z:N.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==Ie.x||e.y!==Ie.y||e.z!==Ie.z||e.yaw!==Ie.yaw||e.pitch!==Ie.pitch,r=performance.now();!n&&r-I<2e3||(Ie=e,I=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof ag&&Ov&&!nv&&(Py(),setInterval(()=>void Py(),3e4));let Le={...t.stats};setInterval(()=>{let e=t.stats;Pe.net={msgsPerSec:e.msgsIn+e.msgsOut-(Le.msgsIn+Le.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(Le.bytesIn+Le.bytesOut),tickAvgMs:Mv.tickAvgMs,tickMaxMs:Mv.tickMaxMs,jitterMs:Lv()},Pe.regras=Nv,Pe.stream={colunas:f.size,fila:E.filaPendente,faltando:m.size,repedidas:h,ultimoLote:E.ultimoLote},Pe.luz={colunas:u,totalMs:l,fila:s.length},Le={...e}},1e3);let L=performance.now(),Re=N.pos.x,ze=N.pos.y,Be=N.pos.z,Ve=!1,He=!1,Ue=0,We=!1,Ge=0,Ke=Z.eyeHeight,qe=0;U_.setAnimationLoop(()=>{let e=performance.now(),t=e-L;L=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(av.keys.forward)-+!!$.down(av.keys.back):0,m=$.active?!!$.down(av.keys.right)-+!!$.down(av.keys.left):0,h=$.active&&$.down(av.keys.jump),g=$.active&&$.down(av.keys.forward);g&&!He&&(e-Ue<300&&(Ve=!0),Ue=e),g||(Ve=!1),He=g;let y=$.active&&$.down(av.keys.agachar),x=o>0&&!y&&(Ve||$.active&&$.down(av.keys.correr));h&&!We&&(Zv()&&e-Ge<300&&(Jv=!Jv),Ge=e),We=h;let S=Jv&&Zv(),C=!0;if(d){E.modoCarga=fv.ativo;{let e=fv.ativo?16:3,t=performance.now()+e,r=0;for(;s.length>0;){let e=s.shift(),o=e.cz*n.dims.x+e.cx;if(c.delete(o),f.has(o)){if(!i){let t=performance.now();Md(n,a,e.cx,e.cz),l+=performance.now()-t,u++}if(E.enfileirarColuna(e.cx,e.cz),++r>=1&&performance.now()>=t)break}}}E.processarFila(av.meshMsPorFrame,(e,t)=>{f.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(N.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(N.pos.z/16)));if(C=f.has(r*n.dims.x+t),(p=(p+1)%60)==0){for(let e of f){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>av.raioRender+2){f.delete(e),E.descartarColuna(i,o),re.descartarColuna(i,o),md(a,i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}A(t,r,e);let i=av.raioRender*16;j.cularPorDistancia(N.pos.x,N.pos.z,i),ie.cularPorDistancia(N.pos.x,N.pos.z,i)}fv.ativo&&f.size>=pe&&s.length===0&&E.filaPendente===0&&fv.concluir()}if(Fe?.ativo){let t=Fe.amostra(e);N.pos.x=t.x,N.pos.y=t.y,N.pos.z=t.z,N.vel.x=N.vel.y=N.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Fe.terminou(e)&&(Fe.parar(),Pe.marcar(`bench: fim`))}let w=N.pos.y;C&&!Fe?.ativo&&tp(n,N,{forward:o,strafe:m,jump:h,yaw:$.yaw,sprint:x,sneak:y,fly:S},r);let T=N.pos.y-w;N.onGround&&!S&&T>.01&&T<=.56&&(qe=Math.min(qe+T,Hf)),qe*=Math.exp(-r*14),qe<.002&&(qe=0),_+=Math.hypot(N.pos.x-Re,N.pos.y-ze,N.pos.z-Be),Re=N.pos.x,ze=N.pos.y,Be=N.pos.z,N.pos.y<-16&&he();let k=1-Math.exp(-r*12);for(let e of ge.values()){e.mesh.position.lerp(e.target,k);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*k}let ae=1-Math.exp(-r*20);Ke+=((y&&!S?Z.sneakEyeHeight:Z.eyeHeight)-Ke)*ae;let oe=av.fov*(N.sprinting?1.1:1);if(Math.abs(G_.fov-oe)>.01&&(G_.fov+=(oe-G_.fov)*ae,G_.updateProjectionMatrix()),G_.position.set(N.pos.x,N.pos.y+Ke-qe,N.pos.z),G_.rotation.set($.pitch,$.yaw,0),G_.getWorldDirection(xe),P=$.active?ap(n,G_.position.x,G_.position.y,G_.position.z,xe.x,xe.y,xe.z,5,Te[Ee]===900):null,be=$.active&&Yv===`sobrevivencia`&&Xv?rp(G_.position.x,G_.position.y,G_.position.z,xe.x,xe.y,xe.z,[...ge].map(([e,t])=>({id:e,x:t.mesh.position.x,y:t.mesh.position.y-Z.height/2,z:t.mesh.position.z})),5):null,be&&P){let e=Math.hypot(P.x+.5-G_.position.x,P.y+.5-G_.position.y,P.z+.5-G_.position.z);be.dist>e&&(be=null)}if(yv?.classList.toggle(`alvo`,be!==null),ye.visible=P!==null&&be===null,P){let[e,t,r,i,a,o]=Wd(K(n,P.x,P.y,P.z));ye.position.set(P.x+(e+i)/2,P.y+(t+a)/2,P.z+(r+o)/2),ye.scale.set(i-e+.004,a-t+.004,o-r+.004)}Pe.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),X_.update(r),Q_.ventoTempo.value=X_.fase*Math.PI*2,Q_.ventoDir.value.set(X_.x,X_.z),Q_.ventoForca.value=av.balanco?X_.forca:0,J_.update(r,X_),b.nivelCeu.value=J_.nivelCeu,D.update(n,G_.position.x,G_.position.y,G_.position.z);let se=Math.floor(X_.fase*16)%16;O+=r;let ce=Math.floor(O*8)%16;(se!==ee||ce!==te)&&O-ne>=1/12&&(ne=O,ee=se,te=ce,Tm(v,se,X_.ondaAgua,ce));let le=performance.now();Pe.gpuInicio(),U_.render(W_,G_),Pe.gpuFim(),Pe.frame(t,performance.now()-le)}),d||fv.concluir(),Fy.has(`hud`)&&Pe.toggle(),new URLSearchParams(location.search).has(`painel`)&&ov?.toggle(),new URLSearchParams(location.search).has(`inv`)&&sv?.toggle(),new URLSearchParams(location.search).has(`amigos`)&&lv?.toggle(),Fy.has(`touch`)&&Sv()}