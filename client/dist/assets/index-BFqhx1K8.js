...
}`)},e.needsUpdate=!0}function Qh(){return{ventoTempo:{value:0},ventoDir:{value:new B(1,0)},ventoForca:{value:0}}}function $h(){return{nivelCeu:{value:1},luzMin:{value:.05}}}function eg(e,t){let n=e.onBeforeCompile;e.onBeforeCompile=(r,i)=>{n?.call(e,r,i),r.uniforms.nivelCeu=t.nivelCeu,r.uniforms.luzMin=t.luzMin,r.vertexShader=r.vertexShader.replace(`#include <common>`,`#include <common>
attribute float luz;
...
`;function _g(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function vg(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function yg(e){return`${(e/1e3).toFixed(1)} s`}var bg=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=gg,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(hg*.25).toFixed(1)} ${hg.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,hg.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(hg*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=yg(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${yg(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=_g(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=vg(n.bytes)}e.forcar.classList.toggle(`hidden`,o<pg||this.fase===`pronto`)}},xg={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`,amigos:`KeyG`}},Sg={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`,amigos:`painel de amigos (áreas compartilhadas)`},Cg=`lj-config`;function wg(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function Tg(e,t){return typeof e==`boolean`?e:t}function Eg(){let e=null;try{e=JSON.parse(localStorage.getItem(Cg)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...xg.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:wg(t.sensitivity,xg.sensitivity,.2,3),fov:wg(t.fov,xg.fov,60,100),pixelRatioCap:wg(t.pixelRatioCap,xg.pixelRatioCap,1,2),volume:wg(t.volume,xg.volume,0,1),raioRender:wg(t.raioRender,xg.raioRender,2,12),meshMsPorFrame:wg(t.meshMsPorFrame,xg.meshMsPorFrame,1,16),uiScale:wg(t.uiScale,xg.uiScale,.6,1.8),nuvens:Tg(t.nuvens,xg.nuvens),balanco:Tg(t.balanco,xg.balanco),keys:r}}function Dg(e){localStorage.setItem(Cg,JSON.stringify(e))}function Og(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var kg=`logica-em-jogo`,Ag=`worlds`;function jg(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var Mg=null;function Ng(){return Mg??=new Promise((e,t)=>{let n=indexedDB.open(kg,1);n.onupgradeneeded=()=>{n.result.createObjectStore(Ag,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),Mg}async function Pg(){return(await jg((await Ng()).transaction(Ag).objectStore(Ag).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function Fg(e){await jg((await Ng()).transaction(Ag,`readwrite`).objectStore(Ag).put(e))}async function Ig(e){await jg((await Ng()).transaction(Ag,`readwrite`).objectStore(Ag).delete(e))}function Lg(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function Rg(e){let t=await e.arrayBuffer();Fp(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function zg(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function Bg(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var Vg=`
:root { --ts: 1; }
...
`;function Hg(e,t,n){let r=e.querySelector(`span`),i=e.querySelector(`small`);r&&(r.textContent=t),i&&(i.textContent=n)}var Ug=class{input;actions;root;heldKeys=new Set;btnVarinha=null;btnAmigos=null;btnQuebrar=null;btnColocar=null;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Vg,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.btnQuebrar=this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.btnColocar=this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.btnVarinha=this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.btnAmigos=this.tapButton(`👥`,`amigos`,()=>this.actions.amigos())),this.btnVarinha.classList.add(`hidden`),this.btnAmigos.classList.add(`hidden`),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){document.documentElement.style.setProperty(`--ts`,String(e))}setVarinhaDisponivel(e){this.btnVarinha?.classList.toggle(`hidden`,!e)}setAmigosDisponivel(e){this.btnAmigos?.classList.toggle(`hidden`,!e)}setVarinha(e){this.btnVarinha?.classList.toggle(`ativo`,e),this.btnQuebrar&&Hg(this.btnQuebrar,e?`①`:`⛏`,e?`canto 1`:`quebrar`),this.btnColocar&&Hg(this.btnColocar,e?`②`:`▣`,e?`canto 2`:`colocar`)}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},Wg=`lj-nome`;function Gg(){let e=localStorage.getItem(Wg),t=e?ku(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(Wg,t),t}function Kg(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function qg(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function Jg(e){document.getElementById(e)?.classList.add(`hidden`)}function Yg(e){let t=Kg(`menu`),n={home:Kg(`menu-home`),worlds:Kg(`menu-worlds`),multi:Kg(`menu-multi`),config:Kg(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),Kg(`menu-version`).textContent=`v${Rp}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Im(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),qg(`menu-erro`,i));let a=Kg(`menu-nome`);a.value=Gg(),a.addEventListener(`change`,()=>{let e=ku(a.value);localStorage.setItem(Wg,e),a.value=e}),Kg(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),Kg(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),Kg(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=Kg(`menu-world-list`);async function c(){let e=[];try{e=await Pg()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>Lg(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){Ig(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=Kg(`menu-new-nome`),u=Kg(`menu-new-tipo`);Kg(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){qg(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}Jg(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:Qu(u.value),tamanho:$u(Kg(`menu-new-tamanho`).value),sobrevivencia:lf(Kg(`menu-new-jogo`).value)})});let d=Kg(`menu-import-file`);Kg(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&Rg(e).then(async e=>{await Fg(e),await c(),Jg(`menu-worlds-erro`)}).catch(e=>{qg(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=Kg(`menu-endereco`),p=Kg(`menu-pin`),m=Kg(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,Kg(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){qg(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){qg(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}Jg(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),Xg(Kg(`menu-config-body`),void 0,()=>r(`home`))}function Xg(e,t,n){$g(e,t,n)}function Zg(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var Qg=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function $g(e,t,n){e.textContent=``;for(let r of Qg){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>e_(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{Dg(structuredClone(xg)),t?.(),$g(e,t,n)}),e.appendChild(r),n&&Zg(e,n)}function e_(e,t,n,r){e.textContent=``;let i=Eg(),a=()=>{Dg(i),n?.()},o=document.createElement(`h2`);o.textContent=Qg.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),zg()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(Sg)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=Sg[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=Og(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=Og(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Pm(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>Im(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t);let r=(t,n,r)=>{let i=document.createElement(`label`);i.className=`config-row`,i.textContent=`${t} `;let o=document.createElement(`input`);o.type=`checkbox`,o.checked=n,o.addEventListener(`change`,()=>{r(o.checked),a()}),i.appendChild(o),e.appendChild(i)};r(`nuvens no céu`,i.nuvens,e=>i.nuvens=e),r(`balanço de folhas e grama`,i.balanco,e=>i.balanco=e),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`tempo de montagem de malha por frame`,1,16,1,i.meshMsPorFrame,e=>i.meshMsPorFrame=e,e=>`${e} ms`)}Zg(e,()=>$g(e,n,r))}var t_=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},n_=class{inv=Ru();ligada=!1;travada=!1;get ativa(){return this.ligada}aplicar(e){this.travada||(this.inv=Ku(e),this.ligada=!0)}travar(e){this.inv=Ku(e),this.ligada=!0,this.travada=!0}desligar(){this.travada||(this.ligada=!1,this.inv=Ru())}idDoSlot(e){return this.inv[e]?.id??null}qtdDoSlot(e){return this.inv[e]?.qtd??0}hotbar(){return Array.from({length:9},(e,t)=>this.idDoSlot(t))}estado(){return this.inv}contar(e){let t=0;for(let n of this.inv)n?.id===e&&(t+=n.qtd);return t}},r_=10,i_=10,a_=10,o_=150/a_,s_=`
#lj-vitals {
  position: fixed;
  left: 50%;
...
`;function c_(e){return`url("data:image/svg+xml,${encodeURIComponent(e)}")`}var l_=c_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#e23b3b" stroke="#5a0d0d" stroke-width="1.2"/></svg>`),u_=c_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#1a1a1a" stroke="#000" stroke-width="1.2"/></svg>`),d_=c_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#7fd4ff" stroke="#0a3550" stroke-width="1.2"/><circle cx="5.8" cy="5.8" r="1.6" fill="#fff" opacity="0.9"/></svg>`),f_=(e,t,n)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M12.8 12.8 8.6 8.6" stroke="${t}" stroke-width="3" stroke-linecap="round"/><circle cx="12.9" cy="12.9" r="2.1" fill="${t}" stroke="${n}" stroke-width="0.9"/><circle cx="6" cy="6" r="4.7" fill="${e}" stroke="${n}" stroke-width="1.1"/></svg>`,p_=c_(f_(`#b2601f`,`#f3e7cf`,`#4d2a10`)),m_=c_(f_(`#1a1a1a`,`#1a1a1a`,`#000`));function h_(e,t,n){let r=document.createElement(`div`);r.className=`linha`;let i=[];for(let a=0;a<e;a++){let e=document.createElement(`div`);if(e.className=`casa`,n!==void 0){let t=document.createElement(`div`);t.className=`icone fundo`,t.style.backgroundImage=n,e.appendChild(t)}let a=document.createElement(`div`);a.className=`icone`,a.style.backgroundImage=t,e.appendChild(a),r.appendChild(e),i.push(e)}return{linha:r,casas:i}}function g_(e,t){for(let[n,r]of e.entries()){let e=r.lastElementChild;if(!e)continue;let i=t>=(n+1)*2,a=!i&&t===n*2+1;e.style.display=i||a?`block`:`none`,e.classList.toggle(`meio`,a)}}var __=class{raiz;linhaVida;linhaFome;linhaAr;dano;morte;casasVida;casasFome;casasAr;morteTimer=null;danoTimer=null;ultimaVida=20;visivel=!1;constructor(){let e=document.createElement(`style`);e.textContent=s_,document.head.appendChild(e),this.raiz=document.createElement(`div`),this.raiz.id=`lj-vitals`;let t=h_(r_,l_,u_),n=h_(i_,p_,m_),r=h_(a_,d_);this.linhaVida=t.linha,this.casasVida=t.casas,this.linhaFome=n.linha,this.casasFome=n.casas,this.linhaAr=r.linha,this.casasAr=r.casas,this.linhaAr.classList.add(`vazia`),this.linhaFome.classList.add(`vazia`);let i=document.createElement(`div`);i.className=`barras`,i.append(this.linhaVida,this.linhaFome),this.raiz.append(this.linhaAr,i),document.body.appendChild(this.raiz),this.dano=document.createElement(`div`),this.dano.id=`lj-dano`,this.morte=document.createElement(`div`),this.morte.id=`lj-morte`,document.body.append(this.dano,this.morte)}setVisivel(e){this.visivel=e,this.raiz.classList.toggle(`ativo`,e),e||this.esconderMorte()}aplicar(e){let t=Math.max(0,Math.min(20,Math.round(e.vida)));g_(this.casasVida,t),this.desenharFome(e.fome),this.desenharAr(e.folego),t<this.ultimaVida&&this.visivel&&this.piscarDano(),e.morreu&&this.visivel&&this.mostrarMorte(e.causa),this.ultimaVida=t}desenharFome(e){this.linhaFome.classList.toggle(`vazia`,e===void 0),e!==void 0&&g_(this.casasFome,Math.max(0,Math.min(20,Math.round(e))))}desenharAr(e){let t=e===void 0||e>=150;if(this.linhaAr.classList.toggle(`vazia`,t),t)return;let n=Math.max(0,Math.ceil(e/o_));for(let[e,t]of this.casasAr.entries()){let r=t.lastElementChild;r&&(r.style.display=e<n?`block`:`none`)}}piscarDano(){this.dano.classList.add(`piscar`),this.danoTimer!==null&&clearTimeout(this.danoTimer),this.danoTimer=setTimeout(()=>this.dano.classList.remove(`piscar`),90)}mostrarMorte(e){this.morte.textContent=e===`queda`?`Você caiu de muito alto`:e===`afogamento`?`Você ficou sem ar`:e===`fome`?`Você passou fome demais`:`Você não sobreviveu`,this.morte.classList.add(`ativo`),this.morteTimer!==null&&clearTimeout(this.morteTimer),this.morteTimer=setTimeout(()=>this.esconderMorte(),2600)}esconderMorte(){this.morte.classList.remove(`ativo`)}},v_=class{send;onToggle;root=document.getElementById(`amigos`);isOpen=!1;data={eu:``,equipe:null,convites:[],enviados:[],online:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Im(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=this.btn(e,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)});return n}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}linha(e,...t){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);return r.className=`jog-nome`,r.textContent=e,n.append(r,...t),n}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`amigos`,t.append(n,this.btn(`✕ fechar`,()=>this.hide()));let r=document.createElement(`div`);r.className=`jog-lista`,this.renderConvites(r),this.renderGrupo(r),this.renderConvidar(r),r.append(this.hint(`pelo chat também dá: /amigos convidar nome · /amigos aceitar · /amigos recusar · /amigos sair · /amigos expulsar nome · /amigos lista`)),e.append(t,r)}renderConvites(e){if(this.data.convites.length!==0){e.append(this.sec(`✉ convites para você (${this.data.convites.length})`));for(let t of this.data.convites)e.append(this.linha(`${t} convidou você`,this.btn(`aceitar`,()=>this.send(`/amigos aceitar ${t}`)),this.btn(`recusar`,()=>this.send(`/amigos recusar ${t}`))));e.append(this.hint(`aceitar um convite descarta os outros — você fica em UM grupo só.`))}}renderGrupo(e){let{eu:t,equipe:n}=this.data;if(!n){e.append(this.sec(`👥 seu grupo`)),e.append(this.hint(`Você não está em nenhum grupo. Quem está no seu grupo pode construir na sua ÁREA PROTEGIDA (e você na dele). Cabem 6 pessoas, contando você.`));return}let r=n.dono===t;e.append(this.sec(`👥 grupo de ${n.dono} — ${n.membros.length}/6`));for(let i of n.membros){let a=[i===n.dono?`dono`:``,i===t?`você`:``].filter(e=>e),o=a.length?`${i} (${a.join(`, `)})`:i;e.append(r&&i!==t?this.linha(o,this.armedBtn(`expulsar`,()=>this.send(`/amigos expulsar ${i}`))):this.linha(o))}let i=document.createElement(`div`);i.className=`painel-row`,i.append(r?this.armedBtn(`sair e DESFAZER o grupo`,()=>this.send(`/amigos sair`)):this.armedBtn(`sair do grupo`,()=>this.send(`/amigos sair`))),e.append(i),r&&e.append(this.hint(`você é o dono: se sair, o grupo acaba para todo mundo.`))}renderConvidar(e){let{eu:t,equipe:n,enviados:r,online:i}=this.data;if(e.append(this.sec(`＋ convidar`)),n&&n.dono!==t){e.append(this.hint(`Só ${n.dono} convida para este grupo. Saia dele para montar o seu.`));return}if(n&&n.membros.length>=6){e.append(this.hint(`Grupo cheio (6/6).`));return}for(let t of r)e.append(this.linha(`${t} — convite enviado, aguardando`));let a=new Set(n?.membros??[]),o=i.filter(e=>e!==t&&!a.has(e)&&!r.includes(e));for(let t of o)e.append(this.linha(t,this.btn(`convidar`,()=>this.send(`/amigos convidar ${t}`))));o.length===0&&r.length===0&&e.append(this.hint(`ninguém mais está na aula agora.`))}},y_=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Im(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},b_=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Im(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},x_=class extends b_{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(rh[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=Au(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=Au(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...rh.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},S_=class extends b_{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},C_=class{fixedColor;group=new ln;cornerMarks=[];boxes=[];bounds=[];culling=null;constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new wi(new Ui(new Li(1.01,1.01,1.01)),new fi({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();if(this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new wi(new Ui(new Li(n+.04,r+.04,i+.04)),new fi({color:this.fixedColor??new U().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a}),this.bounds=e,this.culling){let{px:e,pz:t,raio:n}=this.culling;this.cularPorDistancia(e,t,n)}}cularPorDistancia(e,t,n){this.culling={px:e,pz:t,raio:n};for(let r=0;r<this.boxes.length;r++){let i=this.boxes[r],a=this.bounds[r];if(!i||!a)continue;let o=Math.max(a.min.x-e,0,e-(a.max.x+1)),s=Math.max(a.min.z-t,0,t-(a.max.z+1));i.visible=Math.max(o,s)<=n}}},w_=1/16,T_=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*w_-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*w_-.004,ry:Math.PI}];function E_(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var D_=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(rp(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=rp(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=K(t,e.x,e.y,e.z);if(!Ul(r))return;let i=T_[r-G.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,E_(a,e,null);let o=new Ni(a);o.colorSpace=Re;let s=new ei(new Wi(12*w_,12*w_),new Hr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{E_(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=rp(e,t,n);if(this.conteudos.has(a))if(!Ul(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Ul(K(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function O_(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var k_=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,O_(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},A_=null;function j_(e){e.preventDefault(),e.returnValue=``}var M_=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function N_(e){A_?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||M_.has(e.code))&&e.preventDefault())}function P_(e){A_?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function F_(e){A_||(A_=e,window.addEventListener(`beforeunload`,j_),window.addEventListener(`keydown`,N_,!0),window.addEventListener(`keyup`,P_,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function I_(){A_=null,window.removeEventListener(`beforeunload`,j_),window.removeEventListener(`keydown`,N_,!0),window.removeEventListener(`keyup`,P_,!0),navigator.keyboard?.unlock?.()}var L_=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Ni(t);i.minFilter=o,this.material=new vr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[wu(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===G.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===G.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===G.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Mr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function R_(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&ph(n)}var z_=new vl({antialias:!0});z_.setPixelRatio(Math.min(window.devicePixelRatio,2)),z_.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(z_.domElement);var B_=new vn;B_.background=new U(8900331);var V_=new Ma(75,window.innerWidth/window.innerHeight,.1,512);V_.rotation.order=`YXZ`;var H_=new Fa(16777215,2.2);H_.position.set(60,100,40);var U_=new Ia(16777215,.55);B_.add(H_,U_);var W_=new qh(H_,U_,B_,V_),G_=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();G_!==null&&W_.sync(G_,!1);var K_=new Xh,q_=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();q_&&K_.sync(q_.dir,q_.forca,!0);var J_=Qh(),$=new fg(z_.domElement);$.touchDevice=zg();var Y_=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},X_=Y_(`yaw`),Z_=Y_(`pitch`);X_!==null&&($.yaw=X_),Z_!==null&&($.pitch=Z_);var Q_=Km(new URLSearchParams(location.search));function $_(){let e=Q_?{...Eg(),...qm(Q_)}:Eg();return $.sensitivity=e.sensitivity,V_.fov=e.fov,V_.updateProjectionMatrix(),z_.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Pm(e.volume),ev?.setScale(e.uiScale),W_.setNuvens(e.nuvens),e}var ev=null,tv=$_();Rm(tv.volume);var nv=null,rv=null,iv=null,av=null,ov=null,sv={equipe:null,convites:[],enviados:[]},cv=new bg(()=>{_v(),dv?.setFase(`jogando`),dv?.marcar(`carga concluída`),lv?.()}),lv=null,uv=!1,dv=null,fv=document.getElementById(`overlay`),pv=document.getElementById(`overlay-main`),mv=document.getElementById(`overlay-config`),hv=document.getElementById(`crosshair`);function gv(){pv?.classList.remove(`hidden`),mv?.classList.add(`hidden`)}function _v(){let e=(nv?.open??!1)||(rv?.open??!1)||(iv?.open??!1)||(av?.open??!1)||(ov?.open??!1);fv?.classList.toggle(`hidden`,uv||cv.ativo||$.active||Dv.open||e),hv?.classList.toggle(`hidden`,!$.active),$.locked&&gv(),ev?.setShown($.touch&&!Dv.open&&!e&&!cv.ativo)}document.addEventListener(`pointerlockchange`,_v);function vv(){zg()?($.touch=!0,Bg(),_v()):$.lock()}function yv(){let e=tv.keys;tv=$_();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`,`amigos`])$.rebind(e[t],tv.keys[t]);xv()}var bv=-1;function xv(){if(!Sv||tv.raioRender===bv)return;let e=bv;bv=tv.raioRender,Sv.send(JSON.stringify({type:`radius`,chunks:bv})),dv?.marcar(`raio`,`${e<0?`join`:e} → ${bv}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>vv()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Xg(e,yv,gv),pv?.classList.add(`hidden`),mv?.classList.remove(`hidden`)}),document.getElementById(`overlay-telacheia`)?.addEventListener(`click`,()=>{Bg()}),document.getElementById(`overlay-hud`)?.addEventListener(`click`,()=>{dv?.toggle()}),fv?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Im(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{V_.aspect=window.innerWidth/window.innerHeight,V_.updateProjectionMatrix(),z_.setSize(window.innerWidth,window.innerHeight)});var Sv=null,Cv=`?`,wv=null;function Tv(){return new URLSearchParams(location.search).get(`nome`)??Gg()}function Ev(e){return e.trim().toLowerCase()!==`/amigos`||!av?!1:(nv?.hide(),rv?.hide(),iv?.hide(),av.toggle(),!0)}var Dv=new bh(e=>{Ev(e)||Sv?.send(JSON.stringify({type:`chat`,text:e}))},e=>{_v(),e||$.lock()});_v(),z_.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Dv.open&&Dv.close()});var Ov={tickAvgMs:0,tickMaxMs:0},kv=null,Av=0,jv=[];function Mv(){let e=performance.now();Av>0&&(jv.push(e-Av),jv.length>300&&jv.shift()),Av=e}function Nv(){let e=jv.length;if(e<2)return 0;let t=jv.reduce((e,t)=>e+t,0)/e,n=jv.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var Pv=!1,Fv=null,Iv=null,Lv=null,Rv=null,zv=null,Bv=null,Vv=null,Hv=`aluno`,Uv=!1,Wv=!1,Gv=`criativo`,Kv=!1;function qv(){return cf(Gv)&&(Hv===`professor`||Uv)}var Jv=new n_,Yv=null,Xv=null;function Zv(){return Xv??=new __,Xv}var Qv=null,$v=(()=>{let e=new URLSearchParams(location.search).get(`vida`);if(e===null)return null;let[t,n,r]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{vida:t,...Number.isFinite(n)?{folego:n}:{},...Number.isFinite(r)?{fome:r}:{}}})();$v&&(Zv().setVisivel(!0),Zv().aplicar($v));{let e=new URLSearchParams(location.search).get(`mochila`);if(e!==null){let t=[];e.split(`,`).forEach((e,n)=>{let[r,i]=e.split(`x`).map(Number);r===void 0||!Number.isInteger(r)||r<=0||t.push({slot:n,id:r,qtd:Number.isInteger(i)&&i>0?i:1})}),Jv.travar(t)}}var ey=[],ty=null,ny=!1,ry=!1,iy=[],ay=null,oy=null,sy=null,cy=new t_,ly=null,uy=null,dy=null,fy=[],py=new Set,my=!1,hy=null,gy=null,_y=!1,vy=new Map;function yy(){nv?.update({regions:ey,modo:ly?.modo??`sequencial`,objetivos:ly?.objetivos??[],grupos:fy,myGrupo:dy})}function by(){av?.update({eu:Tv(),equipe:sv.equipe,convites:sv.convites,enviados:sv.enviados,online:[...new Set(vy.values())].sort()})}function xy(e){return e.porGrupo&&Hv!==`professor`?dy===null?!1:e.porGrupo.find(e=>e.grupo===dy)?.completo??!1:e.completo}function Sy(e){if(ly){for(let t of ly.objetivos)xy(t)?py.has(t.id)||(py.add(t.id),e&&my&&km({kind:`objective_complete`})):py.delete(t.id);my=!0,cy.update(ly.modo,ly.objetivos,{grupo:dy,professor:Hv===`professor`,painelKey:Og(tv.keys.painel)}),uy?.(ly.objetivos)}}var Cy=null;function wy(){let e=Cy;if(e){Cy=null;for(let t of e)Ey(t)}}function Ty(){Cy||(Cy=[],requestAnimationFrame(()=>requestAnimationFrame(wy)),setTimeout(wy,500))}function Ey(e){if(Cy){Cy.push(e);return}if(Mv(),Pv||cv.setFase(`mundo`),typeof e==`string`){let t=wp(e);if(!t)return;if(t.type===`debug_stats`)Ov={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},kv=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0};else if(t.type===`block_changed`)Fv?.(t);else if(t.type===`blocks_filled`)Iv?.(t);else if(t.type===`player_moved`)t.name&&vy.get(t.id)!==t.name&&(vy.set(t.id,t.name),mh([...new Set(vy.values())]),by()),Lv?.(t);else if(t.type===`player_left`)vy.delete(t.id),mh([...new Set(vy.values())]),by(),Rv?.(t.id);else if(t.type===`spawn`)Vv={x:t.x,y:t.y,z:t.z},Hv=t.papel??`aluno`;else if(t.type===`regions`)ey=t.regions,ty?.(t.regions),yy();else if(t.type===`objectives`)ly={modo:t.modo,objetivos:t.objetivos},Sy(!0),yy();else if(t.type===`group`)dy=t.grupo,py.clear(),Sy(!1),yy();else if(t.type===`groups`)fy=t.grupos,yy();else if(t.type===`quadros`)oy?.(t.lista);else if(t.type===`quadro_changed`)sy?.(t);else if(t.type===`container`)ov?.atualizar(t);else if(t.type===`container_fechado`)ov?.fecharSemAvisar();else if(t.type===`claims`)ny=t.ativo,t.ativo&&!ry&&(ry=!0,Dv.addMessage(`jogo`,`tecla ${Og(tv.keys.amigos)} abre o painel de amigos — quem está no seu grupo constrói na sua área`)),iy=t.claims,ay?.(t.claims);else if(t.type===`friends`)sv={equipe:t.equipe,convites:t.convites,enviados:t.enviados},by();else if(t.type===`players`)iv?.update({conectados:t.conectados,banidos:t.banidos});else if(t.type===`mundo_trocando`)zv?.(t.nome),Ty();else if(t.type===`teleport`)Bv?.(t);else if(t.type===`time`)G_===null&&W_.sync(t.hora,t.ciclo);else if(t.type===`vento`)q_===null&&K_.sync(t.dir,t.forca,t.ativo);else if(t.type===`voo`)Uv=t.liberado,qv()||(Wv=!1),Dv.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`);else if(t.type===`modo`){let e=Gv!==t.efetivo;Gv=t.efetivo,Kv=t.pvp===!0,qv()||(Wv=!1),$v===null&&(t.efetivo===`sobrevivencia`?Zv().setVisivel(!0):Xv?.setVisivel(!1)),t.efetivo===`criativo`&&Jv.ativa&&(Jv.desligar(),Yv?.()),e&&Dv.addMessage(`jogo`,t.efetivo===`sobrevivencia`?`modo sobrevivência — não dá para voar`:`modo criativo`)}else if(t.type===`inventario`)Jv.aplicar(t.slots),Yv?.();else if(t.type===`vida`){if($v!==null)return;Qv=t,Zv().aplicar(t),t.causa&&km({kind:`dano`}),t.morreu&&(km({kind:`morte`}),Dv.addMessage(`jogo`,t.causa===`queda`?`você caiu de muito alto — voltou ao ponto de partida`:t.causa===`afogamento`?`você ficou sem ar — voltou ao ponto de partida`:t.causa===`fome`?`você passou fome demais — voltou ao ponto de partida`:t.causa===`pvp`?`você foi derrubado por outro jogador — voltou ao ponto de partida`:`você não sobreviveu — voltou ao ponto de partida`))}else t.type===`kicked`?(Im(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),I_(),location.href=location.pathname):t.type===`join_denied`?(Im(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),I_(),location.href=location.pathname):t.type===`chat`&&(Dv.addMessage(t.author,t.text),t.author===`servidor`&&R_(t.text),km({kind:`chat_message`}));return}let t=Op(e);if(t===809716300){gy?.(e);return}let n=()=>(_y=t===Ep,_y?kp(e):Tp(e));if(Pv){hy?.(n());return}Pv=!0,Ny(n())}function Dy(e,t){tv=$_(),Sv=e,cv.abrir({host:Cv,rede:!(e instanceof tg)}),cv.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),_v(),e.onMessage(Ey),$.onKey(tv.keys.chat,()=>{Dv.open||(document.exitPointerLock(),Dv.openInput())}),e.send(JSON.stringify({type:`join`,name:Tv(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),bv=-1,xv()}function Oy(e,t){Cv=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Dy(new ng(e,t=>{Pv||!cv.ativo||cv.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function ky(e,t){wv={id:e.id,name:e.name,createdAt:e.createdAt},Cv=`web-worker (${e.name})`;let n=new tg(new Worker(new URL(`/assets/worker-BW6ELTQV.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho,sobrevivencia:e.sobrevivencia}),Dy(n)}async function Ay(){if(!(Sv instanceof tg)||!wv)return;let e=await Sv.requestSave();await Fg({...wv,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{I_(),Ay().finally(()=>location.reload())});var jy=new URLSearchParams(location.search),My=jy.get(`server`);if(My){let e=jy.get(`codigo`);Oy(My,{pin:jy.get(`pin`)??``,...e?{codigo:e}:{}})}else Q_?ky({id:`bench-${zm}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:$u(jy.get(`tamanho`)??`E`)},zm):Yg({onPlayWorld:ky,onPlayMulti:Oy});function Ny(e){let t=Sv;if(!t)return;F_(()=>$.active);let n=e.world,r=e.seed,i=new URLSearchParams(location.search).has(`semluz`),a=cd(n.dims),s=[],c=new Set,l=0,u=0,d=_y,f=new Set,p=0,m=new Map,h=0,g=0,_=0,v=Sm(),y=new ta({map:v,alphaTest:.5});Zh(y,J_);let b=$h();eg(y,b);let x=new ta({map:v,transparent:!0,opacity:.72,depthWrite:!1}),S=new ta({map:v,transparent:!0,opacity:.4,depthWrite:!1});if(eg(x,b),eg(S,b),new URLSearchParams(location.search).has(`atlas`)){let e=y.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let C=new URLSearchParams(location.search),w=C.has(`semworker`),T=Number(C.get(`meshdepth`)),E=new Dh(n,[y,x,S],B_,!w,Number.isFinite(T)&&T>0?T:void 0,i?void 0:a),D=new Tm(B_),ee=-1,O=0,te=-1,ne=-1,k=(e,t)=>{for(let n=0;n<e.dims.x;n++)for(let r=0;r<e.dims.z;r++)Ad(e,t,n,r)};d||(i||k(n,a),E.buildAll()),gy=e=>{let t=[];try{t=jp(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;f.add(t),m.delete(t),c.has(t)||(c.add(t),s.push({cx:e,cz:r})),re.varrerColuna(n,e,r)}g+=t.length};let A=(e,r,i)=>{let o=n.dims,s=tv.raioRender,c=0;for(let l=e-s;l<=e+s;l++)for(let e=r-s;e<=r+s;e++){if(l<0||e<0||l>=o.x||e>=o.z)continue;let r=e*o.x+l;if(f.has(r))continue;let s=m.get(r);if(!s){m.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||c>=4)){E.descartarColuna(l,e),re.descartarColuna(l,e),fd(a,l,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+l]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:l,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),c++,h++}}for(let t of m.keys()){let n=t%o.x,i=(t-n)/o.x;(f.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&m.delete(t)}},re=new L_(B_);re.setFromWorld(n);let ie=new C_(B_);ie.setRegions(ey),ty=e=>{ie.setRegions(e),ie.clearCorners()};let j=new C_(B_,16747546),ae=e=>{j.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};ae(iy),ay=e=>{ae(e),ie.clearCorners(),!ny&&Hv!==`professor`&&De&&(De=!1,ev?.setVarinha(!1)),ev?.setVarinhaDisponivel(Hv===`professor`||ny),ev?.setAmigosDisponivel(ny),je()};let oe=new D_(B_),se=new k_;oy=e=>oe.setAll(e,n),sy=e=>oe.aplicar(e,n);let ce=new C_(B_,3066993),le=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=dy!==null&&r.grupo===dy;(Hv===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});ce.setRegions(t)};uy=le,ly&&le(ly.objetivos);let ue=e=>t.send(JSON.stringify({type:`chat`,text:e})),de=e=>{e?document.exitPointerLock():$.lock(),_v()};Hv===`professor`&&(iv=new y_(ue,de)),av=new v_(ue,de),by(),nv=Hv===`professor`?new x_(ue,de,()=>{nv?.hide(),rv?.hide(),av?.hide(),iv?.show()}):new S_(ue,de),yy(),$.onKey(tv.keys.painel,()=>{if(!Dv.open){if(Hv!==`professor`&&fy.length===0){Dv.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}rv?.hide(),iv?.hide(),av?.hide(),nv?.toggle()}}),$.onKey(tv.keys.amigos,()=>{Dv.open||(nv?.hide(),rv?.hide(),iv?.hide(),av?.toggle())}),Hv===`professor`&&Dv.addMessage(`jogo`,`tecla ${Og(tv.keys.painel)} abre o painel de autoria`);let M=Vv??{x:n.sizeX/2+.5,y:Ou(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},N=Vf(M.x,M.y,M.z),fe=()=>{if(!d)return 0;let e=tv.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(N.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(N.pos.z/16))),i=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,a=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,i*a)},pe=fe(),me=()=>{cv.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:f.size,total:pe,faltando:m.size>0?m.size:Math.max(0,pe-f.size),fila:E.filaPendente}))};me(),cv.setFase(d?`mundo`:`malha`),zv=e=>{pe=0,cv.abrir({host:Cv,rede:!(t instanceof tg),titulo:`trocando de aula`,alvo:e}),me(),cv.setFase(`preparando`),Pe.setFase(`carregando`),Pe.marcar(`troca de aula`,e),_v()};function he(){N.pos.x=M.x,N.pos.y=M.y,N.pos.z=M.z,N.vel.x=N.vel.y=N.vel.z=0}hy=e=>{n=e.world,r=e.seed,d=_y,f=new Set,m.clear(),a=cd(n.dims),s.length=0,c.clear(),!d&&!i&&k(n,a),E.trocarMundo(n,!d,i?void 0:a),re.setFromWorld(n),ey=[],ie.setRegions([]),ie.clearCorners(),oe.setAll([],n),ly=null,uy?.([]),cy.update(`livre`,[],{grupo:null,professor:Hv===`professor`,painelKey:Og(tv.keys.painel)}),py.clear(),my=!1,fy=[],dy=null,yy(),M=Vv??M,he(),Dv.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),bv=-1,xv(),Pe.setMeta({worldChunks:n.dims,worldSeed:e.seed}),pe=fe(),cv.abrir({host:Cv,rede:!(t instanceof tg),titulo:`trocando de aula`}),me(),cv.setFase(d?`mundo`:`malha`),Pe.setFase(`carregando`),_v(),d||cv.concluir()},Bv=e=>{N.pos.x=e.x,N.pos.y=e.y,N.pos.z=e.z,N.vel.x=N.vel.y=N.vel.z=0,$.yaw=X_??e.yaw,$.pitch=Z_??e.pitch},Fv=e=>{Du(n,e.x,e.y,e.z,e.blockId),E.remeshBlock(e.x,e.y,e.z),i||E.remeshSujos(jd(n,a,e.x,e.y,e.z)),re.onBlockChanged(e.x,e.y,e.z,e.blockId),oe.onBlockChanged(e.x,e.y,e.z,e.blockId,n),km(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},Iv=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)Du(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(n.dims.x-1,e.x1/16|0);t++)for(let r=Math.max(0,e.z0/16|0);r<=Math.min(n.dims.z-1,e.z1/16|0);r++)i||E.remeshSujos(Ad(n,a,t,r));E.remeshBox(t,r),re.onRegionFilled(t,r,e.blockId),oe.validarTodos(n),km(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let ge=new Map,_e=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Ni(t);i.minFilter=o;let a=new Mr(new vr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Z.height/2+.35,0),a},ve=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};Lv=e=>{let t=ge.get(e.id);if(!t){let n=new ei(new Li(Z.width,Z.height,Z.width),new ta({color:new U().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Z.height/2,e.z),n.rotation.y=e.yaw,B_.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},ge.set(e.id,t)}e.name&&e.name!==t.labelName&&(ve(t),t.label=_e(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Z.height/2,e.z),t.targetYaw=e.yaw},Rv=e=>{let t=ge.get(e);t&&(ve(t),B_.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),ge.delete(e))};let ye=new wi(new Ui(new Li(1,1,1)),new fi({color:0}));ye.visible=!1,B_.add(ye);let P=null,be=null,xe=new V,Se=`lj-hotbar`,Ce=ih(Hv),we=()=>Ce.slice(0,9).map(e=>e.id),Te=(()=>{let e=new Set(Ce.map(e=>e.id));e.add(900);let t=we();try{let n=JSON.parse(localStorage.getItem(Se)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),Ee=0,De=!1,Oe=document.getElementById(`hotbar`),ke=eh(y.map?.image,[...rh.map(e=>e.id),900,902,903,904,905,906,907]),Ae=e=>e===900?`balde vazio`:e===901?`balde de água`:e===902?`fruta`:e===903?`trigo`:e===904?`pão`:e===905?`carvão`:e===906?`diamante`:e===907?`graveto`:rh.find(t=>t.id===e)?.name??`?`,je=()=>{if(!Oe)return;if(De){Oe.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${Hv===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=Jv.ativa?Jv.hotbar():Te,t=e.map((e,t)=>{let n=t===Ee?` sel`:``;if(e==null)return`<span class="slot${n} vazio"><small>${t+1}</small></span>`;let r=Jv.ativa?Jv.qtdDoSlot(t):0,i=r>1?`<b class="qtd">${r}</b>`:``;return`<span class="slot${n}"><small>${t+1}</small><img src="${ke.get(e)??``}" alt="">${i}</span>`}).join(``),n=e[Ee];Oe.innerHTML=`<span class="bar-nome">${n==null?`mão vazia`:Ae(n)}</span><span class="slots">${t}</span>`,rv?.refresh(),ov?.refresh()},Me=()=>Jv.ativa?Jv.idDoSlot(Ee):Te[Ee]??null;Yv=()=>je(),je();let Ne=()=>{Hv!==`professor`&&!ny||(De=!De,ev?.setVarinha(De),je())};$.onKey(tv.keys.varinha,Ne);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{Ee=e,je()});$.onWheel(e=>{Ee=(Ee+e+Te.length)%Te.length,je()}),Oe?.addEventListener(`pointerdown`,e=>{let t=e.target?.closest?.(`.slot`);if(!t)return;let n=[...Oe.querySelectorAll(`.slot`)].indexOf(t);n<0||(e.preventDefault(),Ee=n,je())}),rv=new oh(ke,()=>Ce,()=>({hotbar:Te,selected:Ee}),e=>{Te[Ee]=e,localStorage.setItem(Se,JSON.stringify(Te)),je()},e=>{Ee=e,je()},e=>{e?(nv?.hide(),iv?.hide(),av?.hide(),document.exitPointerLock()):$.lock(),_v()},Jv,(e,n)=>t.send(JSON.stringify({type:`mover_item`,de:e,para:n})),Ae,e=>t.send(JSON.stringify({type:`fabricar`,receita:e}))),$.onKey(tv.keys.inventario,()=>{Dv.open||rv?.toggle()}),ov=new ah(ke,Jv,Ae,(e,n,r,i,a)=>t.send(JSON.stringify({type:`mover_container`,x:e,y:n,z:r,de:i,para:a})),()=>t.send(JSON.stringify({type:`fechar_container`})),e=>{e?(nv?.hide(),iv?.hide(),av?.hide(),rv?.hide(),document.exitPointerLock()):$.lock(),_v()});let F=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),ie.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(be&&!De){t.send(JSON.stringify({type:`atacar`,alvo:be.id}));return}if(P){if(De){F(1,P);return}Tl(Me()??-1)&&Gv!==`criativo`||t.send(JSON.stringify({type:`break_block`,x:P.x,y:P.y,z:P.z}))}}),$.onMouseButton(2,()=>{if(Jv.ativa&&Iu(Me()??-1)){t.send(JSON.stringify({type:`comer`,slot:Ee}));return}if(!P)return;if(De){F(2,P);return}{let e=Me();if(Tl(e??-1)){let r=Jv.ativa?{slot:Ee}:{};if(e===901)t.send(JSON.stringify({type:`balde`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,encher:!1,...r})),Jv.ativa||(Te[Ee]=900);else{if(K(n,P.x,P.y,P.z)!==G.Agua)return;t.send(JSON.stringify({type:`balde`,x:P.x,y:P.y,z:P.z,encher:!0,...r})),Jv.ativa||(Te[Ee]=901)}Jv.ativa||(localStorage.setItem(Se,JSON.stringify(Te)),je());return}}if(Ul(K(n,P.x,P.y,P.z))){let{x:e,y:n,z:r}=P;se.open(oe.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(Ju(K(n,P.x,P.y,P.z))!==null){t.send(JSON.stringify({type:`use_block`,x:P.x,y:P.y,z:P.z}));return}if(ou(K(n,P.x,P.y,P.z))){t.send(JSON.stringify({type:`use_block`,x:P.x,y:P.y,z:P.z}));return}let e=Me();if(e!==null){if((e===G.PortaXFechada||e===G.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?G.PortaXFechada:G.PortaZFechada),(e===G.JanelaXFechada||e===G.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?G.JanelaXFechada:G.JanelaZFechada),Wl(e)||Gl(e)||Kl(e)||Ul(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Wl(e)?G.CadeiraXP:Gl(e)?G.SofaXP:Kl(e)?G.CamaXP:G.QuadroXP)+r}if(Nl(e)){let t=e-+!!Pl(e);e=P.ny<0?t+1:t}if(Il(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Bl(zl(e),r,P.ny<0)}t.send(JSON.stringify({type:`place_block`,x:P.x+P.nx,y:P.y+P.ny,z:P.z+P.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!P||De||Jv.ativa)return;let e=K(n,P.x,P.y,P.z);Ql(e)&&(e=G.PortaXFechada),nu(e)&&(e=G.JanelaXFechada),Wl(e)&&(e=G.CadeiraXP),Gl(e)&&(e=G.SofaXP),Kl(e)&&(e=G.CamaXP),Ul(e)&&(e=G.QuadroXP),Nl(e)&&(e=G.LajePedraBaixo+Fl(e)*2),Il(e)&&(e=G.EscadaPedraXP+zl(e)*8),lu(e)&&(uu(e)&&Hv!==`professor`||(Te[Ee]=e,localStorage.setItem(Se,JSON.stringify(Te)),je()))});let Pe=new dg(z_,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Cv});dv=Pe,Pe.contexto=()=>({x:N.pos.x,y:N.pos.y,z:N.pos.z,yaw:$.yaw,pitch:$.pitch,voando:Wv&&qv(),noChao:N.onGround,raioRender:tv.raioRender,meshMsPorFrame:tv.meshMsPorFrame,pixelRatioCap:tv.pixelRatioCap,fov:tv.fov,nuvens:tv.nuvens,balanco:tv.balanco,distanciaTotal:_,colunasRecebidas:g,bytesRecebidos:t.stats.bytesIn}),Pe.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),Pe.carga=()=>cv.relatorio(),Pe.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Fe=null;if(Q_){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);Dv.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let t=Q_.semVida?`bench-semvida`:`bench`;Pe.baixar(e,t),Dv.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${t}-*.json)`)}};lv=()=>{if(Fe)return;Fe=Jm.paraMundo(Q_,M,n.dims),Pe.setMeta({bench:Fe.meta()}),Pe.marcar(`bench: início`,`${Q_.duracaoS}s · raio ${Fe.trajeto.raio}${Q_.semVida?` · sem vida ambiental`:``}`),uv=!0,window.__benchRodando=!0,Wv=!0,_v(),Fe.iniciar(performance.now());let t=Fe.amostra(performance.now());N.pos.x=Re=t.x,N.pos.y=ze=t.y,N.pos.z=Be=t.z,Pe.record(t=>{uv=!1,window.__benchRodando=!1,_v(),window.__benchPerfil=t,e(t)},Q_.duracaoS*1e3)}}$.onKey(tv.keys.hud,()=>Pe.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{Pe.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),zg()&&(Oe&&(Oe.style.pointerEvents=`auto`,Oe.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(Ee=n,je())})),ev=new Ug($,{keys:()=>tv.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>rv?.toggle(),chat:()=>{Dv.open||(document.exitPointerLock(),Dv.openInput())},menu:()=>{$.touch=!1,gv(),_v()},hud:()=>Pe.toggle(),varinha:()=>Ne(),amigos:()=>{nv?.hide(),rv?.hide(),iv?.hide(),av?.toggle()}}),ev.setVarinhaDisponivel(Hv===`professor`||ny),ev.setAmigosDisponivel(ny),ev.setScale(tv.uiScale),_v()),Pe.extra=()=>{let e=$.mouseStats,t=N.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=id(i,a,r),s=fu(o),c=pu(o),l=Math.min(rd(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&s.neve?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===G.GramaSeca?`grama seca`:c===G.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se o bioma neva · chapada ≥85]\nrelevo ${_u(o).toFixed(2)} (teto do bioma ${s.relevo})\nmodo ${Gv===`sobrevivencia`?`sobrevivência`:`criativo`}  voo ${qv()?Wv?`voando`:`liberado`:`trancado`}`+(Qv?`  vida ${Qv.vida}/20`+(Qv.fome===void 0?`  sem fome`:`  fome ${Qv.fome}/20`):``)+`
mouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let Ie={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},I=0;setInterval(()=>{let e={x:N.pos.x,y:N.pos.y,z:N.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==Ie.x||e.y!==Ie.y||e.z!==Ie.z||e.yaw!==Ie.yaw||e.pitch!==Ie.pitch,r=performance.now();!n&&r-I<2e3||(Ie=e,I=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof tg&&wv&&!Q_&&(Ay(),setInterval(()=>void Ay(),3e4));let Le={...t.stats};setInterval(()=>{let e=t.stats;Pe.net={msgsPerSec:e.msgsIn+e.msgsOut-(Le.msgsIn+Le.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(Le.bytesIn+Le.bytesOut),tickAvgMs:Ov.tickAvgMs,tickMaxMs:Ov.tickMaxMs,jitterMs:Nv()},Pe.regras=kv,Pe.stream={colunas:f.size,fila:E.filaPendente,faltando:m.size,repedidas:h,ultimoLote:E.ultimoLote},Pe.luz={colunas:u,totalMs:l,fila:s.length},Le={...e}},1e3);let L=performance.now(),Re=N.pos.x,ze=N.pos.y,Be=N.pos.z,Ve=!1,He=!1,Ue=0,We=!1,Ge=0,Ke=Z.eyeHeight,qe=0;z_.setAnimationLoop(()=>{let e=performance.now(),t=e-L;L=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(tv.keys.forward)-+!!$.down(tv.keys.back):0,m=$.active?!!$.down(tv.keys.right)-+!!$.down(tv.keys.left):0,h=$.active&&$.down(tv.keys.jump),g=$.active&&$.down(tv.keys.forward);g&&!He&&(e-Ue<300&&(Ve=!0),Ue=e),g||(Ve=!1),He=g;let y=$.active&&$.down(tv.keys.agachar),x=o>0&&!y&&(Ve||$.active&&$.down(tv.keys.correr));h&&!We&&(qv()&&e-Ge<300&&(Wv=!Wv),Ge=e),We=h;let S=Wv&&qv(),C=!0;if(d){E.modoCarga=cv.ativo;{let e=cv.ativo?16:3,t=performance.now()+e,r=0;for(;s.length>0;){let e=s.shift(),o=e.cz*n.dims.x+e.cx;if(c.delete(o),f.has(o)){if(!i){let t=performance.now();Ad(n,a,e.cx,e.cz),l+=performance.now()-t,u++}if(E.enfileirarColuna(e.cx,e.cz),++r>=1&&performance.now()>=t)break}}}E.processarFila(tv.meshMsPorFrame,(e,t)=>{f.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(N.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(N.pos.z/16)));if(C=f.has(r*n.dims.x+t),(p=(p+1)%60)==0){for(let e of f){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>tv.raioRender+2){f.delete(e),E.descartarColuna(i,o),re.descartarColuna(i,o),fd(a,i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}A(t,r,e);let i=tv.raioRender*16;j.cularPorDistancia(N.pos.x,N.pos.z,i),ie.cularPorDistancia(N.pos.x,N.pos.z,i)}cv.ativo&&f.size>=pe&&s.length===0&&E.filaPendente===0&&cv.concluir()}if(Fe?.ativo){let t=Fe.amostra(e);N.pos.x=t.x,N.pos.y=t.y,N.pos.z=t.z,N.vel.x=N.vel.y=N.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Fe.terminou(e)&&(Fe.parar(),Pe.marcar(`bench: fim`))}let w=N.pos.y;C&&!Fe?.ativo&&Qf(n,N,{forward:o,strafe:m,jump:h,yaw:$.yaw,sprint:x,sneak:y,fly:S},r);let T=N.pos.y-w;N.onGround&&!S&&T>.01&&T<=.56&&(qe=Math.min(qe+T,zf)),qe*=Math.exp(-r*14),qe<.002&&(qe=0),_+=Math.hypot(N.pos.x-Re,N.pos.y-ze,N.pos.z-Be),Re=N.pos.x,ze=N.pos.y,Be=N.pos.z,N.pos.y<-16&&he();let k=1-Math.exp(-r*12);for(let e of ge.values()){e.mesh.position.lerp(e.target,k);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*k}let ae=1-Math.exp(-r*20);Ke+=((y&&!S?Z.sneakEyeHeight:Z.eyeHeight)-Ke)*ae;let oe=tv.fov*(N.sprinting?1.1:1);if(Math.abs(V_.fov-oe)>.01&&(V_.fov+=(oe-V_.fov)*ae,V_.updateProjectionMatrix()),V_.position.set(N.pos.x,N.pos.y+Ke-qe,N.pos.z),V_.rotation.set($.pitch,$.yaw,0),V_.getWorldDirection(xe),P=$.active?np(n,V_.position.x,V_.position.y,V_.position.z,xe.x,xe.y,xe.z,5,Te[Ee]===900):null,be=$.active&&Gv===`sobrevivencia`&&Kv?ep(V_.position.x,V_.position.y,V_.position.z,xe.x,xe.y,xe.z,[...ge].map(([e,t])=>({id:e,x:t.mesh.position.x,y:t.mesh.position.y-Z.height/2,z:t.mesh.position.z})),5):null,be&&P){let e=Math.hypot(P.x+.5-V_.position.x,P.y+.5-V_.position.y,P.z+.5-V_.position.z);be.dist>e&&(be=null)}if(hv?.classList.toggle(`alvo`,be!==null),ye.visible=P!==null&&be===null,P){let[e,t,r,i,a,o]=Vd(K(n,P.x,P.y,P.z));ye.position.set(P.x+(e+i)/2,P.y+(t+a)/2,P.z+(r+o)/2),ye.scale.set(i-e+.004,a-t+.004,o-r+.004)}Pe.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),K_.update(r),J_.ventoTempo.value=K_.fase*Math.PI*2,J_.ventoDir.value.set(K_.x,K_.z),J_.ventoForca.value=tv.balanco?K_.forca:0,W_.update(r,K_),b.nivelCeu.value=W_.nivelCeu,D.update(n,V_.position.x,V_.position.y,V_.position.z);let se=Math.floor(K_.fase*16)%16;O+=r;let ce=Math.floor(O*8)%16;(se!==ee||ce!==te)&&O-ne>=1/12&&(ne=O,ee=se,te=ce,xm(v,se,K_.ondaAgua,ce));let le=performance.now();Pe.gpuInicio(),z_.render(B_,V_),Pe.gpuFim(),Pe.frame(t,performance.now()-le)}),d||cv.concluir(),jy.has(`hud`)&&Pe.toggle(),new URLSearchParams(location.search).has(`painel`)&&nv?.toggle(),new URLSearchParams(location.search).has(`inv`)&&rv?.toggle(),new URLSearchParams(location.search).has(`amigos`)&&av?.toggle(),jy.has(`touch`)&&vv()}