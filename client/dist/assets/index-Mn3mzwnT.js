...
`,Xf=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Yf,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`⛶`,`tela cheia`,()=>Jf()),this.tapButton(`📊`,`hud`,()=>this.actions.hud())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t){let n=this.makeButton(e,t);n.addEventListener(`pointerdown`,e=>{e.preventDefault(),n.setPointerCapture(e.pointerId),this.syncKey(this.actions.keys().jump,!0)});let r=()=>this.syncKey(this.actions.keys().jump,!1);return n.addEventListener(`pointerup`,r),n.addEventListener(`pointercancel`,r),n}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}};function Zf(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Ad(n)}var Qf=new hl({antialias:!0});Qf.setPixelRatio(Math.min(window.devicePixelRatio,2)),Qf.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Qf.domElement);var $f=new gn;$f.background=new W(8900331);var ep=new Aa(75,window.innerWidth/window.innerHeight,.1,512);ep.rotation.order=`YXZ`;var tp=new Na(16777215,2.2);tp.position.set(60,100,40);var np=new Pa(16777215,.55);$f.add(tp,np);var rp=new Kd(tp,np,$f,ep),ip=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();ip!==null&&rp.sync(ip,!1);var $=new Qd(Qf.domElement),ap=new URLSearchParams(location.search).get(`yaw`);ap!==null&&Number.isFinite(Number(ap))&&($.yaw=Number(ap));function op(){let e=rf();return $.sensitivity=e.sensitivity,ep.fov=e.fov,ep.updateProjectionMatrix(),Qf.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),md(e.volume),e}var sp=op();vd(sp.volume);var cp=null,lp=null,up=null,dp=document.getElementById(`overlay`),fp=document.getElementById(`overlay-main`),pp=document.getElementById(`overlay-config`),mp=document.getElementById(`crosshair`);function hp(){fp?.classList.remove(`hidden`),pp?.classList.add(`hidden`)}function gp(){let e=(cp?.open??!1)||(lp?.open??!1);dp?.classList.toggle(`hidden`,$.active||Cp.open||e),mp?.classList.toggle(`hidden`,!$.active),$.locked&&hp(),up?.setShown($.touch&&!Cp.open&&!e)}document.addEventListener(`pointerlockchange`,gp);function _p(){qf()?($.touch=!0,Jf(),gp()):$.lock()}function vp(){let e=sp.keys;sp=op();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],sp.keys[t])}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>_p()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Cf(e,vp,hp),fp?.classList.add(`hidden`),pp?.classList.remove(`hidden`)}),dp?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&gd(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{ep.aspect=window.innerWidth/window.innerHeight,ep.updateProjectionMatrix(),Qf.setSize(window.innerWidth,window.innerHeight)});var yp=null,bp=`?`,xp=null;function Sp(){return new URLSearchParams(location.search).get(`nome`)??vf()}var Cp=new Id(e=>yp?.send(JSON.stringify({type:`chat`,text:e})),e=>{gp(),e||$.lock()});gp(),Qf.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Cp.open&&Cp.close()});var wp={tickAvgMs:0,tickMaxMs:0},Tp=!1,Ep=null,Dp=null,Op=null,kp=null,Ap=null,jp=null,Mp=`aluno`,Np=!1,Pp=!1;function Fp(){return Mp===`professor`||Np}var Ip=[],Lp=null,Rp=!1,zp=[],Bp=null,Vp=null,Hp=null,Up=new Of,Wp=null,Gp=null,Kp=null,qp=[],Jp=new Set,Yp=!1,Xp=null,Zp=new Map;function Qp(){cp?.update({regions:Ip,modo:Wp?.modo??`sequencial`,objetivos:Wp?.objetivos??[],grupos:qp,myGrupo:Kp})}function $p(e){return e.porGrupo&&Mp!==`professor`?Kp===null?!1:e.porGrupo.find(e=>e.grupo===Kp)?.completo??!1:e.completo}function em(e){if(Wp){for(let t of Wp.objetivos)$p(t)?Jp.has(t.id)||(Jp.add(t.id),e&&Yp&&ld({kind:`objective_complete`})):Jp.delete(t.id);Yp=!0,Up.update(Wp.modo,Wp.objetivos,{grupo:Kp,professor:Mp===`professor`,painelKey:of(sp.keys.painel)}),Gp?.(Wp.objetivos)}}function tm(e){if(typeof e==`string`){let t=Nu(e);if(!t)return;t.type===`debug_stats`?wp={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs}:t.type===`block_changed`?Ep?.(t):t.type===`blocks_filled`?Dp?.(t):t.type===`player_moved`?(t.name&&Zp.get(t.id)!==t.name&&(Zp.set(t.id,t.name),jd([...new Set(Zp.values())])),Op?.(t)):t.type===`player_left`?(Zp.delete(t.id),jd([...new Set(Zp.values())]),kp?.(t.id)):t.type===`spawn`?(jp={x:t.x,y:t.y,z:t.z},Mp=t.papel??`aluno`):t.type===`regions`?(Ip=t.regions,Lp?.(t.regions),Qp()):t.type===`objectives`?(Wp={modo:t.modo,objetivos:t.objetivos},em(!0),Qp()):t.type===`group`?(Kp=t.grupo,Jp.clear(),em(!1),Qp()):t.type===`groups`?(qp=t.grupos,Qp()):t.type===`quadros`?Vp?.(t.lista):t.type===`quadro_changed`?Hp?.(t):t.type===`claims`?(Rp=t.ativo,zp=t.claims,Bp?.(t.claims)):t.type===`friends`||(t.type===`teleport`?Ap?.(t):t.type===`time`?ip===null&&rp.sync(t.hora,t.ciclo):t.type===`voo`?(Np=t.liberado,Fp()||(Pp=!1),Cp.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(gd(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),Gf(),location.href=location.pathname):t.type===`join_denied`?(gd(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),Gf(),location.href=location.pathname):t.type===`chat`&&(Cp.addMessage(t.author,t.text),t.author===`servidor`&&Zf(t.text),ld({kind:`chat_message`})));return}if(Tp){Xp?.(Pu(e));return}Tp=!0,cm(Pu(e))}function nm(e,t){sp=op(),yp=e,e.onMessage(tm),$.onKey(sp.keys.chat,()=>{Cp.open||(document.exitPointerLock(),Cp.openInput())}),e.send(JSON.stringify({type:`join`,name:Sp(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}}))}function rm(e,t){bp=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),nm(new Jd(e),t)}function im(e){xp={id:e.id,name:e.name,createdAt:e.createdAt},bp=`web-worker (${e.name})`;let t=new qd(new Worker(new URL(`/assets/worker-Dwvg63Ex.js`,``+import.meta.url),{type:`module`})),n=crypto.getRandomValues(new Uint32Array(1))[0]??1;t.init({save:e.data??void 0,seed:n,preset:e.preset,tamanho:e.tamanho}),nm(t)}async function am(){if(!(yp instanceof qd)||!xp)return;let e=await yp.requestSave();await pf({...xp,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{Gf(),am().finally(()=>location.reload())});var om=new URLSearchParams(location.search),sm=om.get(`server`);if(sm){let e=om.get(`codigo`);rm(sm,{pin:om.get(`pin`)??``,...e?{codigo:e}:{}})}else Sf({onPlayWorld:im,onPlayMulti:rm});function cm(e){let t=yp;if(!t)return;Wf(()=>$.active);let n=e.world,r=new $i({map:od(),alphaTest:.5});if(new URLSearchParams(location.search).has(`atlas`)){let e=r.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let i=new Ld(n,r,$f);i.buildAll();let a=new Kf($f);a.setFromWorld(n);let s=new Mf($f);s.setRegions(Ip),Lp=e=>{s.setRegions(e),s.clearCorners()};let c=new Mf($f,16747546),l=e=>{c.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};l(zp),Bp=e=>{l(e),s.clearCorners(),!Rp&&Mp!==`professor`&&k&&(k=!1),ne()};let u=new If($f),d=new Rf;Vp=e=>u.setAll(e,n),Hp=e=>u.aplicar(e,n);let f=new Mf($f,3066993),p=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Kp!==null&&r.grupo===Kp;(Mp===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});f.setRegions(t)};Gp=p,Wp&&p(Wp.objetivos);let m=e=>t.send(JSON.stringify({type:`chat`,text:e})),h=e=>{e?document.exitPointerLock():$.lock(),gp()};cp=Mp===`professor`?new Af(m,h):new jf(m,h),Qp(),$.onKey(sp.keys.painel,()=>{if(!Cp.open){if(Mp!==`professor`&&qp.length===0){Cp.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}lp?.hide(),cp?.toggle()}}),Mp===`professor`&&Cp.addMessage(`jogo`,`tecla ${of(sp.keys.painel)} abre o painel de autoria`);let g=jp??{x:n.sizeX/2+.5,y:Ql(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},_=pu(g.x,g.y,g.z);function v(){_.pos.x=g.x,_.pos.y=g.y,_.pos.z=g.z,_.vel.x=_.vel.y=_.vel.z=0}Xp=e=>{n=e.world,i.trocarMundo(n),a.setFromWorld(n),Ip=[],s.setRegions([]),s.clearCorners(),u.setAll([],n),Wp=null,Gp?.([]),Up.update(`livre`,[],{grupo:null,professor:Mp===`professor`,painelKey:of(sp.keys.painel)}),Jp.clear(),Yp=!1,qp=[],Kp=null,Qp(),g=jp??g,v(),Cp.addMessage(`jogo`,`a aula mudou — mundo novo carregado`)},Ap=e=>{_.pos.x=e.x,_.pos.y=e.y,_.pos.z=e.z,_.vel.x=_.vel.y=_.vel.z=0,$.yaw=e.yaw,$.pitch=e.pitch},Ep=e=>{Zl(n,e.x,e.y,e.z,e.blockId),i.remeshBlock(e.x,e.y,e.z),a.onBlockChanged(e.x,e.y,e.z,e.blockId),u.onBlockChanged(e.x,e.y,e.z,e.blockId,n),ld(e.blockId===q.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},Dp=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)Zl(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};i.remeshBox(t,r),a.onRegionFilled(t,r,e.blockId),u.validarTodos(n),ld(e.blockId===q.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let y=new Map,b=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new ji(t);i.minFilter=o;let a=new Ar(new gr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,uu.height/2+.35,0),a},x=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};Op=e=>{let t=y.get(e.id);if(!t){let n=new Qr(new Fi(uu.width,uu.height,uu.width),new $i({color:new W().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+uu.height/2,e.z),n.rotation.y=e.yaw,$f.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},y.set(e.id,t)}e.name&&e.name!==t.labelName&&(x(t),t.label=b(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+uu.height/2,e.z),t.targetYaw=e.yaw},kp=e=>{let t=y.get(e);t&&(x(t),$f.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),y.delete(e))};let S=new Si(new Vi(new Fi(1.002,1.002,1.002)),new ui({color:0}));S.visible=!1,$f.add(S);let C=null,w=new H,T=`lj-hotbar`,E=Sd(Mp),D=()=>E.slice(0,9).map(e=>e.id),ee=(()=>{let e=new Set(E.map(e=>e.id)),t=D();try{let n=JSON.parse(localStorage.getItem(T)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),O=0,k=!1,te=document.getElementById(`hotbar`),A=yd(r.map?.image,xd.map(e=>e.id)),j=e=>xd.find(t=>t.id===e)?.name??`?`,ne=()=>{if(!te)return;if(k){te.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${Mp===`professor`?`/regiao criar nome`:`/claim criar`} · R volta`;return}let e=ee.map((e,t)=>`<span class="slot${t===O?` sel`:``}"><small>${t+1}</small><img src="${A.get(e)??``}" alt=""></span>`).join(``);te.innerHTML=`<span class="bar-nome">${j(ee[O]??q.Grass)}</span><span class="slots">${e}</span>`,lp?.refresh()};ne(),$.onKey(sp.keys.varinha,()=>{Mp!==`professor`&&!Rp||(k=!k,ne())});for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{O=e,ne()});$.onWheel(e=>{O=(O+e+ee.length)%ee.length,ne()}),lp=new Cd(A,()=>E,()=>({hotbar:ee,selected:O}),e=>{ee[O]=e,localStorage.setItem(T,JSON.stringify(ee)),ne()},e=>{O=e,ne()},e=>{e?(cp?.hide(),document.exitPointerLock()):$.lock(),gp()}),$.onKey(sp.keys.inventario,()=>{Cp.open||lp?.toggle()});let re=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),s.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(C){if(k){re(1,C);return}t.send(JSON.stringify({type:`break_block`,x:C.x,y:C.y,z:C.z}))}}),$.onMouseButton(2,()=>{if(!C)return;if(k){re(2,C);return}if(Sl(Xl(n,C.x,C.y,C.z))){let{x:e,y:n,z:r}=C;d.open(u.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(Fl(Xl(n,C.x,C.y,C.z))){t.send(JSON.stringify({type:`use_block`,x:C.x,y:C.y,z:C.z}));return}let e=ee[O];if(e!==void 0){if((e===q.PortaXFechada||e===q.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?q.PortaXFechada:q.PortaZFechada),(e===q.JanelaXFechada||e===q.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?q.JanelaXFechada:q.JanelaZFechada),Cl(e)||wl(e)||Tl(e)||Sl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Cl(e)?q.CadeiraXP:wl(e)?q.SofaXP:Tl(e)?q.CamaXP:q.QuadroXP)+r}t.send(JSON.stringify({type:`place_block`,x:C.x+C.nx,y:C.y+C.ny,z:C.z+C.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!C||k)return;let e=Xl(n,C.x,C.y,C.z);Al(e)&&(e=q.PortaXFechada),Pl(e)&&(e=q.JanelaXFechada),Cl(e)&&(e=q.CadeiraXP),wl(e)&&(e=q.SofaXP),Tl(e)&&(e=q.CamaXP),Sl(e)&&(e=q.QuadroXP),Rl(e)&&(zl(e)&&Mp!==`professor`||(ee[O]=e,localStorage.setItem(T,JSON.stringify(ee)),ne()))});let M=new Zd(Qf,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:bp});M.setRemesh({count:i.remeshCount,totalMs:i.remeshMsTotal,lastMs:i.lastRemeshMs}),$.onKey(sp.keys.hud,()=>M.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{t.send(JSON.stringify({type:`profile_report`,stats:M.stats()}))}),qf()&&(te&&(te.style.pointerEvents=`auto`,te.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(O=n,ne())})),up=new Xf($,{keys:()=>sp.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>lp?.toggle(),chat:()=>{Cp.open||(document.exitPointerLock(),Cp.openInput())},menu:()=>{$.touch=!1,hp(),gp()},hud:()=>M.toggle()}),gp()),M.extra=()=>{let e=$.mouseStats,t=_.pos;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let ie={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},ae=0;setInterval(()=>{let e={x:_.pos.x,y:_.pos.y,z:_.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==ie.x||e.y!==ie.y||e.z!==ie.z||e.yaw!==ie.yaw||e.pitch!==ie.pitch,r=performance.now();!n&&r-ae<2e3||(ie=e,ae=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof qd&&xp&&(am(),setInterval(()=>void am(),3e4));let oe={...t.stats};setInterval(()=>{let e=t.stats;M.net={msgsPerSec:e.msgsIn+e.msgsOut-(oe.msgsIn+oe.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(oe.bytesIn+oe.bytesOut),tickAvgMs:wp.tickAvgMs,tickMaxMs:wp.tickMaxMs},oe={...e}},1e3);let se=performance.now(),ce=!1,le=!1,ue=0,N=!1,de=0,fe=uu.eyeHeight;Qf.setAnimationLoop(()=>{let e=performance.now(),t=e-se;se=e;let r=Math.min(t/1e3,.05),a=$.active?!!$.down(sp.keys.forward)-+!!$.down(sp.keys.back):0,o=$.active?!!$.down(sp.keys.right)-+!!$.down(sp.keys.left):0,s=$.active&&$.down(sp.keys.jump),c=$.active&&$.down(sp.keys.forward);c&&!le&&(e-ue<300&&(ce=!0),ue=e),c||(ce=!1),le=c;let l=$.active&&$.down(sp.keys.agachar),u=a>0&&!l&&(ce||$.active&&$.down(sp.keys.correr));s&&!N&&(Fp()&&e-de<300&&(Pp=!Pp),de=e),N=s;let d=Pp&&Fp();vu(n,_,{forward:a,strafe:o,jump:s,yaw:$.yaw,sprint:u,sneak:l,fly:d},r),_.pos.y<-16&&v();let f=1-Math.exp(-r*12);for(let e of y.values()){e.mesh.position.lerp(e.target,f);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*f}let p=1-Math.exp(-r*20);fe+=((l&&!d?uu.sneakEyeHeight:uu.eyeHeight)-fe)*p;let m=sp.fov*(_.sprinting?1.1:1);Math.abs(ep.fov-m)>.01&&(ep.fov+=(m-ep.fov)*p,ep.updateProjectionMatrix()),ep.position.set(_.pos.x,_.pos.y+fe,_.pos.z),ep.rotation.set($.pitch,$.yaw,0),ep.getWorldDirection(w),C=$.active?yu(n,ep.position.x,ep.position.y,ep.position.z,w.x,w.y,w.z,5):null,S.visible=C!==null,C&&S.position.set(C.x+.5,C.y+.5,C.z+.5),M.setRemesh({count:i.remeshCount,totalMs:i.remeshMsTotal,lastMs:i.lastRemeshMs}),rp.update(r),M.frame(t),Qf.render($f,ep)}),new URLSearchParams(location.search).has(`painel`)&&cp?.toggle(),new URLSearchParams(location.search).has(`inv`)&&lp?.toggle(),om.has(`touch`)&&_p()}