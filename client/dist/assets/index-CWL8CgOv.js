...
`,Ip=class{input;actions;root;heldKeys=new Set;joyPointer=null;lookPointer=null;lookX=0;lookY=0;constructor(e,t){this.input=e,this.actions=t;let n=document.createElement(`style`);n.textContent=Fp,document.head.appendChild(n),this.root=document.createElement(`div`),this.root.id=`touch-ui`,this.root.className=`hidden`;let r=document.createElement(`div`);r.id=`touch-look`,r.addEventListener(`pointerdown`,e=>{this.lookPointer===null&&(this.lookPointer=e.pointerId,this.lookX=e.clientX,this.lookY=e.clientY,r.setPointerCapture(e.pointerId))}),r.addEventListener(`pointermove`,e=>{e.pointerId===this.lookPointer&&(this.input.applyLook(e.clientX-this.lookX,e.clientY-this.lookY),this.lookX=e.clientX,this.lookY=e.clientY)});let i=e=>{e.pointerId===this.lookPointer&&(this.lookPointer=null)};r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i);let a=document.createElement(`div`);a.id=`touch-joy`;let o=document.createElement(`div`);o.id=`touch-joy-thumb`,a.appendChild(o);let s=e=>{let t=a.getBoundingClientRect(),n=t.width/2,r=e.clientX-(t.left+n),i=e.clientY-(t.top+n),s=Math.hypot(r,i);s>n&&(r*=n/s,i*=n/s),o.style.transform=`translate(${r}px, ${i}px)`;let c=this.actions.keys(),l=r/n,u=i/n;this.syncKey(c.forward,u<-.35),this.syncKey(c.back,u>.35),this.syncKey(c.left,l<-.35),this.syncKey(c.right,l>.35)},c=e=>{if(e.pointerId!==this.joyPointer)return;this.joyPointer=null,o.style.transform=``;let t=this.actions.keys();for(let e of[t.forward,t.back,t.left,t.right])this.syncKey(e,!1)};a.addEventListener(`pointerdown`,e=>{this.joyPointer===null&&(this.joyPointer=e.pointerId,a.setPointerCapture(e.pointerId),s(e))}),a.addEventListener(`pointermove`,e=>{e.pointerId===this.joyPointer&&s(e)}),a.addEventListener(`pointerup`,c),a.addEventListener(`pointercancel`,c);let l=document.createElement(`div`);l.id=`touch-acoes`,l.append(this.tapButton(`✋`,`copiar`,()=>this.actions.copiar()),this.holdButton(`⤒`,`pular`,()=>this.actions.keys().jump),this.holdButton(`⤓`,`agachar`,()=>this.actions.keys().agachar),this.tapButton(`⛏`,`quebrar`,()=>this.actions.quebrar()),this.tapButton(`▣`,`colocar`,()=>this.actions.colocar()));let u=document.createElement(`div`);u.id=`touch-topo`,u.append(this.tapButton(`☰`,`menu`,()=>this.actions.menu()),this.tapButton(`🧱`,`blocos`,()=>this.actions.inventario()),this.tapButton(`💬`,`chat`,()=>this.actions.chat()),this.tapButton(`🪄`,`varinha`,()=>this.actions.varinha()),this.tapButton(`⛶`,`tela cheia`,()=>Pp()),this.tapButton(`📊`,`hud`,()=>this.actions.hud())),this.root.append(r,a,l,u),document.body.appendChild(this.root)}setScale(e){this.root.style.setProperty(`--ts`,String(e))}setShown(e){this.root.classList.toggle(`hidden`,!e),e||this.releaseAll()}releaseAll(){for(let e of this.heldKeys)this.input.setKey(e,!1);this.heldKeys.clear(),this.joyPointer=null,this.lookPointer=null}syncKey(e,t){this.input.setKey(e,t),t?this.heldKeys.add(e):this.heldKeys.delete(e)}tapButton(e,t,n){let r=this.makeButton(e,t);return r.addEventListener(`pointerdown`,e=>{e.preventDefault(),n()}),r}holdButton(e,t,n){let r=this.makeButton(e,t);r.addEventListener(`pointerdown`,e=>{e.preventDefault(),r.setPointerCapture(e.pointerId),this.syncKey(n(),!0)});let i=()=>this.syncKey(n(),!1);return r.addEventListener(`pointerup`,i),r.addEventListener(`pointercancel`,i),r}makeButton(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`touch-btn`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`small`);return i.textContent=t,n.append(r,i),n}},Lp=`lj-nome`;function Rp(){let e=localStorage.getItem(Lp),t=e?_u(e):`jogador-${Math.random().toString(36).slice(2,6)}`;return t!==e&&localStorage.setItem(Lp,t),t}function zp(e){let t=document.getElementById(e);if(!t)throw Error(`menu: #${e} não existe no HTML`);return t}function Bp(e,t){let n=document.getElementById(e);n&&(n.textContent=t,n.classList.remove(`hidden`))}function Vp(e){document.getElementById(e)?.classList.add(`hidden`)}function Hp(e){let t=zp(`menu`),n={home:zp(`menu-home`),worlds:zp(`menu-worlds`),multi:zp(`menu-multi`),config:zp(`menu-config`)};function r(e){for(let[t,r]of Object.entries(n))r.classList.toggle(`hidden`,t!==e)}t.classList.remove(`hidden`),r(`home`),zp(`menu-version`).textContent=`v${Vd}`,t.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Af(t.classList.contains(`menu-back`)?`back`:`click`)});let i=sessionStorage.getItem(`lj-erro`);i&&(sessionStorage.removeItem(`lj-erro`),Bp(`menu-erro`,i));let a=zp(`menu-nome`);a.value=Rp(),a.addEventListener(`change`,()=>{let e=_u(a.value);localStorage.setItem(Lp,e),a.value=e}),zp(`menu-btn-single`).addEventListener(`click`,()=>{c(),r(`worlds`)}),zp(`menu-btn-multi`).addEventListener(`click`,()=>r(`multi`)),zp(`menu-btn-config`).addEventListener(`click`,()=>r(`config`));for(let e of t.querySelectorAll(`.menu-back`))e.addEventListener(`click`,()=>r(`home`));function o(n){t.classList.add(`hidden`),e.onPlayWorld(n)}let s=zp(`menu-world-list`);async function c(){let e=[];try{e=await Op()}catch{s.textContent=`não consegui abrir o armazenamento do navegador`;return}s.textContent=e.length?``:`nenhum mundo ainda — crie um!`;for(let t of e){let e=document.createElement(`div`);e.className=`world-row`;let n=document.createElement(`span`);n.className=`world-name`,n.textContent=t.name;let r=document.createElement(`small`);r.textContent=new Date(t.updatedAt).toLocaleDateString(`pt-BR`);let i=document.createElement(`button`);i.type=`button`,i.textContent=`jogar`,i.addEventListener(`click`,()=>o({...t}));let a=document.createElement(`button`);a.type=`button`,a.textContent=`exportar`,a.title=`baixa o arquivo .ljw pra compartilhar`,a.addEventListener(`click`,()=>jp(t));let l=document.createElement(`button`);l.type=`button`,l.textContent=`apagar`,l.addEventListener(`click`,()=>{if(l.dataset.armado){Ap(t.id).then(c);return}l.dataset.armado=`1`,l.textContent=`confirma?`,l.classList.add(`world-del-armado`),window.setTimeout(()=>{delete l.dataset.armado,l.textContent=`apagar`,l.classList.remove(`world-del-armado`)},3e3)}),e.append(n,r,i,a,l),s.appendChild(e)}}let l=zp(`menu-new-nome`),u=zp(`menu-new-tipo`);zp(`menu-btn-new`).addEventListener(`click`,()=>{let e=l.value.trim();if(!e){Bp(`menu-worlds-erro`,`Dê um nome ao mundo novo.`);return}Vp(`menu-worlds-erro`),o({id:crypto.randomUUID(),name:e,createdAt:Date.now(),data:null,preset:wu(u.value),tamanho:Tu(zp(`menu-new-tamanho`).value)})});let d=zp(`menu-import-file`);zp(`menu-btn-import`).addEventListener(`click`,()=>d.click()),d.addEventListener(`change`,()=>{let e=d.files?.[0];d.value=``,e&&Mp(e).then(async e=>{await kp(e),await c(),Vp(`menu-worlds-erro`)}).catch(e=>{Bp(`menu-worlds-erro`,`arquivo inválido: ${e instanceof Error?e.message:String(e)}`)})});let f=zp(`menu-endereco`),p=zp(`menu-pin`),m=zp(`menu-codigo`);f.value=localStorage.getItem(`lj-endereco`)??`ws://${location.hostname}:8080`,zp(`menu-btn-conectar`).addEventListener(`click`,()=>{let n=f.value.trim();if(!/^wss?:\/\//.test(n)){Bp(`menu-multi-erro`,`O endereço precisa começar com ws:// (exemplo: ws://192.168.0.10:8080).`);return}let r=p.value.trim();if(!/^\d{4}$/.test(r)){Bp(`menu-multi-erro`,`O PIN precisa ter 4 números. A primeira entrada com o seu nome é a que registra o PIN.`);return}Vp(`menu-multi-erro`),localStorage.setItem(`lj-endereco`,n);let i=m.value.trim();t.classList.add(`hidden`),e.onPlayMulti(n,{pin:r,...i?{codigo:i}:{}})}),Up(zp(`menu-config-body`),void 0,()=>r(`home`))}function Up(e,t,n){Kp(e,t,n)}function Wp(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`menu-back`,n.textContent=`← voltar`,n.addEventListener(`click`,t),e.appendChild(n)}var Gp=[{id:`controles`,label:`🖱️ controles`},{id:`som`,label:`🔊 som`},{id:`graficos`,label:`🖥️ gráficos`}];function Kp(e,t,n){e.textContent=``;for(let r of Gp){let i=document.createElement(`button`);i.type=`button`,i.textContent=r.label,i.addEventListener(`click`,()=>qp(e,r.id,t,n)),e.appendChild(i)}let r=document.createElement(`button`);r.type=`button`,r.textContent=`restaurar padrões`,r.addEventListener(`click`,()=>{xp(structuredClone(gp)),t?.(),Kp(e,t,n)}),e.appendChild(r),n&&Wp(e,n)}function qp(e,t,n,r){e.textContent=``;let i=bp(),a=()=>{xp(i),n?.()},o=document.createElement(`h2`);o.textContent=Gp.find(e=>e.id===t)?.label??t,e.appendChild(o);function s(t,n,r,i,o,s,c=String){let l=document.createElement(`label`);l.className=`config-row`;let u=document.createElement(`span`);u.textContent=t;let d=document.createElement(`input`);d.type=`range`,d.min=String(n),d.max=String(r),d.step=String(i),d.value=String(o);let f=document.createElement(`output`);return f.textContent=c(o),d.addEventListener(`input`,()=>{let e=Number(d.value);f.textContent=c(e),s(e),a()}),l.append(u,d,f),e.appendChild(l),d}if(t===`controles`){s(`sensibilidade do mouse`,.2,3,.1,i.sensitivity,e=>i.sensitivity=e,e=>`${e.toFixed(1)}×`),Np()&&s(`escala dos controles (toque)`,.6,1.8,.1,i.uiScale,e=>i.uiScale=e,e=>`${Math.round(e*100)}%`);let t=document.createElement(`p`);t.className=`menu-hint`,t.textContent=`teclas — clique num botão e aperte a tecla nova (Esc cancela):`,e.appendChild(t);let n=!1;for(let t of Object.keys(_p)){let r=document.createElement(`div`);r.className=`config-row`;let o=document.createElement(`span`);o.textContent=_p[t];let s=document.createElement(`button`);s.type=`button`,s.textContent=Sp(i.keys[t]),s.addEventListener(`click`,()=>{n||(n=!0,s.textContent=`aperte a tecla…`,window.addEventListener(`keydown`,e=>{e.preventDefault(),e.stopPropagation(),e.code!==`Escape`&&(i.keys[t]=e.code,a()),s.textContent=Sp(i.keys[t]),n=!1},{once:!0,capture:!0}))}),r.append(o,s),e.appendChild(r)}}else if(t===`som`)s(`volume dos sons de interface`,0,1,.05,i.volume,e=>{i.volume=e,Of(e)},e=>`${Math.round(e*100)}%`).addEventListener(`change`,()=>Af(`notify`));else{s(`campo de visão (FOV)`,60,100,1,i.fov,e=>i.fov=e,e=>`${e}°`);let t=document.createElement(`label`);t.className=`config-row`,t.textContent=`alta nitidez (desligue em PC fraco) `;let n=document.createElement(`input`);n.type=`checkbox`,n.checked=i.pixelRatioCap>1,n.addEventListener(`change`,()=>{i.pixelRatioCap=n.checked?2:1,a()}),t.appendChild(n),e.appendChild(t),s(`raio de render (mundo procedural)`,2,12,1,i.raioRender,e=>i.raioRender=e,e=>`${e} chunks`),s(`chunks re-meshados por frame`,2,32,1,i.meshPorFrame,e=>i.meshPorFrame=e,e=>`${e}`)}Wp(e,()=>Kp(e,n,r))}var Jp=class{root=document.getElementById(`objetivos`);update(e,t,n){if(!this.root)return;if(this.root.textContent=``,t.length===0){this.root.classList.add(`hidden`);return}this.root.classList.remove(`hidden`);let r=t.some(e=>e.porGrupo),i=e=>n.grupo===null?void 0:e.porGrupo?.find(e=>e.grupo===n.grupo);if(r&&!n.professor&&n.grupo===null){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`⚠ entre num grupo pra participar — tecla ${n.painelKey} abre o painel de grupos`,this.root.appendChild(e);return}let a=t.filter(e=>r&&!n.professor?i(e)?.completo??!1:e.completo).length,o=document.createElement(`div`);if(o.className=`obj-head`,o.textContent=`objetivos: ${a}/${t.length} concluídos`+(r&&n.grupo!==null?` · seu grupo: ${n.grupo}`:``)+(e===`livre`?` · qualquer ordem`:``),this.root.appendChild(o),a===t.length){let e=document.createElement(`div`);e.className=`obj`,e.textContent=`🏆 cenário completo!`,this.root.appendChild(e);return}for(let e of t){if(n.professor&&r&&e.porGrupo){if(!e.porGrupo.some(e=>e.ativo||e.completo))continue;let t=document.createElement(`div`);t.className=`obj`;let n=document.createElement(`div`);n.textContent=`▸ ${e.texto}`,t.appendChild(n);let r=document.createElement(`small`);r.textContent=e.porGrupo.map(t=>t.completo?`g${t.grupo} ✓`:e.kind===`construir`?`g${t.grupo} ${t.atual}/${t.total}`:e.kind===`limpar`?`g${t.grupo} faltam ${t.atual}`:`g${t.grupo} …`).join(` · `),t.appendChild(r),this.root.appendChild(t);continue}let t=i(e),a=t?t.ativo:e.ativo,o=t?t.completo:e.completo;if(!a||o)continue;let s=t?t.atual:e.atual,c=t?t.total:e.total,l=t?t.extras:e.extras,u=document.createElement(`div`);u.className=`obj`;let d=document.createElement(`div`);d.textContent=`▸ ${e.texto}`,u.appendChild(d);let f=document.createElement(`small`);e.kind===`construir`?f.textContent=`blocos corretos: ${s}/${c}`+(l>0?` · ${l} sobrando`:``):e.kind===`limpar`?f.textContent=`faltam ${s} bloco(s)`:f.textContent=`chegue até a área marcada em verde`+(r?` (do seu grupo)`:``),u.appendChild(f),this.root.appendChild(u)}}},Yp=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Af(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},Xp=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Af(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},Zp=class extends Xp{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(Lf[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=vu(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=vu(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},...Lf.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},Qp=class extends Xp{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},$p=class{fixedColor;group=new un;cornerMarks=[];boxes=[];constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Ti(new Wi(new Ri(1.01,1.01,1.01)),new pi({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Ti(new Wi(new Ri(n+.04,r+.04,i+.04)),new pi({color:this.fixedColor??new H().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a})}},em=1/16,tm=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*em-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*em-.004,ry:Math.PI}];function nm(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var rm=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(sd(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=sd(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=K(t,e.x,e.y,e.z);if(!Ll(r))return;let i=tm[r-G.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,nm(a,e,null);let o=new Pi(a);o.colorSpace=ze;let s=new ti(new Gi(12*em,12*em),new Ur({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{nm(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=sd(e,t,n);if(this.conteudos.has(a))if(!Ll(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Ll(K(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function im(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var am=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,im(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},om=null;function sm(e){e.preventDefault(),e.returnValue=``}var cm=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function lm(e){om?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||cm.has(e.code))&&e.preventDefault())}function um(e){om?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function dm(e){om||(om=e,window.addEventListener(`beforeunload`,sm),window.addEventListener(`keydown`,lm,!0),window.addEventListener(`keyup`,um,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function fm(){om=null,window.removeEventListener(`beforeunload`,sm),window.removeEventListener(`keydown`,lm,!0),window.removeEventListener(`keyup`,um,!0),navigator.keyboard?.unlock?.()}var pm=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Pi(t);i.minFilter=o,this.material=new yr({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();for(let t=0;t<e.sizeY;t++)for(let n=0;n<e.sizeZ;n++)for(let r=0;r<e.sizeX;r++)K(e,r,t,n)===G.Tocha&&this.add(r,t,n)}onBlockChanged(e,t,n,r){r===G.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===G.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new Nr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function mm(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Kf(n)}var hm=new vl({antialias:!0});hm.setPixelRatio(Math.min(window.devicePixelRatio,2)),hm.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(hm.domElement);var gm=new yn;gm.background=new H(8900331);var _m=new Na(75,window.innerWidth/window.innerHeight,.1,512);_m.rotation.order=`YXZ`;var vm=new Ia(16777215,2.2);vm.position.set(60,100,40);var ym=new La(16777215,.55);gm.add(vm,ym);var bm=new cp(vm,ym,gm,_m),xm=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();xm!==null&&bm.sync(xm,!1);var $=new hp(hm.domElement),Sm=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},Cm=Sm(`yaw`),wm=Sm(`pitch`);Cm!==null&&($.yaw=Cm),wm!==null&&($.pitch=wm);function Tm(){let e=bp();return $.sensitivity=e.sensitivity,_m.fov=e.fov,_m.updateProjectionMatrix(),hm.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),Of(e.volume),Em?.setScale(e.uiScale),e}var Em=null,Dm=Tm();Mf(Dm.volume);var Om=null,km=null,Am=null,jm=document.getElementById(`overlay`),Mm=document.getElementById(`overlay-main`),Nm=document.getElementById(`overlay-config`),Pm=document.getElementById(`crosshair`);function Fm(){Mm?.classList.remove(`hidden`),Nm?.classList.add(`hidden`)}function Im(){let e=(Om?.open??!1)||(km?.open??!1)||(Am?.open??!1);jm?.classList.toggle(`hidden`,$.active||Gm.open||e),Pm?.classList.toggle(`hidden`,!$.active),$.locked&&Fm(),Em?.setShown($.touch&&!Gm.open&&!e)}document.addEventListener(`pointerlockchange`,Im);function Lm(){Np()?($.touch=!0,Pp(),Im()):$.lock()}function Rm(){let e=Dm.keys;Dm=Tm();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`])$.rebind(e[t],Dm.keys[t]);Bm()}var zm=-1;function Bm(){!Vm||Dm.raioRender===zm||(zm=Dm.raioRender,Vm.send(JSON.stringify({type:`radius`,chunks:zm})))}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Lm()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&Up(e,Rm,Fm),Mm?.classList.add(`hidden`),Nm?.classList.remove(`hidden`)}),jm?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Af(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{_m.aspect=window.innerWidth/window.innerHeight,_m.updateProjectionMatrix(),hm.setSize(window.innerWidth,window.innerHeight)});var Vm=null,Hm=`?`,Um=null;function Wm(){return new URLSearchParams(location.search).get(`nome`)??Rp()}var Gm=new Qf(e=>Vm?.send(JSON.stringify({type:`chat`,text:e})),e=>{Im(),e||$.lock()});Im(),hm.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Gm.open&&Gm.close()});var Km={tickAvgMs:0,tickMaxMs:0},qm=0,Jm=[];function Ym(){let e=performance.now();qm>0&&(Jm.push(e-qm),Jm.length>300&&Jm.shift()),qm=e}function Xm(){let e=Jm.length;if(e<2)return 0;let t=Jm.reduce((e,t)=>e+t,0)/e,n=Jm.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var Zm=!1,Qm=null,$m=null,eh=null,th=null,nh=null,rh=null,ih=`aluno`,ah=!1,oh=!1;function sh(){return ih===`professor`||ah}var ch=[],lh=null,uh=!1,dh=[],fh=null,ph=null,mh=null,hh=new Jp,gh=null,_h=null,vh=null,yh=[],bh=new Set,xh=!1,Sh=null,Ch=null,wh=!1,Th=new Map;function Eh(){Om?.update({regions:ch,modo:gh?.modo??`sequencial`,objetivos:gh?.objetivos??[],grupos:yh,myGrupo:vh})}function Dh(e){return e.porGrupo&&ih!==`professor`?vh===null?!1:e.porGrupo.find(e=>e.grupo===vh)?.completo??!1:e.completo}function Oh(e){if(gh){for(let t of gh.objetivos)Dh(t)?bh.has(t.id)||(bh.add(t.id),e&&xh&&Cf({kind:`objective_complete`})):bh.delete(t.id);xh=!0,hh.update(gh.modo,gh.objetivos,{grupo:vh,professor:ih===`professor`,painelKey:Sp(Dm.keys.painel)}),_h?.(gh.objetivos)}}function kh(e){if(Ym(),typeof e==`string`){let t=Od(e);if(!t)return;t.type===`debug_stats`?Km={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs}:t.type===`block_changed`?Qm?.(t):t.type===`blocks_filled`?$m?.(t):t.type===`player_moved`?(t.name&&Th.get(t.id)!==t.name&&(Th.set(t.id,t.name),qf([...new Set(Th.values())])),eh?.(t)):t.type===`player_left`?(Th.delete(t.id),qf([...new Set(Th.values())]),th?.(t.id)):t.type===`spawn`?(rh={x:t.x,y:t.y,z:t.z},ih=t.papel??`aluno`):t.type===`regions`?(ch=t.regions,lh?.(t.regions),Eh()):t.type===`objectives`?(gh={modo:t.modo,objetivos:t.objetivos},Oh(!0),Eh()):t.type===`group`?(vh=t.grupo,bh.clear(),Oh(!1),Eh()):t.type===`groups`?(yh=t.grupos,Eh()):t.type===`quadros`?ph?.(t.lista):t.type===`quadro_changed`?mh?.(t):t.type===`claims`?(uh=t.ativo,dh=t.claims,fh?.(t.claims)):t.type===`friends`||(t.type===`players`?Am?.update({conectados:t.conectados,banidos:t.banidos}):t.type===`teleport`?nh?.(t):t.type===`time`?xm===null&&bm.sync(t.hora,t.ciclo):t.type===`voo`?(ah=t.liberado,sh()||(oh=!1),Gm.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`)):t.type===`kicked`?(Af(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),fm(),location.href=location.pathname):t.type===`join_denied`?(Af(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),fm(),location.href=location.pathname):t.type===`chat`&&(Gm.addMessage(t.author,t.text),t.author===`servidor`&&mm(t.text),Cf({kind:`chat_message`})));return}let t=Md(e);if(t===809716300){Ch?.(e);return}let n=()=>(wh=t===Ad,wh?Nd(e):kd(e));if(Zm){Sh?.(n());return}Zm=!0,Ih(n())}function Ah(e,t){Dm=Tm(),Vm=e,e.onMessage(kh),$.onKey(Dm.keys.chat,()=>{Gm.open||(document.exitPointerLock(),Gm.openInput())}),e.send(JSON.stringify({type:`join`,name:Wm(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),zm=-1,Bm()}function jh(e,t){Hm=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Ah(new up(e),t)}function Mh(e){Um={id:e.id,name:e.name,createdAt:e.createdAt},Hm=`web-worker (${e.name})`;let t=new lp(new Worker(new URL(`/assets/worker-BwJKPr32.js`,``+import.meta.url),{type:`module`})),n=crypto.getRandomValues(new Uint32Array(1))[0]??1;t.init({save:e.data??void 0,seed:n,preset:e.preset,tamanho:e.tamanho}),Ah(t)}async function Nh(){if(!(Vm instanceof lp)||!Um)return;let e=await Vm.requestSave();await kp({...Um,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{fm(),Nh().finally(()=>location.reload())});var Ph=new URLSearchParams(location.search),Fh=Ph.get(`server`);if(Fh){let e=Ph.get(`codigo`);jh(Fh,{pin:Ph.get(`pin`)??``,...e?{codigo:e}:{}})}else Hp({onPlayWorld:Mh,onPlayMulti:jh});function Ih(e){let t=Vm;if(!t)return;dm(()=>$.active);let n=e.world,r=e.seed,i=wh,a=new Set,s=0,c=new Map,l=0,u=gf(),d=new na({map:u,alphaTest:.5}),f=new na({map:u,transparent:!0,opacity:.72,depthWrite:!1}),p=new na({map:u,transparent:!0,opacity:.4,depthWrite:!1});if(new URLSearchParams(location.search).has(`atlas`)){let e=d.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let m=new $f(n,[d,f,p],gm),h=new yf(gm),g=0,_=-1;i||m.buildAll(),Ch=e=>{let t=[];try{t=Fd(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;a.add(t),c.delete(t),m.enfileirarColuna(e,r)}};let v=(e,r,i)=>{let o=n.dims,s=Dm.raioRender,u=0;for(let d=e-s;d<=e+s;d++)for(let e=r-s;e<=r+s;e++){if(d<0||e<0||d>=o.x||e>=o.z)continue;let r=e*o.x+d;if(a.has(r))continue;let s=c.get(r);if(!s){c.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||u>=4)){m.descartarColuna(d,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+d]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:d,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),u++,l++}}for(let t of c.keys()){let n=t%o.x,i=(t-n)/o.x;(a.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&c.delete(t)}},y=new pm(gm);y.setFromWorld(n);let b=new $p(gm);b.setRegions(ch),lh=e=>{b.setRegions(e),b.clearCorners()};let x=new $p(gm,16747546),S=e=>{x.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};S(dh),fh=e=>{S(e),b.clearCorners(),!uh&&ih!==`professor`&&ue&&(ue=!1),pe()};let C=new rm(gm),w=new am;ph=e=>C.setAll(e,n),mh=e=>C.aplicar(e,n);let T=new $p(gm,3066993),E=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=vh!==null&&r.grupo===vh;(ih===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});T.setRegions(t)};_h=E,gh&&E(gh.objetivos);let D=e=>t.send(JSON.stringify({type:`chat`,text:e})),ee=e=>{e?document.exitPointerLock():$.lock(),Im()};ih===`professor`&&(Am=new Yp(D,ee)),Om=ih===`professor`?new Zp(D,ee,()=>{Om?.hide(),km?.hide(),Am?.show()}):new Qp(D,ee),Eh(),$.onKey(Dm.keys.painel,()=>{if(!Gm.open){if(ih!==`professor`&&yh.length===0){Gm.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}km?.hide(),Am?.hide(),Om?.toggle()}}),ih===`professor`&&Gm.addMessage(`jogo`,`tecla ${Sp(Dm.keys.painel)} abre o painel de autoria`);let O=rh??{x:n.sizeX/2+.5,y:gu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},k=qu(O.x,O.y,O.z);function te(){k.pos.x=O.x,k.pos.y=O.y,k.pos.z=O.z,k.vel.x=k.vel.y=k.vel.z=0}Sh=e=>{n=e.world,r=e.seed,i=wh,a=new Set,c.clear(),m.trocarMundo(n),y.setFromWorld(n),ch=[],b.setRegions([]),b.clearCorners(),C.setAll([],n),gh=null,_h?.([]),hh.update(`livre`,[],{grupo:null,professor:ih===`professor`,painelKey:Sp(Dm.keys.painel)}),bh.clear(),xh=!1,yh=[],vh=null,Eh(),O=rh??O,te(),Gm.addMessage(`jogo`,`a aula mudou — mundo novo carregado`)},nh=e=>{k.pos.x=e.x,k.pos.y=e.y,k.pos.z=e.z,k.vel.x=k.vel.y=k.vel.z=0,$.yaw=Cm??e.yaw,$.pitch=wm??e.pitch},Qm=e=>{hu(n,e.x,e.y,e.z,e.blockId),m.remeshBlock(e.x,e.y,e.z),y.onBlockChanged(e.x,e.y,e.z,e.blockId),C.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Cf(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},$m=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)hu(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};m.remeshBox(t,r),y.onRegionFilled(t,r,e.blockId),C.validarTodos(n),Cf(e.blockId===G.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let A=new Map,j=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Pi(t);i.minFilter=o;let a=new Nr(new yr({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Z.height/2+.35,0),a},ne=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};eh=e=>{let t=A.get(e.id);if(!t){let n=new ti(new Ri(Z.width,Z.height,Z.width),new na({color:new H().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Z.height/2,e.z),n.rotation.y=e.yaw,gm.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},A.set(e.id,t)}e.name&&e.name!==t.labelName&&(ne(t),t.label=j(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Z.height/2,e.z),t.targetYaw=e.yaw},th=e=>{let t=A.get(e);t&&(ne(t),gm.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),A.delete(e))};let re=new Ti(new Wi(new Ri(1,1,1)),new pi({color:0}));re.visible=!1,gm.add(re);let M=null,ie=new B,ae=`lj-hotbar`,oe=Rf(ih),se=()=>oe.slice(0,9).map(e=>e.id),ce=(()=>{let e=new Set(oe.map(e=>e.id));e.add(900);let t=se();try{let n=JSON.parse(localStorage.getItem(ae)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),le=0,ue=!1,N=document.getElementById(`hotbar`),de=Pf(d.map?.image,[...Lf.map(e=>e.id),900]),fe=e=>e===900?`balde vazio`:e===901?`balde de água`:Lf.find(t=>t.id===e)?.name??`?`,pe=()=>{if(!N)return;if(ue){N.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${ih===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=ce.map((e,t)=>`<span class="slot${t===le?` sel`:``}"><small>${t+1}</small><img src="${de.get(e)??``}" alt=""></span>`).join(``);N.innerHTML=`<span class="bar-nome">${fe(ce[le]??G.Grass)}</span><span class="slots">${e}</span>`,km?.refresh()};pe();let me=()=>{ih!==`professor`&&!uh||(ue=!ue,pe())};$.onKey(Dm.keys.varinha,me);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{le=e,pe()});$.onWheel(e=>{le=(le+e+ce.length)%ce.length,pe()}),km=new zf(de,()=>oe,()=>({hotbar:ce,selected:le}),e=>{ce[le]=e,localStorage.setItem(ae,JSON.stringify(ce)),pe()},e=>{le=e,pe()},e=>{e?(Om?.hide(),Am?.hide(),document.exitPointerLock()):$.lock(),Im()}),$.onKey(Dm.keys.inventario,()=>{Gm.open||km?.toggle()});let he=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),b.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(M){if(ue){he(1,M);return}wl(ce[le]??-1)||t.send(JSON.stringify({type:`break_block`,x:M.x,y:M.y,z:M.z}))}}),$.onMouseButton(2,()=>{if(!M)return;if(ue){he(2,M);return}{let e=ce[le];if(wl(e??-1)){if(e===901)t.send(JSON.stringify({type:`balde`,x:M.x+M.nx,y:M.y+M.ny,z:M.z+M.nz,encher:!1})),ce[le]=900;else{if(K(n,M.x,M.y,M.z)!==G.Agua)return;t.send(JSON.stringify({type:`balde`,x:M.x,y:M.y,z:M.z,encher:!0})),ce[le]=901}localStorage.setItem(ae,JSON.stringify(ce)),pe();return}}if(Ll(K(n,M.x,M.y,M.z))){let{x:e,y:n,z:r}=M;w.open(C.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if($l(K(n,M.x,M.y,M.z))){t.send(JSON.stringify({type:`use_block`,x:M.x,y:M.y,z:M.z}));return}let e=ce[le];if(e!==void 0){if((e===G.PortaXFechada||e===G.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?G.PortaXFechada:G.PortaZFechada),(e===G.JanelaXFechada||e===G.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?G.JanelaXFechada:G.JanelaZFechada),Rl(e)||zl(e)||Bl(e)||Ll(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Rl(e)?G.CadeiraXP:zl(e)?G.SofaXP:Bl(e)?G.CamaXP:G.QuadroXP)+r}if(Dl(e)){let t=e-+!!Ol(e);e=M.ny<0?t+1:t}if(Al(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=Pl(Nl(e),r,M.ny<0)}t.send(JSON.stringify({type:`place_block`,x:M.x+M.nx,y:M.y+M.ny,z:M.z+M.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!M||ue)return;let e=K(n,M.x,M.y,M.z);Gl(e)&&(e=G.PortaXFechada),Yl(e)&&(e=G.JanelaXFechada),Rl(e)&&(e=G.CadeiraXP),zl(e)&&(e=G.SofaXP),Bl(e)&&(e=G.CamaXP),Ll(e)&&(e=G.QuadroXP),Dl(e)&&(e=G.LajePedraBaixo+kl(e)*2),Al(e)&&(e=G.EscadaPedraXP+Nl(e)*8),nu(e)&&(ru(e)&&ih!==`professor`||(ce[le]=e,localStorage.setItem(ae,JSON.stringify(ce)),pe()))});let ge=new mp(hm,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Hm});ge.setRemesh({count:m.remeshCount,totalMs:m.remeshMsTotal,lastMs:m.lastRemeshMs}),$.onKey(Dm.keys.hud,()=>ge.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{ge.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),Np()&&(N&&(N.style.pointerEvents=`auto`,N.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(le=n,pe())})),Em=new Ip($,{keys:()=>Dm.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>km?.toggle(),chat:()=>{Gm.open||(document.exitPointerLock(),Gm.openInput())},menu:()=>{$.touch=!1,Fm(),Im()},hud:()=>ge.toggle(),varinha:()=>me()}),Em.setScale(Dm.uiScale),Im()),ge.extra=()=>{let e=$.mouseStats,t=k.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=Au(i,a,r),s=au(o),c=ou(o),l=Math.min(ku(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&o.temp<.6?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===G.GramaSeca?`grama seca`:c===G.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se temp<0.60 · chapada ≥85]\nmouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let _e={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},ve=0;setInterval(()=>{let e={x:k.pos.x,y:k.pos.y,z:k.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==_e.x||e.y!==_e.y||e.z!==_e.z||e.yaw!==_e.yaw||e.pitch!==_e.pitch,r=performance.now();!n&&r-ve<2e3||(_e=e,ve=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof lp&&Um&&(Nh(),setInterval(()=>void Nh(),3e4));let ye={...t.stats};setInterval(()=>{let e=t.stats;ge.net={msgsPerSec:e.msgsIn+e.msgsOut-(ye.msgsIn+ye.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(ye.bytesIn+ye.bytesOut),tickAvgMs:Km.tickAvgMs,tickMaxMs:Km.tickMaxMs,jitterMs:Xm()},ge.stream={colunas:a.size,fila:m.filaPendente,faltando:c.size,repedidas:l},ye={...e}},1e3);let be=performance.now(),xe=!1,Se=!1,Ce=0,we=!1,Te=0,Ee=Z.eyeHeight,De=0;hm.setAnimationLoop(()=>{let e=performance.now(),t=e-be;be=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(Dm.keys.forward)-+!!$.down(Dm.keys.back):0,c=$.active?!!$.down(Dm.keys.right)-+!!$.down(Dm.keys.left):0,l=$.active&&$.down(Dm.keys.jump),d=$.active&&$.down(Dm.keys.forward);d&&!Se&&(e-Ce<300&&(xe=!0),Ce=e),d||(xe=!1),Se=d;let f=$.active&&$.down(Dm.keys.agachar),p=o>0&&!f&&(xe||$.active&&$.down(Dm.keys.correr));l&&!we&&(sh()&&e-Te<300&&(oh=!oh),Te=e),we=l;let y=oh&&sh(),b=!0;if(i){m.processarFila(Dm.meshPorFrame,(e,t)=>{a.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(k.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(k.pos.z/16)));if(b=a.has(r*n.dims.x+t),(s=(s+1)%60)==0){for(let e of a){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>Dm.raioRender+2){a.delete(e),m.descartarColuna(i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}v(t,r,e)}}let x=k.pos.y;b&&id(n,k,{forward:o,strafe:c,jump:l,yaw:$.yaw,sprint:p,sneak:f,fly:y},r);let S=k.pos.y-x;k.onGround&&!y&&S>.01&&S<=.56&&(De=Math.min(De+S,Gu)),De*=Math.exp(-r*14),De<.002&&(De=0),k.pos.y<-16&&te();let C=1-Math.exp(-r*12);for(let e of A.values()){e.mesh.position.lerp(e.target,C);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*C}let w=1-Math.exp(-r*20);Ee+=((f&&!y?Z.sneakEyeHeight:Z.eyeHeight)-Ee)*w;let T=Dm.fov*(k.sprinting?1.1:1);if(Math.abs(_m.fov-T)>.01&&(_m.fov+=(T-_m.fov)*w,_m.updateProjectionMatrix()),_m.position.set(k.pos.x,k.pos.y+Ee-De,k.pos.z),_m.rotation.set($.pitch,$.yaw,0),_m.getWorldDirection(ie),M=$.active?od(n,_m.position.x,_m.position.y,_m.position.z,ie.x,ie.y,ie.z,5,ce[le]===900):null,re.visible=M!==null,M){let[e,t,r,i,a,o]=Iu(K(n,M.x,M.y,M.z));re.position.set(M.x+(e+i)/2,M.y+(t+a)/2,M.z+(r+o)/2),re.scale.set(i-e+.004,a-t+.004,o-r+.004)}ge.setRemesh({count:m.remeshCount,totalMs:m.remeshMsTotal,lastMs:m.lastRemeshMs}),bm.update(r),h.update(n,_m.position.x,_m.position.y,_m.position.z),g+=r;let E=Math.floor(g*8)%16;E!==_&&(_=E,hf(u,E)),ge.frame(t),hm.render(gm,_m)}),new URLSearchParams(location.search).has(`painel`)&&Om?.toggle(),new URLSearchParams(location.search).has(`inv`)&&km?.toggle(),Ph.has(`touch`)&&Lm()}