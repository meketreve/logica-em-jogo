...
`;function jg(e){return!Number.isFinite(e)||e<=0?`—`:e>=1e6?`${(e/1e6).toFixed(1)} Mbps`:e>=1e3?`${(e/1e3).toFixed(0)} kbps`:`${e.toFixed(0)} bps`}function Mg(e){return e>=1e6?`${(e/1e6).toFixed(1)} MB`:e>=1e3?`${(e/1e3).toFixed(0)} kB`:`${e} B`}function Ng(e){return`${(e/1e3).toFixed(1)} s`}var Pg=class{aoFechar;raiz=null;estilo=null;timer=0;fimTimer=0;t0=0;fase=`conectando`;rede=!0;alvo;ler=null;amostraT=0;amostraBytes=0;amostraProntas=0;bps=0;colsPorSeg=0;primeiraAmostra=!0;pctMax=0;acaoBotao=()=>this.fechar();tempos={};faseMedida=`conectando`;faseT0=0;titulo=`carregando o mundo`;concluiu=!1;cargas=[];els=null;constructor(e){this.aoFechar=e}get ativo(){return this.raiz!==null}abrir(e){if(this.raiz)return;this.rede=e.rede,this.alvo=e.alvo,this.fase=`conectando`,this.pctMax=0,this.bps=0,this.colsPorSeg=0,this.t0=this.amostraT=this.faseT0=performance.now(),this.amostraBytes=0,this.amostraProntas=0,this.tempos={},this.faseMedida=`conectando`,this.concluiu=!1,this.titulo=e.titulo??`carregando o mundo`,this.primeiraAmostra=!0,this.estilo=document.createElement(`style`),this.estilo.textContent=Ag,document.head.appendChild(this.estilo),this.raiz=document.createElement(`div`),this.raiz.id=`load-tela`,this.raiz.innerHTML=`
      ...
      <div id="load-giro"></div>`,document.body.appendChild(this.raiz),this.raiz.querySelector(`h1`).textContent=e.titulo??`carregando o mundo`;let t=this.raiz.querySelector(`#load-linhas`),n={},r=[[`colunas`,`colunas prontas`],[`transf`,`em transferência`],[`fila`,`chunks na fila de malha`],[`taxa`,e.rede?`taxa de rede`:`taxa do worker`],[`recebido`,`recebido`],[`tempo`,`tempo`],[`host`,`hospedeiro`]];for(let[e,i]of r){let r=document.createElement(`dt`);r.textContent=i;let a=document.createElement(`dd`);a.textContent=`—`,t.append(r,a),n[e]=a}n.host.textContent=e.host;let i=this.raiz.querySelector(`#load-forcar`);this.acaoBotao=()=>this.fechar(),i.addEventListener(`click`,()=>this.acaoBotao()),this.els={fase:this.raiz.querySelector(`#load-fase`),anel:this.raiz.querySelector(`#load-anel`),arco:this.raiz.querySelector(`#load-arco`),pct:this.raiz.querySelector(`#load-pct`),valores:n,forcar:i},this.pintar(),this.timer=window.setInterval(()=>this.pintar(),250)}observar(e){this.ler=e}setFase(e){!this.raiz||this.fase===e||(this.fase=e,this.pintar())}medir(e,t){this.tempos[this.faseMedida]=(this.tempos[this.faseMedida]??0)+(t-this.faseT0),this.faseT0=t,this.faseMedida=e}relatorio(){return this.cargas}concluir(){!this.raiz||this.fimTimer||(this.concluiu=!0,this.setFase(`pronto`),this.fimTimer=window.setTimeout(()=>this.fechar(),400))}erro(e,t){let n=this.els;n&&(this.pintar(),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,n.fase.textContent=e,n.fase.style.color=`#ff9c9c`,n.anel.classList.remove(`indef`),this.raiz?.querySelector(`#load-giro`)?.classList.add(`hidden`),n.forcar.textContent=`voltar ao menu`,n.forcar.classList.remove(`hidden`),this.acaoBotao=t)}fechar(){if(!this.raiz)return;let e=performance.now();this.medir(this.faseMedida,e);let t=this.ler?.()??null;this.cargas.push({titulo:this.titulo,totalMs:+(e-this.t0).toFixed(0),fasesMs:Object.fromEntries(Object.entries(this.tempos).filter(([,e])=>e>=1).map(([e,t])=>[e,+t.toFixed(0)])),colunas:t?.prontas??0,bytes:t?.bytes??0,concluida:this.concluiu}),clearInterval(this.timer),clearTimeout(this.fimTimer),this.timer=this.fimTimer=0,this.raiz.remove(),this.estilo?.remove(),this.raiz=null,this.estilo=null,this.els=null,this.ler=null,this.aoFechar()}faseEfetiva(e){return this.fase===`mundo`&&e&&e.total>0&&e.prontas>=e.total?`malha`:this.fase}rotuloFase(e){return e===`preparando`?this.alvo?`o servidor está preparando "${this.alvo}"…`:`preparando a aula nova…`:e===`conectando`?this.rede?`conectando ao servidor…`:`abrindo o mundo…`:e===`mundo`?this.rede?`recebendo o mundo…`:`gerando o mundo…`:e===`malha`?`montando a malha…`:`pronto!`}pintar(){let e=this.els;if(!e)return;let t=performance.now(),n=this.ler?.()??null;if(n&&(this.primeiraAmostra||t-this.amostraT>=1e3)){if(!this.primeiraAmostra){let e=(t-this.amostraT)/1e3;this.bps=(n.bytes-this.amostraBytes)*8/e;let r=Math.max(0,(n.prontas-this.amostraProntas)/e);this.colsPorSeg=this.colsPorSeg===0?r:this.colsPorSeg*.6+r*.4}this.primeiraAmostra=!1,this.amostraT=t,this.amostraBytes=n.bytes,this.amostraProntas=n.prontas}let r=this.pctMax;this.fase===`pronto`?r=1:n&&n.total>0&&(r=Math.min(1,Math.max(0,n.prontas/n.total))),this.pctMax=r=Math.max(this.pctMax,r);let i=this.fase!==`pronto`&&(!n||n.total===0);e.anel.classList.toggle(`indef`,i),i?(e.arco.setAttribute(`stroke-dasharray`,`${(kg*.25).toFixed(1)} ${kg.toFixed(1)}`),e.arco.setAttribute(`stroke-dashoffset`,`0`),e.pct.textContent=`…`):(e.arco.setAttribute(`stroke-dasharray`,kg.toFixed(1)),e.arco.setAttribute(`stroke-dashoffset`,(kg*(1-r)).toFixed(1)),e.pct.textContent=`${Math.round(r*100)}%`);let a=this.faseEfetiva(n);a!==this.faseMedida&&this.medir(a,t),e.fase.textContent=this.rotuloFase(a);let o=t-this.t0,s=Ng(o);if(n&&n.total>0&&this.colsPorSeg>.5&&r<1){let e=(n.total-n.prontas)/this.colsPorSeg*1e3;Number.isFinite(e)&&e<6e5&&(s+=` · falta ~${Ng(e)}`)}if(e.valores.tempo.textContent=s,e.valores.taxa.textContent=jg(this.bps),n){let t=n.total>0;e.valores.colunas.textContent=t?`${n.prontas} / ${n.total}`:`—`,e.valores.transf.textContent=t?`${n.faltando}`:`—`,e.valores.fila.textContent=t?`${n.fila}`:`—`,e.valores.recebido.textContent=Mg(n.bytes)}e.forcar.classList.toggle(`hidden`,o<Dg||this.fase===`pronto`)}},Fg={sensitivity:1,fov:75,pixelRatioCap:2,volume:.8,raioRender:6,meshMsPorFrame:6,uiScale:1,nuvens:!0,balanco:!0,keys:{forward:`KeyW`,back:`KeyS`,left:`KeyA`,right:`KeyD`,jump:`Space`,correr:`ControlLeft`,agachar:`ShiftLeft`,chat:`Enter`,hud:`F3`,varinha:`KeyR`,painel:`KeyP`,inventario:`KeyE`,amigos:`KeyG`}},Ig={forward:`andar pra frente`,back:`andar pra trás`,left:`andar pra esquerda`,right:`andar pra direita`,jump:`pular`,correr:`correr (segurar; ou 2× andar pra frente)`,agachar:`agachar (não cai da borda)`,chat:`abrir chat`,hud:`painel de desempenho`,varinha:`varinha de região (professor)`,painel:`painel (professor: autoria · aluno: grupo)`,inventario:`inventário de blocos`,amigos:`painel de amigos (áreas compartilhadas)`},Lg=`lj-config`;function Rg(e,t,n,r){return typeof e==`number`&&Number.isFinite(e)?Math.min(r,Math.max(n,e)):t}function zg(e,t){return typeof e==`boolean`?e:t}function Bg(){let e=null;try{e=JSON.parse(localStorage.getItem(Lg)??`null`)}catch{}let t=typeof e==`object`&&e?e:{},n=typeof t.keys==`object`&&t.keys!==null?t.keys:{},r={...Fg.keys};for(let e of Object.keys(r))typeof n[e]==`string`&&n[e]&&(r[e]=n[e]);return{sensitivity:Rg(t.sensitivity,Fg.sensitivity,.2,3),fov:Rg(t.fov,Fg.fov,60,100),pixelRatioCap:Rg(t.pixelRatioCap,Fg.pixelRatioCap,1,2),volume:Rg(t.volume,Fg.volume,0,1),raioRender:Rg(t.raioRender,Fg.raioRender,2,12),meshMsPorFrame:Rg(t.meshMsPorFrame,Fg.meshMsPorFrame,1,16),uiScale:Rg(t.uiScale,Fg.uiScale,.6,1.8),nuvens:zg(t.nuvens,Fg.nuvens),balanco:zg(t.balanco,Fg.balanco),keys:r}}function Vg(e){localStorage.setItem(Lg,JSON.stringify(e))}function Hg(e){return e.startsWith(`Key`)?e.slice(3):e.startsWith(`Digit`)?e.slice(5):{Space:`Espaço`,Enter:`Enter`,ShiftLeft:`Shift esq.`,ShiftRight:`Shift dir.`,ControlLeft:`Ctrl esq.`,ArrowUp:`↑`,ArrowDown:`↓`,ArrowLeft:`←`,ArrowRight:`→`}[e]??e}var Ug=`logica-em-jogo`,Wg=`worlds`;function Gg(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error??Error(`IndexedDB falhou`))})}var Kg=null;function qg(){return Kg??=new Promise((e,t)=>{let n=indexedDB.open(Ug,1);n.onupgradeneeded=()=>{n.result.createObjectStore(Wg,{keyPath:`id`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB indisponível`))}),Kg}async function Jg(){return(await Gg((await qg()).transaction(Wg).objectStore(Wg).getAll())).sort((e,t)=>t.updatedAt-e.updatedAt)}async function Yg(e){await Gg((await qg()).transaction(Wg,`readwrite`).objectStore(Wg).put(e))}async function Xg(e){await Gg((await qg()).transaction(Wg,`readwrite`).objectStore(Wg).delete(e))}function Zg(e){let t=e.name.replace(/[^\p{L}\p{N} _-]/gu,``).trim()||`mundo`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([e.data],{type:`application/octet-stream`})),n.download=`${t}.ljw`,n.click(),URL.revokeObjectURL(n.href)}async function Qg(e){let t=await e.arrayBuffer();Kp(t);let n=Date.now();return{id:crypto.randomUUID(),name:e.name.replace(/\.ljw$/i,``)||`mundo importado`,createdAt:n,updatedAt:n,data:t}}function $g(){return new URLSearchParams(location.search).has(`touch`)?!0:window.matchMedia(`(pointer: coarse)`).matches}function e_(){document.documentElement.requestFullscreen?.().then(()=>screen.orientation.lock?.(`landscape`)).catch(()=>{})}var t_=`
:root { --ts: 1; }
...
`;function S_(e){return`url("data:image/svg+xml,${encodeURIComponent(e)}")`}var C_=S_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#e23b3b" stroke="#5a0d0d" stroke-width="1.2"/></svg>`),w_=S_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 14.5 1.8 8.3a3.8 3.8 0 0 1 5.4-5.4L8 3.7l.8-.8a3.8 3.8 0 0 1 5.4 5.4z" fill="#1a1a1a" stroke="#000" stroke-width="1.2"/></svg>`),T_=S_(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" fill="#7fd4ff" stroke="#0a3550" stroke-width="1.2"/><circle cx="5.8" cy="5.8" r="1.6" fill="#fff" opacity="0.9"/></svg>`),E_=(e,t,n)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M12.8 12.8 8.6 8.6" stroke="${t}" stroke-width="3" stroke-linecap="round"/><circle cx="12.9" cy="12.9" r="2.1" fill="${t}" stroke="${n}" stroke-width="0.9"/><circle cx="6" cy="6" r="4.7" fill="${e}" stroke="${n}" stroke-width="1.1"/></svg>`,D_=S_(E_(`#b2601f`,`#f3e7cf`,`#4d2a10`)),O_=S_(E_(`#1a1a1a`,`#1a1a1a`,`#000`));function k_(e,t,n){let r=document.createElement(`div`);r.className=`linha`;let i=[];for(let a=0;a<e;a++){let e=document.createElement(`div`);if(e.className=`casa`,n!==void 0){let t=document.createElement(`div`);t.className=`icone fundo`,t.style.backgroundImage=n,e.appendChild(t)}let a=document.createElement(`div`);a.className=`icone`,a.style.backgroundImage=t,e.appendChild(a),r.appendChild(e),i.push(e)}return{linha:r,casas:i}}function A_(e,t){for(let[n,r]of e.entries()){let e=r.lastElementChild;if(!e)continue;let i=t>=(n+1)*2,a=!i&&t===n*2+1;e.style.display=i||a?`block`:`none`,e.classList.toggle(`meio`,a)}}var j_=class{raiz;linhaVida;linhaFome;linhaAr;dano;morte;casasVida;casasFome;casasAr;morteTimer=null;danoTimer=null;ultimaVida=20;visivel=!1;constructor(){let e=document.createElement(`style`);e.textContent=x_,document.head.appendChild(e),this.raiz=document.createElement(`div`),this.raiz.id=`lj-vitals`;let t=k_(__,C_,w_),n=k_(v_,D_,O_),r=k_(y_,T_);this.linhaVida=t.linha,this.casasVida=t.casas,this.linhaFome=n.linha,this.casasFome=n.casas,this.linhaAr=r.linha,this.casasAr=r.casas,this.linhaAr.classList.add(`vazia`),this.linhaFome.classList.add(`vazia`);let i=document.createElement(`div`);i.className=`barras`,i.append(this.linhaVida,this.linhaFome),this.raiz.append(this.linhaAr,i),document.body.appendChild(this.raiz),this.dano=document.createElement(`div`),this.dano.id=`lj-dano`,this.morte=document.createElement(`div`),this.morte.id=`lj-morte`,document.body.append(this.dano,this.morte)}setVisivel(e){this.visivel=e,this.raiz.classList.toggle(`ativo`,e),e||this.esconderMorte()}aplicar(e){let t=Math.max(0,Math.min(20,Math.round(e.vida)));A_(this.casasVida,t),this.desenharFome(e.fome),this.desenharAr(e.folego),t<this.ultimaVida&&this.visivel&&this.piscarDano(),e.morreu&&this.visivel&&this.mostrarMorte(e.causa),this.ultimaVida=t}desenharFome(e){this.linhaFome.classList.toggle(`vazia`,e===void 0),e!==void 0&&A_(this.casasFome,Math.max(0,Math.min(20,Math.round(e))))}desenharAr(e){let t=e===void 0||e>=150;if(this.linhaAr.classList.toggle(`vazia`,t),t)return;let n=Math.max(0,Math.ceil(e/b_));for(let[e,t]of this.casasAr.entries()){let r=t.lastElementChild;r&&(r.style.display=e<n?`block`:`none`)}}piscarDano(){this.dano.classList.add(`piscar`),this.danoTimer!==null&&clearTimeout(this.danoTimer),this.danoTimer=setTimeout(()=>this.dano.classList.remove(`piscar`),90)}mostrarMorte(e){this.morte.textContent=e===`queda`?`Você caiu de muito alto`:e===`afogamento`?`Você ficou sem ar`:e===`fome`?`Você passou fome demais`:`Você não sobreviveu`,this.morte.classList.add(`ativo`),this.morteTimer!==null&&clearTimeout(this.morteTimer),this.morteTimer=setTimeout(()=>this.esconderMorte(),2600)}esconderMorte(){this.morte.classList.remove(`ativo`)}},M_=class{send;onToggle;root=document.getElementById(`amigos`);isOpen=!1;data={eu:``,equipe:null,convites:[],enviados:[],online:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Ym(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=this.btn(e,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)});return n}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}linha(e,...t){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);return r.className=`jog-nome`,r.textContent=e,n.append(r,...t),n}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`amigos`,t.append(n,this.btn(`✕ fechar`,()=>this.hide()));let r=document.createElement(`div`);r.className=`jog-lista`,this.renderConvites(r),this.renderGrupo(r),this.renderConvidar(r),r.append(this.hint(`pelo chat também dá: /amigos convidar nome · /amigos aceitar · /amigos recusar · /amigos sair · /amigos expulsar nome · /amigos lista`)),e.append(t,r)}renderConvites(e){if(this.data.convites.length!==0){e.append(this.sec(`✉ convites para você (${this.data.convites.length})`));for(let t of this.data.convites)e.append(this.linha(`${t} convidou você`,this.btn(`aceitar`,()=>this.send(`/amigos aceitar ${t}`)),this.btn(`recusar`,()=>this.send(`/amigos recusar ${t}`))));e.append(this.hint(`aceitar um convite descarta os outros — você fica em UM grupo só.`))}}renderGrupo(e){let{eu:t,equipe:n}=this.data;if(!n){e.append(this.sec(`👥 seu grupo`)),e.append(this.hint(`Você não está em nenhum grupo. Quem está no seu grupo pode construir na sua ÁREA PROTEGIDA (e você na dele). Cabem 6 pessoas, contando você.`));return}let r=n.dono===t;e.append(this.sec(`👥 grupo de ${n.dono} — ${n.membros.length}/6`));for(let i of n.membros){let a=[i===n.dono?`dono`:``,i===t?`você`:``].filter(e=>e),o=a.length?`${i} (${a.join(`, `)})`:i;e.append(r&&i!==t?this.linha(o,this.armedBtn(`expulsar`,()=>this.send(`/amigos expulsar ${i}`))):this.linha(o))}let i=document.createElement(`div`);i.className=`painel-row`,i.append(r?this.armedBtn(`sair e DESFAZER o grupo`,()=>this.send(`/amigos sair`)):this.armedBtn(`sair do grupo`,()=>this.send(`/amigos sair`))),e.append(i),r&&e.append(this.hint(`você é o dono: se sair, o grupo acaba para todo mundo.`))}renderConvidar(e){let{eu:t,equipe:n,enviados:r,online:i}=this.data;if(e.append(this.sec(`＋ convidar`)),n&&n.dono!==t){e.append(this.hint(`Só ${n.dono} convida para este grupo. Saia dele para montar o seu.`));return}if(n&&n.membros.length>=6){e.append(this.hint(`Grupo cheio (6/6).`));return}for(let t of r)e.append(this.linha(`${t} — convite enviado, aguardando`));let a=new Set(n?.membros??[]),o=i.filter(e=>e!==t&&!a.has(e)&&!r.includes(e));for(let t of o)e.append(this.linha(t,this.btn(`convidar`,()=>this.send(`/amigos convidar ${t}`))));o.length===0&&r.length===0&&e.append(this.hint(`ninguém mais está na aula agora.`))}},N_=class{send;onToggle;root=document.getElementById(`jogadores`);isOpen=!1;aba=`conectados`;data={conectados:[],banidos:[]};onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Ym(`click`)})}get open(){return this.isOpen}update(e){this.data=e,this.isOpen&&this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}render(){let e=this.root;if(!e)return;e.replaceChildren();let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);n.textContent=`jogadores`;let r=document.createElement(`button`);r.type=`button`,r.textContent=`✕ fechar`,r.addEventListener(`click`,()=>this.hide()),t.append(n,r);let i=document.createElement(`div`);i.className=`inv-abas`;let a=[{id:`conectados`,label:`conectados (${this.data.conectados.length})`},{id:`banidos`,label:`banidos (${this.data.banidos.length})`}];for(let e of a){let t=document.createElement(`button`);t.type=`button`,t.className=`inv-aba`+(e.id===this.aba?` sel`:``),t.textContent=e.label,t.addEventListener(`click`,()=>{this.aba=e.id,this.render()}),i.appendChild(t)}let o=document.createElement(`div`);o.className=`jog-lista`,this.aba===`conectados`?this.renderConectados(o):this.renderBanidos(o),e.append(t,i,o)}renderConectados(e){if(this.data.conectados.length===0){e.append(this.hint(`ninguém conectado agora.`));return}for(let t of this.data.conectados){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t.papel===`professor`?`${t.name} (professor)`:t.name,n.append(r),t.papel!==`professor`&&n.append(this.armedBtn(`expulsar`,()=>this.send(`/kicar ${t.name}`)),this.armedBtn(`banir`,()=>this.send(`/banir ${t.name}`))),e.append(n)}}renderBanidos(e){if(this.data.banidos.length===0){e.append(this.hint(`ninguém banido. Bane pela aba “conectados” ou com /banir nome.`));return}for(let t of this.data.banidos){let n=document.createElement(`div`);n.className=`jog-row`;let r=document.createElement(`span`);r.className=`jog-nome`,r.textContent=t;let i=document.createElement(`button`);i.type=`button`,i.textContent=`desbanir`,i.addEventListener(`click`,()=>this.send(`/desbanir ${t}`)),n.append(r,i),e.append(n)}}},P_=class{send;onToggle;root=document.getElementById(`painel`);data={regions:[],modo:`sequencial`,objetivos:[],grupos:[],myGrupo:null};isOpen=!1;dirty=!1;onEsc=e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation(),this.hide())};constructor(e,t){this.send=e,this.onToggle=t,this.root?.addEventListener(`click`,e=>{e.target instanceof HTMLElement&&e.target.closest(`button`)&&Ym(`click`)}),this.root?.addEventListener(`focusout`,()=>{this.dirty&&this.isOpen&&(this.dirty=!1,this.render())})}get open(){return this.isOpen}update(e){if(this.data=e,!this.isOpen)return;let t=document.activeElement;if(t&&this.root?.contains(t)&&(t instanceof HTMLInputElement||t instanceof HTMLSelectElement)){this.dirty=!0;return}this.render()}toggle(){this.isOpen?this.hide():this.show()}show(){this.isOpen||!this.root||(this.isOpen=!0,this.render(),this.root.classList.remove(`hidden`),window.addEventListener(`keydown`,this.onEsc,!0),this.onToggle(!0))}hide(){this.isOpen&&(this.isOpen=!1,this.root?.classList.add(`hidden`),window.removeEventListener(`keydown`,this.onEsc,!0),this.onToggle(!1))}head(e){let t=document.createElement(`div`);t.className=`painel-head`;let n=document.createElement(`h2`);return n.textContent=e,t.append(n,this.btn(`✕ fechar`,()=>this.hide())),t}sec(e){let t=document.createElement(`h3`);return t.textContent=e,t}btn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,t),n}armedBtn(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{if(n.dataset.armado){t();return}n.dataset.armado=`1`,n.textContent=`confirma?`,n.classList.add(`painel-armado`),window.setTimeout(()=>{delete n.dataset.armado,n.textContent=e,n.classList.remove(`painel-armado`)},3e3)}),n}row(...e){let t=document.createElement(`div`);t.className=`painel-row`;for(let n of e)if(typeof n==`string`){let e=document.createElement(`span`);e.textContent=n,t.appendChild(e)}else t.appendChild(n);return t}hint(e){let t=document.createElement(`p`);return t.className=`painel-hint`,t.textContent=e,t}select(e,t,n){let r=document.createElement(`select`);for(let t of e)r.appendChild(new Option(t.label,t.value));return e.some(e=>e.value===t)&&(r.value=t),n(r.value),r.addEventListener(`change`,()=>n(r.value)),r}textInput(e,t,n,r){let i=document.createElement(`input`);return i.type=`text`,i.placeholder=e,i.value=t,r&&(i.size=r,i.classList.add(`painel-input-curto`)),i.addEventListener(`input`,()=>n(i.value)),i}},F_=class extends P_{onOpenPlayers;constructor(e,t,n){super(e,t),this.onOpenPlayers=n}draft={objKind:`construir`,objModelo:``,objAlvo:``,objRegra:`um`,objTexto:``,regiaoNome:``,encherRegiao:``,encherBloco:String(_h[0]?.id??1),carimbModelo:``,carimbPrefixo:``,carimbEsp:`2`,carimbEixo:`x`,grupoN:`4`};editandoId=null;editandoTexto=``;erroMsg=``;flash(e){this.erroMsg=e,this.render()}cmd(e){this.erroMsg=``,this.send(e)}regionOptions(e){let t=new Set(this.data.regions.map(e=>e.nome)),n=this.data.regions.map(e=>{let t=Ru(e);return{value:e.nome,label:`${e.nome} (${t.x}×${t.y}×${t.z})`}});if(e&&this.data.grupos.length>0)for(let e of t){let r=/^(.+)-1$/.exec(e);r?.[1]&&!t.has(r[1])&&n.push({value:r[1],label:`${r[1]}-1…${this.data.grupos.length} (uma área por grupo)`})}return n}estadoDe(e){if(e.porGrupo?.length){let t=e.porGrupo.filter(e=>e.completo).length;return t===e.porGrupo.length?`✓ todos os grupos`:`${t}/${e.porGrupo.length} grupos ✓`}return e.completo?`✓ concluído`:e.ativo?`ativo`:`aguardando`}render(){let e=this.root;if(e){if(e.textContent=``,e.append(this.head(`painel de autoria`)),this.onOpenPlayers&&e.append(this.row(this.btn(`👥 jogadores (expulsar / banir)`,()=>this.onOpenPlayers?.()))),this.erroMsg){let t=document.createElement(`p`);t.className=`painel-erro`,t.textContent=this.erroMsg,e.append(t)}this.renderAtividade(e),this.renderObjetivos(e),this.renderRegioes(e),this.renderGrupos(e),e.append(this.hint(`as respostas dos comandos aparecem no chat (canto inferior esquerdo)`))}}renderAtividade(e){e.append(this.sec(`▶ começar a aula`)),e.append(this.row(this.armedBtn(`▶ iniciar atividade`,()=>this.cmd(`/iniciar`)),this.btn(`↦ levar grupos às áreas`,()=>this.cmd(`/tp grupos`)))),e.append(this.hint(`iniciar zera o progresso e leva cada grupo à sua área · pelo chat: /iniciar · /tp grupos`))}renderObjetivos(e){e.append(this.sec(`🎯 objetivos`));let t=this.row(`modo:`);for(let e of[`sequencial`,`livre`]){let n=this.btn(e===this.data.modo?`● ${e}`:e,()=>this.cmd(`/objetivo modo ${e}`));e===this.data.modo&&(n.disabled=!0),t.append(n)}t.append(`(sequencial = um de cada vez, na ordem)`),e.append(t),this.data.objetivos.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`painel-obj`;let i=document.createElement(`div`);if(i.textContent=`#${t.id} ${t.kind} → ${t.regiao} — ${this.estadoDe(t)}`,r.append(i),this.editandoId===t.id){let e=this.textInput(`texto do objetivo`,this.editandoTexto,e=>{this.editandoTexto=e}),n=this.btn(`salvar`,()=>{let e=this.editandoTexto.trim();e&&(this.editandoId=null,this.cmd(`/objetivo texto ${t.id} ${e}`),this.render())}),i=this.btn(`cancelar`,()=>{this.editandoId=null,this.render()});r.append(this.row(e,n,i))}else{let e=document.createElement(`small`);e.textContent=t.texto,r.append(e);let i=this.btn(`↑`,()=>this.cmd(`/objetivo mover ${t.id} ${n}`));i.disabled=n===0;let a=this.btn(`↓`,()=>this.cmd(`/objetivo mover ${t.id} ${n+2}`));a.disabled=n===this.data.objetivos.length-1;let o=this.btn(`✎ texto`,()=>{this.editandoId=t.id,this.editandoTexto=t.texto,this.render()});r.append(this.row(i,a,o,this.armedBtn(`✕ remover`,()=>this.cmd(`/objetivo remover ${t.id}`))))}e.append(r)}),e.append(this.sec(`＋ novo objetivo`));let n=this.select([{value:`construir`,label:`construir (copiar um modelo)`},{value:`chegar`,label:`chegar (ir até uma área)`},{value:`limpar`,label:`limpar (esvaziar uma área)`}],this.draft.objKind,e=>{this.draft.objKind=e});n.addEventListener(`change`,()=>this.render()),e.append(this.row(`tipo:`,n));let r=this.regionOptions(!0);if(r.length===0)e.append(this.hint(`crie uma região antes (seção regiões, logo abaixo)`));else{if(this.draft.objKind===`construir`){let t=this.select(this.regionOptions(!1),this.draft.objModelo,e=>{this.draft.objModelo=e}),n=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});e.append(this.row(`modelo:`,t),this.row(`alvo:`,n)),e.append(this.hint(`fotografa o modelo AGORA (construa antes); o alvo precisa ter o mesmo tamanho`))}else{let t=this.select(r,this.draft.objAlvo,e=>{this.draft.objAlvo=e});if(e.append(this.row(`área:`,t)),this.draft.objKind===`chegar`){let t=this.select([{value:`um`,label:`basta um do grupo chegar`},{value:`todos`,label:`o grupo todo dentro, junto`}],this.draft.objRegra,e=>{this.draft.objRegra=e});e.append(this.row(`conclui quando:`,t))}}let t=this.textInput(`texto que o aluno vê (ex.: Copie o padrão do modelo)`,this.draft.objTexto,e=>{this.draft.objTexto=e}),n=this.btn(`criar objetivo`,()=>{let e=this.draft.objTexto.trim();if(!e){this.flash(`escreva o texto do objetivo`);return}let t=this.draft.objKind;if(t===`construir`)this.cmd(`/objetivo add construir ${this.draft.objModelo} ${this.draft.objAlvo} ${e}`);else if(t===`chegar`){let t=this.draft.objRegra===`todos`?`todos `:``;this.cmd(`/objetivo add chegar ${this.draft.objAlvo} ${t}${e}`)}else this.cmd(`/objetivo add limpar ${this.draft.objAlvo} ${e}`);this.draft.objTexto=``,this.render()});e.append(this.row(t,n))}this.data.objetivos.length>0&&e.append(this.row(this.armedBtn(`zerar progresso da turma`,()=>this.cmd(`/objetivo resetar`))))}renderRegioes(e){e.append(this.sec(`📐 regiões`));for(let t of this.data.regions){let n=Ru(t),r=this.row(`${t.nome} — ${n.x}×${n.y}×${n.z} em (${t.min.x}, ${t.min.y}, ${t.min.z})`);r.classList.add(`painel-obj`),r.append(this.armedBtn(`apagar`,()=>this.cmd(`/regiao apagar ${t.nome}`))),e.append(r)}e.append(this.hint(`criar: tecla R no jogo (varinha), clique esq/dir marca os 2 cantos, aí:`));let t=this.textInput(`nome da região (sem espaços)`,this.draft.regiaoNome,e=>{this.draft.regiaoNome=e}),n=this.btn(`criar região`,()=>{let e=this.draft.regiaoNome.trim();if(!e){this.flash(`dê um nome pra região`);return}if(/\s/.test(e)){this.flash(`nome de região não pode ter espaço`);return}this.draft.regiaoNome=``,this.cmd(`/regiao criar ${e}`),this.render()});if(e.append(this.row(t,n)),this.data.regions.length>0){let t=this.select(this.regionOptions(!1),this.draft.encherRegiao,e=>{this.draft.encherRegiao=e}),n=[{value:`0`,label:`ar (limpar)`},..._h.map(e=>({value:String(e.id),label:e.name}))],r=this.select(n,this.draft.encherBloco,e=>{this.draft.encherBloco=e});if(e.append(this.row(`encher`,t,`com`,r,this.btn(`aplicar`,()=>this.cmd(`/regiao encher ${this.draft.encherRegiao} ${this.draft.encherBloco}`)))),this.data.grupos.length>0){let t=this.select(this.regionOptions(!1),this.draft.carimbModelo,e=>{this.draft.carimbModelo=e}),n=this.textInput(`prefixo`,this.draft.carimbPrefixo,e=>{this.draft.carimbPrefixo=e},10),r=this.textInput(`espaço`,this.draft.carimbEsp,e=>{this.draft.carimbEsp=e},4),i=this.select([{value:`x`,label:`eixo x`},{value:`z`,label:`eixo z`}],this.draft.carimbEixo,e=>{this.draft.carimbEixo=e}),a=this.btn(`carimbar: 1 cópia por grupo`,()=>{let e=this.draft.carimbPrefixo.trim(),t=Number(this.draft.carimbEsp);if(!e||/\s/.test(e)){this.flash(`prefixo precisa ser uma palavra sem espaço`);return}if(!Number.isInteger(t)||t<0){this.flash(`espaçamento precisa ser um número inteiro ≥ 0`);return}this.cmd(`/regiao carimbar ${this.draft.carimbModelo} ${e} ${t}`+(this.draft.carimbEixo===`z`?` z`:``))});e.append(this.row(`carimbar`,t,n,r,i,a)),e.append(this.hint(`carimbar copia a região (com blocos!) e nomeia prefixo-1…N — as áreas dos grupos`))}else e.append(this.hint(`a ferramenta de carimbar (1 área por grupo) aparece depois de criar grupos`))}}renderGrupos(e){e.append(this.sec(`👥 grupos`));for(let t of this.data.grupos){let n=this.row(`grupo ${t.id} (${t.membros.length}): ${t.membros.join(`, `)||`—`}`);n.classList.add(`painel-obj`),e.append(n)}let t=this.textInput(`nº`,this.draft.grupoN,e=>{this.draft.grupoN=e},4),n=e=>{let t=Number(this.draft.grupoN);if(!Number.isInteger(t)||t<1){this.flash(`quantidade precisa ser um número ≥ 1`);return}this.cmd(`/grupo criar ${t}${e?` alunos`:``}`)};e.append(this.row(t,this.armedBtn(`criar N grupos`,()=>n(!1)),this.armedBtn(`grupos de N alunos`,()=>n(!0)))),e.append(this.hint(this.data.grupos.length?`criar de novo redistribui a turma e ZERA o progresso por grupo`:`criar grupos distribui os alunos online automaticamente (professor fica fora)`))}},I_=class extends P_{render(){let e=this.root;if(!e)return;if(e.textContent=``,e.append(this.head(`grupos`)),this.data.grupos.length===0){e.append(this.hint(`o professor ainda não criou grupos`));return}let t=this.data.myGrupo;e.append(this.hint(t===null?`você está SEM grupo — entre num grupo pra participar dos objetivos`:`você está no grupo ${t}`));for(let n of this.data.grupos){let r=this.row(`grupo ${n.id} (${n.membros.length}): ${n.membros.join(`, `)||`—`}`);r.classList.add(`painel-obj`),r.append(n.id===t?this.btn(`sair`,()=>this.send(`/grupo sair`)):this.btn(`entrar`,()=>this.send(`/grupo entrar ${n.id}`))),e.append(r)}e.append(this.hint(`pelo chat também dá: /grupo entrar n · /grupo sair`))}},L_=class{fixedColor;group=new cn;cornerMarks=[];boxes=[];bounds=[];culling=null;constructor(e,t){this.fixedColor=t,e.add(this.group);for(let e of[16765952,58879]){let t=new Ci(new Hi(new Ii(1.01,1.01,1.01)),new di({color:e}));t.visible=!1,this.group.add(t),this.cornerMarks.push(t)}}setCorner(e,t,n,r){let i=this.cornerMarks[e-1];i&&(i.position.set(t+.5,n+.5,r+.5),i.visible=!0)}clearCorners(){for(let e of this.cornerMarks)e.visible=!1}setRegions(e){for(let e of this.boxes)this.group.remove(e),e.geometry.dispose(),e.material.dispose();if(this.boxes=e.map((e,t)=>{let n=e.max.x-e.min.x+1,r=e.max.y-e.min.y+1,i=e.max.z-e.min.z+1,a=new Ci(new Hi(new Ii(n+.04,r+.04,i+.04)),new di({color:this.fixedColor??new W().setHSL(t*.618034%1,.9,.55)}));return a.position.set(e.min.x+n/2,e.min.y+r/2,e.min.z+i/2),this.group.add(a),a}),this.bounds=e,this.culling){let{px:e,pz:t,raio:n}=this.culling;this.cularPorDistancia(e,t,n)}}cularPorDistancia(e,t,n){this.culling={px:e,pz:t,raio:n};for(let r=0;r<this.boxes.length;r++){let i=this.boxes[r],a=this.bounds[r];if(!i||!a)continue;let o=Math.max(a.min.x-e,0,e-(a.max.x+1)),s=Math.max(a.min.z-t,0,t-(a.max.z+1));i.visible=Math.max(o,s)<=n}}},R_=1/16,z_=[{dx:.129,dz:.5,ry:Math.PI/2},{dx:.5,dz:.129,ry:0},{dx:1-2*R_-.004,dz:.5,ry:-Math.PI/2},{dx:.5,dz:1-2*R_-.004,ry:Math.PI}];function B_(e,t,n){let r=e.getContext(`2d`);if(!r)return;let i=e.width,a=e.height;r.fillStyle=`#f2eee4`,r.fillRect(0,0,i,a);let o=0,s=a;if(n){let e=t.texto?Math.floor(a*.68):a,c=Math.min(i/n.width,e/n.height),l=n.width*c,u=n.height*c;r.drawImage(n,(i-l)/2,(e-u)/2,l,u),o=e,s=a-e}if(t.texto){r.fillStyle=`#22201c`,r.font=`bold 22px sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`;let e=i-20,n=[],a=``;for(let i of t.texto.split(/\s+/)){let t=a?`${a} ${i}`:i;r.measureText(t).width>e&&a?(n.push(a),a=i):a=t}a&&n.push(a);let c=Math.max(1,Math.floor((s-8)/26)),l=n.slice(0,c),u=o+s/2-(l.length-1)*26/2;l.forEach((t,n)=>r.fillText(t,i/2,u+n*26,e))}}var V_=class{scene;planes=new Map;conteudos=new Map;constructor(e){this.scene=e}get(e,t,n){return this.conteudos.get(mp(e,t,n))??null}setAll(e,t){for(let e of[...this.planes.keys()])this.remover(e);this.conteudos.clear();for(let n of e)this.aplicar(n,t)}aplicar(e,t){let n=mp(e.x,e.y,e.z);if(this.remover(n),!e.texto&&!e.imagem){this.conteudos.delete(n);return}this.conteudos.set(n,e);let r=Pu(t,e.x,e.y,e.z);if(!Xl(r))return;let i=z_[r-K.QuadroXP];if(!i)return;let a=document.createElement(`canvas`);a.width=128,a.height=128,B_(a,e,null);let o=new Mi(a);o.colorSpace=Le;let s=new $r(new Ui(12*R_,12*R_),new Vr({map:o}));if(s.position.set(e.x+i.dx,e.y+.5,e.z+i.dz),s.rotation.y=i.ry,this.scene.add(s),this.planes.set(n,{mesh:s,tex:o}),e.imagem){let t=new Image;t.onload=()=>{B_(a,e,t),o.needsUpdate=!0},t.src=e.imagem}}onBlockChanged(e,t,n,r,i){let a=mp(e,t,n);if(this.conteudos.has(a))if(!Xl(r))this.remover(a),this.conteudos.delete(a);else{let e=this.conteudos.get(a);e&&this.aplicar(e,i)}}validarTodos(e){for(let[t,n]of[...this.conteudos.entries()])Xl(Pu(e,n.x,n.y,n.z))||(this.remover(t),this.conteudos.delete(t))}remover(e){let t=this.planes.get(e);t&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),t.tex.dispose(),this.planes.delete(e))}};async function H_(e){let t=await new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(String(r.result)),r.onerror=()=>n(Error(`falha ao ler o arquivo`)),r.readAsDataURL(e)}),n=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`arquivo não é uma imagem`)),r.src=t}),r=document.createElement(`canvas`),i=Math.min(1,192/Math.max(n.width,n.height));r.width=Math.max(1,Math.round(n.width*i)),r.height=Math.max(1,Math.round(n.height*i));let a=r.getContext(`2d`);if(!a)return null;a.drawImage(n,0,0,r.width,r.height);for(let e of[.75,.55,.35]){let t=r.toDataURL(`image/jpeg`,e);if(t.length<=32768)return t}return null}var U_=class{root=null;get aberto(){return this.root!==null}open(e,t){if(this.root)return;document.exitPointerLock();let n=e?.imagem,r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);z-index:40`;let i=document.createElement(`div`);i.style.cssText=`background:#1d222b;color:#e8e8e8;border-radius:10px;padding:16px;width:min(420px,92vw);display:flex;flex-direction:column;gap:10px;font:14px sans-serif`,i.innerHTML=`<b style="font-size:16px">✏️ Editar quadro</b>`;let a=document.createElement(`textarea`);a.maxLength=300,a.value=e?.texto??``,a.placeholder=`texto do quadro…`,a.style.cssText=`width:100%;height:84px;resize:vertical;background:#12151b;color:#e8e8e8;border:1px solid #3a4150;border-radius:6px;padding:8px;font:14px sans-serif`,a.addEventListener(`keydown`,e=>e.stopPropagation());let o=document.createElement(`input`);o.type=`file`,o.accept=`image/*`,o.style.cssText=`color:#aab`;let s=document.createElement(`div`);s.style.cssText=`min-height:18px;color:#8fa;font-size:12px`,n&&(s.textContent=`quadro tem uma imagem (escolher outra substitui)`);let c=document.createElement(`div`);c.style.cssText=`display:flex;gap:8px;justify-content:flex-end;flex-wrap:wrap`;let l=e=>{let t=document.createElement(`button`);return t.textContent=e,t.style.cssText=`padding:8px 14px;border-radius:6px;border:1px solid #3a4150;background:#2a3140;color:#e8e8e8;cursor:pointer;font:14px sans-serif`,c.appendChild(t),t},u=l(`tirar imagem`);u.style.display=n?``:`none`;let d=l(`cancelar`),f=l(`salvar`);f.style.background=`#3d6b3f`,u.addEventListener(`click`,()=>{n=void 0,o.value=``,u.style.display=`none`,s.textContent=`imagem removida (salve para confirmar)`});let p=e=>{r.remove(),this.root=null,window.removeEventListener(`keydown`,m,!0),t(e)},m=e=>{e.code===`Escape`&&(e.stopPropagation(),p(null))};window.addEventListener(`keydown`,m,!0),d.addEventListener(`click`,()=>p(null)),f.addEventListener(`click`,()=>{let e=o.files?.[0];if(!e){p({texto:a.value,...n?{imagem:n}:{}});return}s.textContent=`comprimindo imagem…`,H_(e).then(e=>{if(e===null){s.textContent=`essa imagem não coube nem comprimida — tente outra`,s.style.color=`#f88`;return}p({texto:a.value,imagem:e})}).catch(()=>{s.textContent=`não deu pra ler esse arquivo como imagem`,s.style.color=`#f88`})}),i.append(a,o,s,c),r.appendChild(i),document.body.appendChild(r),this.root=r,a.focus()}},W_=null;function G_(e){e.preventDefault(),e.returnValue=``}var K_=new Set([`F1`,`F5`,`F6`,`F7`,`F10`,`F12`]);function q_(e){W_?.()&&(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement||(e.ctrlKey||e.metaKey||e.altKey||e.code===`Tab`||K_.has(e.code))&&e.preventDefault())}function J_(e){W_?.()&&e.code.startsWith(`Alt`)&&e.preventDefault()}function Y_(e){W_||(W_=e,window.addEventListener(`beforeunload`,G_),window.addEventListener(`keydown`,q_,!0),window.addEventListener(`keyup`,J_,!0),navigator.keyboard?.lock?.([`KeyW`,`KeyT`,`KeyN`,`KeyR`,`F4`])?.catch(()=>{}))}function X_(){W_=null,window.removeEventListener(`beforeunload`,G_),window.removeEventListener(`keydown`,q_,!0),window.removeEventListener(`keyup`,J_,!0),navigator.keyboard?.unlock?.()}var Z_=class{scene;sprites=new Map;material;constructor(e){this.scene=e;let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);if(!n)throw Error(`canvas 2d indisponível`);let r=n.createRadialGradient(32,32,2,32,32,32);r.addColorStop(0,`rgba(255,225,140,0.55)`),r.addColorStop(.5,`rgba(255,190,80,0.18)`),r.addColorStop(1,`rgba(255,170,60,0)`),n.fillStyle=r,n.fillRect(0,0,64,64);let i=new Mi(t);i.minFilter=o,this.material=new _r({map:i,blending:2,depthWrite:!1,transparent:!0})}setFromWorld(e){this.clear();let{x:t,y:n,z:r}=e.dims;for(let i=0;i<n;i++)for(let n=0;n<r;n++)for(let r=0;r<t;r++)this.varrerChunk(e,r,i,n)}varrerColuna(e,t,n){for(let r=0;r<e.dims.y;r++)this.varrerChunk(e,t,r,n)}descartarColuna(e,t){for(let[n,r]of this.sprites){let[i=0,,a=0]=n.split(`,`).map(Number);Math.floor(i/16)===e&&Math.floor(a/16)===t&&(this.scene.remove(r),this.sprites.delete(n))}}varrerChunk(e,t,n,r){let i=e.chunks[ju(e,t,n,r)];if(i)for(let e=0;e<16;e++)for(let a=0;a<16;a++)for(let o=0;o<16;o++)i[(e*16+a)*16+o]===K.Tocha&&this.add(t*16+o,n*16+e,r*16+a)}onBlockChanged(e,t,n,r){r===K.Tocha?this.add(e,t,n):this.remove(e,t,n)}onRegionFilled(e,t,n){if(n===K.Tocha){for(let n=e.y;n<=t.y;n++)for(let r=e.z;r<=t.z;r++)for(let i=e.x;i<=t.x;i++)this.add(i,n,r);return}for(let n of[...this.sprites.keys()]){let[r=0,i=0,a=0]=n.split(`,`).map(Number);r>=e.x&&r<=t.x&&i>=e.y&&i<=t.y&&a>=e.z&&a<=t.z&&this.remove(r,i,a)}}add(e,t,n){let r=`${e},${t},${n}`;if(this.sprites.has(r))return;let i=new jr(this.material);i.scale.set(2.4,2.4,1),i.position.set(e+.5,t+.55,n+.5),this.scene.add(i),this.sprites.set(r,i)}remove(e,t,n){let r=`${e},${t},${n}`,i=this.sprites.get(r);i&&(this.scene.remove(i),this.sprites.delete(r))}clear(){for(let e of this.sprites.values())this.scene.remove(e);this.sprites.clear()}};function Q_(e){let t=/dispon[ií]veis:\s*(.+?)\.\s*(?:para trocar|para continuar)/i.exec(e)?.[1];if(!t)return;let n=t.split(`·`).map(e=>e.replace(/\(em curso\)/i,``).trim()).filter(Boolean);n.length&&Dh(n)}var $_=new _l({antialias:!0});$_.setPixelRatio(Math.min(window.devicePixelRatio,2)),$_.setSize(window.innerWidth,window.innerHeight),document.body.appendChild($_.domElement);var ev=new _n;ev.background=new W(8900331);var tv=new ja(75,window.innerWidth/window.innerHeight,.1,512);tv.rotation.order=`YXZ`;var nv=new Pa(16777215,2.2);nv.position.set(60,100,40);var rv=new Fa(16777215,.55);ev.add(nv,rv);var iv=new sg(nv,rv,ev,tv),av=(()=>{let e=new URLSearchParams(location.search).get(`hora`);if(e===null)return null;let t=Number(e);return Number.isFinite(t)?t:null})();av!==null&&iv.sync(av,!1);var ov=new ug,sv=(()=>{let e=new URLSearchParams(location.search).get(`vento`);if(e===null)return null;let[t,n]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{dir:t,forca:Number.isFinite(n)?n:.6}})();sv&&ov.sync(sv.dir,sv.forca,!0);var cv=fg(),$=new Eg($_.domElement);$.touchDevice=$g();var lv=e=>{let t=new URLSearchParams(location.search).get(e);if(t===null)return null;let n=Number(t);return Number.isFinite(n)?n:null},uv=lv(`yaw`),dv=lv(`pitch`);uv!==null&&($.yaw=uv),dv!==null&&($.pitch=dv);var fv=ah(new URLSearchParams(location.search));function pv(){let e=fv?{...Bg(),...oh(fv)}:Bg();return $.sensitivity=e.sensitivity,tv.fov=e.fov,tv.updateProjectionMatrix(),$_.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap)),qm(e.volume),mv?.setScale(e.uiScale),iv.setNuvens(e.nuvens),e}var mv=null,hv=pv();Zm(hv.volume);var gv=null,_v=null,vv=null,yv=null,bv=null,xv={equipe:null,convites:[],enviados:[]},Sv=new Pg(()=>{jv(),Tv?.setFase(`jogando`),Tv?.marcar(`carga concluída`),Cv?.()}),Cv=null,wv=!1,Tv=null,Ev=document.getElementById(`overlay`),Dv=document.getElementById(`overlay-main`),Ov=document.getElementById(`overlay-config`),kv=document.getElementById(`crosshair`);function Av(){Dv?.classList.remove(`hidden`),Ov?.classList.add(`hidden`)}function jv(){let e=(gv?.open??!1)||(_v?.open??!1)||(vv?.open??!1)||(yv?.open??!1)||(bv?.open??!1);Ev?.classList.toggle(`hidden`,wv||Sv.ativo||$.active||Vv.open||e),kv?.classList.toggle(`hidden`,!$.active),$.locked&&Av(),mv?.setShown($.touch&&!Vv.open&&!e&&!Sv.ativo)}document.addEventListener(`pointerlockchange`,jv);function Mv(){$g()?($.touch=!0,e_(),jv()):$.lock()}function Nv(){let e=hv.keys;hv=pv();for(let t of[`chat`,`hud`,`varinha`,`painel`,`inventario`,`amigos`])$.rebind(e[t],hv.keys[t]);Fv()}var Pv=-1;function Fv(){if(!Iv||hv.raioRender===Pv)return;let e=Pv;Pv=hv.raioRender,Iv.send(JSON.stringify({type:`radius`,chunks:Pv})),Tv?.marcar(`raio`,`${e<0?`join`:e} → ${Pv}`)}document.getElementById(`overlay-voltar`)?.addEventListener(`click`,()=>Mv()),document.getElementById(`overlay-config-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`overlay-config-body`);e&&u_(e,Nv,Av),Dv?.classList.add(`hidden`),Ov?.classList.remove(`hidden`)}),document.getElementById(`overlay-telacheia`)?.addEventListener(`click`,()=>{e_()}),document.getElementById(`overlay-hud`)?.addEventListener(`click`,()=>{Tv?.toggle()}),Ev?.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`button`):null;t&&Ym(t.classList.contains(`menu-back`)?`back`:`click`)}),window.addEventListener(`resize`,()=>{tv.aspect=window.innerWidth/window.innerHeight,tv.updateProjectionMatrix(),$_.setSize(window.innerWidth,window.innerHeight)});var Iv=null,Lv=`?`,Rv=null;function zv(){return new URLSearchParams(location.search).get(`nome`)??a_()}function Bv(e){return e.trim().toLowerCase()!==`/amigos`||!yv?!1:(gv?.hide(),_v?.hide(),vv?.hide(),yv.toggle(),!0)}var Vv=new Ph(e=>{Bv(e)||Iv?.send(JSON.stringify({type:`chat`,text:e}))},e=>{jv(),e||$.lock()});jv(),$_.domElement.addEventListener(`pointerdown`,()=>{$.touch&&Vv.open&&Vv.close()});var Hv={tickAvgMs:0,tickMaxMs:0},Uv=null,Wv=0,Gv=[];function Kv(){let e=performance.now();Wv>0&&(Gv.push(e-Wv),Gv.length>300&&Gv.shift()),Wv=e}function qv(){let e=Gv.length;if(e<2)return 0;let t=Gv.reduce((e,t)=>e+t,0)/e,n=Gv.reduce((e,n)=>e+(n-t)**2,0)/e;return Math.round(Math.sqrt(n))}var Jv=!1,Yv=null,Xv=null,Zv=null,Qv=null,$v=null,ey=null,ty=null,ny=`aluno`,ry=!1,iy=!1,ay=`criativo`,oy=!1;function sy(){return yf(ay)&&(ny===`professor`||ry)}var cy=new g_,ly=null,uy=null;function dy(){return uy??=new j_,uy}var fy=null,py=(()=>{let e=new URLSearchParams(location.search).get(`vida`);if(e===null)return null;let[t,n,r]=e.split(`,`).map(Number);return t===void 0||!Number.isFinite(t)?null:{vida:t,...Number.isFinite(n)?{folego:n}:{},...Number.isFinite(r)?{fome:r}:{}}})();py&&(dy().setVisivel(!0),dy().aplicar(py));{let e=new URLSearchParams(location.search).get(`mochila`);if(e!==null){let t=[];e.split(`,`).forEach((e,n)=>{let[r,i]=e.split(`x`).map(Number);r===void 0||!Number.isInteger(r)||r<=0||t.push({slot:n,id:r,qtd:Number.isInteger(i)&&i>0?i:1})}),cy.travar(t)}}var my=[],hy=null,gy=!1,_y=!1,vy=[],yy=null,by=null,xy=null,Sy=new h_,Cy=null,wy=null,Ty=null,Ey=[],Dy=new Set,Oy=!1,ky=null,Ay=null,jy=!1,My=new Map;function Ny(){gv?.update({regions:my,modo:Cy?.modo??`sequencial`,objetivos:Cy?.objetivos??[],grupos:Ey,myGrupo:Ty})}function Py(){yv?.update({eu:zv(),equipe:xv.equipe,convites:xv.convites,enviados:xv.enviados,online:[...new Set(My.values())].sort()})}function Fy(e){return e.porGrupo&&ny!==`professor`?Ty===null?!1:e.porGrupo.find(e=>e.grupo===Ty)?.completo??!1:e.completo}function Iy(e){if(Cy){for(let t of Cy.objetivos)Fy(t)?Dy.has(t.id)||(Dy.add(t.id),e&&Oy&&Hm({kind:`objective_complete`})):Dy.delete(t.id);Oy=!0,Sy.update(Cy.modo,Cy.objetivos,{grupo:Ty,professor:ny===`professor`,painelKey:Hg(hv.keys.painel)}),wy?.(Cy.objetivos)}}var Ly=null;function Ry(){let e=Ly;if(e){Ly=null;for(let t of e)By(t)}}function zy(){Ly||(Ly=[],requestAnimationFrame(()=>requestAnimationFrame(Ry)),setTimeout(Ry,500))}function By(e){if(Ly){Ly.push(e);return}if(Kv(),Jv||Sv.setFase(`mundo`),typeof e==`string`){let t=Fp(e);if(!t)return;if(t.type===`debug_stats`)Hv={tickAvgMs:t.tickAvgMs,tickMaxMs:t.tickMaxMs},Uv=t.regrasCelulasAvg===void 0?null:{celulasPorTick:t.regrasCelulasAvg,celulasMaxTick:t.regrasCelulasMax??0,mudancasPorTick:t.regrasMudancasAvg??0,aguaPorTick:t.regrasAguaAvg??0};else if(t.type===`block_changed`)Yv?.(t);else if(t.type===`blocks_filled`)Xv?.(t);else if(t.type===`player_moved`)t.name&&My.get(t.id)!==t.name&&(My.set(t.id,t.name),Oh([...new Set(My.values())]),Py()),Zv?.(t);else if(t.type===`player_left`)My.delete(t.id),Oh([...new Set(My.values())]),Py(),Qv?.(t.id);else if(t.type===`spawn`)ty={x:t.x,y:t.y,z:t.z},ny=t.papel??`aluno`;else if(t.type===`regions`)my=t.regions,hy?.(t.regions),Ny();else if(t.type===`objectives`)Cy={modo:t.modo,objetivos:t.objetivos},Iy(!0),Ny();else if(t.type===`group`)Ty=t.grupo,Dy.clear(),Iy(!1),Ny();else if(t.type===`groups`)Ey=t.grupos,Ny();else if(t.type===`quadros`)by?.(t.lista);else if(t.type===`quadro_changed`)xy?.(t);else if(t.type===`container`)bv?.atualizar(t);else if(t.type===`container_fechado`)bv?.fecharSemAvisar();else if(t.type===`claims`)gy=t.ativo,t.ativo&&!_y&&(_y=!0,Vv.addMessage(`jogo`,`tecla ${Hg(hv.keys.amigos)} abre o painel de amigos — quem está no seu grupo constrói na sua área`)),vy=t.claims,yy?.(t.claims);else if(t.type===`friends`)xv={equipe:t.equipe,convites:t.convites,enviados:t.enviados},Py();else if(t.type===`players`)vv?.update({conectados:t.conectados,banidos:t.banidos});else if(t.type===`mundo_trocando`)$v?.(t.nome),zy();else if(t.type===`teleport`)ey?.(t);else if(t.type===`time`)av===null&&iv.sync(t.hora,t.ciclo);else if(t.type===`vento`)sv===null&&ov.sync(t.dir,t.forca,t.ativo);else if(t.type===`voo`)ry=t.liberado,sy()||(iy=!1),Vv.addMessage(`jogo`,t.liberado?`voo liberado — dois toques no espaço para voar (espaço sobe, agachar desce)`:`voo trancado pela turma`);else if(t.type===`modo`){let e=ay!==t.efetivo;ay=t.efetivo,oy=t.pvp===!0,sy()||(iy=!1),py===null&&(t.efetivo===`sobrevivencia`?dy().setVisivel(!0):uy?.setVisivel(!1)),t.efetivo===`criativo`&&cy.ativa&&(cy.desligar(),ly?.()),e&&Vv.addMessage(`jogo`,t.efetivo===`sobrevivencia`?`modo sobrevivência — não dá para voar`:`modo criativo`)}else if(t.type===`inventario`)cy.aplicar(t.slots),ly?.();else if(t.type===`vida`){if(py!==null)return;fy=t,dy().aplicar(t),t.causa&&Hm({kind:`dano`}),t.morreu&&(Hm({kind:`morte`}),Vv.addMessage(`jogo`,t.causa===`queda`?`você caiu de muito alto — voltou ao ponto de partida`:t.causa===`afogamento`?`você ficou sem ar — voltou ao ponto de partida`:t.causa===`fome`?`você passou fome demais — voltou ao ponto de partida`:t.causa===`pvp`?`você foi derrubado por outro jogador — voltou ao ponto de partida`:`você não sobreviveu — voltou ao ponto de partida`))}else t.type===`kicked`?(Ym(`denied`),sessionStorage.setItem(`lj-erro`,t.reason),X_(),location.href=location.pathname):t.type===`join_denied`?(Ym(`denied`),sessionStorage.setItem(`lj-erro`,`não deu pra entrar: ${t.reason}`),X_(),location.href=location.pathname):t.type===`chat`&&(Vv.addMessage(t.author,t.text),t.author===`servidor`&&Q_(t.text),Hm({kind:`chat_message`}));return}let t=zp(e);if(t===809716300){Ay?.(e);return}let n=()=>(jy=t===Lp,jy?Bp(e):Ip(e));if(Jv){ky?.(n());return}Jv=!0,qy(n())}function Vy(e,t){hv=pv(),Iv=e,Sv.abrir({host:Lv,rede:!(e instanceof hg)}),Sv.observar(()=>({bytes:e.stats.bytesIn+e.stats.bytesOut,prontas:0,total:0,faltando:0,fila:0})),jv(),e.onMessage(By),$.onKey(hv.keys.chat,()=>{Vv.open||(document.exitPointerLock(),Vv.openInput())}),e.send(JSON.stringify({type:`join`,name:zv(),...t?{pin:t.pin}:{},...t?.codigo?{codigo:t.codigo}:{}})),Pv=-1,Fv()}function Hy(e,t){Lv=e;let n=document.getElementById(`btn-sair`);n&&(n.textContent=`voltar ao menu`),Vy(new gg(e,t=>{Jv||!Sv.ativo||Sv.erro(t,()=>{sessionStorage.setItem(`lj-erro`,`${t} (${e})`),location.href=location.pathname})}),t)}function Uy(e,t){Rv={id:e.id,name:e.name,createdAt:e.createdAt},Lv=`web-worker (${e.name})`;let n=new hg(new Worker(new URL(`/assets/worker-DFUsK0cJ.js`,``+import.meta.url),{type:`module`})),r=t??crypto.getRandomValues(new Uint32Array(1))[0]??1;n.init({save:e.data??void 0,seed:r,preset:e.preset,tamanho:e.tamanho,sobrevivencia:e.sobrevivencia}),Vy(n)}async function Wy(){if(!(Iv instanceof hg)||!Rv)return;let e=await Iv.requestSave();await Yg({...Rv,updatedAt:Date.now(),data:e})}document.getElementById(`btn-sair`)?.addEventListener(`click`,()=>{X_(),Wy().finally(()=>location.reload())});var Gy=new URLSearchParams(location.search),Ky=Gy.get(`server`);if(Ky){let e=Gy.get(`codigo`);Hy(Ky,{pin:Gy.get(`pin`)??``,...e?{codigo:e}:{}})}else fv?Uy({id:`bench-${Qm}`,name:`benchmark`,createdAt:0,data:null,preset:`normal`,tamanho:sd(Gy.get(`tamanho`)??`E`)},Qm):l_({onPlayWorld:Uy,onPlayMulti:Hy});function qy(e){let t=Iv;if(!t)return;Y_(()=>$.active);let n=e.world,r=e.seed,i=new URLSearchParams(location.search).has(`semluz`),a=gd(n.dims),s=[],c=new Set,l=0,u=0,d=jy,f=new Set,p=0,m=new Map,h=0,g=0,_=0,v=Fm(),y=new ea({map:v,alphaTest:.5});dg(y,cv);let b=pg();mg(y,b);let x=new ea({map:v,transparent:!0,opacity:.72,depthWrite:!1}),S=new ea({map:v,transparent:!0,opacity:.4,depthWrite:!1});if(mg(x,b),mg(S,b),new URLSearchParams(location.search).has(`atlas`)){let e=y.map?.image;e.style.cssText=`position:fixed;right:8px;top:8px;width:256px;image-rendering:pixelated;z-index:20;border:1px solid #000`,document.body.appendChild(e)}let C=new URLSearchParams(location.search),w=C.has(`semworker`),T=Number(C.get(`meshdepth`)),E=new Vh(n,[y,x,S],ev,!w,Number.isFinite(T)&&T>0?T:void 0,i?void 0:a),D=new Rm(ev),ee=-1,O=0,k=-1,te=-1,A=(e,t)=>{for(let n=0;n<e.dims.x;n++)for(let r=0;r<e.dims.z;r++)Rd(e,t,n,r)};d||(i||A(n,a),E.buildAll()),Ay=e=>{let t=[];try{t=Hp(e,n)}catch(e){console.warn(`[streaming] lote de colunas inválido, será repedido:`,e);return}for(let{cx:e,cz:r}of t){let t=r*n.dims.x+e;f.add(t),m.delete(t),c.has(t)||(c.add(t),s.push({cx:e,cz:r})),ne.varrerColuna(n,e,r)}g+=t.length};let j=(e,r,i)=>{let o=n.dims,s=hv.raioRender,c=0;for(let l=e-s;l<=e+s;l++)for(let e=r-s;e<=r+s;e++){if(l<0||e<0||l>=o.x||e>=o.z)continue;let r=e*o.x+l;if(f.has(r))continue;let s=m.get(r);if(!s){m.set(r,{tentativas:0,proximo:i+4e3});continue}if(!(i<s.proximo||c>=4)){E.descartarColuna(l,e),ne.descartarColuna(l,e),bd(a,l,e);for(let t=0;t<o.y;t++)n.chunks[(t*o.z+e)*o.x+l]=void 0;t.send(JSON.stringify({type:`pedir_coluna`,cx:l,cz:e})),s.tentativas++,s.proximo=i+Math.min(3e4,2e3*2**(s.tentativas-1)),c++,h++}}for(let t of m.keys()){let n=t%o.x,i=(t-n)/o.x;(f.has(t)||Math.max(Math.abs(n-e),Math.abs(i-r))>s)&&m.delete(t)}},ne=new Z_(ev);ne.setFromWorld(n);let re=new L_(ev);re.setRegions(my),hy=e=>{re.setRegions(e),re.clearCorners()};let M=new L_(ev,16747546),ie=e=>{M.setRegions(e.map(e=>({nome:e.dono,min:e.min,max:e.max})))};ie(vy),yy=e=>{ie(e),re.clearCorners(),!gy&&ny!==`professor`&&Ee&&(Ee=!1,mv?.setVarinha(!1)),mv?.setVarinhaDisponivel(ny===`professor`||gy),mv?.setAmigosDisponivel(gy),Ae()};let ae=new V_(ev),oe=new U_;by=e=>ae.setAll(e,n),xy=e=>ae.aplicar(e,n);let se=new L_(ev,3066993),ce=e=>{let t=[];for(let n of e)if(n.porGrupo){let e=!1;for(let r of n.porGrupo){let i=Ty!==null&&r.grupo===Ty;(ny===`professor`||i)&&r.ativo&&!r.completo&&(t.push({nome:`${n.regiao} g${r.grupo}`,min:r.min,max:r.max}),e=!0)}e&&n.kind===`construir`&&t.push({nome:`modelo ${n.regiao}`,min:n.min,max:n.max})}else n.ativo&&!n.completo&&t.push({nome:n.regiao,min:n.min,max:n.max});se.setRegions(t)};wy=ce,Cy&&ce(Cy.objetivos);let le=e=>t.send(JSON.stringify({type:`chat`,text:e})),ue=e=>{e?document.exitPointerLock():$.lock(),jv()};ny===`professor`&&(vv=new N_(le,ue)),yv=new M_(le,ue),Py(),gv=ny===`professor`?new F_(le,ue,()=>{gv?.hide(),_v?.hide(),yv?.hide(),vv?.show()}):new I_(le,ue),Ny(),$.onKey(hv.keys.painel,()=>{if(!Vv.open){if(ny!==`professor`&&Ey.length===0){Vv.addMessage(`jogo`,`o professor ainda não criou grupos — o painel abre quando existirem`);return}_v?.hide(),vv?.hide(),yv?.hide(),gv?.toggle()}}),$.onKey(hv.keys.amigos,()=>{Vv.open||(gv?.hide(),_v?.hide(),vv?.hide(),yv?.toggle())}),ny===`professor`&&Vv.addMessage(`jogo`,`tecla ${Hg(hv.keys.painel)} abre o painel de autoria`);let N=ty??{x:n.sizeX/2+.5,y:Iu(n,Math.floor(n.sizeX/2),Math.floor(n.sizeZ/2)),z:n.sizeZ/2+.5},P=Qf(N.x,N.y,N.z),de=()=>{if(!d)return 0;let e=hv.raioRender,t=Math.max(0,Math.min(n.dims.x-1,Math.floor(P.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(P.pos.z/16))),i=Math.min(n.dims.x-1,t+e)-Math.max(0,t-e)+1,a=Math.min(n.dims.z-1,r+e)-Math.max(0,r-e)+1;return Math.max(1,i*a)},fe=de(),pe=()=>{Sv.observar(()=>({bytes:t.stats.bytesIn+t.stats.bytesOut,prontas:f.size,total:fe,faltando:m.size>0?m.size:Math.max(0,fe-f.size),fila:E.filaPendente}))};pe(),Sv.setFase(d?`mundo`:`malha`),$v=e=>{fe=0,Sv.abrir({host:Lv,rede:!(t instanceof hg),titulo:`trocando de aula`,alvo:e}),pe(),Sv.setFase(`preparando`),Ne.setFase(`carregando`),Ne.marcar(`troca de aula`,e),jv()};function me(){P.pos.x=N.x,P.pos.y=N.y,P.pos.z=N.z,P.vel.x=P.vel.y=P.vel.z=0}ky=e=>{n=e.world,r=e.seed,d=jy,f=new Set,m.clear(),a=gd(n.dims),s.length=0,c.clear(),!d&&!i&&A(n,a),E.trocarMundo(n,!d,i?void 0:a),ne.setFromWorld(n),my=[],re.setRegions([]),re.clearCorners(),ae.setAll([],n),Cy=null,wy?.([]),Sy.update(`livre`,[],{grupo:null,professor:ny===`professor`,painelKey:Hg(hv.keys.painel)}),Dy.clear(),Oy=!1,Ey=[],Ty=null,Ny(),N=ty??N,me(),Vv.addMessage(`jogo`,`a aula mudou — mundo novo carregado`),Pv=-1,Fv(),Ne.setMeta({worldChunks:n.dims,worldSeed:e.seed}),fe=de(),Sv.abrir({host:Lv,rede:!(t instanceof hg),titulo:`trocando de aula`}),pe(),Sv.setFase(d?`mundo`:`malha`),Ne.setFase(`carregando`),jv(),d||Sv.concluir()},ey=e=>{P.pos.x=e.x,P.pos.y=e.y,P.pos.z=e.z,P.vel.x=P.vel.y=P.vel.z=0,$.yaw=uv??e.yaw,$.pitch=dv??e.pitch},Yv=e=>{Fu(n,e.x,e.y,e.z,e.blockId),E.remeshBlock(e.x,e.y,e.z),i||E.remeshSujos(zd(n,a,e.x,e.y,e.z)),ne.onBlockChanged(e.x,e.y,e.z,e.blockId),ae.onBlockChanged(e.x,e.y,e.z,e.blockId,n),Hm(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})},Xv=e=>{for(let t=e.y0;t<=e.y1;t++)for(let r=e.z0;r<=e.z1;r++)for(let i=e.x0;i<=e.x1;i++)Fu(n,i,t,r,e.blockId);let t={x:e.x0,y:e.y0,z:e.z0},r={x:e.x1,y:e.y1,z:e.z1};for(let t=Math.max(0,e.x0/16|0);t<=Math.min(n.dims.x-1,e.x1/16|0);t++)for(let r=Math.max(0,e.z0/16|0);r<=Math.min(n.dims.z-1,e.z1/16|0);r++)i||E.remeshSujos(Rd(n,a,t,r));E.remeshBox(t,r),ne.onRegionFilled(t,r,e.blockId),ae.validarTodos(n),Hm(e.blockId===K.Air?{kind:`block_broken`}:{kind:`block_placed`,blockId:e.blockId})};let he=new Map,ge=e=>{let t=document.createElement(`canvas`),n=t.getContext(`2d`),r=`bold 32px sans-serif`;n.font=r,t.width=Math.ceil(n.measureText(e).width)+20,t.height=44,n.font=r,n.fillStyle=`rgba(0,0,0,0.4)`,n.fillRect(0,0,t.width,t.height),n.fillStyle=`#fff`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,t.width/2,t.height/2);let i=new Mi(t);i.minFilter=o;let a=new jr(new _r({map:i,depthTest:!1,transparent:!0}));a.renderOrder=999;let s=.32;return a.scale.set(s*t.width/t.height,s,1),a.position.set(0,Z.height/2+.35,0),a},_e=e=>{e.label&&=(e.label.material.map?.dispose(),e.label.material.dispose(),e.mesh.remove(e.label),void 0)};Zv=e=>{let t=he.get(e.id);if(!t){let n=new $r(new Ii(Z.width,Z.height,Z.width),new ea({color:new W().setHSL(e.id*.618034%1,.7,.5)}));n.position.set(e.x,e.y+Z.height/2,e.z),n.rotation.y=e.yaw,ev.add(n),t={mesh:n,target:n.position.clone(),targetYaw:e.yaw},he.set(e.id,t)}e.name&&e.name!==t.labelName&&(_e(t),t.label=ge(e.name),t.labelName=e.name,t.mesh.add(t.label)),t.target.set(e.x,e.y+Z.height/2,e.z),t.targetYaw=e.yaw},Qv=e=>{let t=he.get(e);t&&(_e(t),ev.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),he.delete(e))};let ve=new Ci(new Hi(new Ii(1,1,1)),new di({color:0}));ve.visible=!1,ev.add(ve);let F=null,ye=null,be=new H,xe=`lj-hotbar`,Se=vh(ny),Ce=()=>Se.slice(0,9).map(e=>e.id),we=(()=>{let e=new Set(Se.map(e=>e.id));e.add(900);let t=Ce();try{let n=JSON.parse(localStorage.getItem(xe)??`null`);return Array.isArray(n)?t.map((t,r)=>{let i=n[r];return typeof i==`number`&&e.has(i)?i:t}):t}catch{return t}})(),Te=0,Ee=!1,De=document.getElementById(`hotbar`),Oe=mh(y.map?.image,[..._h.map(e=>e.id),900,902,903,904,905,906,907,908,909,910,911,912,913,914,915]),ke=e=>e===900?`balde vazio`:e===901?`balde de água`:e===902?`fruta`:e===903?`trigo`:e===904?`pão`:e===905?`carvão`:e===906?`diamante`:e===907?`graveto`:e===908?`carvão vegetal`:e===909?`lingote de ferro`:e===910?`lingote de ouro`:e===911?`algodão`:e===912?`picareta de madeira`:e===913?`picareta de pedra`:e===914?`picareta de ferro`:e===915?`picareta de diamante`:_h.find(t=>t.id===e)?.name??`?`,Ae=()=>{if(!De)return;if(Ee){De.innerHTML=`<b>[varinha]</b> esq = canto 1 · dir = canto 2 · ${ny===`professor`?`/regiao criar nome`:`/claim criar`} · R/🪄 volta`;return}let e=cy.ativa?cy.hotbar():we,t=e.map((e,t)=>{let n=t===Te?` sel`:``;if(e==null)return`<span class="slot${n} vazio"><small>${t+1}</small></span>`;let r=cy.ativa?cy.qtdDoSlot(t):0,i=r>1?`<b class="qtd">${r}</b>`:``;return`<span class="slot${n}"><small>${t+1}</small><img src="${Oe.get(e)??``}" alt="">${i}</span>`}).join(``),n=e[Te];De.innerHTML=`<span class="bar-nome">${n==null?`mão vazia`:ke(n)}</span><span class="slots">${t}</span>`,_v?.refresh(),bv?.refresh()},je=()=>cy.ativa?cy.idDoSlot(Te):we[Te]??null;ly=()=>Ae(),Ae();let Me=()=>{ny!==`professor`&&!gy||(Ee=!Ee,mv?.setVarinha(Ee),Ae())};$.onKey(hv.keys.varinha,Me);for(let e=0;e<9;e++)$.onKey(`Digit${e+1}`,()=>{Te=e,Ae()});$.onWheel(e=>{Te=(Te+e+we.length)%we.length,Ae()}),De?.addEventListener(`pointerdown`,e=>{let t=e.target?.closest?.(`.slot`);if(!t)return;let n=[...De.querySelectorAll(`.slot`)].indexOf(t);n<0||(e.preventDefault(),Te=n,Ae())}),_v=new bh(Oe,()=>Se,()=>({hotbar:we,selected:Te}),e=>{we[Te]=e,localStorage.setItem(xe,JSON.stringify(we)),Ae()},e=>{Te=e,Ae()},e=>{e?(gv?.hide(),vv?.hide(),yv?.hide(),document.exitPointerLock()):$.lock(),jv()},cy,(e,n)=>t.send(JSON.stringify({type:`mover_item`,de:e,para:n})),ke,e=>t.send(JSON.stringify({type:`fabricar`,receita:e}))),$.onKey(hv.keys.inventario,()=>{Vv.open||_v?.toggle()}),bv=new yh(Oe,cy,ke,(e,n,r,i,a)=>t.send(JSON.stringify({type:`mover_container`,x:e,y:n,z:r,de:i,para:a})),()=>t.send(JSON.stringify({type:`fechar_container`})),e=>{e?(gv?.hide(),vv?.hide(),yv?.hide(),_v?.hide(),document.exitPointerLock()):$.lock(),jv()});let I=(e,n)=>{t.send(JSON.stringify({type:`wand_mark`,corner:e,x:n.x,y:n.y,z:n.z})),re.setCorner(e,n.x,n.y,n.z)};$.onMouseButton(0,()=>{if(ye&&!Ee){t.send(JSON.stringify({type:`atacar`,alvo:ye.id}));return}if(F){if(Ee){I(1,F);return}Al(je()??-1)&&ay!==`criativo`||t.send(JSON.stringify({type:`break_block`,x:F.x,y:F.y,z:F.z}))}}),$.onMouseButton(2,()=>{if(cy.ativa&&Wu(je()??-1)){t.send(JSON.stringify({type:`comer`,slot:Te}));return}if(!F)return;if(Ee){I(2,F);return}{let e=je();if(Al(e??-1)){let r=cy.ativa?{slot:Te}:{};if(e===901)t.send(JSON.stringify({type:`balde`,x:F.x+F.nx,y:F.y+F.ny,z:F.z+F.nz,encher:!1,...r})),cy.ativa||(we[Te]=900);else{if(Pu(n,F.x,F.y,F.z)!==K.Agua)return;t.send(JSON.stringify({type:`balde`,x:F.x,y:F.y,z:F.z,encher:!0,...r})),cy.ativa||(we[Te]=901)}cy.ativa||(localStorage.setItem(xe,JSON.stringify(we)),Ae());return}}if(Xl(Pu(n,F.x,F.y,F.z))){let{x:e,y:n,z:r}=F;oe.open(ae.get(e,n,r),i=>{$.lock(),i&&t.send(JSON.stringify({type:`quadro_set`,x:e,y:n,z:r,texto:i.texto,...i.imagem?{imagem:i.imagem}:{}}))});return}if(nd(Pu(n,F.x,F.y,F.z))!==null){t.send(JSON.stringify({type:`use_block`,x:F.x,y:F.y,z:F.z}));return}if(pu(Pu(n,F.x,F.y,F.z))){t.send(JSON.stringify({type:`use_block`,x:F.x,y:F.y,z:F.z}));return}let e=je();if(e!==null){if((e===K.PortaXFechada||e===K.PortaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.PortaXFechada:K.PortaZFechada),(e===K.JanelaXFechada||e===K.JanelaZFechada)&&(e=Math.abs(Math.sin($.yaw))>Math.abs(Math.cos($.yaw))?K.JanelaXFechada:K.JanelaZFechada),Zl(e)||Ql(e)||$l(e)||Xl(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4;e=(Zl(e)?K.CadeiraXP:Ql(e)?K.SofaXP:$l(e)?K.CamaXP:K.QuadroXP)+r}if(El(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw);e=kl(((Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3)+2)%4)}if(Bl(e)){let t=e-+!!Vl(e);e=F.ny<0?t+1:t}if(Ul(e)){let t=-Math.sin($.yaw),n=-Math.cos($.yaw),r=Math.abs(t)>Math.abs(n)?t>0?0:2:n>0?1:3;e=ql(Kl(e),r,F.ny<0)}t.send(JSON.stringify({type:`place_block`,x:F.x+F.nx,y:F.y+F.ny,z:F.z+F.nz,blockId:e}))}}),$.onMouseButton(1,()=>{if(!F||Ee||cy.ativa)return;let e=Pu(n,F.x,F.y,F.z);au(e)&&(e=K.PortaXFechada),lu(e)&&(e=K.JanelaXFechada),Zl(e)&&(e=K.CadeiraXP),Ql(e)&&(e=K.SofaXP),$l(e)&&(e=K.CamaXP),Xl(e)&&(e=K.QuadroXP),El(e)&&(e=K.Fornalha),Bl(e)&&(e=K.LajePedraBaixo+Hl(e)*2),Ul(e)&&(e=K.EscadaPedraXP+Kl(e)*8),gu(e)&&(_u(e)&&ny!==`professor`||(we[Te]=e,localStorage.setItem(xe,JSON.stringify(we)),Ae()))});let Ne=new Tg($_,{checkpoint:14,worldChunks:n.dims,worldSeed:e.seed,serverHost:Lv});Tv=Ne,Ne.contexto=()=>({x:P.pos.x,y:P.pos.y,z:P.pos.z,yaw:$.yaw,pitch:$.pitch,voando:iy&&sy(),noChao:P.onGround,raioRender:hv.raioRender,meshMsPorFrame:hv.meshMsPorFrame,pixelRatioCap:hv.pixelRatioCap,fov:hv.fov,nuvens:hv.nuvens,balanco:hv.balanco,distanciaTotal:_,colunasRecebidas:g,bytesRecebidos:t.stats.bytesIn}),Ne.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),Ne.carga=()=>Sv.relatorio(),Ne.marcar(`join`,`${n.dims.x}×${n.dims.z}×${n.dims.y} chunks · seed ${e.seed}`);let Pe=null;if(fv){let e=async e=>{try{let t=await fetch(`/perfil`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify(e)}),n=await t.json();if(!t.ok||!n.arquivo)throw Error(`resposta inesperada (${t.status})`);Vv.addMessage(`jogo`,`benchmark concluído — perfil salvo no servidor: ${n.arquivo}`)}catch{let t=fv.semVida?`bench-semvida`:`bench`;Ne.baixar(e,t),Vv.addMessage(`jogo`,`benchmark concluído — o perfil foi baixado (perf-${t}-*.json)`)}};Cv=()=>{if(Pe)return;Pe=sh.paraMundo(fv,N,n.dims),Ne.setMeta({bench:Pe.meta()}),Ne.marcar(`bench: início`,`${fv.duracaoS}s · raio ${Pe.trajeto.raio}${fv.semVida?` · sem vida ambiental`:``}`),wv=!0,window.__benchRodando=!0,iy=!0,jv(),Pe.iniciar(performance.now());let t=Pe.amostra(performance.now());P.pos.x=Le=t.x,P.pos.y=Re=t.y,P.pos.z=ze=t.z,Ne.record(t=>{wv=!1,window.__benchRodando=!1,jv(),window.__benchPerfil=t,e(t)},fv.duracaoS*1e3)}}$.onKey(hv.keys.hud,()=>Ne.toggle()),document.getElementById(`hud-report`)?.addEventListener(`click`,()=>{Ne.record(e=>{t.send(JSON.stringify({type:`profile_report`,stats:e}))})}),$g()&&(De&&(De.style.pointerEvents=`auto`,De.addEventListener(`click`,e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.slot`):null,n=t?.parentElement?Array.from(t.parentElement.children).indexOf(t):-1;n<0||(Te=n,Ae())})),mv=new r_($,{keys:()=>hv.keys,quebrar:()=>$.press(0),colocar:()=>$.press(2),copiar:()=>$.press(1),inventario:()=>_v?.toggle(),chat:()=>{Vv.open||(document.exitPointerLock(),Vv.openInput())},menu:()=>{$.touch=!1,Av(),jv()},hud:()=>Ne.toggle(),varinha:()=>Me(),amigos:()=>{gv?.hide(),_v?.hide(),vv?.hide(),yv?.toggle()}}),mv.setVarinhaDisponivel(ny===`professor`||gy),mv.setAmigosDisponivel(gy),mv.setScale(hv.uiScale),jv()),Ne.extra=()=>{let e=$.mouseStats,t=P.pos,i=Math.floor(t.x),a=Math.floor(t.z),o=fd(i,a,r),s=yu(o),c=bu(o),l=Math.min(dd(i,a,r,n.sizeY),n.sizeY-2),u=l<=23?`areia (praia)`:l>=58&&s.neve?`neve`:l>=85?`pedra (chapada)`:s.topo===`grama`?c===K.GramaSeca?`grama seca`:c===K.GramaFria?`grama fria`:`grama`:`areia (caatinga)`;return`pos ${t.x.toFixed(1)} ${t.y.toFixed(1)} ${t.z.toFixed(1)}  bloco ${Math.floor(t.x)} ${Math.floor(t.y)} ${Math.floor(t.z)}\nbioma ${s.nome}  temp ${o.temp.toFixed(2)}  umid ${o.umid.toFixed(2)}  seed ${r}\nterreno h ${l}  topo ${u}  [praia ≤23 · neve ≥58 se o bioma neva · chapada ≥85]\nrelevo ${wu(o).toFixed(2)} (teto do bioma ${s.relevo})\nmodo ${ay===`sobrevivencia`?`sobrevivência`:`criativo`}  voo ${sy()?iy?`voando`:`liberado`:`trancado`}`+(fy?`  vida ${fy.vida}/20`+(fy.fome===void 0?`  sem fome`:`  fome ${fy.fome}/20`):``)+`
mouse Δmáx ${e.maxDelta}px  descartados ${e.dropped} (último ${e.lastDropped}px)`};let Fe={x:NaN,y:NaN,z:NaN,yaw:NaN,pitch:NaN},L=0;setInterval(()=>{let e={x:P.pos.x,y:P.pos.y,z:P.pos.z,yaw:$.yaw,pitch:$.pitch},n=e.x!==Fe.x||e.y!==Fe.y||e.z!==Fe.z||e.yaw!==Fe.yaw||e.pitch!==Fe.pitch,r=performance.now();!n&&r-L<2e3||(Fe=e,L=r,t.send(JSON.stringify({type:`move`,...e})))},1e3/10),t instanceof hg&&Rv&&!fv&&(Wy(),setInterval(()=>void Wy(),3e4));let Ie={...t.stats};setInterval(()=>{let e=t.stats;Ne.net={msgsPerSec:e.msgsIn+e.msgsOut-(Ie.msgsIn+Ie.msgsOut),bytesPerSec:e.bytesIn+e.bytesOut-(Ie.bytesIn+Ie.bytesOut),tickAvgMs:Hv.tickAvgMs,tickMaxMs:Hv.tickMaxMs,jitterMs:qv()},Ne.regras=Uv,Ne.stream={colunas:f.size,fila:E.filaPendente,faltando:m.size,repedidas:h,ultimoLote:E.ultimoLote},Ne.luz={colunas:u,totalMs:l,fila:s.length},Ie={...e}},1e3);let R=performance.now(),Le=P.pos.x,Re=P.pos.y,ze=P.pos.z,Be=!1,Ve=!1,He=0,Ue=!1,We=0,Ge=Z.eyeHeight,Ke=0;$_.setAnimationLoop(()=>{let e=performance.now(),t=e-R;R=e;let r=Math.min(t/1e3,.05),o=$.active?!!$.down(hv.keys.forward)-+!!$.down(hv.keys.back):0,m=$.active?!!$.down(hv.keys.right)-+!!$.down(hv.keys.left):0,h=$.active&&$.down(hv.keys.jump),g=$.active&&$.down(hv.keys.forward);g&&!Ve&&(e-He<300&&(Be=!0),He=e),g||(Be=!1),Ve=g;let y=$.active&&$.down(hv.keys.agachar),x=o>0&&!y&&(Be||$.active&&$.down(hv.keys.correr));h&&!Ue&&(sy()&&e-We<300&&(iy=!iy),We=e),Ue=h;let S=iy&&sy(),C=!0;if(d){E.modoCarga=Sv.ativo;{let e=Sv.ativo?16:3,t=performance.now()+e,r=0;for(;s.length>0;){let e=s.shift(),o=e.cz*n.dims.x+e.cx;if(c.delete(o),f.has(o)){if(!i){let t=performance.now();Rd(n,a,e.cx,e.cz),l+=performance.now()-t,u++}if(E.enfileirarColuna(e.cx,e.cz),++r>=1&&performance.now()>=t)break}}}E.processarFila(hv.meshMsPorFrame,(e,t)=>{f.delete(t*n.dims.x+e)});let t=Math.max(0,Math.min(n.dims.x-1,Math.floor(P.pos.x/16))),r=Math.max(0,Math.min(n.dims.z-1,Math.floor(P.pos.z/16)));if(C=f.has(r*n.dims.x+t),(p=(p+1)%60)==0){for(let e of f){let i=e%n.dims.x,o=(e-i)/n.dims.x;if(Math.max(Math.abs(i-t),Math.abs(o-r))>hv.raioRender+2){f.delete(e),E.descartarColuna(i,o),ne.descartarColuna(i,o),bd(a,i,o);for(let e=0;e<n.dims.y;e++)n.chunks[(e*n.dims.z+o)*n.dims.x+i]=void 0}}j(t,r,e);let i=hv.raioRender*16;M.cularPorDistancia(P.pos.x,P.pos.z,i),re.cularPorDistancia(P.pos.x,P.pos.z,i)}Sv.ativo&&f.size>=fe&&s.length===0&&E.filaPendente===0&&Sv.concluir()}if(Pe?.ativo){let t=Pe.amostra(e);P.pos.x=t.x,P.pos.y=t.y,P.pos.z=t.z,P.vel.x=P.vel.y=P.vel.z=0,$.yaw=t.yaw,$.pitch=t.pitch,Pe.terminou(e)&&(Pe.parar(),Ne.marcar(`bench: fim`))}let w=P.pos.y;C&&!Pe?.ativo&&lp(n,P,{forward:o,strafe:m,jump:h,yaw:$.yaw,sprint:x,sneak:y,fly:S},r);let T=P.pos.y-w;P.onGround&&!S&&T>.01&&T<=.56&&(Ke=Math.min(Ke+T,Xf)),Ke*=Math.exp(-r*14),Ke<.002&&(Ke=0),_+=Math.hypot(P.pos.x-Le,P.pos.y-Re,P.pos.z-ze),Le=P.pos.x,Re=P.pos.y,ze=P.pos.z,P.pos.y<-16&&me();let A=1-Math.exp(-r*12);for(let e of he.values()){e.mesh.position.lerp(e.target,A);let t=e.targetYaw-e.mesh.rotation.y;e.mesh.rotation.y+=Math.atan2(Math.sin(t),Math.cos(t))*A}let ie=1-Math.exp(-r*20);Ge+=((y&&!S?Z.sneakEyeHeight:Z.eyeHeight)-Ge)*ie;let ae=hv.fov*(P.sprinting?1.1:1);if(Math.abs(tv.fov-ae)>.01&&(tv.fov+=(ae-tv.fov)*ie,tv.updateProjectionMatrix()),tv.position.set(P.pos.x,P.pos.y+Ge-Ke,P.pos.z),tv.rotation.set($.pitch,$.yaw,0),tv.getWorldDirection(be),F=$.active?pp(n,tv.position.x,tv.position.y,tv.position.z,be.x,be.y,be.z,5,we[Te]===900):null,ye=$.active&&ay===`sobrevivencia`&&oy?dp(tv.position.x,tv.position.y,tv.position.z,be.x,be.y,be.z,[...he].map(([e,t])=>({id:e,x:t.mesh.position.x,y:t.mesh.position.y-Z.height/2,z:t.mesh.position.z})),5):null,ye&&F){let e=Math.hypot(F.x+.5-tv.position.x,F.y+.5-tv.position.y,F.z+.5-tv.position.z);ye.dist>e&&(ye=null)}if(kv?.classList.toggle(`alvo`,ye!==null),ve.visible=F!==null&&ye===null,F){let[e,t,r,i,a,o]=Qd(Pu(n,F.x,F.y,F.z));ve.position.set(F.x+(e+i)/2,F.y+(t+a)/2,F.z+(r+o)/2),ve.scale.set(i-e+.004,a-t+.004,o-r+.004)}Ne.setRemesh({count:E.remeshCount,totalMs:E.remeshMsTotal,workerMs:E.remeshWorkerMsTotal,config:E.meshConfig,lastMs:E.lastRemeshMs,porCaminho:E.porCaminho}),ov.update(r),cv.ventoTempo.value=ov.fase*Math.PI*2,cv.ventoDir.value.set(ov.x,ov.z),cv.ventoForca.value=hv.balanco?ov.forca:0,iv.update(r,ov),b.nivelCeu.value=iv.nivelCeu,D.update(n,tv.position.x,tv.position.y,tv.position.z);let oe=Math.floor(ov.fase*16)%16;O+=r;let se=Math.floor(O*8)%16;(oe!==ee||se!==k)&&O-te>=1/12&&(te=O,ee=oe,k=se,Pm(v,oe,ov.ondaAgua,se));let ce=performance.now();Ne.gpuInicio(),$_.render(ev,tv),Ne.gpuFim(),Ne.frame(t,performance.now()-ce)}),d||Sv.concluir(),Gy.has(`hud`)&&Ne.toggle(),new URLSearchParams(location.search).has(`painel`)&&gv?.toggle(),new URLSearchParams(location.search).has(`inv`)&&_v?.toggle(),new URLSearchParams(location.search).has(`amigos`)&&yv?.toggle(),Gy.has(`touch`)&&Mv()}